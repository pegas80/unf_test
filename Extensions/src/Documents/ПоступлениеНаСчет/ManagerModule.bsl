...
Процедура РасшAzRy_СформироватьТаблицаРасчетыСПокупателями(ДокументСсылкаПоступлениеНаСчет, СтруктураДополнительныеСвойства)
	...
	Если ДокументСсылкаПоступлениеНаСчет.AzRyДокументЗагруженИзДругойБазыРедактированиеЗапрешено И ДокументСсылкаПоступлениеНаСчет.AzRyВычислитьКурсовуюРазницу Тогда
