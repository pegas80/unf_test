...
//	
//	// +++ { AzRy - [28.01.2022] - Developer:გიორგი მამულაშვილი - Comment: 
//	AzRyУправлениеНебольшойФирмойСервер_Deprecated.ПриходнаяНакладная_ИнициализироватьДанныеДокумента_ДопТекстЗапроса("ПоступлениеНаСчет", Запрос, ДокументСсылкаПоступлениеНаСчет.AzRyДокументЗагруженИзДругойБазыРедактированиеЗапрешено, "РасшифровкаПлатежа");	
//	// +++ } AzRy - [28.01.2022] - Developer:გიორგი მამულაშვილი - Comment:	
//	
//	Запрос.Выполнить();
//	
...
//		AzRyУправлениеНебольшойФирмойСервер_Deprecated.Сформировать_ВременнаяТаблицаКурсовыхРазницРасчетыСПокупателямиПредварительная3(Запрос);
//		// +++ } AzRy - [28.12.2021] - Developer:გიორგი მამულაშვილი - Comment:
//		
//		НомерЗапроса = 0;
//		Запрос.Текст = AzRyУправлениеНебольшойФирмойСервер_Deprecated.AzRy_ПолучитьТекстЗапросаКурсовыеРазницыРасчетыСПокупателями(Запрос.МенеджерВременныхТаблиц, Истина, НомерЗапроса, ДокументСсылкаПоступлениеНаСчет);
//		МассивРезультатов = Запрос.ВыполнитьПакет();
//		
//		НомерЗапроса = 0;
//		Запрос.Текст = AzRyУправлениеНебольшойФирмойСервер_Deprecated.AzRy_ПолучитьТекстЗапросаКурсовыеРазницыРасчетыСПокупателямиРегл(Запрос.МенеджерВременныхТаблиц, Истина, НомерЗапроса, ДокументСсылкаПоступлениеНаСчет);
//		МассивРезультатов = Запрос.ВыполнитьПакет();		
//	Иначе 	
//		НомерЗапроса = 0;
...
//&После("ИнициализироватьДанныеДокумента_Deprecated")
...
//		
//		// +++ { AzRy - [28.12.2021] - Developer:გიორგი მამულაშვილი - Comment:
//		AzRyУправлениеНебольшойФирмойСервер_Deprecated.Сформировать_ВременнаяТаблицаКурсовыхРазницРасчетыСПоставщикамиПредварительная(Запрос, ДокументСсылкаПоступлениеНаСчет);
//		// +++ } AzRy - [28.12.2021] - Developer:გიორგი მამულაშვილი - Comment:
//		
//		НомерЗапроса = 0;
//		Запрос.Текст = AzRyУправлениеНебольшойФирмойСервер_Deprecated.AzRy_ПолучитьТекстЗапросаКурсовыеРазницыРасчетыСПоставщиками(Запрос.МенеджерВременныхТаблиц, Истина, НомерЗапроса, ДокументСсылкаПоступлениеНаСчет);
//		МассивРезультатов = Запрос.ВыполнитьПакет();
//		
//		НомерЗапроса = 0;
//		Запрос.Текст = AzRyУправлениеНебольшойФирмойСервер_Deprecated.AzRy_ПолучитьТекстЗапросаКурсовыеРазницыРасчетыСПоставщикамиРегл(Запрос.МенеджерВременныхТаблиц, Истина, НомерЗапроса,, ДокументСсылкаПоступлениеНаСчет);
//		МассивРезультатов = Запрос.ВыполнитьПакет();		
//	Иначе 	
//		НомерЗапроса = 0;
