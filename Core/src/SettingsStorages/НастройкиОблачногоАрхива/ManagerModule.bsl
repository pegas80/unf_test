...
Процедура ОбработкаЗагрузки(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	УстановитьПривилегированныйРежим(Истина);
		...
		Иначе
			...
			Результат = СтрШаблон(
				НСтр("ka='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: не найден ключ объекта %1';ru='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: не найден ключ объекта %1';en='HranilischaNastroek.NastroykiOblachnogoArhiva.ObrabotkaZagruzki: Unable to find object% 1 key'"),
				КлючОбъекта);
...
Процедура ОбработкаСохранения(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Иначе
		...
		Результат = СтрШаблон(
			НСтр("ka='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: не найден ключ объекта %1';ru='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: не найден ключ объекта %1';en='HranilischaNastroek.NastroykiOblachnogoArhiva.ObrabotkaSohraneniya: Unable to find object% 1 key'"),
			КлючОбъекта);
		ВызватьИсключение Результат;
