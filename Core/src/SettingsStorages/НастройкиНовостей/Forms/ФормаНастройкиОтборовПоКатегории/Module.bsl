...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтаФорма.ЛентаНовостей.Пустая() Тогда
		ТекстСообщения = НСтр("ka='ახალი ამბების ლენტის მნიშვნელობა არ არის შევსებული. შერჩევის გამართვა შეუძლებელია.';ru='Не заполнено значение Ленты новостей."
"Настройка отбора невозможна.'");
	...
	Если ЭтаФорма.КатегорияНовостей.Пустая() Тогда
		ТекстСообщения = НСтр("ka='ახალი ამბების კატეგორიების მნიშვნელობა არ არის შევსებული. შერჩევის გამართვა შეუძლებელია.';ru='Не заполнено значение Категории новостей."
"Настройка отбора невозможна.'");
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = ТекстСообщения;
		Сообщение.Сообщить();
