...
Процедура ИмяФайлаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Фильтр = НСтр("ka='ფაილი xml';ru='Файл xml'")
		+ "(*.xml)|*.xml";
	ДиалогОткрытияФайла.Фильтр = Фильтр;
	ДиалогОткрытияФайла.МножественныйВыбор = Ложь;
	ДиалогОткрытияФайла.Заголовок = НСтр("ka='Укажите файл, в который надо экспортировать список лент новостей';ru='Укажите файл, в который надо экспортировать список лент новостей'");
...
Процедура КомандаЭкспорт(Команда)
	...
	Если (ВРег(ЭтаФорма.ФорматНовостей) <> ВРег("rss"))
		...
		Сообщение.Текст = НСтр("ka='აირჩიეთ ახალი ამბების სწორი ფორმატი';ru='Выберите правильный формат новостей'");
	...
	Если ПустаяСтрока(ЭтаФорма.ИмяФайла) Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='მიუთითეთ ფაილის სახელი, სადაც უნდა შევინახოთ ახალი ამბების სია';ru='Укажите имя файла, куда сохранить список новостей'");
	...
	ПоказатьОповещениеПользователя(
		НСтр("ka='ექსპორტი დასრულებულია';ru='Экспорт завершен'"),
		,
	...
	ЗаписьХМЛ.ЗаписатьАтрибут("version", "1.1");
		ЗаписьХМЛ.ЗаписатьНачалоЭлемента("head");
			ЗаписьХМЛ.ЗаписатьНачалоЭлемента("title");
				ЗаписьХМЛ.ЗаписатьТекст(НСтр("ka='Список лент новостей (1С)';ru='Список лент новостей (1С)'"));
		...
		ЗаписьХМЛ.ЗаписатьНачалоЭлемента("body");
			ЗаписьХМЛ.ЗаписатьНачалоЭлемента("outline");
				ЗаписьХМЛ.ЗаписатьАтрибут("text", НСтр("ka='სიახლეები 1С';ru='Новости 1С'"));
