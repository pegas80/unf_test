...
Процедура ОбработкаЗагрузки(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. ჩატვირთვისდამუშავება. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаЗагрузки. Нарушение прав доступа'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა. სიახლეების ამწყობი,ჩატვირთვის დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаЗагрузки, когда недоступна роль ЧтениеНовостей или ПолныеПрава'"), // Комментарий
...
Процедура ОбработкаПолученияОписания(КлючОбъекта, КлючНастроек, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. აღწერილობისმიღებისდამუშავება. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаПолученияОписания. Нарушение прав доступа'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა.სიახლეების ამწყობი, აღწერის მიღების დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаПолученияОписания, когда недоступна роль ЧтениеНовостей или ПолныеПрава'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
...
Процедура ОбработкаСохранения(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. შენახვისდამუშავება. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаСохранения. Нарушение прав доступа'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა.სიახლეების ამწყობი, შენახვის დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаСохранения, когда недоступна роль ЧтениеНовостей или ПолныеПрава'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ОтборыПоЛентамНовостейНастроенныеАдминистратором" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей'"), // ИмяСобытия
				НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. შენახვისდამუშავება. შეცდომა';ru='Новости. Хранилище настроек новостей. ОбработкаСохранения. Ошибка'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
...
Процедура ОбработкаУстановкиОписания(КлючОбъекта, КлючНастроек, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. დამუშავებადაყენებებიაღწერილობები. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаУстановкиОписания. Нарушение прав доступа'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა.სიახლეების ამწყობი, აღწერის დაყენების დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаУстановкиОписания, когда недоступна роль ЧтениеНовостей или ПолныеПрава'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
