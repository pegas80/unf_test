...
Процедура ОбработкаЗагрузки(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: Novosti.Hranilische news settings'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. ჩატვირთვისდამუშავება. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаЗагрузки. Нарушение прав доступа';en='News. Storage news settings. ObrabotkaZagruzki. Access Violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა. სიახლეების ამწყობი,ჩატვირთვის დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаЗагрузки, когда недоступна роль ЧтениеНовостей или ПолныеПрава';en='Trying to call HranilischaNastroek.NastroykiNovostey.ObrabotkaZagruzki when available role ChtenieNovostey or PolnyePrava'"), // Комментарий
...
Процедура ОбработкаПолученияОписания(КлючОбъекта, КлючНастроек, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: Novosti.Hranilische news settings'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. აღწერილობისმიღებისდამუშავება. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаПолученияОписания. Нарушение прав доступа';en='News. Storage news settings. ObrabotkaPolucheniyaOpisaniya. Access Violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა.სიახლეების ამწყობი, აღწერის მიღების დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаПолученияОписания, когда недоступна роль ЧтениеНовостей или ПолныеПрава';en='Trying to call HranilischaNastroek.NastroykiNovostey.ObrabotkaPolucheniyaOpisaniya when available role ChtenieNovostey or PolnyePrava'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
...
Процедура ОбработкаСохранения(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: Novosti.Hranilische news settings'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. შენახვისდამუშავება. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаСохранения. Нарушение прав доступа';en='News. Storage news settings. ObrabotkaSohraneniya. Access Violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა.სიახლეების ამწყობი, შენახვის დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаСохранения, когда недоступна роль ЧтениеНовостей или ПолныеПрава';en='Trying to call HranilischaNastroek.NastroykiNovostey.ObrabotkaSohraneniya when available role ChtenieNovostey or PolnyePrava'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ОтборыПоЛентамНовостейНастроенныеАдминистратором" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: Novosti.Hranilische news settings'"), // ИмяСобытия
				НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. შენახვისდამუშავება. შეცდომა';ru='Новости. Хранилище настроек новостей. ОбработкаСохранения. Ошибка';en='News. Storage news settings. ObrabotkaSohraneniya. Mistake'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				НСтр("ka='შეცდომა რეგისტრის ჩანაწერების კრებულის შემოწმებისას ახალიამბებისლენტებისმიხედვითშერჩევებისაერთო (ობიექტის გასაღები ადმინისტრატორისმიერგამართულიახალიამბებისლენტებისმიხედვითშერჩევები) - შეიძლება, რაღაც ველები არ არის შევსებული.';ru='Ошибка при проверке набора записей регистра ОтборыПоЛентамНовостейОбщие (ключ объекта ОтборыПоЛентамНовостейНастроенныеАдминистратором) - возможно, не заполнены какие-то поля.';en='Error checking OtboryPoLentamNovosteyObschie register set of records (OtboryPoLentamNovosteyNastroennyeAdministratorom object key) - may not be filled in any field.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ОтборыПоЛентамНовостейПользовательские" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				...
				, // ОбъектМетаданных
				, // Данные
				НСтр("ka='შეცდომა რეგისტრის ჩანაწერების კრებულის შემოწმებისას ახალიამბებისლენტებისმიხედვითშერჩევები სამომხმარებლო (ობიექტ ახალიამბებისლენტებისმიხედვითშერჩევები-ს გასაღები) - შეიძლება, რომ რაღაც ველები არ არის შევსებული.';ru='Ошибка при проверке набора записей регистра ОтборыПоЛентамНовостейПользовательские (ключ объекта ОтборыПоЛентамНовостейПользовательские) - возможно, не заполнены какие-то поля.';en='Error checking OtboryPoLentamNovosteyPolzovatelskie register set of records (key OtboryPoLentamNovosteyPolzovatelskie object) - may not be filled in any field.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ОтключенныеЛентыНовостей" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				...
				, // ОбъектМетаданных
				, // Данные
				НСтр("ka='შეცდომა რეგისტრის ჩანაწერების კრებულის შემოწმებისას ახალიამბებისგამორთულილენტები (ობიექტის გასაღები ახალიამბებისგამორთულილენტები) - შეიძლება, რომ რაღაც ველები არ არის შევსებული.';ru='Ошибка при проверке набора записей регистра ОтключенныеЛентыНовостей (ключ объекта ОтключенныеЛентыНовостей) - возможно, не заполнены какие-то поля.';en='Error checking OtklyuchennyeLentyNovostey register set of records (OtklyuchennyeLentyNovostey object key) - may not be filled in any field.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ДоступныеЛентыНовостей" Тогда
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='შეცდომა ახალი ამბების გამართვების ჩაწერისას. გასაღებ ახალიამბებისხელმისაწვდომილენტები-სთვის გამართვების ჩაწერა არ უნდა მოხდეს. შეიძლება მხოლოდ ახალიამბებისგამორთულილენტები-ს ჩაწერა.';ru='Ошибка при записи настроек новостей. Настройки для ключа ДоступныеЛентыНовостей не должны записываться. Записывать можно только ОтключенныеЛентыНовостей.';en='Error in setting the news record. key for setting DostupnyeLentyNovostey must not be recorded. You can only record OtklyuchennyeLentyNovostey.'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
...
Процедура ОбработкаУстановкиОписания(КлючОбъекта, КлючНастроек, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если НЕ (ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей()) Тогда
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.ახალი ამბების გამართვების საცავი';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: Novosti.Hranilische news settings'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. ახალი ამბების გამართვების საცავი. დამუშავებადაყენებებიაღწერილობები. დაშვების უფლებების დარღვევა';ru='Новости. Хранилище настроек новостей. ОбработкаУстановкиОписания. Нарушение прав доступа';en='News. Storage news settings. ObrabotkaUstanovkiOpisaniya. Access Violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("ka='ამწყობების საცავის გამოძახების მცდელობა.სიახლეების ამწყობი, აღწერის დაყენების დამუშავება, როდესაც მიუწვდომელია სიახლეების კითხვის როლი ან აბსოლუტური უფლება. ';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаУстановкиОписания, когда недоступна роль ЧтениеНовостей или ПолныеПрава';en='Trying to call HranilischaNastroek.NastroykiNovostey.ObrabotkaUstanovkiOpisaniya when available role ChtenieNovostey or PolnyePrava'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
