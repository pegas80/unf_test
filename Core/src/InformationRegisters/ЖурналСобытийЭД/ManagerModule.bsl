...
Процедура ОбновитьСтатусыЭД() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.УдалитьСтатусЭД = НСтр("ka='მიმღებისთვის მიტანილია';ru='Доставлен получателю';en='delivered to the recipient'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.Доставлен;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='<არ არის მიღებული>';ru='<Не получен>';en='<Not received>'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.НеПолучен;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='<არ არის ჩამოყალიბებული>';ru='<Не сформирован>';en='<Not formed>'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.НеСформирован;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='გაგზავნილია მიმღებისთვის';ru='Отправлен получателю';en='sent to recipient'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.Отправлен;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='გაგზავნილია უწყება დაზუსტების თაობაზე';ru='Отправлено уведомление об уточнении';en='Sent a notice to clarify'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.ОтправленоУведомление;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='გაეგზავნა ედბ-ის ოპერატორს';ru='Отправлен оператору ЭДО';en='Sent to the operator of EDI'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.ПереданОператору;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='მიღებულია უწყება დაზუსტების თაობაზე';ru='Получено уведомление об уточнении';en='We received a notice to clarify'") Тогда
