...
Процедура ОбновитьСтатусыЭД() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.УдалитьСтатусЭД = НСтр("ka='მიმღებისთვის მიტანილია';ru='Доставлен получателю'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.Доставлен;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='<არ არის მიღებული>';ru='<Не получен>'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.НеПолучен;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='<არ არის ჩამოყალიბებული>';ru='<Не сформирован>'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.НеСформирован;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='გაგზავნილია მიმღებისთვის';ru='Отправлен получателю'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.Отправлен;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='გაგზავნილია უწყება დაზუსტების თაობაზე';ru='Отправлено уведомление об уточнении'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.ОтправленоУведомление;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='გაეგზავნა ედბ-ის ოპერატორს';ru='Отправлен оператору ЭДО'") Тогда
			УдалитьСтатусЭД = Перечисления.СтатусыЭД.ПереданОператору;
		ИначеЕсли Выборка.УдалитьСтатусЭД = НСтр("ka='მიღებულია უწყება დაზუსტების თაობაზე';ru='Получено уведомление об уточнении'") Тогда
