...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") И Параметры.Отбор.Свойство("Номенклатура") Тогда
		...
		Если Номенклатура.ТипНоменклатуры <> Перечисления.ТипыНоменклатуры.Запас Тогда
			...
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ka='კონტრაგენტების ფასების შეყვანა შეიძლება მხოლოდ მარაგის ტიპის მქონე ნომენკლატურისთვის';ru='Цены контрагентов можно вводить только для номенклатуры с типом Запас'");
