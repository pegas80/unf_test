...
Процедура ВидЦенНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Контрагент) Тогда
		...
		ТекстСообщения = НСтр("ka='ფასის ტიპების ასარჩევად მიუთითეთ კონტრაგენტი.';ru='Укажите контрагента для выбора видов цен.';en='Specify the counterparty to select the kinds of prices.'");
