...
Процедура УстановитьЦенуНаКлиенте()
	...
	Если ЗначениеЗаполнено(Элементы.ЦеныНоменклатуры.ТекущиеДанные.Ссылка)
		...
		ПоказатьВводЧисла(ПослеВыбораЦены, Элементы.ЦеныНоменклатуры.ТекущиеДанные.Цена, НСтр("ka='Введите цену товара';ru='Введите цену товара';en='Enter the price of the goods'"));
	КонецЕсли;
КонецПроцедуры
