...
Процедура Подключить(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Запись.РегистрационныйНомер) Тогда
		ТекстСообщения = НСтр("ka='Введите регистрационный номер, полученный при регистрации ККМ в ФНС.';ru='Введите регистрационный номер, полученный при регистрации ККМ в ФНС.'");
...
"полученный на ККМ при регистрации у оператора фискальных данных (ОФД).'");
	...
	Если НЕ ЗначениеЗаполнено(Запись.ПрайсЛист) Тогда
		ТекстСообщения = НСтр("ka='Для работы с кассой необходим прайс-лист для указания цен.';ru='Для работы с кассой необходим прайс-лист для указания цен.'");
	...
	Если Модифицированность Тогда
		ЗаголовокВопроса = Нстр("ka='Подключение кассового аппарата';ru='Подключение кассового аппарата'");
		ТекстВопроса = Нстр("ka='Для подключения необходимо сохранить введенные данные. Сохранить?';ru='Для подключения необходимо сохранить введенные данные. Сохранить?'");
		СписокКнопок = Новый СписокЗначений;
		СписокКнопок.Добавить(КодВозвратаДиалога.Да, Нстр("ka='შენახვა';ru='Сохранить'"));
		СписокКнопок.Добавить(КодВозвратаДиалога.Отмена, Нстр("ka='გაუქმება';ru='Отменить'"));
...
Процедура ВыгрузитьТовары(Команда)
	...
	ЗаголовокВопроса = Нстр("ka='Выгрузка товаров и цен для кассового аппарата';ru='Выгрузка товаров и цен для кассового аппарата'");
	ТекстВопроса = Нстр("ka='Все товары и цены будут выгружены в кассовый аппарат. Выгрузить?';ru='Все товары и цены будут выгружены в кассовый аппарат. Выгрузить?'");
	СписокКнопок = Новый СписокЗначений;
	СписокКнопок.Добавить(КодВозвратаДиалога.Да, Нстр("ka='გადმოტვირთვა';ru='Выгрузить'"));
	СписокКнопок.Добавить(КодВозвратаДиалога.Отмена, Нстр("ka='გაუქმება';ru='Отменить'"));
	ПоказатьВопрос(ОписаниеОповещения, ТекстВопроса, СписокКнопок,, КодВозвратаДиалога.Да, ЗаголовокВопроса);
КонецПроцедуры
...
Процедура ОчиститьТовары(Команда)
	...
	ЗаголовокВопроса = Нстр("ka='Удаление товаров и цен с кассового аппарата';ru='Удаление товаров и цен с кассового аппарата'");
	ТекстВопроса = Нстр("ka='Вы действительно хотите удалить все товары и цены с кассового аппарата?';ru='Вы действительно хотите удалить все товары и цены с кассового аппарата?'");
	СписокКнопок = Новый СписокЗначений;
	СписокКнопок.Добавить(КодВозвратаДиалога.Да, Нстр("ka='წაშლა';ru='Удалить'"));
	СписокКнопок.Добавить(КодВозвратаДиалога.Отмена, Нстр("ka='გაუქმება';ru='Отменить'"));
	ПоказатьВопрос(ОписаниеОповещения, ТекстВопроса, СписокКнопок,, КодВозвратаДиалога.Да, ЗаголовокВопроса);
КонецПроцедуры
...
Процедура ЗагрузитьЧеки(Команда)
	...
	ВыборПериода.Добавить("ТекущаяНеделя", НСтр("ka='მიმდინარე კვირა';ru='Текущая неделя'"));
	ВыборПериода.Добавить("ТекущийМесяц", НСтр("ka='მიმდინარე თვე';ru='Текущий месяц'"));
	ВыборПериода.Добавить("ПрошлыйМесяц", НСтр("ka='Прошлый и текущий месяц';ru='Прошлый и текущий месяц'"));
	ВыборПериода.Добавить("ТекущийКвартал", НСтр("ka='მიმდინარე კვარტალი';ru='Текущий квартал'"));
	ВыборПериода.Добавить("ТекущийГод", НСтр("ka='მიმდინარე წელი';ru='Текущий год'"));
	ВыборПериода.Добавить("Все", НСтр("ka='За все периоды';ru='За все периоды'"));
...
Процедура ПослеВыбораПериода(Результат, Параметры) Экспорт
	...
	Если Результат <> Неопределено Тогда
		...
		ЗаголовокВопроса = Нстр("ka='Загрузка чеков с кассового аппарата';ru='Загрузка чеков с кассового аппарата'");
		ТекстВопроса = Нстр("ka='Будут загружены все кассовые чеки за выбранный период. Загрузить?';ru='Будут загружены все кассовые чеки за выбранный период. Загрузить?'");
		СписокКнопок = Новый СписокЗначений;
		СписокКнопок.Добавить(КодВозвратаДиалога.Да, Нстр("ka='ჩატვირთვა';ru='Загрузить'"));
		СписокКнопок.Добавить(КодВозвратаДиалога.Отмена, Нстр("ka='გაუქმება';ru='Отменить'"));
		ПоказатьВопрос(ОписаниеОповещения, ТекстВопроса, СписокКнопок,, КодВозвратаДиалога.Да, ЗаголовокВопроса);
...
Процедура ПослеВопросаВыгрузкаТоваров(Знач Результат, Знач ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		ЗаголовокПредупреждения = НСтр("ka='Выгрузка товаров и цен';ru='Выгрузка товаров и цен'");
...
Процедура ПослеВопросаСнятиеСРегистрации(Знач Результат, Знач ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		ЗаголовокПредупреждения = Нстр("ka='Отключение кассового аппарата.';ru='Отключение кассового аппарата.'");
		ДополнительныеПараметры = Новый Структура("Режим", 2);
		ТекстПредупреждения = НСтр("ka='Отключение может занять некоторое время.';ru='Отключение может занять некоторое время.'");
...
Процедура ПослеВопросаУдалениеТоваров(Знач Результат, Знач ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		ЗаголовокПредупреждения = НСтр("ka='საქონლის მოშორება';ru='Удаление товаров'");
...
Процедура ПослеВопросаЗагрузкаЧеков(Знач Результат, Знач ДополнительныеПараметры) Экспорт
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		ЗаголовокПредупреждения = НСтр("ka='Загрузка кассовых чеков';ru='Загрузка кассовых чеков'");
	...
	Если НЕ ДополнительныеПараметры = Неопределено Тогда
		Если ДополнительныеПараметры.Свойство("Режим") Тогда
			...
			Если ЕстьОшибки Тогда
				ЗаголовокПредупреждения = Нстр("ka='Подключение кассового аппарата.';ru='Подключение кассового аппарата.'");
		...
		ИначеЕсли ДополнительныеПараметры.Свойство("РежимТовары") Тогда
			...
			Если ЕстьОшибки Тогда
				ЗаголовокПредупреждения = Нстр("ka='Выгрузка товаров на кассовый аппарат.';ru='Выгрузка товаров на кассовый аппарат.'");
				ПоказатьПредупреждение(, СообщениеОбОшибке,, ЗаголовокПредупреждения);
			Иначе
				ОповеститьОбИзменении(Запись.КассаККМ);
				ПриЧтенииСозданииНаСервере();
		...
		ИначеЕсли ДополнительныеПараметры.Свойство("РежимТоварыОчистка") Тогда
			...
			Если ЕстьОшибки Тогда
				ЗаголовокПредупреждения = Нстр("ka='Очистка товаров на кассовом аппарате.';ru='Очистка товаров на кассовом аппарате.'");
				ПоказатьПредупреждение(, СообщениеОбОшибке,, ЗаголовокПредупреждения);
			Иначе
				ОповеститьОбИзменении(Запись.КассаККМ);
				ПриЧтенииСозданииНаСервере();
		...
		ИначеЕсли ДополнительныеПараметры.Свойство("РежимДокументы") Тогда
			...
			Если ЕстьОшибки Тогда
				ЗаголовокПредупреждения = Нстр("ka='Загрузка чеков с кассового аппарата.';ru='Загрузка чеков с кассового аппарата.'");
				ПоказатьПредупреждение(, СообщениеОбОшибке,, ЗаголовокПредупреждения);
			Иначе
				ОповеститьОбИзменении(Запись.КассаККМ);
				ПриЧтенииСозданииНаСервере();
	...
	Если Результат = КодВозвратаДиалога.Да Тогда
		...
		Если Успешно И ЗначениеЗаполнено(Запись.КассаККМ) Тогда
			...
			Если СостояниеРегистрации =
				...
				ЗаголовокВопроса = Нстр("ka='Отключение кассового аппарата';ru='Отключение кассового аппарата'");
				ТекстВопроса = Нстр("ka='После отключения данные по чекам не смогут быть загружены. Отключить?';ru='После отключения данные по чекам не смогут быть загружены. Отключить?'");
				СписокКнопок = Новый СписокЗначений;
				СписокКнопок.Добавить(КодВозвратаДиалога.Да, Нстр("ka='გამორთვა';ru='Отключить'"));
				СписокКнопок.Добавить(КодВозвратаДиалога.Отмена, Нстр("ka='გაუქმება';ru='Отменить'"));
				ПоказатьВопрос(ОписаниеОповещения, ТекстВопроса, СписокКнопок,, КодВозвратаДиалога.Да, ЗаголовокВопроса);
			Иначе
				...
				Если Результат Тогда
					...
					ТекстПредупреждения = НСтр("ka='Подключение может занять некоторое время.';ru='Подключение может занять некоторое время.'");
				Иначе
...
Процедура УстановитьСостояниеОбменаТовары()
	...
	Если Запись.ЗарегистрироватьТоварыНаСервереШтрихМ Тогда
		...
		Элементы.ВыгрузитьТовары.Заголовок = НСтр("ka='Идёт выгрузка товаров и цен';ru='Идёт выгрузка товаров и цен'");
		Элементы.ОчиститьТовары.Доступность = Ложь;
		Элементы.ОчиститьТовары.Заголовок = НСтр("ka='Удалить товары и цены';ru='Удалить товары и цены'");
		
		Ожидание = Истина;
		//Заголовок = СтрШаблон(НСтр("ka='%1 (%2)';ru='%1 (%2)'"),
	...
	ИначеЕсли Запись.ПроверитьРегистрациюТоваровНаСервереШтрихМ Тогда
		Элементы.ВыгрузитьТовары.Доступность = Ложь;
		Элементы.ВыгрузитьТовары.Заголовок = НСтр("ka='Проверка загрузки цен';ru='Проверка загрузки цен'");
		Элементы.ОчиститьТовары.Доступность = Ложь;
		Элементы.ОчиститьТовары.Заголовок = НСтр("ka='Удалить товары и цены';ru='Удалить товары и цены'");
	...
	ИначеЕсли Запись.ОчиститьТоварыНаСервереШтрихМ Тогда
		Элементы.ВыгрузитьТовары.Доступность = Ложь;
		Элементы.ВыгрузитьТовары.Заголовок = НСтр("ka='Выгрузить товары и цены';ru='Выгрузить товары и цены'");
		Элементы.ОчиститьТовары.Доступность = Ложь;
		Элементы.ОчиститьТовары.Заголовок = НСтр("ka='Идёт удаление товаров и цен';ru='Идёт удаление товаров и цен'");
...
Процедура УстановитьСостояниеОбменаЧеки()
	...
	Если Запись.ЗапроситьЧекиНаСервереШтрихМ Тогда
		...
		Элементы.ЗагрузитьЧеки.Заголовок = НСтр("ka='Идёт загрузка чеков';ru='Идёт загрузка чеков'");
		Ожидание = Истина;
		//Заголовок = СтрШаблон(НСтр("ka='%1 (%2)';ru='%1 (%2)'"),
		//	Запись.КассаККМ.Наименование, Элементы.ЗагрузитьЧеки.Заголовок);
	Иначе
		Элементы.ЗагрузитьЧеки.Заголовок = НСтр("ka='ჩეკების ატვირთვა';ru='Загрузить чеки'");
	КонецЕсли;
...
Процедура ВыполнитьЗагрузкуЧековНаСервере(ЕстьОшибки, СообщениеОбОшибке)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ka='Фоновое получение кассовых чеков';ru='Фоновое получение кассовых чеков'");
...
Функция ПодключитьОтключитьКассуПоТарифу(Подключить)
	...
	Если Подключить Тогда
		...
		Если Результат Тогда
			ТекстСообщения = СтрШаблон(НСтр("ka='Занята лицензия %1 на сервере лицензий';ru='Занята лицензия %1 на сервере лицензий'"), Запись.РегистрационныйНомер);
	...
	Иначе
		...
		Если Результат Тогда
			ТекстСообщения = СтрШаблон(НСтр("ka='Освобождена лицензия %1 на сервере лицензий';ru='Освобождена лицензия %1 на сервере лицензий'"), Запись.ИдентификаторТарификации);
			ОбменСКассовымСерверомШтрихМ.ЗаписатьВПротоколКассовогоАппарата(Запись.РегистрационныйНомер, ТекстСообщения);
...
Процедура УстановитьСостояниеОбъекта()
	...
	Если СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.НеПодключен Тогда
		Элементы.Подключить.Заголовок = Нстр("ka='მივუერთოთ';ru='Подключить'");
	...
	ИначеЕсли СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.Подключен Тогда
		Элементы.Подключить.Заголовок = Нстр("ka='გამორთვა';ru='Отключить'");
		Элементы.Подключить.Доступность = Истина;
		Элементы.Токен.ТолькоПросмотр = Ложь;
	...
	ИначеЕсли СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.ОжидаетПодключение Тогда
		Элементы.Подключить.Заголовок = Нстр("ka='მიმდინარეობს შეერთება';ru='Идёт подключение'");
	...
	ИначеЕсли СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.ОжидаетПереподключение Тогда
		Элементы.Подключить.Заголовок = Нстр("ka='მიმდინარეობს ხელახლა შეერთება';ru='Идёт переподключение'");
		Элементы.Подключить.Доступность = Ложь;
	ИначеЕсли СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.ОжидаетОтключение Тогда
		Элементы.Подключить.Заголовок = Нстр("ka='მიდის გამორთვა';ru='Идёт отключение'");
		Элементы.Подключить.Доступность = Ложь;
	КонецЕсли;
	...
	Если СостояниеРегистрации = Перечисления.СостоянияРегистрацииКассовогоАппарата.НеПодключен И ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		...
		Если ИнформацияПоТарифу.СвободноЛицензий = 0 Тогда
			...
			Элементы.ДекорацияНетЛицензий.Заголовок = 
				НСтр("ka='Нет возможности подключения к сервису. Обратитесь к обслуживающему вас партнеру комании 1С.';ru='Нет возможности подключения к сервису. Обратитесь к обслуживающему вас партнеру комании 1С.'");
		Иначе
