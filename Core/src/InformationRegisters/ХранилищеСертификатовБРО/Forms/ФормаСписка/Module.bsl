...
Процедура ИмпортироватьСертификат(Команда)
	...
	ТекстПодсказки = НСтр("ka='Укажите логическое хранилище';ru='Укажите логическое хранилище';en='Specify the logical storage'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
