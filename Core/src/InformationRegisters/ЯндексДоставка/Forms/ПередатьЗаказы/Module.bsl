...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НСтр("ka='Не задан параметр ""Заказы"".';ru='Не задан параметр ""Заказы"".'"),
...
Процедура ОбработатьЗавершениеЗадания(Результат, Параметры) Экспорт
	...
	Если Результат.Статус = "Выполнено" Тогда
		...
		ПоказатьОповещениеПользователя(НСтр("ka='Заказы выгружены в Яндекс.Доставку';ru='Заказы выгружены в Яндекс.Доставку'"));
