...
Функция ВозможенЗапросРазрешенийНаИспользованиеВнешнихРесурсов()
	...
	Иначе
		...
		Если Не Пользователи.ЭтоПолноправныйПользователь() Тогда
			...
			ВызватьИсключение НСтр("ka='გარე რესურსების გამოყენებაზე ნებართვების მოსათხოვნად დაშვების უფლებები არასაკმარისია!';ru='Недостаточно прав доступа для запроса разрешений на использование внешних ресурсов!'");
