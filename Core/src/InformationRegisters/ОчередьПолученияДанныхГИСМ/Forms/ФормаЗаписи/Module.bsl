	...
	Если Не Запись.ИсходныйКлючЗаписи.Пустой() Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			Иначе
				...
				ТекстовыйДокументКонвертSOAP.УстановитьТекст(НСтр("ka='<SOAP-конверт не загружен>';ru='<SOAP-конверт не загружен>'"));
				ТекстовыйДокументТекстСообщенияXML.УстановитьТекст(НСтр("ka='<SOAP-конверт не загружен>';ru='<SOAP-конверт не загружен>'"));
