	...
	Если Выборка.Следующий() Тогда
		...
		Если Сообщения = Неопределено Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ka='Не удалось обработать сообщение. SOAP-конверт не загружен.';ru='Не удалось обработать сообщение. SOAP-конверт не загружен.';en='Unable to process the message. SOAP-envelope is not loaded.'"));
