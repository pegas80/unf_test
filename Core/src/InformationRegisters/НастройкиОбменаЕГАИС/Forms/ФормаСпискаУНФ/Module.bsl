...
Процедура УстановитьЗаголовокФормы()
	...
	Иначе
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='Настройки обмена с ЕГАИС:';ru='Настройки обмена с ЕГАИС:'") + " " + Строка(РабочееМесто);
	КонецЕсли;
...
Процедура УстановитьОтборПоРабочемуМесту()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		...
		НСтр("ka='Доступная настройка обмена';ru='Доступная настройка обмена'"),
		Истина);
...
Процедура ДобавитьУсловноеОформлениеПоТекущемуРабочемуМесту()
	...
	ПредставлениеЭлемента = НСтр("ka='Доступная настройка обмена';ru='Доступная настройка обмена'");
...
Функция ТекстНадписиОткрытьРасписание(Расписание)
	...
	Возврат ?(Не ПустаяСтрока(СтроковоеПредставлениеРасписания),
		СтроковоеПредставлениеРасписания, НСтр("ka='არ არის მითითებული';ru='Не задано'"));
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления = УсловноеОформление.Элементы.Добавить();
	ЭлементУсловногоОформления.Представление = НСтр("ka='სამუშაო ადგილის(მაგიდის) ნახვა';ru='Представление рабочего места'");
	ЭлементУсловногоОформления.Использование = Истина;
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ka='<Все>';ru='<Все>'"));
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		...
		НСтр("ka='Пустое рабочее место';ru='Пустое рабочее место'"),
		Истина);
