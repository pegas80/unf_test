...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	ОчиститьСообщения();
	Если НЕ ПравоДобавленияЦеныНоменклатуры Тогда
		ТекстСообщения = НСтр("ru = 'მოცემულ მომხმარებელს არა აქვს ნომენკლატურის ფასის დამატების უფლება!'; ka = 'მოცემულ მომხმარებელს არა აქვს ნომენკლატურის ფასის დამატების უფლება!'");
