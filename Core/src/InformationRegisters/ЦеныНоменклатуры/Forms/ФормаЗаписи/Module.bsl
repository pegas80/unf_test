...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ТекущийОбъект.ВидЦен.РассчитыватьАвтоматически Тогда
		...
		ТекстСообщения = Нстр("ka='ფასების მოცემული სახეობის მიხედვით ჩანაწერების გამოთვლა მხოლოდ ავტომატურად ხდება';ru='Записи по данному виду цен рассчитываются только автоматически'");
