...
Функция ПереместитьДанныеВНовыйРегистр() Экспорт
	...
	Если Выборка.Количество() < 10000 Тогда
		...
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ka='რეგისტრ დაშვებისმნიშვნელობებისკრებულებისწაშლა-დან მონაცემთა გადატანა დასრულებულია.';ru='Завершен перенос данных из регистра УдалитьНаборыЗначенийДоступа.'"),
	...
	Иначе
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ka='შესრულებულია რეგისტრ დაშვებისმნიშვნელობებისკრებულებისწაშლა-ს მონაცემთა გადატანის ნაბიჯი.';ru='Выполнен шаг переноса данных из регистра УдалитьНаборыЗначенийДоступа.'"),
			РежимТранзакцииЗаписиЖурналаРегистрации.Транзакционная);
	КонецЕсли;
