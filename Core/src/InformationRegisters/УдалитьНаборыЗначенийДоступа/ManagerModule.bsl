...
Функция ПереместитьДанныеВНовыйРегистр() Экспорт
	...
	Если Выборка.Количество() < 10000 Тогда
		...
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ka='რეგისტრ დაშვებისმნიშვნელობებისკრებულებისწაშლა-დან მონაცემთა გადატანა დასრულებულია.';ru='Завершен перенос данных из регистра УдалитьНаборыЗначенийДоступа.';en='Completed UdalitNaboryZnacheniyDostupa transfer of data from the register.'"),
	...
	Иначе
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ka='შესრულებულია რეგისტრ დაშვებისმნიშვნელობებისკრებულებისწაშლა-ს მონაცემთა გადატანის ნაბიჯი.';ru='Выполнен шаг переноса данных из регистра УдалитьНаборыЗначенийДоступа.';en='Data transfer is executed from step UdalitNaboryZnacheniyDostupa register.'"),
			РежимТранзакцииЗаписиЖурналаРегистрации.Транзакционная);
	КонецЕсли;
