...
Процедура ОбработатьВводТокенаЗапроса(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ka='მიმდინარეობს მოთხოვნის ტოკენის დამუშავება';ru='Выполняется обработка токена запроса'"));
...
Процедура ОбработатьСобытиеБраузерДокументСформирован()
	...
	Если СтруктураЗаголовка.Статус=СтатусОтказ() Тогда
		...
		НСтр("ka='შეცდომა დაშვების ტოკენის მიღებისას';ru='Ошибка при получении токена доступа'"),,
		КодОшибки,
...
Процедура ОбработатьПолучениеТокенаЗапроса()
	...
	ПоказатьОповещениеПользователя(
	НСтр("ka='მოთხოვნის ტოკენი მიღებულია, მიმდინარეობს დაშვების ტოკენზე გაცვლა...';ru='Токен запроса получен, выполняется обмен на токен доступа...'"),,,
	...
	Иначе
		ПоказатьОповещениеПользователя(
		НСтр("ka='დაშვების ტოკენი წარმატებით იქნა მიღებული';ru='Токен доступа получен успешно'"),,,
