...
Процедура ОбновитьРодителейВладельца(ВладелецНастроекПрав, ЕстьИзменения = Ложь, ОбновитьИерархию = Ложь, ОбъектыСИзменениями = Неопределено) Экспорт
	...
	ЗаголовокОшибки =
		НСтр("ka='შეცდომა დაშვების მნიშვნელობებით უფლებების მფლობელთა იერარქიის განახლებისას.';ru='Ошибка при обновлении иерархии владельцев прав по значениям доступа.'")
		+ Символы.ПС
		+ Символы.ПС;
