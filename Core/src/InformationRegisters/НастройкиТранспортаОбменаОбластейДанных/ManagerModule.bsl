...
Функция НастройкиТранспорта(Знач КонечнаяТочкаКорреспондента) Экспорт
	...
	Если РезультатЗапроса.Пустой() Тогда
		ВызватьИсключение СтрШаблон(НСтр("ka='ბოლო წერტილ %1-ისთვის შეერთების გამართვები არ არის მიცემული.';ru='Не заданы настройки подключения для конечной точки %1.';en='Do not set the connection settings for the endpoint% 1.'"),
