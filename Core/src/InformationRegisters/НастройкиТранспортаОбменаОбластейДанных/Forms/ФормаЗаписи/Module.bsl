...
Процедура ПроверитьПодключение(ВидТранспортаСтрокой)
	...
	ТекстПредупреждения = ?(Отказ, НСтр("ka='ვერ მოხერხდა ჩართვის დაყენება.';ru='Не удалось установить подключение.'"), НСтр("ka='მიერთება წარმატებით არის დაყენებული.';ru='Подключение успешно установлено.'"));
