	...
	Для каждого ТекущаяЗапись Из ЭтотОбъект Цикл
		Если ТипЗнч(ТекущаяЗапись.Список) = ТипКатегорияНовостей Тогда
			Если ТекущаяЗапись.Список.Пустая() Тогда
				...
				Сообщение.Текст = НСтр("ka='განახლებადი კატეგორიის მნიშვნელობა შევსებული უნდა იყოს.';ru='Значение обновляемой категории должно быть заполнено.';en='The value is updated categories to be filled.'");
				Сообщение.Сообщить();
			КонецЕсли;
...
"- Код категории новостей (начинается с [Значения категории новостей:])';ka='Неправильное значение %1."
"Разрешено только:"
"- Список категорий новостей"
"- Список лент новостей"
...
"- Список лент новостей"
"- Код категории новостей (начинается с [Значения категории новостей:])"
"- Ссылка на план видов характеристик КатегорииНовостей';ka='Неправильное значение %1."
"Разрешено только:"
"- Список категорий новостей"
"- Список лент новостей"
"- Код категории новостей (начинается с [Значения категории новостей:])"
