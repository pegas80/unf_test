...
Процедура ОбновитьВсеТиповыеПравила(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ka='წესების განახლება წარმატებით დასრულდა.';ru='Обновление правил успешно завершено.';en='Updating the rules successfully completed.'"));
