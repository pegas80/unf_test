...
Процедура ЗагрузитьСтандартныеЗначения() Экспорт
	...
	ОблачныйАрхивКлиентСервер.ЗарегистрироватьНачалоШагаВыполнения(
		...
		СтрШаблон(
			НСтр("ka='Загрузка стандартных значений (%1)';ru='Загрузка стандартных значений (%1)'"),
			ИмяСвойства));
...
"'"),
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		...
		СтрШаблон(
			НСтр("ka='Облачный архив. Сервис и регламент. Загрузка стандартных значений. %1';ru='Облачный архив. Сервис и регламент. Загрузка стандартных значений. %1'"),
...
Процедура ЗагрузитьСтандартноеЗначение(НаборЗаписей, ТекущаяЗаписьХДТО, ОбъектМетаданных, ИмяСвойства, КонтекстВыполнения)
	...
	ОблачныйАрхивКлиентСервер.ЗарегистрироватьНачалоШагаВыполнения(
		...
		НСтр("ka='Загрузка записи регистра сведений';ru='Загрузка записи регистра сведений'"));
