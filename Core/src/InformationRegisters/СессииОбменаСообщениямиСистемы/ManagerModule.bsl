...
Функция СтатусСессии(Знач Сессия) Экспорт
	...
	Если РезультатЗапроса.Пустой() Тогда
		СтрокаСообщения = НСтр("ka='სისტემა ""%1""-ის შეტყობინებების გაცვლის სესია ვერ მოიძებნა.';ru='Сессия обмена сообщениями системы ""%1"" не найдена.';en='Session messaging system ""%1"" not found.'");
