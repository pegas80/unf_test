...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ПрограммноеЗакрытие <> Истина Тогда
		...
		Если МассивОтобранныхЗаписей.Количество() > 0 Тогда
			...
			ТекстПредупреждения = НСтр("ka='Есть отобранные документы. Вы действительно хотите закрыть форму?';ru='Есть отобранные документы. Вы действительно хотите закрыть форму?';en='It has selected documents. Do you really want to close the form?'");
