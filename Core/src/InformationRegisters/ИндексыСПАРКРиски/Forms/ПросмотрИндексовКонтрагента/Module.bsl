...
Процедура ОтобразитьЗначенияИндексов(РезультатИндексыКонтрагента)
	...
	ИначеЕсли ВидОшибки = ПредопределенноеЗначение("Перечисление.ВидыОшибокСПАРКРиски.НеизвестныйИНН")
		...
		Элементы.ДекорацияСтатусИСобытие.Заголовок = НСтр("ka='Нет информации о контрагенте';ru='Нет информации о контрагенте';en='No information about the counterparty'");
		Элементы.ДекорацияСтатусИСобытие.Видимость = Истина;
...
"<a href=""SPARK:About"">Подробнее о сервисе</a><body>';ka='<body>Оценка надежности контрагентов.<br />"
