	...
	Пока Выборка.Следующий() Цикл
		...
		Если РегистрыСведений.ОбластиСтатистики.СобиратьСтатистикуКонфигурации(ОбластьДанныхСтрока) Тогда
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(НСтр("ka='კონფიგურაციისსტატისტიკა';ru='СтатистикаКонфигурации';en='StatistikaKonfiguratsii'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,
				,,
				НСтр("ka='Не удалось установить разделение сеанса. Область данных';ru='Не удалось установить разделение сеанса. Область данных';en='Unable to establish a session division. The data area'") + " = " + Формат(Выборка.ОбластьДанных, "ЧГ=0")
