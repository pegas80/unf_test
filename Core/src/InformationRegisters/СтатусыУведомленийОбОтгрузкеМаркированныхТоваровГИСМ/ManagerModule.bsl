	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ka='Не удалось обработать сообщение: %1 из очереди получения квитанций по причине: %2';ru='Не удалось обработать сообщение: %1 из очереди получения квитанций по причине: %2';en='Unable to process the message:% 1 from the queue receiving the receipt for a reason:% 2'"),
				Выборка.Сообщение,
