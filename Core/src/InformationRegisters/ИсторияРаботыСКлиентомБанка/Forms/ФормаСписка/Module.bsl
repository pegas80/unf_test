...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПротоколТекст",НСтр("ka='ჩვენება';ru='Показать'"));
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекст",НСтр("ka='გახსნა';ru='Открыть'"));
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекстЗагрузка",НСтр("ka='ხელახლად ატვირთვა';ru='Загрузить снова'"));
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекстВыгрузка",НСтр("ka='დისკზე შენახვა';ru='Сохранить на диск'"));
...
Процедура СохранитьНаДиск(ТекущиеДанные, ПараметрыОткрытияФормы)
	...
	Если ПараметрыЗаписи = Неопределено Тогда
		ТекстСообщения = НСтр("ka='საინფორმაციო ბაზიდან მონაცემთა მიღება ვერ მოხერხდა!';ru='Не удалось получить данные из информационной базы!'");
