...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПротоколТекст",НСтр("ka='ჩვენება';ru='Показать';en='show'"));
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекст",НСтр("ka='გახსნა';ru='Открыть';en='Open'"));
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекстЗагрузка",НСтр("ka='ხელახლად ატვირთვა';ru='Загрузить снова';en='Download again'"));
	Список.Параметры.УстановитьЗначениеПараметра("ФайлОбменаТекстВыгрузка",НСтр("ka='დისკზე შენახვა';ru='Сохранить на диск';en='Save to disk'"));
...
Процедура СохранитьНаДиск(ТекущиеДанные, ПараметрыОткрытияФормы)
	...
	Если ПараметрыЗаписи = Неопределено Тогда
		ТекстСообщения = НСтр("ka='საინფორმაციო ბაზიდან მონაცემთა მიღება ვერ მოხერხდა!';ru='Не удалось получить данные из информационной базы!';en='Failed to get the data from the knowledge base!'");
