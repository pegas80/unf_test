...
Процедура УстановитьУсловноеОформление()
	...
	// 1. Версия платформы, скрыта
		...
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ka='დამალულია';ru='Скрыта';en='hidden'"));
	...
	// 2. Версия платформы, видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ka='ჩანს';ru='Видна';en='visible'"));
	...
	// 3. Версия платформы, отбор не настроен - видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ka='შერჩევა არ არის გამართული, ჩანს';ru='Отбор не настроен, видна';en='The selection is not set, visible'"));
