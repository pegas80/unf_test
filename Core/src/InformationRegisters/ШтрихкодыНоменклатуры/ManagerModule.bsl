...
Функция ПолучитьДанныеПоШтрихкодам(Штрихкоды, СтруктурнаяЕдиница = Неопределено) Экспорт
	...
	|	И КодыТоваровПодключаемогоОборудованияOffline.Используется //+++ Дмгг
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	Для каждого ТекШтрихкод Из Штрихкоды Цикл
		...
		//Если ЛЕВ(ТекШтрихкод.Штрихкод,1) = "2" Тогда// Kuzmich, 13.03.2019, неправильно находит штрихкод НЕ от весов
...
&НаСервере
Процедура УcтановитьКакОсновнойШтрихкод(Номенклатура,Штрихкод) Экспорт
	
	НоменклатураОбъект = Номенклатура.ПолучитьОбъект();
	НоменклатураОбъект.ОсновнойШтрихКод = Штрихкод;
