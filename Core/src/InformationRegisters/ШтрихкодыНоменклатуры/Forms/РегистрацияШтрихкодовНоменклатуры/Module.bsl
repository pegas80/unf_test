...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Выборка.Следующий() Тогда // Штрихкод уже записан в БД
		...
		ОписаниеОшибки = НСтр("ka='ასეთი შტრიხკოდი უკვე დანიშნულია ნომენკლატურისთვის  %Номенклатура%';ru='Такой штрихкод уже назначен для номенклатуры %Номенклатура%'");
		ОписаниеОшибки = СтрЗаменить(ОписаниеОшибки, "%Номенклатура%", """" + Выборка.НоменклатураПредставление + """"
						+ ?(ЗначениеЗаполнено(Выборка.Характеристика), " " + НСтр("ka='მახასიათებლით';ru='с характеристикой'") + " """ + Выборка.ХарактеристикаПредставление + """", "")
						+ ?(ЗначениеЗаполнено(Выборка.Партия), " """ + НСтр("ka='პარტიაში';ru='в партии'") + " " + Выборка.ПартияПредставление + """", "")
						);
