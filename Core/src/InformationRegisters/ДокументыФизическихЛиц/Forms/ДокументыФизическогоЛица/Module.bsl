...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Физлицо") Тогда
		...
		Если Не ЕстьУдостоверение И ЕстьДокументы Тогда
			...
			ТекстСообщения = НСтр("ka='ფიზ.პირი %1-ისთვის არ არის მითითებული პირადობის დამადასტურებელი დოკუმენტი.';ru='Для физлица %1 не задан документ, удостоверяющий личность.'");
