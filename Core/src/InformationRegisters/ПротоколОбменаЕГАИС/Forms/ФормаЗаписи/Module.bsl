...
Процедура ЗаполнитьСтраницыСессийОбмена()
	...
	Пока Выборка.Следующий() Цикл
		...
		Реквизит = Новый РеквизитФормы("ДатаЗапроса" + ТекИдентификатор, Новый ОписаниеТипов("Дата"), "", НСтр("ka='მოთხოვნის თარიღი';ru='Дата запроса'"));
		ДобавляемыеРеквизиты.Добавить(Реквизит);
		
		Реквизит = Новый РеквизитФормы("Комментарий" + ТекИдентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ka='კომენტარი';ru='Комментарий'"));
		ДобавляемыеРеквизиты.Добавить(Реквизит);
		
		Реквизит = Новый РеквизитФормы("ТекстXML" + ТекИдентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ka='ტექსტი XML';ru='Текст XML'"));
		ДобавляемыеРеквизиты.Добавить(Реквизит);
	КонецЦикла;
	...
	Пока Выборка.Следующий() Цикл
		...
		Если СтраницаОсновное = Неопределено Тогда
			...
			СтраницаОсновное.Заголовок = НСтр("ka='ძირითადი';ru='Основное'");
		КонецЕсли;
		...
		Если СтраницаТекстXML = Неопределено Тогда
			...
			СтраницаТекстXML.Заголовок = НСтр("ka='ტექსტი XML';ru='Текст XML'");
		КонецЕсли;
