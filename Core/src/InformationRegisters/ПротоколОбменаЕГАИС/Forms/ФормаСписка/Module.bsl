...
Процедура ОбработкаОтветовИзЕГАИС_Завершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Обработка ответов из ЕГАИС завершена.';ru='Обработка ответов из ЕГАИС завершена.'"));
...
Процедура УстановитьУсловноеОформление()
	...
	ПредставлениеЭлемента = НСтр("ka='Получен отказ из УТМ';ru='Получен отказ из УТМ'");
