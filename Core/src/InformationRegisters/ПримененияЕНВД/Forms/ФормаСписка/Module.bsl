...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Запрос.Выполнить().Пустой() Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='მშეგ-ის გამოყენება გათვალისწინებულია, თუ საცალო საწყობები შემოღებულია';ru='Применение ЕНВД предусмотрено, если заведены розничные склады'");
	КонецЕсли;
