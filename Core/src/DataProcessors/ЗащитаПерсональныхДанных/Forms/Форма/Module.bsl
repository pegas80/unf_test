...
Процедура УстановитьУсловноеОформление()
	...
	СписокЗначений.Добавить(НСтр("ka='_$Session$_.AuthenticationError';ru='_$Session$_.AuthenticationError'"));
	СписокЗначений.Добавить(НСтр("ka='_$Access$_.AccessDenied';ru='_$Access$_.AccessDenied'"));
...
Функция ПрочитатьЖурнал(ОтборЖурналаНаКлиенте)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ka='პერსონალური მონაცემების დაცვა';ru='Защита персональных данных'");
