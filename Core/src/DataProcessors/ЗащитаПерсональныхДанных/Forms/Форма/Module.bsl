...
Процедура УстановитьУсловноеОформление()
	...
	СписокЗначений.Добавить(НСтр("ka='_$Session$_.AuthenticationError';ru='_$Session$_.AuthenticationError';en='_ $ Session $ _. AuthenticationError'"));
	СписокЗначений.Добавить(НСтр("ka='_$Access$_.AccessDenied';ru='_$Access$_.AccessDenied';en='_ $ Access $ _. AccessDenied'"));
...
Функция ПрочитатьЖурнал(ОтборЖурналаНаКлиенте)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ka='პერსონალური მონაცემების დაცვა';ru='Защита персональных данных';en='Protection of personal information'");
