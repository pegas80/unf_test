...
Процедура ПроверитьДублированиеМОЛ(Отказ = Ложь)
	...
	Если ЗначениеЗаполнено(КонтекстПечати.ПодписьМОЛ1)
		...
		ТекстСообщения = НСтр("ka='Совпадает подпись материально-ответственных лиц. Просьба исправить дублирование.';ru='Совпадает подпись материально-ответственных лиц. Просьба исправить дублирование.'");
