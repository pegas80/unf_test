	...
	Если Параметры.Множественный Тогда
		...
		Элементы.ВидОперацииВходящие.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Вид операции поступлений (%1 %2)';ru='Вид операции поступлений (%1 %2)';en='Transaction Type revenue (% 1% 2)'"),
				КоличествоВходящих,
		...
		Элементы.ВидОперацииИсходящие.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Вид операции списаний (%1 %2)';ru='Вид операции списаний (%1 %2)';en='Write-type operations (% 1% 2)'"),
				КоличествоИсходящих,
				ПодобратьСловоПодЧисло(
					КоличествоИсходящих,
					НСтр("ka='документ';ru='документ';en='document'"),
