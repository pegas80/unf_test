	...
	Если Параметры.Множественный Тогда
		...
		Элементы.КорреспонденцияВходящие.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Корр. счет учета поступлений (%1 %2)';ru='Корр. счет учета поступлений (%1 %2)';en='Corr. by taking into account receipts (% 1% 2)'"),
				КоличествоВходящих,
				ПодобратьСловоПодЧисло(
					КоличествоВходящих,
					НСтр("ka='документ';ru='документ';en='document'"),
					НСтр("ka='დოკუმენტი:';ru='документа';en='document'"),
					НСтр("ka='документов';ru='документов';en='documents'")));
			
		Элементы.КорреспонденцияИсходящие.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Корр. счет учета списаний (%1 %2)';ru='Корр. счет учета списаний (%1 %2)';en='Corr. by taking into account offs (% 1% 2)'"),
				КоличествоИсходящих,
				ПодобратьСловоПодЧисло(
					КоличествоИсходящих,
					НСтр("ka='документ';ru='документ';en='document'"),
