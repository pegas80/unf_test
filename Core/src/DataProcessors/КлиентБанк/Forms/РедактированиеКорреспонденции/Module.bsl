	...
	Если Параметры.Множественный Тогда
		...
		Элементы.КорреспонденцияВходящие.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Корр. счет учета поступлений (%1 %2)';ru='Корр. счет учета поступлений (%1 %2)'"),
				КоличествоВходящих,
				ПодобратьСловоПодЧисло(
					КоличествоВходящих,
					НСтр("ka='документ';ru='документ'"),
					НСтр("ka='დოკუმენტი:';ru='документа'"),
					НСтр("ka='документов';ru='документов'")));
			
		Элементы.КорреспонденцияИсходящие.Заголовок = 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Корр. счет учета списаний (%1 %2)';ru='Корр. счет учета списаний (%1 %2)'"),
				КоличествоИсходящих,
				ПодобратьСловоПодЧисло(
					КоличествоИсходящих,
					НСтр("ka='документ';ru='документ'"),
