...
Процедура ВыполнитьЗакрытиеМесяца(СтруктураПараметров, ФоновоеЗаданиеАдресХранилища = "") Экспорт
	...
	Если СтруктураПараметров.ВыполнитьРасчетАмортизации Тогда
		...
		Иначе
			...
			ДокОбъект.Комментарий = НСтр("ka='#Создан автоматически, помощником закрытия месяца.';ru='#Создан автоматически, помощником закрытия месяца.'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ka='თვის დახურვა';ru='Закрытие месяца'");
	...
	Дело.Важное			= Истина;
	Дело.Представление	= НСтр("ka='Выполнить закрытие месяца';ru='Выполнить закрытие месяца'");
	...
	Дело.Подсказка		= НСтр("ka='Закрытие месяца необходимо выполнить для окончательного расчета себестоимости, финансового результата и курсовых разниц';ru='Закрытие месяца необходимо выполнить для окончательного расчета себестоимости, финансового результата и курсовых разниц'");
