...
Процедура ВыполнитьЗакрытиеМесяца(СтруктураПараметров, ФоновоеЗаданиеАдресХранилища = "") Экспорт
	...
	Если СтруктураПараметров.ВыполнитьРасчетАмортизации Тогда
		...
		Иначе
			...
			ДокОбъект.Комментарий = НСтр("ka='#Создан автоматически, помощником закрытия месяца.';ru='#Создан автоматически, помощником закрытия месяца.';en='# Created automatically, closing the assistant month.'");
