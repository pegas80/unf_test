...
Процедура ВыполнитьЗакрытиеМесяцаВДлительнойОперации(СтруктураПараметровФоновогоЗадания)
	...
	НСтр("ka='Выполняется закрытие месяца';ru='Выполняется закрытие месяца'")
	);
...
Процедура ПредупредитьОАктивномФоновомЗадании(Отказ = Истина)
	...
	Отказ = Истина;
	ТекстПредупреждения = НСтр("ka='Дождитесь окончания рабочего процесса (рекомендуется) либо прервите его самостоятельно.';ru='Дождитесь окончания рабочего процесса (рекомендуется) либо прервите его самостоятельно.'");
	...
	Для Сч = 1 По 12 Цикл
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаРаспределениеЗатрат" + Сч]) Тогда
			Если Элементы.Найти("РаспределениеЗатратКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРаспределениеЗатрат" + Сч] = НСтр("ka='Распределение затрат выполнено успешно!';ru='Распределение затрат выполнено успешно!'");
			...
			ИначеЕсли Элементы.Найти("РаспределениеЗатратКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРаспределениеЗатрат" + Сч] = НСтр("ka='Распределение затрат не требуется.';ru='Распределение затрат не требуется.'");
			ИначеЕсли Элементы.Найти("РаспределениеЗатратКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРаспределениеЗатрат" + Сч] = НСтр("ka='Распределение затрат не производилось.';ru='Распределение затрат не производилось.'");
			ИначеЕсли Элементы.Найти("РаспределениеЗатратКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРаспределениеЗатрат" + Сч] = НСтр("ka='Требуется выполнить распределение затрат.';ru='Требуется выполнить распределение затрат.'");
			КонецЕсли;
		Иначе
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаРасчетПрямыхЗатрат" + Сч]) Тогда
			Если Элементы.Найти("РасчетПрямыхЗатратКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетПрямыхЗатрат" + Сч] = НСтр("ka='Расчет прямых затрат выполнен успешно!';ru='Расчет прямых затрат выполнен успешно!'");
				МесяцЗакрыт = Истина; // месяц закрыт, если распределение выполнено успешно
			ИначеЕсли Элементы.Найти("РасчетПрямыхЗатратКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетПрямыхЗатрат" + Сч] = НСтр("ka='Расчет прямых затрат не требуется.';ru='Расчет прямых затрат не требуется.'");
			ИначеЕсли Элементы.Найти("РасчетПрямыхЗатратКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетПрямыхЗатрат" + Сч] = НСтр("ka='Расчет прямых затрат не производился.';ru='Расчет прямых затрат не производился.'");
			ИначеЕсли Элементы.Найти("РасчетПрямыхЗатратКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетПрямыхЗатрат" + Сч] = НСтр("ka='Требуется выполнить расчет прямых затрат.';ru='Требуется выполнить расчет прямых затрат.'");
			КонецЕсли;
		Иначе
			МесяцЗакрыт = Истина; // месяц закрыт, если есть ошибки
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаРасчетФактическойСебестоимости" + Сч]) Тогда
			Если Элементы.Найти("РасчетФактическойСебестоимостиКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФактическойСебестоимости" + Сч] = НСтр("ka='Расчет фактической себестоимости выполнен успешно!';ru='Расчет фактической себестоимости выполнен успешно!'");
				МесяцЗакрыт = Истина; // месяц закрыт, если распределение выполнено успешно
			ИначеЕсли Элементы.Найти("РасчетФактическойСебестоимостиКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФактическойСебестоимости" + Сч] = НСтр("ka='Расчет фактической себестоимости не требуется.';ru='Расчет фактической себестоимости не требуется.'");
			ИначеЕсли Элементы.Найти("РасчетФактическойСебестоимостиКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФактическойСебестоимости" + Сч] = НСтр("ka='Расчет фактической себестоимости не производился.';ru='Расчет фактической себестоимости не производился.'");
			ИначеЕсли Элементы.Найти("РасчетФактическойСебестоимостиКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФактическойСебестоимости" + Сч] = НСтр("ka='Требуется выполнить расчет фактической себестоимости.';ru='Требуется выполнить расчет фактической себестоимости.'");
			КонецЕсли;
		Иначе
			МесяцЗакрыт = Истина; // месяц закрыт, если есть ошибки
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаРасчетФинансовогоРезультата" + Сч]) Тогда
			Если Элементы.Найти("РасчетФинансовогоРезультатаКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФинансовогоРезультата" + Сч] = НСтр("ka='Расчет финансового результата выполнен успешно!';ru='Расчет финансового результата выполнен успешно!'");
				МесяцЗакрыт = Истина; // месяц закрыт, если распределение выполнено успешно
			ИначеЕсли Элементы.Найти("РасчетФинансовогоРезультатаКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФинансовогоРезультата" + Сч] = НСтр("ka='Расчет финансового результата не требуется.';ru='Расчет финансового результата не требуется.'");
			ИначеЕсли Элементы.Найти("РасчетФинансовогоРезультатаКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФинансовогоРезультата" + Сч] = НСтр("ka='Расчет финансового результата не производился.';ru='Расчет финансового результата не производился.'");
			ИначеЕсли Элементы.Найти("РасчетФинансовогоРезультатаКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетФинансовогоРезультата" + Сч] = НСтр("ka='Требуется выполнить расчет финансового результата.';ru='Требуется выполнить расчет финансового результата.'");
			КонецЕсли;
		Иначе
			МесяцЗакрыт = Истина; // месяц закрыт, если есть ошибки
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаРасчетКурсовыхРазниц" + Сч]) Тогда
			Если Элементы.Найти("РасчетКурсовыхРазницКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетКурсовыхРазниц" + Сч] = НСтр("ka='Расчет курсовых разниц выполнен успешно!';ru='Расчет курсовых разниц выполнен успешно!'");
				МесяцЗакрыт = Истина; // месяц закрыт, если распределение выполнено успешно
			ИначеЕсли Элементы.Найти("РасчетКурсовыхРазницКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетКурсовыхРазниц" + Сч] = НСтр("ka='Расчет курсовых разниц не требуется.';ru='Расчет курсовых разниц не требуется.'");
			ИначеЕсли Элементы.Найти("РасчетКурсовыхРазницКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетКурсовыхРазниц" + Сч] = НСтр("ka='Расчет курсовых разниц не производился.';ru='Расчет курсовых разниц не производился.'");
			ИначеЕсли Элементы.Найти("РасчетКурсовыхРазницКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетКурсовыхРазниц" + Сч] = НСтр("ka='Требуется выполнить расчет курсовых разниц.';ru='Требуется выполнить расчет курсовых разниц.'");
			КонецЕсли;
		Иначе
			МесяцЗакрыт = Истина; // месяц закрыт, если есть ошибки
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаРасчетСебестоимостиВРознице" + Сч]) Тогда
			Если Элементы.Найти("РасчетСебестоимостиВРозницеКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетСебестоимостиВРознице" + Сч] = НСтр("ka='Расчет себестоимости в рознице (суммовой учет) выполнен успешно!';ru='Расчет себестоимости в рознице (суммовой учет) выполнен успешно!'");
				МесяцЗакрыт = Истина; // месяц закрыт, если распределение выполнено успешно
			ИначеЕсли Элементы.Найти("РасчетСебестоимостиВРозницеКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетСебестоимостиВРознице" + Сч] = НСтр("ka='Расчет себестоимости в рознице (суммовой учет) не требуется.';ru='Расчет себестоимости в рознице (суммовой учет) не требуется.'");
			ИначеЕсли Элементы.Найти("РасчетСебестоимостиВРозницеКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетСебестоимостиВРознице" + Сч] = НСтр("ka='Расчет себестоимости в рознице (суммовой учет) не производился.';ru='Расчет себестоимости в рознице (суммовой учет) не производился.'");
			ИначеЕсли Элементы.Найти("РасчетСебестоимостиВРозницеКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаРасчетСебестоимостиВРознице" + Сч] = НСтр("ka='Требуется выполнить расчет себестоимости в рознице (суммовой учет).';ru='Требуется выполнить расчет себестоимости в рознице (суммовой учет).'");
			КонецЕсли;
		Иначе
			МесяцЗакрыт = Истина; // месяц закрыт, если есть ошибки
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ЭтаФорма["ТекстОшибкаНачислениеАмортизации" + Сч]) Тогда
			Если Элементы.Найти("НачислениеАмортизацииКартинка" + Сч).Картинка = Элементы.Зеленый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаНачислениеАмортизации" + Сч] = НСтр("ka='Начисление амортизации выполнено успешно!';ru='Начисление амортизации выполнено успешно!'");
				МесяцЗакрыт = Истина; // месяц закрыт, если распределение выполнено успешно
			ИначеЕсли Элементы.Найти("НачислениеАмортизацииКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка Тогда
				ЭтаФорма["ТекстОшибкаНачислениеАмортизации" + Сч] = НСтр("ka='Начисление амортизации не требуется.';ru='Начисление амортизации не требуется.'");
			ИначеЕсли Элементы.Найти("НачислениеАмортизацииКартинка" + Сч).Картинка = Элементы.Серый.Картинка Тогда
				ЭтаФорма["ТекстОшибкаНачислениеАмортизации" + Сч] = НСтр("ka='Начисление амортизации не производилось.';ru='Начисление амортизации не производилось.'");
			ИначеЕсли Элементы.Найти("НачислениеАмортизацииКартинка" + Сч).Картинка = Элементы.Красный.Картинка Тогда
				ЭтаФорма["ТекстОшибкаНачислениеАмортизации" + Сч] = НСтр("ka='Требуется выполнить начисление амортизации.';ru='Требуется выполнить начисление амортизации.'");
			КонецЕсли;
		Иначе
			МесяцЗакрыт = Истина; // месяц закрыт, если есть ошибки
		КонецЕсли;
		...
		Если Элементы.Найти("РаспределениеЗатратКартинка" + Сч).Картинка = Элементы.ЗеленыйНеТребуется.Картинка
			...
			Элементы.Найти("ДекорацияВыполнятьЗакрытиеНеТребуется" + Сч).Заголовок = НСтр("ka='Закрытие месяца не требуется, т.к. нет данных для расчета.';ru='Закрытие месяца не требуется, т.к. нет данных для расчета.'");
		Иначе
...
Процедура ВыполнитьЗакрытиеМесяца(Команда)
	...
	Если КонецМесяца(Дата(ТекГод, ТекМесяц, 1)) <= КонецДня(ДатаЗапретаРедактирования) Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ka='Нельзя закрыть месяц, т.к. он относится к запрещенному для редактирования периоду!';ru='Нельзя закрыть месяц, т.к. он относится к запрещенному для редактирования периоду!'"));
		Возврат;
	КонецЕсли;
