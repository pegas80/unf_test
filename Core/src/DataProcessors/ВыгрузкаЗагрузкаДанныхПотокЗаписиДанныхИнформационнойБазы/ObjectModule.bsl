...
Процедура ЗаписатьОбъектДанныхИнформационнойБазы(Объект, Артефакты) Экспорт
	...
	Исключение
		...
		ВызватьИсключение СтрШаблон(НСтр("ka='При выгрузке объекта %1 произошла ошибка: %2';ru='При выгрузке объекта %1 произошла ошибка: %2';en='When unloading the object% 1 An error occurred:% 2'"),
			Объект,
