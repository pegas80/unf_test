...
#КонецЕсли
	...
	ДиалогОткрытияФайла.Фильтр = НСтр("ka='გარე დამუშავება';ru='Внешняя обработка'") + "(*.epf)|*.epf";
	ДиалогОткрытияФайла.МножественныйВыбор = Ложь;
	ДиалогОткрытияФайла.Заголовок = НСтр("ka='Выберите внешнюю обработку';ru='Выберите внешнюю обработку'");
