...
"Правильный формат - ""ЧислоПотоковОбновления=Х"", где ""Х"" - максимальное количество потоков обновления.'");
	...
	Если ТолькоОбновлениеПараметровРаботыПрограммы Тогда
		Заголовок = НСтр("ka='Обновление параметров работы программы';ru='Обновление параметров работы программы'");
	...
	ИначеЕсли РежимОбновленияДанных = "НачальноеЗаполнение" Тогда
		Заголовок = НСтр("ka='Начальное заполнение данных';ru='Начальное заполнение данных'");
	...
	ИначеЕсли РежимОбновленияДанных = "ПереходСДругойПрограммы" Тогда
		Заголовок = НСтр("ka='Переход с другой программы';ru='Переход с другой программы'");
	...
	Иначе
		Заголовок = НСтр("ka='პროგრამის ვერსიის განახლება';ru='Обновление версии программы'");
...
Функция ЗагрузитьОбновитьПараметрыРаботыПрограммыВФоне()
	...
	ПараметрыОперации.НаименованиеФоновогоЗадания = НСтр("ka='პროგრამის პარამეტრების ფონის განახლება';ru='Фоновое обновление параметров работы программы'");
...
Процедура ЗавершитьОбновлениеПараметровРаботыПрограммы(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат = Неопределено Или Результат.Статус = "Отменено" Тогда
		...
		КраткоеСообщениеОбОшибке = НСтр("ka='შეცდომა ფონური სამუსაოების შედეგის მიღებისას პროგრამის პარამეტრების განახლების დროს.';ru='Ошибка получения результата от фонового задания при обновлении параметров работы программы.'");
...
Функция ЗапускЗадания()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ka='Фоновая регистрация данных отложенного обновления';ru='Фоновая регистрация данных отложенного обновления'");
