...
Процедура УстановитьПометкуСтрокДерева(Пометка, Знач ТекКолонка)
	...
	Иначе
		...
		ПоказатьПредупреждение(,СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Для установки или снятия меток по требуемой колонке%1предварительно активизируйте колонку.';ru='Для установки или снятия меток по требуемой колонке%1предварительно активизируйте колонку.';en='To install or remove the labels the desired column 1predvaritelno% activate column.'"), Символы.ПС));
