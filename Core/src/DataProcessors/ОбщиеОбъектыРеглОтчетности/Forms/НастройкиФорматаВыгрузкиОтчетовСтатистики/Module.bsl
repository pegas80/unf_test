...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		Если Не ЗначениеЗаполнено(Организация) Тогда
			ПоказатьПредупреждение(,НСтр("ka='Не указана организация, настройки формата выгрузки статистических отчетов не сохранены.';ru='Не указана организация, настройки формата выгрузки статистических отчетов не сохранены.';en='Not specified organization, format settings unloading statistical reports are not saved.'"));
			Возврат;
		КонецЕсли;
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='Настройки были изменены. Сохранить изменения?';ru='Настройки были изменены. Сохранить изменения?';en='Settings have been changed. I save changes?'"), РежимДиалогаВопрос.ДаНетОтмена);
