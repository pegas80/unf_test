...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		Если Не ЗначениеЗаполнено(Организация) Тогда
			ПоказатьПредупреждение(,НСтр("ka='Не указана организация, настройки формата выгрузки статистических отчетов не сохранены.';ru='Не указана организация, настройки формата выгрузки статистических отчетов не сохранены.'"));
			Возврат;
		КонецЕсли;
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='Настройки были изменены. Сохранить изменения?';ru='Настройки были изменены. Сохранить изменения?'"), РежимДиалогаВопрос.ДаНетОтмена);
