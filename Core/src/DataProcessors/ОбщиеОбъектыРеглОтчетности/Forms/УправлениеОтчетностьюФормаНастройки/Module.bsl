...
"иначе измененные настройки будут утеряны.';ka='Настройки были изменены."
"Перед завершением работы рекомендуется их сохранить,"
"иначе измененные настройки будут утеряны.'");
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='Сохранить настройки?';ru='Сохранить настройки?';en='Save settings?'"), РежимДиалогаВопрос.ДаНетОтмена);
