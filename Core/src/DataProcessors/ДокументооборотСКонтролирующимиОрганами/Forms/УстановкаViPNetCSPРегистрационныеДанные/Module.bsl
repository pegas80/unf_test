...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(ЭлектроннаяПочта)
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Некорректно заполнен адрес электронной почты.';ru='Некорректно заполнен адрес электронной почты.';en='Correctly filled email address.'"),, "ЭлектроннаяПочта",, Отказ);
	КонецЕсли;
