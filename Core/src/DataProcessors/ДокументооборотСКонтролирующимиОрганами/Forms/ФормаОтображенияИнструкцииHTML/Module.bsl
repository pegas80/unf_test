...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Не задана инструкция для показа пользователю';ru='Не задана инструкция для показа пользователю'"));
	КонецЕсли;
КонецПроцедуры
