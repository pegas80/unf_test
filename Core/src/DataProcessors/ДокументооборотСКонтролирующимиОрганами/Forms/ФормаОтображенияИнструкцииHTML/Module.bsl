...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Не задана инструкция для показа пользователю';ru='Не задана инструкция для показа пользователю';en='Is not set to display the user manual'"));
	КонецЕсли;
КонецПроцедуры
