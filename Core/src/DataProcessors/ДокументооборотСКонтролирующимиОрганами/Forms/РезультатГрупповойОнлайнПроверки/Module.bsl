...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТаблицаСРезультатами.Количество() = 1 И Параметры.РежимПоказаДляОдиночногоДокументаРазрешен Тогда
		Заголовок = НСтр("ka='შემოწმება';ru='Проверка'") + ": " + ТаблицаСРезультатами[0].ПредставлениеДокумента;
...
Процедура ЗаполнитьСоответствие(ПоддержкаСервисаОнлайнПроверкиВУниверсальномФормате = Ложь)
	...
	Если ПредставлениеРезультатовПроверки = Неопределено Тогда
		...
		Если ПоддержкаСервисаОнлайнПроверкиВУниверсальномФормате <> Истина Тогда
			...
			ПредставлениеРезультатовПроверки.Вставить("-1",	НСтр("ka='უცნობი შეცდომა';ru='Неизвестная ошибка'"));
			ПредставлениеРезультатовПроверки.Вставить("0",	НСтр("ka='Ошибок не обнаружено';ru='Ошибок не обнаружено'"));
			ПредставлениеРезультатовПроверки.Вставить("1",	НСтр("ka='Ошибка расшифровки';ru='Ошибка расшифровки'"));
			ПредставлениеРезультатовПроверки.Вставить("2",	НСтр("ka='Неизвестный формат';ru='Неизвестный формат'"));
			ПредставлениеРезультатовПроверки.Вставить("3",	НСтр("ka='Файл отчета поврежден';ru='Файл отчета поврежден'"));
			ПредставлениеРезультатовПроверки.Вставить("4",	НСтр("ka='Обнаружены ошибки';ru='Обнаружены ошибки'"));
			ПредставлениеРезультатовПроверки.Вставить("5",	НСтр("ka='Проверка не выполнена';ru='Проверка не выполнена'"));
			ПредставлениеРезультатовПроверки.Вставить("6",	НСтр("ka='Обнаружены ошибки';ru='Обнаружены ошибки'"));
		...
		Иначе
			...
			ПредставлениеРезультатовПроверки.Вставить("0",	НСтр("ka='Ошибок не обнаружено';ru='Ошибок не обнаружено'"));
			ПредставлениеРезультатовПроверки.Вставить("1",	НСтр("ka='Ошибка расшифровки';ru='Ошибка расшифровки'"));
			ПредставлениеРезультатовПроверки.Вставить("2",	НСтр("ka='Неизвестный формат или файл поврежден';ru='Неизвестный формат или файл поврежден'"));
			ПредставлениеРезультатовПроверки.Вставить("3",	НСтр("ka='Обнаружены ошибки';ru='Обнаружены ошибки'"));
			ПредставлениеРезультатовПроверки.Вставить("4",	НСтр("ka='არის გაფრთხილებები';ru='Есть предупреждения'"));
