...
Функция ЗафиксироватьПривязкуВБД(Организация, НоваяУчетнаяЗапись, ТекстПредупреждения)
	...
	Исключение
		...
		НСтр("ka='Не удалось сопоставить вновь созданную учетной запись организации:%1';ru='Не удалось сопоставить вновь созданную учетной запись организации:%1';en='Failed to associate the newly created organization Account:% 1'"),
