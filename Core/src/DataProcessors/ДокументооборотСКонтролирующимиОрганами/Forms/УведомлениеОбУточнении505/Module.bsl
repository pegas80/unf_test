...
"%1'"),
	...
	Если НЕ ЗначениеЗаполнено(УзелФайл) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""Файл"".';ru='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""Файл"".';en='Incorrect structure of the XML notification of clarification: not detected node ""File"".'"),,,, Отказ);
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(УзелДокумент) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""Документ"".';ru='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""Документ"".';en='Incorrect structure of the XML notification of clarification: not detected node ""document"".'"),,,, Отказ);
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(УзелСведУвед) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""СведУвед"".';ru='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""СведУвед"".';en='Incorrect structure of the XML notification of clarification: not found ""SvedUved"" node.'"),,,, Отказ);
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(УзелОбщСвУвед) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""ОбщСвУвед"".';ru='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""ОбщСвУвед"".';en='Incorrect structure of the XML notification of clarification: not found ""ObschSvUved"" node.'"),,,, Отказ);
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(УзелВыявлОшФайл) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""ВыявлОшФайл"".';ru='Некорректная структура XML уведомления об уточнении: не обнаружен узел ""ВыявлОшФайл"".';en='Incorrect structure of the XML notification of clarification: not found ""VyyavlOshFayl"" node.'"),,,, Отказ);
		Возврат;
	КонецЕсли;
