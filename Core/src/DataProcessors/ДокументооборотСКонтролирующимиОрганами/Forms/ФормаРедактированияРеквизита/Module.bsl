...
Процедура КнопкаОК(Команда)
	...
	Если ИмяРеквизита = "КодРосстата" Тогда
		...
		Если СтрДлина(СокрЛП(ЗначениеРеквизита))<> 5 Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Код органа Росстата должен состоять из 4 цифр';ru='Код органа Росстата должен состоять из 4 цифр'"), ,"ЗначениеРеквизита");
