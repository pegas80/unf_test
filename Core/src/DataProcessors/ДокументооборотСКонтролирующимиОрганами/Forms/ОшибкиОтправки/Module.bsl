...
Процедура УстановитьЗаголовок(Параметры)
	...
	Если ЭтоРасшифровка Тогда
	    Заголовок = НСтр("ka='Ошибки расшифровки';ru='Ошибки расшифровки'");
	ИначеЕсли ЭтоОбмен Тогда
		Заголовок = НСтр("ka='Ошибки обновления';ru='Ошибки обновления'");
...
Процедура ВывестиНадписьПроОшибки(МассивОшибок)
	...
	Если ЭтоРасшифровка Тогда
		Надпись = НСтр("ka='Обратите внимание, при расшифровке возникли следующие ошибки:';ru='Обратите внимание, при расшифровке возникли следующие ошибки:'");
	ИначеЕсли ЭтоОбмен Тогда
		Надпись = НСтр("ka='Обратите внимание, при обновлении возникли следующие ошибки:';ru='Обратите внимание, при обновлении возникли следующие ошибки:'");
	ИначеЕсли ЭтоОтправка Тогда
		Надпись = НСтр("ka='Возникли следующие ошибки:';ru='Возникли следующие ошибки:'");
	Иначе
		Надпись = НСтр("ka='Обратите внимание, при обновлении возникли следующие ошибки:';ru='Обратите внимание, при обновлении возникли следующие ошибки:'");
	КонецЕсли;
