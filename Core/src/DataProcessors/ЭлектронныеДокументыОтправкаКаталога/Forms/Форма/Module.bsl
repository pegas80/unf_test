...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ИдентификаторФормы")
		...
		ТекстИсключения = НСтр("ka='Данная обработка предназначена для вызова из ""Настройки ЭДО""."
"Вызывать ее вручную запрещено.';ru='Данная обработка предназначена для вызова из ""Настройки ЭДО""."
...
"Продолжить?';ka='Подобранные товары отправлены не будут. "
"Продолжить?'");
...
Процедура ЗаполнитьТаблицуТоваров(Команда)
	...
	Если Объект.Товары.Количество() > 0 Тогда
		ТекстВопроса = НСтр("ka='Таблица товаров будет перезаполнена. Продолжить?';ru='Таблица товаров будет перезаполнена. Продолжить?';en='Table products will be refilled. Proceed?'");
