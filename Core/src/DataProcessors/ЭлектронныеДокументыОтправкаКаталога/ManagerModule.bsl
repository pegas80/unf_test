...
Процедура УстановитьОтборПоТипуЦен(Компоновщик)
	...
	Если НЕ ОтборТипЦен.Использование
		...
		Если ОтборТипЦен.Использование Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(Нстр("ka='Возможен отбор только по одному типу цен. Информация о ценах номенклатуры не заполнена.';ru='Возможен отбор только по одному типу цен. Информация о ценах номенклатуры не заполнена.';en='Possible selection of only one type of price. Information on the range of prices is not filled.'"));
		КонецЕсли;
