...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(МассивЭлементов) <> Тип("Массив") Тогда
		ВызватьИсключение НСтр("ka='В форму создания номенклатуры переданы некорректные параметры.';ru='В форму создания номенклатуры переданы некорректные параметры.'");
	КонецЕсли;
	...
	ЗаголовокКоманды = НСтр("ka='Создать номенклатуру (%КоличествоЭлементов%)';ru='Создать номенклатуру (%КоличествоЭлементов%)'");
