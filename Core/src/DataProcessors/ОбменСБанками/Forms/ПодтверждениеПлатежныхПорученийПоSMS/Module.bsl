...
Процедура КомандаПодтвердить(Команда)
	...
	Если ПустаяСтрока(Пароль) Тогда
		ТекстСообщения = НСтр("ka='Для продолжения необходимо указать код подтверждения.';ru='Для продолжения необходимо указать код подтверждения.';en='To continue, you must specify the confirmation code.'");
