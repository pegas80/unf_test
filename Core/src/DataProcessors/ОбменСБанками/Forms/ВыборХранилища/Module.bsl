...
Процедура Готово(Команда)
	...
	Если Не ЗначениеЗаполнено(ИдентификаторХранилища) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Не выбрано аппаратное устройство.';ru='Не выбрано аппаратное устройство.';en='Unspecified hardware device.'"), , "ИдентификаторХранилища");
		Возврат;
	КонецЕсли;
