...
Процедура ПриОткрытии(Отказ)
	...
	Если КоличествоЭлементов = 0 Тогда
		Отказ = Истина;
		ПоказатьПредупреждение(, НСтр("ka='Не установлен сканер. Обратитесь к администратору программы.';ru='Не установлен сканер. Обратитесь к администратору программы.'"));
	Иначе
...
Процедура ВыбратьСканер(Команда)
	...
	Если ПустаяСтрока(ИмяУстройства) Тогда
		ТекстСообщения = НСтр("ka='Не выбран сканер.';ru='Не выбран сканер.'");
