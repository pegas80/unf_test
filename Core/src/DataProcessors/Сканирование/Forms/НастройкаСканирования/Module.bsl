...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ИспользоватьImageMagickДляПреобразованияВPDF Тогда
		Элементы.ФорматСканированногоИзображения.Заголовок = НСтр("ka='ფორმატი';ru='Формат';en='Format'");
	Иначе
		Элементы.ФорматСканированногоИзображения.Заголовок = НСтр("ka='ტიპი';ru='Тип';en='Type of'");
	КонецЕсли;
...
Процедура ПутьКПрограммеКонвертацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Фильтр = НСтр("ka='Исполняемые файлы(*.exe)|*.exe';ru='Исполняемые файлы(*.exe)|*.exe';en='Executable files (* exe.) | * .Exe'");
	ДиалогОткрытияФайла.Фильтр = Фильтр;
	ДиалогОткрытияФайла.МножественныйВыбор = Ложь;
	ДиалогОткрытияФайла.Заголовок = НСтр("ka='Выберите файл для преобразования в PDF';ru='Выберите файл для преобразования в PDF';en='Select a file to convert to PDF'");
...
Процедура ПрочитатьНастройкиСканера()
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ka='Идет сбор сведений о сканере ""%1""...';ru='Идет сбор сведений о сканере ""%1""...';en='Gathering information about your scanner ""%1"" ...'"), ИмяУстройства);
