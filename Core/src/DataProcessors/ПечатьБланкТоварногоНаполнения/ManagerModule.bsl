...
Функция ПредставлениеПФ() Экспорт
	...
	Возврат НСтр("ka='სასაქონლო შევსების ბლანკი';ru='Бланк товарного наполнения';en='commodity form filling'");
...
Функция СформироватьПФ(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати) Экспорт
	...
	Для каждого ДанныеОбъекта Из ДанныеОбъектовПечати Цикл
		...
		ДанныеОбъекта.ПредставлениеРегистратора = НСтр("ka='მარაგების ჩამოწერა';ru='Списание запасов';en='Write-off stocks'");
		Текст = НСтр("ka=' ';ru=' от '");
		...
		Если ОбластьМакета <> Неопределено
			...
			Если ЕстьТЧЗапасы Тогда
				...
				ДанныеПечати.Вставить("ТипНоменклатурыТаблицы", Нстр("ka='მარაგები';ru='Запасы';en='Stocks'"));
			...
			Если ЕстьТЧМатериалы Тогда
				...
				ДанныеПечати.Вставить("ТипНоменклатурыТаблицы", Нстр("ka='მასალები';ru='Материалы';en='materials'"));
				ОбластьМакетаШапка.Параметры.Заполнить(ДанныеПечати);
				ТабличныйДокумент.Вывести(ОбластьМакетаШапка);
