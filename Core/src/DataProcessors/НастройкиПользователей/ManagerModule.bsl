...
Функция НастройкиВсехФорм(ИмяПользователя)
	...
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventsJournal", 
		НСтр("ka='Стандартные.Журнал регистрации';ru='Стандартные.Журнал регистрации';en='Standartnye.Zhurnal registration'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventForm", 
		НСтр("ka='Стандартные.Журнал регистрации, Событие';ru='Стандартные.Журнал регистрации, Событие';en='Standartnye.Zhurnal registration event'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventsJournalFilter", 
		НСтр("ka='Стандартные.Журнал регистрации, Настройка отбора событий';ru='Стандартные.Журнал регистрации, Настройка отбора событий';en='Standartnye.Zhurnal registration, selection of events Setting'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardFindByRef.Форма.MainForm", 
		НСтр("ka='Стандартные.Поиск ссылок на объект';ru='Стандартные.Поиск ссылок на объект';en='Standartnye.Poisk object references'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardFullTextSearchManagement.Форма.MainForm", 
		НСтр("ka='Стандартные.Управление полнотекстовым поиском';ru='Стандартные.Управление полнотекстовым поиском';en='Standartnye.Upravlenie full-text search'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardDocumentsPosting.Форма.MainForm", 
		НСтр("ka='Стандартные.Проведение документов';ru='Стандартные.Проведение документов';en='Standartnye.Provedenie documents'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardDeleteMarkedObjects.Форма.Form", 
		НСтр("ka='Стандартные.Удаление помеченных объектов';ru='Стандартные.Удаление помеченных объектов';en='Standartnye.Udalenie marked objects'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardExternalDataSourceManagement.Форма.Form", 
		НСтр("ka='Стандартные.Управление внешними источниками данных';ru='Стандартные.Управление внешними источниками данных';en='Standartnye.Upravlenie external data sources'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardTotalsManagement.Форма.MainForm", 
		НСтр("ka='Стандартные.Управление итогами';ru='Стандартные.Управление итогами';en='Standartnye.Upravlenie the outcome'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardActiveUsers.Форма.ActiveUsersListForm", 
		НСтр("ka='Стандартные.Активные пользователи';ru='Стандартные.Активные пользователи';en='Standartnye.Aktivnye users'") , Ложь, БиблиотекаКартинок.Форма);
...
Функция ФормыОбъектовМетаданных()
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.КритерииОтбора, "КритерийОтбора", НСтр("ka='Критерий отбора';ru='Критерий отбора';en='Selection bias'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.КритерийОтбора, СписокФорм);
		
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ХранилищаНастроек, "ХранилищеНастроек", НСтр("ka='გამართვების საცავი';ru='Хранилище настроек';en='Storage settings'"),
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Справочники, "Справочник", НСтр("ka='ცნობარი';ru='Справочник';en='Directory'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Документы, "Документ", НСтр("ka='დოკუმენტი';ru='Документ';en='Document'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Документ, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ЖурналыДокументов, "ЖурналДокументов", НСтр("ka='დოკუმენტების ჟურნალი';ru='Журнал документов';en='journal of documents'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.ЖурналДокументов, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Перечисления, "Перечисление", НСтр("ka='Перечисление';ru='Перечисление';en='enumeration'"),
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Отчеты, "Отчет", НСтр("ka='ანგარიშგება';ru='Отчет';en='Report'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Отчет, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Обработки, "Обработка", НСтр("ka='დამუშავება';ru='Обработка';en='Treatment'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбораГруппы");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовХарактеристик, "ПланВидовХарактеристик", НСтр("ka='მახასიათებლების ტიპების გეგმა';ru='План видов характеристик';en='Plans species'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыСчетов, "ПланСчетов", НСтр("ka='ანგარიშების გეგმა';ru='План счетов';en='Chart of accounts'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовРасчета, "ПланВидовРасчета", НСтр("ka='ანგარიშსწორების ტიპების გეგმა';ru='План видов расчета';en='Plan of calculation types'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.ПланВидовРасчета, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыСведений, "РегистрСведений", НСтр("ka='ცნობების რეგისტრი';ru='Регистр сведений';en='information register'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрСведений, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыНакопления, "РегистрНакопления", НСтр("ka='დაგროვების რეგისტრი';ru='Регистр накопления';en='accumulation register'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрНакопления, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыБухгалтерии, "РегистрБухгалтерии", НСтр("ka='ბუღალტერიის რეგისტრი';ru='Регистр бухгалтерии';en='accounts register'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрБухгалтерии, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыРасчета, "РегистрРасчета", НСтр("ka='ანგარიშსწორების რეგისტრი';ru='Регистр расчета';en='calculation register'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.БизнесПроцессы, "БизнесПроцесс", НСтр("ka='ბიზნეს-პროცესი';ru='Бизнес-процесс';en='Buisness process'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Задачи, "Задача", НСтр("ka='ამოცანა';ru='Задача';en='Task'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Задача, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ВнешниеИсточникиДанных, "ВнешнийИсточникДанных", НСтр("ka='Внешние источники данных';ru='Внешние источники данных';en='External data sources'"),
...
Процедура ДобавитьТипФормыВПредставление(Объект, Форма, ИмяФормы)
	...
	Если Форма = Объект.ОсновнаяФормаСписка Тогда
		ИмяФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1 (список)';ru='%1 (список)';en='% 1 (list)'"), ИмяФормы);
	ИначеЕсли Форма = Объект.ОсновнаяФормаДляВыбора Тогда
		ИмяФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1 (выбор)';ru='%1 (выбор)';en='1% (range)'"), ИмяФормы);
	ИначеЕсли Форма = Объект.ОсновнаяФормаГруппы Тогда
		ИмяФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1 (группа)';ru='%1 (группа)';en='1% (group)'"), ИмяФормы);
	КонецЕсли;
...
"Список пропущенных вариантов отчетов:';ka='Невозможно скопировать личные варианты отчетов."
"Для того чтобы личный вариант отчета стал доступен другим пользователям,"
"необходимо его пересохранить со снятой пометкой ""Только для автора""."
"Список пропущенных вариантов отчетов:'");
	...
	Если НеСкопированныеНастройкиОтчетов.Количество() <> 0 Тогда
		ОбластьЗаголовок = ТабМакет.ПолучитьОбласть("Заголовок");
		ОбластьЗаголовок.Параметры.Описание = 
			НСтр("ka='У следующих пользователей недостаточно прав на отчеты:';ru='У следующих пользователей недостаточно прав на отчеты:';en='In the following users are not allowed on the reports:'");
		ТабДок.Вывести(ОбластьЗаголовок);
...
Процедура ЗаполнитьСписокНастроекВнешнегоВида(Параметры)
	...
	Для Каждого НастройкаФормы Из НастройкиФорм Цикл
		...
		ИначеЕсли ПредставлениеОбъектаМетаданных[0] = НСтр("ka='სტანდარტულები';ru='Стандартные';en='standard'") Тогда
	...
	Настройка = НСтр("ka='საკომანდო ინტერფეისი და საწყისი გვერდი';ru='Командный интерфейс и начальная страница';en='Command interface and home page'");
...
Процедура ЗаполнитьСписокПрочихНастроек(Параметры)
	...
	Если Ключи.Количество() > 0 Тогда
		...
		Если Не ПустаяСтрока(Параметры.Поиск) Тогда
			Если СтрНайти(ВРег(НСтр("ka='პერსონალური პარამეტრები';ru='Персональные настройки';en='personal settings'")), ВРег(Параметры.Поиск)) = 0 Тогда
				ВыводитьНастройку = Ложь;
			КонецЕсли;
		КонецЕсли;
		
		Если ВыводитьНастройку Тогда
			Настройка = НСтр("ka='პერსონალური პარამეტრები';ru='Персональные настройки';en='personal settings'");
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("ka='Настройки печати табличных документов';ru='Настройки печати табличных документов';en='Configure the print spreadsheet documents'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если ЕстьНастройкиПечати
		...
		Настройка = НСтр("ka='Настройки печати табличных документов';ru='Настройки печати табличных документов';en='Configure the print spreadsheet documents'");
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("ka='Избранное';ru='Избранное';en='Избранное'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если ЕстьИзбранное
		...
		Настройка = НСтр("ka='Избранное';ru='Избранное';en='Избранное'");
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("ka='სხვა გამართვები';ru='Прочие настройки';en='Other settings'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если ПрочиеКлючи.Количество() <> 0
		И ВыводитьНастройку Тогда
		Настройка = НСтр("ka='სხვა გამართვები';ru='Прочие настройки';en='Other settings'");
		Картинка = БиблиотекаКартинок.ПрочиеПользовательскиеНастройки;
		ТипНастройки = "ПрочаяНастройка";
...
Процедура ДобавитьНастройкиРабочегоСтолаИКомандногоИнтерфейса(Параметры, ДеревоНастроек)
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		Если СтрНайти(ВРег(НСтр("ka='საკომანდო ინტერფეისი და საწყისი გვერდი';ru='Командный интерфейс и начальная страница';en='Command interface and home page'")), ВРег(Параметры.Поиск)) = 0 Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
	...
	Если КлючиВсехНастроек.Количество() > 0 Тогда
		...
		НоваяСтрокаИнтерфейса.Настройка = НСтр("ka='საკომანდო ინტერფეისი და საწყისი გვერდი';ru='Командный интерфейс и начальная страница';en='Command interface and home page'");
		НоваяСтрокаИнтерфейса.Картинка = БиблиотекаКартинок.Картинка;
		НоваяСтрокаИнтерфейса.ТипСтроки = НСтр("ka='საკომანდო ინტერფეისი და საწყისი გვერდი';ru='Командный интерфейс и начальная страница';en='Command interface and home page'");
	...
	Если КлючиНастроекРабочегоСтола.Количество() > 0 Тогда
		...
		НоваяПодстрокаИнтерфейса.Настройка = НСтр("ka='საწყისი გვერდი';ru='Начальная страница';en='start page'");
	...
	Если КлючиНастроекИнтерфейса.Количество() > 0 Тогда
		...
		НоваяПодстрокаИнтерфейса = НоваяСтрокаИнтерфейса.Строки.Добавить();
		НоваяПодстрокаИнтерфейса.Настройка = НСтр("ka='Командный интерфейс';ru='Командный интерфейс';en='commands interface'");
		НоваяПодстрокаИнтерфейса.Картинка = БиблиотекаКартинок.Картинка;
