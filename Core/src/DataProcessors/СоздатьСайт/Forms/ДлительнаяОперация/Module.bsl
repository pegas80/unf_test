...
Процедура Отменить(Команда)
	ТекстВопроса = НСтр("ka='Создание сайта еще не завершено.';ru='Создание сайта еще не завершено.'");
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить(1, НСтр("ka='Подождать еще';ru='Подождать еще'"));
...
Процедура ПриЗакрытииНаСервере()
	...
	Сообщить(НСтр("ka='Создание сайта прервано';ru='Создание сайта прервано'"));
