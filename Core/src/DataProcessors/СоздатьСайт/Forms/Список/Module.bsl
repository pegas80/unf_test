...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ТипСайта = 4 Тогда
			НадписьТипСайта = НСтр("ka='ინტერნეტ-მაღაზია';ru='Интернет-магазин';en='Shop Online'");
		ИначеЕсли Выборка.ТипСайта = 3 Тогда
			НадписьТипСайта = НСтр("ka='კომპანიის საიტი';ru='Сайт компании';en='The site of the company'");
		ИначеЕсли Выборка.ТипСайта = 2 Тогда
			НадписьТипСайта = НСтр("ka='Лендинг';ru='Лендинг';en='Landing'");
		ИначеЕсли Выборка.ТипСайта = 1 Тогда			
			НадписьТипСайта = НСтр("ka='Сайт специалиста';ru='Сайт специалиста';en='specialist website'");
		КонецЕсли;
