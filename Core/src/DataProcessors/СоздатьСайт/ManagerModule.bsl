...
Процедура ЗапуститьОбменССайтом(КодУзлаОбмена)
	...
	ОбменССайтом.ВыполнитьОбмен(УзелОбмена, НСтр("ka='Обмен полный при создании сайта';ru='Обмен полный при создании сайта';en='Exchange full when creating a site'"), Ложь);
