...
Процедура Инициализация() Экспорт
	...
	ТелоСообщенияПростое	= НСтр("ka='Сообщение обмена данными';ru='Сообщение обмена данными'");
	ТелоСообщенияСжатое	= НСтр("ka='Сжатое сообщение обмена данными';ru='Сжатое сообщение обмена данными'");
	ТелоСообщенияПакетное	= НСтр("ka='Пакетное сообщение обмена данными';ru='Пакетное сообщение обмена данными'");
...
Функция ПолучитьСообщениеОбмена()
	...
	Если ТаблицаСообщенийОбмена.Количество() = 0 Тогда
		...
		СтрокаСообщения = НСтр("ka='Не обнаружены письма с заголовком: ""%1""';ru='Не обнаружены письма с заголовком: ""%1""'");
...
Процедура ИнициализацияСообщенийОшибок()
	...
	// Общие коды ошибок
	СообщенияОшибок.Вставить(001, НСтр("ka='Не обнаружены сообщения обмена.';ru='Не обнаружены сообщения обмена.'"));
	...
	СообщенияОшибок.Вставить(006, НСтр("ka='Сообщение обмена не отправлено: превышен допустимый размер сообщения.';ru='Сообщение обмена не отправлено: превышен допустимый размер сообщения.'"));
	
	// Коды ошибок, зависящие от вида транспорта.
	СообщенияОшибок.Вставить(101, НСтр("ka='Ошибка инициализации: не указана учетная запись электронной почты транспорта сообщений обмена.';ru='Ошибка инициализации: не указана учетная запись электронной почты транспорта сообщений обмена.'"));
	СообщенияОшибок.Вставить(102, НСтр("ka='Ошибка при отправке сообщения электронной почты.';ru='Ошибка при отправке сообщения электронной почты.'"));
	СообщенияОшибок.Вставить(103, НСтр("ka='Ошибка при получении заголовков сообщений с сервера электронной почты.';ru='Ошибка при получении заголовков сообщений с сервера электронной почты.'"));
	СообщенияОшибок.Вставить(104, НСтр("ka='Не обнаружены сообщения обмена на почтовом сервере.';ru='Не обнаружены сообщения обмена на почтовом сервере.'"));
	СообщенияОшибок.Вставить(105, НСтр("ka='Ошибка при получении сообщения с сервера электронной почты.';ru='Ошибка при получении сообщения с сервера электронной почты.'"));
	СообщенияОшибок.Вставить(106, НСтр("ka='Ошибка при записи файла сообщения обмена на диск.';ru='Ошибка при записи файла сообщения обмена на диск.'"));
	СообщенияОшибок.Вставить(107, НСтр("ka='Проверка параметров учетной записи завершилась с ошибками.';ru='Проверка параметров учетной записи завершилась с ошибками.'"));
	...
	СообщенияОшибок.Вставить(109, НСтр("ka='Ошибка: в почтовом сообщении не найден файл с сообщением.';ru='Ошибка: в почтовом сообщении не найден файл с сообщением.'"));
