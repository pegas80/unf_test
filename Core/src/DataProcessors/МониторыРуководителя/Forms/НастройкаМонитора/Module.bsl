...
Процедура ДолгиПоляРасшифровкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='Отметьте выводимые колонки';ru='Отметьте выводимые колонки';en='Note outputted column'");
...
Процедура СохранитьНастройкиНаСервере()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("НастройкиДляМонитора", "СоставВиджетов", СоставВиджетов,
		НСтр("ka='Настройка состава виджетов монитора руководителя';ru='Настройка состава виджетов монитора руководителя';en='Setting composition monitor widget manager'"));
	...
	Для Каждого ЭлементСписка Из СоставВиджетов Цикл
		...
		ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("НастройкиДляМонитора", ИмяВиджета, НастройкаВиджета,
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Настройка виджета %1 монитора руководителя';ru='Настройка виджета %1 монитора руководителя';en='Configure the widget% 1 monitor head'"),
