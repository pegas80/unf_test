...
Процедура ЗапуститьФоновоеЗаданиеНаСервере()
	...
	НаименованиеЗадания = НСтр("ka='ნახლდება ხელმძღვანელის მონიტორის ვიჯეტები';ru='Обновление виджетов монитора руководителя';en='Update Monitor Widget manager'");
...
Процедура ОбновитьОтображениеВиджетов()
	...
	ФорматДатыПодсказки = НСтр("ka='Л=ka_GE;';ru='Л=ru_RU;';en='L = ru_RU;'") + "ДФ=dd.MM.yyyy";
	ФорматДатыТочки = НСтр("ka='Л=ka_GE;';ru='Л=ru_RU;';en='L = ru_RU;'") + "ДФ=d.MM";
	ФорматСуммы = НСтр("ka='Л=ka_GE;';ru='Л=ru_RU;';en='L = ru_RU;'") + " ЧДЦ=2; ЧРД=,; ЧН=0,00";
	ФорматКоличества = НСтр("ka='Л=ka_GE;';ru='Л=ru_RU;';en='L = ru_RU;'") + " ЧДЦ=; ЧН=0";
...
Процедура ОбновитьВиджетПродажи(ДанныеПродажи, НастройкаВиджета)
	...
	Если Выборка.Следующий() Тогда
		Элементы.ДанныеПродажи.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='გაყიდვები';ru='Продажи';en='the sale'"), Выборка.Выручка, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеПрибыль.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='მოგება';ru='Прибыль';en='Profit'"), Выборка.Прибыль, Истина, Выборка.ПредставлениеВалютыУчета);
	Иначе
		Элементы.ДанныеПродажи.Заголовок = "";
		Элементы.ДанныеПрибыль.Заголовок = "";
	КонецЕсли;
	Элементы.ДанныеРейтингТоваров.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='საქონლის რეიტინგი';ru='Рейтинг товаров';en='product ratings'"),
		НастройкаВиджета.ПервыеТовары, , НСтр("ka='საუკეთესოები';ru='лучших';en='best'"));
	Элементы.ДанныеРейтингМенеджеров.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='მენეჯერების რეიტინგი';ru='Рейтинг менеджеров';en='Rating managers'"),
		НастройкаВиджета.ПервыеМенеджеры, , НСтр("ka='საუკეთესოები';ru='лучших';en='best'"));
	...
	СерияСебестоимость = ДиаграммаПродажи.Серии.Добавить(НСтр("ka='თვითღირებულება';ru='Себестоимость';en='Cost price'"));
	СерияСебестоимость.Маркер = ТипМаркераДиаграммы.Круг;
	СерияСебестоимость.Индикатор = Истина;
	СерияВаловаяПрибыль = ДиаграммаПродажи.Серии.Добавить(НСтр("ka='საერთო მოგება';ru='Валовая прибыль';en='Gross profit'"));
	СерияВаловаяПрибыль.Маркер = ТипМаркераДиаграммы.Круг;
	СерияВыручка = ДиаграммаПродажи.Серии.Добавить(НСтр("ka='შემოსავალი';ru='Выручка';en='revenue'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='მოგება: %1 на %2';ru='Выручка: %1 на %2';en='Revenue:% 1% 2'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='თვითღირებულება: %1 на %2';ru='Себестоимость: %1 на %2';en='Cost: 1% to 2%'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='საერთო მოგება: %1 на %2';ru='Валовая прибыль: %1 на %2';en='Gross profit:% 1% 2'"),
	...
	Пока ВыборкаПериод.Следующий() Цикл
		...
		Если НЕ ЕстьДанныеДляОтображения Тогда
			...
			Если ДиаграммаРейтингТоваров.Серии.Количество() = 0 Тогда
				...
				Серия.Текст = НСтр("ka='საუკეთესო საქონელი';ru='Лучший товар';en='Best product'");
			Иначе
		...
		Пока ВыборкаНоменклатура.Следующий() Цикл
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='მოგება: %1 ნომენკლატურისთვის: ""%2""   %3';ru='Выручка: %1 за номенклатуру: ""%2"" на %3';en='Revenue: 1% of range: ""%2"" on% 3'"),
				Формат(Выручка, ФорматСуммы),
	...
	Пока ВыборкаПериод.Следующий() Цикл
		...
		Если НЕ ЕстьДанныеДляОтображения Тогда
			...
			Если ДиаграммаРейтингМенеджеров.Серии.Количество() = 0 Тогда
				...
				Серия.Текст = НСтр("ka='საუკეთესო მენეჯერი';ru='Лучший менеджер';en='Best manager'");
			Иначе
		...
		Пока ВыборкаМенеджеры.Следующий() Цикл
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='მოგება: %1 по менеджеру: %2, на %3';ru='Выручка: %1 по менеджеру: %2, на %3';en='Revenue: 1% for the manager 2%, 3 at%'"),
				Формат(Выручка, ФорматСуммы),
	...
	СерияРасходы = ДиаграммаПрибыль.Серии.Добавить(НСтр("ka='დანახარჯები';ru='Расходы';en='Costs'"));
	СерияРасходы.Маркер = ТипМаркераДиаграммы.Круг;
	СерияРасходы.Индикатор = Истина;
	СерияПрибыль = ДиаграммаПрибыль.Серии.Добавить(НСтр("ka='მოგება';ru='Прибыль';en='Profit'"));
	СерияПрибыль.Маркер = ТипМаркераДиаграммы.Круг;
	СерияДоходы = ДиаграммаПрибыль.Серии.Добавить(НСтр("ka='შემოსავლები';ru='Доходы';en='earnings'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='მოგება: %1 на %2';ru='Доход: %1 на %2';en='Income: 1% to 2%'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='დანახარჯი: %1 на %2';ru='Расход: %1 на %2';en='Flow rate: 1% to 2%'"),
		...
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='შემოსავალი: %1 на %2';ru='Прибыль: %1 на %2';en='Gain: 1% to 2%'"),
...
Процедура ОбновитьВиджетДенежныеСредства(ДанныеДенежныхСредств, НастройкаВиджета)
	...
	Если Выборка.Следующий() Тогда
		Элементы.ДанныеОстаткиДС.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='ფულის ნაშთი';ru='Остаток денег';en='The rest of money'"), Выборка.ОстатокДенег, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеНаличные.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='ნაღდი ფული';ru='Наличные';en='Cash'"), Выборка.Наличные, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеБезналичные.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='უნაღდო';ru='Безналичные';en='Cashless'"), Выборка.Безналичные, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеДенежныйПоток.Заголовок = СформироватьЗаголовокВарианта(НСтр("ka='ფულის ნაკადი';ru='Денежный поток';en='Cash flow'"), Выборка.ДенежныйПоток, Истина, Выборка.ПредставлениеВалютыУчета);
	Иначе
	...
	Серия = ДиаграммаОстатокДенег.Серии.Добавить(НСтр("ka='ნაშთი';ru='Остаток';en='the balance'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='ფულის ნაშთი: %1 на %2';ru='Остаток денег: %1 на %2';en='The residue money: 1% to 2%'"),
	...
	Серия = ДиаграммаНаличные.Серии.Добавить(НСтр("ka='ნაშთი';ru='Остаток';en='the balance'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='ნაღდი: %1 на %2';ru='Наличные: %1 на %2';en='Cash: 1% to 2%'"),
	...
	Серия = ДиаграммаБезналичные.Серии.Добавить(НСтр("ka='ნაშთი';ru='Остаток';en='the balance'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='უნაღდო: %1 на %2';ru='Безналичные: %1 на %2';en='Cashless: 1% to 2%'"),
	...
	Серия = ДиаграммаДенежныйПоток.Серии.Добавить(НСтр("ka='ნაშთი';ru='Остаток';en='the balance'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='ფულადი ნაკადი: %1 на %2';ru='Денежный поток: %1 на %2';en='Cash Flow: 1% to 2%'"),
...
Процедура ОбновитьВиджетДолги(ДанныеВзаиморасчетов, НастройкаВиджета)
	...
	Если Выборка.Следующий() Тогда
		Элементы.ДанныеДолгПокупателей.Заголовок =	СформироватьЗаголовокВарианта(НСтр("ka='მყიდველთა დავალიანება';ru='Долг покупателей';en='debt buyers'"),
			Выборка.ДолгПокупателей, , Выборка.ПредставлениеВалютыУчета);
		Элементы.ДанныеДолгПоставщикам.Заголовок =	СформироватьЗаголовокВарианта(НСтр("ka='დავალიანება მომწოდებლებთან';ru='Долг поставщикам';en='debt providers'"),
	...
	Точка.Текст = НСтр("ka='დავალიანება';ru='Долг';en='Debt'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если КлючиСерий.Количество() < МаксСерийДиаграммы Тогда
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='დავალიანება: %1 от покупателя: %2';ru='Задолженность: %1 от покупателя: %2';en='Debt: 1% from the buyer: 2%'"),
		...
		Иначе
			...
			СводнаяСерия.Текст = НСтр("ka='სხვები';ru='Прочие';en='other'");
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='სხვა მყიდველთა დავალიანება: %1';ru='Задолженность прочих покупателей: %1';en='Receivable from other customers: 1%'"),
	...
	Серия = ДиаграммаДолгПокупателей.Серии.Добавить(НСтр("ka='დავალიანება';ru='Задолженность';en='debts'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
	...
	Пока Выборка.Следующий() Цикл
		...
		Точка.Текст = Формат(Период, ФорматДатыТочки);
		Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='საერთო დავალიანება: %1 на %2';ru='Общая задолженность: %1 на %2';en='Total debt:% 1% 2'"),
	...
	Пока Выборка.Следующий() Цикл
		...
		Если КлючиСерий.Количество() < МаксСерийДиаграммы Тогда
			...
			Серия.Раздвигать = Истина;
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='დავალიანება: %1 მომწოდებელთან: %2';ru='Задолженность: %1 поставщику: %2';en='Debt: 1% supplier: 2%'"),
		...
		Иначе
			...
			Подсказка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='დავალიანება სხვა მომწოდებლებთან: %1';ru='Задолженность прочим поставщикам: %1';en='Receivable from other suppliers of: 1%'"),
				Формат(НовоеЗначение, ФорматСуммы),
				);
	...
	Серия = ДиаграммаДолгПоставщикам.Серии.Добавить(НСтр("ka='დავალიანება';ru='Задолженность';en='debts'"));
	Серия.Маркер = ТипМаркераДиаграммы.Круг;
...
Функция СформироватьПредставлениеПериода(ДатаОкончания, ВидПериода, Интервал)
	...
	ФорматнаяСтрока = НСтр("ka='Л=ka_GE;';ru='Л=ru_RU;';en='L = ru_RU;'") + " ДФ='d MMMM'";
	
	Если Интервал = Перечисления.Периодичность.День Тогда
		ПредставлениеИнтервала = НСтр("ka='დღეებით';ru='по дням';en='by days'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Неделя Тогда
		ПредставлениеИнтервала = НСтр("ka='კვირებით';ru='по неделям';en='weekly'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Декада Тогда
		ПредставлениеИнтервала = НСтр("ka='დეკადებით';ru='по декадам';en='by decades of'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Месяц Тогда
		ПредставлениеИнтервала = НСтр("ka='თვიურად';ru='помесячно';en='per month'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Квартал Тогда
		ПредставлениеИнтервала = НСтр("ka='კვარტალურად';ru='поквартально';en='quarterly'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Полугодие Тогда
		ПредставлениеИнтервала = НСтр("ka='ნახევარწლედად';ru='по полугодиям';en='by half'");
	ИначеЕсли Интервал = Перечисления.Периодичность.Год Тогда
		ПредставлениеИнтервала = НСтр("ka='კვირეებად';ru='по неделям';en='weekly'");
	Иначе
...
Процедура ИнициализироватьДиаграмму(Диаграмма, ВидДиаграммы = Неопределено)
	...
	Диаграмма.ФорматЗначенийВПодписях	= НСтр("ka='Л=ka_GE;';ru='Л=ru_RU;';en='L = ru_RU;'") + " ЧДЦ=; ЧН=' '";
	...
	Диаграмма.ОбластьЗаголовка.Текст			= НСтр("ka='არ არის მონაცემები';ru='Нет данных для отображения';en='No data to display'");
