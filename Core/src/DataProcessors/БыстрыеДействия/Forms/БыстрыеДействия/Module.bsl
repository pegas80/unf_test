...
Процедура Инициализация(Отказ)
	...
	Если ПолучитьФункциональнуюОпцию("УчетРозничныхПродаж") И ДоступныПродажи Тогда
		ДобавитьБыстроеДействие("РабочееМестоКассира", НСтр("ka='მსა';ru='РМК'"), "БыстроеДействиеОткрытьРМК");
	КонецЕсли;
	Если ДоступныПродажи Тогда
		ДобавитьБыстроеДействие("ДобавитьЗаказПокупателя", НСтр("ka='შეკვეთის გაფორმება';ru='Оформить заказ'"), "БыстроеДействиеСоздатьЗаказПокупателя");
		ДобавитьБыстроеДействие("ДобавитьСчетНаОплату", НСтр("ka='ანგარიშის გამოწერა';ru='Выписать счет'"), "БыстроеДействиеСоздатьСчетНаОплату");
		ДобавитьБыстроеДействие("ДобавитьРасходнуюНакладную", НСтр("ka='გაყიდვა';ru='Продать'"), "БыстроеДействиеСоздатьРасходнуюНакладную");
	КонецЕсли;
	Если ДоступныЗакупки Тогда
		ДобавитьБыстроеДействие("ДобавитьПриходнуюНакладную", НСтр("ka='ყიდვა';ru='Купить'"), "БыстроеДействиеСоздатьПриходнуюНакладную");
	КонецЕсли;
	Если ДоступнаКасса Тогда
		ДобавитьБыстроеДействие("ДобавитьПоступлениеВКассу", НСтр("ka='გადახდის მიღება';ru='Принять оплату'"), "БыстроеДействиеСоздатьПоступлениеВКассу");
		ДобавитьБыстроеДействие("ДобавитьРасходИзКассы", НСтр("ka='გადავიხადოთ';ru='Оплатить'"), "БыстроеДействиеСоздатьРасходИзКассы");
	КонецЕсли;
	Если ДоступныПродажи Тогда
		ДобавитьБыстроеДействие("СписокЗаказовПокупателя", НСтр("ka='შეკვეთები';ru='Заказы'"), "БыстроеДействиеСписокЗаказовПокупателей");
		ДобавитьБыстроеДействие("СписокРасходныхНакладных", НСтр("ka='გაყიდვები';ru='Продажи'"), "БыстроеДействиеСписокРасходныхНакладных");
	КонецЕсли; 
	Если ДоступнаКасса Тогда
		ДобавитьБыстроеДействие("СписокКассовыхДокументов", НСтр("ka='გადახდები';ru='Оплаты'"), "БыстроеДействиеЖурналКассовыхДокументов");
	КонецЕсли;
	Если ДоступныЗакупки Тогда
		ДобавитьБыстроеДействие("СписокПриходныхНакладных", НСтр("ka='შესყიდვები';ru='Закупки'"), "БыстроеДействиеСписокПриходныхНакладных");
	КонецЕсли; 
	Если ДоступноДобавлениеТоваров Тогда
		ДобавитьБыстроеДействие("СписокНоменклатуры", НСтр("ka='საქონელი და მომსახურება';ru='Товары и услуги'"), "БыстроеДействиеСписокНоменклатуры");
	КонецЕсли;
	Если ДоступныПродажи Тогда
		ДобавитьБыстроеДействие("СписокПокупателей", НСтр("ka='მყიდველები';ru='Покупатели'"), "БыстроеДействиеСписокПокупателей");
	КонецЕсли;
	Если ДоступныЗакупки Тогда
		ДобавитьБыстроеДействие("СписокПоставщиков", НСтр("ka='მომწოდებლები';ru='Поставщики'"), "БыстроеДействиеСписокПоставщиков");
	КонецЕсли; 
...
Процедура СоздатьЭлементыБыстрыеДействия()
	...
	Элемент.Подсказка = НСтр("ka='პარამეტრები';ru='Настройка'");
