...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВариантыИзменения = "Сумма" Тогда
		...
		ЭтаФорма.Заголовок = НСтр("ka='Изменить на сумму';ru='Изменить на сумму';en='Change in the amount of'");
		
	ИначеЕсли ВариантыИзменения = "Процент" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ka='Изменить на процент';ru='Изменить на процент';en='Change in the percentage of'");
		
	ИначеЕсли ВариантыИзменения = "Округление" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ka='დამრგვალება';ru='Округление';en='rounding'");
		
	ИначеЕсли ВариантыИзменения = "Очистить" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ka='გასუფთავება';ru='Очистить';en='clean'");
		
	ИначеЕсли ВариантыИзменения = "Формула" Тогда
		
		ЭтаФорма.Заголовок = НСтр("ka='Изменить по формуле';ru='Изменить по формуле';en='Change the formula'");
