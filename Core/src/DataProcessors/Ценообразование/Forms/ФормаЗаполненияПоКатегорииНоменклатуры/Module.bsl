...
Процедура ВывестиСообщениеОНеправильномВыборе()
	...
	ТекстСообщения = НСтр("ka='საჭიროა შეავსოთ ნომენკლატურების კატეგორიის სია';ru='Необходимо заполнить список категорий номенклатуры';en='You must fill out a list of the range of categories'");
