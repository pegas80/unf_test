...
"'") + Строка(СообщениеОбОшибке);
	...
	ТекстПредупреждения = НСтр("ka='Проверка параметров доступа в Интернет успешно пройдена.';ru='Проверка параметров доступа в Интернет успешно пройдена.';en='Check the Internet access parameters passed successfully.'");
	Возврат ТекстПредупреждения;
