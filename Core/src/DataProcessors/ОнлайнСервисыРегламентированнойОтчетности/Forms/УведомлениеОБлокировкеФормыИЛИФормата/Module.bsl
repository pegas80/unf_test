...
Процедура ПриОткрытииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ОбновлениеМодуляДокументооборотаНаИсправительныйДоступно Тогда
		...
		Элементы.ПроверитьОбновленияЗапрет.Заголовок 		= НСтр("ka='Обновить модуль';ru='Обновить модуль'");
		Элементы.ПроверитьОбновленияРекомендация.Заголовок 	= НСтр("ka='Обновить модуль';ru='Обновить модуль'");
	КонецЕсли;
...
Процедура ЗаполнитьHTML()
	...
	Иначе
		...
		Если ОбновлениеМодуляДокументооборотаНаИсправительныйДоступно Тогда
			ТекстHTML = СтрЗаменить(ТекстHTML, "ЗаголовокИсправление",	НСтр("ka='Информация по обновлению:';ru='Информация по обновлению:'"));
