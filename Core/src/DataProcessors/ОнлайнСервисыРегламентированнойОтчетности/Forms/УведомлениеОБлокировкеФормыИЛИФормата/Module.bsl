...
Процедура ПриОткрытииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ОбновлениеМодуляДокументооборотаНаИсправительныйДоступно Тогда
		...
		Элементы.ПроверитьОбновленияЗапрет.Заголовок 		= НСтр("ka='Обновить модуль';ru='Обновить модуль';en='update module'");
		Элементы.ПроверитьОбновленияРекомендация.Заголовок 	= НСтр("ka='Обновить модуль';ru='Обновить модуль';en='update module'");
	КонецЕсли;
...
Процедура ЗаполнитьHTML()
	...
	Иначе
		...
		Если ОбновлениеМодуляДокументооборотаНаИсправительныйДоступно Тогда
			ТекстHTML = СтрЗаменить(ТекстHTML, "ЗаголовокИсправление",	НСтр("ka='Информация по обновлению:';ru='Информация по обновлению:';en='Upgrade Information:'"));
