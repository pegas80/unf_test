...
Процедура КодРегионаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если СписокКодовРегионов = Неопределено Тогда
		...
		ТекстПредупреждения = НСтр("ka='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.';ru='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.'");
	...
	СписокКодовРегионов.ПоказатьВыборЭлемента(
		ОписаниеОповещения,
		НСтр("ka='Коды регионов';ru='Коды регионов'"),
