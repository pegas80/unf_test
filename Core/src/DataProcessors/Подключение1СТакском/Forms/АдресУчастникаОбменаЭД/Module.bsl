...
"Сохранить изменения?';ka='Адрес участника обмена электронными документами изменен."
"Сохранить изменения?'");
...
Процедура КодРегионаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если СписокКодовРегионов = Неопределено Тогда
		...
		ТекстПредупреждения = НСтр("ka='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.';ru='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.';en='The code list is not already loaded. Click on the ""Download"" link, or enter the area code manually.'");
	...
	СписокКодовРегионов.ПоказатьВыборЭлемента(
		ОписаниеОповещения,
		НСтр("ka='Коды регионов';ru='Коды регионов';en='Area codes'"),
