...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстЗаголовка = НСтр("ka='Период: с %1 по %2';ru='Период: с %1 по %2'");
	...
	ЗаголовокЗаявки = НСтр("ka='Заявка №%1 от %2';ru='Заявка №%1 от %2'");
	...
	Если Не ПрограммноеЗакрытие Тогда
		...
		Если Модифицированность Тогда
			...
			Если ЗавершениеРаботы Тогда
				ТекстПредупреждения =
					НСтр("ka='Заявка на изменение тарифа обмена электронными документами не отправлена.';ru='Заявка на изменение тарифа обмена электронными документами не отправлена.'");
			Иначе
				ОписаниеОповещения = Новый ОписаниеОповещения(
					"ПриОтветеНаВопросОЗакрытииМодифицированнойФормы",
					ЭтотОбъект);
				ТекстВопроса = НСтр("ka='Данные изменены. Закрыть форму без сохранения данных?';ru='Данные изменены. Закрыть форму без сохранения данных?'");
...
"%1'");
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Интернет-поддержка. Изменение тарифа в 1С-Такском.';ru='Интернет-поддержка. Изменение тарифа в 1С-Такском.'"),
			ТекстСообщения,
			"taxcom",
			,
...
Процедура УстановитьНадписьНаГиперссылкеОбновленияСтатуса()
	...
	ТекстЗаголовка = НСтр("ka='Проверить выполнение заявки (осталось %1 сек.)';ru='Проверить выполнение заявки (осталось %1 сек.)'");
