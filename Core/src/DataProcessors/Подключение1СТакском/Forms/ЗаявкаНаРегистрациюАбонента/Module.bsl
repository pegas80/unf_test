...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НадписьЛогина.Заголовок = НСтр("ka='Логин:';ru='Логин:'") + " " + Параметры.login;
	...
	Если СтатусФормы = "new" ИЛИ НЕ ЗначениеЗаполнено(СтатусФормы) Тогда
		...
		Элементы.НадписьЗаголовкаФормы.Заголовок = НСтр("ka='Заявка на регистрацию участника обмена ЭД';ru='Заявка на регистрацию участника обмена ЭД'");
		Элементы.НадписьСтатусаЗаявки.Заголовок = НСтр("ka='Новая заявка';ru='Новая заявка'");
	...
	ИначеЕсли СтатусФормы = "change" Тогда
		...
		Элементы.НадписьЗаголовкаФормы.Заголовок = НСтр("ka='Изменение данных участника обмена ЭД';ru='Изменение данных участника обмена ЭД'");
		Элементы.НадписьСтатусаЗаявки.Заголовок = НСтр("ka='Новая заявка';ru='Новая заявка'");
		Элементы.ОтправитьЗаявку.Видимость = Истина;
	...
	ИначеЕсли СтатусФормы = "show" Тогда
		...
		ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Заявка №%1 от %2';ru='Заявка №%1 от %2'"),
			НомерЗаявки,
	...
	Если НЕ ЗначениеЗаполнено(СтатусЗаявки) ИЛИ СтатусЗаявки = "none" Тогда
		...
		ТекстСтатуса = НСтр("ka='Новая заявка.';ru='Новая заявка.'");
		Элементы.НадписьПричина.Видимость = Ложь;
		
	ИначеЕсли СтатусЗаявки = "notconsidered" Тогда
		
		ТекстСтатуса = НСтр("ka='Заявка оператором еще не рассмотрена.';ru='Заявка оператором еще не рассмотрена.'");
		Элементы.НадписьПричина.Видимость = Ложь;
		
	ИначеЕсли СтатусЗаявки = "rejected" Тогда
		
		ТекстСтатуса = НСтр("ka='Заявка оператором отклонена.';ru='Заявка оператором отклонена.'");
		Элементы.НадписьПричина.Видимость = Истина;
		
	Иначе
		
		// Статус заявки - "obtained".
		ТекстСтатуса = НСтр("ka='Заявка успешно выполнена оператором';ru='Заявка успешно выполнена оператором'");
		Элементы.НадписьПричина.Видимость = Ложь;
	...
	Если Не ПрограммноеЗакрытие Тогда
		...
		Если Модифицированность Тогда
			...
			Если ЗавершениеРаботы Тогда
				ТекстПредупреждения =
					НСтр("ka='Заявка на регистрацию данных участника обмена электронными документами не отправлена.';ru='Заявка на регистрацию данных участника обмена электронными документами не отправлена.'");
			Иначе
				ОписаниеОповещения = Новый ОписаниеОповещения(
					"ПриОтветеНаВопросОЗакрытииМодифицированнойФормы",
					ЭтотОбъект);
				
				ТекстВопроса = НСтр("ka='Данные заявки изменены. Закрыть форму без сохранения данных?';ru='Данные заявки изменены. Закрыть форму без сохранения данных?'");
...
"%2'");
		...
		Если СтатусФормы = "new" ИЛИ ПустаяСтрока(СтатусФормы) Тогда
			ЧтоНеПолучилось = НСтр("ka='Не получается отправить заявку на регистрацию участника обмена ЭД';ru='Не получается отправить заявку на регистрацию участника обмена ЭД'");
		ИначеЕсли СтатусФормы = "change" Тогда
			ЧтоНеПолучилось = НСтр("ka='Не получается отправить заявку на изменение данных участника обмена ЭД';ru='Не получается отправить заявку на изменение данных участника обмена ЭД'");
		ИначеЕсли СтатусФормы = "show" Тогда
			ЧтоНеПолучилось = НСтр("ka='Возникли проблемы с заявкой участника обмена ЭД';ru='Возникли проблемы с заявкой участника обмена ЭД'");
		КонецЕсли;
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Интернет-поддержка. Заявка на регистрацию участника обмена ЭД в 1С-Такском';ru='Интернет-поддержка. Заявка на регистрацию участника обмена ЭД в 1С-Такском'"),
			ТекстСообщения,
			"taxcom",
			,
...
Процедура ОтправитьЗаявку(Команда)
	...
	Если ПустаяСтрока(Организация) Тогда
		...
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Организация""';ru='Не заполнено поле ""Организация""'");
	...
	Если ПустаяСтрока(Адрес) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Адрес""';ru='Не заполнено поле ""Адрес""'");
	...
	Если ПустаяСтрока(Телефон) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Телефон""';ru='Не заполнено поле ""Телефон""'");
	...
	Если ПустаяСтрока(КодРегиона) Тогда
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст =
			НСтр("ka='Не указан ""Код региона"" (Код региона нужно указать в форме ""Адрес участника обмена ЭД"")';ru='Не указан ""Код региона"" (Код региона нужно указать в форме ""Адрес участника обмена ЭД"")'");
		Сообщение.Поле = "Адрес";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ПустаяСтрока(ИНН) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='ველი ""გსნ"" არ არის შევსებული';ru='Не заполнено поле ""ИНН""'");
		Сообщение.Поле = "ИНН";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ЮрФизЛицо <> "ЮрЛицо" И ЮрФизЛицо <> "ФизЛицо" Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не выбран тип организации (юридическое или физическое лицо)';ru='Не выбран тип организации (юридическое или физическое лицо)'");
	...
	Если ПустаяСтрока(КПП) И ЮрФизЛицо = "ЮрЛицо" Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""КПП""';ru='Не заполнено поле ""КПП""'");
		Сообщение.Поле = "КПП";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ПустаяСтрока(ОГРН) И ЮрФизЛицо = "ЮрЛицо" Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""ОГРН""';ru='Не заполнено поле ""ОГРН""'");
		Сообщение.Поле = "ОГРН";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если ПустаяСтрока(КодНалоговогоОргана) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Код налогового органа""';ru='Не заполнено поле ""Код налогового органа""'");
	...
	Если ПустаяСтрока(Фамилия) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Фамилия""';ru='Не заполнено поле ""Фамилия""'");
	...
	Если ПустаяСтрока(Имя) Тогда
		Ошибка    = Истина;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Имя""';ru='Не заполнено поле ""Имя""'");
		Сообщение.Поле = "Имя";
		Сообщение.Сообщить();
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(Телефон) Тогда
		Если СтрДлина(Телефон) > 20 Тогда
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='""Телефон"" должен содержать не более 20 символов';ru='""Телефон"" должен содержать не более 20 символов'");
			Сообщение.Поле = "Телефон";
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(КодРегиона) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(КодРегиона)) <> 2 Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""Код региона"" должен содержать 2 цифры';ru='""Код региона"" должен содержать 2 цифры'");
				Сообщение.Поле = "Адрес";
				Сообщение.Сообщить();
			Иначе
				Если КодРегионаЧисло > 99 ИЛИ КодРегионаЧисло < 1 Тогда
					Ошибка    = Истина;
					Сообщение = Новый СообщениеПользователю;
					Сообщение.Текст = НСтр("ka='""Код региона"" должен быть от 01 до 99';ru='""Код региона"" должен быть от 01 до 99'");
		...
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='В ""Коде региона"" использованы недопустимые символы';ru='В ""Коде региона"" использованы недопустимые символы'");
			Сообщение.Поле = "Адрес";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(ИНН) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(ИНН)) <> 12 И ЮрФизЛицо = "ФизЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""ИНН"" должен содержать 12 цифр';ru='""ИНН"" должен содержать 12 цифр'");
				Сообщение.Поле = "ИНН";
				Сообщение.Сообщить();
			ИначеЕсли СтрДлина(СокрЛП(ИНН)) <> 10 И ЮрФизЛицо = "ЮрЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""ИНН"" должен содержать 10 цифр';ru='""ИНН"" должен содержать 10 цифр'");
				Сообщение.Поле = "ИНН";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='В ""ИНН"" использованы недопустимые символы';ru='В ""ИНН"" использованы недопустимые символы'");
			Сообщение.Поле = "ИНН";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(КПП) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(КПП)) <> 9 Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""КПП"" должен содержать 9 цифр';ru='""КПП"" должен содержать 9 цифр'");
				Сообщение.Поле = "КПП";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='В ""КПП"" использованы недопустимые символы';ru='В ""КПП"" использованы недопустимые символы'");
			Сообщение.Поле = "КПП";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(ОГРН) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(ОГРН)) <> 13  И ЮрФизЛицо = "ЮрЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""ОГРН"" должен содержать 13 цифр';ru='""ОГРН"" должен содержать 13 цифр'");
				Сообщение.Поле = "ОГРН";
				Сообщение.Сообщить();
			ИначеЕсли СтрДлина(СокрЛП(ОГРН)) <> 15  И ЮрФизЛицо = "ФизЛицо" Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""ОГРН"" должен содержать 15 цифр';ru='""ОГРН"" должен содержать 15 цифр'");
				Сообщение.Поле = "ОГРН";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='В ""ОГРН"" использованы недопустимые символы';ru='В ""ОГРН"" использованы недопустимые символы'");
			Сообщение.Поле = "ОГРН";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
	...
	Если НЕ ПустаяСтрока(КодНалоговогоОргана) Тогда
		Попытка
			...
			Если СтрДлина(СокрЛП(КодНалоговогоОргана)) <> 4 Тогда
				Ошибка    = Истина;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = НСтр("ka='""Код налогового органа"" должен содержать 4 цифры';ru='""Код налогового органа"" должен содержать 4 цифры'");
				Сообщение.Поле = "КодНалоговогоОргана";
				Сообщение.Сообщить();
			КонецЕсли;
		Исключение
			Ошибка    = Истина;
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='В ""Коде налогового органа"" использованы недопустимые символы';ru='В ""Коде налогового органа"" использованы недопустимые символы'");
			Сообщение.Поле = "КодНалоговогоОргана";
			Сообщение.Сообщить();
		КонецПопытки;
	КонецЕсли;
