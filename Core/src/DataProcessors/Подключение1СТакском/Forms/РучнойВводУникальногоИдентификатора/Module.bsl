...
""
"%1';ka='У меня не получается ввести уникальный идентификатор участника ЭД вручную."
""
"Прошу помочь разобраться с проблемой."
""
"%1'");
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='1С-Такском. Ввод уникального идентификатора участника обмена ЭД вручную.';ru='1С-Такском. Ввод уникального идентификатора участника обмена ЭД вручную.';en='1C Taxcom. Enter a unique identifier ED exchange participant manual.'"),
			ТекстСообщения,
			"taxcom",
			,
