...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ИдентификаторСтроки") Тогда
		...
		Заголовок = НСтр("ka='მაჩვენელების აწყობა';ru='Настройка показателя';en='Setting indicator'");
	Иначе
		ИдентификаторСтроки = -1;
		Заголовок = НСтр("ka='მაჩვენებლების დამატება';ru='Добавление показателя';en='Adding index'");
	КонецЕсли; 
