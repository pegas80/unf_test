...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЦикла; 
	Элементы.Поле.СписокВыбора.Добавить("...", НСтр("ka='სხვა ველები';ru='Прочие поля'"),, БиблиотекаКартинок.Выбрать);
...
Процедура ПолеПриИзмененииСервер()
	...
	Для каждого Тип Из ОписаниеТипов.Типы() Цикл
		Если Тип=Тип("Число") Тогда
			// Числа
			ДобавитьВидСравнения("Больше", НСтр("ka='მეტი';ru='Больше'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("БольшеИлиРавно", НСтр("ka='მეტია ან ტოლია';ru='Больше или равно'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("Меньше", НСтр("ka='ნაკლები';ru='Меньше'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("МеньшеИлиРавно", НСтр("ka='ნაკლები ან ტოლი';ru='Меньше или равно'"), НедоступныеВидыСравнения);
		...
		ИначеЕсли Тип=Тип("Строка") Тогда
			// Строки
			ДобавитьВидСравнения("Содержит", НСтр("ka='შეიცავს';ru='Содержит'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеСодержит", НСтр("ka='არ შეიცავს';ru='Не содержит'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НачинаетсяС", НСтр("ka='იწყება  დან';ru='Начинается с'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеНачинаетсяС", НСтр("ka='არ იწყება';ru='Не начинается с'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("Подобно", НСтр("ka='Подобно';ru='Подобно'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеПодобно", НСтр("ka='Не подобно';ru='Не подобно'"), НедоступныеВидыСравнения);
		ИначеЕсли Тип=Тип("Булево") Тогда
			ДобавитьВидСравнения("Равно", НСтр("ka='უდრის';ru='Равно'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеРавно",НСтр("ka='არ უდრის';ru='Не равно'"), НедоступныеВидыСравнения);
		ИначеЕсли ОбщегоНазначения.ЭтоСсылка(Тип) Тогда
			...
			Если (ОбщегоНазначения.ЭтоСправочник(МетаданныеОбъекта) 
				...
				ДобавитьВидСравнения("ВСпискеПоИерархии", НСтр("ka='В группах';ru='В группах'"), НедоступныеВидыСравнения);
				ДобавитьВидСравнения("НеВСпискеПоИерархии", НСтр("ka='Не в группах';ru='Не в группах'"), НедоступныеВидыСравнения);
			КонецЕсли;
			Если КоличествоЗначений>2 Тогда
				ДобавитьВидСравнения("ВСписке", НСтр("ka='სიაში';ru='В списке'"), НедоступныеВидыСравнения);
				ДобавитьВидСравнения("НеВСписке", НСтр("ka='არა სიაში';ru='Не в списке'"), НедоступныеВидыСравнения);
			КонецЕсли; 
			ДобавитьВидСравнения("Равно", НСтр("ka='უდრის';ru='Равно'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеРавно",НСтр("ka='არ უდრის';ru='Не равно'"), НедоступныеВидыСравнения);
		КонецЕсли;	
