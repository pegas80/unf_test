...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЦикла; 
	Элементы.Поле.СписокВыбора.Добавить("...", НСтр("ka='სხვა ველები';ru='Прочие поля';en='Other fields'"),, БиблиотекаКартинок.Выбрать);
...
Процедура ПолеПриИзмененииСервер()
	...
	Для каждого Тип Из ОписаниеТипов.Типы() Цикл
		Если Тип=Тип("Число") Тогда
			// Числа
			ДобавитьВидСравнения("Больше", НСтр("ka='მეტი';ru='Больше';en='More'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("БольшеИлиРавно", НСтр("ka='მეტია ან ტოლია';ru='Больше или равно';en='More or equal'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("Меньше", НСтр("ka='ნაკლები';ru='Меньше';en='Less'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("МеньшеИлиРавно", НСтр("ka='ნაკლები ან ტოლი';ru='Меньше или равно';en='Less or equal'"), НедоступныеВидыСравнения);
		...
		ИначеЕсли Тип=Тип("Строка") Тогда
			// Строки
			ДобавитьВидСравнения("Содержит", НСтр("ka='შეიცავს';ru='Содержит';en='contains'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеСодержит", НСтр("ka='არ შეიცავს';ru='Не содержит';en='does not contain'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НачинаетсяС", НСтр("ka='იწყება  დან';ru='Начинается с';en='Begin with'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеНачинаетсяС", НСтр("ka='არ იწყება';ru='Не начинается с';en='It does not start with'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("Подобно", НСтр("ka='Подобно';ru='Подобно';en='Like'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеПодобно", НСтр("ka='Не подобно';ru='Не подобно';en='I do not like'"), НедоступныеВидыСравнения);
		ИначеЕсли Тип=Тип("Булево") Тогда
			ДобавитьВидСравнения("Равно", НСтр("ka='უდრის';ru='Равно';en='Equally'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеРавно",НСтр("ka='არ უდრის';ru='Не равно';en='Not equal'"), НедоступныеВидыСравнения);
		ИначеЕсли ОбщегоНазначения.ЭтоСсылка(Тип) Тогда
			...
			Если (ОбщегоНазначения.ЭтоСправочник(МетаданныеОбъекта) 
				...
				ДобавитьВидСравнения("ВСпискеПоИерархии", НСтр("ka='В группах';ru='В группах';en='In groups'"), НедоступныеВидыСравнения);
				ДобавитьВидСравнения("НеВСпискеПоИерархии", НСтр("ka='Не в группах';ru='Не в группах';en='Not Group'"), НедоступныеВидыСравнения);
			КонецЕсли;
			Если КоличествоЗначений>2 Тогда
				ДобавитьВидСравнения("ВСписке", НСтр("ka='სიაში';ru='В списке';en='The list'"), НедоступныеВидыСравнения);
				ДобавитьВидСравнения("НеВСписке", НСтр("ka='არა სიაში';ru='Не в списке';en='Not on the list'"), НедоступныеВидыСравнения);
			КонецЕсли; 
			ДобавитьВидСравнения("Равно", НСтр("ka='უდრის';ru='Равно';en='Equally'"), НедоступныеВидыСравнения);
			ДобавитьВидСравнения("НеРавно",НСтр("ka='არ უდრის';ru='Не равно';en='Not equal'"), НедоступныеВидыСравнения);
		КонецЕсли;	
