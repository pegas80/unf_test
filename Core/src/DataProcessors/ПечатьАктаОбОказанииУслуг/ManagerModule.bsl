...
Функция ПредставлениеПФ(Подробно = Ложь) Экспорт
	...
	Возврат ?(Подробно, НСтр("ka='Акт об оказании услуг (подробно)';ru='Акт об оказании услуг (подробно)';en='Act on the provision of services (in detail)'"), НСтр("ka='აქტი გაწეული მომსახურების შესახებ';ru='Акт об оказании услуг';en='The act of providing services'"));
...
Функция СформироватьПФ(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати, Подробно) Экспорт
	...
	Для каждого ДанныеОбъекта Из ДанныеОбъектовПечати Цикл
		...
		Если ОбластьМакета <> Неопределено Тогда
			...
			ШаблонЗаголовка = Нстр("ka='აქტი გაწული მომსახურების შესახებ № %1  %2';ru='Акт об оказании услуг № %1 от %2';en='The act of the Service number 1% from 2%'");
		...
		Если ОбластьМакета <> Неопределено Тогда
			...
			ШаблонИтоговойСтроки = НСтр("ka='სულ არის %2 ოდენობის %1 დასახელება';ru='Всего наименований %1, на сумму %2';en='All kinds of 1%, amounting to 2%'");
