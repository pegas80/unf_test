...
Процедура ОтразитьРасходыВПрограмме(Команда)
	...
	ПоказатьВводДаты(оп, ДатаУплаты, НСтр("ka='Когда был уплачен авансовый платеж?';ru='Когда был уплачен авансовый платеж?';en='When he was paid the down payment?'"), ЧастиДаты.Дата);
