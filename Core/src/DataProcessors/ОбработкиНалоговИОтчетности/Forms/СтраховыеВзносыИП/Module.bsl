...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Год(ДатаДокументаОбработкиСобытия) > 2013 Тогда
		Элементы.ДекорацияПФРСтраховая.Заголовок = НСтр("ka='ПФР';ru='ПФР';en='FIU'");
		Элементы.ДекорацияИтого.Заголовок = НСтр("ka='Итого (2-в-1):';ru='Итого (2-в-1):';en='Total (2-in-1):'");
...
Процедура ОтразитьРасходыВПрограмме(Команда)
	...
	Список.Добавить(ДокументВзаиморасчетовСБюджетомФФОМС,НСтр("ka='ФФОМС';ru='ФФОМС';en='FFOMS'"));
	
	Если Год(ДатаДокументаОбработкиСобытия) < 2014 Тогда
		Список.Добавить(ДокументВзаиморасчетовСБюджетомПФРСтраховая,НСтр("ka='ПФР страховая';ru='ПФР страховая';en='FIU insurance'"));
		Список.Добавить(ДокументВзаиморасчетовСБюджетомПФРНакопительная,НСтр("ka='ПФР накопительная';ru='ПФР накопительная';en='FIU funded'"));
	Иначе
		Список.Добавить(ДокументВзаиморасчетовСБюджетомПФРСтраховая,НСтр("ka='ПФР';ru='ПФР';en='FIU'"));
	КонецЕсли;
...
"Создать его автоматически?';ka='В справочнике «Контрагенты» не задан налоговый орган для уплаты взноса."
