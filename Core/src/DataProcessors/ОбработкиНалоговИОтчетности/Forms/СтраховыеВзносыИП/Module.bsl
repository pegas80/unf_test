...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Год(ДатаДокументаОбработкиСобытия) > 2013 Тогда
		Элементы.ДекорацияПФРСтраховая.Заголовок = НСтр("ka='ПФР';ru='ПФР'");
		Элементы.ДекорацияИтого.Заголовок = НСтр("ka='Итого (2-в-1):';ru='Итого (2-в-1):'");
...
Процедура ОтразитьРасходыВПрограмме(Команда)
	...
	Список.Добавить(ДокументВзаиморасчетовСБюджетомФФОМС,НСтр("ka='ФФОМС';ru='ФФОМС'"));
	
	Если Год(ДатаДокументаОбработкиСобытия) < 2014 Тогда
		Список.Добавить(ДокументВзаиморасчетовСБюджетомПФРСтраховая,НСтр("ka='ПФР страховая';ru='ПФР страховая'"));
		Список.Добавить(ДокументВзаиморасчетовСБюджетомПФРНакопительная,НСтр("ka='ПФР накопительная';ru='ПФР накопительная'"));
	Иначе
		Список.Добавить(ДокументВзаиморасчетовСБюджетомПФРСтраховая,НСтр("ka='ПФР';ru='ПФР'"));
	КонецЕсли;
