...
Процедура ПереходВыполнил(Команда)
	...
	ПоказатьВопрос(оп, НСтр("ka='ИФНС приняла сведения о ССЧ по сотрудникам?';ru='ИФНС приняла сведения о ССЧ по сотрудникам?';en='The IRS took SSFS information on employees?'"), РежимДиалогаВопрос.ДаНет);
	Возврат;
...
Процедура ОтправитьОтчетность(Команда)
	...
	ПоказатьВопрос(ОписаниеОповещения,
		НСтр("ka='Вы подтверждаете, что Сведения о ССЧ по сотрудникам заполнены полностью и корректно?';ru='Вы подтверждаете, что Сведения о ССЧ по сотрудникам заполнены полностью и корректно?';en='You acknowledge that information about SSFS of staff filled completely and correctly?'"), РежимДиалогаВопрос.ДаНет);
