...
Функция ПроверитьНаличиеГосОргана(ИмяПроцедурыПоЗавершениюСозданияГосОргана)
	...
	Иначе
		...
		ТекстВопроса = НСтр("ka='В справочнике «Контрагенты» не задано отделение ПФ РФ для уплаты взноса."
"Создать его автоматически?';ru='В справочнике «Контрагенты» не задано отделение ПФ РФ для уплаты взноса."
...
Процедура ВыполнитьЗаполнениеСведенийОНалоговойИнспекции(ДопПараметры)
	...
	Если ЗначениеЗаполнено(ОписаниеОшибки) Тогда
		Если ОписаниеОшибки = "НеУказаныПараметрыАутентификации" Тогда
			...
			ТекстВопроса = НСтр("ka='Для автоматического создания отделения ПФ РФ"
"в справочнике «Контрагенты» необходимо подключиться к Интернет-поддержке"
"пользователей. Подключиться сейчас?';ru='Для автоматического создания отделения ПФ РФ"
"в справочнике «Контрагенты» необходимо подключиться к Интернет-поддержке"
