...
Процедура ПереходВыполнил(Команда)
	...
	ПоказатьВопрос(оп, НСтр("ka='ПФР принял СЗВ-М?';ru='ПФР принял СЗВ-М?'"), РежимДиалогаВопрос.ДаНет);
	Возврат;
...
Процедура ОтправитьОтчетность(Команда)
	...
	ПоказатьВопрос(ОписаниеОповещения,
		НСтр("ka='Вы подтверждаете, что СЗВ-М заполнены полностью и корректно?';ru='Вы подтверждаете, что СЗВ-М заполнены полностью и корректно?'"), РежимДиалогаВопрос.ДаНет);
