	...
	Если ЗначениеЗаполнено(КомплектОтчетности) Тогда
		...
		Если Выборка1.Следующий() Тогда
			...
			Если Месяц(ОтчетныйПериод) = 10 И ЭтоОтчетностьРанее2013года Тогда
				...
				Элементы.ДекорацияОписаниеРаботы2.Заголовок = НСтр("ka='Распечатайте РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 в 2-х экземплярах';ru='Распечатайте РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 в 2-х экземплярах'");
				Элементы.ДекорацияТекстОписание7.Заголовок = НСтр("ka='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 на флешку или дискету (разные налоговые по-разному принимают)';ru='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-2, СЗВ-6-3, АДВ-6-4 на флешку или дискету (разные налоговые по-разному принимают)'");
			...
			Если Не ЭтоОтчетностьРанее2014года Тогда
				...
				Элементы.ДекорацияОписаниеРаботы2.Заголовок = НСтр("ka='Распечатайте РСВ-1 в 2-х экземплярах';ru='Распечатайте РСВ-1 в 2-х экземплярах'");
				Элементы.ДекорацияТекстОписание7.Заголовок = НСтр("ka='Сохраните файлы РСВ-1 на флешку или дискету (разные налоговые по-разному принимают)';ru='Сохраните файлы РСВ-1 на флешку или дискету (разные налоговые по-разному принимают)'");
			ИначеЕсли Не ЭтоОтчетностьРанее2013года Тогда
				Элементы.ДекорацияОписаниеРаботы2.Заголовок = НСтр("ka='Распечатайте РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 в 2-х экземплярах';ru='Распечатайте РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 в 2-х экземплярах'");
				Элементы.ДекорацияТекстОписание7.Заголовок = НСтр("ka='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 на флешку или дискету (разные налоговые по-разному принимают)';ru='Сохраните файлы РСВ-1, АДВ-6-2, СЗВ-6-4, АДВ-6-5 на флешку или дискету (разные налоговые по-разному принимают)'");
			КонецЕсли;
			...
			Если НЕ ЭтоОтчетностьРанее2014года И Не ЗначениеЗаполнено(ДокументРаздел6РасчетаРСВ1) И ИмеютсяСотрудникиВПФР Тогда
				...
				Элементы.ДекорацияПредупреждение.Заголовок = НСтр("ka='Внимание! В программе появились новые формы отчетности в ПФР. Сформируйте данный комплект отчетности заново.';ru='Внимание! В программе появились новые формы отчетности в ПФР. Сформируйте данный комплект отчетности заново.'");
...
Процедура ПереходВыполнил(Команда)
	...
	ПоказатьВопрос(оп, НСтр("ka='ПФР приняла отчетность?';ru='ПФР приняла отчетность?'"), РежимДиалогаВопрос.ДаНет);
	Возврат;
...
Процедура ОтправитьОтчетность(Команда)
	...
	ПоказатьВопрос(ОписаниеОповещения,
		НСтр("ka='Вы подтверждаете, что отчет заполнен полностью и корректно?';ru='Вы подтверждаете, что отчет заполнен полностью и корректно?'"), РежимДиалогаВопрос.ДаНет);
...
Процедура ПриОтветеНаВопросОЗаполнении(РезультатВопроса, ДопПараметры) Экспорт
	...
	Если Отказ Тогда
		ПоказатьПредупреждение(,НСтр("ka='Отправка прервана! В отчете РСВ-1 найдены ошибки. Проверьте корректность заполнения отчета и повторите снова.';ru='Отправка прервана! В отчете РСВ-1 найдены ошибки. Проверьте корректность заполнения отчета и повторите снова.'"));
...
Процедура ЗаписьНаДискПослеПодключенияРасширенияРаботыСФайлами(Подключено, Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(ДокументОтчетности) Тогда
		...
		Если Ошибки.Количество() > 0 Тогда
			ПоказатьПредупреждение(,НСтр("ka='Сохранение прервано! В отчете РСВ-1 найдены ошибки. Проверьте корректность заполнения отчета и повторите снова.';ru='Сохранение прервано! В отчете РСВ-1 найдены ошибки. Проверьте корректность заполнения отчета и повторите снова.'"));
