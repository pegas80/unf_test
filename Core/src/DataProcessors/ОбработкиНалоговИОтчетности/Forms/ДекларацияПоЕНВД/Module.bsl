...
Процедура ПереходВыполнил(Команда)
	...
	ПоказатьВопрос(оп, НСтр("ka='ИФНС приняла декларацию?';ru='ИФНС приняла декларацию?'"), РежимДиалогаВопрос.ДаНет);
	Возврат;
...
Процедура ОтправитьОтчетность(Команда)
	...
	ПоказатьВопрос(ОписаниеОповещения,
		НСтр("ka='Вы подтверждаете, что Декларация заполнена полностью и корректно?';ru='Вы подтверждаете, что Декларация заполнена полностью и корректно?'"), РежимДиалогаВопрос.ДаНет);
...
Процедура ДекорацияОписаниеРазеделовНажатие(Элемент)
	...
	ПараметрыФормы.Вставить("Заголовок",НСтр("ka='მშეგ-ის დეკლარაცია';ru='Декларация по ЕНВД'"));
