		...
		Если ТипЗнч(НоваяСтрока.ОбъектДоговораОбслуживания) = Тип("СправочникСсылка.Номенклатура") Тогда
			Если КоличествоОказаноБезЦены <> 0 И СуммаОказаноБезЦены = 0
				...
				ТекстОшибки = СтрШаблон(
					НСтр("ka='По договору %1: %2 не может быть сформирован Счет! Для номенклатуры %3 не установлена цена во виду цен договора: %4';ru='По договору %1: %2 не может быть сформирован Счет! Для номенклатуры %3 не установлена цена во виду цен договора: %4'"),
	...
	Для Итератор = 0 По Параметры.СписокДоговорыОбслуживания.Количество() - 1 Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ka='Пакетное формирование счетов и электронных писем';ru='Пакетное формирование счетов и электронных писем'"),
				УровеньЖурналаРегистрации.Ошибка,,,
				ТекстОшибки
			);
			
			ТекстОшибки = СтрШаблон(
				НСтр("ka='Для договора %1 не удалось создать пакет документов по причине: %2';ru='Для договора %1 не удалось создать пакет документов по причине: %2'"),
...
Функция СоздатьЭлектронноеПисьмо(ШаблонСообщения, Договор, ДокументыКОтправке)
	...
	Исключение
		ТекстСообщения = СтрШаблон(
			НСтр("ka='Не удалось автоматически отправить электронное письмо по причине: %2';ru='Не удалось автоматически отправить электронное письмо по причине: %2'"),
