...
Процедура ДобавитьОбъекты(ОбъектМетаданных, СтрокаДерева, ТипМетаданных)
	...
	Если ТипМетаданных.Ключ = "Константы" Тогда
		...
		СтрокаОбъект.ПредставлениеПравилаОбработки = НСтр("ka='ძირითადი მნიშვნელობა';ru='По умолчанию';en='Default'");
...
Процедура ДобавитьСвойства(ОбъектМетаданных, СтрокаДерева, Тип, ЕстьОбрабатываемыеСвойства)
	...
	Если Тип = "СтандартныеРеквизиты" Тогда
		Имя = Тип;
		Синоним = НСтр("ka='სტანდარტული რეკვიზიტები';ru='Стандартные реквизиты';en='standard details'");
	...
	Иначе
		...
		Если Тип = "ПризнакиУчета" Тогда
			Синоним = НСтр("ka='Признаки учета';ru='Признаки учета';en='signs of accounting'");
		Иначе
			Синоним = Тип;
		КонецЕсли;
		Коллекция = ОбъектМетаданных[Тип];
	...
	Для Каждого ЭлементКоллекции Из Коллекция Цикл
		...
		СтрокаСвойство.ПредставлениеПравилаОбработки = НСтр("ka='ძირითადი მნიშვნელობა';ru='По умолчанию';en='Default'");
