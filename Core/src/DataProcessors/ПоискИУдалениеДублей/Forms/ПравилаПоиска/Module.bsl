...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Правила поиска дублей ""%1""';ru='Правила поиска дублей ""%1""';en='Search rules takes ""%1""'"), Параметры.ПредставлениеОбластиОтбора);
...
Процедура УчитыватьПрикладныеПравилаПриИзменении(Элемент)
	...
	ТекстЗаголовка = НСтр("ka='გაფრთხილება';ru='Предупреждение';en='A warning'");
	ТекстВопроса   = НСтр("ka='Внимание: поиск и удаление дублей элементов без учета поставляемых ограничений"
"может привести к рассогласованию данных в программе."
""
"Отключить использование поставляемых ограничений?';ru='Внимание: поиск и удаление дублей элементов без учета поставляемых ограничений"
"может привести к рассогласованию данных в программе."
""
...
Функция ОшибкиВыбора()
	...
	Возврат НСтр("ka='Необходимо указать хотя бы одно правило поиска дублей.';ru='Необходимо указать хотя бы одно правило поиска дублей.';en='You must specify at least one rule takes search.'");
КонецФункции
