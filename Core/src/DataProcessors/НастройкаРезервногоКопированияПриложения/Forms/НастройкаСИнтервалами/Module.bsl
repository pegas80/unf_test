...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='მონაცემები შეიცვალა. შევინახოთ ცვლილებები?';ru='Данные были изменены. Сохранить изменения?';en='The data have been changed. I save changes?'"), 
...
Процедура ПрименитьОграниченияНастроек()
	...
	ШаблонПодсказки = НСтр("ka='Максимум %1';ru='Максимум %1';en='Maximum% 1'");
...
Функция ПодписьКоличестваКопий(Знач Количество)
	...
	МассивПредставлений.Добавить(НСтр("ka='последнюю копию';ru='последнюю копию';en='latest copy'"));
	МассивПредставлений.Добавить(НСтр("ka='последние копии';ru='последние копии';en='latest copies'"));
	МассивПредставлений.Добавить(НСтр("ka='последних копий';ru='последних копий';en='latest copies'"));
