...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='მონაცემები შეიცვალა. შევინახოთ ცვლილებები?';ru='Данные были изменены. Сохранить изменения?'"), 
...
Процедура ПрименитьОграниченияНастроек()
	...
	ШаблонПодсказки = НСтр("ka='Максимум %1';ru='Максимум %1'");
...
Функция ПодписьКоличестваКопий(Знач Количество)
	...
	МассивПредставлений.Добавить(НСтр("ka='последнюю копию';ru='последнюю копию'"));
	МассивПредставлений.Добавить(НСтр("ka='последние копии';ru='последние копии'"));
	МассивПредставлений.Добавить(НСтр("ka='последних копий';ru='последних копий'"));
