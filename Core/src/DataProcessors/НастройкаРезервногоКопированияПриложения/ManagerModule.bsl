...
#КонецЕсли
		...
		ВызватьИсключение(НСтр("ka='Менеджер сервиса не поддерживает резервное копирование приложений';ru='Менеджер сервиса не поддерживает резервное копирование приложений'"));
