...
Процедура СбросНастроек(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("ka='კონტრაგენტების შემოწმება';ru='Проверка контрагентов'"),,НСтр("ka='კონტრაგენტების შემოწმების გამართვები გასუფთავებულია';ru='Настройки проверки контрагентов сброшены'"));
КонецПроцедуры
