...
Функция ПолучитьСообщениеОбмена()
	...
	Если ТаблицаФайловСообщенийОбмена.Количество() = 0 Тогда
		...
		СтрокаСообщения = НСтр("ka='Каталог обмена информацией на сервере: ""%1""';ru='Каталог обмена информацией на сервере: ""%1""';en='Catalog of the exchange of information on the server: ""%1""'");
		...
		СтрокаСообщения = НСтр("ka='Имя файла сообщения обмена: ""%1"" или ""%2""';ru='Имя файла сообщения обмена: ""%1"" или ""%2""';en='Name of file sharing messages: ""%1"" or ""%2""'");
...
Процедура ИнициализацияСообщенийОшибок()
	...
	// Общие коды ошибок
	СообщенияОшибок.Вставить(001, НСтр("ka='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';ru='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';en='The message file catalog information was not found with the data exchange.'"));
	...
	СообщенияОшибок.Вставить(004, НСтр("ka='Ошибка при создании временного каталога.';ru='Ошибка при создании временного каталога.';en='Error creating temporary directory.'"));
	...
	СообщенияОшибок.Вставить(101, НСтр("ka='Не задан путь на сервере.';ru='Не задан путь на сервере.';en='Do not set the path on the server.'"));
	СообщенияОшибок.Вставить(102, НСтр("ka='Ошибка инициализации подключения к FTP-серверу.';ru='Ошибка инициализации подключения к FTP-серверу.';en='Error initializing connection to the FTP-server.'"));
	СообщенияОшибок.Вставить(103, НСтр("ka='Ошибка подключения к FTP-серверу, проверьте правильность задания пути и права доступа к ресурсу.';ru='Ошибка подключения к FTP-серверу, проверьте правильность задания пути и права доступа к ресурсу.';en='Error connecting to the FTP-server, check the path is set correctly and the right of access to the resource.'"));
	СообщенияОшибок.Вставить(104, НСтр("ka='Ошибка при поиске файлов на FTP-сервере.';ru='Ошибка при поиске файлов на FTP-сервере.';en='Error when searching files to FTP-server.'"));
	СообщенияОшибок.Вставить(105, НСтр("ka='Ошибка при получении файла с FTP-сервера.';ru='Ошибка при получении файла с FTP-сервера.';en='Error retrieving file from the FTP-server.'"));
	СообщенияОшибок.Вставить(106, НСтр("ka='Ошибка удаления файла на FTP-сервере, проверьте права доступа к ресурсу.';ru='Ошибка удаления файла на FTP-сервере, проверьте права доступа к ресурсу.';en='Failed to delete files to FTP-server, check the permissions to a resource.'"));
