...
Функция СортироватьЗагружаемыеТипы(Знач ЗагружаемыеТипы)
	...
	Для каждого ОбъектМетаданных Из ЗагружаемыеТипы Цикл
		...
		Иначе
			...
			ШаблонТекста = НСтр("ka='Выгрузка объекта метаданных не поддерживается %1';ru='Выгрузка объекта метаданных не поддерживается %1';en='Unloading object metadata is not supported 1%'");
	...
	Для Каждого ОбъектМетаданных Из ТекущиеЗагружаемыеТипы Цикл
		...
		Иначе
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ka='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена';ru='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена';en='VygruzkaZagruzkaDannyh.ZagruzkaObektaPropuschena'", Метаданные.ОсновнойЯзык.КодЯзыка),
				УровеньЖурналаРегистрации.Информация,
				ОбъектМетаданных,
				,
				СтрШаблон(НСтр("ka='Загрузка данных объекта метаданных %1 пропущена, т.к. он включен в"
"список объектов метаданных, исключаемых из выгрузки и загрузки данных';ru='Загрузка данных объекта метаданных %1 пропущена, т.к. он включен в"
