...
Функция СортироватьЗагружаемыеТипы(Знач ЗагружаемыеТипы)
	...
	Для каждого ОбъектМетаданных Из ЗагружаемыеТипы Цикл
		...
		Иначе
			...
			ШаблонТекста = НСтр("ka='Выгрузка объекта метаданных не поддерживается %1';ru='Выгрузка объекта метаданных не поддерживается %1'");
	...
	Для Каждого ОбъектМетаданных Из ТекущиеЗагружаемыеТипы Цикл
		...
		Иначе
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ka='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена';ru='ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена'", Метаданные.ОсновнойЯзык.КодЯзыка),
