...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Параметры.НазваниеРегиона Тогда
		ТекстВопроса = НСтр("ka='Для автоподбора и выбора адресных сведений необходимо загрузить классификатор по региону ""%1"".';ru='Для автоподбора и выбора адресных сведений необходимо загрузить классификатор по региону ""%1"".';en='To quickly auto and select the address information must download qualifier in the region ""%1"".'");
