...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Элементы.ДополнительныеТерритории.Видимость = Ложь И Элементы.УлицыИНаселенныеПункты.Видимость = Ложь Тогда
		КраткоеПредставлениеОшибки = НСтр("ka='Данные о улицах, населенных пунктах и дополнительных территориях для введенного адреса отсутствуют';ru='Данные о улицах, населенных пунктах и дополнительных территориях для введенного адреса отсутствуют'");
		Возврат;
	КонецЕсли;
