...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Родитель) И Уровень > 1 Тогда
		...
		КраткоеПредставлениеОшибки = НСтр("ka='Поле не содержит адресных сведений для выбора.';ru='Поле не содержит адресных сведений для выбора.'");
		Возврат;
	КонецЕсли;
	...
	Если ДанныеКлассификатора.Отказ Тогда
		...
		КраткоеПредставлениеОшибки = НСтр("ka='Автоподбор и проверка адреса недоступны:';ru='Автоподбор и проверка адреса недоступны:'") + Символы.ПС + ДанныеКлассификатора.КраткоеПредставлениеОшибки;
		Возврат;
...
"Продолжить?'"), Данные.Представление);
	...
	ЗаголовокПредупреждения = НСтр("ka='დადასტურება';ru='Подтверждение'");
