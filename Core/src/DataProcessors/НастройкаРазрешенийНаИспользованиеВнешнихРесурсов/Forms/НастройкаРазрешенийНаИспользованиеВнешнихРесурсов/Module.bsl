...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ФормаРазрешить.Заголовок = НСтр("ka='შემდეგ >';ru='Далее >'");
...
Процедура Далее(Команда)
	...
	Если Элементы.ГруппаСтраницы.ТекущаяСтраница = Элементы.СтраницаРазрешения Тогда
		...
		Элементы.ФормаРазрешить.Заголовок = НСтр("ka='Настроить разрешения в кластере серверов';ru='Настроить разрешения в кластере серверов'");
