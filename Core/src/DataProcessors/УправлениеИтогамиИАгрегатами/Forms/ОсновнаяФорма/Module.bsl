...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.УправлениеИтогамиИАгрегатами.Форма.ФормаВыбораПериода") Тогда
		...
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Установка периода рассчитанных итогов ...';ru='Установка периода рассчитанных итогов ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Установка периода рассчитанных итогов завершена';ru='Установка периода рассчитанных итогов завершена'"));
		...
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка установки периода рассчитанных итогов.';ru='Ошибка установки периода рассчитанных итогов.'"));
	...
	ИначеЕсли ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Обработка.УправлениеИтогамиИАгрегатами.Форма.ФормаПараметровПерестроения") Тогда
		...
		Если КонтекстВыбора = "ПерестроитьАгрегаты" Тогда
			...
			ПараметрыИтогов = Новый Структура;
			ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Перестроение агрегатов ...';ru='Перестроение агрегатов ...'"));
			ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Перестроение агрегатов завершено';ru='Перестроение агрегатов завершено'"));
			...
			ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка перестроения агрегатов.';ru='Ошибка перестроения агрегатов.'"));
...
Процедура ВключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Включение использования итогов ...';ru='Включение использования итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Включение использования итогов завершено';ru='Включение использования итогов завершено'"));
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка включения использования итогов.';ru='Ошибка включения использования итогов.'"));
...
Процедура ВключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Включение использования текущих итогов ...';ru='Включение использования текущих итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Включение использования текущих итогов завершено';ru='Включение использования текущих итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка включения использования текущих итогов.';ru='Ошибка включения использования текущих итогов.'"));
...
Процедура ВыключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Выключение использования итогов ...';ru='Выключение использования итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Выключение использования итогов завершено';ru='Выключение использования итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка выключения использования итогов.';ru='Ошибка выключения использования итогов.'"));
...
Процедура ВыключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Выключение использования текущих итогов ...';ru='Выключение использования текущих итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Выключение использования текущих итогов завершено';ru='Выключение использования текущих итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка выключения использования текущих итогов.';ru='Ошибка выключения использования текущих итогов.'"));
...
Процедура ВключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Включение разделения итогов ...';ru='Включение разделения итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Включение разделения итогов завершено';ru='Включение разделения итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРазделениеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РазделениеИтогов");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка включения разделения итогов.';ru='Ошибка включения разделения итогов.'"));
...
Процедура ВыключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Выключение разделения итогов ...';ru='Выключение разделения итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Выключение разделения итогов завершено';ru='Выключение разделения итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРазделениеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РазделениеИтогов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка выключения разделения итогов.';ru='Ошибка выключения разделения итогов.'"));
...
Процедура ВключитьРежимАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Включение режима агрегатов ...';ru='Включение режима агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Включение режима агрегатов завершено';ru='Включение режима агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРежимАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РежимАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка включения режима агрегатов.';ru='Ошибка включения режима агрегатов.'"));
...
Процедура ВключитьРежимИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Включение режима итогов ...';ru='Включение режима итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Включение режима итогов завершено';ru='Включение режима итогов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРежимАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РежимАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка включения режима итогов.';ru='Ошибка включения режима итогов.'"));
...
Процедура ВключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Включение использования агрегатов ...';ru='Включение использования агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Включение использования агрегатов завершено';ru='Включение использования агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Истина);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка включения использования агрегатов.';ru='Ошибка включения использования агрегатов.'"));
...
Процедура ВыключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Выключение использования агрегатов ...';ru='Выключение использования агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Выключение использования агрегатов завершено';ru='Выключение использования агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка выключения использования агрегатов.';ru='Ошибка выключения использования агрегатов.'"));
...
Процедура ОчиститьАгрегатыПоРегистрам(Команда)
	...
	ТекстВопроса = НСтр("ka='Очистка агрегатов может привести к существенному замедлению отчетов.';ru='Очистка агрегатов может привести к существенному замедлению отчетов.'");
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить(КодВозвратаДиалога.Да, НСтр("ka='Очистить агрегаты';ru='Очистить агрегаты'"));
...
Процедура ЗаполнитьАгрегатыПоРегистрам(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Заполнение агрегатов ...';ru='Заполнение агрегатов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Заполнение агрегатов завершено';ru='Заполнение агрегатов завершено'"));
	ПараметрыИтогов.Вставить("Действие",               "ЗаполнитьАгрегаты");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Неопределено);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка заполнения агрегатов.';ru='Ошибка заполнения агрегатов.'"));
...
Процедура УстановитьПериодРассчитанныхИтогов(Команда)
	...
	Если МассивДействий.Количество() = 0 Тогда
		ПоказатьПредупреждение(, НСтр("ka='Отсутствуют регистры, для которых можно выполнить данную операцию.';ru='Отсутствуют регистры, для которых можно выполнить данную операцию.'"));
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьАгрегатыИВыполнитьПерестроение(Команда)
	...
	Если МассивДействий.Количество() = 0 Тогда
		ПоказатьПредупреждение(, НСтр("ka='Отсутствуют регистры, для которых можно выполнить выбранное действие.';ru='Отсутствуют регистры, для которых можно выполнить выбранное действие.'"));
		Возврат;
	КонецЕсли;
...
Процедура ПересчитатьИтоги(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Пересчет итогов ...';ru='Пересчет итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Пересчет итогов завершен';ru='Пересчет итогов завершен'"));
	ПараметрыИтогов.Вставить("Действие",               "ПересчитатьИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка пересчета итогов.';ru='Ошибка пересчета итогов.'"));
...
Процедура ПересчитатьТекущиеИтоги(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Пересчет текущих итогов ...';ru='Пересчет текущих итогов ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Пересчет текущих итогов завершен';ru='Пересчет текущих итогов завершен'"));
	ПараметрыИтогов.Вставить("Действие",               "ПересчитатьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка пересчета текущих итогов.';ru='Ошибка пересчета текущих итогов.'"));
...
Процедура УстановитьУсловноеОформление()
	...
	Инструкция.Оформление.Вставить("Текст", НСтр("ka='შედეგები';ru='Итоги'"));
	...
	Инструкция.Оформление.Вставить("Текст", НСтр("ka='Агрегаты';ru='Агрегаты'"));
	СтандартныеПодсистемыСервер.ДобавитьЭлементУсловногоОформления(ЭтотОбъект, Инструкция);
	...
	Инструкция.Оформление.Вставить("Текст", НСтр("ka='Только итоги';ru='Только итоги'"));
	СтандартныеПодсистемыСервер.ДобавитьЭлементУсловногоОформления(ЭтотОбъект, Инструкция);
...
Процедура ОчиститьАгрегатыПоРегистрамЗавершение(Ответ, ДополнительныеПараметры) Экспорт
	Если Ответ = КодВозвратаДиалога.Да Тогда
		...
		ПараметрыИтогов = Новый Структура;
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Очистка агрегатов ...';ru='Очистка агрегатов ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Очистка агрегатов завершена';ru='Очистка агрегатов завершена'"));
		ПараметрыИтогов.Вставить("Действие",               "ОчиститьАгрегаты");
		ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
		ПараметрыИтогов.Вставить("Поле",                   "Наименование");
		ПараметрыИтогов.Вставить("Значение1",              Неопределено);
		ПараметрыИтогов.Вставить("Значение2",              Неопределено);
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка очистки агрегатов.';ru='Ошибка очистки агрегатов.'"));
...
Процедура ПересчитатьИтогиЗаПериодЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ka='Пересчет итогов за период...';ru='Пересчет итогов за период...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ka='Пересчет итогов за период завершен';ru='Пересчет итогов за период завершен'"));
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ka='Ошибка пересчета итогов за период.';ru='Ошибка пересчета итогов за период.'"));
...
Процедура ПолучитьОптимальныеАгрегатКлиентЗавершение(ПустойПараметр, РезультатВыполнения) Экспорт
	...
	Иначе
		ПоказатьОповещениеПользователя(НСтр("ka='Агрегаты успешно получены.';ru='Агрегаты успешно получены.'"),,
	...
	Для Счетчик = 1 По Выбранные.Количество() Цикл
		...
		Если Не ВыбраннаяСтрока.РежимАгрегатов
			...
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ka='Операция невозможна в режиме итогов';ru='Операция невозможна в режиме итогов'"),
				,
				ПолеСообщенияОбОшибке);
			Продолжить;
		КонецЕсли;
	...
	Если Результат.МожноПолучить Тогда
		...
		#Иначе
			...
			Если Расширение = "zip" Тогда
				Фильтр = НСтр("ka='Архив ZIP (*.%1)|*.%1';ru='Архив ZIP (*.%1)|*.%1'");
			ИначеЕсли Расширение = "xml" Тогда
				Фильтр = НСтр("ka='Документ XML (*.%1)|*.%1';ru='Документ XML (*.%1)|*.%1'");
			Иначе
				Фильтр = "";
			КонецЕсли;
...
Функция Префикс()
	...
	Возврат НСтр("ka='Агрегаты регистра';ru='Агрегаты регистра'");
...
Функция ПолучитьОптимальныеАгрегатыСервер()
	...
	Для НомерСтроки = 1 По Всего Цикл
		...
		Если ИнформацияОбОшибке <> Неопределено Тогда
			...
			ЗаголовокОшибки = НСтр("ka='Не удалось получить оптимальные агрегаты регистра ""%1"":';ru='Не удалось получить оптимальные агрегаты регистра ""%1"":'");
	...
	Если Успешно > 0 Тогда
		...
		Иначе
			КраткоеИмяФайла = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Оптимальные агрегаты регистров накопления %1.zip';ru='Оптимальные агрегаты регистров накопления %1.zip'"),
	...
	Если Всего = 1 Тогда
		...
		Если Результат.ЕстьОшибки Тогда
			Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Не удалось получить оптимальные агрегаты регистра накопления ""%1"".';ru='Не удалось получить оптимальные агрегаты регистра накопления ""%1"".'"), ИмяРегистра);
			Результат.ПодробныйТекстСообщения = ПодробныйТекстОшибок;
		Иначе
			Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='%1 (регистр накопления)';ru='%1 (регистр накопления)'"),	ИмяРегистра);
		КонецЕсли;
	ИначеЕсли Успешно = 0 Тогда
		// Ничего не получилось.
		Результат.ЕстьОшибки = Истина;
		Результат.ТекстСообщения = НСтр("ka='Не удалось получить оптимальные агрегаты регистров накопления.';ru='Не удалось получить оптимальные агрегаты регистров накопления.'");
		Результат.ПодробныйТекстСообщения = ПодробныйТекстОшибок;
...
"Не получены: %3.'"),
	...
	Иначе
		// Полностью успешно.
		Результат.ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Регистры накопления (%1)';ru='Регистры накопления (%1)'"), Успешно);
	КонецЕсли;
...
Процедура ОбновитьСписокИтоговНаСервере()
	...
	ГруппаИтоговЗаголовок = НСтр("ka='შედეგები';ru='Итоги'");
...
Процедура ОбновитьАгрегатыПоРегистрамНаСервере()
	...
	ГруппаАгрегатыЗаголовок = НСтр("ka='Агрегаты';ru='Агрегаты'");
...
Функция УстановитьПараметрыРегистраНаСервере(Знач ВидРегистра,
	...
	Попытка
		...
		Иначе
			ВызватьИсключение НСтр("ka='Неправильное имя параметра';ru='Неправильное имя параметра'") + "(1): " + Действие;
		КонецЕсли;
	...
	Попытка
		...
		Иначе
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Неправильное имя параметра: %1';ru='Неправильное имя параметра: %1'"),
...
Процедура УстановитьРасширенныйРежим()
	...
	Если ПолныеВозможности Тогда
		Заголовок        = НСтр("ka='Управление итогами - полные возможности';ru='Управление итогами - полные возможности'");
		ТекстГиперссылки = НСтр("ka='Часто используемые возможности';ru='Часто используемые возможности'");
		Элементы.Операции.ТекущаяСтраница = Элементы.РасширенныеВозможности;
	Иначе
		Заголовок        = НСтр("ka='Управление итогами - часто используемые возможности';ru='Управление итогами - часто используемые возможности'");
		ТекстГиперссылки = НСтр("ka='Полные возможности';ru='Полные возможности'");
...
Процедура ПрочитатьИнформациюПоРегистрам()
	...
	Для Каждого Регистр Из Метаданные.РегистрыБухгалтерии Цикл
		...
		Представление = Регистр.Представление() + " (" + НСтр("ka='регистр бухгалтерии';ru='регистр бухгалтерии'") + ")";
	...
	Для Каждого Регистр Из Метаданные.РегистрыНакопления Цикл
		...
		Если Регистр.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Обороты Тогда
			...
			Постфикс = НСтр("ka='регистр накопления, только обороты';ru='регистр накопления, только обороты'");
		Иначе
			ОстаткиИОбороты = Истина;
			Постфикс = НСтр("ka='регистр накопления, остатки и обороты';ru='регистр накопления, остатки и обороты'");
		КонецЕсли;
