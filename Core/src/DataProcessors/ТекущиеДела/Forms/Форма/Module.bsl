...
Функция СформироватьСписокТекущихДелВФоне()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ka='მიმდინარე საქმეების სიის განახლება';ru='Обновление списка текущих дел'");
...
Процедура СоздатьЗаголовок(Дело, Группа, РазделСвернут)
	...
	Элемент.Подсказка = НСтр("ka='განყოფილების ჩაშლა/აკეცვა';ru='Развернуть/свернуть раздел'");
