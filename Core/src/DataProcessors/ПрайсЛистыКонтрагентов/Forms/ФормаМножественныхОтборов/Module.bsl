...
Процедура ПереключитьРежимОтбора(ИмяТабличнойЧасти)
	...
	Иначе
		...
		Если Объект[ИмяТабличнойЧасти].Количество() > 0 Тогда
			...
			ТекстВопроса = Нстр("ka='Множественный отбор будет очищен. Продолжить?';ru='Множественный отбор будет очищен. Продолжить?';en='Multiple selection is cleared. Proceed?'");
