	...
	Для Каждого ОбъектМетаданных Из ВыгружаемыеТипы Цикл
		...
		Если ИсключаемыеТипы.Найти(ОбъектМетаданных) <> Неопределено Тогда
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ka='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаПропущена';ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаОбъектаПропущена';en='VygruzkaZagruzkaDannyh.VygruzkaObektaPropuschena'", Метаданные.ОсновнойЯзык.КодЯзыка),
				УровеньЖурналаРегистрации.Информация,
				ОбъектМетаданных,
				,
				СтрШаблон(НСтр("ka='Выгрузка данных объекта метаданных %1 пропущена, т.к. он включен в"
"список объектов метаданных, исключаемых из выгрузки и загрузки данных';ru='Выгрузка данных объекта метаданных %1 пропущена, т.к. он включен в"
