...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если Не ЗначениеЗаполнено(ДокументДляПечати) Тогда
		ВидОперации = НСтр("ka='Печать электронного документа';ru='Печать электронного документа'");
		ТекстСообщения = НСтр("ka='Не указан электронный документ для печати';ru='Не указан электронный документ для печати'");
