...
Процедура ОбновитьСписок(Отказ)
	...
	Если МассивОрганизаций.Количество() = 0 Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='Отсутствуют подключенные организации к сервису 1С:Бизнес-сеть.';ru='Отсутствуют подключенные организации к сервису 1С:Бизнес-сеть.'"),,,, Отказ);
		Возврат;
	КонецЕсли;
...
Процедура УдалитьДокументВСервисеПослеВопроса(Результат, МассивСтрок) Экспорт
	...
	Если КоличествоСтрок = 1 Тогда
		ТекстОповещения	= НСтр("ka='Документ удален.';ru='Документ удален.'");
		ТекстПояснения	= НСтр("ka='Удален входящий документ в сервисе 1С:Бизнес-сеть.';ru='Удален входящий документ в сервисе 1С:Бизнес-сеть.'");
	Иначе
		ТекстОповещения	= НСтр("ka='Документы удалены (%1).';ru='Документы удалены (%1).'");
		ТекстОповещения = СтрШаблон(ТекстОповещения, КоличествоСтрок);
		ТекстПояснения	= НСтр("ka='Удалены входящие документы в сервисе 1С:Бизнес-сеть.';ru='Удалены входящие документы в сервисе 1С:Бизнес-сеть.'");
	КонецЕсли;
