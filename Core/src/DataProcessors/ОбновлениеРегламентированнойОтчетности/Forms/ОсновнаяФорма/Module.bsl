...
Процедура ПриОткрытии(Отказ)
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='Обновить комплект отчетности?';ru='Обновить комплект отчетности?';en='Update Kit reporting?'"), РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да);
