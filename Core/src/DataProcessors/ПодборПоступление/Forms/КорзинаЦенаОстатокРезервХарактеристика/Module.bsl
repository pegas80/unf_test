...
Процедура ВыводитьСоветУслугиВПриходныхДокументах()
	...
	Если КешНастройкиПодбора.ВыводитьСоветУслугиВПриходныхДокументах Тогда
		...
		ЗаголовокФормы = Нстр("ka='Совет';ru='Совет'");
		ТекстСообщения = НСтр("ka='Услуги в приходных документах отражают расходы компании, поэтому выбор характеристик ограничен.';ru='Услуги в приходных документах отражают расходы компании, поэтому выбор характеристик ограничен.'");
