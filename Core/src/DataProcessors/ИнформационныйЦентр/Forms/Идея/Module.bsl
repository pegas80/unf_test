...
Процедура УдалитьНажатие(Элемент)
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='Удалить Ваш комментарий?';ru='Удалить Ваш комментарий?'"), РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да);
...
Процедура ДобавитьКомментарий(Команда)
	...
	Если ПустаяСтрока(ТекстКомментария) Тогда 
		ВызватьИсключение НСтр("ka='Поле комментарий должно быть заполнено';ru='Поле комментарий должно быть заполнено'");
	КонецЕсли;
