...
Процедура ДобавитьИдею(Команда)
	...
	Если ПустаяСтрока(Наименование) Тогда 
		ВызватьИсключение НСтр("ka='Поле Наименование не должно быть пустым';ru='Поле Наименование не должно быть пустым'");
	КонецЕсли;
	
	Если ПустаяСтрока(Предмет) Тогда 
		ВызватьИсключение НСтр("ka='Поле Предмет не должно быть пустым';ru='Поле Предмет не должно быть пустым'");
	КонецЕсли;
