...
Процедура ЗаполнитьПереписку(ДанныеПоПереписке)
	...
	Для Каждого ЭлементВзаимодействия Из ДанныеПоПереписке.Interactions Цикл 
		...
		НовоеВзаимодействие.Описание = ?(ПустаяСтрока(ЭлементВзаимодействия.Description), НСтр("ka='<Без текста>';ru='<Без текста>'"), ЭлементВзаимодействия.Description);
		...
		НовоеВзаимодействие.ПояснениеККартинке = ?(ЭлементВзаимодействия.Incoming, НСтр("ka='Вх.';ru='Вх.'"), НСтр("ka='Исх.';ru='Исх.'"));
