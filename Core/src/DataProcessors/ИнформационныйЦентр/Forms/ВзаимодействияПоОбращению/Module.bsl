...
Процедура ЗаполнитьПереписку(ДанныеПоПереписке)
	...
	Для Каждого ЭлементВзаимодействия Из ДанныеПоПереписке.Interactions Цикл 
		...
		НовоеВзаимодействие.Описание = ?(ПустаяСтрока(ЭлементВзаимодействия.Description), НСтр("ka='<Без текста>';ru='<Без текста>';en='<No Text>'"), ЭлементВзаимодействия.Description);
		...
		НовоеВзаимодействие.ПояснениеККартинке = ?(ЭлементВзаимодействия.Incoming, НСтр("ka='Вх.';ru='Вх.';en='Bx.'"), НСтр("ka='Исх.';ru='Исх.';en='Ex.'"));
