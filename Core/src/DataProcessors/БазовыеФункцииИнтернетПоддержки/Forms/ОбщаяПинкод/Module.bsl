...
"Пинкод: %1.'");
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Интернет-поддержка. Регистрация продукта.';ru='Интернет-поддержка. Регистрация продукта.'"),
			ТекстСообщения,
			,
			,
...
Функция ЗаполнениеПолейКорректно()
	...
	Если ПустаяСтрока(ПинКод) Тогда
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Пинкод""';ru='Не заполнено поле ""Пинкод""'");
	...
	Если СтрДлина(ПинКодСтр) <> 16 Тогда
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Пин-код должен состоять из 16 цифр.';ru='Пин-код должен состоять из 16 цифр.'");
		Сообщение.Поле  = "ПинКод";
		Сообщение.Сообщить();
