...
Процедура СписокЗарегистрированныхПродуктовРегНомерНажатие(Элемент)
	...
	ИнтернетПоддержкаПользователейКлиент.ОткрытьВебСтраницу(
		...
		НСтр("ka='Список зарегистрированных продуктов';ru='Список зарегистрированных продуктов'"),
...
Процедура ПояснениеКЗаголовкуРегНомерОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылка, СтандартнаяОбработка)
	...
	Если НавигационнаяСсылка = "TechSupport" Тогда
		...
		ТекстСообщения =
			НСтр("ka='Не получается ввести регистрационный номер программного продукта.';ru='Не получается ввести регистрационный номер программного продукта.'");
		
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Интернет-поддержка. Ввод регистрационного номера.';ru='Интернет-поддержка. Ввод регистрационного номера.'"),
			ТекстСообщения,
			,
			,
...
Процедура ЗаполнитьФорму()
	...
	ЗаголовокПользователя = НСтр("ka='Логин:';ru='Логин:'") + " " + Параметры.login;
...
Функция ЗаполнениеПолейКорректно()
	...
	Если ПустаяСтрока(РегистрационныйНомерРегНомер) Тогда
		...
		Сообщение.Текст = НСтр("ka='Не заполнено поле ""Регистрационный номер""';ru='Не заполнено поле ""Регистрационный номер""'");
