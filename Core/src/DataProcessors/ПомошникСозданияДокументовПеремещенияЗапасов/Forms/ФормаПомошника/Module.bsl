...
Процедура УстановитьЗаголовкиРеквизитов()
	...
	Элементы.СтруктурнаяЕдиница.Заголовок = ?(ЭтоОтправитель, Нстр("ru = 'Склад отправитель'; ka = 'საწყობის გამგზავნი'"), Нстр("ru = 'Склад получатель'; ka = 'საწყობის მიმღები'"));
	Элементы.ТаблицаЗапасовСтруктурнаяЕдиница.Заголовок = ?(НЕ ЭтоОтправитель, Нстр("ru = 'Склад отправитель'; ka = 'საწყობის გამგზავნი'"), Нстр("ru = 'Склад получатель'; ka = 'საწყობის მიმღები'"));
