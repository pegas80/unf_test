...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ПоДублям Тогда
		...
		Заголовок = НСтр("ka='Дублирующиеся номера КиЗ';ru='Дублирующиеся номера КиЗ';en='Duplicate numbers Keyes'");
	...
	ИначеЕсли Параметры.ПоПроблемамСопоставления Тогда
		...
		Заголовок = НСтр("ka='Номера КиЗ, несопоставленные заказанным';ru='Номера КиЗ, несопоставленные заказанным';en='Non Keyes, unmapped ordered'");
