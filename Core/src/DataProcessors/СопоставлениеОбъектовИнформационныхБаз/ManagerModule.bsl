...
Функция РезультатСопоставленияОбъектов(Параметры)
	...
	Если Параметры.РеквизитыФормы.ТолькоПрименитьТаблицуНеутвержденныхЗаписей Тогда
		...
		Если Отказ Тогда
			ВызватьИсключение НСтр("ka='Возникли ошибки в процессе сопоставления объектов.';ru='Возникли ошибки в процессе сопоставления объектов.'");
		КонецЕсли;
...
Функция РезультатАвтоматическогоСопоставленияОбъектов(Параметры)
	...
	Если Отказ Тогда
		ВызватьИсключение НСтр("ka='Возникли ошибки в процессе автоматического сопоставления объектов.';ru='Возникли ошибки в процессе автоматического сопоставления объектов.'");
	КонецЕсли;
