...
Процедура Применить(Команда)
	...
	Если МассивОтмеченныхЭлементовСписка.Количество() = 0 Тогда
		...
		НСтрока = НСтр("ka='Следует указать хотя бы одно поле';ru='Следует указать хотя бы одно поле'");
	...
	ИначеЕсли МассивОтмеченныхЭлементовСписка.Количество() > МаксимальноеКоличествоПользовательскихПолей() Тогда
		...
		СтрокаСообщения = НСтр("ka='Уменьшите количество полей (можно выбирать не более [КоличествоПолей] полей)';ru='Уменьшите количество полей (можно выбирать не более [КоличествоПолей] полей)'");
