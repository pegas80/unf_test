...
"';ka='Начало загрузки файлов новостей"
"Время начала (мс): %ТНачало%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		...
		НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Начало';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Начало';en='News. Loading news. Download News Files. Start'"), // ИдентификаторШага
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Загрузка: Получение настроек, формирование списка лент новостей';ru='Загрузка: Получение настроек, формирование списка лент новостей';en='Download: Get the settings, the formation of the news feed list'"),
			ТШаг,
...
"%ИнформацияОбОшибке%';ka='Ошибка получения новостей из метаданных %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине"
"%ИнформацияОбОшибке%'");
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
									НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка получения файла из метаданных';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка получения файла из метаданных';en='News. Loading news. Download News Files. Error getting file metadata'"), // ИдентификаторШага
							...
							Если ЕстьОшибки = Ложь Тогда
								Попытка
									Если ТипЗнч(ОбъектМетаданныхМакет) = ТипОбъектМетаданных Тогда
										...
										Иначе
											Макет = Неопределено;
											ТекстСообщения = НСтр("ka='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей% - эти метаданные не обрабатываются';ru='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей% - эти метаданные не обрабатываются';en='Failed to get the news from the layout% filename% for feeds% LentaNovostey% - the metadata is not processed'");
											ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
											ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
											// Запись в журнал регистрации
											ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										...
										Если Макет <> Неопределено Тогда
											Если ОбъектМетаданныхМакет.ТипМакета = Метаданные.СвойстваОбъектов.ТипМакета.ТекстовыйДокумент Тогда
												...
												Исключение
													...
													ТекстСообщения = НСтр("ka='ЗагрузитьФайлыНовостейССервера (получено из макета): Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.';ru='ЗагрузитьФайлыНовостейССервера (получено из макета): Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.'");
													...
													ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
														НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
														НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка удаления временного файла';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка удаления временного файла';en='News. Loading news. Download News Files. Error deleting temporary file'"), // ИдентификаторШага
												...
												КонецПопытки;
											Иначе
												ТекстСообщения = НСтр("ka='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей%: возможна загрузка только из текстового макета';ru='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей%: возможна загрузка только из текстового макета';en='Failed to get the news from the layout% filename% for feeds LentaNovostey%%: possibility to download only from the text layout'");
												ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
												ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
												// Запись в журнал регистрации
												ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									...
									КонецЕсли;
								Исключение
									ТекстСообщения = НСтр("ka='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине %ИнформацияОбОшибке%';ru='Ошибка получения новостей из макета %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине %ИнформацияОбОшибке%';en='Failed to get the news from the layout% filename% for newsfeeds LentaNovostey%%% due InformatsiyaObOshibke%'");
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
									// Запись в журнал регистрации
					...
					КонецЕсли;
				Исключение
					ТекстСообщения = НСтр("ka='Ошибка получения файла %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине %ИнформацияОбОшибке%';ru='Ошибка получения файла %ИмяФайла% для ленты новостей %ЛентаНовостей% по причине %ИнформацияОбОшибке%';en='Error getting file% filename% for feeds LentaNovostey%%% due InformatsiyaObOshibke%'");
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
					// Запись в журнал регистрации
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
						НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка получения файла';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Ошибка получения файла';en='News. Loading news. Download News Files. Error getting file'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
				...
				ТекстШага = НСтр("ka='Загрузка: загрузка файла новостей из ленты новостей %ЛентаНовостей% (протокол %Протокол%, сайт %Сайт%, имя файла %ИмяФайла%)."
"Успешно? %Успешно%';ru='Загрузка: загрузка файла новостей из ленты новостей %ЛентаНовостей% (протокол %Протокол%, сайт %Сайт%, имя файла %ИмяФайла%)."
"Успешно? %Успешно%'");
		...
		ИначеЕсли (ВРег(ТекущееХТТПСоединение.Протокол) = ВРег("http"))
			...
			ТекстШага = НСтр("ka='Загрузка: установка http/https соединения (протокол %Протокол%)."
"Успешно? %СоединениеУстановлено%';ru='Загрузка: установка http/https соединения (протокол %Протокол%)."
					...
					Пока (ФайлПолучен <> Истина) И (ПопыткаПолученияФайла < НастройкиПолученияНовостей.HTTPСоединениеКоличествоПопытокПолученияФайла) Цикл
						Попытка
							...
							// Непосредственно загрузка файла, начало.
								...
								ТекстСообщения = НСтр("ka='Начало попытки %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл %ИмяВременногоФайла%."
"(URL %URL%).';ru='Начало попытки %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл %ИмяВременногоФайла%."
"(URL %URL%).'");
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
									НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Начало загрузки';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Начало загрузки';en='News. Loading news. Download News Files. Getting to the news server files. Start download'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
									, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
...
""
"(URL %URL%)"
"Время загрузки (сек): %ВремяЗагрузки%';ka='При попытке %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл получен ответ сервера с кодом %КодОтвета%, заголовки:"
"%Заголовки%"
""
"(URL %URL%)"
"Время загрузки (сек): %ВремяЗагрузки%'");
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
									НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Конец загрузки';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Конец загрузки';en='News. Loading news. Download News Files. Getting to the news server files. End download'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
									, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
...
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%';ka='Успешное завершение попытки %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл %ИмяВременногоФайла%."
"Получен файл размером %РазмерФайла% байт."
"(URL %URL%)"
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%'");
									...
									ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
										НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Успешная проверка чтения временного файла после загрузки';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Успешная проверка чтения временного файла после загрузки';en='News. Loading news. Download News Files. Getting to the news server files. A successful reading temporary file after loading'"), // ИдентификаторШага
										УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
										, // ОбъектМетаданных
										, // Данные
										ТекстСообщения, // Комментарий
									...
									Исключение
										ИнформацияОбОшибке = ИнформацияОбОшибке();
										ТекстСообщения = НСтр("ka='ЗагрузитьФайлыНовостейССервера (получено из интернет): Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.';ru='ЗагрузитьФайлыНовостейССервера (получено из интернет): Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.'");
										ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяВременногоФайла%", СокрЛП(ИмяВременногоФайла));
...
"(URL %URL%).';ka='Неудачное завершение попытки %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла% получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл %ИмяВременногоФайла% - после попытки загрузки, файла все еще не существует."
"(URL %URL%).'");
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПопыткаПолученияФайла%", ПопыткаПолученияФайла);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%HTTPСоединениеКоличествоПопытокПолученияФайла%", НастройкиПолученияНовостей.HTTPСоединениеКоличествоПопытокПолученияФайла);
									ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
									...
									ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
										НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Ошибка чтения временного файла после загрузки';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Ошибка чтения временного файла после загрузки';en='News. Loading news. Download News Files. Getting to the news server files. Error reading temporary file after loading'"), // ИдентификаторШага
										УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
										, // ОбъектМетаданных
										, // Данные
										ТекстСообщения, // Комментарий
						...
						Исключение
							...
							ТекстСообщения = НСтр("ka='Попытка %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла%. Ошибка получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл по причине: %ИнформацияОбОшибке%';ru='Попытка %ПопыткаПолученияФайла% / %HTTPСоединениеКоличествоПопытокПолученияФайла%. Ошибка получения файла %ИмяФайла% с сервера %Сайт% для ленты новостей %ЛентаНовостей% во временный файл по причине: %ИнформацияОбОшибке%';en='Trying to PopytkaPolucheniyaFayla%% /%% HTTPSoedinenieKolichestvoPopytokPolucheniyaFayla. Error getting file% filename% to% server% Site for news feeds% LentaNovostey% the temporary file for a reason:% InformatsiyaObOshibke%'");
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПопыткаПолученияФайла%", ПопыткаПолученияФайла);
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%HTTPСоединениеКоличествоПопытокПолученияФайла%", НастройкиПолученияНовостей.HTTPСоединениеКоличествоПопытокПолученияФайла);
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", ТекущаяЛентаНовостей.ИмяФайла);
							ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Сайт%", ТекущаяЛентаНовостей.Сайт);
							...
							ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
								НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
								НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Ошибка загрузки';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Получение файлов с сервера новостей. Ошибка загрузки';en='News. Loading news. Download News Files. Getting to the news server files. loading error'"), // ИдентификаторШага
								УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
								, // ОбъектМетаданных
								, // Данные
								ТекстСообщения, // Комментарий
					...
					ТекстШага = НСтр("ka='Загрузка: загрузка файла новостей из ленты новостей %ЛентаНовостей% (протокол %Протокол%, сайт %Сайт%, имя файла %ИмяФайла%, имя файла на сервере %лкИмяФайлаНаСервере%)."
"Успешно? %Успешно%';ru='Загрузка: загрузка файла новостей из ленты новостей %ЛентаНовостей% (протокол %Протокол%, сайт %Сайт%, имя файла %ИмяФайла%, имя файла на сервере %лкИмяФайлаНаСервере%)."
"Успешно? %Успешно%'");
					ТекстШага = СтрЗаменить(ТекстШага, "%ЛентаНовостей%", ТекущаяЛентаНовостей.ЛентаНовостей);
					ТекстШага = СтрЗаменить(ТекстШага, "%Протокол%", ТекущаяЛентаНовостей.Протокол);
					ТекстШага = СтрЗаменить(ТекстШага, "%Сайт%", ТекущаяЛентаНовостей.Сайт);
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Загрузка: помещение ссылок на хранилища в таблицу лент новостей';ru='Загрузка: помещение ссылок на хранилища в таблицу лент новостей';en='Download: placing links to store in the table news feeds'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Загрузка: обработка неактивных лент новостей';ru='Загрузка: обработка неактивных лент новостей';en='Download: inactive processing news feeds'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
"';ka='Завершение загрузки файлов новостей"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Загрузка файлов новостей. Конец';ru='Новости. Загрузка новостей. Загрузка файлов новостей. Конец';en='News. Loading news. Download News Files. the end'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
...
"Время начала (мс): %ТНачало%"
"';ka='Начало парсинга файлов новостей"
"Время начала (мс): %ТНачало%"
"'");
	ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ТНачало%", Т0Начало);
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Начало';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Начало';en='News. Loading news. Parsing news files. Start'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
	...
	Для каждого ТекущаяСтрока Из ЛентыНовостей Цикл
		...
		ТШагЛентаНовостей = ТекущаяУниверсальнаяДатаВМиллисекундах();
		ЕстьОшибки = Ложь;
		СтатусОбработки = НСтр("ka='Начало обработки';ru='Начало обработки';en='Start of treatment'");

		Если (ТекущаяСтрока.Пометка) ИЛИ (ТекущаяСтрока.ОбязательныйКанал) Тогда
			СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Помечена для обработки';ru='Помечена для обработки';en='Labeled for treatment'");
			Если НЕ ПустаяСтрока(ТекущаяСтрока.АдресВХранилище) Тогда
				...
				Если Файл.Существует() Тогда
					...
					Исключение
						...
						ТекстСообщения = НСтр("ka='В загруженном файле для ленты новостей %ЛентаНовостей% находится текст не в формате xml. Лента новостей будет пропущена."
""
"Подробно:"
"%ИнформацияОбОшибке%"
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%';ru='В загруженном файле для ленты новостей %ЛентаНовостей% находится текст не в формате xml. Лента новостей будет пропущена."
""
"Подробно:"
"%ИнформацияОбОшибке%"
""
...
"%ПервыеСтрокиФайла%'");
						...
						ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
							НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
							НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка формата файла';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка формата файла';en='News. Loading news. Parsing news files. Error file format'"), // ИдентификаторШага
							УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
							, // ОбъектМетаданных
							, // Данные
							ТекстСообщения, // Комментарий
							ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
						СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Формат файла не xml, или неправильно сформированный xml';ru='Формат файла не xml, или неправильно сформированный xml';en='no xml file format, or malformed xml'");
						// Пропустить ленту новостей
						ЕстьОшибки = Истина;
					КонецПопытки;
					...
					Если ЕстьОшибки = Ложь Тогда
						...
						ИначеЕсли (НРег(ХМЛТип.ИмяТипа) = "rss") Тогда // И (ВРег(ХМЛТип.URIПространстваИмен)=ВРег("http://www.w3.org/2005/RSS_2_0")).
							...
							Если (ОбъектХДТО.Свойства().Получить("version") = Неопределено) Тогда
								ТекстСообщения = НСтр("ka='Невозможно определить версию rss в ленте новостей %ЛентаНовостей% - отсутствует свойство version. Необходимы данные в формате версии 2.0.';ru='Невозможно определить версию rss в ленте новостей %ЛентаНовостей% - отсутствует свойство version. Необходимы данные в формате версии 2.0.';en='Unable to determine the version of rss in the newswire% LentaNovostey% - there is no version property. Requires data in version 2.0 format.'");
								ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяСтрока.ЛентаНовостей);
								// Запись в журнал регистрации
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
									НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка версии rss';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка версии rss';en='News. Loading news. Parsing news files. Error version rss'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
									, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
									ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
								СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Неправильно сформированный xml: отсутствует свойство version для rss';ru='Неправильно сформированный xml: отсутствует свойство version для rss';en='Malformed xml: no version property for rss'");
								// Пропустить ленту новостей
								ЕстьОшибки = Истина;
							Иначе
								лкВерсия = ОбъектХДТО.Получить("version");
								Если (Число(лкВерсия) <> 2.0) Тогда
									ТекстСообщения = НСтр("ka='Неподдерживаемая версия новостей RSS %version% в ленте новостей %ЛентаНовостей%';ru='Неподдерживаемая версия новостей RSS %version% в ленте новостей %ЛентаНовостей%';en='Unsupported version of news RSS% version% in the newswire% LentaNovostey%'");
									...
									ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
										...
										ТекстСообщения, // Комментарий
										ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
									СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Неправильно сформированный xml: свойство version для rss не равно 2.0';ru='Неправильно сформированный xml: свойство version для rss не равно 2.0';en='Malformed xml: version attribute is not equal to rss 2.0'");
									// Пропустить ленту новостей
									ЕстьОшибки = Истина;
								КонецЕсли;
							КонецЕсли;
...
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%';ka='Неподдерживаемый тип новостей %ТипНовостей% в файле %ИмяФайла% для ленты новостей %ЛентаНовостей%"
""
"Первые строки файла:"
"%ПервыеСтрокиФайла%'");
							...
							ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
								...
								ТекстСообщения, // Комментарий
								ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
							СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Неправильно сформированный xml: ожидаются данные в формате rss (rss.channel) или atom (feed)';ru='Неправильно сформированный xml: ожидаются данные в формате rss (rss.channel) или atom (feed)';en='Malformed xml: expected data format rss (rss.channel) or atom (feed)'");
							// Пропустить ленту новостей.
							ЕстьОшибки = Истина;
						КонецЕсли;
...
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.';ka='ПарсингХМЛФайловНовостей: Не удалось удалить временный файл %ИмяВременногоФайла% для ленты новостей %ЛентаНовостей% по причине:"
"%ИнформацияОбОшибке%"
""
"Рекомендуется вручную удалить этот временный файл.'");
						ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяВременногоФайла%", СокрЛП(ИмяВременногоФайла));
						...
						ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
							НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
							НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка удаления временного файла';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка удаления временного файла';en='News. Loading news. Parsing news files. Error deleting temporary file'"), // ИдентификаторШага
							УровеньЖурналаРегистрации.Предупреждение, // УровеньЖурналаРегистрации.*
							, // ОбъектМетаданных
							, // Данные
							ТекстСообщения, // Комментарий
				...
				Иначе
					ТекстСообщения = НСтр("ka='Отсутствует загруженный файл %ИмяФайла% для ленты новостей %ЛентаНовостей%. Возможно, недостаточно места на диске, нет прав для записи в этот каталог или произошла какая-то другая ошибка.';ru='Отсутствует загруженный файл %ИмяФайла% для ленты новостей %ЛентаНовостей%. Возможно, недостаточно места на диске, нет прав для записи в этот каталог или произошла какая-то другая ошибка.';en='No uploaded file% filename% for feeds% LentaNovostey%. Perhaps out of disk space, do not have permission to write to that directory, or there was some other error.'");
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИмяФайла%", СокрЛП(ИмяВременногоФайла));
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяСтрока.ЛентаНовостей);
					// Запись в журнал регистрации
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
						НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка чтения файла';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка чтения файла';en='News. Loading news. Parsing news files. Error reading file'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
						ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
					СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Не удалось сохранить файл из временного хранилища';ru='Не удалось сохранить файл из временного хранилища';en='Unable to save the file from the temporary storage'");
					// Пропустить ленту новостей.
					ЕстьОшибки = Истина;
				КонецЕсли;

			Иначе
				ТекстСообщения = НСтр("ka='Не загружен файл новостей для ленты новостей %ЛентаНовостей% (пустой адрес в хранилище после загрузки файла [%ЛентаНовостей.ИмяФайла%] с сайта [%ЛентаНовостей.Сайт%] по протоколу [%ЛентаНовостей.Протокол%]). Лента новостей не обработана.';ru='Не загружен файл новостей для ленты новостей %ЛентаНовостей% (пустой адрес в хранилище после загрузки файла [%ЛентаНовостей.ИмяФайла%] с сайта [%ЛентаНовостей.Сайт%] по протоколу [%ЛентаНовостей.Протокол%]). Лента новостей не обработана.';en='Not downloaded file for news feeds% LentaNovostey% (empty address in the repository after downloading the file [% LentaNovostey.ImyaFayla%] site [% LentaNovostey.Sayt%] protocol [% LentaNovostey.Protokol%]). News Feed is not processed.'");
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ТекущаяСтрока.ЛентаНовостей);
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка чтения файла из временного хранилища';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Ошибка чтения файла из временного хранилища';en='News. Loading news. Parsing news files. Error reading the file from the temporary storage'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					Метаданные.Справочники.ЛентыНовостей, // ОбъектМетаданных
					ТекущаяСтрока.ЛентаНовостей, // Данные
					ТекстСообщения, // Комментарий
					ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
				СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Отсутствует файл для обработки (пустой адрес в хранилище)';ru='Отсутствует файл для обработки (пустой адрес в хранилище)';en='Missing file for processing (a blank address in the store)'");
			КонецЕсли;

		Иначе
			СтатусОбработки = СтатусОбработки + ", " + НСтр("ka='Не помечена для обработки';ru='Не помечена для обработки';en='Not marked for processing'");
		КонецЕсли;

		ТекстШага = НСтр("ru='Парсинг: лента новостей %ЛентаНовостей%."
"Статус обработки: %СтатусОбработки%."
"Успешно? %Успешно%';ka='Парсинг: лента новостей %ЛентаНовостей%."
"Статус обработки: %СтатусОбработки%."
"Успешно? %Успешно%'");
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';ka='Завершение парсинга файлов новостей"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Конец';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Конец';en='News. Loading news. Parsing news files. the end'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		Т0Длительность, // Данные
		ТекстСообщения, // Комментарий
...
"Время начала (мс): %ТНачало%"
"';ka='Начало вспомогательных мероприятий после парсинга файлов новостей"
"Время начала (мс): %ТНачало%"
"'");
	ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ТНачало%", Т0Начало);
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Вспомогательные мероприятия после парсинга файлов новостей. Начало';ru='Новости. Загрузка новостей. Вспомогательные мероприятия после парсинга файлов новостей. Начало';en='News. Loading news. Supporting activities after parsing the news files. Start'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
...
#Область ВспомогательныеОбработкиОсновные_КатегорииНовостейПростыеНеобработанные
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия, ПересчитатьНеобработанныеКатегорииНовостей';ru='Парсинг: вспомогательные мероприятия, ПересчитатьНеобработанныеКатегорииНовостей';en='Parsing: supporting activities PereschitatNeobrabotannyeKategoriiNovostey'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
#Область ВспомогательныеОбработкиОсновные_ОптимизацияОтборовПоНовостям
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия, ОптимизироватьОтборыПоНовостям';ru='Парсинг: вспомогательные мероприятия, ОптимизироватьОтборыПоНовостям';en='Parsing: supporting activities OptimizirovatOtboryPoNovostyam'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
#Область ВспомогательныеОбработкиОсновные_ПересчитатьОтборыПоНовостям_РедкоМеняющиеся
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия, ПересчитатьОтборыПоНовостям_РедкоМеняющиеся';ru='Парсинг: вспомогательные мероприятия, ПересчитатьОтборыПоНовостям_РедкоМеняющиеся';en='Parsing: supporting activities PereschitatOtboryPoNovostyam_RedkoMenyayuschiesya'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
#Область ВспомогательныеОбработкиОсновные_ПересчитатьОтборыПоНовостям_Общие
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия, ПересчитатьОтборыПоНовостям_Общие';ru='Парсинг: вспомогательные мероприятия, ПересчитатьОтборыПоНовостям_Общие';en='Parsing: supporting activities PereschitatOtboryPoNovostyam_Obschie'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
#Область ВспомогательныеОбработкиОсновные_ОбновлениеПериодическихСвойствНовостей
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия, ОбновлениеПериодическихСвойствНовостей';ru='Парсинг: вспомогательные мероприятия, ОбновлениеПериодическихСвойствНовостей';en='Parsing: supporting activities ObnovleniePeriodicheskihSvoystvNovostey'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
#Область ВспомогательныеОбработкиОсновные_ОбновлениеПривязокКМетаданным
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия, ОбновлениеПривязокКМетаданным';ru='Парсинг: вспомогательные мероприятия, ОбновлениеПривязокКМетаданным';en='Parsing: supporting activities ObnovleniePrivyazokKMetadannym'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';ka='Завершение вспомогательных мероприятий после парсинга файлов новостей"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Вспомогательные мероприятия после парсинга файлов новостей. Конец';ru='Новости. Загрузка новостей. Вспомогательные мероприятия после парсинга файлов новостей. Конец';en='News. Loading news. Supporting activities after parsing the news files. the end'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		Т0Длительность, // Данные
		ТекстСообщения, // Комментарий
...
"Время начала (мс): %ТНачало%"
"';ka='Начало настроенных разработчиками мероприятий после парсинга файлов новостей"
"Время начала (мс): %ТНачало%"
"'");
	ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ТНачало%", Т0Начало);
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Настроенные разработчиками мероприятия после парсинга файлов новостей. Начало';ru='Новости. Загрузка новостей. Настроенные разработчиками мероприятия после парсинга файлов новостей. Начало';en='News. Loading news. Minded developers event after parsing the news files. Start'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
	...
	ЛогШаговВыполнения.Добавить(
		Новый Структура("Шаг, ВремяНачала, ВремяОкончания",
			НСтр("ka='Парсинг: вспомогательные мероприятия (переопределяемые), ДополнительноОбработатьНовостиПослеПолучения';ru='Парсинг: вспомогательные мероприятия (переопределяемые), ДополнительноОбработатьНовостиПослеПолучения';en='Parsing: supporting activities (redefined) DopolnitelnoObrabotatNovostiPoslePolucheniya'"),
			ТШаг,
			ТекущаяУниверсальнаяДатаВМиллисекундах()));
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';ka='Завершение настроенных разработчиками мероприятий после парсинга файлов новостей"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Настроенные разработчиками мероприятия после парсинга файлов новостей. Конец';ru='Новости. Загрузка новостей. Настроенные разработчиками мероприятия после парсинга файлов новостей. Конец';en='News. Loading news. Minded developers event after parsing the news files. the end'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		Т0Длительность, // Данные
		ТекстСообщения, // Комментарий
	...
	Если НЕ Результат.Пустой() Тогда
		...
		Для каждого ТекущаяСтрока Из ТаблицаОбновляемыхДанных Цикл
			Если ТипЗнч(ТекущаяСтрока.Список) = Тип("ПланВидовХарактеристикСсылка.КатегорииНовостей") Тогда
				ТекстСообщения = НСтр("ka='Загрузка значений категории %Выборка.Список% (%Выборка.Список.Код%)';ru='Загрузка значений категории %Выборка.Список% (%Выборка.Список.Код%)';en='Loading values ​​category Vyborka.Spisok%% (% Vyborka.Spisok.Kod%)'");
			...
			Иначе
				Если ТекущаяСтрока.Список = "Список лент новостей" Тогда // Идентификатор.
					ТекстСообщения = НСтр("ka='Загрузка списка лент новостей';ru='Загрузка списка лент новостей';en='Download your feed list'");
					ТекущаяСтрока.ПредставлениеДляЗагрузки = ТекстСообщения;
				ИначеЕсли ТекущаяСтрока.Список = "Список категорий новостей" Тогда // Идентификатор.
					ТекстСообщения = НСтр("ka='Загрузка списка категорий новостей';ru='Загрузка списка категорий новостей';en='Downloading news category list'");
					ТекущаяСтрока.ПредставлениеДляЗагрузки = ТекстСообщения;
				ИначеЕсли Найти(ВРег(ТекущаяСтрока.Список), ВРег("Значения категории новостей:")) = 1 Тогда // Идентификатор.
					ТекстСообщения = НСтр("ka='Загрузка значений категории с кодом %Выборка.Список%';ru='Загрузка значений категории с кодом %Выборка.Список%';en='Loading values ​​category code% Vyborka.Spisok%'");
...
"%ТаблицаОбновляемыхДанных%';ka='УправлениеНовостями.ПолучитьСтандартныеСпискиТребующиеОбновления, Таблица обновляемых данных:"
"%ТаблицаОбновляемыхДанных%'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		...
		НСтр("ka='Новости. Сервис и регламент. ИнформацияОбОбновлении';ru='Новости. Сервис и регламент. ИнформацияОбОбновлении';en='News. Service and regulations. InformatsiyaObObnovlenii'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
...
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';ka='Ошибка обновления списка значений категории новостей (Прокси.getUpdatedCategoryValuesByCode):"
"sCategoryCode = %СокрЛП(Список.Код)%"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка классификаторов. Список значений категории. Ошибка';ru='Новости. Загрузка классификаторов. Список значений категории. Ошибка';en='News. Loading classifiers. List of Values ​​category. Mistake'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
			...
			Если ТипЗнч(СписокОбновленныхДанных) = ТипОбъектXDTO Тогда
				...
				ТекстСообщения = НСтр("ka='Информация об обновлении значений категорий новостей (Прокси.getUpdatedCategoryValuesByCode):"
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';ru='Информация об обновлении значений категорий новостей (Прокси.getUpdatedCategoryValuesByCode):"
"configName = %configName%"
"configVersion = %configVersion%"
"Код категории: %КодКатегории%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
...
"%Данные%'");
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка классификаторов. Список значений категории. Информация';ru='Новости. Загрузка классификаторов. Список значений категории. Информация';en='News. Loading classifiers. List of Values ​​category. Information'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
...
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';ka='Ошибка записи элемента (%Режим%) с уникальным идентификатором %ТекущаяСтрокаХДТО.guid%:"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
...
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';ka='Ошибка обновления списка лент новостей (Прокси.getUpdatedChannels):"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%errCode%", errCode);
			...
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка классификаторов. Список лент новостей. Ошибка';ru='Новости. Загрузка классификаторов. Список лент новостей. Ошибка';en='News. Loading classifiers. A list of news feeds. Mistake'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
		...
		Если ТипЗнч(СписокОбновленныхДанных) = ТипОбъектXDTO Тогда
			...
			ТекстСообщения = НСтр("ka='Информация об обновлении списка лент новостей (Прокси.getUpdatedChannels):"
"configName = %configName%"
"configVersion = %configVersion%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
"errCode = %errCode%"
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';ru='Информация об обновлении списка лент новостей (Прокси.getUpdatedChannels):"
"configName = %configName%"
"configVersion = %configVersion%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
"errCode = %errCode%"
...
"%Данные%'");
			...
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка классификаторов. Список лент новостей. Информация';ru='Новости. Загрузка классификаторов. Список лент новостей. Информация';en='News. Loading classifiers. A list of news feeds. Information'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
...
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';ka='Ошибка обновления списка лент новостей (Прокси.getAllChannels):"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%errCode%", errCode);
		...
		Если ТипЗнч(СписокВсехДанных) = ТипОбъектXDTO Тогда
			...
			ТекстСообщения = НСтр("ka='Информация об обновлении списка лент новостей (Прокси.getAllChannels):"
"configName = %configName%"
"configVersion = %configVersion%"
"errCode = %errCode%"
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';ru='Информация об обновлении списка лент новостей (Прокси.getAllChannels):"
"configName = %configName%"
"configVersion = %configVersion%"
"errCode = %errCode%"
"errDescription = %errDescription%"
				...
				Если ТипЗнч(СписокВсехДанных.channel) = ТипСписокXDTO Тогда // Правильно сработает, даже если передали только одно значение.
					...
					Для Каждого ТекущийЭлементСписка Из СписокВсехЗагруженныхСерверныхЛентНовостей Цикл
						Если ТекущийЭлементСписка.Пометка = Ложь Тогда
							...
							ТекстСообщения = НСтр("ka='Лента новостей %ЛентаНовостейНаименование% помечена на удаление, т.к. она была отключена на сервере 1С';ru='Лента новостей %ЛентаНовостейНаименование% помечена на удаление, т.к. она была отключена на сервере 1С';en='Newsline% LentaNovosteyNaimenovanie% tagged for deletion because it has been disabled on the server 1C'");
							...
							ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
								...
								НСтр("ka='Новости. Все обновления новостей. Обновление классификаторов. Отключение ленты новостей';ru='Новости. Все обновления новостей. Обновление классификаторов. Отключение ленты новостей';en='News. All news updates. Update of classifiers. Disabling news feeds'"), // ИдентификаторШага
								УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
								, // ОбъектМетаданных
								, // Данные
								ТекстСообщения, // Комментарий
...
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';ka='Ошибка обновления списка категорий новостей (Прокси.getUpdatedCategories):"
"errCode = %errCode%"
"errDescription = %errDescription%"
"%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%errCode%", errCode);
			...
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка классификаторов. Список категорий. Ошибка';ru='Новости. Загрузка классификаторов. Список категорий. Ошибка';en='News. Loading classifiers. List categories. Mistake'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
		...
		Если ТипЗнч(СписокОбновленныхДанных) = ТипОбъектXDTO Тогда
			...
			ТекстСообщения = НСтр("ka='Информация об обновлении списка категорий новостей (Прокси.getUpdatedCategories):"
"configName = %configName%"
"configVersion = %configVersion%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
"errCode = %errCode%"
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';ru='Информация об обновлении списка категорий новостей (Прокси.getUpdatedCategories):"
"configName = %configName%"
"configVersion = %configVersion%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
"errCode = %errCode%"
		...
		Если НЕ ПустаяСтрока(СписокУИН) Тогда
			...
			Если НЕ ПустаяСтрока(Владелец.ВерсияДанных) Тогда
				...
				Исключение
					...
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
						НСтр("ka='Новости. Загрузка классификаторов. Список значений категории (по УИН). Ошибка';ru='Новости. Загрузка классификаторов. Список значений категории (по УИН). Ошибка';en='News. Loading classifiers. The list of categories of values ​​(by UIN). Mistake'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
				...
				Если ТипЗнч(СписокОбновленныхДанных) = ТипОбъектXDTO Тогда
					...
					ТекстСообщения = НСтр("ka='Информация об обновлении значений категорий новостей (Прокси.getUpdatedCategoryValuesByGuid):"
"configName = %configName%"
"configVersion = %configVersion%"
...
"errDescription = %errDescription%"
"Полученные данные:"
"%Данные%';ru='Информация об обновлении значений категорий новостей (Прокси.getUpdatedCategoryValuesByGuid):"
"configName = %configName%"
"configVersion = %configVersion%"
"УИН категории: %СписокУИН%"
"lastSynchronizationDateTime = %lastSynchronizationDateTime%"
...
"%Данные%'");
					...
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
						НСтр("ka='Новости. Загрузка классификаторов. Список значений категории (по УИН). Информация';ru='Новости. Загрузка классификаторов. Список значений категории (по УИН). Информация';en='News. Loading classifiers. The list of categories of values ​​(by UIN). Information'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
						, // ОбъектМетаданных
						, // Данные
						ТекстСообщения, // Комментарий
...
"configVersion = %configVersion%"
"Время начала (мс): %ТНачало%"
"';ka='Получение списка последних обновлений, начало"
"configName = %configName%"
"configVersion = %configVersion%"
"Время начала (мс): %ТНачало%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка классификаторов. Список обновлений классификаторов. Начало';ru='Новости. Загрузка классификаторов. Список обновлений классификаторов. Начало';en='News. Loading classifiers. List classifiers updates. Start'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
	...
	Иначе
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ДатыОбновленияСписков%", НСтр("ka='Получено значение с типом значения, отличным от ОбъектXDTO';ru='Получено значение с типом значения, отличным от ОбъектXDTO';en='The value obtained with the type of value other than ObektXDTO'"));
	КонецЕсли;
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка классификаторов. Список обновлений классификаторов. Выполнение';ru='Новости. Загрузка классификаторов. Список обновлений классификаторов. Выполнение';en='News. Loading classifiers. List classifiers updates. Performance'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		Метаданные.РегламентныеЗадания.ВсеОбновленияНовостей, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';ka='Получение списка последних обновлений, завершение"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка классификаторов. Список обновлений классификаторов. Конец';ru='Новости. Загрузка классификаторов. Список обновлений классификаторов. Конец';en='News. Loading classifiers. List classifiers updates. the end'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		Метаданные.РегламентныеЗадания.ВсеОбновленияНовостей, // ОбъектМетаданных
		Т0Длительность, // Данные
		ТекстСообщения, // Комментарий
...
"Время начала (мс): %ТНачало%"
"';ka='Начало парсинга файла новостей для ленты новостей %ЛентаНовостей%"
"Время начала (мс): %ТНачало%"
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Начало';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Начало';en='News. Loading news. Parsing news files. Parsing news file. Start'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
...
"Определен формат ленты новостей: %ФорматНовостей%';ka='Парсинг файла новостей для ленты новостей %ЛентаНовостей%"
"Определен формат ленты новостей: %ФорматНовостей%'");
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
			НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Выполнение';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Выполнение';en='News. Loading news. Parsing news files. Parsing news file. Performance'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			ТекстСообщения, // Комментарий
		...
		Если ТипЗнч(ОбъектХДТО.Свойства().Получить("channel")) = ТипСвойствоXDTO
			...
			Если ОбъектХДТО.Свойства().Получить("channel") <> Неопределено Тогда
				...
				Иначе
					...
					// Запись в журнал регистрации
					ТекстСообщения = НСтр("ka='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует поле channel.lastBuildDate. Все новости будут прочитаны и загружены, но это займет больше времени.';ru='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует поле channel.lastBuildDate. Все новости будут прочитаны и загружены, но это займет больше времени.';en='The file obtained for news feeds% LentaNovostey% field is missing channel.lastBuildDate. All news will be read and downloaded, but it will take more time.'");
					ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
					ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
						НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
						НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей';en='News. Loading news. Parsing news files. Parsing news file'"), // ИдентификаторШага
						УровеньЖурналаРегистрации.Предупреждение, // УровеньЖурналаРегистрации.*
			...
			Иначе
				// Запись в журнал регистрации
				ТекстСообщения = НСтр("ka='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует обязательное поле channel. Файл не был обработан.';ru='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует обязательное поле channel. Файл не был обработан.';en='The file obtained for news feeds% LentaNovostey% missing a required field channel. The file was not processed.'");
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Ошибка';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Ошибка';en='News. Loading news. Parsing news files. Parsing news file. Mistake'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					Метаданные.Справочники.Новости, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
...
"Определен формат ленты новостей: %ФорматНовостей%'");
		...
		Иначе // updated - обязательное поле, наверное формат некорректный
			ДатаЗагрузкиПоследнихНовостейВФайле = '00010101';
			// Запись в журнал регистрации
			ТекстСообщения = НСтр("ka='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует поле feed.updated. Все новости будут прочитаны и загружены, но это займет больше времени.';ru='В файле полученном для ленты новостей %ЛентаНовостей% отсутствует поле feed.updated. Все новости будут прочитаны и загружены, но это займет больше времени.';en='The file obtained for news feeds% LentaNovostey% no feed.updated field. All news will be read and downloaded, but it will take more time.'");
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Предупреждение';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Предупреждение';en='News. Loading news. Parsing news files. Parsing news file. A warning'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Предупреждение, // УровеньЖурналаРегистрации.*
				Метаданные.Справочники.Новости, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
	...
	Иначе
		...
		РезультатЗагрузкиНовостей = НСтр("ka='Новости не загружены, т.к. передан необрабатываемый формат ленты новостей.';ru='Новости не загружены, т.к. передан необрабатываемый формат ленты новостей.';en='The news is not loaded, because passed unprocessed newsfeeds format.'");

		ТекстСообщения = НСтр("ru='Парсинг файла новостей для ленты новостей %ЛентаНовостей%"
"Не обрабатываемый формат ленты новостей: %ФорматНовостей%';ka='Парсинг файла новостей для ленты новостей %ЛентаНовостей%"
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';ka='Завершение парсинга файла новостей для ленты новостей %ЛентаНовостей%."
"Результат загрузки новостей:"
"%РезультатЗагрузкиНовостей%"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
...
"'");
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Конец';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Конец';en='News. Loading news. Parsing news files. Parsing news file. the end'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		Т0Длительность, // Данные
		ТекстСообщения, // Комментарий
...
"Время начала (мс): %ТНачало%"
"';ka='Начало попытки записи новости с данными:"
"заголовок [%ЗаголовокНовости%], УИН [%УИННовости%], лента новостей [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публикации [%ДатаПубликации%]."
"Время начала (мс): %ТНачало%"
"'");
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
...
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"';ka='Успешная попытка записи новости с данными:"
"заголовок [%ЗаголовокНовости%], УИН [%УИННовости%], лента новостей [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публикации [%ДатаПубликации%], УИН в ИБ [%УИН_ИБ%]."
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
"'");
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Запись новости. Конец';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Запись новости. Конец';en='News. Loading news. Parsing news files. Parsing news file. Parsing news. Record news. the end'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
...
"заголовок [%ЗаголовокНовости%], УИН [%УИННовости%], лента новостей [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публикации [%ДатаПубликации%],"
"по причине: %ИнформацияОбОшибке%';ka='Неудачная попытка записи новости с данными:"
"заголовок [%ЗаголовокНовости%], УИН [%УИННовости%], лента новостей [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публикации [%ДатаПубликации%],"
"по причине: %ИнформацияОбОшибке%'");
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Запись новости. Ошибка';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Запись новости. Ошибка';en='News. Loading news. Parsing news files. Parsing news file. Parsing news. Record news. Mistake'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					Метаданные.Справочники.Новости, // ОбъектМетаданных
...
"Возможно, новость уже существует в базе с такой же датой публикации или (при отмене публикации) этой новости нет в базе.';ka='Новость пропущена, ее данные:"
"заголовок [%ЗаголовокНовости%], УИН [%УИННовости%], лента новостей [%ЛентаНовостей%], формат [%ФорматНовостей%], дата публикации [%ДатаПубликации%], %ЗначениеПометкаУдаления%, %СуществуетВБазе%."
"Возможно, новость уже существует в базе с такой же датой публикации или (при отмене публикации) этой новости нет в базе.'");
			...
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЛентаНовостей%", ЛентаНовостей);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ФорматНовостей%", ФорматНовостей);
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ЗначениеПометкаУдаления%", ?(ЗначениеПометкаУдаления = Истина, НСтр("ka='на сервере публикация отменена';ru='на сервере публикация отменена';en='publication on the server canceled'"), НСтр("ka='опубликована на сервере';ru='опубликована на сервере';en='published on the server'")));
			ТекстСообщения = СтрЗаменить(ТекстСообщения, "%СуществуетВБазе%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ka='в базе еще не создана';ru='в базе еще не создана';en='the database does not exist yet'"), НСтр("ka='существует в базе';ru='существует в базе';en='It exists in the'")));
			// Запись в журнал регистрации
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Запись новости. Новость пропущена';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Запись новости. Новость пропущена';en='News. Loading news. Parsing news files. Parsing news file. Parsing news. Record news. news skipped'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
		...
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%ЗаписыватьНовость%", ?(ЗаписыватьНовость = Истина, НСтр("ka='Будет записана';ru='Будет записана';en='It will be recorded'"), НСтр("ka='Будет пропущена';ru='Будет пропущена';en='will be skipped'")));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%СуществуетВБазе%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ka='В базе еще не создана';ru='В базе еще не создана';en='The database has not been created'"), НСтр("ka='Уже существует в базе';ru='Уже существует в базе';en='Already exists in the database'")));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%ДатаПубликацииИБ%", ?(СтруктураНовости.Ссылка.Пустая(), " " + НСтр("ka='(в базе не было)';ru='(в базе не было)';en='(In the database was not)'"), " (" + Формат(ДатаПубликацииИБ, "ДЛФ=DT") + ")"));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%ЗначениеПометкаУдаленияИБ%", ?(СтруктураНовости.Ссылка.Пустая(), " " + НСтр("ka='(в базе не было)';ru='(в базе не было)';en='(In the database was not)'"), " (" + ЗначениеПометкаУдаленияИБ + ")"));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%УИН_ИБ%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ka='(еще не создана)';ru='(еще не создана)';en='(Not yet established)'"), СтруктураНовости.УИН_ИБ));
		РезультатЗагрузкиНовости = СтрЗаменить(РезультатЗагрузкиНовости, "%НавигационнаяСсылка%", ?(СтруктураНовости.Ссылка.Пустая(), НСтр("ka='(еще не создана)';ru='(еще не создана)';en='(Not yet established)'"), ПолучитьНавигационнуюСсылку(СтруктураНовости.Ссылка)));
	...
	Если ТипЗнч(ДанныеХДТО) = ТипОбъектXDTO Тогда
		...
		Если ТипЗнч(СвойствоДвоичныеДанные) = ТипСвойствоXDTO Тогда
			...
			Исключение
				Данные = Неопределено;
				ИнформацияОбОшибке = ИнформацияОбОшибке();
				ТекстСообщения = НСтр("ka='Не удалось загрузить бинарные данные для новости с УИН %ОбъектНовость.УИННовости% по причине: %ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';ru='Не удалось загрузить бинарные данные для новости с УИН %ОбъектНовость.УИННовости% по причине: %ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%';en='Failed to load the binary data for news from UIN% ObektNovost.UINNovosti% due to:% PodrobnoePredstavlenieOshibki (InformatsiyaObOshibke)%'");
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "ОбъектНовость.УИННовости", ОбъектНовость.УИННовости);
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПодробноеПредставлениеОшибки(ИнформацияОбОшибке)%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Чтение новости. Блок бинарных данных';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Парсинг новости. Чтение новости. Блок бинарных данных';en='News. Loading news. Parsing news files. Parsing news file. Parsing news. Reading the news. Block of binary data'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
...
Процедура ЗагрузитьДатуПоследнегоОбновленияСтандартногоСписка(Обновление)
	...
	Если ТипЗнч(Обновление) = ТипОбъектXDTO Тогда
		Попытка
			...
			КонецЕсли;
		Исключение
				ТекстСообщения = НСтр("ka='Ошибка загрузки строки обновления списков: %ИнформацияОбОшибке%';ru='Ошибка загрузки строки обновления списков: %ИнформацияОбОшибке%';en='line error loading lists of renovation:% InformatsiyaObOshibke%'");
				ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
				// Запись в журнал регистрации
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("ka='БИП:სიახლეები. სიახლეების ატვირთვა';ru='БИП:Новости.Загрузка новостей';en='BIP: Novosti.Zagruzka news'"), // ИмяСобытия
					НСтр("ka='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Блок дат обновления списков';ru='Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей. Блок дат обновления списков';en='News. Loading news. Parsing news files. Parsing news file. Date of renovation Block lists'"), // ИдентификаторШага
					УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
					, // ОбъектМетаданных
					, // Данные
					ТекстСообщения, // Комментарий
			...
			Если ТипЗнч(ОбъектХДТО.categoriesRefList.categoryRef) = ТипСписокXDTO Тогда // Правильно сработает, даже если передали только одно значение.
				...
				Пока БылиУдаления = Истина Цикл
					...
					Для каждого ТекущаяКатегория Из лкОбъект.ДоступныеКатегорииНовостей Цикл
						...
						Если КатегорияЕстьНаСервере = Ложь Тогда
							ТекстСообщения = НСтр("ka='Из ленты новостей %Наименование% удалена категория %Категория%.';ru='Из ленты новостей %Наименование% удалена категория %Категория%.';en='From news feeds% name% Remove Category% Category%.'");
							...
							ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
								НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
								НСтр("ka='Новости. Загрузка классификаторов. Список лент новостей. Лента новостей';ru='Новости. Загрузка классификаторов. Список лент новостей. Лента новостей';en='News. Loading classifiers. A list of news feeds. timeline'"), // ИдентификаторШага
								УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
								, // ОбъектМетаданных
								, // Данные
								ТекстСообщения, // Комментарий
				...
				Для каждого ТекущаяКатегория Из МассивДоступныхКатегорий Цикл
					...
					Если КатегорияЕстьНаКлиенте = Ложь Тогда
						ТекстСообщения = НСтр("ka='В ленте новостей %Наименование% добавлена категория %Категория%.';ru='В ленте новостей %Наименование% добавлена категория %Категория%.';en='The newswire% Name% is added category% category%.'");
						ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Наименование%", СокрЛП(лкОбъект.Наименование));
...
Функция ПодключитьсяКВебСервисуОбновленияСтандартныхСписков()
	...
	ТекстСообщения = НСтр("ka='Начало загрузки стандартных списков"
"МестоположениеWSDL = %МестоположениеWSDL%';ru='Начало загрузки стандартных списков"
"МестоположениеWSDL = %МестоположениеWSDL%'");
	ТекстСообщения = СтрЗаменить(ТекстСообщения, "%МестоположениеWSDL%", МестоположениеWSDL);
	// Запись в журнал регистрации
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
		НСтр("ka='Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков. Начало';ru='Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков. Начало';en='News. Loading classifiers. The connection to the web service updates the standard lists. Start'"), // ИдентификаторШага
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
	...
	Попытка
		...
		Если ТипЗнч(Прокси) <> ТипWSПрокси Тогда
			ТекстСообщения = НСтр("ka='Неудачное подключение к веб-сервису обновления стандартных списков';ru='Неудачное подключение к веб-сервису обновления стандартных списков';en='Unsuccessful connection to the Web service updates the standard lists'");
			// Запись в журнал регистрации
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков. Ошибка';ru='Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков. Ошибка';en='News. Loading classifiers. The connection to the web service updates the standard lists. Mistake'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		Иначе
			ТекстСообщения = НСтр("ka='Успешное подключение к веб-сервису обновления стандартных списков';ru='Успешное подключение к веб-сервису обновления стандартных списков';en='Successfully connected to the Web service updates the standard lists'");
			// Запись в журнал регистрации
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:Новости.Загрузка классификаторов';ru='БИП:Новости.Загрузка классификаторов';en='BIP: Novosti.Zagruzka classifiers'"), // ИмяСобытия
				НСтр("ka='Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков. Конец';ru='Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков. Конец';en='News. Loading classifiers. The connection to the web service updates the standard lists. the end'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
				, // ОбъектМетаданных
				, // Данные
				ТекстСообщения, // Комментарий
...
"%ИнформацияОбОшибке%';ka='Неудачное подключение к веб-сервису обновления стандартных списков по причине:"
"%ИнформацияОбОшибке%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ИнформацияОбОшибке%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
		// Запись в журнал регистрации
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
