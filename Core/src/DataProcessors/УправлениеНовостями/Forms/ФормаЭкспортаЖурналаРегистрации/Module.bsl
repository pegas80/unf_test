...
"Данные не удалось поместить во временное хранилище.';ka='Не удалось экспортировать события журнала регистрации в файл."
...
"%1';ka='Журнал событий успешно экспортирован в файл с именем"
"%1'"),
							ИмяФайла);
						ЭтаФорма.РезультатЭкспорта = ТекстСообщения;
					Исключение
...
"%1';ka='Не удалось записать файл по причине:"
"%1'"),
...
"Во временное хранилище помещены данные неправильного типа %1.';ka='Не удалось экспортировать события журнала регистрации в файл."
