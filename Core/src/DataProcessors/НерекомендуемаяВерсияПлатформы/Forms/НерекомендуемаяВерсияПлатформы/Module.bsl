...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстУсловие = ?(Параметры.ЗавершитьРаботу, НСтр("ka='აუცილებელი';ru='необходимо'"), НСтр("ka='რეკომუნდებულია';ru='рекомендуется'"));
	...
	Если Параметры.ЗавершитьРаботу Тогда
		...
		Заголовок = НСтр("ka='აუცილებელია პლატფორმის ვერსიის განახლება';ru='Необходимо обновить версию платформы'");
	КонецЕсли;
