...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстУсловие = ?(Параметры.ЗавершитьРаботу, НСтр("ka='აუცილებელი';ru='необходимо';en='must'"), НСтр("ka='რეკომუნდებულია';ru='рекомендуется';en='recommended'"));
	...
	Если Параметры.ЗавершитьРаботу Тогда
		...
		Заголовок = НСтр("ka='აუცილებელია პლატფორმის ვერსიის განახლება';ru='Необходимо обновить версию платформы';en='You must update the version of the platform'");
	КонецЕсли;
