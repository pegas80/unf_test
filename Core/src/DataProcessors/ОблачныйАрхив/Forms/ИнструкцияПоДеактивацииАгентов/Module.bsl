...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.КоманднаяСтрокаДругойКомпьютер = 
		НСтр("ka='<Путь к установленному Агенту резервного копирования>';ru='<Путь к установленному Агенту резервного копирования>'")
		+ ПолучитьРазделительПути()
		+ "BackupAgent.exe stop_backup -db_id="
		+ ИдентификаторИБ_Полный;
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		ТекстПодсказки = НСтр("ka='Агенты резервного копирования были установлены на следующих компьютерах:';ru='Агенты резервного копирования были установлены на следующих компьютерах:'")
			+ Символы.ПС
			+ ТекстПодсказки;
