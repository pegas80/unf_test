...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(1, НСтр("ka='ორშაბათი';ru='Понедельник'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(2, НСтр("ka='სამშაბათი';ru='Вторник'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(3, НСтр("ka='ოთხშაბათი';ru='Среда'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(4, НСтр("ka='ხუთშაბათი';ru='Четверг'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(5, НСтр("ka='პარასკევი';ru='Пятница'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(6, НСтр("ka='შაბათი';ru='Суббота'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(7, НСтр("ka='კვირა დღე';ru='Воскресенье'"), Ложь);

	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Очистить();
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(1, НСтр("ka='ორშაბათი';ru='Понедельник'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(2, НСтр("ka='სამშაბათი';ru='Вторник'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(3, НСтр("ka='ოთხშაბათი';ru='Среда'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(4, НСтр("ka='ხუთშაბათი';ru='Четверг'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(5, НСтр("ka='პარასკევი';ru='Пятница'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(6, НСтр("ka='შაბათი';ru='Суббота'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(7, НСтр("ka='კვირა დღე';ru='Воскресенье'"), Ложь);
...
Процедура КомандаЗаписатьИЗакрыть(Команда)
	...
	Если ПустаяСтрока(ЭтаФорма.Вариант) Тогда
		ПоказатьОповещениеПользователя(
			,
			,
			НСтр("ka='Расписание не было настроено';ru='Расписание не было настроено'"),
