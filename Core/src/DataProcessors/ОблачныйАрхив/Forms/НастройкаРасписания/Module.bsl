...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(1, НСтр("ka='ორშაბათი';ru='Понедельник';en='Monday'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(2, НСтр("ka='სამშაბათი';ru='Вторник';en='Tuesday'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(3, НСтр("ka='ოთხშაბათი';ru='Среда';en='Wednesday'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(4, НСтр("ka='ხუთშაბათი';ru='Четверг';en='Thursday'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(5, НСтр("ka='პარასკევი';ru='Пятница';en='Friday'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(6, НСтр("ka='შაბათი';ru='Суббота';en='Saturday'"), Ложь);
	ЭтаФорма.Еженедельно_ДниНедели.Добавить(7, НСтр("ka='კვირა დღე';ru='Воскресенье';en='Sunday'"), Ложь);

	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Очистить();
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(1, НСтр("ka='ორშაბათი';ru='Понедельник';en='Monday'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(2, НСтр("ka='სამშაბათი';ru='Вторник';en='Tuesday'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(3, НСтр("ka='ოთხშაბათი';ru='Среда';en='Wednesday'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(4, НСтр("ka='ხუთშაბათი';ru='Четверг';en='Thursday'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(5, НСтр("ka='პარასკევი';ru='Пятница';en='Friday'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(6, НСтр("ka='შაბათი';ru='Суббота';en='Saturday'"), Ложь);
	ЭтаФорма.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(7, НСтр("ka='კვირა დღე';ru='Воскресенье';en='Sunday'"), Ложь);
...
Процедура КомандаЗаписатьИЗакрыть(Команда)
	...
	Если ПустаяСтрока(ЭтаФорма.Вариант) Тогда
		ПоказатьОповещениеПользователя(
			,
			,
			НСтр("ka='Расписание не было настроено';ru='Расписание не было настроено';en='The schedule was not set'"),
