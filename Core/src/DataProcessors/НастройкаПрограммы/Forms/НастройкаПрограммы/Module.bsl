...
Процедура Отправить(Команда)
	...
	Получатель.Добавить("info@erpcompact.ge", "ONESOFT");


	ПараметрыПисьма = Новый Структура;
	ПараметрыПисьма.Вставить("Получатель", Получатель);
	ПараметрыПисьма.Вставить("Тема", НСтр("ka='მინდა ეს შესაძლებლობები მომავალ ვერსიაში';ru='Хочу эти возможности в будущей версии';en='I want these features in a future version'"));
...
Процедура СформироватьОписанияРазделов(СтрокиДерева)
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		Если СтрокаДерева.Строки.Количество() = 0 Тогда
			...
			ГруппаПотенциальные.Заголовок = НСтр("ka='მინდა ეს შესაძლებლობები მომავალ ვერსიაში';ru='Хочу эти возможности в будущей версии';en='I want these features in a future version'");
			...
			ГруппаСвояВозможность.Заголовок = НСтр("ka='ვერ ნახეთ საჭირო შესაძლებობა? შემოგვთავაზეთ თქვენი';ru='Не нашли нужную возможность? Предложите свою';en='We did not find the right opportunity? Make an'");
