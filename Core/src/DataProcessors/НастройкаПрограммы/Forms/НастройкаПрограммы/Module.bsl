...
Процедура Отправить(Команда)
	...
	ПараметрыПисьма.Вставить("Тема", НСтр("ka='მინდა ეს შესაძლებლობები მომავალ ვერსიაში';ru='Хочу эти возможности в будущей версии'"));
...
Процедура СформироватьОписанияРазделов(СтрокиДерева)
	...
	Для Каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		Если СтрокаДерева.Строки.Количество() = 0 Тогда
			...
			ГруппаПотенциальные.Заголовок = НСтр("ka='მინდა ეს შესაძლებლობები მომავალ ვერსიაში';ru='Хочу эти возможности в будущей версии'");
			...
			ГруппаСвояВозможность.Заголовок = НСтр("ka='ვერ ნახეთ საჭირო შესაძლებობა? შემოგვთავაზეთ თქვენი';ru='Не нашли нужную возможность? Предложите свою'");
