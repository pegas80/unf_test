...
Процедура ОжиданиеПолученияДанных_ОбработкаДлительнойОперации(Отказ)
	...
	Попытка
		...
		Иначе
			...
			ВызватьИсключение НСтр("ka='Неизвестный режим получения данных корреспондента.';ru='Неизвестный режим получения данных корреспондента.';en='Unknown mode data acquisition correspondent.'");
