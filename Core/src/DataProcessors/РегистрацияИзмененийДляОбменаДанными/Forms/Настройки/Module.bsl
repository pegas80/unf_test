...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТекущийОбъект.ЭтоФайловаяБаза() Тогда
		...
		Если ТекЭлемент <> Неопределено Тогда
			ТекЭлемент.Представление = НСтр("ka='В каталоге:';ru='В каталоге:'");
		КонецЕсли;
	КонецЕсли;
...
#Иначе
	ВызватьИсключение(НСтр("ka='В WEB-клиенте данная возможность недоступна.';ru='В WEB-клиенте данная возможность недоступна.'"));
#КонецЕсли
...
Процедура ПослеПроверкиРасширенияРаботыСФайлами(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат Тогда
		...
		Диалог.Фильтр = НСтр("ka='Внешние обработки (*.epf)|*.epf';ru='Внешние обработки (*.epf)|*.epf'");
