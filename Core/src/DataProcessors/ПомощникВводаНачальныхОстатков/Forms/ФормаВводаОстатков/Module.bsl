...
Процедура ВидЦенСебестоимостиОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ВыбранноеЗначение) Тогда
		...
		ПоказатьВопрос(Оповещение, НСтр("ka='Обновить цены в таблице товаров?';ru='Обновить цены в таблице товаров?'"), РежимДиалогаВопрос.ДаНетОтмена,, КодВозвратаДиалога.Да);
	КонецЕсли; 
...
Процедура ПоискПоШтрихкоду(Команда)
	...
	ПоказатьВводЗначения(Оповещение, ТекШтрихкод, НСтр("ka='შეიყვანეთ შტრიხკოდი';ru='Введите штрихкод'"));
...
Процедура ЗагрузитьВводыОстатков()
	...
	Пока ВыборкаРезультатЗапроса.Следующий() Цикл
		...
		Элементы.ДатаОстатков.ПредупреждениеПриРедактировании = НСтр("ka='Дата именится также для всех остатков, введенных ранее';ru='Дата именится также для всех остатков, введенных ранее'");
...
Процедура УстановитьТекстПояснения()
	...
	Если ТекущийНомерСтраницы = 0 Тогда
		Элементы.ДекорацияПояснеиеСледующегоДействия.Заголовок =НСтр("ka='დააჭირეთ ღილაკს ""შემდეგ"" თანხობრივი ნაშთების შესავსებად';ru='Нажмите кнопку ""Далее"" для заполнения остатков денежных средств'"); 
	ИначеЕсли ТекущийНомерСтраницы = 1 Тогда
		Элементы.ДекорацияПояснеиеСледующегоДействия.Заголовок = НСтр("ka='დააჭირეთ ღილაკს ""შემდეგ"" სასაქონლო ნაშთების შესავსებად';ru='Нажмите кнопку ""Далее"" для заполнения остатков товаров'");
	ИначеЕсли ТекущийНомерСтраницы = 2 Тогда
		Элементы.ДекорацияПояснеиеСледующегоДействия.Заголовок = НСтр("ka='დააჭირეთ ღილაკს ""შემდეგ"" გაანგარიშების ბალანსის შესავსებად';ru='Нажмите кнопку ""Далее"" для заполнения остатков по расчетам'");
	ИначеЕсли ТекущийНомерСтраницы = 3 Тогда
		Элементы.ДекорацияПояснеиеСледующегоДействия.Заголовок = НСтр("ka='დააჭირეთ ღილაკს ""შემდეგ"" სხვა ნაშთების შესავსებად';ru='Нажмите кнопку ""Далее"" для заполнения прочих остатков'");
	ИначеЕсли ТекущийНомерСтраницы = 4 Тогда
...
Процедура УстановитьДоступностьКнопок()
	...
	Если ТекущийНомерСтраницы >= ПоследняяСтраница - 1 Тогда
		Элементы.Далее.Заголовок = НСтр("ka='დასრულება';ru='Закончить'");
		Элементы.Далее.Картинка = БиблиотекаКартинок.Пометка;
	Иначе
		Элементы.Далее.Заголовок = НСтр("ka='შემდეგი';ru='Далее'");
...
Процедура ВыполнитьПроверкиПриПереходеНаСледующуюСтраницу(Отказ)
	...
	Если ТекущийНомерСтраницы = 1 Тогда
		...
		Если НЕ ЗначениеЗаполнено(ВалютаУчета) Тогда
			ТекстСообщения = НСтр("ka='Укажите валюту учета.';ru='Укажите валюту учета.'");
		...
		Если НЕ ЗначениеЗаполнено(НациональнаяВалюта) Тогда
			ТекстСообщения = НСтр("ka='Укажите национальную валюту.';ru='Укажите национальную валюту.'");
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				ТекстСообщения, , , ,
				Отказ
			);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковБанкИКасса.ДенежныеСредства Цикл
			...
			ТекСтрока,
			"БанковскийСчетКасса",
			НСтр("ka='Укажите банковский счет или кассу в строке %1.';ru='Укажите банковский счет или кассу в строке %1.'"),
			Отказ);
			...
			НСтр("ka='Укажите валюту в строке %1.';ru='Укажите валюту в строке %1.'"),
			Отказ);
	...
	ИначеЕсли ТекущийНомерСтраницы = 2 Тогда
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковТовары.Запасы Цикл
			...
			ТекСтрока,
			"СтруктурнаяЕдиница",
			НСтр("ka='Укажите структурную единицу в строке %1.';ru='Укажите структурную единицу в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Номенклатура",
			НСтр("ka='Укажите номенклатуру в строке %1.';ru='Укажите номенклатуру в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"ЕдиницаИзмерения",
			НСтр("ka='Укажите единицу измерения в строке %1.';ru='Укажите единицу измерения в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Количество",
			НСтр("ka='Укажите количество в строке %1.';ru='Укажите количество в строке %1.'"),
			Отказ);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковТовары.ЗапасыПринятые Цикл
			...
			ТекСтрока,
			"ВидОперации",
			НСтр("ka='Укажите вид операции в строке %1.';ru='Укажите вид операции в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Контрагент",
			НСтр("ka='Укажите поставщика в строке %1.';ru='Укажите поставщика в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Договор",
			НСтр("ka='Укажите договор в строке %1.';ru='Укажите договор в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Партия",
			НСтр("ka='Укажите партию в строке %1.';ru='Укажите партию в строке %1.'"),
			Отказ);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковТовары.ЗапасыПереданные Цикл
			...
			ТекСтрока,
			"Контрагент",
			НСтр("ka='Укажите покупателя в строке %1.';ru='Укажите покупателя в строке %1.'"),
			Отказ);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковТовары.ЗапасыВРазрезеГТД Цикл
			...
			ТекСтрока,
			"СтранаПроисхождения",
			НСтр("ka='Укажите страну происхождения в строке %1.';ru='Укажите страну происхождения в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"НомерГТД",
			НСтр("ka='Укажите номер ГТД в строке %1.';ru='Укажите номер ГТД в строке %1.'"),
			Отказ);
	...
	ИначеЕсли ТекущийНомерСтраницы = 3 Тогда
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковРасчетыСКонтрагентами.РасчетыСПоставщиками Цикл
			...
			ТекСтрока,
			"СуммаВал",
			НСтр("ka='Укажите сумму в строке %1.';ru='Укажите сумму в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Сумма",
			НСтр("ka='Укажите сумму в валюте учета в строке %1.';ru='Укажите сумму в валюте учета в строке %1.'"),
			Отказ);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковЗарплата.РасчетыСПерсоналом Цикл
			...
			ТекСтрока,
			"СтруктурнаяЕдиница",
			НСтр("ka='Укажите подразделение в строке %1.';ru='Укажите подразделение в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Сотрудник",
			НСтр("ka='Укажите сотрудника в строке %1.';ru='Укажите сотрудника в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"ПериодРегистрации",
			НСтр("ka='Укажите период в строке %1.';ru='Укажите период в строке %1.'"),
			Отказ);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковНалоги.РасчетыПоНалогам Цикл
			...
			ТекСтрока,
			"ВидНалога",
			НСтр("ka='Укажите вид налога в строке %1.';ru='Укажите вид налога в строке %1.'"),
			Отказ);
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковЭквайринг.РасчетыПоЭквайрингу Цикл
			...
			НСтр("ka='Укажите экваринговый терминал в строке %1.';ru='Укажите экваринговый терминал в строке %1.'"),
			Отказ);
	...
	ИначеЕсли ТекущийНомерСтраницы = 4 Тогда
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковИмущество.ВнеоборотныеАктивы Цикл
			...
			ТекСтрока,
			"ВнеоборотныйАктив",
			НСтр("ka='Укажите карточку имущества в строке %1.';ru='Укажите карточку имущества в строке %1.'"),
			Отказ);
			...
			НСтр("ka='Укажите текущее состояние в строке %1.';ru='Укажите текущее состояние в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"СчетЗатрат",
			НСтр("ka='Укажите счет затрат в строке %1.';ru='Укажите счет затрат в строке %1.'"),
			Отказ);
			//+++
			ПроверитьКолонкуТаблицы(
			"ВводНачальныхОстатковИмущество.ВнеоборотныеАктивы",
		...
		Для каждого ТекСтрока Из ВводНачальныхОстатковПрочее.ПрочиеРазделы Цикл
			...
			ТекСтрока,
			"ВидДвижения",
			НСтр("ka='Укажите вид движения в строке %1.';ru='Укажите вид движения в строке %1.'"),
			Отказ);
			...
			ТекСтрока,
			"Счет",
			НСтр("ka='Укажите счет в строке %1.';ru='Укажите счет в строке %1.'"),
			Отказ);
			...
			Если УчетВалютныхОпераций И ТекСтрока.Валютный Тогда
				...
				ТекСтрока,
				"СуммаВал",
				НСтр("ka='Укажите валютную сумму в строке %1.';ru='Укажите валютную сумму в строке %1.'"),
				Отказ);
...
Функция СписокВыбораВалют(Валюты)
	...
	КонецЦикла; 
	Результат.Добавить(Неопределено, НСтр("ka='Еще валюты...';ru='Еще валюты...'"));
	Возврат Результат;
	...
	Если ТипЗнч(РезультатЗагрузки) = Тип("Структура") Тогда
		...
		ИначеЕсли РезультатЗагрузки.ОписаниеДействия = "ОбработатьПодготовленныеДанные" Тогда
			...
			Если ПолноеИмяОбъектаЗаполнения = "Документ.ВводНачальныхОстатков.ТабличнаяЧасть.Запасы" Тогда
				...
				ПоказатьПредупреждение(,Нстр("ka='Загрузка данных завершена.';ru='Загрузка данных завершена.'"));
