...
"по полю ""Порядок"". Настроить необходимую сортировку?';ka='სიის დახარისხების დაყენება რეკომენდებულია ველ ""წესი""-ში. გავმართოთ საჭირო დახარისხება?'");
...
Процедура УправлениеВидимостьюСервер()
	...
	Иначе
		...
		Заголовок = "ფასდაკლებები და ფასნამატები";
	КонецЕсли;
