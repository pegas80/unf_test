...
"рекомендуется увеличить объем памяти до %2 Гб.'");
	...
	ЗаголовокСообщения = НСтр("ka='Рекомендация по повышению скорости работы';ru='Рекомендация по повышению скорости работы'");
	
	ПараметрыВопроса = СтандартныеПодсистемыКлиент.ПараметрыВопросаПользователю();
	ПараметрыВопроса.Заголовок = ЗаголовокСообщения;
	ПараметрыВопроса.Картинка = БиблиотекаКартинок.Предупреждение32;
	ПараметрыВопроса.Вставить("ТекстФлажка", НСтр("ka='Не показывать в течение двух месяцев';ru='Не показывать в течение двух месяцев'"));
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("ПродолжитьРаботу", НСтр("ka='Продолжить работу';ru='Продолжить работу'"));
