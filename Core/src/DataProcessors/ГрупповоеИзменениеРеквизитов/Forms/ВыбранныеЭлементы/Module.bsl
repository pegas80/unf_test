...
Процедура ОбновитьСписокВыбранныхНаСервере()
	...
	Элементы.ГруппаВыбранныеОбъекты.Заголовок = ПодставитьПараметрыВСтроку(НСтр("ka='Выбранные элементы (%1)';ru='Выбранные элементы (%1)';en='Selected Items (1%)'"), ВыбранныеОбъекты().Строки.Количество());
