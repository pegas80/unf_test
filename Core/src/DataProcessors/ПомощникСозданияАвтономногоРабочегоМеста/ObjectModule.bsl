...
Функция СформироватьНаименованиеПриложенияВСервисе()
	...
	Результат = СтрЗаменить(Результат, "[Пояснение]", НСтр("ka='приложение в Интернете';ru='приложение в Интернете'"));
...
Функция ЗаголовокСистемы()
	...
	Возврат ?(ПустаяСтрока(Результат), НСтр("ka='ავტონომიური სამუშაო ადგილი';ru='Автономное рабочее место'"), Результат);
КонецФункции
