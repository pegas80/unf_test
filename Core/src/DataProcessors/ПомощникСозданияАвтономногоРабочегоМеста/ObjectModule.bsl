...
Функция СформироватьНаименованиеПриложенияВСервисе()
	...
	Результат = СтрЗаменить(Результат, "[Пояснение]", НСтр("ka='приложение в Интернете';ru='приложение в Интернете';en='online application'"));
...
Функция ЗаголовокСистемы()
	...
	Возврат ?(ПустаяСтрока(Результат), НСтр("ka='ავტონომიური სამუშაო ადგილი';ru='Автономное рабочее место';en='Standalone workstation'"), Результат);
КонецФункции
