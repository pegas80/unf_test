...
Процедура ОбработкаОтветовИзЕГАИС_Завершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ka='ესასს-იდან პასუხების დამუშავება %1-ისთვის დასრულებულია.';ru='Обработка ответов из ЕГАИС для %1 завершена.';en='Processing responses from EGAIS to 1% complete.'"), 
