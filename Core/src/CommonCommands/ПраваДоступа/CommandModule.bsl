...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если Не УправлениеНебольшойФирмойУправлениеДоступомПовтИсп.ЭтоПолноправныйПользователь() Тогда
		...
		ТекстИсключения = НСтр("ka='მოცემული გამართვა ხელმისაწვდომია მხოლოდ პროგრამის ადმინისტრატორისთვის!';ru='Данная настройка доступна только для администратора программы!';en='This option is only available to the administrator of the program!'");
