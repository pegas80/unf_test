...
Процедура ДатаПриИзменении(Элемент)
	...
	Если Объект.Дата <> ДатаПередИзменением Тогда
		...
		КонецЕсли;
	КонецЕсли; 
	ЗаполнитьТаблицуВнеоборотныеАктивы(); //Малышев 2025-09-10 ONESOFT-4344
...
Процедура ЗаполнитьТаблицуВнеоборотныеАктивы()
	...
	Запрос.УстановитьПараметр("ДатаДокумента", Объект.Дата-1);  //Малышев 2025-09-10 ONESOFT-4344 --)
