		...
		Для каждого СтрокаТЧ Из Товары Цикл
			...
			Если ЗначениеЗаполнено(СтрокаТЧ.КодТаможенногоОргана)
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.КодТаможенногоОргана) Тогда
					ТекстОшибки = НСтр("ka='В строке %НомерСтроки% списка ""Товары"" не указан ""Код таможенного органа"".';ru='В строке %НомерСтроки% списка ""Товары"" не указан ""Код таможенного органа"".'");
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.ДатаРегистрацииДекларации) Тогда
					ТекстОшибки = НСтр("ka='В строке %НомерСтроки% списка ""Товары"" не указана ""Дата регистрации декларации"".';ru='В строке %НомерСтроки% списка ""Товары"" не указана ""Дата регистрации декларации"".'");
					ТекстОшибки =  СтрЗаменить(ТекстОшибки, "%НомерСтроки%", НомерСтроки);
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.РегистрационныйНомерДекларации) Тогда
					ТекстОшибки = НСтр("ka='В строке %НомерСтроки% списка ""Товары"" не указан ""Регистрационный номер декларации"".';ru='В строке %НомерСтроки% списка ""Товары"" не указан ""Регистрационный номер декларации"".'");
					ТекстОшибки =  СтрЗаменить(ТекстОшибки, "%НомерСтроки%", НомерСтроки);
