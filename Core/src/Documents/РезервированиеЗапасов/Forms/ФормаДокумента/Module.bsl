...
Процедура ЗаполнитьПоОснованию(Команда)
	...
	ТекстВопроса = НСтр("ka='დოკუმენტი სრულიად შეივსება ""მყიდველის შეკვეთით""! გავაგრძელოთ ოპერაცია?';ru='Документ будет полностью перезаполнен по ""Заказу покупателя""! Продолжить выполнение операции?'");
	Ответ = Неопределено;
