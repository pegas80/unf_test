...
Процедура ИнициализироватьДанныеПоУслуге(ДокументСсылкаОтчетПереработчика, СтруктураДополнительныеСвойства, СуммаУслуги) Экспорт
	...
	Запрос.УстановитьПараметр("ОтражениеРасходовПоПереработке", НСтр("ka='გადამუშავებაზე ხარჯების ასახვა';ru='Отражение расходов по переработке'"));
...
Процедура СформироватьТаблицаРасчетыПоНалогам(ДокументСсылкаОтчетПереработчика, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("НачислениеНалогаНДС", НСтр("ka='დღგ-ს დარიცხვა';ru='Начисление налога НДС'"));
	Запрос.УстановитьПараметр("НачислениеНалогаИмпорт", НСтр("ka='იმპორტის გადასახადის დარიცხვა';ru='Начисление налога импорта'"));
