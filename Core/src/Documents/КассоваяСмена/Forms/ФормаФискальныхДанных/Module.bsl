...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("КассоваяСмена") Тогда
		...
		Если XMLСтрока = Неопределено или не ТипЗнч(XMLСтрока) = Тип("Строка") или XMLСтрока = "" Тогда
			Отказ = Истина;
			ТекстПредупреждения = НСтр("ka='Нет фискальных данных';ru='Нет фискальных данных'");
		Иначе
	...
	Иначе
		Отказ = Истина;
		ТекстПредупреждения = НСтр("ka='Форма фискальных данных пердназначена для открытия из элемента Кассовой смены';ru='Форма фискальных данных пердназначена для открытия из элемента Кассовой смены'");
	КонецЕсли;
