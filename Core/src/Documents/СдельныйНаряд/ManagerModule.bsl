...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаСдельныйНаряд, СтруктураДополнительныеСвойства) Экспорт
	...
	("ВЫБРАТЬ
	 ...
	 |  ТаблицаОпераций.КоррНоменклатура КАК СубконтоДт2,
	...
	СтруктураДополнительныеСвойства.ТаблицыДляДвижений.Вставить("ТаблицаХозрасчетный", МассивРезультатов[8].Выгрузить()); //+++ Дмгг
