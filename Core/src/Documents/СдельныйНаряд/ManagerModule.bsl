...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаСдельныйНаряд, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("РазноскаЗарплаты",		НСтр("ka='ხარჯების მიკუთვნება პროდუქციაზე';ru='Отнесение затрат на продукцию'"));
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='სანარდო განწესი';ru='Сдельный наряд'");
