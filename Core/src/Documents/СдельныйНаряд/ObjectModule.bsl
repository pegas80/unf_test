...
Процедура ЗаполнитьПоЗаказуНаПроизводство(ДокументСсылкаЗаказНаПроизводство) Экспорт
	...
	Если ДокументСсылкаЗаказНаПроизводство.СтруктурнаяЕдиница.ТипСтруктурнойЕдиницы = Перечисления.ТипыСтруктурныхЕдиниц.Склад Тогда
		ВызватьИсключение НСтр("ka='სანარდო განწესი არ შეიძლება შეყვანილი იქნას საწარმოო შეკვეთის საფუძველზე საწყობის მიხედვით!';ru='Сдельный наряд не может быть введен на основании заказа на производство по складу!'");
	КонецЕсли;
