...
Процедура ОбработатьИзменениеДоговораИВалютыРасчетов(ПараметрыДокумента)
	...
	Если ОткрытьФормуЦеныИВалюты Тогда
		...
		ТекстПредупреждение = НСтр("ka='შეიცვალა კონტრაგენტთან ხელშეკრულებით გათვალისწინებული ანგარიშსწორების ვალუტა! აუცილებელია დოკუმენტის ვალუტის შემოწმება!';ru='Изменилась валюта расчетов по договору с контрагентом!"
