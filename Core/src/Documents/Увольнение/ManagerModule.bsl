...
Процедура СформироватьКадровыйПриказ(ОписаниеПечатнойФормы, МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Для каждого ДанныеСотрудника Из СведенияОСотрудниках Цикл
		...
		ОписаниеУвольнения = НСтр("ka='уволить ""';ru='уволить ""'") + СокрЛП(Лев(ДатаУвольненияСтрокой, 2)) + """  " + СокрЛП(Прав(ДатаУвольненияСтрокой, СтрДлина(ДатаУвольненияСтрокой) - 2));
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='Т-8 (Приказ об увольнении)';ru='Т-8 (Приказ об увольнении)'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='Т-8 (Приказ об увольнении)';ru='Т-8 (Приказ об увольнении)'");
