...
Функция СформироватьПлатежнаяВедомость(ПечатнаяФорма, МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		Запрос.УстановитьПараметр("Осн", НСтр("ka='ძირითადი';ru='Осн.';en='DOS.'"));
		Запрос.УстановитьПараметр("Совм", НСтр("ka='Совм.';ru='Совм.';en='Joint.'"));
		Запрос.Текст =
		"ВЫБРАТЬ
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='საგადახდო უწყისი';ru='Платежная ведомость';en='Payment statement'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='საგადახდო უწყისი';ru='Платежная ведомость';en='Payment statement'");
