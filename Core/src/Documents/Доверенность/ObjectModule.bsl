...
Процедура ЗаполнитьПоЗаказуПоставщику(ДанныеЗаполнения) Экспорт
	...
	Если ЗначениеЗаполнено(ДанныеЗаполнения.Ссылка)
		...
		ПоДокументу = НСтр("ka='მყიდველის გადასახდელი ანგარიში #';ru='Счет на оплату покупателя №'") + СокрЛП(ДанныеЗаполнения.Ссылка.НомерВходящегоДокумента) + НСтр("ru=' от ';ka='ვისგან'") + СокрЛП(ДанныеЗаполнения.Ссылка.ДатаВходящегоДокумента);
