...
Функция ИнициализироватьДанныеДокументаДляВыгрузки(ДокументСсылка, ВидДокумента) Экспорт
	...
	Иначе
		ТекстОшибки = НСтр("ka='Неподдерживаемый вид документа %1 для исходящей ТТН';ru='Неподдерживаемый вид документа %1 для исходящей ТТН';en='Unsupported document type% 1 for outgoing TTH'");
