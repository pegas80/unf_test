	...
	Если ПроверитьЗаполнениеДоговоров Тогда
		...
		Для каждого Договор Из ДоговорыКонтрагентов Цикл
			...
			Если НЕ ЗначениеЗаполнено(Договор.Договор) Тогда
				...
				ТекстСообщения = НСтр("ka='ცხრილში არის სტრიქონები კონტრაგენტის შეუვსებელი ხელშეკრულებით';ru='В таблице присутствуют строки с незаполненным договором контрагента'");
