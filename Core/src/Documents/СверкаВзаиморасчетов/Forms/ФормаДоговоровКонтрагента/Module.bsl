...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок		= НСтр("ka='Список договоров контрагента: ';ru='Список договоров контрагента: '") + Строка(Контрагент);
	...
	Если ПроверитьЗаполнениеДоговоров Тогда
		...
		Для каждого Договор Из ДоговорыКонтрагентов Цикл
			...
			Если НЕ ЗначениеЗаполнено(Договор.Договор) Тогда
				...
				ТекстСообщения = НСтр("ka='ცხრილში არის სტრიქონები კონტრაგენტის შეუვსებელი ხელშეკრულებით';ru='В таблице присутствуют строки с незаполненным договором контрагента';en='The table contains rows with blank contract counterparty'");
