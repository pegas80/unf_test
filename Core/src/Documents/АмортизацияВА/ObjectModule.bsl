...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаОшибкиЗакрытияМесяца.Количество() > 0 Тогда
		ТекстСообщения = НСтр("ka='ამორტიზაციის დარიცხვისას ჩამოყალიბდა გაფრთხილებები! დაწვრილებით იხ. ანგარიშგებაში კალენდარული თვის დახურვის შესახებ.';ru='При начислении амортизации были сформированы предупреждения! Подробнее см. в отчете о закрытии месяца.'");
