...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='მოთხოვნა საწყობში';ru='Требование на склад'");
...
Функция ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ИмяМакета = "")
	...
	Запрос.УстановитьПараметр("Характеристика", НСтр("ka='მახასიათებელი:';ru='Характеристика:'"));
	Запрос.Текст = 
	"ВЫБРАТЬ
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ka='საწარმოო შეკვეთები';ru='Заказы на производство'");
	...
	Дело.Важное			= Истина;
	Дело.Представление	= НСтр("ka='ვადაგადაცილებული';ru='Просроченные'");
