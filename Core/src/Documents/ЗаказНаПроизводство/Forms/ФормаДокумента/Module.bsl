...
"В строке №%Номер% табличной части ""Продукция"" номенклатура ""%НоменклатураПредставление%"" является работой (услугой)';ka='გარჩევის ოპერაციის შესრულება არ ხდება სამუშაოსთვის და მომსახურებისთვის!"
"ცხრილ ""პროდუქციის"" სტრიქონ №%Номер%-ში ნომენკლატურა ""%НоменклатураПредставление%"" არის სამუშაო (მომსახურება)'");
