...
Процедура ПолучитьСреднееЗначениеСебестоимости(СтруктураДанные, Цена) //+++ Дмгг
	...
	Запрос.Текст = 
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	СУММА(ВременнаяТаблицаОстатки.КоличествоОстаток - ЕСТЬNULL(ВременнаяТаблицаОбороты.КоличествоОборот, 0)) КАК КоличествоОстаток,
		|	СУММА(ВременнаяТаблицаОстатки.СуммаОстаток - ЕСТЬNULL(ВременнаяТаблицаОбороты.СуммаОборот, 0)) КАК СуммаОстаток
		|ИЗ
