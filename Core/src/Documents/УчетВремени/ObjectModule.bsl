...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ДниНеделиПредст.Вставить(1, НСтр("ka='ორშაბათი';ru='Понедельник';en='Monday'"));
	ДниНеделиПредст.Вставить(2, НСтр("ka='სამშაბათი';ru='Вторник';en='Tuesday'"));
	ДниНеделиПредст.Вставить(3, НСтр("ka='ოთხშაბათი';ru='Среда';en='Wednesday'"));
	ДниНеделиПредст.Вставить(4, НСтр("ka='ხუთშაბათი';ru='Четверг';en='Thursday'"));
	ДниНеделиПредст.Вставить(5, НСтр("ka='პარასკევი';ru='Пятница';en='Friday'"));
	ДниНеделиПредст.Вставить(6, НСтр("ka='შაბათი';ru='Суббота';en='Saturday'"));
	ДниНеделиПредст.Вставить(7, НСтр("ka='კვირა დღე';ru='Воскресенье';en='Sunday'"));
	...
	Для каждого СтрокаТЧ Из Операции Цикл
		...
		Для Счетчик = 1 По 7 Цикл
			...
			Если (ЗначениеЗаполнено(СтрокаТЧ[ДниНедели.Получить(Счетчик) + "ВремяНачала"]) 
				...
				ТекстСообщения = НСтр("ka='სტრიქონ %НомерСтроки% სვეტი ""%ДеньНедели%"" არაკორექტულად არის შევსებული!';ru='Не корректно заполнена колонка ""%ДеньНедели%"" в строке %НомерСтроки%!';en='Not correctly filled in the column ""% DenNedeli%"" on line% NomerStroki%!'");
