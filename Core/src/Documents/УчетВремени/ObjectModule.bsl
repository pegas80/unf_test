...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ДниНеделиПредст.Вставить(1, НСтр("ka='ორშაბათი';ru='Понедельник'"));
	ДниНеделиПредст.Вставить(2, НСтр("ka='სამშაბათი';ru='Вторник'"));
	ДниНеделиПредст.Вставить(3, НСтр("ka='ოთხშაბათი';ru='Среда'"));
	ДниНеделиПредст.Вставить(4, НСтр("ka='ხუთშაბათი';ru='Четверг'"));
	ДниНеделиПредст.Вставить(5, НСтр("ka='პარასკევი';ru='Пятница'"));
	ДниНеделиПредст.Вставить(6, НСтр("ka='შაბათი';ru='Суббота'"));
	ДниНеделиПредст.Вставить(7, НСтр("ka='კვირა დღე';ru='Воскресенье'"));
	...
	Для каждого СтрокаТЧ Из Операции Цикл
		...
		Для Счетчик = 1 По 7 Цикл
			...
			Если (ЗначениеЗаполнено(СтрокаТЧ[ДниНедели.Получить(Счетчик) + "ВремяНачала"]) 
				...
				ТекстСообщения = НСтр("ka='სტრიქონ %НомерСтроки% სვეტი ""%ДеньНедели%"" არაკორექტულად არის შევსებული!';ru='Не корректно заполнена колонка ""%ДеньНедели%"" в строке %НомерСтроки%!'");
