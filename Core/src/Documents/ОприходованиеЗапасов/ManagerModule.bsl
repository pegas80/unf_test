...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаОприходованиеЗапасов, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ПрочееОприходование", НСтр("ka='მარაგების სხვაგვარი შემოსავალში გატარება';ru='Прочее оприходование запасов'"));
...
Функция СформироватьАктОприходованияЗапасов(ПечатнаяФорма, МассивОбъектов, ОбъектыПечати)
	...
	Для каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		ТекстИтоговойСтроки = НСтр("ka='სულ, %СуммаВсего% %ВалютаУпр%-ის ოდენობის %ВсегоНаименований% დასახელება';ru='Всего наименований %ВсегоНаименований%, на сумму %СуммаВсего% %ВалютаУпр%'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='მარაგების შესავალში აყვანის აქტი';ru='Акт об оприходовании запасов'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='მარაგების შესავალში აყვანის აქტი';ru='Акт об оприходовании запасов'");
