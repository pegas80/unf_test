...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановкаФорматовЦен();//++Lazare 03.02.2021, Количество знаков после запятой в цене	
...
//++Lazare, 03.02.2021, Количество знаков после запятой в цене
...
Процедура ЗаполнитьПроектПоДокументу(ПроектЗначение = Неопределено)
	...
	Если ПроектЗначение = Неопределено Тогда
		Объект.Проект = КэшЗначений.ПустойСклад;
	КонецЕсли;
