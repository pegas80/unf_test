...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаНачислениеНалогов, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ВозмещенНалог", НСтр("ka='გადასახადი ანაზღაურებულია';ru='Возмещен налог'"));
	Запрос.УстановитьПараметр("Доходы", НСтр("ka='შემოსავლები';ru='Доходы'")); 
	Запрос.УстановитьПараметр("Расходы", НСтр("ka='დანახარჯები';ru='Расходы'")); 
	Запрос.УстановитьПараметр("Взаиморасчет", НСтр("ka='დანახარჯები';ru='Расходы'"));
