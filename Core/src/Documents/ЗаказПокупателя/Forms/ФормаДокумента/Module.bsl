...
Процедура ЗапасыНоменклатураПриИзменении(Элемент)
	...
	Если ПолучитьФункционалТипЦеныНоменклатурыПоКоличеству() Тогда 
		...
		//СтрокаТабличнойЧасти.ОптоваяДиапазон = 0;
		//СтрокаТабличнойЧасти.УчетнаяДиапазон = 0;
		//
		...
		//	 количествоДиапазона =  УправлениеНебольшойФирмойСервер.ПолучитьКоличествоДиапазонаПоВидЦены(ВидЦен,СтрокаТабличнойЧасти.Характеристика);
		//	 СтрокаТабличнойЧасти.ОптоваяДиапазон = количествоДиапазона ;
		//	 ОптоваяЦена = ВидЦен;
		// ИначеЕсли 
		//	 ВидЦен = ПредопределенноеЗначение("Справочник.ВидыЦен.Учетная")   Тогда 	 
		//	 количествоДиапазона =  УправлениеНебольшойФирмойСервер.ПолучитьКоличествоДиапазонаПоВидЦены(ВидЦен,СтрокаТабличнойЧасти.Характеристика);
		//	 СтрокаТабличнойЧасти.УчетнаяДиапазон = количествоДиапазона ;
		//КонецЕсли;
		...
		Иначе
			...
			Если МассивСтрокТЧ.Количество() = 0 Тогда
				...
				Если ПолучитьФункционалТипЦеныНоменклатурыПоКоличеству() Тогда 
					...
					НоваяСтрока.ОптоваяДиапазон = 0;
					НоваяСтрока.УчетнаяДиапазон = 0;
					Если ВидЦен = ПредопределенноеЗначение("Справочник.ВидыЦен.Оптовая")  Тогда 
						количествоДиапазона =  УправлениеНебольшойФирмойСервер.ПолучитьКоличествоДиапазонаПоВидЦены(ВидЦен, ДанныеШтрихкода.Характеристика);
						НоваяСтрока.ОптоваяДиапазон = количествоДиапазона ;		
						ОптоваяЦена = ВидЦен;	
					ИначеЕсли 
						ВидЦен = ПредопределенноеЗначение("Справочник.ВидыЦен.Учетная")   Тогда 	 
						количествоДиапазона =  УправлениеНебольшойФирмойСервер.ПолучитьКоличествоДиапазонаПоВидЦены(ВидЦен, ДанныеШтрихкода.Характеристика);
						НоваяСтрока.УчетнаяДиапазон = количествоДиапазона ;
					КонецЕсли;
