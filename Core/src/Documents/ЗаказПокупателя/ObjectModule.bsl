...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ТекстКолонкаНеЗаполненаШаблон = НСтр("ka='სია ""%3""-ის სტრიქონ %2-ში სვეტი ""%1"" არ არის შევსებული';ru='Не заполнена колонка ""%1"" в строке %2 списка ""%3""'");
	...
	Если ЗапланироватьОплату
		...
		ТекстСообщения = НСтр("ru='Поле ""Дата оплаты"" не заполнено.';ka='ველი ""გადახდის თარიღი"" შეუვსებელია.'");
