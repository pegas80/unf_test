...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	Иначе
		Если Данные.ПометкаУдаления Тогда
			Состояние = НСтр("ka='(წაშლილია)';ru='(удален)'");
		ИначеЕсли Данные.Свойство("Проведен") И НЕ Данные.Проведен Тогда
			Состояние = НСтр("ka='(არ არის გატარებული)';ru='(не проведен)'");
		КонецЕсли;
	КонецЕсли;
	
	Если Данные.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийЗаказПокупателя.ЗаказНаряд") Тогда
		ЗаголовокПредставление = НСтр("ru='Заказ-наряд';ka='შეკვეთა-განწესი'");
	Иначе
		ЗаголовокПредставление = НСтр("ka='მყიდველის შეკვეთა';ru='Заказ покупателя'");
	КонецЕсли;
	
	Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ka='%1 %2 %3 %4-ის';ru='%1 %2 от %3 %4'"),
...
Процедура ПроверитьВозможностьВводаНаОснованииЗаказаПокупателя(ДанныеЗаполнения, ЗначенияРеквизитов) Экспорт
	...
	Если ЗначенияРеквизитов.Свойство("Проведен") Тогда
		Если НЕ ЗначенияРеквизитов.Проведен Тогда
			ТекстОшибки = НСтр("ka='დოკუმენტი %Документ% არ არის გატარებული. გაუტარებელი დოკუმენტის საფუძველზე შეყვანა აკრძალულია.';ru='Документ %Документ% не проведен. Ввод на основании непроведенного документа запрещен.'");
	...
	Если ЗначенияРеквизитов.Свойство("СостояниеЗаказа")
		...
		ТекстОшибки = НСтр("ka='Документ %Документ% в состоянии Завершен. Ввод на основании завершенного заказа запрещен.';ru='Документ %Документ% в состоянии Завершен. Ввод на основании завершенного заказа запрещен.'");
		ТекстОшибки = СтрЗаменить(ТекстОшибки, "%Документ%", ДанныеЗаполнения);
		ВызватьИсключение ТекстОшибки;
	КонецЕсли;
...
Процедура ПоляЗагрузкиДанныхИзВнешнегоИсточника(ТаблицаПолейЗагрузки, НастройкиЗагрузкиДанных) Экспорт
	...
	Если ПустаяСтрока(ПолноеИмяОбъектаЗаполнения) 
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Штрихкод", НСтр("ka='შტრიხკოდი';ru='Штрихкод'"), ОписаниеТиповСтрока200, ОписаниеТиповКолонка, "Номенклатура", 1, , Истина);
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Артикул", НСтр("ka='არტიკული';ru='Артикул'"), ОписаниеТиповСтрока25, ОписаниеТиповКолонка, "Номенклатура", 2, , Истина);
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "НоменклатураНаименование", НСтр("ka='ნომენკლატურა(დასახელება)';ru='Номенклатура (наименование)'"), ОписаниеТиповСтрока100, ОписаниеТиповКолонка, "Номенклатура", 3, , Истина);
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "НоменклатураНаименованиеПолное",НСтр("ka='ნომენკლატურა(სრული დასახელება)';ru='Номенклатура (полное наименование)'"), ОписаниеТиповСтрока1000, ОписаниеТиповКолонка, "Номенклатура", 5, , Истина);
		
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Содержание", НСтр("ka='შემადგენლობა';ru='Содержание'"), ОписаниеТиповСтрока1000, ОписаниеТиповСтрока1000, , , , , НастройкиЗагрузкиДанных.СодержаниеВидимо);
		
		Если ПолучитьФункциональнуюОпцию("ИспользоватьХарактеристики") Тогда
			
			ОписаниеТиповКолонка = Новый ОписаниеТипов("СправочникСсылка.ХарактеристикиНоменклатуры");
			ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Характеристика", НСтр("ka='მახასიათებელი(დასახელება)';ru='Характеристика (наименование)'"), ОписаниеТиповСтрока150, ОписаниеТиповКолонка);
		...
		Если ПолучитьФункциональнуюОпцию("ИспользоватьПартии") Тогда
			...
			ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Партия", НСтр("ka='პარტია(დასახელება)';ru='Партия (наименование)'"), ОписаниеТиповСтрока100, ОписаниеТиповКолонка);
			
		КонецЕсли;
		
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Количество", НСтр("ka='რაოდენობა';ru='Количество'"), ОписаниеТиповСтрока25, ОписаниеТиповЧисло15_3, , , Истина);
		
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Резерв", НСтр("ka='რეზერვი';ru='Резерв'"), ОписаниеТиповСтрока25, ОписаниеТиповЧисло15_3, , , , , ПолучитьФункциональнуюОпцию("РезервированиеЗапасов"));
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Цена", НСтр("ka='ფასი';ru='Цена'"), ОписаниеТиповСтрока25, ОписаниеТиповЧисло15_2, , , Ложь);
		
		ОписаниеТиповКолонка = Новый ОписаниеТипов("СправочникСсылка.СтавкиНДС");
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "СтавкаНДС", НСтр("ka='დღგ-ს განაკვეთი';ru='Ставка НДС'"), ОписаниеТиповСтрока50, ОписаниеТиповКолонка);
		
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "СуммаНДС", НСтр("ka='დღგ-ს თანხა';ru='Сумма НДС'"), ОписаниеТиповСтрока25, ОписаниеТиповЧисло15_2);
		
		ПолеВидимо = (НастройкиЗагрузкиДанных.ПоложениеДатыВЗаказе = Перечисления.ПоложениеРеквизитаНаФорме.ВТабличнойЧасти);
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "ДатаОтгрузки", НСтр("ka='გადატვირთვის თარიღი';ru='Дата отгрузки'"), ОписаниеТиповСтрока25, ОписаниеТиповДата, , , , , ПолеВидимо);
	...
	ИначеЕсли ПолноеИмяОбъектаЗаполнения="Документ.ЗаказПокупателя.ТабличнаяЧасть.Калькуляция" Тогда
		...
		Если НастройкиЗагрузкиДанных.ЗагрузкаКалькуляции Тогда
			ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "ЭтоРасход", НСтр("ka='დანახარჯი';ru='Это расход'"), ОписаниеТиповСтрока25, ОписаниеТиповБулево, , , , , НастройкиЗагрузкиДанных.ЗагрузкаКалькуляции);
		...
		ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Количество", НСтр("ka='რაოდენობა';ru='Количество'"), ОписаниеТиповСтрока25, ОписаниеТиповЧисло15_3);
		Если НастройкиЗагрузкиДанных.ЗагрузкаКалькуляции Тогда
			ЗагрузкаДанныхИзВнешнегоИсточника.ДобавитьПолеОписанияЗагрузки(ТаблицаПолейЗагрузки, "Себестоимость", НСтр("ka='თვითღირებულება';ru='Себестоимость'"), ОписаниеТиповСтрока25, ОписаниеТиповЧисло15_2);
		КонецЕсли; 
...
Процедура ЗаполнитьСписокТекущихДелЗаказПокупателя(ТекущиеДела)
	...
	ГруппаДел	= НСтр("ka='მყიდველთა შეკვეთები';ru='Заказы покупателей'");
	...
	Дело.Важное			= Истина;
	Дело.Представление	= НСтр("ru='Просрочено выполнение';ka='გადავადებულია შესრულება'");
	...
	Дело.Важное			= Истина;
	Дело.Представление	= НСтр("ka='Просрочена оплата';ru='Просрочена оплата'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ru='На сегодня';ka='დღეისთვის'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ka='Не завершенные';ru='Не завершенные'");
...
Процедура ЗаполнитьСписокТекущихДелЗаказНаряд(ТекущиеДела)
	...
	ГруппаДел	= НСтр("ka='შეკვეთა განწესი';ru='Заказ наряды'");
...
Процедура СформироватьТаблицаРасчетыСПокупателями(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ВозникновениеОбязательствПокупателя", НСтр("ka='მყიდველის ვალდებულებების წარმოშობა';ru='Возникновение обязательств покупателя'"));
	Запрос.УстановитьПараметр("ЗачетАванса", НСтр("ka='წინასწარ გადახდილი თანხის ჩათვლა';ru='Зачет предоплаты'"));
...
Процедура СформироватьТаблицаДоходыИРасходы(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ОтражениеДоходов", НСтр("ru='Отражение доходов';ka='შემოსავლების ასახვა'"));
	Запрос.УстановитьПараметр("КурсоваяРазница", НСтр("ka='სხვაობა კურსებს შორის';ru='Курсовая разница'"));
	//Паганини_ ПФ
	Запрос.УстановитьПараметр("УдержаниеПенсионногоФонда",	НСтр("ru='Удержание организации для пенсионного фонда';ka='ორგანიზაციის ხარჯი საპენსიო ფონდისთვის'"));
	//_Паганини ПФ
...
Процедура СформироватьТаблицаРасчетыСПерсоналом(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	//Паганини_ ПФ
	Запрос.УстановитьПараметр("НалогПенсионногоФонда", 		НСтр("ka='საპენსიო ფონდის გადასახადი';ru='Налог пенсионного фонда'"));
...
Процедура СформироватьТаблицаЗапасыПринятые(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ПриемЗапасовТоварыНаКомиссии", НСтр("ka='მარაგების მიღება';ru='Прием запасов'"));
...
Процедура СформироватьТаблицаЗапасыРаботы(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("СборкаЗапасов", НСтр("ka='მარაგების შეკრება';ru='Сборка запасов'"));
	РезультатЗапроса = Запрос.Выполнить();
	...
	Для н = 0 По СтруктураДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаЗапасы.Количество() - 1 Цикл
		...
		Если КоличествоТребуется > 0 Тогда
			...
			СтрокаТаблицыРасход.СодержаниеПроводки = НСтр("ka='მარაგების ჩამოწერა';ru='Списание запасов'");
		...
		Если КоличествоТребуетсяСвободныйОстатокПеремещение > 0
			...
			Если Окр(СуммаКСписаниюПеремещение, 2, 1) <> 0 Тогда
				...
				Если Ложь Тогда
					...
					ЗаполнитьЗначенияСвойств(СтрокаТаблицаХозрасчетныйПеремещение, СтрокаТаблицаЗапасыПеремещение);
					СтрокаТаблицаХозрасчетныйПеремещение.Сумма = СуммаКСписаниюПеремещение;
					СтрокаТаблицаХозрасчетныйПеремещение.Содержание = НСтр("ru='Списание запасов';ka='მარაგების ჩამოწერა'");
...
Процедура СформироватьТаблицаЗапасыИсполнители(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("НачислениеЗарплаты", НСтр("ka='ხელფასის დარიცხვა';ru='Начисление зарплаты'"));	
	Запрос.УстановитьПараметр("РазноскаЗарплаты", 	НСтр("ru='Отнесение затрат на продукцию';ka='ხარჯების მიკუთვნება პროდუქციაზე'"));	
...
Процедура СформироватьТаблицаЗапасыТовары(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("СписаниеЗапасов", НСтр("ka='მარაგების ჩამოწერა';ru='Списание запасов'"));
			...
			Если КоличествоТребуетсяРезерв > 0 Тогда // Нужно сделать резерв.
				...
				Если СтрокаТаблицаЗапасы.Выполнен Тогда // Если заказ выполнени - надо и продать.
					...
					Если Окр(СуммаКСписанию, 2, 1) <> 0 Тогда
						...
						СтрокаДоходыИРасходы.СодержаниеПроводки = НСтр("ka='ხარჯების ასახვა';ru='Отражение расходов'");
...
Процедура СформироватьТаблицаУправленческий(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ЗачетПредоплаты", НСтр("ka='წინასწარ გადახდილი თანხის ჩათვლა';ru='Зачет предоплаты'"));
	Запрос.УстановитьПараметр("ОтражениеВыручки", НСтр("ka='შემოსავალი გაყიდვიდან';ru='Выручка от продажи'"));
	Запрос.УстановитьПараметр("КурсоваяРазница", НСтр("ka='სხვაობა კურსებს შორის';ru='Курсовая разница'"));
	Запрос.УстановитьПараметр("НачислениеНДС", НСтр("ka='Начисление НДС';ru='Начисление НДС'"));
	Запрос.УстановитьПараметр("ПоложительнаяКурсоваяРазницаСчетУчета", ПланыСчетов.Управленческий.ПрочиеДоходы);
	Запрос.УстановитьПараметр("ОтрицательнаяКурсоваяРазницаСчетУчета", ПланыСчетов.Управленческий.ПрочиеРасходы);
	...
	Для н = 0 По СтруктураДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаЗапасы.Количество() - 1 Цикл
		...
		Если КоличествоТребуетсяРезерв > 0 И РезервированиеЗапасов Тогда //Тогда
			...
			Если Окр(СуммаКСписанию, 2, 1) <> 0 ИЛИ КоличествоТребуетсяРезерв > 0 Тогда
				...
				СтрокаТаблицыПриход.Период = СтрокаТаблицаЗапасы.ДатаКонцаСобран;//+++ Дмгг 
		...
		Если СтрокаТаблицаЗапасы.ВидДвижения = ВидДвиженияНакопления.Расход 
			...
			Для каждого НайденнаяСтрока Из НайденныеСтроки Цикл
				...
				Если СтрокаТаблицаЗапасы.Сумма <> 0 Тогда
					...
					СтрокаТаблицаУправленческий.Содержание = НСтр("ka='მარაგების ჩამოწერა';ru='Списание запасов'");
					...
					СтрокаТаблицаХозрасчетный = СтруктураДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаХозрасчетный.Добавить();
					ЗаполнитьЗначенияСвойств(СтрокаТаблицаХозрасчетный, СтрокаТаблицаЗапасы);
					СтрокаТаблицаХозрасчетный.Содержание = НСтр("ka='მარაგების ჩამოწერა';ru='Списание запасов'");
...
Процедура ИнициализироватьДанныеДокументаЗаказНаряд(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства) 
	...
	Запрос.УстановитьПараметр("РаспределениеЗапасов", НСтр("ru='Распределение запасов';ka='მარაგების გადანაწილება'"));
...
Процедура ИнициализироватьДанныеДокументаЗаказПокупателя(ДокументСсылкаЗаказПокупателя, СтруктураДополнительныеСвойства) 
	...
	Запрос.УстановитьПараметр("ИспользоватьХарактеристики", СтруктураДополнительныеСвойства.УчетнаяПолитика.ИспользоватьХарактеристики);
	Запрос.УстановитьПараметр("ИспользоватьПартии",  СтруктураДополнительныеСвойства.УчетнаяПолитика.ИспользоватьПартии);
	Запрос.УстановитьПараметр("РезервированиеЗапасов", НСтр("ka='მარაგების რეზერვირება';ru='Резервирование запасов'"));
...
Процедура ВывестиСекциюЗаголовок(Макет, Результат, Параметры)
	...
	Область.Параметры.ТекущаяДата = Формат(ТекущаяДата(), НСтр("ka=""ДФ='dd.MM.yyyy ЧЧ:мм'"";ru=""ДФ='dd.MM.yyyy ЧЧ:мм'"""));
	...
	Если Шапка.ПометкаУдаления Тогда
		Показатели.Вставить("СостояниеДокумента", НСтр("ka='Помечен на удаление';ru='Помечен на удаление'"));
	ИначеЕсли Шапка.Проведен Тогда
		Показатели.Вставить("СостояниеДокумента", НСтр("ru='Проведен';ka='გატარებულია'"));
	Иначе
...
Процедура ВывестиСекциюЗапасы(Макет, Результат, Параметры)
	...
	Пока НомерВарианта <= ПоследнийВариант Цикл
		...
		Если ЕстьНесколькоВариантов Тогда
			...
			ОбластьМакета.Параметры.ВариантПредставление = СтрШаблон(НСтр("ru='Вариант №%1';ka='Вариант №%1'"), НомерВарианта);
...
Процедура ВывестиСекциюДоходыРасходы(Макет, Результат, Параметры)
	...
	Пока ВыборкаДопРасходы.Следующий() Цикл
		...
		Если ВыборкаДопРасходы.ДополнительныйРасход Тогда
			ОбластьГруппа.Параметры.Группа = НСтр("ru='Расходы';ka='დანახარჯები'");;
		Иначе
			ОбластьГруппа.Параметры.Группа = НСтр("ka='მარაგები';ru='Запасы'");;
		КонецЕсли; 
...
Функция ОбластьПоПоказателю(Макет, Показатель, Показатели, Левая)
	...
	Если Показатель="Валюта" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Валюта:';ka='ვალუტა:'");
	...
	Если Показатель="Организация" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Организация:';ka='ორგანიზაცია'");
	...
	Если Показатель="Подразделение" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Подразделение:';ka='ქვეგანყოფილება:'");
	...
	Если Показатель="Склад" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Склад:';ka='საწყობი:'");
	...
	Если Показатель="Ответственный" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Ответственный:';ka='პასუხისმგებელი:'");
	...
	Если Показатель="СуммаОплаты" Тогда
		...
		Если НЕ ЗначениеЗаполнено(Показатели.ДокументОплаты) Тогда
			Область = Макет.ПолучитьОбласть("ОбщиеДанныеБезЗаголовкаВажно|"+Колонка);
			Область.Параметры.Значение = НСтр("ka='არ არის გადახდილი';ru='Не оплачен'");
	...
	Если Показатель="СлужбаДоставки" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Служба доставки:';ka='Служба доставки:'");
	...
	Если Показатель="СтоимостьДоставки" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Стоимость доставки:';ka='Стоимость доставки:'");
	...
	Если Показатель="КонтактноеЛицоДоставки" Тогда
		Область = Макет.ПолучитьОбласть("ОбщиеДанные|"+Колонка);
		Область.Параметры.Показатель = НСтр("ru='Получатель:';ka='მიმღები:'");
	...
	Пока Шапка.Следующий() Цикл
		...
		Если Шапка.ОжидаетсяВыборВариантаКП Тогда
			...
			Сообщение.Текст = СтрШаблон(
				НСтр("ru='Печатная форма ""%1"" (%2) не может быть сформирована: не выбран основной вариант.';ka='Печатная форма ""%1"" (%2) не может быть сформирована: не выбран основной вариант.'"),
...
Процедура СформироватьУниверсальныйПередаточныйДокумент(ПечатнаяФорма, МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		Для Каждого Строчка Из ТабличнаяЧасть Цикл
			...
			СтруктураЗаполненияСекции.Вставить("Акциз", ?(Шапка.ДатаДокумента < НачалоИспользованияСФ1137, "", Нстр("ka='აქციზის გარეშე';ru='без акциза'")));
			...
			Если Строчка.Номенклатура.ТипНоменклатуры = Перечисления.ТипыНоменклатуры.Услуга Тогда
				...
				СтруктураЗаполненияСекции.Вставить("Акциз", Нстр("ka='აქციზის გარეშე';ru='без акциза'"));
			...
			Если ВРег(Строчка.СтавкаНДС) = "БЕЗ НДС" Тогда
				...
				СтруктураЗаполненияСекции.Вставить("СтавкаНДС", Нстр("ka='დღგ-ის გარეშე';ru='без НДС'"));
				СтруктураЗаполненияСекции.Вставить("СуммаНДС", Нстр("ka='დღგ-ის გარეშე';ru='без НДС'"));
		...
		СтруктураЗаполненияСекции.Вставить("КоличествоЛистов", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='დოკუმენტი შედგენილია %1%2 %3-ისთვის';ru='Документ составлен на%1%2 %3'"), Символы.ПС, КоличествоСтраниц,
			УправлениеНебольшойФирмойСервер.ФормаМножественногоЧисла(НСтр("ka='ფურცელს';ru='листе'"), НСтр("ka='გვერდებზე';ru='листах'"), НСтр("ka='გვერდებზე';ru='листах'"), КоличествоСтраниц)
			));
		...
		Если НЕ ПустаяСтрока(СведенияОПоставщике.ИНН) 
			...
			ПредставлениеОрганизации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1, გსნ/აამკ %2/%3';ru='%1, ИНН/КПП %2/%3'"),
		...
		ИначеЕсли НЕ ПустаяСтрока(СведенияОПоставщике.ИНН) Тогда
			...
			ПредставлениеОрганизации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1, გსნ %2';ru='%1, ИНН %2'"),
		...
		Если НЕ ПустаяСтрока(СведенияОПокупателе.ИНН)
			...
			ПредставлениеКонтрагента = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1, გსნ/აამკ %2/%3';ru='%1, ИНН/КПП %2/%3'"),
		...
		ИначеЕсли НЕ ПустаяСтрока(СведенияОПокупателе.ИНН) Тогда
			...
			ПредставлениеКонтрагента = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1, გსნ %2';ru='%1, ИНН %2'"),
...
Процедура СформироватьКоммерческоеПредложение(ПечатнаяФорма, МассивОбъектов, ОбъектыПечати, Ошибки)
	...
	Пока Шапка.Следующий() Цикл
		...
		Пока НомерВарианта <= ПоследнийВариант Цикл
			...
			Если ЕстьНесколькоВариантов Тогда
				ДанныеПечати.Очистить();
				ДанныеПечати.Вставить("ВариантПредставление", СтрШаблон(НСтр("ru='Вариант №%1';ka='Вариант №%1'"), НомерВарианта));
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='მყიდველის შეკვეთა';ru='Заказ покупателя'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='ხელშეკრულების დანართი';ru='Приложение к договору'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ru='Калькуляция';ka='კალკულაცია'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ru='Коммерческое предложение';ka='კომერციული წინადადება'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ru='Заказ-наряд';ka='შეკვეთა-განწესი'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='ზედნადები';ru='Накладная'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='უნივერსალური გადასაცემი დოკუმენტი';ru='Универсальный передаточный документ'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='საგარანტიო ტალონი';ru='Гарантийный талон'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.ПолныйПутьКМакету = "Документ.ЗаказПокупателя.ПФ_MXL_СводныйОтчет";
		ПечатнаяФорма.СинонимМакета = НСтр("ka='ნაკრები დავალიანება';ru='Сводный отчет'");
	...
	Если ПечатнаяФорма <> Неопределено Тогда //И Константы.ФункционалСбораТоваров.Получить() Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='აგროვების შემოწმება';ru='Проверка сбора'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='მყიდველის შეკვეთა';ru='Заказ покупателя'");
	...
	КомандаПечати.Представление = НСтр("ka='ხელშეკრულების ფორმა';ru='Форма договора'");
	...
	КомандаПечати.Представление = НСтр("ka='ხელშეკრულების დანართი';ru='Приложение к договору'");
	КомандаПечати.СписокФорм = "ФормаДокумента,ФормаСписка,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МестоРазмещения = "ПодменюПечать";
	...
	КомандаПечати.Представление = НСтр("ka='კონვერტი';ru='Конверт'");
	КомандаПечати.СписокФорм = "ФормаДокумента,ФормаСписка,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате";
	...
	КомандаПечати.Представление = НСтр("ru='Калькуляция';ka='კალკულაცია'");
	...
	КомандаПечати.Представление = НСтр("ka='Сводно о заказе';ru='Сводно о заказе'");
	КомандаПечати.СписокФорм = "ФормаДокумента";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МестоРазмещения = "ПодменюПечать";
	...
	Если РольДоступна("ПолныеПрава") ИЛИ РольДоступна("ДобавлениеИзменениеПодсистемыПродажи") Тогда
		...
		КомандаПечати.Представление = НСтр("ru='Коммерческое предложение';ka='კომერციული წინადადება'");
	...
	КомандаПечати.Представление = НСтр("ka='Настраиваемый комплект документов';ru='Настраиваемый комплект документов'");
	...
	КомандаПечати.Представление = НСтр("ru='Заказ-наряд';ka='შეკვეთა-განწესი'");
	КомандаПечати.СписокФорм = "ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,РеквизитыПечатиЗаказНаряд";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МестоРазмещения = "ПодменюПечать";
	...
	КомандаПечати.Представление = НСтр("ru='Расходная накладная';ka='გასავლის ზედდებული'");
	КомандаПечати.СписокФорм = "ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,РеквизитыПечатиЗаказНаряд";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МестоРазмещения = "ПодменюПечать";
	КомандаПечати.Порядок = 23;
	...
	КомандаПечати.Представление = НСтр("ru='Расходная накладная (с услугами)';ka='გასავლის ზედნადები (მომსახურებებთან ერთად)'");
	КомандаПечати.СписокФорм = "ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,РеквизитыПечатиЗаказНаряд";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МестоРазмещения = "ПодменюПечать";
	КомандаПечати.Порядок = 26;
	...
	КомандаПечати.Представление = НСтр("ka='უნივერსალური გადასაცემი დოკუმენტი';ru='Универсальный передаточный документ'");
	КомандаПечати.СписокФорм = "ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,РеквизитыПечатиЗаказНаряд";
	КомандаПечати.ПроверкаПроведенияПередПечатью = Ложь;
	КомандаПечати.МестоРазмещения = "ПодменюПечать";
	...
	КомандаПечати.Представление = НСтр("ka='საგარანტიო ტალონი';ru='Гарантийный талон'");
	...
	КомандаПечати.Представление = НСтр("ka='Сводно о заказ-наряде';ru='Сводно о заказ-наряде'");
	...
	//Если Константы.ФункционалСбораТоваров.Получить() Тогда
		...
		КомандаПечати.Представление = НСтр("ka='აგროვების შემოწმება';ru='Проверка сбора'");
		//КомандаПечати.СписокФорм = "ФормаДокумента,ФормаСписка,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате,ФормаЗаказНаряда,ФормаСпискаЗаказНаряда,ФормаСпискаДокументовКОтгрузке,ФормаСпискаДокументовКОплате";
		КомандаПечати.СписокФорм = "ФормаДокумента";
...
КонецПроцедуры
//ПодольскийАИ #УчетПроектов 1.10.2020 }