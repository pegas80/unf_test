...
Процедура УстановитьСведенияДействующегоСогласия()
	...
	ЧастиСообщения.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='სუბიექტ %1-ს მიღებული ჰქონდა';ru='У субъекта %1 уже было получено';en='In the subject% 1 has already been received'"), Формат(Согласие.ДатаПолучения, "ДЛФ=D")) + " ");
