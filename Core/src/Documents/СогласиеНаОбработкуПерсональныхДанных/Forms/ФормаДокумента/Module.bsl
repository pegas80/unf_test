...
Процедура УстановитьСведенияДействующегоСогласия()
	...
	ЧастиСообщения.Добавить(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='სუბიექტ %1-ს მიღებული ჰქონდა';ru='У субъекта %1 уже было получено'"), Формат(Согласие.ДатаПолучения, "ДЛФ=D")) + " ");
