...
Функция ТекстЗапросаИнициализироватьДанныеДокумента()
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВЫРАЗИТЬ(&Ссылка КАК Документ.РасходнаяНакладная) КАК Ссылка,
	|	СУММА(ЕСТЬNULL(РасходнаяНакладнаяПредоплата.Курс, 0)) / МАКСИМУМ(РасходнаяНакладнаяПредоплата.НомерСтроки) КАК Курс,
	|	СУММА(ЕСТЬNULL(РасходнаяНакладнаяПредоплата.Кратность, 0)) / МАКСИМУМ(РасходнаяНакладнаяПредоплата.НомерСтроки) КАК Кратность,
