...
Процедура СформироватьПланированиеРасходаДС(ТабличныйДокумент, МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		Заголовок = НСтр("ka='Планирование расхода денежных средств № ';ru='Планирование расхода денежных средств № '") + НомерДокумента + НСтр("ru=' от ';ka='ვისგან'") + ДатаДокумента;
		...
		Если ДанныеДокумента.ТипДС = Перечисления.ТипыДенежныхСредств.Безналичные Тогда
			...
			ОписаниеИсточникаФинансирования = НСтр("ka='расчетный счет организации № ';ru='расчетный счет организации № '") + ДанныеДокумента.НомерРС;
			
		ИначеЕсли ДанныеДокумента.ТипДС = Перечисления.ТипыДенежныхСредств.Безналичные Тогда
			
			ОписаниеИсточникаФинансирования = НСтр("ka='касса организации ';ru='касса организации '") + ДанныеДокумента.Касса;
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='ფს-ის ხარჯვის დაგეგმვა';ru='Планирование расходов ДС';en='DS planning costs'");
