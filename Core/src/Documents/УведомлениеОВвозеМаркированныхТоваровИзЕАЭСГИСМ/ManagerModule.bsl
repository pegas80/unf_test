...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_40(ДокументСсылка)
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		Исключение
			ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
				СообщениеXML,
				СтрШаблон(НСтр("ka='В строке %1 указана некорректная стоимость ""%2"".';ru='В строке %1 указана некорректная стоимость ""%2"".'"),
					СтрокаТЧ.НомерСтроки,
...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_41(ДокументСсылка)
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ka='Не указан или указан неверно номер документа-основания.';ru='Не указан или указан неверно номер документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ka='Не указана или указана неверно дата документа-основания.';ru='Не указана или указана неверно дата документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		...
		СообщениеXML,
			СтрШаблон(
				НСтр("ka='Не удалось определить наименование документа-основания.';ru='Не удалось определить наименование документа-основания.'"), Шапка.Контрагент));
	КонецПопытки;
