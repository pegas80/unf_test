...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_40(ДокументСсылка)
	...
	Для Каждого СтрокаТЧ Из Товары Цикл
		...
		Исключение
			ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
				СообщениеXML,
				СтрШаблон(НСтр("ka='В строке %1 указана некорректная стоимость ""%2"".';ru='В строке %1 указана некорректная стоимость ""%2"".';en='Line% 1 contains an incorrect value of ""2%"".'"),
					СтрокаТЧ.НомерСтроки,
...
Функция УведомлениеОВвозеМаркированныхТоваровИзЕАЭСXML2_41(ДокументСсылка)
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ka='Не указан или указан неверно номер документа-основания.';ru='Не указан или указан неверно номер документа-основания.';en='Unknown or document-base invalid number.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(
			СообщениеXML,
			СтрШаблон(
				НСтр("ka='Не указана или указана неверно дата документа-основания.';ru='Не указана или указана неверно дата документа-основания.';en='Missing or incorrect date of the document-base.'"), Шапка.Контрагент));
	КонецПопытки;
	...
	Исключение
		...
		СообщениеXML,
			СтрШаблон(
				НСтр("ka='Не удалось определить наименование документа-основания.';ru='Не удалось определить наименование документа-основания.';en='Unable to determine the name of the document-base.'"), Шапка.Контрагент));
	КонецПопытки;
