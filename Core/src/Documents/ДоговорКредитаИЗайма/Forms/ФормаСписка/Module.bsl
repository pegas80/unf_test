...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВидДоговораЗаймСотруднику = ПредопределенноеЗначение("Перечисление.ВидыДоговоровКредитаИЗайма.ДоговорЗаймаСотруднику");
...
Процедура ОткрытьОтчетПоКредитам(Команда)
	...
	Если ТекущиеДанные <> Неопределено И ТекущиеДанные.ВидДоговора <> ВидДоговораЗаймСотруднику Тогда
