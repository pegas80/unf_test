...
Процедура ИнициализироватьДанныеДокументаЗапасы(ДокументСсылкаВводНачальныхОстатков, СтруктураДополнительныеСвойства) Экспорт
	...
	|		ВводНачальныхОстатковЗапасы.Номенклатура.СчетУчетаЗатратРегл КАК СчетУчетаЗатратРегл //+++ Дмгг
	|	ИЗ
	...
	|		ЗНАЧЕНИЕ(ПланСчетов.ХозРасчетный.ПустаяСсылка) //+++ Дмгг
	|	ИЗ
	...
	|		ВводНачальныхОстатковЗапасыПринятые.Номенклатура.СчетУчетаЗатратРегл КАК СчетУчетаЗатратРегл //+++ Дмгг
	|	ИЗ
	...
	|		ВводНачальныхОстатковЗапасыПереданные.Номенклатура.СчетУчетаЗатратРегл КАК СчетУчетаЗатратРегл //+++ Дмгг
	|	ИЗ
