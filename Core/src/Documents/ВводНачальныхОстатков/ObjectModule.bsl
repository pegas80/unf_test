...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	СтратегияЗаполнения[Тип("ДокументСсылка.ИнвентаризацияОсновныхСредств")] = "ЗаполнитьПоИнвентаризацииОсновныхСредств";
  ...
  Процедура ЗаполнитьПоИнвентаризацииОсновныхСредств(ДокументСсылкаИнвентаризацияОсновныхСредств) Экспорт
	...
	Для каждого СтрокаТабличнойЧасти Из ДокументСсылкаИнвентаризацияОсновныхСредств.ВнеоборотныеАктивы Цикл
		...
		Если СтрокаТабличнойЧасти.Отклонение > 0 Тогда
			...
			ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаТабличнойЧасти);   
			НоваяСтрока.СтруктурнаяЕдиница = СтрокаТабличнойЧасти.Подразделение;
			НоваяСтрока.ТекущееСостояниеВнеоборотногоАктива = Перечисления.СостоянияВнеоборотныхАктивов.ПринятКУчету;
