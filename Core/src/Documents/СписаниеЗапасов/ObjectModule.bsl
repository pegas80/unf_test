...
Процедура ОтразитьДвиженияДокументаСписаниеЗапасов(ДополнительныеСвойства, Движения, Отказ)
	...
	Для каждого Выборка Из ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаЗапасы Цикл	
		...
		БухгалтерскийУчет.УстановитьСубконто(Движение.СчетДт, Движение.СубконтоДт, "Проекты", Выборка.Проект);//++Lazare.29.11.2021
		...
		БухгалтерскийУчет.УстановитьСубконто(Движение.СчетКт, Движение.СубконтоКт, "Проекты", Выборка.Проект);//++++Lazare.29.11.2021
