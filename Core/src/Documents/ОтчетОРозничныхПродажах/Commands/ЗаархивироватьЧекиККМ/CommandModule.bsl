...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПоказатьОповещениеПользователя(НСтр("ka='საკონტროლო-საკასო აპარატის ჩეკების არქივაცია შესრულებულია';ru='Архивация чеков ККМ выполнена';en='Archiving LSP checks performed'"));
