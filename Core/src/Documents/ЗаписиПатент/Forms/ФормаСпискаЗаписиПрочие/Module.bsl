...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок = ЭтаФорма.Заголовок + ?(ПустаяСтрока(ЭтаФорма.Заголовок),"",": ")+НСтр("ka='შემოსავლების აღრიცხვის წიგნის ჩანაწერები (პატენტი)';ru='Записи книги учета доходов (Патент)'");
...
Функция ЗапуститьОбновлениеДанныхНаСервере()
	...
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		ПараметрыФункции, 
		НСтр("ka='პატენტის ჩანაწერების სიის განახლება';ru='Обновление списка записей патента'"));
