...
Процедура СформироватьТаблицаРасчетыСПокупателями(ДокументСсылкаОперацияПоПлатежнымКартам, СтруктураДополнительныеСвойства)
	...
	// Щербаков +++
	Запрос.УстановитьПараметр("ПереводыВПутиРегл", ПланыСчетов.Хозрасчетный.ПереводыВПути);
	// Щербаков ---
	...
	|	&ПереводыВПутиРегл КАК ПереводыВПутиРегл,
	|	ВременнаяТаблицаРасшифровкаПлатежа.Статья КАК Статья,
	// Щербаков ---
	|	&ПереводыВПути КАК ПереводыВПути,
	|   ВременнаяТаблицаРасшифровкаПлатежа.ЭквайринговыйТерминал.СчетУчетаРегл КАК СчетУчетаТерминала, //+++ Дмгг
	...
	|
	|СГРУППИРОВАТЬ ПО
	|   ВременнаяТаблицаРасшифровкаПлатежа.ЭквайринговыйТерминал.СчетУчетаРегл, //+++ Дмгг
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаОперацияПоПлатежнымКартам, СтруктураДополнительныеСвойства) Экспорт
	...
	|	ТаблицаДокумента.Ссылка.БанковскийСчет.СчетУчетаРегл КАК БанковскийСчетКассаСчетУчетаРегл, //+++ Дмгг
	...
	|	ТаблицаДокумента.Ссылка.ЭквайринговыйТерминал.СчетУчетаРегл, //+++ Дмгг
	...
	|	ТаблицаДокумента.Ссылка.БанковскийСчет.СчетУчетаРегл //+++ Дмгг
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ТаблицаДокумента.БанковскийСчет.СчетУчетаРегл КАК БанковскийСчетСчетУчетаРегл, //+++ Дмгг
	|	ТаблицаДокумента.ЭквайринговыйТерминал,
	|	ТаблицаДокумента.ЭквайринговыйТерминал.СчетУчета,
	|	ТаблицаДокумента.ЭквайринговыйТерминал.СчетУчетаРегл,
	...
	// Щербаков +++
	ИнтеграцияСНалоговойСлужбой_И_БухгалтерскийУчет.СформироватьТаблицаХозрасчетный_ОперацияПоПлатежнымКартам(ДокументСсылкаОперацияПоПлатежнымКартам, СтруктураДополнительныеСвойства);
	// Щербакво ---
