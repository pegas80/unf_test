...
Процедура КоличествоПриИзменении(Элемент)
	...
	// //+++ Lazare_13.05.2021
	//
	//Если КоличествоСтр > Количество Тогда
	//	Если ПроверитьПравоРедактирования() Тогда
	//		Количество = КоличествоСтр;
	//	    Возврат;
	//	КонецЕсли;
	//КонецЕсли;					
	//
	//КоличествоСтр = Количество;
	//
	//Фрм = ПолучитьФорму("Документ.ЧекККМ.Форма.ФормаДокумента_РМК");
	//а = Фрм.ПолученыШтрихкоды(ДанныеШтрикодов) ; 
	 //--- Lazare_13.05.2021
