...
Процедура ДобавитьОплатуКартойЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ТипЗнч(Результат) = Тип("Структура") Тогда
		...
		ВидКарты = "";
		ЭквайриноговыйТерминал = ПредопределенноеЗначение("Справочник.ЭквайринговыеТерминалы.ПустаяСсылка");
		...
		Иначе
			...
			ЭквайриноговыйТерминал = СтруктураЭвкайринговогоТерминала.ЭквайринговыйТерминал;
		КонецЕсли;
		//--- Дмгг
		...
		ДополнительныеПараметры.Вставить("ЭквайриноговыйТерминал", ЭквайриноговыйТерминал);  //+++ Дмгг
...
Процедура ОперацияПоПлатежнойКартеЗавершение(РезультатВыполнения, Параметры) Экспорт
	...
	Если РезультатВыполнения.Результат Тогда
		...
		//+++ Дмгг
		Если ИспользоватьНовуюФормуОплат И ЗначениеЗаполнено(Параметры.ЭквайриноговыйТерминал) Тогда
			Объект.ЭквайринговыйТерминал = Параметры.ЭквайриноговыйТерминал;
			//ИзменитьЭквайринговыйТерминалВЧекеККМНаСервере(Параметры.ЭквайриноговыйТерминал);
		КонецЕсли;                                                   
		//--- Дмгг
