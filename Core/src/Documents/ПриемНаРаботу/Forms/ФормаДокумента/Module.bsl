...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ УчетНалогов Тогда
		...
		Элементы.Сотрудники.РасширеннаяПодсказка.Заголовок = 
			НСтр("ka='დარიცხვები და დაკავებები ყოველი თანამშრომლისთვის ცალ-ცალკე მიეთითება შესაბამის გვერდზე.';ru='Начисления и удержания указываются на соответствующей странице для каждого сотрудника в отдельности.'");
