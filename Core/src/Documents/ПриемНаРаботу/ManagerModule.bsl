...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаПриемНаРаботу, СтруктураДополнительныеСвойства) Экспорт
	...
	|	ПриемНаРаботуСотрудники.ГрафикРаботы КАК ГрафикРаботы,
	|	ПриемНаРаботуСотрудники.ЗанимаемыхСтавок КАК ЗанимаемыхСтавок,
	|	ПриемНаРаботуСотрудники.КлючСвязи КАК КлючСвязи,
	|	ПриемНаРаботуСотрудники.УчастникПенсионногоФонда КАК УчастникПенсионногоФонда,
	|	ПриемНаРаботуСотрудники.ВидУдержанияПФ КАК ВидУдержанияПФ,
	|	ПриемНаРаботуСотрудники.УчаствуетДобровольно КАК УчаствуетДобровольно,
	|	ПриемНаРаботуСотрудники.Период КАК Период,
	|	ПриемНаРаботуСотрудники.ДатаОкончанияДоговора КАК ДатаОкончанияДоговора
	|,	ПриемНаРаботуСотрудники.ВидОтпуска КАК ВидОтпуска //+++ Дмгг
	|,	ПриемНаРаботуСотрудники.ВидОтпуска.КоличествоДней КАК КоличествоДней //+++ Дмгг
	...
	|	ПриемНаРаботуСотрудники.Сотрудник КАК Сотрудник,
	|	ПриемНаРаботуСотрудники.Период КАК Период,
	|	ПриемНаРаботуНачисленияУдержания.ВидНачисленияУдержания КАК ВидНачисленияУдержания,
	|	ПриемНаРаботуНачисленияУдержания.Валюта КАК Валюта,
	|	ПриемНаРаботуНачисленияУдержания.Сумма КАК Сумма,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПриемНаРаботуНалогиНаДоходы.КлючСвязи КАК КлючСвязи,
	...
	|,	ТаблицаСотрудники.ВидОтпуска КАК ВидОтпуска //+++ Дмгг
	|,	ТаблицаСотрудники.КоличествоДней КАК КоличествоДнейОтпуска //+++ Дмгг
	|ИЗ
