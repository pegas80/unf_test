...
Процедура УстановитьВидимостьИДоступность(ВидОперацииПриИзменении = Ложь)
	...
	ВидимостьПроектов = УчетПоПроектам И ЭтаПеремещение;
	Элементы.ПроектОтправитель.Видимость		= ВидимостьПроектов;
	Элементы.ПроектПолучатель.Видимость			= ВидимостьПроектов;
	Элементы.ЗапасыПроектОтправитель.Видимость	= ВидимостьПроектов;
	Элементы.ЗапасыПроектПолучатель.Видимость	= ВидимостьПроектов;
	//ПодольскийАИ #УчетПроектов 08.10.2020 }
