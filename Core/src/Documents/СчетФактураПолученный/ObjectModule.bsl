...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(ДокументОснование)
		...
		ТекстОшибки = НСтр("ka='საფუძველ-დოკუმენტი %ПредставлениеДокументаОснования% არ არის გატარებული. ანგარიშფაქტურის გატარება შეუძლებელია.';ru='Документ-основание %ПредставлениеДокументаОснования% не проведен. Проведение счет фактуры не возможно.'");
