...
Процедура ЗаполнитьНачисленияУдержания(Команда)	
	...
	Если СтрокаТабличнойЧасти = Неопределено Тогда
		...
		Сообщение.Текст = НСтр("ka='არ არის არჩეული ცხრილის ნაწილ ""თანამშრომლების"" სტრიქონი!';ru='Не выбрана строка табличной части ""Сотрудники""!'");
		Сообщение.Сообщить();	
		Возврат;
