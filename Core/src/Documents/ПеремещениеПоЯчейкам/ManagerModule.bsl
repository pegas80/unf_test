...
Процедура СформироватьПеремещениеЗапасовПоЯчейкам(ОписаниеПечатнойФормы, МассивОбъектов, ОбъектыПечати)
	...
	Для каждого ТекущийДокумент Из МассивОбъектов Цикл
		...
		Если ВыборкаИтогов.ИтогКоличество = 0 Тогда
			...
			КоличествоПеремещеныхЗапасовПрописью = Нстр("ka='დოკუმენტში არ არის მითითებული გადაადგილებადი მარაგები.';ru='В документе не указаны перемещаемые запасы.'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета = НСтр("ka='მარაგების გადაადგილება უჯრედებში';ru='Перемещение запасов по ячейкам'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='მარაგების გადაადგილება უჯრედებში';ru='Перемещение запасов по ячейкам'");
