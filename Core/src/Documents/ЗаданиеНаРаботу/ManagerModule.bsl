...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='სამუშაო დავალება';ru='Задание на работу';en='Job to job'");
...
Процедура ПриЗаполненииРасширенногоВводаЗаписиКалендаря(ТаблицаОписаний) Экспорт
	...
	НоваяСтрока.Представление = НСтр("ka='სამუშაო დავალება: შიდა';ru='Задание на работу: внутреннее';en='a job assignment: interior'");
	...
	НоваяСтрока.Представление = НСтр("ka='სამუშაო დავალება: გარე';ru='Задание на работу: внешнее';en='a job assignment: External'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ka='სამუშაო დავალება';ru='Задания на работу';en='Job to job'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ka='კონტროლზე';ru='На контроле';en='under control'");
