...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='სამუშაო დავალება';ru='Задание на работу'");
...
Процедура ПриЗаполненииРасширенногоВводаЗаписиКалендаря(ТаблицаОписаний) Экспорт
	...
	НоваяСтрока.Представление = НСтр("ka='სამუშაო დავალება: შიდა';ru='Задание на работу: внутреннее'");
	...
	НоваяСтрока.Представление = НСтр("ka='სამუშაო დავალება: გარე';ru='Задание на работу: внешнее'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ka='სამუშაო დავალება';ru='Задания на работу'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ka='კონტროლზე';ru='На контроле'");
