...
Функция ИнициализироватьДанныеДокументаДляВыгрузки(ДокументСсылка, ВидДокумента) Экспорт
	...
	Иначе
		ТекстОшибки = НСтр("ka='Неподдерживаемый вид документа %1 для акта списания';ru='Неподдерживаемый вид документа %1 для акта списания';en='Unsupported document type% 1 for debiting act'");
