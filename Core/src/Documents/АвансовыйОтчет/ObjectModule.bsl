...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ЗПДетальноИтог = ПлатежныеВедомостиДетальный.Итог("Сумма"); //+++ Дмгг, 07.05.2025, ONESOFT-4025
	
	//Если ИзрасходованоИтог > ЗапасыИтог + РасходыИтог + ОплатыИтог + ЗПИтог Тогда
	Если ИзрасходованоИтог > ЗапасыИтог + РасходыИтог + ОплатыИтог + ЗПИтог + ЗПДетальноИтог Тогда //+++ Дмгг, 07.05.2025, ONESOFT-4025
