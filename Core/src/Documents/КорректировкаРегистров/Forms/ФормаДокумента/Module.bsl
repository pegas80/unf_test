...
Процедура ОбработатьИзменениеРегистров(СписокРегистров)
	...
	Для Каждого Элемент Из СписокРегистров Цикл
		...
		Если Элемент.Пометка Тогда
			...
			//Lazare
			Если   Элемент.Значение =  "ПараметрыВнеоборотныхАктивов"
				Тогда  Элементы.Загрузить.Видимость = Истина ;	
			ИначеЕсли   Элемент.Значение =  "Запасы"
				Тогда  Элементы.ЗагрузитьВРегистрЗапасы.Видимость = Истина ;
			КонецЕсли;
			//lazare
		Иначе
...
Процедура Загрузить(Команда)
	...
	Форма = ПолучитьФорму("Обработка.ОобработкаЗагрузкиТабличнойЧастиРегистра.Форма.Форма1");
...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ЗагрузитьВРегистрЗапасы.Видимость = Ложь;
	
	Для Каждого Регистр из Объект.ТаблицаРегистров Цикл 	   
			Если  Регистр.Имя = "ПараметрыВнеоборотныхАктивов"
				Тогда  Элементы.Загрузить.Видимость = Истина;
			ИначеЕсли Регистр.Имя = "Запасы"
				Тогда  Элементы.ЗагрузитьВРегистрЗапасы.Видимость = Истина;
			КонецЕсли;			
	КонецЦикла;	 
...
&НаКлиенте
Процедура ЗагрузитьВРегистрЗапасы(Команда)
		
	Форма = ПолучитьФорму("Обработка.ОобработкаЗагрузкиТабличнойЧастиРегистра.Форма.ФормаЗагрузкиВРегистрЗапаси");
	Если Не Форма.Открыта ()
		Тогда 
		Форма.Открыть();
	КонецЕсли;	
