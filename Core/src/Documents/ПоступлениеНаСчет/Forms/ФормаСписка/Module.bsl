...
Процедура ПоступлениеВозвратКредитаКонтрагентомБанк(Команда)
	...
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("ПоступлениеНаСчет", "ВозвратКредитаКонтрагентом", ДанныеМеток);
...
&НаКлиенте
Процедура ПоступлениеВозвратОтСотрудника(Команда) //+++ Дмгг ВозвратОтСотрудника
	
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("ПоступлениеНаСчет", "ВозвратДенегОтСотрудника", ДанныеМеток);
