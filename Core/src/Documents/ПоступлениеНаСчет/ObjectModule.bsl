...
Процедура ЗаполнитьПоНачислениюНалогов(ДокументОснование) Экспорт
	...
	Если ДокументОснование.ВидОперации <> Перечисления.ВидыОперацийНачислениеНалогов.Возмещение Тогда
		ВызватьИсключение НСтр("ka='ანგარიშზე შემოსვლის შეყვანა შეიძლება მხოლოდ გადასახადების ანაზღაურების, და არა დარიცხვის საფუძველზე.';ru='Поступление на счет можно ввести только на основании возмещения налогов, а не начисления.'");
	КонецЕсли;
...
Процедура ЗаполнитьПоРасходнойНакладной(ДокументОснование) Экспорт
	...
	Если ДокументОснование.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ПередачаВПереработку Тогда
		ТекстИсключения = НСтр("ka='დოკუმენტის შეყვანა ოპერაციის საფუძველზე შეუძლებელია - ""%ВидОперации""!';ru='Невозможен ввод документа на основании операции - ""%ВидОперации""!'");
...
Процедура ЗаполнитьПоПриемуВРемонт(ДокументСсылкаПриемИПередачаВРемонт) Экспорт
	...
	Если ДокументСсылкаПриемИПередачаВРемонт.ВариантРемонта = Перечисления.ВариантыРемонта.НашаМастерскаяМногоэтапныйРемонт Тогда
		ВызватьИсключение НСтр("ka='Для выбранного варианта ремонта вводите оплаты на основании подчиненных документов - Заказ-наряд, Расходная, Акт';ru='Для выбранного варианта ремонта вводите оплаты на основании подчиненных документов - Заказ-наряд, Расходная, Акт'");
	КонецЕсли;
