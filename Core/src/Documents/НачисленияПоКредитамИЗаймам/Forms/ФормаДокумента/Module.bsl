...
Процедура ЗаполнитьНачисления(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.ВидОперации) Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ka='ოპერაცია არ არის მითითებული!';ru='Не указана операция!'"));
		Возврат;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(Объект.Организация) Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ka='ორგანიზაცია არ არის მითითებული!';ru='Не указана организация!'"));
		Возврат;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(Объект.ДатаНачала) Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ka='დარიცხვების პერიოდის დასაწყისი არ არის მითითებული!';ru='Не указано начало периода начислений!'"));
		Возврат;
	КонецЕсли;
	
	Если НЕ ЗначениеЗаполнено(Объект.ДатаОкончания) Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ka='დარიცხვების პერიოდის დასასრული არ არის მითითებული!';ru='Не указан конец периода начислений!'"));
		Возврат;
	КонецЕсли;
