...
Процедура СформироватьТаблицаСуммовойУчетВРознице(ДокументСсылкаПереоценкаВРозницеСуммовойУчет, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ПереоценкаВРозницеСуммовойУчет", НСтр("ka='გადაფასება საცალო ვაჭრობაში';ru='Переоценка в рознице';en='Revaluation at retail'"));
...
Процедура СформироватьТаблицаУправленческий(ДокументСсылкаПереоценкаВРозницеСуммовойУчет, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ТорговаяНаценка", НСтр("ka='სავაჭრო ფასნამატი';ru='Торговая наценка';en='trade margin'"));
	Запрос.УстановитьПараметр("КурсоваяРазница", НСтр("ka='სხვაობა კურსებს შორის';ru='Курсовая разница';en='Exchange difference'"));
	Запрос.УстановитьПараметр("ОтражениеДоходов", НСтр("ka='შემოსავლების ასახვა';ru='Отражение доходов';en='income'"));
	Запрос.УстановитьПараметр("ОтражениеРасходов", НСтр("ka='ხარჯების ასახვა';ru='Отражение расходов';en='reflection expenditure'"));
