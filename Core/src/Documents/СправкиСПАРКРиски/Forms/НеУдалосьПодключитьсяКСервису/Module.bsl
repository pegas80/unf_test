...
Процедура ОтправитьСообщениеВТехПоддержку(АдресПолучателя)
	...
	Тема      = НСтр("ka='Интернет-поддержка. 1СПАРК Риски';ru='Интернет-поддержка. 1СПАРК Риски';en='Internet support. 1SPARK Risks'");
	Сообщение = НСтр("ka='Ошибка при подключении к сервису 1СПАРК Риски."
"Описание ошибки:';ru='Ошибка при подключении к сервису 1СПАРК Риски."
"Описание ошибки:'")
		+ Символы.ПС
		+ ИнформацияОбОшибке;
