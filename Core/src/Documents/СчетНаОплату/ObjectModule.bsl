		...
		Для Каждого Стр Из Запасы Цикл
			Если НЕ УправлениеНебольшойФирмойСервер.РазрешенаПродажаНоменклатурыПоДоговоруОбслуживания(Договор, Стр.Номенклатура, Стр.Характеристика) Тогда
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
					НСтр("ka='Запрещено проводить незапланированные запасы/услуги по текущему договору обслуживания!';ru='Запрещено проводить незапланированные запасы/услуги по текущему договору обслуживания!';en='It is forbidden to carry out unplanned inventory / services according to the current contract of service!'"),
...
Процедура ЗаполнитьПоЗаказуПокупателя(ДанныеЗаполнения) Экспорт
	...
	|	ЗаказПокупателя.Проект,  //Малышев 2024-06-22 ONESOFT-3265
