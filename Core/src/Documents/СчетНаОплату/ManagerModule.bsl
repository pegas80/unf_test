...
Функция ПечатьПриложениеКДоговору(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	Пока Шапка.Следующий() Цикл
		...
		Если Макет.Области.Найти("ИтогоКОплате") = Неопределено Тогда
			...
			ТекстСообщения = НСтр("ka='ყურადღება! მაკეტის არეალი ""სულ გადასახდელად"" არ არის აღმოჩენილი. შეიძლება გამოიყენება სამომხმარებლო მაკეტი.';ru='ВНИМАНИЕ! Не обнаружена область макета ""Итог к оплате"". Возможно используется пользовательский макет.'");
