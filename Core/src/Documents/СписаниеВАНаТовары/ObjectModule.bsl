...
Процедура ВыполнитьПредварительныйКонтроль(Отказ)
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		Пока ВыборкаИзРезультатаЗапроса.Следующий() Цикл
			ТекстСообщения = НСтр("ka='Остаточная стоимость имущества ""%ВнеоборотныйАктив%"" не равна распределенной себестоимости на товарах.';ru='Остаточная стоимость имущества ""%ВнеоборотныйАктив%"" не равна распределенной себестоимости на товарах.'"
			);
