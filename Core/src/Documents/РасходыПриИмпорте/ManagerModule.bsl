...
Процедура СформироватьТаблицаЗапасы(ДокументСсылкаРасходыПриИмпорте, СтруктураДополнительныеСвойства);
	...
	Запрос.УстановитьПараметр("ТаможеннаяПошлина", НСтр("ka='საბაჟო ბაჟი';ru='Таможенная пошлина'"));
	Запрос.УстановитьПараметр("ТаможенныйСбор", НСтр("ka='საბაჟო შეკრება';ru='Таможенный сбор'"));
	Запрос.УстановитьПараметр("ТаможенныйНДС", НСтр("ka='НДС, уплаченный таможенным органам';ru='НДС, уплаченный таможенным органам'"));
...
Процедура СформироватьТаблицаРасчетыСПрочимиКонтрагентами(ДокументСсылкаРасходыПриИмпорте, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ТаможенныйСбор", НСтр("ka='საბაჟო შეკრება';ru='Таможенный сбор'"));
	Запрос.УстановитьПараметр("ТаможеннаяПошлина", НСтр("ka='საბაჟო ბაჟი';ru='Таможенная пошлина'"));
	Запрос.УстановитьПараметр("ТаможенныйШтраф", НСтр("ka='საბაჟო ჯარიმა';ru='Таможенный штраф'"));
	Запрос.УстановитьПараметр("ТаможенныйНДС", НСтр("ka='НДС, уплаченный таможенным органам';ru='НДС, уплаченный таможенным органам'"));
