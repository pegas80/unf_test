...
Процедура ЗаполнитьПоИнвентаризацииВсеРасходжения(ДокументСсылкаИнвентаризацияЗапасов, ЗаполняетсяИзФормыДокумента = Ложь) Экспорт
	...
	Если РезультатЗапроса.Пустой() Тогда
		ВызватьИсключение НСтр("ka='Нет данных для оформления пересортицы: в инвентаризации нет отклонений или все документы уже оформлены!';ru='Нет данных для оформления пересортицы: в инвентаризации нет отклонений или все документы уже оформлены!'");
	КонецЕсли;
