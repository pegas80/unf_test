...
Процедура СформироватьТаблицаЗапасы(ДокументСсылкаСписаниеЗапасов, СтруктураДополнительныеСвойства)
	...
	Для н = 0 По КоличествоСтрок Цикл
		...
		Если Не УправлениеНебольшойФирмойСервер.ВыполнитьКонтрольОстатков() И
			...
			ШаблонСообщения = НСтр("ka='Номенклатура: %НоменклатураХарактеристикаПартия%';ru='Номенклатура: %НоменклатураХарактеристикаПартия%'");
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаСписаниеЗапасов, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ПоступлениеРасходов", НСтр("ka='სხვა ხარჯები';ru='Прочие расходы'"));
	Запрос.УстановитьПараметр("ПоступлениеДоходов", НСтр("ka='სხვა შემოსავლების შემოსვლა';ru='Поступление прочих доходов'"));
...
Процедура СформироватьАктПересортицыТоваров(ТабДокумент, ТекущийДокумент)
	...
	СинонимДокумента = НСтр("ka='Акт о пересортице товаров';ru='Акт о пересортице товаров'");
	...
	Пока ВыборкаДокументы.Следующий() Цикл
		...
		ТекстИтоговойСтроки = НСтр("ka='Всего наименований %ВсегоНаименований%';ru='Всего наименований %ВсегоНаименований%'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "АктПересортицыТоваров") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "АктПересортицыТоваров",
				НСтр("ka='Акт о пересортице товаров';ru='Акт о пересортице товаров'"),
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='Акт о пересортице товаров';ru='Акт о пересортице товаров'");
