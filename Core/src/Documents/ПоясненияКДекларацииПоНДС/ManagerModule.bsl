...
Функция ПредставлениеКонтрагента(Строка, Представление) Экспорт
	...
	Если ЗначениеЗаполнено(Представление) Тогда
		Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1 (%2)';ru='%1 (%2)'"), ПредставлениеИНН, Представление);
	Иначе
...
Функция ПредставлениеДокументаОплаты(Строка) Экспорт
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
											НСтр("ka='%1 %2-დან';ru='%1 от %2'"), Строка.Номер, Формат(Строка.Дата, "ДЛФ=D"));
КонецФункции
...
Функция НаименованиеОтветаПоТребованию(Требование) Экспорт
	...
	Наименование 			= НСтр("ka='Пояснения к декларации по НДС %ПредставлениеДекларации%';ru='Пояснения к декларации по НДС %ПредставлениеДекларации%'");
...
Функция ПредставлениеОшибкиРаздела8(КодОшибки, ГрафаОшибки) Экспорт
	...
	Если КодОшибки = 1 Тогда
		Возврат НСтр("ka='У контрагента нет записи об операции';ru='У контрагента нет записи об операции'");
	ИначеЕсли КодОшибки = 2 Тогда
		Возврат НСтр("ka='Операция отражена по разному в разделах 8 и 9';ru='Операция отражена по разному в разделах 8 и 9'");
	ИначеЕсли КодОшибки = 3 Тогда
		Возврат НСтр("ka='Операция отражена по разному в разделах 10 и 11';ru='Операция отражена по разному в разделах 10 и 11'")
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			Если Графа = "1" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер строки декл.""';ru='""Номер строки декл.""'"));
			ИначеЕсли Графа = "2" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код вида опер.""';ru='""Код вида опер.""'"));
			ИначеЕсли Графа = "3" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер с/ф""';ru='""Номер с/ф""'"));
			ИначеЕсли Графа = "4" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата с/ф""';ru='""Дата с/ф""'"));
			ИначеЕсли Графа = "5" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер испр. с/ф""';ru='""Номер испр. с/ф""'"));
			ИначеЕсли Графа = "6" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата испр. с/ф""';ru='""Дата испр. с/ф""'"));
			ИначеЕсли Графа = "7" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер корр. с/ф""';ru='""Номер корр. с/ф""'"));
			ИначеЕсли Графа = "8" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата корр. с/ф""';ru='""Дата корр. с/ф""'"));
			ИначеЕсли Графа = "9" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер испр. корр. с/ф""';ru='""Номер испр. корр. с/ф""'"));
			ИначеЕсли Графа = "10" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата испр. корр. с/ф""';ru='""Дата испр. корр. с/ф""'"));
			ИначеЕсли Графа = "11" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер док.оплаты""';ru='""Номер док.оплаты""'"));
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата док.оплаты""';ru='""Дата док.оплаты""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата принятия на учет""';ru='""Дата принятия на учет""'"));
			ИначеЕсли Графа = "14" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН продавца""';ru='""ИНН продавца""'"));
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН посредника""';ru='""ИНН посредника""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер тамож.декларации""';ru='""Номер тамож.декларации""'"));
			ИначеЕсли Графа = "17" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""'"));
			ИначеЕсли Графа = "18" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость""';ru='""Стоимость""'"));
			ИначеЕсли Графа = "19" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Сумма НДС к вычету""';ru='""Сумма НДС к вычету""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
			СообщениеОбОшибке = НСтр("ka='Ошибка в графах %1';ru='Ошибка в графах %1'");
		Иначе
			СообщениеОбОшибке = НСтр("ka='Ошибка в графе %1';ru='Ошибка в графе %1'");
		КонецЕсли;
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "10" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата испр. корр. с/ф""';ru='""Дата испр. корр. с/ф""'"));
			ИначеЕсли Графа = "11" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН покупателя""';ru='""ИНН покупателя""'"));
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН посредника""';ru='""ИНН посредника""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер док.оплаты""';ru='""Номер док.оплаты""'"));
			...
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стомость (всего)""';ru='""Стомость (всего)""'"));
			ИначеЕсли Графа = "17" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (НДС 18%)""';ru='""Стоимость (НДС 18%)""'"));
			ИначеЕсли Графа = "18" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (НДС 10%)""';ru='""Стоимость (НДС 10%)""'"));
			ИначеЕсли Графа = "19" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (НДС 0%)""';ru='""Стоимость (НДС 0%)""'"));
			ИначеЕсли Графа = "20" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""НДС 18%""';ru='""НДС 18%""'"));
			ИначеЕсли Графа = "21" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""НДС 10%""';ru='""НДС 10%""'"));
			ИначеЕсли Графа = "22" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (без НДС)""';ru='""Стоимость (без НДС)""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "11" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН покупателя""';ru='""ИНН покупателя""'"));
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН субкомиссионера""';ru='""ИНН субкомиссионера""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код вида сделки""';ru='""Код вида сделки""'"));
			ИначеЕсли Графа = "14" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""'"));
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (всего)""';ru='""Стоимость (всего)""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Сумма НДС""';ru='""Сумма НДС""'"));
			ИначеЕсли Графа = "17" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Увеличение стоимости""';ru='""Увеличение стоимости""'"));
			ИначеЕсли Графа = "18" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Уменьшение стоимости""';ru='""Уменьшение стоимости""'"));
			ИначеЕсли Графа = "19" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Увеличение суммы НДС""';ru='""Увеличение суммы НДС""'"));
			ИначеЕсли Графа = "20" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Уменьшение суммы НДС""';ru='""Уменьшение суммы НДС""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН продавца""';ru='""ИНН продавца""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер с/ф продавца""';ru='""Номер с/ф продавца""'"));
			ИначеЕсли Графа = "14" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата с/ф продавца""';ru='""Дата с/ф продавца""'"));
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость""';ru='""Стоимость""'"));
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "6" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Сумма НДС""';ru='""Сумма НДС""'"));
			ИначеЕсли Графа = "7" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стомоисть всего""';ru='""Стомоисть всего""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
