...
Функция ПредставлениеКонтрагента(Строка, Представление) Экспорт
	...
	ПредставлениеИНН = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1';ru='%1'"), Строка.ИНН);
	
	Если ЗначениеЗаполнено(Представление) Тогда
		Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1 (%2)';ru='%1 (%2)';en='%12)'"), ПредставлениеИНН, Представление);
	Иначе
...
Функция ПредставлениеДокументаОплаты(Строка) Экспорт
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
											НСтр("ka='%1 %2-დან';ru='%1 от %2';en='% 1% 2 from'"), Строка.Номер, Формат(Строка.Дата, "ДЛФ=D"));
КонецФункции
...
Функция НаименованиеОтветаПоТребованию(Требование) Экспорт
	...
	Наименование 			= НСтр("ka='Пояснения к декларации по НДС %ПредставлениеДекларации%';ru='Пояснения к декларации по НДС %ПредставлениеДекларации%';en='Explanation of the VAT declaration% PredstavlenieDeklaratsii%'");
...
Функция ПредставлениеОшибкиРаздела8(КодОшибки, ГрафаОшибки) Экспорт
	...
	Если КодОшибки = 1 Тогда
		Возврат НСтр("ka='У контрагента нет записи об операции';ru='У контрагента нет записи об операции';en='There is no record of the counterparty of the transaction'");
	ИначеЕсли КодОшибки = 2 Тогда
		Возврат НСтр("ka='Операция отражена по разному в разделах 8 и 9';ru='Операция отражена по разному в разделах 8 и 9';en='Operation is reflected differently in sections 8 and 9'");
	ИначеЕсли КодОшибки = 3 Тогда
		Возврат НСтр("ka='Операция отражена по разному в разделах 10 и 11';ru='Операция отражена по разному в разделах 10 и 11';en='Operation is reflected differently in sections 10 and 11'")
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			Если Графа = "1" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер строки декл.""';ru='""Номер строки декл.""';en='""Number DEKL line.""'"));
			ИначеЕсли Графа = "2" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код вида опер.""';ru='""Код вида опер.""';en='""Code type of opera.""'"));
			ИначеЕсли Графа = "3" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер с/ф""';ru='""Номер с/ф""';en='""S / F Number""'"));
			ИначеЕсли Графа = "4" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата с/ф""';ru='""Дата с/ф""';en='""Date with the / f""'"));
			ИначеЕсли Графа = "5" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер испр. с/ф""';ru='""Номер испр. с/ф""';en='""Number Corr. W / f""'"));
			ИначеЕсли Графа = "6" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата испр. с/ф""';ru='""Дата испр. с/ф""';en='""Date Corr. W / f""'"));
			ИначеЕсли Графа = "7" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер корр. с/ф""';ru='""Номер корр. с/ф""';en='""Number corr. W / f""'"));
			ИначеЕсли Графа = "8" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата корр. с/ф""';ru='""Дата корр. с/ф""';en='""Date of corr. W / f""'"));
			ИначеЕсли Графа = "9" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер испр. корр. с/ф""';ru='""Номер испр. корр. с/ф""';en='""Number Corr. Trend. W / f""'"));
			ИначеЕсли Графа = "10" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата испр. корр. с/ф""';ru='""Дата испр. корр. с/ф""';en='""Date Corr. Trend. W / f""'"));
			ИначеЕсли Графа = "11" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер док.оплаты""';ru='""Номер док.оплаты""';en='""Number dok.oplaty""'"));
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата док.оплаты""';ru='""Дата док.оплаты""';en='""Date dok.oplaty""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата принятия на учет""';ru='""Дата принятия на учет""';en='""Date of the registration""'"));
			ИначеЕсли Графа = "14" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН продавца""';ru='""ИНН продавца""';en='""INN Seller""'"));
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН посредника""';ru='""ИНН посредника""';en='""INN intermediary""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер тамож.декларации""';ru='""Номер тамож.декларации""';en='""Number tamozh.deklaratsii""'"));
			ИначеЕсли Графа = "17" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""';en='""Currency code""'"));
			ИначеЕсли Графа = "18" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость""';ru='""Стоимость""';en='""Cost""'"));
			ИначеЕсли Графа = "19" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Сумма НДС к вычету""';ru='""Сумма НДС к вычету""';en='""The amount of VAT deductible""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
			СообщениеОбОшибке = НСтр("ka='Ошибка в графах %1';ru='Ошибка в графах %1';en='Error in columns 1%'");
		Иначе
			СообщениеОбОшибке = НСтр("ka='Ошибка в графе %1';ru='Ошибка в графе %1';en='Error in column 1%'");
		КонецЕсли;
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "10" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата испр. корр. с/ф""';ru='""Дата испр. корр. с/ф""';en='""Date Corr. Trend. W / f""'"));
			ИначеЕсли Графа = "11" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН покупателя""';ru='""ИНН покупателя""';en='""TIN buyer""'"));
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН посредника""';ru='""ИНН посредника""';en='""INN intermediary""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер док.оплаты""';ru='""Номер док.оплаты""';en='""Number dok.oplaty""'"));
			...
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""';en='""Currency code""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стомость (всего)""';ru='""Стомость (всего)""';en='""Stomost (total)""'"));
			ИначеЕсли Графа = "17" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (НДС 18%)""';ru='""Стоимость (НДС 18%)""';en='""The price (VAT 18%)""'"));
			ИначеЕсли Графа = "18" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (НДС 10%)""';ru='""Стоимость (НДС 10%)""';en='""The price (VAT 10%)""'"));
			ИначеЕсли Графа = "19" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (НДС 0%)""';ru='""Стоимость (НДС 0%)""';en='""The price (VAT 0%)""'"));
			ИначеЕсли Графа = "20" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""НДС 18%""';ru='""НДС 18%""';en='""18% VAT""'"));
			ИначеЕсли Графа = "21" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""НДС 10%""';ru='""НДС 10%""';en='""VAT 10%,""'"));
			ИначеЕсли Графа = "22" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (без НДС)""';ru='""Стоимость (без НДС)""';en='""Cost without VAT)""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "11" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН покупателя""';ru='""ИНН покупателя""';en='""TIN buyer""'"));
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН субкомиссионера""';ru='""ИНН субкомиссионера""';en='""INN subcommission agent""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код вида сделки""';ru='""Код вида сделки""';en='""The type of transaction code""'"));
			ИначеЕсли Графа = "14" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""';en='""Currency code""'"));
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость (всего)""';ru='""Стоимость (всего)""';en='""The price (of all)""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Сумма НДС""';ru='""Сумма НДС""';en='""TAX""'"));
			ИначеЕсли Графа = "17" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Увеличение стоимости""';ru='""Увеличение стоимости""';en='""The increase in the cost of""'"));
			ИначеЕсли Графа = "18" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Уменьшение стоимости""';ru='""Уменьшение стоимости""';en='""Reducing the cost of""'"));
			ИначеЕсли Графа = "19" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Увеличение суммы НДС""';ru='""Увеличение суммы НДС""';en='""Increasing the amount of VAT""'"));
			ИначеЕсли Графа = "20" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Уменьшение суммы НДС""';ru='""Уменьшение суммы НДС""';en='""Reducing the amount of VAT""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "12" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""ИНН продавца""';ru='""ИНН продавца""';en='""INN Seller""'"));
			ИначеЕсли Графа = "13" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Номер с/ф продавца""';ru='""Номер с/ф продавца""';en='""W / f Number seller""'"));
			ИначеЕсли Графа = "14" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Дата с/ф продавца""';ru='""Дата с/ф продавца""';en='""S / F date Seller""'"));
			ИначеЕсли Графа = "15" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Код валюты""';ru='""Код валюты""';en='""Currency code""'"));
			ИначеЕсли Графа = "16" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стоимость""';ru='""Стоимость""';en='""Cost""'"));
	...
	ИначеЕсли КодОшибки = 4 Тогда
		...
		Для Каждого Графа Из МассивГраф Цикл
			...
			ИначеЕсли Графа = "6" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Сумма НДС""';ru='""Сумма НДС""';en='""TAX""'"));
			ИначеЕсли Графа = "7" Тогда
				МассивПредставлений.Добавить(НСтр("ka='""Стомоисть всего""';ru='""Стомоисть всего""';en='""Stomoist all""'"));
			КонецЕсли;
		КонецЦикла;
		ГрафыОшибки = СтрСоединить(МассивПредставлений, ", ");
		Если МассивПредставлений.Количество()> 1 Тогда
