...
Функция ПроверитьЗаполнениеНаКлиенте()
	...
	Для Каждого ДокументОплаты Из ДокументыОплаты Цикл
		Если НЕ ЗначениеЗаполнено(ДокументОплаты.Номер) Тогда
			ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Заполнение", НСтр("ka='ნომერი';ru='Номер';en='room'"));
		...
		Если НЕ ЗначениеЗаполнено(ДокументОплаты.Дата) Тогда
			ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Заполнение", НСтр("ka='თარიღი';ru='Дата';en='Date'"));
