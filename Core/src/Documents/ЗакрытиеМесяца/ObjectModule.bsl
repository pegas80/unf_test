...
Процедура РассчитатьКурсовыеРазницы(Отказ, ТаблицаОшибок)
	...
	Если _РасчетКурсовыхРазницКредиты Тогда
		...
		|	РасчетыПоКредитамИЗаймамОстатки.ОсновнойДолгОстаток,
		|	РасчетыПоКредитамИЗаймамОстатки.ОсновнойДолгВалОстаток
		...
		|	РасчетыПоКредитамИЗаймамОбороты.ОсновнойДолгРасход,
		...
		|			КОНЕЦ
		|	КОНЕЦ КАК Курс,
		|	ВТ_ОстаткиТекущегоМесяца.ОсновнойДолгОстаток,
		|	ВТ_ОстаткиТекущегоМесяца.ОсновнойДолгВалОстаток,
