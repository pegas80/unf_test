...
Процедура СформироватьДвиженияПоРегиструУчетаЗатрат(НаборЗаписей, НаборЗаписейУправленческий, НаборЗаписейХозрасчетный, СтрокаДвижения, Сумма, ФиксированнаяСтоимость, СодержаниеПроводки = Неопределено)
	...
	Иначе
		...
		БухгалтерскийУчет.УстановитьСубконто(НоваяСтрока.СчетДт, НоваяСтрока.СубконтоДт, "Номенклатура", СтрокаДвижения.КоррНоменклатура);//Номенклатура);
...
Процедура РассчитатьСтомостьВозвратов()
	...
	|	ТаблицаВозвратов.Номенклатура.НаправлениеДеятельности.СчетУчетаСебестоимостиПродажРегл КАК НаправлениеДеятельностиПродажиСчетУчетаСебестоимостиПродажРегл,
	|	ТаблицаВозвратов.Характеристика КАК Характеристика,
	|	ТаблицаВозвратов.Партия КАК Партия,
	|	ТаблицаВозвратов.ЗаказПокупателя КАК ЗаказПокупателя,
	...
	|	&ПустойСчетРегл КАК КоррСчетУчетаРегл, //+++ Дмгг
	...
	//|			И ТаблицаВозвратов.СчетУчетаРегл = ТаблицаПродажи.СчетУчетаРегл
	|			И ВЫБОР 
	|				КОГДА &ИспользоватьТолькоРегламентированныйПланСчетов 
	...
	//|			И (ТаблицаПродажи.КоррСчетУчетаРегл = &ПустойСчетРегл)
	|			И ВЫБОР 
	|				КОГДА &ИспользоватьТолькоРегламентированныйПланСчетов 
	...
	|	ТаблицаВозвратов.Номенклатура.НаправлениеДеятельности.СчетУчетаСебестоимостиПродажРегл,
