...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НомерТТН.Видимость = ПрихОрдВоВремяСинхронизациТТН;
	Элементы.IDTТН.Видимость   = ПрихОрдВоВремяСинхронизациТТН;
	//--Lazare 13.11.2023
...
Процедура КонтрагентПриИзменении(Элемент)
	Объект.Договор = РС_ОбщегоНазначения.ПолучитьЗначениеРеквизита(Объект.Контрагент, "ДоговорПоУмолчанию");
КонецПроцедуры