...
Процедура ЗапроситьОтменуПроведения(Команда)
	...
	ТекстВопроса = НСтр("ka='Отправить в ЕГАИС запрос на отмену проведения постановки на баланс?';ru='Отправить в ЕГАИС запрос на отмену проведения постановки на баланс?';en='Send in EGAIS request to cancel the setting on the balance sheet?'");
