...
Процедура ЗапроситьОтменуПроведения(Команда)
	...
	ТекстВопроса = НСтр("ka='Отправить в ЕГАИС запрос на отмену проведения постановки на баланс?';ru='Отправить в ЕГАИС запрос на отмену проведения постановки на баланс?'");
