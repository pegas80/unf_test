...
Процедура УстановитьУсловноеОформлениеСтатусаОбработки(Форма, ОформляемоеПоле = "Список", ПутьКДанным = "Список.СтатусОбработки") Экспорт
	...
	ПредставлениеЭлемента = НСтр("ka='ხორციელდება დოკუმენტის გადაცემა ესასს-ში';ru='Документ передается в ЕГАИС'");
	...
	ПредставлениеЭлемента = НСтр("ka='მიღებულია ესასს-ში გადაცემის შეცდომა';ru='Получена ошибка передачи в ЕГАИС'");
...
Функция ИнициализироватьДанныеДокументаДляВыгрузки(ДокументСсылка, ВидДокумента) Экспорт
	...
	Иначе
		ТекстОшибки = НСтр("ka='Неподдерживаемый вид документа %1 для акта постановки на баланс';ru='Неподдерживаемый вид документа %1 для акта постановки на баланс'");
