...
Процедура ДокументыОснованияДокументОснованиеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если Отказ Тогда
		ТекстСообщения = НСтр("ka='ასარჩევი დოკუმენტის კონტრაგენტი, ხელშეკრულება, ვალუტა ან ოპერაცია განსხვავდება ადრე არჩეული დოკუმენტებისგან.';ru='Контрагент, договор, валюта или операция выбираемого документа отличается от выбранных ранее документов.'");
		ОчиститьСообщения();
