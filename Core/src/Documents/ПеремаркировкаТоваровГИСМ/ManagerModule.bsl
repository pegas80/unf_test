...
Функция МаркировкаТоваровXML(ДокументСсылка)
	...
	Исключение
		ИнтеграцияГИСМКлиентСервер.ДобавитьТекстОшибки(СообщениеXML, СтрШаблон(НСтр("ka='ორგანიზაცია %1-ის GLN არ არის შევსებული.';ru='Не заполнен GLN организации %1.'"), Шапка.Организация));
	КонецПопытки;
