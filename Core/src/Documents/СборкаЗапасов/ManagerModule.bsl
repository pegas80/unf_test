...
Процедура СформироватьТаблицаЗапасыЗапасыСборка(ДокументСсылкаСборкаЗапасов, СтруктураДополнительныеСвойства, СуммаСборки)
	...
	Если ТаблицыПродукцияКПеремещению.Количество() > 1 Тогда
		...
		ТаблицыПродукцияКПеремещению.Свернуть("Организация,Период,СценарийПланирования,СтруктурнаяЕдиницаПродукции,ЗатратыНаВыпуск,КоррЗаказПокупателя,КоррНоменклатура,КоррПартия,КоррСтруктурнаяЕдиница,КоррСчетУчета,КоррСчетУчетаРегл,СчетУчетаЗатратРегл,КоррХарактеристика,СчетДтПродукции,СчетКтПродукции,СчетУчетаПродукции,СчетДтПродукцииРегл,СчетКтПродукцииРегл,СчетУчетаПродукцииРегл","Сумма");
	КонецЕсли;
...
Процедура СформироватьТаблицуРаспределенияМатериаловСборка(ДокументСсылкаСборкаЗапасов, СтруктураДополнительныеСвойства, ТаблицаПродукция) Экспорт
	...
	ТаблицаСоставПродукции.Свернуть("КоррНоменклатура,КоррХарактеристика,КоррПартия,КоррСпецификация,КоррСчетУчета,СчетУчетаПродукции,СчетДт,СчетДтПродукции,СчетКтПродукции,КоррСчетУчетаРегл,СчетУчетаЗатратРегл,СчетУчетаПродукцииРегл,СчетДтРегл,СчетДтПродукцииРегл,СчетКтПродукцииРегл,КоррКоличество,ТМНоменклатура,ТМХарактеристика,Распределено", "ТМКоличество");
...
Процедура СформироватьТаблицуРаспределенияМатериаловРазборка(ДокументСсылкаСборкаЗапасов, СтруктураДополнительныеСвойства, ТаблицаПродукция) Экспорт
	...
	ТаблицаСоставПродукции.Свернуть("Номенклатура,Характеристика,Партия,ПартияСтатус,Спецификация,СчетУчета,СчетУчетаЗапасов,СчетКт,СчетУчетаРегл,СчетУчетаЗапасовРегл,СчетКтРегл,Количество,Резерв,ТМНоменклатура,ТМХарактеристика");
