...
Процедура ПодобратьСправкиБ(Команда)
	...
	Если Объект.ОрганизацияЕГАИС.Пустая() Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Не выбрана организация ЕГАИС';ru='Не выбрана организация ЕГАИС';en='organization EGAIS not selected'"));
		Возврат;
	КонецЕсли;
