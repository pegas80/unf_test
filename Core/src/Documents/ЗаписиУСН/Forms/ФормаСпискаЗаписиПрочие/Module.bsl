...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок = ЭтаФорма.Заголовок + ?(ПустаяСтрока(ЭтаФорма.Заголовок),"",": ")+НСтр("ka='ჩანაწერები შემოსავლების და ხარჯების აღრიცხვის წიგნი';ru='Записи Книги учета доходов и расходов'");
...
Процедура ПересчитатьСДаты(Команда)
	...
	ПоказатьВводДаты(Оповещение, ТекущаяДата(), НСтр("ka='Пересчитать с даты';ru='Пересчитать с даты'"), ЧастиДаты.Дата);
...
Функция ЗапуститьОбновлениеДанныхНаСервере()
	...
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		ПараметрыФункции, 
		НСтр("ka='შემოსავლების და ხარჯების აღრიცხვის წიგნის ჩანაწერების სიის განახლება';ru='Обновление списка записей КУДиР'"));
