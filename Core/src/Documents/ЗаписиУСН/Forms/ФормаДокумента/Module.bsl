...
Процедура Декорация2Нажатие(Элемент)
	...
	ПоказатьПредупреждение(
			,
			НСтр("ka='მოცემული ჩანაწერები ავტომატურად არის გენერირებული. მოცემული დოკუმენტის ხელით შეცვლა არ არის რეკომენდებული. განმეორებითი, ავტომატური ჩამოყალიბებისას ხელით გაკეთებული კორექტირებები დაიკარგება."
"შესწორების შესაძლებლობის ჩასართავად დააჭირეთ «რედაქტირების რეჟიმის ჩართვა»-ს';ru='Данные записи сгенерированы автоматически. "
...
Процедура СтрокиДатаПервичногоДокументаПриИзменении(Элемент)
	...
	ТекстПредупреждения = НСтр("ru='Дата должны быть в интервале ';ka='Дата должны быть в интервале '")+ПредставлениеПериода;
