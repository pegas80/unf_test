...
Процедура СформироватьТаблицаРасчетыСПрочимиКонтрагентами(ДокументСсылкаПрочиеРасходы, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("КомментарийПриход", НСтр("ka='კონტრაგენტის ვალის გაზრდა';ru='Увеличение долга контрагента';en='The increase in the debt of the counterparty'"));
	Запрос.УстановитьПараметр("КомментарийРасход", НСтр("ka='კონტრაგენტის ვალის შემცირება';ru='Уменьшение долга контрагента';en='Reducing the debt counterparty'"));
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаПрочиеРасходы, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.УстановитьПараметр("ПоступлениеДоходов", НСтр("ka='სხვა შემოსავლები';ru='Прочие доходы';en='Other income'"));
	Запрос.УстановитьПараметр("ПрочееОприходование", НСтр("ka='სხვა ხარჯები (ხარჯები)';ru='Прочих затраты (расходы)';en='Other expenses (costs)'"));
