...
Процедура ПослеОтправкиЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ИмяВидаОбъекта = НСтр("ka='уведомление';ru='уведомление'");
...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.УведомлениеОтправлено Тогда
		Форма.ЗаданиеЯвноРеквизитовПолучателяДокументовПредставление = ?(НЕ Объект.ЗаданиеЯвноРеквизитовПолучателяДокументов,
			НСтр("ka='На учетную запись отправителя уведомления';ru='На учетную запись отправителя уведомления'"),
			НСтр("ka='Задать вручную реквизиты получателя документов';ru='Задать вручную реквизиты получателя документов'"));
		Форма.ПолучательДокументовЯвляетсяФизическимЛицомПредставление = ?(Объект.ПолучательДокументовЯвляетсяФизическимЛицом,
			НСтр("ka='იურიდიული პირი';ru='Юридическое лицо'"),
			НСтр("ka='ფიზიკური პირი';ru='Физическое лицо'"));
	...
	Если НЕ Объект.ЗаданиеЯвноРеквизитовПолучателяДокументов Тогда
		Если НЕ Форма.УведомлениеОтправлено Тогда
			ДолжностноеЛицоПредставление = ?(ЗначениеЗаполнено(Форма.ФамилияИмяОтчествоДолжностногоЛицаПредставление),
				СокрЛП(Форма.ФамилияИмяОтчествоДолжностногоЛицаПредставление), НСтр("ka='(არ არის განსაზღვრული)';ru='(не определено)'"));
...
"'");
		...
		ТекстСообщения = ТекстДолжностноеЛицо
			+ НСтр("ka='Обратите внимание, при смене должностного лица необходимо отправить уведомление заново.';ru='Обратите внимание, при смене должностного лица необходимо отправить уведомление заново.'");
