...
Процедура ЗаполнитьПоПриходнаяНакладная(ДокументСсылкаПриходнаяНакладная) Экспорт
	...
	Если ДокументСсылкаПриходнаяНакладная.ВидОперации <> Перечисления.ВидыОперацийПриходнаяНакладная.ПриемНаКомиссию Тогда
		...
		НСтр("ka='ოპერაცია ""%1""-ის საფუძველზე კომიტენტისთვის ანგარიშგების შეყვანა არ შეიძლება!';ru='Нельзя ввести Отчет комитенту на основании операции ""%1""!';en='You can not enter a report to the principal on the basis of the operation ""%1""!'"),
