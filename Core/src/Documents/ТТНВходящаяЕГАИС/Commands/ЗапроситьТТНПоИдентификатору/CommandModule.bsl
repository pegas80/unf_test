...
Процедура ФормированиеЗапросаТТН_Завершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='სასაქონლო-სატრანსპორტო ზედნადების ჩატვირთვის თაობაზე მოთხოვნა ჩამოყალიბებულია.';ru='Запрос на загрузку ТТН сформирован.';en='Download Request Waybill formed.'"));
