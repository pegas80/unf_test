...
Функция ИнициализироватьДанныеДокументаДляВыгрузки(ДокументСсылка, ВидДокумента) Экспорт
	...
	Иначе
		ТекстОшибки = НСтр("ka='Неподдерживаемый вид документа %1 для входящей ТТН';ru='Неподдерживаемый вид документа %1 для входящей ТТН';en='Unsupported document type% 1 inbound TTH'");
