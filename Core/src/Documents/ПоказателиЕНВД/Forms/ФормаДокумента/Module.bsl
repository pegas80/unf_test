...
Процедура Перезаполнить(Команда)
	...
	спсОтвет.Добавить(КодВозвратаДиалога.Да,НСтр("ka='ხელახლად შევსება';ru='Перезаполнить';en='refill'"));
	...
	Если Объект.ПоказателиЕНВД.Количество() > 0 Тогда
		...
		ПоказатьВопрос(оп,НСтр("ka='ცხრილი გასუფთავდება';ru='Табличная часть будет очищена';en='Tabular section is cleared'"),спсОтвет);
		Возврат;
	КонецЕсли;
...
Процедура НастроитьФорму()
	...
	Элементы.ПоказателиЕНВДЗаголовок1.Заголовок = 
		...
		+ Объект.ДнейВсего1 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего1, НСтр("ka='დღე';ru='день';en='day'"),НСтр("ka='დღე';ru='дня';en='day'"),НСтр("ka='დღე';ru='дней';en='days'"))
		+ ")";
	...
	Элементы.ПоказателиЕНВДЗаголовок2.Заголовок = 
		...
		+ Объект.ДнейВсего2 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего2, НСтр("ka='დღე';ru='день';en='day'"),НСтр("ka='დღე';ru='дня';en='day'"),НСтр("ka='დღე';ru='дней';en='days'"))
		+ ")";
	...
	Элементы.ПоказателиЕНВДЗаголовок3.Заголовок = 
		...
		+ Объект.ДнейВсего3 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего3, НСтр("ka='დღე';ru='день';en='day'"),НСтр("ka='დღე';ru='дня';en='day'"),НСтр("ka='დღე';ru='дней';en='days'"))
		+ ")";
