...
Процедура Перезаполнить(Команда)
	...
	спсОтвет.Добавить(КодВозвратаДиалога.Да,НСтр("ka='ხელახლად შევსება';ru='Перезаполнить'"));
	спсОтвет.Добавить(КодВозвратаДиалога.Отмена,НСтр("ka='გაუქმება';ru='Отмена'"));
	
	Если Объект.ПоказателиЕНВД.Количество() > 0 Тогда
		оп = Новый ОписаниеОповещения("ОповещениеОчистки", ЭтотОбъект);
		ПоказатьВопрос(оп,НСтр("ka='ცხრილი გასუფთავდება';ru='Табличная часть будет очищена'"),спсОтвет);
		Возврат;
	КонецЕсли;
...
Процедура НастроитьФорму()
	...
	Элементы.ПоказателиЕНВДЗаголовок1.Заголовок = 
		...
		+ Объект.ДнейВсего1 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего1, НСтр("ka='დღე';ru='день'"),НСтр("ka='დღე';ru='дня'"),НСтр("ka='დღე';ru='дней'"))
		+ ")";
	...
	Элементы.ПоказателиЕНВДЗаголовок2.Заголовок = 
		...
		+ Объект.ДнейВсего2 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего2, НСтр("ka='დღე';ru='день'"),НСтр("ka='დღე';ru='дня'"),НСтр("ka='დღე';ru='дней'"))
		+ ")";
	...
	Элементы.ПоказателиЕНВДЗаголовок3.Заголовок = 
		...
		+ Объект.ДнейВсего3 
		+ " "
		+ ПодобратьСловоПодЧисло(Объект.ДнейВсего3, НСтр("ka='დღე';ru='день'"),НСтр("ka='დღე';ru='дня'"),НСтр("ka='დღე';ru='дней'"))
		+ ")";
