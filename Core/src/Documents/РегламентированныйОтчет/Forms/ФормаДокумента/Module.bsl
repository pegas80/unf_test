...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИсточникОтчета = "РегламентированныйОтчетТорговыйСбор1"
		...
		Сообщение.Текст = НСтр("ka='Отчет был сохранен в предыдущей редакции конфигурации. Открытие невозможно.';ru='Отчет был сохранен в предыдущей редакции конфигурации. Открытие невозможно.'");
		Сообщение.Сообщить();
			...
			Иначе
				...
				Если Объект.ИсточникОтчета = "РегламентированныйОтчетРСВ1" Тогда
					...
					Если Объект.ДатаОкончания >= '20140101' Тогда
						...
						Сообщение = Новый СообщениеПользователю;
						Сообщение.Текст = НСтр("ka='Копирование формы РСВ-1, начиная с отчетного периода ""1 квартал 2014 г."" и более поздние, не предусмотрено.';ru='Копирование формы РСВ-1, начиная с отчетного периода ""1 квартал 2014 г."" и более поздние, не предусмотрено.'");
						Сообщение.Сообщить();
