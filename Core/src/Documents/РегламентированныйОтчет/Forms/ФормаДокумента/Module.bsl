...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИсточникОтчета = "РегламентированныйОтчетТорговыйСбор1"
		...
		Сообщение.Текст = НСтр("ka='Отчет был сохранен в предыдущей редакции конфигурации. Открытие невозможно.';ru='Отчет был сохранен в предыдущей редакции конфигурации. Открытие невозможно.';en='The report has been saved in a previous version of the configuration. Opening impossible.'");
		Сообщение.Сообщить();
	...
	Если ОткрытьФормуОтчета Тогда
			...
			Иначе
				...
				Если Объект.ИсточникОтчета = "РегламентированныйОтчетРСВ1" Тогда
					...
					Если Объект.ДатаОкончания >= '20140101' Тогда
						...
						Сообщение = Новый СообщениеПользователю;
						Сообщение.Текст = НСтр("ka='Копирование формы РСВ-1, начиная с отчетного периода ""1 квартал 2014 г."" и более поздние, не предусмотрено.';ru='Копирование формы РСВ-1, начиная с отчетного периода ""1 квартал 2014 г."" и более поздние, не предусмотрено.';en='Copy form RSV-1, starting from the reporting period ""Q1 2014"" and later, it is not provided.'");
						Сообщение.Сообщить();
		...
		Исключение
			...
			Если ИнформацияОбОшибке.Причина = Неопределено Тогда
				Сообщение.Текст = НСтр("ka='При открытии формы регламентированного отчета произошла ошибка.';ru='При открытии формы регламентированного отчета произошла ошибка.';en='When you open the form regulated Report an error occurred.'");
