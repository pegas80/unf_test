...
Процедура ПриЗаписи(Отказ)
	...
	Если мЭтоНовый Тогда
		РегламентированнаяОтчетность.ОбработатьСобытие1СОтчетности(НСтр("ka='Регламентированный отчет. Создание';ru='Регламентированный отчет. Создание'"), ЭтотОбъект.Ссылка);
	КонецЕсли;
