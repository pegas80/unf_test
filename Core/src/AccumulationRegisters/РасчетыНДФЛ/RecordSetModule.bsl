...
//	ЭлементБлокировки = Блокировка.Добавить("РегистрНакопления.РасчетыНДФЛ.НаборЗаписей");
...
//		Запрос = Новый Запрос(
//		"ВЫБРАТЬ
//		|	РасчетыНДФЛ.НомерСтроки КАК НомерСтроки,
//		|	РасчетыНДФЛ.Организация КАК Организация,
//		|	РасчетыНДФЛ.ВидНалога КАК ВидНалога,
//		|	ВЫБОР
//		|		КОГДА РасчетыНДФЛ.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
//		|			ТОГДА РасчетыНДФЛ.Сумма
//		|		ИНАЧЕ -РасчетыНДФЛ.Сумма
//		|	КОНЕЦ КАК СуммаПередЗаписью
//		|ПОМЕСТИТЬ ДвиженияРасчетыПоНалогамПередЗаписью
//		|ИЗ
//		|	РегистрНакопления.РасчетыНДФЛ КАК РасчетыНДФЛ
//		|ГДЕ
//		|	РасчетыНДФЛ.Регистратор = &Регистратор
//		|	И &Замещение");
//		
...
//		|
//		|ВЫБРАТЬ
//		|	РасчетыНДФЛ.НомерСтроки,
//		|	РасчетыНДФЛ.Организация,
//		|	РасчетыНДФЛ.ВидНалога,
//		|	ВЫБОР
//		|		КОГДА РасчетыНДФЛ.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
//		|			ТОГДА РасчетыНДФЛ.Сумма
//		|		ИНАЧЕ -РасчетыНДФЛ.Сумма
...
//	|		РегистрНакопления.РасчетыНДФЛ КАК РасчетыНДФЛ
//	|	ГДЕ
//	|		РасчетыНДФЛ.Регистратор = &Регистратор) КАК ДвиженияРасчетыПоНалогамИзменение
//	|
//	|СГРУППИРОВАТЬ ПО
