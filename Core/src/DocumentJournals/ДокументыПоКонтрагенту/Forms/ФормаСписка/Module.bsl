...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Контрагент.Пустая() Тогда
		ВызватьИсключение НСтр("ka='კონტრაგენტის თაობაზე დოკუმენტების ჟურნალის გახსნა ხდება კონტრაგენტის ბარათიდან.';ru='Журнал документов по контрагенту открывается из карточки контрагента.'");
	КонецЕсли;
	
	Заголовок = НСтр("ka='დოკუმენტი მიხედვით';ru='Документы по'") + " """ + Параметры.Контрагент + """";
