...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтаФорма.ЛентаНовостей.Пустая() Тогда
		Элементы.Список.Подсказка = НСтр("ka='კატეგორიები შერჩევის გარეშე, ახალი ამბების ყველა ლენტისთვის';ru='Категории без отбора, для всех лент новостей';en='Categories without selection, for all your feed'");
	...
	Иначе
		ТекстСообщения = НСтр("ka='კატეგორიები ახალი ამბების ლენტის მიხედვით შერჩევით %ЭтаФорма.ЛентаНовостей%';ru='Категории с отбором по ленте новостей %ЭтаФорма.ЛентаНовостей%';en='Categories with the selection of the newswire% EtaForma.LentaNovostey%'");
