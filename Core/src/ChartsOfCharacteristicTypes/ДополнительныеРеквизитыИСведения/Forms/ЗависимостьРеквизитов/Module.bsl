...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='დამატებითი რეკვიზიტ ""%2""-ის %1';ru='%1 дополнительного реквизита ""%2""';en='1% additional props ""%2""'");
	Если НастраиваемоеСвойство = "Доступен" Тогда
		ПредставлениеСвойства = НСтр("ka='წვდომა';ru='Доступность';en='Availability'");
	ИначеЕсли НастраиваемоеСвойство = "ЗаполнятьОбязательно" Тогда
		ПредставлениеСвойства = НСтр("ka='შევსების აუცილებლობა';ru='Обязательность заполнения';en='Mandatory fields'");
	Иначе
		ПредставлениеСвойства = НСтр("ka='ხილვადობა';ru='Видимость';en='Visibility'");
	КонецЕсли;
