...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='დამატებითი რეკვიზიტ ""%2""-ის %1';ru='%1 дополнительного реквизита ""%2""'");
	Если НастраиваемоеСвойство = "Доступен" Тогда
		ПредставлениеСвойства = НСтр("ka='წვდომა';ru='Доступность'");
	ИначеЕсли НастраиваемоеСвойство = "ЗаполнятьОбязательно" Тогда
		ПредставлениеСвойства = НСтр("ka='შევსების აუცილებლობა';ru='Обязательность заполнения'");
	Иначе
		ПредставлениеСвойства = НСтр("ka='ხილვადობა';ru='Видимость'");
	КонецЕсли;
