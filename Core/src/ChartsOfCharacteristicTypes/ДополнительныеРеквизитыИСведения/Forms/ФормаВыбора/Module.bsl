...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ВыборОбщегоСвойства Тогда
		...
		Если ЭтоДополнительноеСведение = Истина Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ka='საერთო დამატებითი ინფორმაციის არჩევა';ru='Выбор общего дополнительного сведения'");
		ИначеЕсли ЭтоДополнительноеСведение = Ложь Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ka='საერთო დამატებითი რეკვიზიტის არჩევა';ru='Выбор общего дополнительного реквизита'");
		КонецЕсли;
	...
	ИначеЕсли Параметры.ВыборВладельцаДополнительныхЗначений Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='აირჩიეთ ნიმუში';ru='Выбор образца'");
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		...
		НСтр("ka='საერთო (რამდენიმე კრებულისთვის)';ru='Общие (для нескольких наборов)'"),
		Истина);
