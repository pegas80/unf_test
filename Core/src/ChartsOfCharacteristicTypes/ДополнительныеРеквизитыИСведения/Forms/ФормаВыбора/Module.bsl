...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ВыборОбщегоСвойства Тогда
		...
		Если ЭтоДополнительноеСведение = Истина Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ka='საერთო დამატებითი ინფორმაციის არჩევა';ru='Выбор общего дополнительного сведения';en='Selecting additional general information'");
		ИначеЕсли ЭтоДополнительноеСведение = Ложь Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("ka='საერთო დამატებითი რეკვიზიტის არჩევა';ru='Выбор общего дополнительного реквизита';en='Selecting total additional props'");
		КонецЕсли;
	...
	ИначеЕсли Параметры.ВыборВладельцаДополнительныхЗначений Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='აირჩიეთ ნიმუში';ru='Выбор образца';en='Selection of the sample'");
