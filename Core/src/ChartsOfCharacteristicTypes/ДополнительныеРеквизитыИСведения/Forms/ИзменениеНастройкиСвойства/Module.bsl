...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоДополнительноеСведение Тогда
		...
		Заголовок = НСтр("ka='დამატებითი ინფორმაციის გამართვის შეცვლა';ru='Изменить настройку дополнительного сведения';en='Change the setting of additional information'");
	Иначе
...
Процедура ЗаписатьНачало()
	...
	Состояние(НСтр("ka='მიმდინარეობს თვისების გამართვის შეცვლა. გთხოვთ, მოიცადოთ';ru='Выполняется изменение настройки свойства. Пожалуйста, подождите';en='You modify the properties settings. Please wait'"));
...
Функция ЗаписатьНаСервере()
	...
	НаименованиеЗадания = НСтр("ka='დამატებითი თვისების გამართვის ცვლილება';ru='Изменение настройки дополнительного свойства';en='Changing the setting of additional properties'");
