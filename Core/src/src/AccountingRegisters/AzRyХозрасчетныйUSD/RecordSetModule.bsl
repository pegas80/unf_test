...
//		
//		Если Истина Тогда //УчетнаяПолитика.Существует(Организация, Период) Тогда
//			НоваяСтрока.ПлательщикНалогаНаПрибыль = Ложь; //УчетнаяПолитика.ПлательщикНалогаНаПрибыль(Организация, Период);
//			НоваяСтрока.ПоддержкаПБУ18 = Ложь; //УчетнаяПолитика.ПоддержкаПБУ18(Организация, Период);
//		Иначе
...
//		
//		Если Истина Тогда //УчетнаяПолитика.Существует(Организация, Период) Тогда
//			НоваяСтрока.РаздельныйУчетНДСНаСчете19 = Ложь; //УчетнаяПолитика.РаздельныйУчетНДСНаСчете19(Организация, Период);
//		Иначе
