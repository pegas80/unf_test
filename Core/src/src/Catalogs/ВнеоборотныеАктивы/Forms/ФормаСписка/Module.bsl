...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураСостоянияВнеоборотныхАктивов.Вставить("НеПринятКУчету", Перечисления.СостоянияВнеоборотныхАктивов.НеПринятКУчету); //++Lazare 05.08.2021	
...
Функция ПолучитьПериодПоследнегоНачисления(Знач Организация)
	...
	Если Выборка.Следующий() Тогда
		Возврат НСтр("ru='Последнее начисление: ';ka='Последнее начисление: '") + Формат(Выборка.Дата, "ДЛФ=DD");
	Иначе
		Возврат "";
	КонецЕсли;
