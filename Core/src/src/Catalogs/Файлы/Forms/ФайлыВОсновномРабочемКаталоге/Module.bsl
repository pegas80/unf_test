...
Процедура УдалитьИзЛокальногоКэшаФайловВыполнить()
	...
	ТекстВопроса = НСтр("ka='ძირითადი სამუშაო კატალოგიდან წავშალოთ არჩეული ფაილები?';ru='Удалить выбранные файлы из основного рабочего каталога?';en='Remove selected files from the main working directory?'");
...
"занятые для редактирования.';ka='ძირითადი სამუშაო კატალოგიდან რედაქტირებისთვის დაკავებული ფაილების წაშლა არ შეიძლება.'"));
	КонецЕсли;
