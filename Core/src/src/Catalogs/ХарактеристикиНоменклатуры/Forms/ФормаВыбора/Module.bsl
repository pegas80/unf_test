...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЕсли;
	//+++ Lazare_27.05.2021
	Если УправлениеНебольшойФирмойПовтИсп.ПолучитьЗначениеПоУмолчаниюПользователя(
		...
		ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ИспользуетсяВдокументах");
...
&НаКлиенте
Процедура КомандаХарактеристики(Команда)
	...
	КомандаХарактеристикиНаСервере(ТекущаяСтрока.Ссылка);
	
КонецПроцедуры

&НаСервере
Процедура КомандаХарактеристикиНаСервере(Характеристика)
