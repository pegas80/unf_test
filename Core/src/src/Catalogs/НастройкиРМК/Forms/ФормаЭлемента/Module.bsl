...
Функция АдресВоВременномХранилище()
	...
	Возврат ПоместитьВоВременноеХранилище(
		Новый Структура(
			...
			"БыстрыеТовары", Объект //Малышев 2025-03-10 ONESOFT-3916
		),
...
Процедура Заполнить(Команда)
	...
	Если Объект.КнопкиНижнейПанели.Количество()>0 Тогда
		...
		ТекстВопроса = НСтр("ka='ღილაკების ცხრილი შევსებულია. გავასუფთაოთ?';ru='Таблица кнопок заполнена. Очистить?';en='buttons Fill in the table. Clear?'");
