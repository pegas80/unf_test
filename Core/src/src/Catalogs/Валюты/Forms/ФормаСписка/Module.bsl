...
Процедура ЗагрузитьКурсыВалют(Команда)
	...
	ОткрытьФорму("Обработка.ЗагрузкаКурсовВалютГрузия.Форма.Форма", ПараметрыФормы);
	
КонецПроцедуры

&НаКлиенте
Процедура ЗагрузитьИсториюКурсовВалют(Команда)
	
	ПараметрыФормы = Новый Структура("ОткрытиеИзСписка");
	ОткрытьФорму("Обработка.ЗагрузкаКурсовВалютГрузия.Форма.ФормаИсторияКурсов", ПараметрыФормы);
