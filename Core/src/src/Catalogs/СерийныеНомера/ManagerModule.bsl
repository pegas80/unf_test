...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Владелец")
		...
		Сообщение.Текст = НСтр("ka='ნომენკლატურისთვის სერიული ნომრების აღრიცხვა არ წარმოებს!';ru='Для номенклатуры не ведется учет серийных номеров!';en='registration serial number is not conducted for an item!'");
		Сообщение.Сообщить();
