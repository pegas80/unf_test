...
Процедура ФормированиеЗапросаСправки_Завершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Запрос на загрузку справки 1 сформирован.';ru='Запрос на загрузку справки 1 сформирован.';en='Request for help load 1 is formed.'"));
