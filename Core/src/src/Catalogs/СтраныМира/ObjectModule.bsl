...
Функция СуществующийЭлемент() Экспорт
	...
	Если Выборка.Следующий() Тогда
		Результат = Новый Структура("ОписаниеОшибки", 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='კოდ %1-ით უკვე არსებობს ქვეყანა %2. შეცვალეთ კოდი ან გამოიყენეთ უკვე არსებული მონაცემები.';ru='С кодом %1 уже существует страна %2. Измените код или используйте уже существующие данные.';en='Code% 1 already exists% 2 country. Change the code, or use a pre-existing data.'"),
