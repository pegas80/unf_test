...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Kuzmich, 11.10.2023, (ONESOFT-2531) Добавление показателья "Сверхурочние часы" в формуле расчета начисление
	НовыйИсточник = ДеревоЗначений.Строки.Добавить();
	НовыйИсточник.ОписаниеПоля = "Сверхурочные часы";
	НовыйИсточник.Источник = "Справочники.ВидыРабочегоВремени.Сверхурочные";
	НовыйИсточник.ПредставлениеПоля = "Сверхурочные часы";
	НовыйИсточник.ИмяПоля = "Сверхурочные";
	// Kuzmich, 11.10.2023, (ONESOFT-2531) Добавление показателья "Сверхурочние часы" в формуле расчета начисление
