...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтображатьСклад Тогда
		СтрокиЗаголовкаФормы.Добавить(НСтр("ka='საწყობები';ru='Склады';en='warehouses'"));
	КонецЕсли;
	Если ОтображатьПодразделение Тогда
		СтрокиЗаголовкаФормы.Добавить(НСтр("ka='ქვეგანყოფილებები';ru='Подразделения';en='unit'"));
	КонецЕсли;
