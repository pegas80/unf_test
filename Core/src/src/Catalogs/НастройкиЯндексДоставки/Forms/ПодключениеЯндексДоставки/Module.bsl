...
Процедура КомандаПродолжить(Команда)
	...
	Если Не ЗначениеЗаполнено(Объект.КлючиМетодов) Тогда
		...
		НСтр("ka='Не указаны ключи методов.';ru='Не указаны ключи методов.';en='Are not given methods.'"),,
		"КлючиМетодов",
		"Объект");
		Возврат;
	КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(Объект.Идентификаторы) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
		НСтр("ka='Не указаны идентификаторы.';ru='Не указаны идентификаторы.';en='Not specified IDs.'"),,
		"Идентификаторы",
		"Объект");
		Возврат;
	КонецЕсли;
