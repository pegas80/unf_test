...
Процедура РабочийКаталогВладельцаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ДиалогОткрытияФайла.Выбрать() Тогда
		...
		Исключение
			...
			ТекстОшибки =
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='არასწორი გზაა ან კატალოგ ""%1""-ში არ არსებობს ჩაწერის უფლება';ru='Неверный путь или отсутствуют права на запись в каталог ""%1""';en='Invalid path or write permissions to the directory ""%1""'"), ИмяКаталога);
