...
"Открыть существующее рабочее место?';ka='ახალი სამუშაო ადგილის შექმნა არ არის საჭირო. "
"კლიენტის მოცემული იდენტიფიკატორისთვის იგი უკვე შექმნილია."
"გავხსნათ არსებული სამუშაო ადგილი?'");
