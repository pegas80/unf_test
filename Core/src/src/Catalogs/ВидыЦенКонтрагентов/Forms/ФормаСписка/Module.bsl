...
Процедура ПоказатьПомощникЗагрузкиДанныхИзВнешнегоИсточника()
	...
	Если ДанныеТекущейСтроки = Неопределено Тогда
		...
		ТекстСообщения = НСтр("ka='აუცილებელია კონტრაგენტის ფასების სახეობის გამოყოფა, რომლისთვის იგეგმება ფასების ჩატვირთვა';ru='Необходимо выделить вид цен контрагента, для которого планируется загрузить цены';en='It is necessary to highlight the type of counterparty price for which it is planned to download prices'");
