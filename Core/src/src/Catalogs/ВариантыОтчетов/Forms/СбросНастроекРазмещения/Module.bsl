...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("МассивВариантов") Или ТипЗнч(Параметры.МассивВариантов) <> Тип("Массив") Тогда
		ТекстОшибки = НСтр("ka='ანგარიშგებების ვარიანტები არ არის მითითებული.';ru='Не указаны варианты отчетов.';en='Not specified reporting options.'");
		Возврат;
	КонецЕсли;
...
Процедура КомандаСбросить(Команда)
	...
	Если КоличествоВыбранныхВариантов = 0 Тогда
		ПоказатьПредупреждение(, НСтр("ka='ანგარიშგებების ვარიანტები არ არის მითითებული.';ru='Не указаны варианты отчетов.';en='Not specified reporting options.'"));
		Возврат;
	КонецЕсли;
	...
	Если КоличествоВариантов = 1 И КоличествоВыбранныхВариантов = 1 Тогда
		...
		ОповещениеЗаголовок = НСтр("ka='ანგარიშგების ვარიანტის განთავსების გამართვები გასუფთავებულია';ru='Сброшены настройки размещения варианта отчета';en='Reset your network settings report options'");
...
"вариантов отчетов (%1 шт.).';ka='ანგარიშგების ვარიანტების განთავსების გამართვები გასუფთავებულია (%1 ც.).'");
...
"- Выбраны варианты дополнительных или внешних отчетов.';ka='ანგარიშგებების არჩეული ვარიანტების განთავსების გამართვების ჩამოყრა არ არის საჭირო ერთი, ან რამდენიმე მიზეზის გამო:"
"- არჩეულია ანგარიშგებების სამომხმარებლო ვარიანტები."
"- არჩეულია ანგარიშგებების წასაშლელად მონიშნული ვარიანტები."
"- არჩეულია დამატებითი ან გარე ანგარიშგებების ვარიანტები.'");
			Возврат;
		КонецЕсли;
	КонецЕсли;
