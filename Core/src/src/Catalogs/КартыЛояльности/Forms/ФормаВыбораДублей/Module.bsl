...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок =  НСтр("ka='შტრიხკოდის (მაგნიტური კოდის) და ბარათის სახეობის დუბლების სია';ru='Список дублей по штрихкоду (магнитному коду) и виду карты';en='List of doubles by barcode (magnetic code) and a mind map'");
