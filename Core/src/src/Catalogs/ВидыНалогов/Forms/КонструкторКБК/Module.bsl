...
Процедура СоздатьСоответствиеВидаИПодвидаДоходаДляСтраховыхВзносов()
	...
	Если ГодПлатежа < Год(ПлатежиВБюджетКлиентСервер.НачалоДействияПриказа2017_90н()) Тогда
		СтраховыеВзносы.Вставить("1011",
			НСтр("ka='1011 - страховые взносы до 2017 г. на обязательное медицинское страхование (ОМС)';ru='1011 - страховые взносы до 2017 г. на обязательное медицинское страхование (ОМС)';en='1011 - premiums until 2017 for compulsory health insurance (CHI)'"));
		ПениПоСтраховыеВзносы.Вставить("2011",
			НСтр("ka='2011 - пени и проценты по страховым взносам до 2017 г. на обязательное медицинское страхование (ОМС)';ru='2011 - пени и проценты по страховым взносам до 2017 г. на обязательное медицинское страхование (ОМС)';en='2011 - penalties and interest on insurance payments until 2017 for compulsory health insurance (CHI)'"));
		ШтрафыПоСтраховыеВзносы.Вставить("3011",
			НСтр("ka='3011 - штрафы по страховым взносам до 2017 г. на обязательное медицинское страхование (ОМС)';ru='3011 - штрафы по страховым взносам до 2017 г. на обязательное медицинское страхование (ОМС)';en='3011 - penalties on insurance premiums until 2017 for compulsory health insurance (CHI)'"));
	Иначе
		СтраховыеВзносы.Вставить("1013",
			НСтр("ka='1013 - страховые взносы с 2017 г. на обязательное медицинское страхование (ОМС)';ru='1013 - страховые взносы с 2017 г. на обязательное медицинское страхование (ОМС)';en='1013 - premiums from 2017 to compulsory health insurance (CHI)'"));
		ПениПоСтраховыеВзносы.Вставить("2013",
			НСтр("ka='2013 - пени по страховым взносам с 2017 г. на обязательное медицинское страхование (ОМС)';ru='2013 - пени по страховым взносам с 2017 г. на обязательное медицинское страхование (ОМС)';en='2013 - penalties on insurance premiums from 2017 to compulsory health insurance (CHI)'"));
		ПроцентыПоСтраховыеВзносы.Вставить("2213",
			НСтр("ka='2213 - проценты по страховым взносам с 2017 г. на обязательное медицинское страхование (ОМС)';ru='2213 - проценты по страховым взносам с 2017 г. на обязательное медицинское страхование (ОМС)';en='2213 - Interest on insurance premiums from 2017 to compulsory health insurance (CHI)'"));
		ШтрафыПоСтраховыеВзносы.Вставить("3013",
			НСтр("ka='3013 - штрафы по страховым взносам с 2017 г. на обязательное медицинское страхование (ОМС)';ru='3013 - штрафы по страховым взносам с 2017 г. на обязательное медицинское страхование (ОМС)';en='3013 - penalties on insurance premiums from 2017 to compulsory health insurance (CHI)'"));
	КонецЕсли;
	...
	ДопВзносыСамостоятельно.Вставить("1100",
		НСтр("ka='1100 - дополнительные страховые взносы на накопительную часть трудовой пенсии (для лиц уплачивающих самостоятельно)';ru='1100 - дополнительные страховые взносы на накопительную часть трудовой пенсии (для лиц уплачивающих самостоятельно)';en='1100 - additional insurance contributions to the funded part of labor pension (for persons paying their own)'"));
	ДопВзносыРаботодатель   = Новый Соответствие;
	ДопВзносыРаботодатель.Вставить("1200",
		НСтр("ka='1200 - дополнительные страховые взносы на накопительную часть трудовой пенсии (софинансирование работодателем)';ru='1200 - дополнительные страховые взносы на накопительную часть трудовой пенсии (софинансирование работодателем)';en='1200 - additional insurance contributions to the funded part of labor pension (co-financed by the employer)'"));
	ПодвидыДохода = Новый Массив;
	...
	ФиксированныеВзносыФСС.Вставить("6000",
		НСтр("ka='6000 - фиксированные взносы в Фонд социального страхования';ru='6000 - фиксированные взносы в Фонд социального страхования';en='6000 - fixed contributions to the Social Insurance Fund'"));
	ПодвидыДохода = Новый Массив;
	...
	СтраховыеВзносыДо2012.Вставить("1012",
		НСтр("ka='1012 - страховые взносы на обязательное медицинское страхование (ОМС) за себя до 2012 года';ru='1012 - страховые взносы на обязательное медицинское страхование (ОМС) за себя до 2012 года';en='1012 - premiums for compulsory health insurance (CHI) for themselves before 2012'"));
	ПодвидыДохода = Новый Массив;
	ПодвидыДохода.Добавить(СтраховыеВзносы);
	Если ГодПлатежа < Год(ПлатежиВБюджетКлиентСервер.НачалоДействияПриказа2017_90н()) Тогда
	...
	Если ГодПлатежа < Год(ПлатежиВБюджетКлиентСервер.НачалоДействияПриказа2017_90н()) Тогда
		ВзносыНаОПССтраховая.Вставить("1000",
			НСтр("ka='1000 - страховые взносы до 2017 г. на ОПС на выплату страховой пенсии';ru='1000 - страховые взносы до 2017 г. на ОПС на выплату страховой пенсии';en='1000 - premiums until 2017 at the OPS for the payment of pension'"));
		ПениНаВзносыНаОПССтраховая.Вставить("2100",
			НСтр("ka='2100 - пени по страховым взносам до 2017 г. на ОПС на выплату страховой пенсии';ru='2100 - пени по страховым взносам до 2017 г. на ОПС на выплату страховой пенсии';en='2100 - penalties for insurance premiums up to 2017 on the OPS for the payment of pension'"));
		ПроцентыНаВзносыНаОПССтраховая.Вставить("2200",
			НСтр("ka='2200 - проценты по страховым взносам до 2017 г. на ОПС на выплату страховой пенсии';ru='2200 - проценты по страховым взносам до 2017 г. на ОПС на выплату страховой пенсии';en='2200 - Interest on insurance premiums up to 2017 on the OPS for the payment of pension'"));
		ШтрафыНаВзносыНаОПССтраховая.Вставить("3000",
			НСтр("ka='3000 - штрафы по страховым взносам до 2017 г. на ОПС на выплату страховой пенсии';ru='3000 - штрафы по страховым взносам до 2017 г. на ОПС на выплату страховой пенсии';en='3000 - penalties for insurance premiums up to 2017 on the OPS for the payment of pension'"));
	Иначе
		ВзносыНаОПССтраховая.Вставить("1010",
			НСтр("ka='1010 - страховые взносы с 2017 г. на ОПС на выплату страховой пенсии';ru='1010 - страховые взносы с 2017 г. на ОПС на выплату страховой пенсии';en='1010 - premiums from 2017 to the OPS for the payment of pension'"));
		ПениНаВзносыНаОПССтраховая.Вставить("2110",
			НСтр("ka='2110 - пени по страховым взносам с 2017 г. на ОПС на выплату страховой пенсии';ru='2110 - пени по страховым взносам с 2017 г. на ОПС на выплату страховой пенсии';en='2110 - penalties on insurance premiums in 2017, at the OPS for the payment of pension'"));
		ПроцентыНаВзносыНаОПССтраховая.Вставить("2210",
			НСтр("ka='2210 - проценты по страховым взносам с 2017 г. на ОПС на выплату страховой пенсии';ru='2210 - проценты по страховым взносам с 2017 г. на ОПС на выплату страховой пенсии';en='2210 - Interest on insurance premiums in 2017, at the OPS for the payment of pension'"));
		ШтрафыНаВзносыНаОПССтраховая.Вставить("3010",
			НСтр("ka='3010 - штрафы по страховым взносам с 2017 г. на ОПС на выплату страховой пенсии';ru='3010 - штрафы по страховым взносам с 2017 г. на ОПС на выплату страховой пенсии';en='3010 - penalties on insurance premiums in 2017, at the OPS for the payment of pension'"));
	КонецЕсли;
	ПодвидыДохода = Новый Массив;
	...
	Если ГодПлатежа < Год(ПлатежиВБюджетКлиентСервер.НачалоДействияПриказа2017_90н()) Тогда
		ВзносыНаОПСвФиксированномРазмереДо.Вставить("1100",
			НСтр("ka='1100 - страховые взносы на ОПС в фиксированном размере до 2017 г., исчисленные с суммы дохода, не превышающие предела';ru='1100 - страховые взносы на ОПС в фиксированном размере до 2017 г., исчисленные с суммы дохода, не превышающие предела';en='1100 - premiums for OPS in a fixed amount of up to 2017, calculated from the amount of income that do not exceed the limit'"));
		ВзносыНаОПСвФиксированномРазмереСверх.Вставить("1200",
			НСтр("ka='1200 - страховые взносы на ОПС в фиксированном размере, исчисленные с суммы дохода, полученной сверх предела';ru='1200 - страховые взносы на ОПС в фиксированном размере, исчисленные с суммы дохода, полученной сверх предела';en='1200 - premiums for OPS in a fixed amount, calculated from the amount of income received in excess of the limit'"));
		ПениНаВзносыНаОПСвФиксированномРазмере.Вставить("2100",
			НСтр("ka='2100 - пени по страховым взносам на ОПС в фиксированном размере до 2017 г. на выплату страховой пенсии';ru='2100 - пени по страховым взносам на ОПС в фиксированном размере до 2017 г. на выплату страховой пенсии';en='2100 - penalties on insurance premiums in the OPS in a fixed amount of up to 2017 for the payment of pension'"));
		ПроцентыНаВзносыНаОПСвФиксированномРазмере.Вставить("2200",
			НСтр("ka='2200 - проценты по страховым взносам на ОПС в фиксированном размере до 2017 г. на выплату страховой пенсии';ru='2200 - проценты по страховым взносам на ОПС в фиксированном размере до 2017 г. на выплату страховой пенсии';en='2200 - Interest on insurance premiums in the OPS in a fixed amount of up to 2017 for the payment of pension'"));
		ШтрафыНаВзносыНаОПСвФиксированномРазмере.Вставить("3000",
			НСтр("ka='3000 - штрафы по страховым взносам на ОПС в фиксированном размере до 2017 г. на выплату страховой пенсии';ru='3000 - штрафы по страховым взносам на ОПС в фиксированном размере до 2017 г. на выплату страховой пенсии';en='3000 - penalties on insurance premiums in the OPS in a fixed amount of up to 2017 for the payment of pension'"));
	Иначе
		ВзносыНаОПСвФиксированномРазмереДо.Вставить("1110",
			НСтр("ka='1110 - страховые взносы на ОПС в фиксированном размере с 2017 г., исчисленные с суммы дохода, не превышающие предела';ru='1110 - страховые взносы на ОПС в фиксированном размере с 2017 г., исчисленные с суммы дохода, не превышающие предела';en='1110 - premiums for OPS in a fixed amount of 2017, calculated from the amount of income that do not exceed the limit'"));
		ВзносыНаОПСвФиксированномРазмереСверх.Вставить("1200",
			НСтр("ka='1200 - страховые взносы на ОПС в фиксированном размере, исчисленные с суммы дохода, полученной сверх предела';ru='1200 - страховые взносы на ОПС в фиксированном размере, исчисленные с суммы дохода, полученной сверх предела';en='1200 - premiums for OPS in a fixed amount, calculated from the amount of income received in excess of the limit'"));
		ПениНаВзносыНаОПСвФиксированномРазмере.Вставить("2110",
			НСтр("ka='2110 - пени по страховым взносам на ОПС в фиксированном размере с 2017 г. на выплату страховой пенсии';ru='2110 - пени по страховым взносам на ОПС в фиксированном размере с 2017 г. на выплату страховой пенсии';en='2110 - penalties on insurance premiums in the OPS in a fixed amount of 2017 for the payment of pension'"));
		ПроцентыНаВзносыНаОПСвФиксированномРазмере.Вставить("2210",
			НСтр("ka='2210 - проценты по страховым взносам на ОПС в фиксированном размере с 2017 г. на выплату страховой пенсии';ru='2210 - проценты по страховым взносам на ОПС в фиксированном размере с 2017 г. на выплату страховой пенсии';en='2210 - Interest on insurance premiums in the OPS in a fixed amount of 2017 for the payment of pension'"));
		ШтрафыНаВзносыНаОПСвФиксированномРазмере.Вставить("3010",
			НСтр("ka='3010 - штрафы по страховым взносам на ОПС в фиксированном размере с 2017 г. на выплату страховой пенсии';ru='3010 - штрафы по страховым взносам на ОПС в фиксированном размере с 2017 г. на выплату страховой пенсии';en='3010 - penalties on insurance premiums in the OPS in a fixed amount of 2017 for the payment of pension'"));
	КонецЕсли;
	ПодвидыДохода = Новый Массив;
	...
	Если ГодПлатежа < Год(ПлатежиВБюджетКлиентСервер.НачалоДействияПриказа2017_90н()) Тогда
		...
		СтраховыеВзносыВФСС.Вставить("1000",
			НСтр("ka='1000 - страховые взносы до 2017 г. в ФСС';ru='1000 - страховые взносы до 2017 г. в ФСС';en='1000 - premiums up to 2017 in the FSS'"));
		ПениНаСтраховыеВзносыВФСС.Вставить("2100",
			НСтр("ka='2100 - пени по страховым взносам до 2017 г. в ФСС';ru='2100 - пени по страховым взносам до 2017 г. в ФСС';en='2100 - penalties for insurance premiums up to 2017 in the FSS'"));
		ПроцентыНаСтраховыеВзносыВФСС.Вставить("2200",
			НСтр("ka='2200 - проценты по страховым взносам до 2017 г. на обязательное социальное страхование';ru='2200 - проценты по страховым взносам до 2017 г. на обязательное социальное страхование';en='2200 - Interest on insurance premiums until 2017 for compulsory social insurance'"));
		ШтрафыНаСтраховыеВзносыВФСС.Вставить("3000",
			НСтр("ka='3000 - штрафы по страховым взносам до 2017 г. в ФСС';ru='3000 - штрафы по страховым взносам до 2017 г. в ФСС';en='3000 - penalties for insurance premiums up to 2017 in the FSS'"));
	Иначе
		// Страховые взносы
		СтраховыеВзносыВФСС.Вставить("1010",
			НСтр("ka='1010 - страховые взносы с 2017 г. на обязательное социальное страхование';ru='1010 - страховые взносы с 2017 г. на обязательное социальное страхование';en='1010 - premiums from 2017 for compulsory social insurance'"));
		ПениНаСтраховыеВзносыВФСС.Вставить("2110",
			НСтр("ka='2110 - пени по страховым взносам с 2017 г. на обязательное социальное страхование';ru='2110 - пени по страховым взносам с 2017 г. на обязательное социальное страхование';en='2110 - penalties on insurance premiums 2017 for compulsory social insurance'"));
		ПроцентыНаСтраховыеВзносыВФСС.Вставить("2210",
			НСтр("ka='2210 - проценты по страховым взносам с 2017 г. на обязательное социальное страхование';ru='2210 - проценты по страховым взносам с 2017 г. на обязательное социальное страхование';en='2210 - Interest on insurance premiums 2017 for compulsory social insurance'"));
		ШтрафыНаСтраховыеВзносыВФСС.Вставить("3010",
			НСтр("ka='3010 - штрафы по страховым взносам с 2017 г. на обязательное социальное страхование';ru='3010 - штрафы по страховым взносам с 2017 г. на обязательное социальное страхование';en='3010 - penalties on insurance premiums 2017 for compulsory social insurance'"));
	КонецЕсли;
	ПодвидыДохода = Новый Массив;
	...
	ВзносыНаСтраховыеВзносыВФССНС.Вставить("1000",
		НСтр("ka='1000 - страховые взносы в ФСС от несчастных случаев';ru='1000 - страховые взносы в ФСС от несчастных случаев';en='1000 - the insurance premiums in the FSS Accident'"));
	ПениНаВзносыНаСтраховыеВзносыВФССНС     = Новый Соответствие;
	ПениНаВзносыНаСтраховыеВзносыВФССНС.Вставить("2100",
		НСтр("ka='2100 - пени по страховым взносам в ФСС от несчастных случаев';ru='2100 - пени по страховым взносам в ФСС от несчастных случаев';en='2100 - penalties on insurance premiums in the FSS Accident'"));
	ПроцентыНаВзносыНаСтраховыеВзносыВФССНС     = Новый Соответствие;
	ПроцентыНаВзносыНаСтраховыеВзносыВФССНС.Вставить("2200",
		НСтр("ka='2200 - проценты по страховым взносам в ФСС от несчастных случаев';ru='2200 - проценты по страховым взносам в ФСС от несчастных случаев';en='2200 - Interest on insurance premiums in the FSS Accident'"));
	ШтрафыНаВзносыНаСтраховыеВзносыВФССНС   = Новый Соответствие;
	ШтрафыНаВзносыНаСтраховыеВзносыВФССНС.Вставить("3000",
		НСтр("ka='3000 - штрафы по страховым взносам в ФСС от несчастных случаев';ru='3000 - штрафы по страховым взносам в ФСС от несчастных случаев';en='3000 - penalties on insurance premiums in the FSS Accident'"));
	ПодвидыДохода = Новый Массив;
	...
	СтраховыйВзносыВредныеУсловия.Вставить("1010",
		НСтр("ka='1010 - Страховые взносы по доп.тарифу за вредные условия труда (не зависит от специальной оценки)';ru='1010 - Страховые взносы по доп.тарифу за вредные условия труда (не зависит от специальной оценки)';en='1010 - Insurance premiums for dop.tarifu for harmful working conditions (independent of the special assessment)'"));
	СтраховыйВзносыВредныеУсловияСпецОценка = Новый Соответствие;
	СтраховыйВзносыВредныеУсловияСпецОценка.Вставить("1020",
		НСтр("ka='1020 - Страховые взносы по доп.тарифу за вредные условия труда (зависит от специальной оценки)';ru='1020 - Страховые взносы по доп.тарифу за вредные условия труда (зависит от специальной оценки)';en='1020 - Insurance premiums for dop.tarifu for harmful working conditions (independent of the special assessment)'"));
	ПодвидыДохода = Новый Массив;
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ka='КБК был изменен, сохранить?';ru='КБК был изменен, сохранить?';en='CSC has been changed, save?'");
...
Процедура АдминистраторДоходаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтруктураПараметров.Вставить("Заголовок",    НСтр("ka='Разряды 1-3 (код администратора поступлений)';ru='Разряды 1-3 (код администратора поступлений)';en='Bits 1-3 (revenue administrator code)'"));
...
Процедура ВидДоходаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтруктураПараметров.Вставить("Заголовок",           НСтр("ka='თანრიგი 4-20';ru='Разряды 4-20';en='Bits 4-20'"));
	СтруктураПараметров.Вставить("ГодПлатежа",          ГодПлатежа);
	ОткрытьФорму("Справочник.ВидыНалогов.Форма.ФормаВыбораКодаИзКлассификатора", СтруктураПараметров, Элемент);
...
Процедура ЗаполнитьСписокПодвидаДохода(Форма)
	...
	Если Форма.ВидПеречисления = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.НалоговыйПлатеж") Тогда
		...
		Иначе
			Элементы.ПодвидДохода.СписокВыбора.Добавить("1000",
				НСтр("ka='1000 - сумма налога (взноса)';ru='1000 - сумма налога (взноса)';en='1000 - the amount of tax (fee)'"));
			Если Форма.ГодПлатежа < Год(ПлатежиВБюджетКлиентСервер.НачалоДействияПриказа126н()) Тогда
				Элементы.ПодвидДохода.СписокВыбора.Добавить("2000",
					НСтр("ka='2000 - пени и проценты по налогу (взносу)';ru='2000 - пени и проценты по налогу (взносу)';en='2000 - percentage of fines and tax (contribution)'"));
			Иначе
				Элементы.ПодвидДохода.СписокВыбора.Добавить("2100",
					НСтр("ka='2100 - пени по налогу (взносу)';ru='2100 - пени по налогу (взносу)';en='2100 - interest income tax (fee)'"));
				Элементы.ПодвидДохода.СписокВыбора.Добавить("2200",
					НСтр("ka='2200 - проценты по налогу (взносу)';ru='2200 - проценты по налогу (взносу)';en='2200 - Percent tax (contribution)'"));
			КонецЕсли;
			Элементы.ПодвидДохода.СписокВыбора.Добавить("3000",
				НСтр("ka='3000 - суммы штрафов по налогу (взносу)';ru='3000 - суммы штрафов по налогу (взносу)';en='3000 - the amount of tax penalties (fee)'"));
			КонецЕсли;
	...
	ИначеЕсли Форма.ВидПеречисления = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.ТаможенныйПлатеж") Тогда
		Элементы.ПодвидДохода.СписокВыбора.Добавить("0000",
			НСтр("ka='0000 - сумма авансового платежа';ru='0000 - сумма авансового платежа';en='0000 - amount of the advance payment'"));
		Элементы.ПодвидДохода.СписокВыбора.Добавить("1000",
			НСтр("ka='1000 - сумма платежа';ru='1000 - сумма платежа';en='1000 - amount of payment'"));
		Элементы.ПодвидДохода.СписокВыбора.Добавить("2000",
			НСтр("ka='2000 - пени и проценты по соответствующему платежу';ru='2000 - пени и проценты по соответствующему платежу';en='2000 - penalties and interest on the respective payments'"));
		Элементы.ПодвидДохода.СписокВыбора.Добавить("3000",
			НСтр("ka='3000 - суммы денежных взысканий (штрафов) по соответствующему платежу';ru='3000 - суммы денежных взысканий (штрафов) по соответствующему платежу';en='3000 - amount of monetary penalties (fines) for the respective payments'"));
		Элементы.ПодвидДохода.СписокВыбора.Добавить("6000",
			НСтр("ka='6000 - в федеральные государственные органы, внебюджетные фонды, Банк России';ru='6000 - в федеральные государственные органы, внебюджетные фонды, Банк России';en='6000 - in the federal state bodies, non-budgetary funds, the Bank of Russia'"));
	Иначе
		Если Форма.ВидИПодвидДоходаДляСтраховыхВзносов.Свойство("ВД" + Форма.ВидДохода) Тогда
			Для каждого ПодвидДохода Из Форма.ВидИПодвидДоходаДляСтраховыхВзносов["ВД" + Форма.ВидДохода] Цикл
				Для каждого КлючиИЗначениеПодвидДохода Из ПодвидДохода Цикл
		...
		Иначе
			Элементы.ПодвидДохода.СписокВыбора.Добавить("1000",
				НСтр("ka='1000 - сумма взноса';ru='1000 - сумма взноса';en='1000 - Contribution'"));
			Элементы.ПодвидДохода.СписокВыбора.Добавить("2000",
				НСтр("ka='2000 - пени и проценты по взносу';ru='2000 - пени и проценты по взносу';en='2000 - penalties and interest on installment'"));
			Элементы.ПодвидДохода.СписокВыбора.Добавить("3000",
				НСтр("ka='3000 - суммы штрафов по взносу';ru='3000 - суммы штрафов по взносу';en='3000 - amount of contribution fines'"));
			Элементы.ПодвидДохода.СписокВыбора.Добавить("6000",
				НСтр("ka='6000 - суммы и штрафы в федеральные государственные органы, внебюджетные фонды, Банк России';ru='6000 - суммы и штрафы в федеральные государственные органы, внебюджетные фонды, Банк России';en='6000 - the amount of fines and federal government agencies, extra-budgetary funds, the Bank of Russia'"));
		КонецЕсли;
	КонецЕсли;
	
	Элементы.ПодвидДохода.СписокВыбора.Добавить("", НСтр("ka='<указать вручную>';ru='<указать вручную>';en='<Specify manually>'"));
...
Функция ЕстьОшибкиЗаполненияРеквизитов()
	...
	Если ПустаяСтрока(АдминистраторДохода) Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Заполнение", НСтр("ka='თანრიგი(ხარისხი) 1-3';ru='Разряды 1-3';en='Bits 1-3'"));
	...
	ИначеЕсли СтрДлина(АдминистраторДохода) <> 3 Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Корректность", НСтр("ka='თანრიგი(ხარისხი) 1-3';ru='Разряды 1-3';en='Bits 1-3'"),,,
			НСтр("ka='Поле должно состоять из 3 знаков';ru='Поле должно состоять из 3 знаков';en='The field shall consist of three characters'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "АдминистраторДохода");
		ЕстьОшибки = Истина;
	КонецЕсли;
	
	Если ПустаяСтрока(ВидДохода) Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Заполнение", НСтр("ka='თანრიგი 4-13';ru='Разряды 4-13';en='Bits 4-13'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "ВидДохода");
		ЕстьОшибки = Истина;
	ИначеЕсли СтрДлина(ВидДохода) <> 10 Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Корректность", НСтр("ka='თანრიგი 4-13';ru='Разряды 4-13';en='Bits 4-13'"),,,
			НСтр("ka='Поле должно состоять из 10 знаков';ru='Поле должно состоять из 10 знаков';en='The field shall consist of 10 characters'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "ВидДохода");
		ЕстьОшибки = Истина;
	КонецЕсли;
	
	Если ПустаяСтрока(ПодвидДохода) Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Заполнение", НСтр("ka='თანრიგი (ხარისხი) 14-17';ru='Разряды 14-17';en='Bits 14-17'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "ПодвидДохода");
		ЕстьОшибки = Истина;
	ИначеЕсли СтрДлина(ПодвидДохода) <> 4 Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Корректность", НСтр("ka='თანრიგი (ხარისხი) 14-17';ru='Разряды 14-17';en='Bits 14-17'"),,,
			НСтр("ka='Поле должно состоять из 4 знаков';ru='Поле должно состоять из 4 знаков';en='The field shall consist of 4 characters'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "ПодвидДохода");
		ЕстьОшибки = Истина;
	КонецЕсли;
	
	Если ПустаяСтрока(КОСГУ) Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Заполнение", НСтр("ka='თანრიგი (ხარისხი) 18-20';ru='Разряды 18-20';en='Bits 18-20'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "КОСГУ");
		ЕстьОшибки = Истина;
	ИначеЕсли СтрДлина(КОСГУ) <> 3 Тогда
		ТекстСообщения = ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения("Поле", "Корректность", НСтр("ka='თანრიგი (ხარისხი) 18-20';ru='Разряды 18-20';en='Bits 18-20'"),,,
			НСтр("ka='Поле должно состоять из 3 знаков';ru='Поле должно состоять из 3 знаков';en='The field shall consist of three characters'"));
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "КОСГУ");
		ЕстьОшибки = Истина;
	КонецЕсли;
