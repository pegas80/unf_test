...
Процедура ПередЗаписью(Отказ)
	...
	Если ЗначениеЗаполнено(ПодключаемоеОборудование)
		...
		Если Выборка.Следующий() Тогда
			Отказ = Истина;
			ТекстСообщения = НСтр("ka='Указанное оборудование уже используется в другой кассе ККМ.';ru='Указанное оборудование уже используется в другой кассе ККМ.';en='This equipment is already used in another box office cash register.'");
