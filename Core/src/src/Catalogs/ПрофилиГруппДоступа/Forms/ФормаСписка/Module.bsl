...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Заголовок = НСтр("ka='დაშვების ჯგუფების პროფილების შერჩევა';ru='Подбор профилей групп доступа';en='Selection of groups of access profiles'");
		Иначе
			Заголовок = НСтр("ka='დაშვების ჯგუფების პროფილის არჩევა';ru='Выбор профиля групп доступа';en='Profile selection group access'");
		КонецЕсли;
	Иначе
...
Процедура ВидПользователейНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПользователиСлужебныйКлиент.ВыбратьНазначение(ЭтотОбъект,
		НСтр("ka='პროფილების დანიშნულების არჩევა';ru='Выбор назначения профилей';en='The choice of destination profiles'"), Истина, Истина, ОписаниеОповещения);
