...
Функция ПолучитьСообщениеОбмена()
	...
	Если ТаблицаФайловСообщенийОбмена.Количество() = 0 Тогда
		...
		СтрокаСообщения = НСтр("ka='Каталог обмена информацией: ""%1""';ru='Каталог обмена информацией: ""%1""';en='information exchange directory: ""%1""'");
...
Функция ВыполнитьКопированиеФайла(Знач ИмяФайлаИсточника, Знач ИмяФайлаПриемника)
	...
	Исключение
		...
		СтрокаСообщения = НСтр("ka='Ошибка при копировании файла из %1 в %2. Описание ошибки: %3';ru='Ошибка при копировании файла из %1 в %2. Описание ошибки: %3';en='An error occurred while copying the file from% 1 to% 2. description of the error:% 3'");
...
Процедура ИнициализацияСообщенийОшибок()
	...
	СообщенияОшибок.Вставить(1, НСтр("ka='Ошибка подключения: Не указан каталог обмена информацией.';ru='Ошибка подключения: Не указан каталог обмена информацией.';en='Connection Error: Not specified information exchange directory.'"));
	СообщенияОшибок.Вставить(2, НСтр("ka='Ошибка подключения: Каталог обмена информацией не существует.';ru='Ошибка подключения: Каталог обмена информацией не существует.';en='Connection Error: Catalog exchange of information does not exist.'"));
	
	СообщенияОшибок.Вставить(3, НСтр("ka='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';ru='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';en='The message file catalog information was not found with the data exchange.'"));
	СообщенияОшибок.Вставить(4, НСтр("ka='Ошибка при распаковке сжатого файла сообщения.';ru='Ошибка при распаковке сжатого файла сообщения.';en='Error message when you unpack the compressed file.'"));
	СообщенияОшибок.Вставить(5, НСтр("ka='Ошибка при сжатии файла сообщения обмена.';ru='Ошибка при сжатии файла сообщения обмена.';en='Error during compression file sharing posts.'"));
	СообщенияОшибок.Вставить(6, НСтр("ka='Ошибка при создании временного каталога';ru='Ошибка при создании временного каталога';en='Error creating temporary directory'"));
	СообщенияОшибок.Вставить(7, НСтр("ka='Архив не содержит файл сообщения обмена';ru='Архив не содержит файл сообщения обмена';en='Archive contains file sharing posts'"));
	
	СообщенияОшибок.Вставить(8, НСтр("ka='Ошибка записи файла в каталог обмена информацией. Проверьте права пользователя на доступ к каталогу.';ru='Ошибка записи файла в каталог обмена информацией. Проверьте права пользователя на доступ к каталогу.';en=""Error writing file information exchange directory. Check the user's right to access the directory."""));
	СообщенияОшибок.Вставить(9, НСтр("ka='Ошибка удаления файла из каталога обмена информацией. Проверьте права пользователя на доступ к каталогу.';ru='Ошибка удаления файла из каталога обмена информацией. Проверьте права пользователя на доступ к каталогу.';en=""Failed to remove the file from the directory of information exchange. Check the user's right to access the directory."""));
