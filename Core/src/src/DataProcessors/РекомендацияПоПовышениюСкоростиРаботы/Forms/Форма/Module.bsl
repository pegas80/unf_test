...
Процедура ПриОткрытии(Отказ)
	...
	ТекстСообщения = НСтр("ka='На компьютере установлено %1 Гб оперативной памяти."
"Для того чтобы программа работала быстрее, "
"рекомендуется увеличить объем памяти до %2 Гб.';ru='На компьютере установлено %1 Гб оперативной памяти."
"Для того чтобы программа работала быстрее, "
"рекомендуется увеличить объем памяти до %2 Гб.'");
	...
	ЗаголовокСообщения = НСтр("ka='Рекомендация по повышению скорости работы';ru='Рекомендация по повышению скорости работы';en='The recommendation to increase the speed'");
	
	ПараметрыВопроса = СтандартныеПодсистемыКлиент.ПараметрыВопросаПользователю();
	ПараметрыВопроса.Заголовок = ЗаголовокСообщения;
	ПараметрыВопроса.Картинка = БиблиотекаКартинок.Предупреждение32;
	ПараметрыВопроса.Вставить("ТекстФлажка", НСтр("ka='Не показывать в течение двух месяцев';ru='Не показывать в течение двух месяцев';en='Do not show for two months'"));
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("ПродолжитьРаботу", НСтр("ka='Продолжить работу';ru='Продолжить работу';en='Continue work'"));
