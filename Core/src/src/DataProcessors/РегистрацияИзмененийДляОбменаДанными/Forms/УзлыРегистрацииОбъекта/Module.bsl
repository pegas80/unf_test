...
Процедура ИзменитьРегистрацию(Команда)
	...
	Текст = НСтр("ka='Изменить регистрацию ""%1"""
"на узлах?';ru='Изменить регистрацию ""%1"""
"на узлах?'");
...
Процедура ИзменитьРегистрациюЗавершение(Знач РезультатВопроса, Знач ДополнительныеПараметры) Экспорт
	...
	Если Количество > 0 Тогда
		Текст = НСтр("ka='Регистрация %1 была изменена на %2 узлах';ru='Регистрация %1 была изменена на %2 узлах';en='Registering% 1 has been changed to% 2 nodes'");
		ЗаголовокОповещения = НСтр("ka='Изменение регистрации:';ru='Изменение регистрации:';en='Change of registration:'");
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ka='ДеревоУзловОбменаНомерСообщения';ru='ДеревоУзловОбменаНомерСообщения';en='DerevoUzlovObmenaNomerSoobscheniya'"));
