...
Процедура ВыполнитьЗакрытиеМесяца(СтруктураПараметров, ФоновоеЗаданиеАдресХранилища = "") Экспорт
	...
	Если СтруктураПараметров.ВыполнитьРасчетАмортизации Тогда
		...
		Иначе
			...
			ДокОбъект.Комментарий = НСтр("ru = '#Создан автоматически, помощником закрытия месяца.'; ka = '#შექმნილია თვის დახურვის დოკუმენტის მიერ,ავტომატურად.'; en = '# Created automatically, closing the assistant month.'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ka='თვის დახურვა';ru='Закрытие месяца';en='month-end closing'");
	...
	Дело.Важное			= Истина;
	Дело.Представление	= НСтр("ka='Выполнить закрытие месяца';ru='Выполнить закрытие месяца';en='Perform month-end closing'");
	...
	Дело.Подсказка		= НСтр("ka='Закрытие месяца необходимо выполнить для окончательного расчета себестоимости, финансового результата и курсовых разниц';ru='Закрытие месяца необходимо выполнить для окончательного расчета себестоимости, финансового результата и курсовых разниц';en='Closing of the month you need to perform for the final costing, financial results and exchange rate differences'");
