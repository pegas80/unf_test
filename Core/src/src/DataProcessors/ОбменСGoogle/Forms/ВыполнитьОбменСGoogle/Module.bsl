...
Функция ЗаголовокВыполняетсяОбменGoogle()
	...
	Если ОбластьДоступа = Перечисления.ОбластиДоступаGoogle.Контакты Тогда
		Возврат НСтр("ka='Выполняется загрузка контактов из Google...';ru='Выполняется загрузка контактов из Google...';en='Loading contacts from Google ...'");
	ИначеЕсли ОбластьДоступа = Перечисления.ОбластиДоступаGoogle.Календарь Тогда
		Возврат НСтр("ka='Выполняется синхронизация календаря с Google...';ru='Выполняется синхронизация календаря с Google...';en='To synchronize the calendar with Google ...'");
	КонецЕсли;
	
	ВызватьИсключение НСтр("ka='Не указана область доступа для синхронизации с Google';ru='Не указана область доступа для синхронизации с Google';en='Not specified domain access to sync with Google'");
