...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипПолучателя = ФНС Тогда
		Заголовок = НСтр("ka='Изменение кодов ФНС';ru='Изменение кодов ФНС';en='Changing Tax Service code'");
		Элементы.СтраницыПолучателей.ТекущаяСтраница = Элементы.ГруппаФНС;
	Иначе
		Заголовок = НСтр("ka='Изменение кодов Росстата';ru='Изменение кодов Росстата';en='Change codes Rosstat'");
