...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТаблицаСРезультатами.Количество() = 1 И Параметры.РежимПоказаДляОдиночногоДокументаРазрешен Тогда
		Заголовок = НСтр("ka='შემოწმება';ru='Проверка';en='inspection'") + ": " + ТаблицаСРезультатами[0].ПредставлениеДокумента;
...
Процедура ЗаполнитьСоответствие(ПоддержкаСервисаОнлайнПроверкиВУниверсальномФормате = Ложь)
	...
	Если ПредставлениеРезультатовПроверки = Неопределено Тогда
		...
		Если ПоддержкаСервисаОнлайнПроверкиВУниверсальномФормате <> Истина Тогда
			...
			ПредставлениеРезультатовПроверки.Вставить("-1",	НСтр("ka='უცნობი შეცდომა';ru='Неизвестная ошибка';en='Unknown error'"));
			ПредставлениеРезультатовПроверки.Вставить("0",	НСтр("ka='Ошибок не обнаружено';ru='Ошибок не обнаружено';en='No errors were found'"));
			ПредставлениеРезультатовПроверки.Вставить("1",	НСтр("ka='Ошибка расшифровки';ru='Ошибка расшифровки';en='error decrypting'"));
			ПредставлениеРезультатовПроверки.Вставить("2",	НСтр("ka='Неизвестный формат';ru='Неизвестный формат';en='Unknown format'"));
			ПредставлениеРезультатовПроверки.Вставить("3",	НСтр("ka='Файл отчета поврежден';ru='Файл отчета поврежден';en='The report file is corrupted'"));
			ПредставлениеРезультатовПроверки.Вставить("4",	НСтр("ka='Обнаружены ошибки';ru='Обнаружены ошибки';en='errors found'"));
			ПредставлениеРезультатовПроверки.Вставить("5",	НСтр("ka='Проверка не выполнена';ru='Проверка не выполнена';en='Verification Failed'"));
			ПредставлениеРезультатовПроверки.Вставить("6",	НСтр("ka='Обнаружены ошибки';ru='Обнаружены ошибки';en='errors found'"));
		...
		Иначе
			...
			ПредставлениеРезультатовПроверки.Вставить("0",	НСтр("ka='Ошибок не обнаружено';ru='Ошибок не обнаружено';en='No errors were found'"));
			ПредставлениеРезультатовПроверки.Вставить("1",	НСтр("ka='Ошибка расшифровки';ru='Ошибка расшифровки';en='error decrypting'"));
			ПредставлениеРезультатовПроверки.Вставить("2",	НСтр("ka='Неизвестный формат или файл поврежден';ru='Неизвестный формат или файл поврежден';en='Unknown format, or the file is corrupted'"));
			ПредставлениеРезультатовПроверки.Вставить("3",	НСтр("ka='Обнаружены ошибки';ru='Обнаружены ошибки';en='errors found'"));
			ПредставлениеРезультатовПроверки.Вставить("4",	НСтр("ka='არის გაფრთხილებები';ru='Есть предупреждения';en='there are warnings'"));
