...
Процедура ВывестиСообщениеОНеправильномВыборе()
	...
	ТекстСообщения = НСтр("ka='საჭიროა შეავსოთ შემოსავლის ზედდებულის სია';ru='Необходимо заполнить список приходных накладных';en='It is necessary to fill the list of Invoice'");
