...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(МассивЭлементов) <> Тип("Массив") Тогда
		ВызватьИсключение НСтр("ka='В форму создания контрагентов переданы некорректные параметры.';ru='В форму создания контрагентов переданы некорректные параметры.';en='In the form of the creation of counterparties passed incorrect parameters.'");
	КонецЕсли;
	...
	ЗаголовокКоманды = НСтр("ka='Создать контрагентов (%КоличествоЭлементов%)';ru='Создать контрагентов (%КоличествоЭлементов%)';en='Create counterparties (% KolichestvoElementov%)'");
