...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ВключеноРезервирование = (ПолучитьФункциональнуюОпцию("РезервированиеЗапасов") ИЛИ ПолучитьФункциональнуюОпцию("РезервированиеЗапасов_new"));
	// Kuzmich, 28.10.2024, (ONESOFT-3520) Подбор номенклатуры в документах реализаций и подбор (две обработки)
	...
	// Kuzmich, 28.10.2024, (ONESOFT-3520) Подбор номенклатуры в документах реализаций и подбор (две обработки)
	ВключеноРезервирование = (ПолучитьФункциональнуюОпцию("РезервированиеЗапасов") ИЛИ ПолучитьФункциональнуюОпцию("РезервированиеЗапасов_new")) И Не Константы.НеРезервироватьВФормеПодбора.Получить();
	// Kuzmich, 28.10.2024, (ONESOFT-3520) Подбор номенклатуры в документах реализаций и подбор (две обработки)
