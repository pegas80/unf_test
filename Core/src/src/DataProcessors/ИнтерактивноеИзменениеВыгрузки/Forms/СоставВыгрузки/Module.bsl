...
Функция СформироватьТабличныйДокументСервер()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = 
		НСтр("ka='Формирование отчета по составу данных для отправки при синхронизации';ru='Формирование отчета по составу данных для отправки при синхронизации';en='Generating a report on the composition of the data to be sent during synchronization'");
