...
""
"%1';ka='При обновлении версии программы возникла ошибка:"
""
"%1'"),
...
#КонецЕсли
	...
	ДиалогОткрытияФайла.Фильтр = НСтр("ka='გარე დამუშავება';ru='Внешняя обработка';en='external processing'") + "(*.epf)|*.epf";
	ДиалогОткрытияФайла.МножественныйВыбор = Ложь;
	ДиалогОткрытияФайла.Заголовок = НСтр("ka='Выберите внешнюю обработку';ru='Выберите внешнюю обработку';en='Select external processing'");
