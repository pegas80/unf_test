...
Процедура УдалитьНажатие(Элемент)
	...
	ПоказатьВопрос(ОписаниеОповещения, НСтр("ka='Удалить Ваш комментарий?';ru='Удалить Ваш комментарий?';en='To delete your comment?'"), РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да);
...
Процедура ДобавитьКомментарий(Команда)
	...
	Если ПустаяСтрока(ТекстКомментария) Тогда 
		ВызватьИсключение НСтр("ka='Поле комментарий должно быть заполнено';ru='Поле комментарий должно быть заполнено';en='Comments field must be filled'");
	КонецЕсли;
