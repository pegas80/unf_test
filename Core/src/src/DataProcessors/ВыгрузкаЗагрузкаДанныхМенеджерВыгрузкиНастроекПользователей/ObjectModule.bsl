		...
		Пока Продолжать Цикл
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
					НСтр("ka='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';en='VygruzkaZagruzkaDannyh.VygruzkaNastroykiPropuschena'", Метаданные.ОсновнойЯзык.КодЯзыка),
...
"Пользователь=%3"
"Представление=%4"
"';ka='Выгрузка настройки пропущена, т.к. настройка не может быть прочитана:"
"КлючНастроек=%1"
"КлючОбъекта=%2"
"Пользователь=%3"
"Представление=%4"
...
Процедура ВыгрузитьЭлементНастроек(ПотокЗаписи, Знач КлючНастроек, Знач КлючОбъекта, Знач Пользователь, Знач Представление, Знач Настройки)
	...
	Если НайтиНедопустимыеСимволыXML(КлючНастроек) > 0
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';ru='ВыгрузкаЗагрузкаДанных.ВыгрузкаНастройкиПропущена';en='VygruzkaZagruzkaDannyh.VygruzkaNastroykiPropuschena'", Метаданные.ОсновнойЯзык.КодЯзыка),
			УровеньЖурналаРегистрации.Предупреждение,,,
			НСтр("ka='Выгрузка настройки пропущена, т.к. в ключевых параметрах содержатся недопустимые символы.';ru='Выгрузка настройки пропущена, т.к. в ключевых параметрах содержатся недопустимые символы.';en='Uploading settings skipped because in key parameters contain invalid characters.'", Метаданные.ОсновнойЯзык.КодЯзыка));
