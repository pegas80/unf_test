...
"ФайловыеФункцииСлужебныйВМоделиСервисаБТС.ПередВыгрузкойОбъекта()!';ka='მეტამონაცემთა ობიექტი %1 არ შეიძლება დამუშავდეს შემდეგი დამამუშავებლით ფილურიფუნქციებისამსახურებრივისტბსერვისისმოდელში.ობიექტისგადმოტვირთვამდე()!'", Метаданные.ОсновнойЯзык.КодЯзыка),
