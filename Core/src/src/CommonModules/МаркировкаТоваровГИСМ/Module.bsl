...
Процедура ПроверитьСоответствияGTIN(ДокументОбъект, Отказ) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		ШаблонСообщения = НСтр("ka='GTIN КиЗ %1 %2 отличается от GTIN товара %3 в строке %4.';ru='GTIN КиЗ %1 %2 отличается от GTIN товара %3 в строке %4.';en='GTIN Keyes% 1% 2 differs from GTIN Product% 3% 4 in a row.'");
