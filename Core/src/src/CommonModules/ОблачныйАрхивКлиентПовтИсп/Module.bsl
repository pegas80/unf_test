...
"%1';ka='Ошибка при использовании Windows Script Host:"
"%1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
			ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:ОблачныйАрхив.Отладка';ru='БИП:ОблачныйАрхив.Отладка';en='BIP: OblachnyyArhiv.Otladka'"), // ИмяСобытия
				НСтр("ka='Облачный архив. Отладка. Работа с Windows Script Host';ru='Облачный архив. Отладка. Работа с Windows Script Host';en='Cloud archive. Debugging. Working with the Windows Script Host'"), // ИдентификаторШага
