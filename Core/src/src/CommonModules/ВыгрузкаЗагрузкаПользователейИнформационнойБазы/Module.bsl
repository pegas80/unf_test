...
Функция РежимЗапускаСтрокой(Знач РежимЗапуска)
	...
	Иначе
		ШаблонСообщения = НСтр("ka='საკლიენტო დანართის გაშვების უცნობი რეჟიმი %1';ru='Неизвестный режим запуска клиентского приложения %1';en='Unknown client application startup mode 1%'");
