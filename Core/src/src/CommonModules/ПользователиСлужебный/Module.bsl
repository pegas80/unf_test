...
"""%1""."
""
"Обратитесь к администратору.';ka='სეანს მიმდინარემომხმარებელი-ს პარამეტრის დადგენა ვერ მოხერხდა შემდეგი მიზეზით:"
"""%1""."
""
...
"მიმართეთ ადმინისტრატორს.'"),
	...
	Если Не РолиАдминистратораДоступны() Тогда
		Возврат КраткоеПредставлениеОшибкиАвторизацииПослеРегистрацииВЖурнале(
			НСтр("ka='უფლება ადმინისტრირების მქონე მომხმარებლის სახელით გაშვება შეუძლებელია, ვინაიდან იგი არ არის რეგისტრირებული მომხმარებელთა სიაში."
""
"სიის საწარმოებლად და მომხმარებელთა უფლებების გასამართად განკუთვნილია სია მომხმარებლები, ამისათვის კონფიგურირების რეჟიმ 1С:საწარმოს გამოყენება საჭირო არ არის.';ru='Запуск от имени пользователя с правом Администрирование невозможен,"
...
"режим конфигурирования 1С:Предприятия для этого использовать не следует.'"),
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		Возврат КраткоеПредставлениеОшибкиАвторизацииПослеРегистрацииВЖурнале(ИнформацияОбОшибке,
			НСтр("ka='სიაში ადმინისტრატორის ავტომატური რეგისტრაციის შესრულება ვერ მოხერხდა შემდეგი მიზეზით:"
"""%1""."
""
"სიის საწარმოებლად და მომხმარებლების უფლებების გასამართად განკუთვნილია სია ""მომხმარებლები"", ამისთვის 1С:საწარმოს კონფიგურირების რეჟიმის გამოყენება არ არის საჭირო.';ru='Не удалось выполнить автоматическую регистрацию администратора в списке по причине:"
"""%1""."
""
"Для ведения списка и настройки прав пользователей предназначен список Пользователи,"
"режим конфигурирования 1С:Предприятия для этого использовать не следует.'"),
	...
	Комментарий =
		НСтр("ka='განხორციელდა გაშვება როლ ""სრული უფლებები""-ს მქონე მომხმარებლის სახელით, რომელიც მომხმარებლების სიაში არ არის რეგისტრირებული."
"მომხმარებლების სიაში შესრულებულია ავტომატური რეგისტრაცია."
""
"სიის საწარმოებლად და მომხმარებლების უფლებების გასამართად განკუთვნილია სია ""მომხმარებლები"", ამისთვის 1С:საწარმოს კონფიგურირების რეჟიმის გამოყენება არ არის საჭირო.';ru='Выполнен запуск от имени пользователя с ролью ""Полные права"","
...
"режим конфигурирования 1С:Предприятия для этого использовать не следует.'");
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ka='მომხმარებლები. ადმინისტრატორი რეგისტრირებულია ცნობარ ადმინისტრატორებში.';ru='Пользователи.Администратор зарегистрирован в справочнике Пользователи';en='Polzovateli.Administrator registered in the directory Users'",
...
""
"Обратитесь к администратору.';ka='პროგრამაში შესასვლელად არასაკმარისი უფლებებია."
""
"მიმართეთ ადმინისტრატორს.'"),
		, РегистрироватьВЖурнале);
...
"Неверное значение параметра Действие: ""%1"".';ka='შეცდომა პროცედურაში მომხმარებლებისამსახურებრივი.როლებისინტერფეისისდამუშავება()"
"პარამეტრ მოქმედება-ს არასწორი მნიშვნელობა: ""%1"".'"),
			Действие);
	КонецЕсли;
...
"Обратитесь к администратору.';ka='დაყენებულია მომხმარებლის პაროლის ""%1"" შეცვლის აკრძალვა."
"მიმართეთ ადმინისტრატორს.'"), Пользователь));
			Возврат Ложь;
		КонецЕсли;
	КонецЕсли;
	...
	ДополнительныеПараметры.Вставить("ТекстОшибки", СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ka='პაროლის შეცვლა შესაძლებელი იქნება მხოლოდ %1-ის შემდეგ.';ru='Пароль можно будет сменить только через %1.';en='The password can be changed only by 1%.'"), ЧислоИПредмет));
...
Функция ОбработатьНовыйПароль(Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(ТекстОшибки) Тогда
		...
		Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='%1"
""
"შეზღუდვა დაყენებულია კონფიგურატორში მენიუ ""ადმინისტრირება""-ში პუნქტი ""საინფორმაციო ბაზის პარამეტრები...""."
"საჭიროა პაროლის მინიმალური სიგრძის და სირთულის მოთხოვნის გასუფთავება კონფიგურატორში და პროგრამის გამართვებში მომხმარებლების შესვლის გამართვების მიცემა.';ru='%1"
""
...
"задать настройки входа пользователей в настройках программы.'"),
	...
	Попытка
		...
		Если ПользователиСлужебныйПовтИсп.Настройки().ОбщиеНастройкиВхода
		   ...
		   И ИспользованныеПароли.Найти(СохраняемоеЗначениеПароля) <> Неопределено Тогда
			...
			ТекстОшибки = НСтр("ka='ახალი პაროლი უწინ გამოიყენებოდა.';ru='Новый пароль использовался ранее.';en='A new password has been used previously.'");
	...
	Исключение
		...
		Если ВызовИзФормыСменаПароля Тогда
			ЗаписьЖурналаРегистрации(
				НСтр("ka='მომხმარებლები. პაროლის შეცვლის შეცდომა';ru='Пользователи.Ошибка смены пароля';en='Polzovateli.Oshibka password change'",
				     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
"%2';ka='მომხმარებელ ""%1""-ის პაროლის შეცვლა ვერ მოხერხდა შემდეგი მიზეზით: %2'"),
		...
		Попытка
			...
			Если Не ЗначениеЗаполнено(ИмяПользователя())
			   И ПользователиИнформационнойБазы.ПолучитьПользователей().Количество() = 0 Тогда
				...
				ВременныйАдминистраторИБ.Имя = НСтр("ru='Временный первый администратор';en='Since the first administrator'")
			...
			ВременныйПользовательИБ.Имя = НСтр("ru='Временный пользователь';en='a temporary user'")
				+ " (" + Строка(Новый УникальныйИдентификатор) + ")";
...
"В параметре ОписаниеПользователяИБ не указано свойство Действие.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას."
"პარამეტრ საინფორმაციობაზისმომხმარებლისაღწერილობა-ში არ არის მითითებული თვისება მოქმედება.'"),
...
"неверное значение ""%2"" свойства Действие.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას."
"პარამეტრ საინფორმაციობაზისმომხმარებლისაღწერილობა-ში მითითებულია თვისება მოქმედება-ს არასწორი მნიშვნელობა ""%2"".'"),
			ПользовательОбъект.Ссылка,
...
"с которым уже сопоставлен другой пользователем ИБ.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. სბ-ის მომხმარებლის შეპირისპირება ცნობარში არსებულ მომხმარებელთან, რომელთანაც უკვე შეპირისპირებულია სბ-ის სხვა მომხმარებელი, არ შეიძლება.'"),
...
"""%2"".';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. სბ-ის მომხმარებლის შეპირისპირება ცნობარში ამ მომხმარებელთან არ შეიძლება, ვინაიდან იგი უკვე შეპირისპირებულია სხვა მომხმარებელთან ცნობარ ""%2""-ში.'"),
		...
		Если ТипЗнч(ОписаниеПользователяИБ) = Тип("Структура") Тогда
			...
			Если ЗапретРедактированияРолей()
				...
				Если ВРег(Пользователи.РольАдминистратораСистемы().Имя) = ВРег("ПолныеПрава") Тогда
					Текст = НСтр("ka='პროგრამის მომხმარებელთა სიას ემატება პირველი მომხმარებელი, ამიტომ, მისთვის ავტომატურად დაინიშნება როლი ""სრული უფლებები"". გავაგრძელოთ?';ru='В список пользователей программы добавляется первый пользователь,"
"поэтому ему автоматически будет назначена роль ""Полные права""."
"Продолжить?'");
				Иначе
					Текст = НСтр("ka='პროგრამის მომხმარებლების სიას დაემატება პირველი მომხმარებელი, ამიტომ მას, ავტომატურად დაენიშნება როლი ""სისტემის ადმინისტრატორი"" და სრული უფლებები"" ში."
"გავაგრძელოთ?';ru='В список пользователей программы добавляется первый пользователь, поэтому ему"
...
"Сначала создайте администратора в справочнике Пользователи.';ka='საინფორმაციო ბაზის პირველ მომხმარებელს სრული უფლებები უნდა ჰქონდეს. გარე მომხმარებელი არ შეიძლება, რომ სრულუფლებიანი იყოს. თავდაპირველად, ცნობარ მომხმარებლებში შექმენით ადმინისტრატორი.'");
			Возврат Истина;
		КонецЕсли;
	КонецЕсли;
...
"""\\ИмяДомена\ИмяПользователя"".';ka='საოპერაციო სისტემის მომხმარებელი უნდა იყოს შემდეგ ფორმატში "
"""\\დომენისსახელი\მომხმარებლისსახელი"".'"),
					,
					"ПользовательОС",
					,
					Отказ);
...
"не найдена в метаданных.';ka='გარე მომხმარებელ"
"""%1""-ის როლების განახლებისას გარე მომხმარებელთა ჯგუფ ""%3""-ის როლი ""%2"" მეტამონაცემებში ვერ მოიძებნა.'"),
				СокрЛП(Выборка.ВнешнийПользователь.Наименование),
				Выборка.Роль,
				Строка(Выборка.ГруппаВнешнихПользователей));
			
			ЗаписьЖурналаРегистрации(
				НСтр("ka='მომხმარებლები. მეტამონაცემებში როლი ვერ მოიძებნა';ru='Пользователи.Роль не найдена в метаданных';en='Polzovateli.Rol not found in the metadata'",
				     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,
				,
				,
...
"т.к. у группы стоит признак ""Все пользователи заданного типа"".';ka='მომხმარებელი ""%1"" არ შეიძლება, რომ შეყვანილი იქნას ჯგუფ ""%2""-ში, ვინაიდან ჯგუფს დაყენებული აქვს ნიშან-თვისება ""მოცემული ტიპის ყველა მომხმარებელი"".'"),
					Предмет, НаименованиеГруппы) + Символы.ПС;
			Иначе
				СообщениеПользователю = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru='Пользователь ""%1"" не может быть включен в группу ""%2"","
"т.к. в состав ее участников входят только %3.';ka='მომხმარებელი ""%1"" არ შეიძლება, რომ შეყვანილი იქნას ჯგუფ ""%2""-ში, ვინაიდან მის მონაწილეთა შემადგენლობაში შედიან მხოლოდ %3.'"),
		...
		Иначе
			...
			СообщениеПользователю = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='ყველა მომხმარებელი არ შეიძლება, რომ შეყვანილი იქნას ჯგუფ ""%1""-ში, ვინაიდან მის შემადგენლობაში შედიან მხოლოდ %2, ან ჯგუფს დაყენებული აქვს ნიშან-თვისება ""მოცემული ტიპის ყველა მომხმარებელი"".';ru='Не все пользователи могут быть включены в группу ""%1"","
...
"или у группы стоит признак ""Все пользователи заданного типа"".'"),
	...
	Если КоличествоПользователей = 1 Тогда
		...
		СообщениеПользователю = НСтр("ka='""%1"" %2 ""%3""';ru='""%1"" %2 ""%3""'");
	...
	ИначеЕсли КоличествоПользователей > 1 Тогда
		...
		СтрокаОбъект = Формат(КоличествоПользователей, "ЧДЦ=0") + " "
			+ ПользователиСлужебныйКлиентСервер.ПредметЦелогоЧисла(КоличествоПользователей,
				"Л = ru_RU", НСтр("ka='მომხმარებელი,მომხმარებელს,მომხმარებლებს,,,,,,0';ru='пользователь,пользователя,пользователей,,,,,,0';en='user, user, users 0 ,,,,,,'"));
		...
		КонецЕсли;
		СообщениеПользователю = НСтр("ka='%1 %2 ""%3""';ru='%1 %2 ""%3""';en=""% 1% 2 '% 3'""");
	КонецЕсли;
...
Функция ЗначенияПараметровСеансаТекущийПользователь()
	...
	ЗаголовокОшибки = НСтр("ka='სეანს მიმდინარემომხმარებელი-ს პარამეტრის დაყენება ვერ მოხერხდა.';ru='Не удалось установить параметр сеанса ТекущийПользователь.';en='Failed to set the session TekuschiyPolzovatel.'") + Символы.ПС;
...
"в сеансе без указания всех разделителей.';ka='სეანსის პარამეტრის დაუშვებელი მიღება მიმდინარემომხმარებელი სეანსში არის ყველა გამყოფის მიუთითებლად.'");
...
""
"Обратитесь к администратору.';ka='მომხმარებელი ""%1"" ცნობარ ""მომხმარებლები""-ში და ""გარე მომხმარებლები""-ში  ვერ მოიძებნა."
""
"მიმართეთ ადმინისტრატორს.'");
	Иначе
		ШаблонСообщенияОбОшибке =
...
""
"Обратитесь к администратору.';ka='ცნობარ ""მომხმარებლები""-ში მომხმარებელი %1 ვერ მოიძებნა."
""
"მიმართეთ ადმინისტრატორს.'");
	КонецЕсли;
...
Функция КраткоеПредставлениеОшибкиАвторизацииПослеРегистрацииВЖурнале(ИнформацияОбОшибке, ШаблонОшибки = "", РегистрироватьВЖурнале = Истина)
	...
	Если РегистрироватьВЖурнале Тогда
		ЗаписьЖурналаРегистрации(
			НСтр("ka='მომხმარებლები.პროგრამაში შესვლის შეცდომა';ru='Пользователи.Ошибка входа в программу';en='Polzovateli.Oshibka entry into the program'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ПроверитьПраваПользователя(ПользовательИБ, РежимПроверки, ЭтоВнешнийПользователь)
	...
	ИмяСобытия = НСтр("ka='მომხმარებლები. შეცდომა საინფორმაციო ბაზის მომხმარებლებისთვის როლების დაყენებისას';ru='Пользователи.Ошибка при установке ролей пользователю ИБ';en='Polzovateli.Oshibka when setting user roles IB'",
	     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
"%2.';ka='მიუწვდომელი როლის მქონე მომხმარებელ %1-ის შესვლის მცდელობა:"
"%2.'"),
			ПользовательИБ.ПолноеИмя, ДобавляемыеНедоступныеРоли);
		Иначе
			ТекстРегистрацииВхода = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Попытка входа пользователя %1 с недоступными ролями:"
"%2.';ka='მიუწვდომელი როლების მქონე მომხმარებელ %1-ის შესვლის მცდელობა:"
"%2.'"),
			ПользовательИБ.ПолноеИмя, ДобавляемыеНедоступныеРоли);
		КонецЕсли;
...
"Обратитесь к администратору.';ka='შესვლის შესრულება შეუძლებელია მიუწვდომელი როლების არსებობის გამო. მიმართეთ ადმინისტრატორს.'");
...
"""%2"".';ka='მომხმარებელ %1-ისთვის მიუწვდომელი როლ ""%2""-ის წაშლის მცდელობა.'"),
...
"%2.';ka='მომხმარებელ %1-ისთვის მიუწვდომელი როლების წაშლის მცდელობა:"
"%2.'"),
			ПользовательИБ.ПолноеИмя, УдаляемыеНедоступныеРоли);
	Иначе
...
"%2.';ka='მომხმარებელ %1-ისთვის მიუწვდომელი როლის დანიშვნის მცდელობა:"
"%2.'"),
			ПользовательИБ.ПолноеИмя, ДобавляемыеНедоступныеРоли);
...
"%2.';ka='მომხმარებელ %1-ისთვის მიუწვდომელი როლების დანიშვნის მცდელობა: %2.'"),
			ПользовательИБ.ПолноеИмя, ДобавляемыеНедоступныеРоли);
	Иначе
...
"%2.';ka='მომხმარებელ ""%1""-ისთვის შეუძლებელია მიუწვდომელი როლ %2-ის დანიშვნა.'"),
			ПользовательИБ.ПолноеИмя, ДобавляемыеНедоступныеРоли);
		
	ИначеЕсли СтрЧислоСтрок(ДобавляемыеНедоступныеРоли) > 1 Тогда
		ТекстСообщенияДобавления = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Пользователю ""%1"" невозможно назначить недоступные роли:"
"%2.';ka='მომხმარებელ ""%1""-ისთვის შეუძლებელია მიუწვდომელი როლების დანიშვნა:"
"%2.'"),
			ПользовательИБ.ПолноеИмя, ДобавляемыеНедоступныеРоли);
	Иначе
...
Функция ТребуетсяСменитьПароль(ОписаниеОшибки = "", ПриЗапуске = Ложь, РегистрироватьВЖурнале = Истина)
	...
	Исключение
		...
		ОтменитьТранзакцию();
		ШаблонТекстаОшибки =
			НСтр("ka='მიმდინარე მომხმარებლის შესახებ ინფორმაციის ჩაწერა ვერ მოხერხდა შემდეგი მიზეზით:"
"%1"
""
"მიმართეთ ადმინისტრატორს.';ru='Не удалось записать сведения о текущем пользователе по причине:"
"%1"
""
"Обратитесь к администратору.'");
		Если ПриЗапуске Тогда
			...
			Если РегистрироватьВЖурнале Тогда
				ЗаписьЖурналаРегистрации(
					НСтр("ka='მომხმარებლები.პროგრამაში შესვლის შეცდომა';ru='Пользователи.Ошибка входа в программу';en='Polzovateli.Oshibka entry into the program'",
					     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
					УровеньЖурналаРегистрации.Ошибка,
		...
		Иначе
			Если РегистрироватьВЖурнале Тогда
				ЗаписьЖурналаРегистрации(
					НСтр("ka='მომხმარებლები. უკანასკნელი აქტიურობის თარიღის განახლების შეცდომა';ru='Пользователи.Ошибка обновления даты последней активности';en='Polzovateli.Oshibka renovation last activity date'",
					     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
					УровеньЖурналаРегистрации.Ошибка,
					Метаданные.НайтиПоТипу(ТипЗнч(ТекущийПользователь)),
					ТекущийПользователь,
...
Функция ОшибкаДлиныИлиСложностиПароля(Пароль, МинимальнаяДлинаПароля, СложныйПароль)
	...
	Если СтрДлина(Пароль) < МинимальнаяДлинаПароля Тогда
		Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='ახალი პაროლის სიმბოლოების რაოდენობა %1-ზე ნაკლები არ უნდა იყოს.';ru='Количество символов нового пароля должно быть не менее %1.';en='Number of new characters of the password must be at least 1%.'"),
...
"%1';ka='შემდეგი მიზეზით ვერ მოხერხდა იმის შემოწმება, პასუხობს თუ არა პაროლი სირთულის მოთხოვნებს:"
"%1'"),
			КраткоеПредставлениеОшибки(ИнформацияОбОшибке));
	КонецПопытки;
...
Процедура ПроверитьИзмененияРеквизитовПользователя(ПользовательОбъект, ПараметрыОбработки)
	...
	Если ТипЗнч(ПользовательОбъект) = Тип("СправочникОбъект.Пользователи")
	   И БлокируемыеРеквизиты.Служебный <> ПользовательОбъект.Служебный Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибка при записи пользователя ""%1""."
"Реквизит Служебный не допускается изменять в подписках на события.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. მოვლენებზე ხელმოწერებში რეკვიზიტ სამსახურებრივი-ს შეცვლა არ არის დაშვებული.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
	...
	Если БлокируемыеРеквизиты.Подготовлен <> ПользовательОбъект.Подготовлен Тогда
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибка при записи пользователя ""%1""."
"Реквизит Подготовлен не допускается изменять в подписках на события.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. რეკვიზიტ მომზადებულია-ს შეცვლა მოვლენების გამოწერებში დაუშვებელია.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
...
"Обновление реквизита выполняется автоматически.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. რეკვიზიტის საინფორმაციობაზისმომხმარებლისიდენტიფიკატორი შეცვლა დაუშვებელია. რეკვიზიტის განახლება ხორციელდება ავტომატურად.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
...
"Обновление реквизита выполняется автоматически.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. რეკვიზიტი სბმომხმარებლისთვისებები-ს შეცვლა დაუშვებელია. რეკვიზიტის განახლება ავტომატურად ხორციელდება.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
	...
	Если СтарыйПользователь.ПометкаУдаления = Ложь
	   ...
	   И Пользователи.ВходВПрограммуРазрешен(ПользовательОбъект.ИдентификаторПользователяИБ) Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибка при записи пользователя ""%1""."
"Нельзя помечать на удаление пользователя, которому разрешен вход в программу.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. პროგრამაში შესვლის ნებართვის მქონე მომხმარებლის წასაშლელად მონიშვნა არ შეიძლება.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
	...
	Если СтарыйПользователь.Недействителен = Ложь
	   ...
	   И Пользователи.ВходВПрограммуРазрешен(ПользовательОбъект.ИдентификаторПользователяИБ) Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибка при записи пользователя ""%1""."
"Нельзя пометить недействительным пользователя, которому разрешен вход в программу.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. პროგრამაში შესვლის ნებართვის მქონე მომხმარებლის უმოქმედოდ მონიშვნა არ შეიძლება.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
	...
	Если СтарыйПользователь.Подготовлен = Ложь
	   ...
	   И Пользователи.ВходВПрограммуРазрешен(ПользовательОбъект.ИдентификаторПользователяИБ) Тогда
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Ошибка при записи пользователя ""%1""."
"Нельзя пометить подготовленным пользователя, которому разрешен вход в программу.';ka='შეცდომა მომხმარებელ ""%1""-ის ჩაწერისას. მომხმარებლის, რომლისთვის ნებადართულია პროგრამაში შესვლა, მომზადებულად მონიშვნა არ შეიძლება.'"),
			ПользовательОбъект.Ссылка);
	КонецЕсли;
...
"%2';ka='მომხმარებელ ""%1""-ისთვის ნიშან-თვისება ""პროგრამაში შესვლა აკრძალულია""-ს მოხსნა ვერ მოხერხდა შემდეგი მიზეზით მოქმედების ვადის დასრულების გამო:"
"%2'");
			Иначе
				ШаблонКомментария =
					НСтр("ru='Не удалось снять пользователю ""%1"" признак"
...
"%2';ka='მომხმარებელ ""%1""-ისთვის ნიშან-თვისება ""პროგრამაში შესვლა ნებადართულია""-ს მოხსნა ვერ მოხერხდა პროგრამაში დადგენილ ვადაზე მეტად მუშაობის არარსებობის გამო შემდეგი მიზეზით:"
"%2'");
			КонецЕсли;
			ЗаписьЖурналаРегистрации(
				НСтр("ka='მომხმარებლები. პროგრამაში შესვლის ავტომატური აკრძალვის შეცდომა';ru='Пользователи.Ошибка автоматического запрещения входа в программу';en='Polzovateli.Oshibka automatic prohibition of entry into the program'",
				     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,
				Метаданные.НайтиПоТипу(ТипЗнч(Пользователь)),
				Пользователь,
