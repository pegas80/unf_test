...
Процедура ОповеститьПользователяОКопированииСтрок(КоличествоСкопированных) Экспорт
	...
	ТекстЗаголовка = НСтр("ka='სტრიქონები კოპირებულია';ru='Строки скопированы';en='rows copied'");
	ТекстСообщения = НСтр("ka='გაცვლის ბუფერში კოპირებულია სტრიქონები (%КоличествоСкопированных%)';ru='В буфер обмена скопированы строки (%КоличествоСкопированных%)';en='The clipboard copied row (% KolichestvoSkopirovannyh%)'");
...
Процедура ОповеститьПользователяОВставкеСтрок(КоличествоСкопированных, КоличествоВставленных) Экспорт
	...
	ТекстЗаголовка = НСтр("ka='ჩადგმული სტრიქონები';ru='Строки вставлены';en='line inserted'");
