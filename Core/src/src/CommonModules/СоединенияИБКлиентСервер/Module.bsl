...
Функция ТекстДляАдминистратора() Экспорт
	...
	Возврат НСтр("ka='ადმინისტრატორისთვის:';ru='Для администратора:';en='Administrator:'");
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ka='მომხმარებლების მუშაობის დასრულება';ru='Завершение работы пользователей';en='Shut users'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
