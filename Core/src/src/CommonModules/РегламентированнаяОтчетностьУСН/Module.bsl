...
Функция ПолучитьТекстНазначенияПлатежаНалогаПоСтраховымВзносам(ДатаДокумента, ВидВзаиморасчетов) Экспорт
	...
	Если ВидВзаиморасчетов = Справочники.ВидыНалогов.ПФРНакопительная Тогда
		Если ДатаДокумента > '20130101' Тогда
			Возврат Нстр("ka='ფიქსირებული ოდენობის სადაზღვევო შენატანები შრომითი პენსიის დაგროვებითი ნაწილის გადასახდელად.';ru='Страховые взносы в фиксированном размере на выплату накопительной части трудовой пенсии.';en='Insurance premiums in a fixed amount for the payment of the funded part of labor pension.'");
		Иначе
			Возврат Нстр("ka='სადაზღვევო შენატანები სადაზღვევო წელიწადის ღირებულებიდან გამომდინარე, შრომითი პენსიის დაგროვებითი ნაწილის გადასახდელად.';ru='Страховые взносы исходя из стоимости страхового года на выплату накопительной части трудовой пенсии.';en='Insurance premiums are based on the cost of the insurance year for the payment of the funded part of labor pension.'");
		КонецЕсли;
	ИначеЕсли ВидВзаиморасчетов = Справочники.ВидыНалогов.ПФРСтраховая
		...
		Если ДатаДокумента > '20130101' Тогда
			Возврат Нстр("ka='ფიქსირებული ოდენობის სადაზღვევო შენატანები შრომითი პენსიის სადაზღვევო ნაწილის გადასახდელად.';ru='Страховые взносы в фиксированном размере на выплату страховой части трудовой пенсии.';en='Insurance premiums in a fixed amount for the payment of insurance part of labor pensions.'");
		Иначе
			Возврат Нстр("ka='სადაზღვევო წელიწადის ღირებულებიდან გამომდინარე სადაზღვევო შენატანები შრომითი პენსიის სადაზღვევო ნაწილის გადასახდელად.';ru='Страховые взносы исходя из стоимости страхового года на выплату страховой части трудовой пенсии.';en='Insurance premiums are based on the cost of the insurance year for the payment of insurance part of labor pensions.'");
		КонецЕсли;
	ИначеЕсли ВидВзаиморасчетов = Справочники.ВидыНалогов.ТФОМС Тогда
		Возврат Нстр("ka='სადაზღვევო შენატანები სავალდებულო სამედიცინო დაზღვევაზე, რომელთა ჩარიცხვა ხდება სავალდებულო სამედიცინო დაზღვევის ადგილობრივი ფონდის ბიუჯეტში.';ru='Страховые взносы на ОМС, зачисляемые в бюджет ТФОМС.';en='Insurance premiums for compulsory health insurance to be transferred to the budget TFOMS.'");
	ИначеЕсли ВидВзаиморасчетов = Справочники.ВидыНалогов.ФФОМС Тогда
		Возврат Нстр("ka='სადაზღვევო შენატანები სავალდებულო სამედიცინო დაზღვევაზე, რომელთა ჩარიცხვა ხდება სავალდებულო სამედიცინო დაზღვევის ცენტრალური ფონდის ბიუჯეტში.';ru='Страховые взносы на ОМС, зачисляемые в бюджет ФФОМС.';en='Insurance premiums for compulsory health insurance to be transferred to the budget FFOMS.'");
	КонецЕсли;
	...
	Если ДокументФормирования <> Неопределено Тогда
		...
		Пока ВыборкаЗаписейУСН.Следующий() Цикл
			...
			Если ТипЗнч(ВыборкаЗаписейУСН.ПервичныйДокумент) = Тип("ДокументСсылка.ОтчетОРозничныхПродажах") Тогда
				НоваяСтрокаУСН.Содержание = НСтр("ka='საცალო გაყიდვის ამონაგების მიღება';ru='Поступление розничной выручки';en='Receipt of retail sales'");
			Иначе
				Если ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеВКассу.ОтПокупателя Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='ნაღდი ფულადი სახსრების შემოსვლა მყიდველ ""%1""-სგან';ru='Поступление наличных денежных средств от покупателя ""%1""';en='Receipt of cash from the buyer ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеВКассу.Прочее 
					...
					НоваяСтрокаУСН.Содержание = НСтр("ka='ნაღდი ფულადი სახსრების შემოსვლა სხვა ოპერაციებით';ru='Поступление наличных денежных средств по прочим операциям';en='Receipt of cash on other transactions'");
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.ОтПокупателя Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='უნაღდო ფულადი სახსრების შემოსვლა მყიდველ ""%1""-სგან';ru='Поступление безналичных денежных средств от покупателя ""%1""';en='Receipt of non-cash funds from the buyer ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.Прочее
					...
					НоваяСтрокаУСН.Содержание = НСтр("ka='უნაღდო ფულადი სახსრების შემოსვლა სხვა ოპერაციების მიხედვით';ru='Поступление безналичных денежных средств по прочим операциям';en='Receipt of non-cash funds on other transactions'");
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.ПоступлениеОплатыПоКартам Тогда
					НоваяСтрокаУСН.Содержание = НСтр("ka='შენატანი საცალო გაყიდვებისგან, მიღებული უნაღდო გზით';ru='Поступление от розничных продаж, оплаченной безналичным способом';en='Proceeds from retail sales, paid non-cash'");
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийРасходИзКассы.Покупателю Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='მყიდველ ""%1""-ისთვის ნაღდი ფულადი სახსრების დაბრუნება';ru='Возврат наличных денежных средств покупателю ""%1""';en='Return cash buyer ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийРасходСоСчета.Покупателю Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='უნაღდო ფულადი სახსრების დაბრუნება მყიდველ ""%1""-ისთვის';ru='Возврат безналичных денежных средств покупателю ""%1""';en='Return of non-cash buyer ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийРасходСоСчета.ВозвратОплатыНаПлатежныеКарты Тогда
					НоваяСтрокаУСН.Содержание = НСтр("ka='Возврат розничному покупателю безналичных денежных средств';ru='Возврат розничному покупателю безналичных денежных средств';en='Return retail purchaser of non-cash'");
				КонецЕсли;
			...
			Если ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.ПоступлениеОплатыПоКартам И 
				...
				НоваяСтрокаУСНКомиисия.Содержание = НСтр("ka='ბანკის საკომისიო ეკვაირინგის ოპერაციებისთვის';ru='Комиссия банка за операции эквайринга';en='Bank fee for acquiring operation'");
			КонецЕсли;
			
		КонецЦикла;
		
		Результат.ДополнительнаяИнформация = НСтр("ru='Сформировано записей: ';ka='Сформировано записей: '") + Строка(ДокументФормирования.ЗаписиКУДиР.Количество());
...
Процедура ВыполнитьФормированиеПоРасходамНаОплатуТруда(Организация, ПериодФормирования, Результат, МенеджерВТ)
	...
	Запрос.УстановитьПараметр("ОкончаниеПериода", КонецДня(ПериодФормирования));
	Запрос.УстановитьПараметр("Организация", Организация);
	Запрос.УстановитьПараметр("СодержаниеСтроки", НСтр("ka='დანახარჯები შრომის ანაზღაურებაზე';ru='Расходы на оплату труда';en='Labor costs'"));
...
Процедура ВыполнитьФормированиеПоПрочимРасходам(Организация, ПериодФормирования, Результат, МенеджерВТ)
	...
	Для Каждого Строка Из РезультатЗапроса Цикл
		...
		Если Строка.ВидОперации = Перечисления.ВидыОперацийРасходИзКассы.Налоги Тогда
			Строка.Содержание = НСтр("ka='ნაღდი ფულადი სახსრების გასავალი გადასახადების გადახდაზე';ru='Расход наличных денежных средств на уплату налогов';en='Flow of cash to pay taxes'");
		ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийРасходИзКассы.Прочее 
			...
			Строка.Содержание =  НСтр("ka='ნაღდი ფულადი სახსრების გასავალი სხვა ოპერაციების მიხედვით';ru='Расход наличных денежных средств по прочим операциям';en='Consumption of cash on other transactions'");
		ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийРасходСоСчета.Налоги Тогда
			Строка.Содержание = НСтр("ka='უნაღდო ფულადი სახსრების გასავალი გადასახადების გადახდაზე';ru='Расход безналичных денежных средств на уплату налогов';en='Consumption of non-cash funds to the payment of taxes'");
		ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийРасходСоСчета.Прочее
			...
			Строка.Содержание = НСтр("ka='სხვა ოპერაციების გამო უნაღდო ფულადი სახსრების გასავალი';ru='Расход безналичных денежных средств по прочим операциям';en='Consumption of non-cash funds on other transactions'");
		ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.Налоги Тогда
			Строка.Содержание = НСтр("ka='Возврат излишне уплаченных налогов';ru='Возврат излишне уплаченных налогов';en='Overpaid taxes'");
		КонецЕсли;
	КонецЦикла;
...
Процедура ВыполнитьФормированиеПоРасходамНаОСиНМА(Организация, ПериодФормирования, Результат, МенеджерВТ)
	...
	Запрос.УстановитьПараметр("ТекстПризнанияРасходовПоОС", НСтр("ru='Признаны расходы по ОС: ';ka='Признаны расходы по ОС: '"));
...
Функция ВыполнитьРасчетЕдиногоНалога(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено, ФиксироватьСтатусСобытия=Истина) Экспорт
	...
	Если ТаблицаПоНалогу.Количество() = 0 Тогда
		...
		СтруктураРасчетаЕдиногоНалога.ДополнительнаяИнформация.Описание = НСтр("ka='გადასახადის გამოსათვლელად მონაცემები არ არის';ru='Нет данных для расчета налога';en='There is no data for the calculation of tax'");
	...
	Если СуммаМинимальногоНалога > СуммаЕдиногоНалога Тогда
		...
		СтруктураРасчетаЕдиногоНалога.ДополнительнаяИнформация.Описание = НСтр("ka='გამოანგარიშებულია მინიმალური გადასახადი %1-იანი განაკვეთით';ru='Рассчитан минимальный налог по ставке 1%';en='Calculate the minimum tax rate of 1%'");
		
	Иначе
		
		СтруктураРасчетаЕдиногоНалога.СуммаЕН = СуммаЕдиногоНалога;
		СтруктураРасчетаЕдиногоНалога.ДополнительнаяИнформация.Описание = НСтр("ka='გამოთვლილია გადასახადი წლის მანძილზე';ru='Рассчитан налог за год';en='Calculated tax for the year'");
...
Функция ВыполнитьРасчетАвансовогоПлатежа(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если ТаблицаПоНалогу.Количество() = 0 Тогда
		...
		СтруктураРасчетаАвансовогоПлатежа.ДополнительнаяИнформация.Описание = НСтр("ka='გადასახადის გამოსათვლელად მონაცემები არ არის';ru='Нет данных для расчета налога';en='There is no data for the calculation of tax'");
	...
	СтруктураРасчетаАвансовогоПлатежа.ДополнительнаяИнформация.Описание = НСтр("ka='გამოთვლილია საავანსო გადახდა';ru='Рассчитан авансовый платеж';en='Calculated advance payment'");
...
Функция СформироватьДекларациюПоУСН(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='დგს-ის მიხედვით დეკლარაციის შედგენა კალენდრის შესაბამისი მოვლენის გარეშე';ru='Формирование декларации по УСН невозможно без соответствующего события календаря';en='Formation of the Declaration on the USN is not possible without the appropriate calendar events'");
	КонецЕсли;
...
Функция СформироватьРасчетПоСтраховымВзносам(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='Формирование расчета по страховым взносам невозможно без соответствующего события календаря';ru='Формирование расчета по страховым взносам невозможно без соответствующего события календаря';en='Formation of the calculation of insurance premiums is not possible without the appropriate calendar events'");
	КонецЕсли;
...
Функция СформироватьСведенияОСреднесписочнойЧисленности(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='საშუალო-სიითი რაოდენობის ჩამოყალიბება კალენდრის შესაბამისი მოვლენის გარეშე, შეუძლებელია';ru='Формирование сведений о среднесписочной численности невозможно без соответствующего события календаря';en='Formation of information on the average number is not possible without the appropriate calendar events'");
	КонецЕсли;
...
Функция СформироватьФорму1Предприниматель(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='Формирование формы №1-предприниматель невозможно без соответствующего события календаря';ru='Формирование формы №1-предприниматель невозможно без соответствующего события календаря';en='Formation form №1-entrepreneur is not possible without the appropriate calendar events'");
	КонецЕсли;
...
Функция СформироватьФорму6НДФЛ(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='Формирование формы 6-НДФЛ невозможно без соответствующего события календаря';ru='Формирование формы 6-НДФЛ невозможно без соответствующего события календаря';en='Formation of 6-PIT form is impossible without the appropriate calendar events'");
	КонецЕсли;
...
Функция СформироватьДекларацию12(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='Формирование декларация об объеме розничной продажи пива и пивных напитков (Приложение №12) невозможно без соответствующего события календаря';ru='Формирование декларация об объеме розничной продажи пива и пивных напитков (Приложение №12) невозможно без соответствующего события календаря';en='Formation of the volume declaration of retail sale of beer and beer drinks (Appendix №12) is impossible without the appropriate calendar events'");
	КонецЕсли;
...
Функция СформироватьСЗВМ(Организация, ПериодРасчета, СобытиеКалендаря = Неопределено) Экспорт
	...
	Если СобытиеКалендаря = Неопределено Тогда
		ВызватьИсключение НСтр("ka='Формирование сведений о застрахованных лицах (СЗВ-М) невозможно без соответствующего события календаря';ru='Формирование сведений о застрахованных лицах (СЗВ-М) невозможно без соответствующего события календаря';en='Formation of information about insured persons (SCB-M) is not possible without the appropriate calendar events'");
	КонецЕсли;
	...
	Для Каждого Строка Из ТаблицаПоТорговомуСбору Цикл
		...
		Если Найденные.Количество() > 1 Тогда
			ЗаписьЖурналаРегистрации(
				НСтр("ka='ЕНВД. შიდა ლოგიკა';ru='ЕНВД.Внутренняя логика';en='ENVD.Vnutrennyaya logic'"),
				УровеньЖурналаРегистрации.Ошибка,
				,
				,
				НСтр("ka='მშეგ-ის მიხედვით ურთიერთანგარიშსწორების დოკუმენტების ძებნის ალგორითმის მუშაობის ლოგიკის დარღვევა';ru='Нарушение логики работы алгоритма поиска документов взаиморасчетов по ЕНВД';en='Violation of the logic algorithm of search of documents on mutual UTII'"));
		КонецЕсли;
...
Функция ПолучитьДокументРегламентированнойОтчетностиПоСобытиюКалендаря(Организация,СобытиеКалендаря) Экспорт
	...
	Если ИмяОтчета = Неопределено Тогда
		ВызватьИсключение НСтр("ka='კალენდრის ამოცანის რეგლამენტირებულ ანგარიშგებასთან შესაბამისობა არ მოიძებნა';ru='Не найдено соответствие задачи календаря регламентированному отчету';en='compliance with the calendar task has not regulated reports'");
	КонецЕсли;
...
Процедура ВыполнитьФормированиеПоРасходамНаТовары(Организация, ПериодФормирования, Результат, МенеджерВТ)
	...
	Запрос.УстановитьПараметр("ПризнаныРасходыНаТовары", НСтр("ka='Признаны расходы на приобретение товаров';ru='Признаны расходы на приобретение товаров';en='Recognized as the cost of purchasing goods'"));
	Запрос.УстановитьПараметр("РасходыУменьшенныеОтВозврата", НСтр("ka='Расходы уменьшены на сумма возвращенных покупателем товаров';ru='Расходы уменьшены на сумма возвращенных покупателем товаров';en='Costs are reduced by the amount of the returned goods by the buyer'"));
	
	Запрос.УстановитьПараметр("ПризнаныРасходыНаТоварыНДС", НСтр("ka='Признаны расходы на приобретение товаров (НДС)';ru='Признаны расходы на приобретение товаров (НДС)';en='Recognized as expenses for the purchase of goods (VAT)'"));
	Запрос.УстановитьПараметр("РасходыУменьшенныеОтВозвратаНДС", НСтр("ka='Расходы уменьшены на сумму возвращенных покупателем товаров (НДС)';ru='Расходы уменьшены на сумму возвращенных покупателем товаров (НДС)';en='Costs are reduced by the amount of the returned goods by the buyer (VAT)'"));
	...
	Если ДокументФормирования <> Неопределено Тогда
		...
		Пока ВыборкаЗаписейУСН.Следующий() Цикл
			...
			Если ТипЗнч(ВыборкаЗаписейУСН.ПервичныйДокумент) = Тип("ДокументСсылка.АвансовыйОтчет") Тогда
				НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='ხარჯი საქონლის გადასახდელად, საქვეანგარიშო ფულადი სახსრების მომსახურებაზე';ru='Расходы на оплату товаров, услуг из подотчетных денежных средств';en='Expenses for goods and services from the imprest cash'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
			Иначе
				Если ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийРасходИзКассы.Поставщику Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='ნაღდი ფულადი სახსრების გასავალი მომწოდებელ ""%1""-სთვის გადასახდელად';ru='Расход наличных денежных средств на оплату поставщику ""%1""';en='Flow of cash for payment provider ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийРасходСоСчета.Поставщику Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='უნაღდო ფულადი სახსრების გასავალი მომწოდებელ ""%1""-ისთვის გადასახდელად';ru='Расход безналичных денежных средств на оплату поставщику ""%1""';en='Consumption of non-cash payment to provider ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеВКассу.ОтПоставщика Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='მომწოდებელ ""%1""-ისგან ნაღდი ფულადი სახსრების დაბრუნება';ru='Возврат наличных денежных средств от поставщика ""%1""';en='Return of cash from the provider ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				ИначеЕсли ВыборкаЗаписейУСН.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.ОтПоставщика Тогда
					НоваяСтрокаУСН.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='მომწოდებელ ""%1""-ისგან უნაღდო ფულადი სახსრების დაბრუნება';ru='Возврат безналичных денежных средств от поставщика ""%1""';en='Return of non-cash assets of the provider ""%1""'"), СокрЛП(ВыборкаЗаписейУСН.Контрагент));
				КонецЕсли;
			КонецЕсли;
			...
			Если ВыборкаЗаписейУСН.СуммаНДС > 0 Тогда
				...
				НоваяСтрокаУСННДС.Содержание = НоваяСтрокаУСННДС.Содержание+ НСтр("ka='(დღგ)';ru=' (НДС)'");
			КонецЕсли;
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Исключение
				...
				ТекстСообщения = НСтр("ka='ვერ მოხერხდა მოქმედების დასრულება: %1';ru='Не удалось завершить действие: %1';en='Failed to complete the action:% 1'");
...
Функция ПолучитьДанныеСобытия(Событие, РеквизитыСобытия) Экспорт
	...
	Если ТипЗнч(Событие) <> Тип("СправочникСсылка.КалендарьПодготовкиОтчетности")
		...
		ВызватьИсключение (НСтр("ka='მეთოდ მონაცემთამიღებამოვლენები-ს არასწორი პარამეტრები';ru='Неверные параметры метода ПолучитьДанныеСобытия';en='Incorrect method parameters PoluchitDannyeSobytiya'"));
	КонецЕсли;
...
Функция ПолучитьДанныеДокументаОтчетности(ДокументОтчетности, РеквизитыДокумента) Экспорт
	...
	Если ТипЗнч(ДокументОтчетности) <> Тип("ДокументСсылка.РегламентированныйОтчет") Тогда
		ВызватьИсключение (НСтр("ka='მეთოდ ანგარიშგებულობისდოკუმენტისმონაცემებისმიღება-ს არასწორი პარამეტრები';ru='Неверные параметры метода ПолучитьДанныеДокументаОтчетности';en='Incorrect method parameters PoluchitDannyeDokumentaOtchetnosti'"));
	КонецЕсли;
...
Процедура ПроверитьРегистрациюВИФНС(Организация, Отказ, РегистрацияВНалоговомОргане = Неопределено) Экспорт
	...
	Иначе
		...
		Если Результат.Пустой() Тогда
			...
			РегистрацияВНалоговомОргане.Наименование = НСтр("ka='ავტოჩანაწერი';ru='Автозапись';en='autorecord'");
...
Процедура ВыполнитьФормированияЗаписейПатента(Патент) Экспорт
	...
	Для Каждого Строка Из РезультатЗапроса Цикл
		...
		Если ТипЗнч(Строка.ПервичныйДокумент) = Тип("ДокументСсылка.ОтчетОРозничныхПродажах") Тогда
			Строка.Содержание = НСтр("ka='საცალო გაყიდვის ამონაგების მიღება';ru='Поступление розничной выручки';en='Receipt of retail sales'");
		Иначе
			Если Строка.ВидОперации = Перечисления.ВидыОперацийПоступлениеВКассу.ОтПокупателя Тогда
				Строка.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='ნაღდი ფულადი სახსრების შემოსვლა მყიდველ ""%1""-სგან';ru='Поступление наличных денежных средств от покупателя ""%1""';en='Receipt of cash from the buyer ""%1""'"), СокрЛП(Строка.Контрагент));
			ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийПоступлениеВКассу.Прочее 
				...
				Строка.Содержание = НСтр("ka='ნაღდი ფულადი სახსრების შემოსვლა სხვა ოპერაციებით';ru='Поступление наличных денежных средств по прочим операциям';en='Receipt of cash on other transactions'");
			ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.ОтПокупателя Тогда
				Строка.Содержание = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='უნაღდო ფულადი სახსრების შემოსვლა მყიდველ ""%1""-სგან';ru='Поступление безналичных денежных средств от покупателя ""%1""';en='Receipt of non-cash funds from the buyer ""%1""'"), СокрЛП(Строка.Контрагент));
			ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.Прочее
				...
				Строка.Содержание = НСтр("ka='უნაღდო ფულადი სახსრების შემოსვლა სხვა ოპერაციების მიხედვით';ru='Поступление безналичных денежных средств по прочим операциям';en='Receipt of non-cash funds on other transactions'");
			ИначеЕсли Строка.ВидОперации = Перечисления.ВидыОперацийПоступлениеНаСчет.ПоступлениеОплатыПоКартам Тогда
				Строка.Содержание = НСтр("ka='შენატანი საცალო გაყიდვებისგან, მიღებული უნაღდო გზით';ru='Поступление от розничных продаж, оплаченной безналичным способом';en='Proceeds from retail sales, paid non-cash'");
			КонецЕсли;
...
Процедура ОтразитьИзменениеСтатусаРегламентированнойОтчетности(Источник, Отказ, Замещение) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.Статус = НСтр("ka='არ არის ჩაბარებული';ru='Не сдано';en='Do not put'")
			ИЛИ  Выборка.Статус = НСтр("ka='ჩაბარებულია ნაწილობრივ';ru='Сдан частично';en='Delivered in part'")
			ИЛИ  Выборка.Статус = НСтр("ka='Не принято в обработку';ru='Не принято в обработку';en='Not accepted for processing'") Тогда
			ЗаголовокСообщения = НСтр("ka='Отчет в %2 не принят!';ru='Отчет в %2 не принят!';en='Report to% 2 is not accepted!'");
			ТекстСообщения     = НСтр("ka='Исправьте ошибки и отправьте отчет «%1» еще раз';ru='Исправьте ошибки и отправьте отчет «%1» еще раз';en='Correct the errors and submit a report ""%1"" again'");
		ИначеЕсли Выборка.Статус = НСтр("ka='ჩაბარებულია';ru='Сдано';en='Rented'") Тогда
			ЗаголовокСообщения = НСтр("ka='Сдан отчет в %2!';ru='Сдан отчет в %2!';en='Handed over the report to% 2!'");
			ТекстСообщения     = НСтр("ka='Отчет «%1» принят в %2';ru='Отчет «%1» принят в %2';en='Report ""%1""% 2 adopted'");
		ИначеЕсли Выборка.Статус = НСтр("ka='Сдано, требует уточнения';ru='Сдано, требует уточнения';en='Rented requires clarification'") Тогда
			ЗаголовокСообщения = НСтр("ka='Отчет в %2 сдан, но требует уточнения';ru='Отчет в %2 сдан, но требует уточнения';en='Report in 2% delivered, but requires clarification'");
			ТекстСообщения     = НСтр("ka='Подготовьте и отправьте корректирующий отчет «%1»';ru='Подготовьте и отправьте корректирующий отчет «%1»';en='Prepare and submit a correction report ""%1""'");
		КонецЕсли;
