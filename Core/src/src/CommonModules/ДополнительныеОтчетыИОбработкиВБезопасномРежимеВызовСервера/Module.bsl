...
"из сценария или из контекста клиентского приложения!';ka='საერთო მოდულ დამატებითიანგარიშგებებიდადამუშავებებიუსაფრთხორეჟიმშისერვერისმოხმობა-ს ფუნქციის არაკორექტული მოხმობა!"
"მოცემული მოდულის ექსპორტირებადი ფუნქციების უსაფრთხო რეჟიმში გამოსაყენებლად, ისინი მოხმობილი უნდა იქნას მხოლოდ სცენარიდან ან კლიენტური დანართის კონტექსტიდან!'");
