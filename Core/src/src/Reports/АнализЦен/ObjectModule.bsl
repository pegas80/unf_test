...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["АнализЦен"].Теги = НСтр("ka='Запасы,Продажи,Закупки,Товары,Номенклатура,Себестоимость';ru='Запасы,Продажи,Закупки,Товары,Номенклатура,Себестоимость';en='Inventories, Sales, Purchases, Products, Inventory, Cost of'");
