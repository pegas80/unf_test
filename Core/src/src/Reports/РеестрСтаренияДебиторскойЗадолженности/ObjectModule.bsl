...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Деньги,Долги,Дебиторка,Контрагенты,Покупатели,Продажи,CRM,Работы';ru='Деньги,Долги,Дебиторка,Контрагенты,Покупатели,Продажи,CRM,Работы';en='Money, Debt, Receivables, Accounts, Customers, Sales, CRM, Work'");
	КонецЦикла;
