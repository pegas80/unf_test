...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ОСВ"].Теги = НСТР("ka='Компания,ОСВ';ru='Компания,ОСВ';en='The company, SALT'");
...
Процедура ДобавитьПолеВалютнаяСумма(НастройкиСКД, Форма)
	...
	Стр.Заголовок = НСтр("ka='სავალუტო თანხის ჩვენება';ru='Показывать валютную сумму';en='Show currency amount'");
