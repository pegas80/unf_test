...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	//Иначе	
		...
		Если ЗначениеЗаполнено(ПараметрыОтчета.ВидСубконто) Тогда
			...
			Запрос.УстановитьПараметр("ВидСубконто", ПараметрыОтчета.ВидСубконто);
			
			РезультатЗапроса = Запрос.Выполнить();
			
			БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек,	"Счет", РезультатЗапроса.Выгрузить().ВыгрузитьКолонку("Счет"));
	...
	Если ЗначениеЗаполнено(ПараметрыОтчета.ВидСубконто) Тогда
		БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ВидСубконто", ПараметрыОтчета.ВидСубконто);
	КонецЕсли;
	
	//Если ЗначениеЗаполнено(ПараметрыОтчета.ЗначениеСубконто) Тогда
	//	БухгалтерскиеОтчетыКлиентСервер.ДобавитьОтбор(КомпоновщикНастроек.Настройки, "Субконто1", ПараметрыОтчета.ЗначениеСубконто, ВидСравненияКомпоновкиДанных.Равно, ИСТИНА);
	//КонецЕсли;
...
Процедура ЗаполнитьПравилаРасшифровки(Правила) Экспорт
	...
	БухгалтерскиеОтчетыРасшифровка.ДобавитьТребуемыйРеквизитРасшифровки(Правило.ТребуемыеРеквизиты, "ВидСубконто", "ВидСубконто");
	БухгалтерскиеОтчетыРасшифровка.ДобавитьТребуемыйРеквизитРасшифровки(Правило.ТребуемыеРеквизиты, "Субконто1", "Субконто1");
	Правило.ШаблонПредставления = НСтр("ru='Карточка субконто: Счет = [Счет], Вид субконто = [ВидСубконто], Субконто = [Субконто1]'");
