...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';ru='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';en='Stocks Nomenclature, products, repair, Serial Numbers'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';ru='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';en='Stocks Nomenclature, products, repair, Serial Numbers'");
