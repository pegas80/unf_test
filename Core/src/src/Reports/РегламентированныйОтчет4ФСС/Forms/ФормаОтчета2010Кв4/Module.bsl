...
Процедура УдалитьСтраницу(Команда)
	...
	ПоказатьВопрос(ОписаниеОповещения , НСтр("ka='Удалить текущую страницу?';ru='Удалить текущую страницу?';en='Delete current page?'"), РежимДиалогаВопрос.ДаНет, 60, КодВозвратаДиалога.Да);
