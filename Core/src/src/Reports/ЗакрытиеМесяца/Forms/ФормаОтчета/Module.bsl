...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		ВызватьИсключение НСтр("ka='Открытие отчета предусмотрено только из документа ""Закрытие месяца"".';ru='Открытие отчета предусмотрено только из документа ""Закрытие месяца"".';en='Opening a report is provided only from the document, ""Closing the Month"".'");
