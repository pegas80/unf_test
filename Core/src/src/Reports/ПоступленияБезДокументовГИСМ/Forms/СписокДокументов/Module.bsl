...
Процедура СформироватьЗаголовкиФормы(Параметры)
	...
	Если Параметры.ИмяНабораДанных = "КиЗ" Тогда
		Заголовок = НСтр("ka='Несопоставленные документы поступления и ""Заявки на выпуски КиЗ""';ru='Несопоставленные документы поступления и ""Заявки на выпуски КиЗ""';en='Unmatched receipts and documents ""Applications for issues Keyes""'");
	...
	ИначеЕсли Параметры.ИмяНабораДанных = "МаркированныеТовары" Тогда
		Заголовок = НСтр("ka='Несопоставленные документы поступления и ""Уведомления о поступлении""';ru='Несопоставленные документы поступления и ""Уведомления о поступлении""';en='Unmatched receipts and documents ""Notification of admission""'");
...
Процедура СформириватьПредставлениеОтборы(Параметры)
	...
	ТекстПредставленияОтбора = НСтр("ka='Номер КиЗ: %1, Организация : %2, Контрагент: %3.';ru='Номер КиЗ: %1, Организация : %2, Контрагент: %3.';en='Keys number:% 1, Organization: 2%, Contractor:% 3.'");
