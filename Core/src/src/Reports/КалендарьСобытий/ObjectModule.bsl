...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["КалендарьСобытий"].Теги = НСтр("ka='CRM,События';ru='CRM,События';en='CRM, Events'");
	НастройкиВариантов["КалендарьСобытийПоОтветственным"].Теги = НСтр("ka='CRM,События';ru='CRM,События';en='CRM, Events'");
	НастройкиВариантов["КалендарьСобытийПоКонтактам"].Теги = НСтр("ka='CRM,События';ru='CRM,События';en='CRM, Events'");
	НастройкиВариантов["КалендарьСобытийПоТемам"].Теги = НСтр("ka='CRM,События';ru='CRM,События';en='CRM, Events'");
