	...
	Если ТипЗнч(НаборСсылок) = Тип("СписокЗначений") Тогда
		...
		Если ВсегоСсылок >= 0 Тогда
			...
			Если ОдинаковыйТип Тогда
				Результат = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Места использования %1';ru='Места использования %1';en='Designated use 1%'"), НаборСсылок[0].Значение.Метаданные().Представление());
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
	
	Если Результат = Неопределено Тогда
		Результат = НСтр("ka='Места использования элементов';ru='Места использования элементов';en='Designated use items'");
	КонецЕсли;
