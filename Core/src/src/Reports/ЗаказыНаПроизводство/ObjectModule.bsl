...
Процедура ПриКонтекстномОткрытии(СсылкаНаОбъект, ПолеСвязи, Отборы, Отказ) Экспорт
	...
	Если ПолеСвязи = "ЗаказНаПроизводство" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ЗаказНаПроизводство) Тогда
			Отказ = Истина;
			Сообщить(НСтр("ka='Отчет можно сформировать только при сборке на основании заказа на производство';ru='Отчет можно сформировать только при сборке на основании заказа на производство';en='The report can be generated only in the assembly on the basis of an order for the production'"));
			Возврат;
		КонецЕсли; 
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Производство,Заказы,Продукция';ru='Производство,Заказы,Продукция';en='Production, Orders, Products'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ka='Производство,Заказы,Продукция';ru='Производство,Заказы,Продукция';en='Production, Orders, Products'");
