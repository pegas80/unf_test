...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//	"ФормаОтчета",
	//	НСтр("ru='Новости: Оборотно-сальдовая ведомость по счету';en='News: turnover balance sheet in a row'"),
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ka='ბრუნვითი უწყისი ანგარიშის მიხედვით %1%2';ru='Оборотно-сальдовая ведомость по счету %1%2';en='Trial balance of the account% 1% 2'"), Отчет.Счет,
