...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Компания,Деньги,План,Факт';ru='Компания,Деньги,План,Факт';en='Company, Money, Plan Fact'");
	НастройкиВариантов["ВВалюте"].Теги = НСТР("ka='Компания,Деньги,План,Факт,Валюты';ru='Компания,Деньги,План,Факт,Валюты';en='Company, Money, Plan, fact Currencies'");
	НастройкиВариантов["План-фактный анализ"].Теги = НСТР("ka='Компания,Деньги,План,Факт';ru='Компания,Деньги,План,Факт';en='Company, Money, Plan Fact'");
	НастройкиВариантов["План-фактный анализ (вал.)"].Теги = НСТР("ka='Компания,Деньги,План,Факт,Валюты';ru='Компания,Деньги,План,Факт,Валюты';en='Company, Money, Plan, fact Currencies'");
