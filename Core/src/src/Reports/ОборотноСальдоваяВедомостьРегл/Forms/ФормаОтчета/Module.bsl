...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//	"ФормаОтчета",
	//	НСтр("ru='Новости: Оборотно-сальдовая ведомость';en='News: trial balance'"),
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Оборотно-сальдовая ведомость%1'; ka = 'ბრუნვითი უწყისი%1'; en = 'Turnover balance sheet%1'"),
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	Если ЗаполняемыеНастройки.Свойство("УсловноеОформление") Тогда
		...
		Схема = Отчеты.ОборотноСальдоваяВедомостьРегл.ПолучитьМакет("СхемаКомпоновкиДанных");
	...
	Если ЗаполняемыеНастройки.Свойство("ДополнительныеПоля") Тогда
		...
		НоваяСтрока.Представление = НСтр("ka='ანგარიშის დასახელების გამოტანა';ru='Выводить наименование счета';en='Show the name of the account'");
