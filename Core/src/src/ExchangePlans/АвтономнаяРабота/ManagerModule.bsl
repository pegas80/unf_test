...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ka='ავტონომიური სამუშაო ადგილის გაცვლის გამართვები';ru='Настройки обмена автономного рабочего места';en='Settings sharing standalone workstation'");
...
Функция ОписаниеОграниченийПередачиДанных(НастройкаОтборовНаУзле, ВерсияКорреспондента, ИдентификаторНастройки) Экспорт
	...
	Если НастройкаОтборовНаУзле.ИспользоватьОтборПоОрганизациям Тогда
		...
		Возврат НСтр("ka='ავტონომიურ სამუშაო ადგილზე ხელმისაწვდომია მხოლოდ მონაცემთა ნაწილი.';ru='В автономном рабочем месте доступна только часть данных.';en='In stand-alone workplace is only available piece of data.'");
		
	Иначе
		
		Возврат НСтр("ka='ავტონომიურ სამუშაო ადგილზე ხელმისაწვდომია ყველა მონაცემი.';ru='В автономном рабочем месте доступны все данные.';en='In stand-alone workplace have access to all data.'");
