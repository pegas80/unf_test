...
"Набор свойств %2 не связан ни с одним владельцем значений свойств.';ka='შეცდომა თვისება %1-ის გამართვის შეცვლისას."
"თვისებების კრებული %2 თვისებების მნიშვნელობის არცერთ მფლობელთან არ არის დაკავშირებული.'"),
				Свойство,
		...
		ИначеЕсли Свойство = СвойствоОбъект.Ссылка Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Ошибка при изменении настройки свойства %1."
"Тип значения не содержит дополнительных значений.';ka='შეცდომა თვისება %1-ის გამართვის შეცვლისას. მნიშვნელობის ტიპი დამატებით მნიშვნელობებს არ შეიცავს.'"),
				Свойство);
		КонецЕсли;
