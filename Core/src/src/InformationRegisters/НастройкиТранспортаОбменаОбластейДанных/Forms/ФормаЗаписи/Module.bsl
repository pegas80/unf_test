...
Процедура ПроверитьПодключение(ВидТранспортаСтрокой)
	...
	ТекстПредупреждения = ?(Отказ, НСтр("ka='ვერ მოხერხდა ჩართვის დაყენება.';ru='Не удалось установить подключение.';en='Unable to establish connection.'"), НСтр("ka='მიერთება წარმატებით არის დაყენებული.';ru='Подключение успешно установлено.';en='The connection is successfully established.'"));
