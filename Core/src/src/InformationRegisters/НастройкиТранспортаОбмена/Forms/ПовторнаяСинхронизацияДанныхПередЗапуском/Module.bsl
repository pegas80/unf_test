...
"""%1""."
"Техническую информацию см. в <a href = ""ЖурналРегистрации"">Журнале регистрации</a>.';ka='""%1""-იდან მიღებული პროგრამის განახლების დაყენება ვერ მოხერხდა."
"ტექნიკური ინფორმაცია იხ. <a href = ""რეგისტრაციისჟურნალი"">რეგისტრაციის ჟურნალში</a>.'");
...
Процедура СинхронизироватьИПродолжить(Команда)
	...
	ИначеЕсли СтатусОбновления = "ОбновлениеКонфигурации" Тогда
		...
		ТекстПредупреждения = НСтр("ka='მთავარი კვანძიდან მიღებულია ცვლილებები, რომლებიც ჯერ არ არის გამოყენებული."
"საჭიროა კონფიგურატორის გახსნა და მონაცემთა ბაზის კონფიგურაციის განახლება.';ru='Из главного узла получены изменения, которые еще не применены."
...
Процедура СинхронизироватьИПродолжитьБезОбновленияИБЗавершение()
	...
	ИначеЕсли КонфигурацияИзменена() Тогда
		...
		КонецЕсли;
		ТекстПредупреждения = НСтр("ka='მთავარი კვანძიდან მიღებულია ცვლილებები, რომლებიც გამოსაყენებელია. საჭიროა კონფიგურატორის გახსნა და მონაცემთა ბაზის კონფიგურაციის განახლება.';ru='Из главного узла получены изменения, которые нужно применить."
"Требуется открыть конфигуратор и обновить конфигурацию базы данных.'");
	Иначе
...
"Подробности см. в журнале регистрации.';ka='Получение данных из главного узла завершилось с ошибками."
