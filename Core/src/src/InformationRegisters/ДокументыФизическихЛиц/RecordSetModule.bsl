...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ТекстСообщения = НСтр("ka='%1-ისთვის ფიზ.პირი %2-ისთვის უკვე შეყვანილია პირადობის დამადასტურებელი დოკუმენტი.';ru='На %1 у физлица %2 уже введен документ, удостоверяющий личность.';en='% 1% 2 from physical persons already entered identification document.'");
