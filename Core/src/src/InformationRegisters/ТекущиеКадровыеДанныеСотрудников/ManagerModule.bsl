...
Процедура ОбновитьТекущиеКадровыеДанныеСотрудников(СписокСотрудников = Неопределено,Документ = Неопределено) Экспорт
	...
	|	ПриемНаРаботу.ДатаОкончанияДоговора КАК ДатаОкончанияДоговора
	...
	|	Сотрудники.ДатаОкончанияДоговора КАК ДатаОкончанияДоговора
	...
	|	КадровыеПеремещенияСрез.ДатаОкончанияДоговора КАК ДатаОкончанияДоговора
	...
	|	ВЫБОР
	|		КОГДА &Документ = ""КадровоеПеремещение""
	|			ТОГДА ВТКадровыеПеремещения.ДатаОкончанияДоговора
	|		ИНАЧЕ ПринятыеСотрудники.ДатаОкончанияДоговора
