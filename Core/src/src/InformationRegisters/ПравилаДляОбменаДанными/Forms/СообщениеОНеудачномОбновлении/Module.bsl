...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПравилаИзФайла.ПравилаКонвертации И ПравилаИзФайла.ПравилаРегистрации Тогда
		ТипПравил = НСтр("ka='კონვერტაციები და რეგისტრაციები';ru='конвертации и регистрации';en='conversion and registration'");
	ИначеЕсли ПравилаИзФайла.ПравилаКонвертации Тогда
		ТипПравил = НСтр("ka='კონვერტაციები';ru='конвертации';en='conversion'");
	ИначеЕсли ПравилаИзФайла.ПравилаРегистрации Тогда
		ТипПравил = НСтр("ka='რეგისტრაციები';ru='регистрации';en='of registration'");
	КонецЕсли;
