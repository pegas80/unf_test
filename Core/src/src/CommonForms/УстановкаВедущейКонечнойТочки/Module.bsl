...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='წამყვანი საბოლოო წერტილის დაყენება ""%1""-სთვის';ru='Установка ведущей конечной точки для ""%1""';en='Installation of a leading end-point for the ""%1""'"),
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ТекстПредупреждения = НСтр("ka='გავაუქმოთ ოპერაციის შესრულება?';ru='Отменить выполнение операции?';en='Cancel the operation?'");
...
Процедура Установить(Команда)
	...
	Состояние(НСтр("ka='მიმდინარეობს წამყვანი საბოლოო წერტილის დაყენება. გთხოვთ, მოიცადოთ...';ru='Выполняется установка ведущей конечной точки. Пожалуйста, подождите...';en='Installs leading endpoint. Please wait...'"));
...
"Перейти в журнал регистрации?';ka='წამყვანი საბოლოო წერტილის დაყენებისას შეცდომები წარმოიშვა. გადავიდეთ რეგისტრაციის ჟურნალში?'");
	...
	ПоказатьОповещениеПользователя(,, НСтр("ka='წამყვანი ბოლო წერტილის დაყენება წარმატებით დასრულდა.';ru='Установка ведущей конечной точки успешно завершена.';en='Installing leading endpoint is successfully completed.'"));
