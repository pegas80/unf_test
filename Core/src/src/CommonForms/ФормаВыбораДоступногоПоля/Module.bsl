...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Режим = "Группировка" Тогда
		...
		Заголовок = НСтр("ru = 'Выбор поля группировки'; ka = 'დაჯგუფების ველის შერჩევა'; en = 'Selecting the grouping field'");
	...
	ИначеЕсли Режим = "Выбор" Тогда
		...
		Элементы.ГруппаДоступныеПоляОтбор.Видимость       = Ложь;
		Элементы.ГруппаДоступныеПоляПорядок.Видимость     = Ложь;
		Заголовок = НСтр("ru = 'Выбор поля'; ka = 'ველის შერჩევა'; en = 'field Chooser'");
	...
	ИначеЕсли Режим = "Отбор" Тогда
		...
		Элементы.ГруппаДоступныеПоляВыбор.Видимость       = Ложь;
		Элементы.ГруппаДоступныеПоляПорядок.Видимость     = Ложь;
		Заголовок = НСтр("ru = 'Выбор поля отбора'; ka = 'შერჩევის ველის არჩევა'; en = 'Choice selection field'");
	...
	ИначеЕсли Режим = "Порядок" Тогда
		...
		Элементы.ГруппаДоступныеПоляВыбор.Видимость       = Ложь;
		Элементы.ГруппаДоступныеПоляОтбор.Видимость       = Ложь;
		Заголовок = НСтр("ru = 'Выбор поля сортировки'; ka = 'დახარისხების ველის შერჩევა'; en = 'Selecting the sort fields'");
