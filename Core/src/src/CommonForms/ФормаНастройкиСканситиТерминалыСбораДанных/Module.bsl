...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокИсточникЗагрузки.Добавить("Документ", НСтр("ka='მონაცემთა შეკრების ტერმინალის დოკუმენტი';ru='Документ терминала сбора данных';en='Document Data Terminal'"));
	СписокИсточникЗагрузки.Добавить("База",     НСтр("ka='მონაცემთა შეკრების ტერმინალის ბაზა';ru='База терминала сбора данных';en='Database collection terminal'"));
