		...
		Для каждого СтрокаТЧ Из Товары Цикл
			...
			Если ЗначениеЗаполнено(СтрокаТЧ.КодТаможенногоОргана)
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.КодТаможенногоОргана) Тогда
					ТекстОшибки = НСтр("ka='В строке %НомерСтроки% списка ""Товары"" не указан ""Код таможенного органа"".';ru='В строке %НомерСтроки% списка ""Товары"" не указан ""Код таможенного органа"".';en='In line%% NomerStroki list of ""Goods"" Unknown ""customs authority code"".'");
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.ДатаРегистрацииДекларации) Тогда
					ТекстОшибки = НСтр("ka='В строке %НомерСтроки% списка ""Товары"" не указана ""Дата регистрации декларации"".';ru='В строке %НомерСтроки% списка ""Товары"" не указана ""Дата регистрации декларации"".';en='In line%% NomerStroki list of ""goods"" is not specified ""Registration Date Declaration"".'");
					ТекстОшибки =  СтрЗаменить(ТекстОшибки, "%НомерСтроки%", НомерСтроки);
				...
				Если Не ЗначениеЗаполнено(СтрокаТЧ.РегистрационныйНомерДекларации) Тогда
					ТекстОшибки = НСтр("ka='В строке %НомерСтроки% списка ""Товары"" не указан ""Регистрационный номер декларации"".';ru='В строке %НомерСтроки% списка ""Товары"" не указан ""Регистрационный номер декларации"".';en='In line%% NomerStroki list of ""Goods"" Unknown ""Declaration Registration Number.""'");
					ТекстОшибки =  СтрЗаменить(ТекстОшибки, "%НомерСтроки%", НомерСтроки);
