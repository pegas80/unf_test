...
Процедура ИнициализироватьДанныеДокументаРасчетыПоКредитамИЗаймам(ДокументСсылкаВводНачальныхОстатков, СтруктураДополнительныеСвойства) Экспорт
	...
	|	ВЫБОР
	|		КОГДА ВводНачальныхОстатковКредитыИЗайми.ДоговорКредитаЗайма.ВидДоговора = ЗНАЧЕНИЕ(Перечисление.ВидыДоговоровКредитаИЗайма.ДоговорЗаймаСотруднику)
	|			ТОГДА ЗНАЧЕНИЕ (Перечисление.ВидыДоговоровКредитаИЗайма.ДоговорЗаймаСотруднику)
	|		ИНАЧЕ ЗНАЧЕНИЕ (Перечисление.ВидыДоговоровКредитаИЗайма.КредитПолученный) 
	...
	|	И ТаблицаДокумента.Ссылка = &Ссылка
	|	И ТаблицаДокумента.ДоговорКредитаЗайма.ВидДоговора <> ЗНАЧЕНИЕ(Перечисление.ВидыДоговоровКредитаИЗайма.ДоговорЗаймаСотруднику)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	НЕОПРЕДЕЛЕНО,
	|	0,
	|	ТаблицаДокумента.ДоговорКредитаЗайма.Сотрудник,
	|	ТаблицаДокумента.ДоговорКредитаЗайма,
	|	NULL,
	|	ТаблицаДокумента.Валюта,
	|	NULL,
