...
"Использовать последнюю введенную корректировку?'");
	...
	Если ВыдатьСообщениеОЗачетеАвансовДляДоговоровВУЕ Тогда
		...
		Сообщение.Текст = НСтр("ka='Для корректировочных документов в валюте по договору в у.е. распределение авансов по курсу авансов не поддерживается. Корректируемый документ должен быть оформлен в рублях.';ru='Для корректировочных документов в валюте по договору в у.е. распределение авансов по курсу авансов не поддерживается. Корректируемый документ должен быть оформлен в рублях.'");
		Сообщение.Сообщить();
	КонецЕсли;
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если ИсточникВыбора.ИмяФормы = "Документ.СчетФактура.Форма.ФормаДокумента" Тогда
		...
		//Элементы.СчетФактураНадпись.Заголовок = РаботаСФормойДокументаКлиентСервер.СформироватьНадписьСчетФактура(ВыбранноеЗначение);//Паганини#OneSoft
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ОбновлениеТекстаПроСчетФактуру" 
		...
		//Элементы.СчетФактураНадпись.Заголовок = РаботаСФормойДокументаКлиентСервер.СформироватьНадписьСчетФактура(Параметр.Представление);//Паганини#OneSoft
...
Процедура СчетФактураНадписьОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	//СтандартнаяОбработка = Ложь;
	//УправлениеНебольшойФирмойКлиент.ОткрытьСчетФактуру(ЭтотОбъект);//Паганини#OneSoft
...
Процедура ПодготовитьФормуНаСервере()
	...
	//Элементы.СчетФактураНадпись.Заголовок = РаботаСФормойДокументаКлиентСервер.СформироватьНадписьСчетФактура(НайденныйСчетФактура,,СчетФактураТекст);//Паганини#OneSoft
