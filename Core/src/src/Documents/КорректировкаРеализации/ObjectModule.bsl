...
Процедура ЗаполнитьПоРеализации(ДанныеЗаполнения) Экспорт
	...
	|	РасходнаяНакладная.Проект, //Малышев 2024-08-24 ONESOFT-3415
	...
	|	РасходнаяНакладнаяЗапасы.Проект, //Малышев 2024-08-24 ONESOFT-3415
...
Процедура ЗаполнитьПоЗаказуНаряду(ДанныеЗаполнения) Экспорт
	...
	Если НЕ СостоянияЗаказов.ЭтоСостояниеВыполненияЗаказНаряда(ЗначенияРеквизитов.СостояниеЗаказа, ЗначенияРеквизитов.ВидЗаказа) Тогда
		...
		ТекстИсключения = НСтр("ka='კორექტირება შეიძლება შეიქმნას მხოლოდ შესრულებული სერვისის დოკუმენტის საფუძველზე.';ru='Корректировка может быть создана только на основании выполненного заказа-наряда.'");
		ВызватьИсключение ТекстИсключения;
	...
	|	ЗаказПокупателя.Проект, //Малышев 2024-08-24 ONESOFT-3415
	...
	|	ЗаказПокупателяРаботы.Проект, //Малышев 2024-08-24 ONESOFT-3415
	...
	|	ЗаказПокупателяЗапасы.Проект, //Малышев 2024-08-24 ONESOFT-3415
