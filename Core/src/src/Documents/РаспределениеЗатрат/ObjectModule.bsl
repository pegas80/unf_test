...
Процедура ВыполнитьЗаполнениеПродукцииПоВыпуску() Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_Себестоиимость КАК ВТ_Себестоиимость
	|		ПО ВТ_Производство.Номенклатура = ВТ_Себестоиимость.Номенклатура
	|			И ВТ_Производство.Характеристика = ВТ_Себестоиимость.Характеристика
	|			И ВТ_Производство.Партия = ВТ_Себестоиимость.Партия
	|			И ВТ_Производство.ЕдиницаИзмерения = ВТ_Себестоиимость.НоменклатураЕдиницаИзмерения";
	//--- Дмгг
