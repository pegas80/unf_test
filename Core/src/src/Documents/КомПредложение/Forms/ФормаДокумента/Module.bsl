...
Процедура ЭтоПодарокПриИзменении(Элемент)
	...
	Для Каждого ТекСтр Из Объект.ТаблицаПредложений Цикл
...
// Олег Литвиненко 20.09.22 --->
&НаКлиенте
Процедура ТаблицаПредложенийЭтоПодарокПриИзменении(Элемент)
...
Процедура УстановитьВидимостьЭтоПодарок()
	...
	Если СрезУчетнаяПолитикаРегл.Количество() Тогда
		...
		Элементы.ТаблицаПредложенийЭтоПодарок.Видимость = ИспользоватьПодарокВТабличнойЧасти;
