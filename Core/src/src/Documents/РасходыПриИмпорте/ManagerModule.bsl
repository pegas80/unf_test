...
Процедура СформироватьТаблицаЗапасы(ДокументСсылкаРасходыПриИмпорте, СтруктураДополнительныеСвойства);
	...
	Запрос.УстановитьПараметр("ТаможеннаяПошлина", НСтр("ka='საბაჟო ბაჟი';ru='Таможенная пошлина';en='customs duty'"));
	Запрос.УстановитьПараметр("ТаможенныйСбор", НСтр("ka='საბაჟო შეკრება';ru='Таможенный сбор';en='customs duty'"));
	Запрос.УстановитьПараметр("ТаможенныйНДС", НСтр("ka='НДС, уплаченный таможенным органам';ru='НДС, уплаченный таможенным органам';en='VAT paid to customs authorities'"));
...
Процедура СформироватьТаблицаРасчетыСПрочимиКонтрагентами(ДокументСсылкаРасходыПриИмпорте, СтруктураДополнительныеСвойства)
	...
	Запрос.УстановитьПараметр("ТаможенныйСбор", НСтр("ka='საბაჟო შეკრება';ru='Таможенный сбор';en='customs duty'"));
	Запрос.УстановитьПараметр("ТаможеннаяПошлина", НСтр("ka='საბაჟო ბაჟი';ru='Таможенная пошлина';en='customs duty'"));
	Запрос.УстановитьПараметр("ТаможенныйШтраф", НСтр("ka='საბაჟო ჯარიმა';ru='Таможенный штраф';en='customs penalty'"));
	Запрос.УстановитьПараметр("ТаможенныйНДС", НСтр("ka='НДС, уплаченный таможенным органам';ru='НДС, уплаченный таможенным органам';en='VAT paid to customs authorities'"));
	...
	//+++ Дмгг
	|	ТаблицаДокументаСборы.СчетУчетаРасчетовСПоставщикомРегл КАК СчетУчетаРегл,
	//--- Дмгг
	...
	//+++ Дмгг
	|	ТаблицаДокументаСборы.СчетУчетаРасчетовСПоставщикомРегл,
	//--- Дмгг
	|	ВЫБОР
	|		КОГДА ТаблицаДокументаСборы.ВестиРасчетыПоДокументам
	|			ТОГДА &Ссылка
	...
	//+++ Дмгг
	|	ТаблицаДокументаПошлина.СчетУчетаРасчетовСПоставщикомРегл,
	//--- Дмгг
	...
	//+++ Дмгг
	|	,ВременнаяТаблицаРасчетыСПрочимиКонтрагентами.СчетУчетаРегл КАК СчетУчетаРегл
	//--- Дмгг
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаДополнительныеРасходы, СтруктураДополнительныеСвойства) Экспорт
	...
	//+++ Дмгг
	|	РасходыПриИмпортеЗапасы.Ссылка.Контрагент.СчетУчетаРасчетовСПокупателемРегл КАК СчетУчетаРасчетовСПокупателемРегл,
	|	РасходыПриИмпортеЗапасы.Ссылка.Контрагент.СчетУчетаРасчетовСПоставщикомРегл КАК СчетУчетаРасчетовСПоставщикомРегл,
	//--- Дмгг
	...
	//+++ Дмгг
	|	РасходыПриИмпортеЗапасы.Номенклатура.СчетУчетаЗапасовРегл КАК СчетУчетаРегл,
	//--- Дмгг
	...
	//+++ Дмгг
	|	РасходыПриИмпортеРасходы.Контрагент.СчетУчетаРасчетовСПоставщикомРегл КАК СчетУчетаРасчетовСПоставщикомРегл,
	//--- Дмгг
	...
	//+++ Дмгг
	|	РасходыПриИмпортеЗапасыНДС.Ссылка.Контрагент.СчетУчетаРасчетовСПоставщикомРегл КАК СчетУчетаРасчетовСПоставщикомРегл,
	//--- Дмгг
	...
	//+++ Дмгг
	|	РасходыПриИмпортеЗапасыНДС.Номенклатура.СчетУчетаЗапасовРегл КАК СчетУчетаРегл,
	//--- Дмгг
