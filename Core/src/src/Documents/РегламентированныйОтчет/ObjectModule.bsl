...
Процедура ПриЗаписи(Отказ)
	...
	Если мЭтоНовый Тогда
		РегламентированнаяОтчетность.ОбработатьСобытие1СОтчетности(НСтр("ka='Регламентированный отчет. Создание';ru='Регламентированный отчет. Создание';en='Regulated report. Creature'"), ЭтотОбъект.Ссылка);
	КонецЕсли;
