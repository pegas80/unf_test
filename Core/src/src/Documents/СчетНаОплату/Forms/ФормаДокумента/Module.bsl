...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьБиллинг") Тогда
		...
		Иначе
			...
			Элементы.РасшифровкаБиллингаОбъектДоговораОбслуживания.Заголовок = НСтр("ka='ნომენკლატურა';ru='Номенклатура';en='Nomenclature'");
		КонецЕсли;
	КонецЕсли;
...
"Необходимо проверить валюту документа!'"
		...
		ИначеЕсли ВопросВидЦен Тогда
			...
			Если ПересчетНеобходим Тогда
				...
				Сообщение = НСтр("ka='კონტრაგენტთან ხელშეკრულება ითვალისწინებს დოკუმენტში დადგენილისგან განსხვავებულ ფასების და ფასდაკლების პირობებს! გადავთვალოთ დოკუმენტი ხელშეკრულების შესაბამისად?';ru='Договор с контрагентом предусматривает условия цен и скидок, отличные от установленных в документе! "
...
"Необходимо проверить валюту документа!'"
		...
		ИначеЕсли ВопросВидЦен Тогда
			...
			Если ПересчетНеобходим Тогда
				...
				ТекстСообщения = НСтр("ka='კონტრაგენტთან ხელშეკრულება ითვალისწინებს დოკუმენტში დადგენილისგან განსხვავებულ ფასების და ფასდაკლების პირობებს! გადავთვალოთ დოკუმენტი ხელშეკრულების შესაბამისად?';ru='Договор с контрагентом предусматривает условия цен и скидок, отличные от установленных в документе! "
"Пересчитать документ в соответствии с договором?'");
