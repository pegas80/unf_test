...
Процедура ЗаполнитьПоЗаказуПокупателя(ДокументСсылкаЗаказПокупателя) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ВидОперации = Перечисления.ВидыОперацийЗаказПокупателя.ЗаказНаряд Тогда
			...
			НСтр("ka='შესრულებული სამუშაოების შესახებ აქტის შეყვანა შეკვეთა-განწესის %1 საფუძველზე არ შეიძლება!';ru='Нельзя ввести Акт выполненных работ на основании заказ-наряда %1!';en='You can not enter a completion certificate on the basis of purchase order% 1!'"),
