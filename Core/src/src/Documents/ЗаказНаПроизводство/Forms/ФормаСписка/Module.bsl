...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
		...
		"ФормаСписка",
		Неопределено,
		НСтр("ka='Новости: Заказы на производство';ru='Новости: Заказы на производство';en='News: Orders for production'"),
		Ложь,
...
Процедура УстановитьОтборТекущиеДела()
	...
	АвтоЗаголовок = Ложь;
	Заголовок = НСтр("ka='საწარმოო შეკვეთები';ru='Заказы на производство';en='Orders for production'");
