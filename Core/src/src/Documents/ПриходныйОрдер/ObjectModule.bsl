...
"Документ ""%ДокументСсылка"" не имеет ордерного склада!';ka='ოპერაცია ""საორდერო საწყობში შემოსვლები""-ს შეყვანა შეუძლებელია. დოკუმენტ ""%ДокументСсылка""-ს საორდერო საწყობი არ გააჩნია!'");
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	//Lazare_
	Если НЕ ПометкаУдаления И НЕ РС_ОбщегоНазначения.РеквизитНомерТТНДокументаУникален(Ссылка,"НомерТТН",НомерТТН,"ПриходныйОрдер" ) Тогда
	...
	КонецЕсли;	
	Если НЕ ПометкаУдаления И НЕ РС_ОбщегоНазначения.РеквизитIDTТНДокументаУникален(Ссылка,"IDTТН",IDTТН ,"ПриходныйОрдер" ) Тогда
