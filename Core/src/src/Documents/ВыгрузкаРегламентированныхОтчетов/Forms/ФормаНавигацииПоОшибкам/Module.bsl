...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого СтрТаблСообщений Из ВладелецТС.ТаблицаСообщений Цикл
		...
		РегламентированнаяОтчетность.ОбработатьСобытие1СОтчетности(НСтр("ka='Регламентированный отчет. Проверка выгрузки';ru='Регламентированный отчет. Проверка выгрузки';en='Regulated report. Check discharge'"), СтрТаблСообщений);
