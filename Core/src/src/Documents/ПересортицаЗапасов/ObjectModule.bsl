...
Процедура ЗаполнитьПоИнвентаризацииВсеРасходжения(ДокументСсылкаИнвентаризацияЗапасов, ЗаполняетсяИзФормыДокумента = Ложь) Экспорт
	...
	Если РезультатЗапроса.Пустой() Тогда
		ВызватьИсключение НСтр("ka='Нет данных для оформления пересортицы: в инвентаризации нет отклонений или все документы уже оформлены!';ru='Нет данных для оформления пересортицы: в инвентаризации нет отклонений или все документы уже оформлены!';en='No data for the design of regrading: in the inventory there is no deviation, or all of the documents have already been prepared!'");
	КонецЕсли;
