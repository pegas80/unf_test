...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.ДругиеВидыОтсутствия.ИнициализироватьДанныеДокумента(Ссылка, ДополнительныеСвойства);
	...
	УправлениеНебольшойФирмойСервер.ОтразитьДругиеВидыОтсутствия(ДополнительныеСвойства, Движения, Отказ);
	УправлениеНебольшойФирмойСервер.ОтразитьОдноразовыеНачисленияУдержанияОтпуска(ДополнительныеСвойства, Движения, Отказ);
