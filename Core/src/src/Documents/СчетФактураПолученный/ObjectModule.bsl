...
"Документ-основание:"
"%1.';ka='ავანსად ანგარიშფაქტურისთვის მონაცემები არ არის! დოკუმენტი-საფუძველი: %1.'"),
		БанковскийДокумент);
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(ДокументОснование)
		...
		ТекстОшибки = НСтр("ka='საფუძველ-დოკუმენტი %ПредставлениеДокументаОснования% არ არის გატარებული. ანგარიშფაქტურის გატარება შეუძლებელია.';ru='Документ-основание %ПредставлениеДокументаОснования% не проведен. Проведение счет фактуры не возможно.';en='Paper base PredstavlenieDokumentaOsnovaniya%% not conducted. Carrying through the invoice is not possible.'");
...
"კიდევ ერთი დოკუმენტ ""ანგარიშფაქტურა (მიღებული)""-ს ჩაწერა დაუშვებელია!';ru='Для документа ""%Ссылка%"" "
...
"კიდევ ერთი დოკუმენტ ""ანგარიშფაქტურა (მიღებული)""-ს ჩაწერა დაუშვებელია!';ru='Для документа ""%1"""
