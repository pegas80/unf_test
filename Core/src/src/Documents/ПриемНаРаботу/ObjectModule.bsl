...
Процедура ВыполнитьПредварительныйКонтроль(Отказ)
	...
	ТаблицаСотрудники 			= Сотрудники.Выгрузить(,"НомерСтроки, Сотрудник, Период,ДатаОкончанияДоговора ,КлючСвязи");
	...
	|	ПриемНаРаботуСотрудники.ДатаОкончанияДоговора КАК ДатаОкончанияДоговора,
