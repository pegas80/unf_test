...
Процедура РасходВыдачаКредитаБанк(Команда)
	...
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("РасходСоСчета", "ВыдачаКредитаКонтрагенту", ДанныеМеток);
...
&НаКлиенте
Процедура РасходЗарплатаПоВедомостиБанкВРазрезеСотрудников(Команда) // Kuzmich, 23.02.2019,Зарплата по ведомости в разрезе сотрудников
	
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("РасходСоСчета", "ЗарплатаВРазрезеСотрудников", ДанныеМеток);
	
КонецПроцедуры

&НаКлиенте 
Процедура РасходПенсионномуФонду(Команда) //Паганини ПФ
	
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("РасходСоСчета", "ПенсионномуФонду", ДанныеМеток);
