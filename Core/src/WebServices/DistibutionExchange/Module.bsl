...
Функция ЗаписатьДанные(КодМобильногоКомпьютера, ДанныеМобильногоПриложения)
	...
	//--------------------------------------------------------------------------
	// © Шишка В.В. [28 сентября 2023]  НАЧАЛО
	Если ОшибкиВозврата.Количество() Тогда
	
		ЗаписьJSON = Новый ЗаписьJSON;
		ЗаписьJSON.УстановитьСтроку();
		ЗаписатьJSON(ЗаписьJSON, ОшибкиВозврата);
...
//--------------------------------------------------------------------------
// © Шишка В.В. [7 октября 2023]  НАЧАЛО
Функция ПроверитьДанныеВозвратов(КодМобильногоКомпьютера, ДанныеМобильногоПриложения)
	...
	ОПТИМУС_ОбменДистрибуция.ВыполнитьПрорверкуПоЗаявкамНаВозврат(УзелОбмена, ДанныеМобильногоПриложения, ОшибкиВозврата);
	Если ОшибкиВозврата.Количество() Тогда
...
КонецФункции	
// © Шишка В.В. [7 октября 2023]  КОНЕЦ
//--------------------------------------------------------------------------
