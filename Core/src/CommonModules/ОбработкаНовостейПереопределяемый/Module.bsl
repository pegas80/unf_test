...
//   НоваяСтрока.Наименование = НСтр("ka='როგორ განვაახლოთ კონფიგურაცია';ru='Как обновить конфигурацию'");
//   НоваяСтрока.Ссылка = Справочники.Новости.НайтиПоРеквизиту("УИННовости", "123456"); // Новость должна присутствовать в справочнике!
//   НоваяСтрока = Форма.Новости.Добавить();
//   НоваяСтрока.Наименование = НСтр("ka='როგორ მოვახდინოთ ავტოგანახლების გამართვა';ru='Как настроить автообновление'");
...
"	Отказ: %3'");
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ka='Новости. Переопределяемый. ОбработатьЗаписьПользователя. Начало';ru='Новости. Переопределяемый. ОбработатьЗаписьПользователя. Начало'"), // ИмяСобытия
	...
	ТекстСообщения = НСтр("ka='Завершаем для нового пользователя установку признака ОповещениеВключено = Ложь.';ru='Завершаем для нового пользователя установку признака ОповещениеВключено = Ложь.'");
	ЗаписьЖурналаРегистрации(
		НСтр("ka='Новости. Переопределяемый. ОбработатьЗаписьПользователя. Конец';ru='Новости. Переопределяемый. ОбработатьЗаписьПользователя. Конец'"), // ИмяСобытия
		УровеньЖурналаРегистрации.Информация, // УровеньЖурналаРегистрации.*
		, // ОбъектМетаданных
		, // Данные
		ТекстСообщения, // Комментарий
