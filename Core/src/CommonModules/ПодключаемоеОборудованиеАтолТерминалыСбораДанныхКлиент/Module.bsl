			...
			Для Каждого СтрокаФормата Из Параметры.ФорматЗагрузки Цикл
				...
				ИначеЕсли СтрокаФормата.Наименование = "Количество" Тогда
					...
					Исключение 
						ВыходныеПараметры.Очистить();
						ВыходныеПараметры.Добавить(999);
						ВыходныеПараметры.Добавить(НСтр("ka='შეცდომა ველ ""რაოდენობა""-ს ჩატვირთვისას.';ru='Ошибка при загрузке поля ""Количество"".'"));
						Результат = Ложь;
					КонецПопытки;
				КонецЕсли;
			КонецЦикла;
...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	ВыходныеПараметры.Добавить(?(Результат, "", НСтр("ka='შეცდომა მოწყობილობის შეერთებისას';ru='Ошибка при подключении устройства'")));
