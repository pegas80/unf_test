...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ЕстьОбменСКонтрагентами Тогда
		...
		Обработчик.Комментарий = НСтр("ka='დოკუმენტების მდგომარეობას ცვლის ""მოსალოდნელია შეტყობინება""-დან ""მოსალოდნელია მიღების თაობაზე შეტყობინება""-თი';ru='Изменяет состояние документов с ""Ожидается извещение"" на ""Ожидается извещение о получении""';en='It changes the state of documents with the ""expected notification"" to ""Pending notification of receipt""'");
		Обработчик.НачальноеЗаполнение = Ложь;
		...
		Обработчик.Комментарий = НСтр("ka='ახდენს კონტრაგენტების შემოწმებას სერვის 1C-ედბ-სთან შეერთებაზე.';ru='Проверяет контрагентов на подключение к сервису 1С-ЭДО.';en='Checks counterparties to connect to 1C-EDI service.'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Создает входящие и исходящие ЭД';ru='Обмен с контрагентами: Создает входящие и исходящие ЭД';en='Exchange with counterparts: Creates the incoming and outgoing ED'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Создает входящие и исходящие ЭД для произвольных ЭД';ru='Обмен с контрагентами: Создает входящие и исходящие ЭД для произвольных ЭД';en='Exchange with counterparts: Creates the incoming and outgoing ED for any ED'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Удаляет полученные и отправленные пакеты ЭД';ru='Обмен с контрагентами: Удаляет полученные и отправленные пакеты ЭД';en='Exchange with counterparts: Deletes sent and received packets ED'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Создает входящие и исходящие ЭД для старых CML документов';ru='Обмен с контрагентами: Создает входящие и исходящие ЭД для старых CML документов';en='Exchange with counterparts: Creates the incoming and outgoing ED for older CML documents'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Заполняет дату последнего изменения состояния ЭДО';ru='Обмен с контрагентами: Заполняет дату последнего изменения состояния ЭДО';en='Exchange with counterparts: Fills the last modified date of the EDC status'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Заполнение регистра сведений Журнал событий ЭДО';ru='Обмен с контрагентами: Заполнение регистра сведений Журнал событий ЭДО';en='Exchange with counterparts: Filling in the register of information EDM Event Log'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Обновление устаревших видов ЭД';ru='Обмен с контрагентами: Обновление устаревших видов ЭД';en='Exchange with counterparts: Upgrading of obsolete ED'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Обновление регистра сведений Состояния электронных документов';ru='Обмен с контрагентами: Обновление регистра сведений Состояния электронных документов';en='Exchange with counterparts: Updating the register state information of electronic documents'");
	...
	Если ЕстьОбменСБанками И ЕстьОбменСКонтрагентами Тогда
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Обновляет данные подсистемы Обмен с банками';ru='1С:ДиректБанк: Обновляет данные подсистемы Обмен с банками';en='1C: DirektBank: Updates the data exchange subsystem with banks'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Обновляет данные регистра Подписываемые виды ЭД';ru='1С:ДиректБанк: Обновляет данные регистра Подписываемые виды ЭД';en='1C: DirektBank: Updates the data register signs types ED'");
	...
	Если ЕстьОбменСБанками Тогда
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Переносит данные дополнительных обработок в константу';ru='1С:ДиректБанк: Переносит данные дополнительных обработок в константу';en='1C: DirektBank: Transfers the data of additional treatments in constant'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Переносит статусы проверки подписей в присоединенные файлы';ru='1С:ДиректБанк: Переносит статусы проверки подписей в присоединенные файлы';en='1C: DirektBank: migration status of verification of signatures in attachments'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Заполняет версию формата.';ru='1С:ДиректБанк: Заполняет версию формата.';en='1C: DirektBank: Fills the version of the format.'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Включает автоматическое обновление списка банков.';ru='1С:ДиректБанк: Включает автоматическое обновление списка банков.';en='1C: DirektBank: Enables automatic update of the list of banks.'");
