...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если ЕстьОбменСКонтрагентами Тогда
		...
		Обработчик.Комментарий = НСтр("ka='დოკუმენტების მდგომარეობას ცვლის ""მოსალოდნელია შეტყობინება""-დან ""მოსალოდნელია მიღების თაობაზე შეტყობინება""-თი';ru='Изменяет состояние документов с ""Ожидается извещение"" на ""Ожидается извещение о получении""'");
		Обработчик.НачальноеЗаполнение = Ложь;
		...
		Обработчик.Комментарий = НСтр("ka='ახდენს კონტრაგენტების შემოწმებას სერვის 1C-ედბ-სთან შეერთებაზე.';ru='Проверяет контрагентов на подключение к сервису 1С-ЭДО.'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Создает входящие и исходящие ЭД';ru='Обмен с контрагентами: Создает входящие и исходящие ЭД'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Создает входящие и исходящие ЭД для произвольных ЭД';ru='Обмен с контрагентами: Создает входящие и исходящие ЭД для произвольных ЭД'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Удаляет полученные и отправленные пакеты ЭД';ru='Обмен с контрагентами: Удаляет полученные и отправленные пакеты ЭД'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Создает входящие и исходящие ЭД для старых CML документов';ru='Обмен с контрагентами: Создает входящие и исходящие ЭД для старых CML документов'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Заполняет дату последнего изменения состояния ЭДО';ru='Обмен с контрагентами: Заполняет дату последнего изменения состояния ЭДО'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Заполнение регистра сведений Журнал событий ЭДО';ru='Обмен с контрагентами: Заполнение регистра сведений Журнал событий ЭДО'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Обновление устаревших видов ЭД';ru='Обмен с контрагентами: Обновление устаревших видов ЭД'");
		...
		Обработчик.Комментарий = НСтр("ka='Обмен с контрагентами: Обновление регистра сведений Состояния электронных документов';ru='Обмен с контрагентами: Обновление регистра сведений Состояния электронных документов'");
	...
	Если ЕстьОбменСБанками И ЕстьОбменСКонтрагентами Тогда
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Обновляет данные подсистемы Обмен с банками';ru='1С:ДиректБанк: Обновляет данные подсистемы Обмен с банками'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Обновляет данные регистра Подписываемые виды ЭД';ru='1С:ДиректБанк: Обновляет данные регистра Подписываемые виды ЭД'");
	...
	Если ЕстьОбменСБанками Тогда
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Переносит данные дополнительных обработок в константу';ru='1С:ДиректБанк: Переносит данные дополнительных обработок в константу'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Переносит статусы проверки подписей в присоединенные файлы';ru='1С:ДиректБанк: Переносит статусы проверки подписей в присоединенные файлы'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Заполняет версию формата.';ru='1С:ДиректБанк: Заполняет версию формата.'");
		...
		Обработчик.Комментарий = НСтр("ka='1С:ДиректБанк: Включает автоматическое обновление списка банков.';ru='1С:ДиректБанк: Включает автоматическое обновление списка банков.'");
