...
Процедура ЗафиксироватьДлительностьКлючевойОперации(
	...
	Если БезопасныйРежим() <> Ложь Тогда
		ЗаписьЖурналаРегистрации(НСтр("ka='ქვესისტემის მუშაობა მწარმოებლურობის შეფასებას უსაფრთხო რეჟიმში მხარდაჭერა არ გააჩნია';ru='Работа подсистемы оценка производительности в безопасном режиме не поддерживается';en='Work performance evaluation subsystem in Safe Mode is not supported'", Метаданные.ОсновнойЯзык.КодЯзыка),
