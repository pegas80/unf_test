...
Процедура ЗафиксироватьДлительностьКлючевойОперации(
	...
	Если БезопасныйРежим() <> Ложь Тогда
		ЗаписьЖурналаРегистрации(НСтр("ka='ქვესისტემის მუშაობა მწარმოებლურობის შეფასებას უსაფრთხო რეჟიმში მხარდაჭერა არ გააჩნია';ru='Работа подсистемы оценка производительности в безопасном режиме не поддерживается'", Метаданные.ОсновнойЯзык.КодЯзыка),
