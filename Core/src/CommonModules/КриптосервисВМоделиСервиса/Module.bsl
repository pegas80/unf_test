...
Функция ПолучитьПроверочныйКод(Знач ПредметПроверки, ПовторнаяОтправка = Ложь, Тип = "phone") Экспорт
	...
	Исключение
		Если Тип = "phone" Тогда
			Событие = НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Проверка мобильного телефона';ru='Электронная подпись в модели сервиса.Криптосервис.Проверка мобильного телефона';en='Electronic signature in the mobile phone model servisa.Kriptoservis.Proverka'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		Иначе
			Событие = НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Проверка электронной почты';ru='Электронная подпись в модели сервиса.Криптосервис.Проверка электронной почты';en='Electronic signature model servisa.Kriptoservis.Proverka email'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		КонецЕсли;
...
Функция ПроверитьНомерТелефона(НомерТелефона, ПроверочныйКод) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Проверка мобильного телефона';ru='Электронная подпись в модели сервиса.Криптосервис.Проверка мобильного телефона';en='Electronic signature in the mobile phone model servisa.Kriptoservis.Proverka'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПроверитьАдресЭлектроннойПочты(АдресЭлектроннойПочты, ПроверочныйКод) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Проверка электронной почты';ru='Электронная подпись в модели сервиса.Криптосервис.Проверка электронной почты';en='Electronic signature model servisa.Kriptoservis.Proverka email'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьВременныйПароль(Идентификатор, ПовторнаяОтправка = Ложь, Тип = "phone") Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Получение временного пароля';ru='Электронная подпись в модели сервиса.Криптосервис.Получение временного пароля';en='Electronic signature in servisa.Kriptoservis.Poluchenie model temporary password'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьСеансовыйКлюч(Идентификатор, ВременныйПароль) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Получение сеансового ключа';ru='Электронная подпись в модели сервиса.Криптосервис.Получение сеансового ключа';en='Electronic signature in the model of the session key servisa.Kriptoservis.Poluchenie'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Авторизован(Идентификатор) Экспорт
	...
	Если ЗначениеЗаполнено(СеансовыйКлюч) Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Авторизация';ru='Электронная подпись в модели сервиса.Криптосервис.Авторизация';en='Electronic signature in servisa.Kriptoservis.Avtorizatsiya model'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
				УровеньЖурналаРегистрации.Ошибка,,,
				КомментарийПоИсключению(
					ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьСвойстваСертификата(Сертификат) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Получение свойств сертификата';ru='Электронная подпись в модели сервиса.Криптосервис.Получение свойств сертификата';en='Electronic signature model servisa.Kriptoservis.Poluchenie certificate properties'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Подписать(Идентификатор, ИсходныеДанные, ВключатьИсходныеДанные) Экспорт
    ...
    Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Подписание';ru='Электронная подпись в модели сервиса.Криптосервис.Подписание';en='Electronic signature in servisa.Kriptoservis.Podpisanie model'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПодписатьДанные(Идентификатор, ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Подписание данных';ru='Электронная подпись в модели сервиса.Криптосервис.Подписание данных';en='Electronic signature in the data model servisa.Kriptoservis.Podpisanie'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПроверитьПодпись(Сертификат, Подпись, ИсходныеДанные) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Проверка подписи';ru='Электронная подпись в модели сервиса.Криптосервис.Проверка подписи';en='Electronic signature in the signature model servisa.Kriptoservis.Proverka'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Зашифровать(Идентификатор, СертификатыПолучателей, ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Шифрование';ru='Электронная подпись в модели сервиса.Криптосервис.Шифрование';en='Electronic signature in servisa.Kriptoservis.Shifrovanie model'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция Расшифровать(Идентификатор, ЗашифрованныеДанные, Идентификаторы = Неопределено) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Дешифрование';ru='Электронная подпись в модели сервиса.Криптосервис.Дешифрование';en='Electronic signature in servisa.Kriptoservis.Deshifrovanie model'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПодписатьИЗашифровать(Идентификатор, СертификатыПолучателей, ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Подписание и шифрование';ru='Электронная подпись в модели сервиса.Криптосервис.Подписание и шифрование';en='Electronic signature and encryption model servisa.Kriptoservis.Podpisanie'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
				Новый Структура("Идентификатор,СертификатыПолучателей,ИсходныеДанные", Идентификатор, СертификатыПолучателей, ИсходныеДанные)));
...
Функция ХешироватьДанные(ИсходныеДанные) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Хеширование данных';ru='Электронная подпись в модели сервиса.Криптосервис.Хеширование данных';en='Electronic signature in the data model servisa.Kriptoservis.Heshirovanie'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
...
Функция ПолучитьСпособыДоставкиПаролей(Идентификатор) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Получение способов доставки паролей';ru='Электронная подпись в модели сервиса.Криптосервис.Получение способов доставки паролей';en='Electronic signature model servisa.Kriptoservis.Poluchenie delivery methods passwords'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
				Новый Структура("Идентификатор", Идентификатор)));
...
Функция СообщениеСПаролемДоставлено(Идентификатор) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Получение статуса SMS';ru='Электронная подпись в модели сервиса.Криптосервис.Получение статуса SMS';en='Electronic signature model SMS status servisa.Kriptoservis.Poluchenie'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			КомментарийПоИсключению(
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()),
				Новый Структура("Идентификатор", Идентификатор)));
...
Функция Сертификат(Знач Сертификат)
	...
	Иначе
		ВызватьИсключение(НСтр("ka='Параметр <Сертификат> должен иметь тип ДвоичныеДанные или Структура.';ru='Параметр <Сертификат> должен иметь тип ДвоичныеДанные или Структура.';en='The <certificate> DvoichnyeDannye must be of type or structure.'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
	КонецЕсли;
...
Процедура ВызватьСтандартноеИсключение()
	...
	ВызватьИсключение(НСтр("ka='სერვისი დროებით მიუწვდომელია. მიმართეთ მხარდაჭერის სამსახურს ან მოგვიანებით სცადეთ.';ru='Сервис временно недоступен. Обратитесь в службу поддержки или повторите попытку позже.';en='Service is temporarily unavailable. Please contact customer support or try again later.'"));
...
Функция ПолучитьСвойстваКриптосообщения(Криптосообщение, ТолькоКлючевыеСвойства = Ложь) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронная подпись в модели сервиса.Криптосервис.Получение свойств криптосообщения';ru='Электронная подпись в модели сервиса.Криптосервис.Получение свойств криптосообщения';en='Electronic signature model properties servisa.Kriptoservis.Poluchenie kriptosoobscheniya'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
