...
Функция ПроверитьПодключениеОрганизации(ОрганизацияОтчета, ТолькоОтчетность = Ложь) Экспорт
	...
	ИначеЕсли (НЕ Подключение.ФСРАР) и (НЕ ТолькоОтчетность) Тогда	
	    ПоказатьПредупреждение(,НСтр("ka='По организации отчета не включена возможность электронного документооборота с Росалкогольрегулированием!';ru='По организации отчета не включена возможность электронного документооборота с Росалкогольрегулированием!'"));
	КонецЕсли;
