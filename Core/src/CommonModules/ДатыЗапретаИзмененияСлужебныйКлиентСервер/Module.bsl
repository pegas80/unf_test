...
Функция ОписанияДатЗапрета() Экспорт
	...
	Список.Вставить("",                      НСтр("ka='არ არის დაყენებული';ru='Не установлена'"));
	Список.Вставить("ПроизвольнаяДата",      НСтр("ka='თავისუფალი თარიღი';ru='Произвольная дата'"));
	Список.Вставить("КонецПрошлогоГода",     НСтр("ka='წინა წლის დასასრული';ru='Конец прошлого года'"));
	Список.Вставить("КонецПрошлогоКвартала", НСтр("ka='წინა კვარტლის დასასრული';ru='Конец прошлого квартала'"));
	Список.Вставить("КонецПрошлогоМесяца",   НСтр("ka='წინა თვის დასასრული';ru='Конец прошлого месяца'"));
	Список.Вставить("КонецПрошлойНедели",    НСтр("ka='წინა კვირის დასასრული';ru='Конец прошлой недели'"));
	Список.Вставить("ПредыдущийДень",        НСтр("ka='წინა დღე';ru='Предыдущий день'"));
