...
Процедура ПроверитьКонтрагентовВОтчете(Форма, ДополнительныеПараметры) Экспорт
	...
	НаименованиеЗадания = НСтр("ka='Проверка контрагентов в отчетах по НДС';ru='Проверка контрагентов в отчетах по НДС'");
...
Функция СсылкаНаИнструкцию() Экспорт
	...
	// Предлагаем заменить стандартное поведение
	Результат = Новый ФорматированнаяСтрока(НСтр("ka='დაწვრილებით, შემოწმების შესახებ';ru='Подробнее о проверке'"),,,, "e1cib/app/Обработка.ИнструкцияПоИспользованиюПроверкиКонтрагента");
