...
Функция РасчетЯчеек(ТабличныйДокумент, ВыделенныеОбласти) Экспорт
	...
	Если ВыделенныеОбласти = Неопределено Тогда
		...
		#Иначе
			ВызватьИсключение НСтр("ka='პარამეტრ ""გამოყოფილიარეალები""-ს მნიშვნელობა არ არის მითითებული.';ru='Не указано значение параметра ""ВыделенныеОбласти"".';en='Unknown value ""VydelennyeOblasti"".'");
		#КонецЕсли
	КонецЕсли;
