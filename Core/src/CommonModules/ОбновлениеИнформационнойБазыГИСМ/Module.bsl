...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение версии схем обмена с ГИСМ.';ru='Заполнение версии схем обмена с ГИСМ.';en='Filling version schemes GISM exchange.'");
	...
	Обработчик.Комментарий = НСтр("ka='Обновление версии схем обмена с ГИСМ.';ru='Обновление версии схем обмена с ГИСМ.';en='Upgrading schemes GISM exchange.'");
	...
	Обработчик.Комментарий = НСтр("ka='Обновление настроек обмена с ГИСМ.';ru='Обновление настроек обмена с ГИСМ.';en='Updating sharing settings from GISM.'");
	...
	Обработчик.Комментарий = НСтр("ka='Перенос GLN из справочника организаций в регистр ""Организации для обмена с ГИСМ"".';ru='Перенос GLN из справочника организаций в регистр ""Организации для обмена с ГИСМ"".';en='Transfer of GLN from the directory of organizations to register ""with the Organization for GISM exchange.""'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение ресурса GLN в регистре ""Очередь получения квитанций о фиксации ГИСМ"".';ru='Заполнение ресурса GLN в регистре ""Очередь получения квитанций о фиксации ГИСМ"".';en='Filling resource GLN in the register ""Queue obtain receipts for GISM fixing"".'");
	...
	Обработчик.Комментарий = НСтр("ka='Обновляет справочник ""Виды меха ГИСМ"" согласно новым данным классификатора.';ru='Обновляет справочник ""Виды меха ГИСМ"" согласно новым данным классификатора.';en='Updates the directory ""Forms GISM fur"" according to new data classifier.'");
	...
	Обработчик.Комментарий = НСтр("ka='Очищает в документе ""Уведомление об импорте маркированных товаров"" виды меха не соответствующие новому классификатору.';ru='Очищает в документе ""Уведомление об импорте маркированных товаров"" виды меха не соответствующие новому классификатору.';en='Clears the document ""Notice on import of goods marked"" types of fur is not corresponding to the new classifier.'");
	...
	Обработчик.ЧитаемыеОбъекты   = "Константа.ВерсииСхемОбменаГИСМ";
	Обработчик.ИзменяемыеОбъекты = "Константа.ВерсииСхемОбменаГИСМ";
	Обработчик.Комментарий = НСтр("ka='Обновление версии схем обмена с ГИСМ до 2.41';ru='Обновление версии схем обмена с ГИСМ до 2.41';en='Upgrading exchange schemes GISM to 2.41'");
	...
	Обработчик.Комментарий = НСтр("ka='Обработка ошибочно присвоенного статуса документа ""Уведомление об отгрузке маркированной продукции"".';ru='Обработка ошибочно присвоенного статуса документа ""Уведомление об отгрузке маркированной продукции"".';en='Processing mistakenly assigned the status of the document ""Notification of shipment labeled products.""'");
...
Процедура ВерсииСхемОбменаГИСМ_ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ka='Не удалось обработать константу ВерсииСхемОбменаГИСМ по причине: %Причина%';ru='Не удалось обработать константу ВерсииСхемОбменаГИСМ по причине: %Причина%';en='Could not be processed due to the constant VersiiShemObmenaGISM:% reason%'");
...
Процедура НастройкиОбменаГИСМ_ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ka='Не удалось обработать константу НастройкиОбменаГИСМ по причине: %Причина%';ru='Не удалось обработать константу НастройкиОбменаГИСМ по причине: %Причина%';en='Could not be processed due to the constant NastroykiObmenaGISM:% reason%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Причина%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(),
			УровеньЖурналаРегистрации.Предупреждение,
