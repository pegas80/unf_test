...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение версии схем обмена с ГИСМ.';ru='Заполнение версии схем обмена с ГИСМ.'");
	...
	Обработчик.Комментарий = НСтр("ka='Обновление версии схем обмена с ГИСМ.';ru='Обновление версии схем обмена с ГИСМ.'");
	...
	Обработчик.Комментарий = НСтр("ka='Обновление настроек обмена с ГИСМ.';ru='Обновление настроек обмена с ГИСМ.'");
	...
	Обработчик.Комментарий = НСтр("ka='Перенос GLN из справочника организаций в регистр ""Организации для обмена с ГИСМ"".';ru='Перенос GLN из справочника организаций в регистр ""Организации для обмена с ГИСМ"".'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение ресурса GLN в регистре ""Очередь получения квитанций о фиксации ГИСМ"".';ru='Заполнение ресурса GLN в регистре ""Очередь получения квитанций о фиксации ГИСМ"".'");
	...
	Обработчик.Комментарий = НСтр("ka='Обновляет справочник ""Виды меха ГИСМ"" согласно новым данным классификатора.';ru='Обновляет справочник ""Виды меха ГИСМ"" согласно новым данным классификатора.'");
	...
	Обработчик.Комментарий = НСтр("ka='Очищает в документе ""Уведомление об импорте маркированных товаров"" виды меха не соответствующие новому классификатору.';ru='Очищает в документе ""Уведомление об импорте маркированных товаров"" виды меха не соответствующие новому классификатору.'");
	...
	Обработчик.ЧитаемыеОбъекты   = "Константа.ВерсииСхемОбменаГИСМ";
	Обработчик.ИзменяемыеОбъекты = "Константа.ВерсииСхемОбменаГИСМ";
	Обработчик.Комментарий = НСтр("ka='Обновление версии схем обмена с ГИСМ до 2.41';ru='Обновление версии схем обмена с ГИСМ до 2.41'");
	...
	Обработчик.Комментарий = НСтр("ka='Обработка ошибочно присвоенного статуса документа ""Уведомление об отгрузке маркированной продукции"".';ru='Обработка ошибочно присвоенного статуса документа ""Уведомление об отгрузке маркированной продукции"".'");
...
Процедура ВерсииСхемОбменаГИСМ_ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ka='Не удалось обработать константу ВерсииСхемОбменаГИСМ по причине: %Причина%';ru='Не удалось обработать константу ВерсииСхемОбменаГИСМ по причине: %Причина%'");
...
Процедура НастройкиОбменаГИСМ_ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Исключение
		...
		ТекстСообщения = НСтр("ka='Не удалось обработать константу НастройкиОбменаГИСМ по причине: %Причина%';ru='Не удалось обработать константу НастройкиОбменаГИСМ по причине: %Причина%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%Причина%", ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗаписьЖурналаРегистрации(ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(),
			УровеньЖурналаРегистрации.Предупреждение,
