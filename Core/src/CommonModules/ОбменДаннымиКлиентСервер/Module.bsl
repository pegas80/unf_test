...
Процедура ПроверитьНедопустимыеСимволыВИмениПользователяWSПрокси(Знач ИмяПользователя) Экспорт
	...
	Если СтрокаСодержитСимвол(ИмяПользователя, НедопустимыеСимволыВИмениПользователяWSПрокси()) Тогда
		...
		СтрокаСообщения = НСтр("ka='მომხმარებელ %1-ის სახელი შეიცავს დაუშვებელ სიმბოლოებს. მომხმარებლის სახელი არ უნდა შეიცავდეს სიმბოლოებს: %2.';ru='В имени пользователя %1 содержатся недопустимые символы."
...
"Адрес должен начинаться с префикса Интернет протокола %2 (например: ""http://myserver.com/service"").';ka='მისამართ ""%1""-ის არასწორი ფორმატი."
"მისამართი უნდა იწყებოდეს ინტერნეტ პროტოკოლის პრეფიქსით %2 (მაგალითად: ""http://myserver.com/service"").'");
