...
Процедура ДобавитьУсловноеОформлениеТаблицыСопоставлений(ЭтотОбъект, ПутьРеквизита, НастройкиЗагрузкиДанных) Экспорт
	...
	ИначеЕсли НастройкиЗагрузкиДанных.ЭтоЗагрузкаСправочника Тогда
		...
		ТекстНовыйЭлемент	= Нстр("ka='<შეიქმნება ახალი ელემენტი>';ru='<Будет создан новый элемент>'");
		ТекстПропущены		= Нстр("ka='<მონაცემები გამოტოვებული იქნება>';ru='<Данные будут пропущены>'");
	...
	ИначеЕсли НастройкиЗагрузкиДанных.ЭтоЗагрузкаРегистраСведений Тогда
		...
		ТекстУсловногоОформления = Нстр("ka='<სტრიქონი გამოტოვებული იქნება...>';ru='<Строка будет пропущена...>'");
