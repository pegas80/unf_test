...
"Возможна некорректная работа отборов по дополнительным реквизитам и сведениям в списках.';ka='დამატებითი რეკვიზიტების და ცნობების რესტრუქტურიზაცია."
"შესაძლებელია სიებში დამატებითი რეკვიზიტების და ცნობების მიხედვით შერჩევების არაკორექტული მუშაობა.'");
	...
	Если МетаданныеСправочника.ТабличныеЧасти.Найти("ДополнительныеРеквизиты") <> Неопределено Тогда
		...
		Для каждого Свойство Из Свойства Цикл
			Если НЕ Свойство.ЭтоДополнительноеСведение Тогда
				...
				СтрокаИнфоПроКолонки.Группа = НСтр("ka='დამატებითი რეკვიზიტები';ru='Доп. реквизиты';en='Extras. requisites'");
				...
				Если Значения.Количество() > 0 Тогда
					СтрокаИнфоПроКолонки.Примечание = СтрокаИнфоПроКолонки.Примечание  + Символы.ПС + НСтр("ka='მნიშვნელობების ვარიანტები:';ru='Варианты значений:';en='Setting options:'") + Символы.ПС;
		...
		Для каждого Свойство Из ДополнительныеСведения Цикл
			...
			СтрокаИнфоПроКолонки.ОбязательнаДляЗаполнения = Свойство.ЗаполнятьОбязательно;
			СтрокаИнфоПроКолонки.Позиция = Позиция;
			СтрокаИнфоПроКолонки.Группа = НСтр("ka='დამატ. თვისებები';ru='Доп. свойства';en='Extras. properties'");
			СтрокаИнфоПроКолонки.Видимость = Истина;
			СтрокаИнфоПроКолонки.Примечание = Свойство.Наименование;
			СтрокаИнфоПроКолонки.Ширина = 30;
			Позиция = Позиция + 1;
...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа.Представление = НСтр("ka='დამატებითი ცნობები';ru='Дополнительные сведения';en='additional information'");
