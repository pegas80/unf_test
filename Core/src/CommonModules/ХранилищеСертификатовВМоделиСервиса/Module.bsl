...
Функция ДвоичныеДанныеСертификата(ИсходныйСертификат) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Хранилище сертификатов в модели сервиса.Ошибка при удалении файла';ru='Хранилище сертификатов в модели сервиса.Ошибка при удалении файла'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
