	...
	Если Не ЗначениеЗаполнено(ОтчетностьВРосстат) Тогда
		...
		Если ЗначениеЗаполнено(ИмяОтчетаРегламентированныйОтчетСтатистикаБухОтчетность) Тогда
			...
			Исключение
				...
				Сообщение.Текст = НСтр("ka='Не удалось открыть форму отчета ""Бухгалтерская отчетность в Росстат"".';ru='Не удалось открыть форму отчета ""Бухгалтерская отчетность в Росстат"".'");
				Сообщение.Сообщить();

			КонецПопытки;
		Иначе
			ТекстСообщения = НСтр("ka='Форма отчета ""Бухгалтерская отчетность в Росстат"" не поддерживается.';ru='Форма отчета ""Бухгалтерская отчетность в Росстат"" не поддерживается.'");
...
"Подготовить отчет для отправки в Росстат сейчас?'");
	...
	ЗаголовокВопроса = НСтр("ka='Отправка отчета в Росстат';ru='Отправка отчета в Росстат'");
	
	Кнопки = Новый СписокЗначений;
	Кнопки.Добавить("ПодготовитьСейчас", НСтр("ka='მომზადება ახლავე';ru='Подготовить сейчас'"));
	Кнопки.Добавить("Позже", НСтр("ka='მოგვიანებით';ru='Позже'"));
