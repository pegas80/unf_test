...
Процедура ДобавитьСообщение(Комментарий, Ссылка, Форма) Экспорт
	...
	Если (Ссылка.Пустая() Или Форма.Модифицированность) Тогда
		ТекстВопроса = НСтр("ka='კომენტარის დასატოვებლად საჭიროა ცვლილებების ჩაწერა. გავაგრძელოთ?';ru='Чтобы оставлять комментарии, нужно записать изменения. Продолжить?'");
