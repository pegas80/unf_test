...
Функция ПолучитьСтандартныеРасписанияДляНапоминания()
	...
	Результат.Вставить(НСтр("ka='ყოველ ორშაბათს, 9:00-ზე';ru='по понедельникам, в 9:00';en='Mondays, 9:00'"), Расписание);
	...
	Расписание.ДниНедели = ДниНедели;
	Результат.Вставить(НСтр("ka='პარასკევობით, 15:00-ზე';ru='по пятницам, в 15:00';en='on Fridays at 15:00'"), Расписание);
	...
	Расписание.ПериодНедель = 1;
	Расписание.ВремяНачала = '00010101090000';
	Результат.Вставить(НСтр("ka='ყოველდღე, 9:00-ზე';ru='каждый день, в 9:00';en='every day, at 9:00 am'"), Расписание);
