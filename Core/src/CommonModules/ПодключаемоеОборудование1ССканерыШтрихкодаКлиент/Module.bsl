...
"Проверьте настройки порта.';ka='შეცდომა მოწყობილობის შეერთებისას. შეამოწმეთ პორტის გასწორებები.'"));
		КонецЕсли;
...
"Проверьте настройки порта.';ka='შეცდომა მოწყობილობის შეერთებისას. შეამოწმეთ პორტის გასწორებები.'"));
			...
			Иначе
				...
				ВыходныеПараметры.Очистить();
				ВыходныеПараметры.Добавить(999);
				ВыходныеПараметры.Добавить(НСтр("ka='მოწყობილობის დაკავება ვერ მოხერხდა. შეამოწმეთ პორტის გასწორებები.';ru='Не удалось занять устройство."
