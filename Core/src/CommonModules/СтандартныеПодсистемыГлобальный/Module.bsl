...
Процедура ПоказатьПредупрежденияПриЗавершенииРаботы() Экспорт
	...
	Пояснение = НСтр("ka='Выполнить дополнительные действия и завершить работу';ru='Выполнить дополнительные действия и завершить работу';en='Additional steps and exit'");
