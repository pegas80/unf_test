...
Функция XMLТипСсылки(Знач Значение) Экспорт
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ka='შეცდომა ობიექტ %1-ისთვის ბმულის XMLტიპის დადგენისას: ობიექტი არ არის მიმთითებელი!';ru='Ошибка при определении XMLТипа ссылки для объекта %1: объект не является ссылочным!'"),
