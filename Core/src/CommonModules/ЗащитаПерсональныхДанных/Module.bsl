...
Процедура ДобавитьКомандуПечатиСогласияНаОбработкуПерсональныхДанных(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='პერსონალურ მონაცემთა დამუშავების თანხმობა...';ru='Согласие на обработку ПДн...';en='Consent to the processing of PD ...'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		Дело.Представление  = НСтр("ka='თანხმობა პერსონალურ მონაცემთა დამუშავებაზე';ru='Согласия на обработку ПДн';en='Consent to the processing of PD'");
		Дело.Количество     = ИстекшиеСогласия.Количество();
		Дело.Подсказка      = НСтр("ka='პერსონალურ მონაცემთა დამუშავებაზე თანხმობები ამოიწურა. აუცილებელია პერსონალურ მონაცემთა დამუშავების შეწყვეტა ან სუბიექტისგან დამუშავების თაობაზე თანხმობის მოთხოვნა.';ru='Истекли согласия на обработку персональных данных (ПДн). Необходимо прекратить обработку ПДн или запросить у субъекта продление согласия на обработку.';en='Expired consent to processing of personal data (PD). It is necessary to stop the processing of PD or to request an extension of the subject to the consent process.'");
...
Функция ОбластиПерсональныхДанных()
	...
	НоваяОбласть.Представление = НСтр("ka='ПДн დამუშავება';ru='Обработка ПДн';en='Treatment of PD'");
...
Функция ДеревоОбластейПерсональныхДанных()
	...
	Если ОбластиДанных.Количество() = 0 
		...
		ДобавитьОбластьДанныхВДерево(ДеревоОбластейДанных, ОбластиДанных, Новый Структура("Имя, Представление, Родитель", "", НСтр("ka='პერსონალური მონაცემები';ru='Персональные данные';en='Personal data'")));
	КонецЕсли;
