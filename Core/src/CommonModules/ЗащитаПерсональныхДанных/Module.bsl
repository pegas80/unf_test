...
Процедура ДобавитьКомандуПечатиСогласияНаОбработкуПерсональныхДанных(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='პერსონალურ მონაცემთა დამუშავების თანხმობა...';ru='Согласие на обработку ПДн...'");
...
Функция ОбластиПерсональныхДанных()
	...
	НоваяОбласть.Представление = НСтр("ka='ПДн დამუშავება';ru='Обработка ПДн'");
...
Функция ДеревоОбластейПерсональныхДанных()
	...
	Если ОбластиДанных.Количество() = 0 
		...
		ДобавитьОбластьДанныхВДерево(ДеревоОбластейДанных, ОбластиДанных, Новый Структура("Имя, Представление, Родитель", "", НСтр("ka='პერსონალური მონაცემები';ru='Персональные данные'")));
	КонецЕсли;
