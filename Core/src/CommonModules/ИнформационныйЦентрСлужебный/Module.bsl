...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий          = НСтр("ka='Сформировать словарь полных путей к формам в справонике ""ПолныеПутиКФормам"".';ru='Сформировать словарь полных путей к формам в справонике ""ПолныеПутиКФормам"".'");
...
Процедура ОбновитьИнформационныеСсылкиДляФормВМоделиСервиса() Экспорт
	...
	Попытка
		...
		ТекстОшибки = НСтр("ka='საინფორმაციო ბმულების განახლება ვერ მოხერხდა';ru='Не удалось обновить Информационные ссылки'");
...
Функция ОпределитьПространствоИменПоФайлу(ПутьКФайлу)
	...
	Пока ЧтениеИнформационныхСсылок.ТипУзла = ТипУзлаXML.НачалоЭлемента Цикл
		...
		Исключение
			ИмяСобытия = ИнформационныйЦентрСервер.ПолучитьИмяСобытияДляЖурналаРегистрации() + "." + НСтр("ka='საინფორმაციო ბმულები';ru='Информационные ссылки'");
