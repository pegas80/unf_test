...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий          = НСтр("ka='Сформировать словарь полных путей к формам в справонике ""ПолныеПутиКФормам"".';ru='Сформировать словарь полных путей к формам в справонике ""ПолныеПутиКФормам"".';en='Dictionary form full paths to the forms in spravonike ""PolnyePutiKFormam"".'");
...
Процедура ОбновитьИнформационныеСсылкиДляФормВМоделиСервиса() Экспорт
	...
	Попытка
		...
		ТекстОшибки = НСтр("ka='საინფორმაციო ბმულების განახლება ვერ მოხერხდა';ru='Не удалось обновить Информационные ссылки';en='Failed to update the Information links'");
...
Функция ОпределитьПространствоИменПоФайлу(ПутьКФайлу)
	...
	Пока ЧтениеИнформационныхСсылок.ТипУзла = ТипУзлаXML.НачалоЭлемента Цикл
		...
		Исключение
			ИмяСобытия = ИнформационныйЦентрСервер.ПолучитьИмяСобытияДляЖурналаРегистрации() + "." + НСтр("ka='საინფორმაციო ბმულები';ru='Информационные ссылки';en='Информационные ссылки'");
			...
			ЗаписьЖурналаРегистрации(ИмяСобытия, 
				...
				,
				,
				НСтр("ru='Не удалось определить тип информационной ссылки: ';ka='Не удалось определить тип информационной ссылки: '") + Символы.ПС + Символы.ПС + ПредставлениеОбъекта);
