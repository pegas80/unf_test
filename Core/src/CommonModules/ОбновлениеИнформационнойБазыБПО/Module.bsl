...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ka='შესაერთებელი მოწყობილობის მოსაწოდებელი დრაივერების განახლება.';ru='Обновление поставляемых драйверов подключаемого оборудования.'");
