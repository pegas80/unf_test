...
Процедура ПроверитьСсылкиНаОбъект(Знач ОбработкаПродолжения, Знач МассивСсылок, Знач СинонимыРеквизитов) Экспорт
	...
	ЗаголовокДиалога = НСтр("ka='რეკვიზიტების რედაქტირების ნებართვა';ru='Разрешение редактирования реквизитов'");
...
"Поиск мест использования может занять длительное время.'"),
	...
	Кнопки.Добавить(КодВозвратаДиалога.Да, НСтр("ka='შემოწმება და დაშვება';ru='Проверить и разрешить'"));
...
Процедура ПоказатьПредупреждениеВсеВидимыеРеквизитыРазблокированы(ОбработкаПродолжения = Неопределено) Экспорт
	...
	ПоказатьПредупреждение(ОбработкаПродолжения,
		НСтр("ka='ობიექტის ყველა ხილვადი რეკვიზიტის რედაქტირება უკვე დასრულებულია.';ru='Редактирование всех видимых реквизитов объекта уже разрешено.'"));
