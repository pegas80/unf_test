...
Процедура ЗагрузитьИндексыКонтрагентовВФоне(Параметры, АдресРезультата) Экспорт
	...
	ДлительныеОперации.СообщитьПрогресс(
		100,
		НСтр("ka='СервисСПАРКРиски.ЗагрузитьИндексыКонтрагентовВФоне завершено';ru='СервисСПАРКРиски.ЗагрузитьИндексыКонтрагентовВФоне завершено'"),
...
#Область ПроверкаПодключенияИнтернетПоддержки
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("ka='Выполнение ЗагрузитьИндексыКонтрагентов, ПередВызовомОперацииСервиса';ru='Выполнение ЗагрузитьИндексыКонтрагентов, ПередВызовомОперацииСервиса'"));
		...
		Если НЕ Результат.ВидОшибки.Пустая() Тогда
			...
			ОписаниеРезультата = СтрШаблон(
				НСтр("ka='Ошибка выполнения: %1';ru='Ошибка выполнения: %1'"),
				Результат.ВидОшибки);
...
#Область СозданиеТаблицыЗначений
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("ka='Выполнение ЗагрузитьИндексыКонтрагентов, СозданиеТаблицыЗначений';ru='Выполнение ЗагрузитьИндексыКонтрагентов, СозданиеТаблицыЗначений'"));
...
#Область ДополнительныеПараметрыВызоваОперацииСервиса
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("ka='Выполнение ЗагрузитьИндексыКонтрагентов, ДополнительныеПараметрыВызоваОперацииСервиса';ru='Выполнение ЗагрузитьИндексыКонтрагентов, ДополнительныеПараметрыВызоваОперацииСервиса'"));
...
#Область ВызовВебСервиса
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("ka='Выполнение ЗагрузитьИндексыКонтрагентов, ВызовВебСервиса';ru='Выполнение ЗагрузитьИндексыКонтрагентов, ВызовВебСервиса'"));

	ОписаниеРезультата = СтрШаблон(
		НСтр("ka='Вызов метода веб-сервиса для %1 записей (пачками).';ru='Вызов метода веб-сервиса для %1 записей (пачками).'"),
	...
	Для Каждого ТекущийКонтрагент Из МассивОписанийКонтрагентов Цикл
		...
		Если РазмерЗапроса >= 100 Тогда
			...
			ОписаниеРезультата = ОписаниеРезультата
				+ Символы.ПС
				+ СтрШаблон(
					НСтр("ka='Обработка пачки %1: %2 мс; %3';ru='Обработка пачки %1: %2 мс; %3'"),
					НомерПачки,
					ТКонец - ТНачало,
					?(Результат.ВидОшибки.Пустая(),
						"",
						СтрШаблон(
							НСтр("ka='Вид ошибки: %1';ru='Вид ошибки: %1'"),
							Результат.ВидОшибки)));
	...
	Если РазмерЗапроса > 0 Тогда
		...
		ОписаниеРезультата = ОписаниеРезультата
			+ Символы.ПС
			+ СтрШаблон(
				НСтр("ka='Обработка пачки %1 (последней): %2 мс; %3';ru='Обработка пачки %1 (последней): %2 мс; %3'"),
				НомерПачки,
				ТКонец - ТНачало,
				?(Результат.ВидОшибки.Пустая(),
					"",
...
#Область ЗаполнениеГрадациямиИндексовИРеквизитами
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("ka='Выполнение ЗагрузитьИндексыКонтрагентов, ЗаполнениеГрадациямиИндексовИРеквизитами';ru='Выполнение ЗагрузитьИндексыКонтрагентов, ЗаполнениеГрадациямиИндексовИРеквизитами'"));

	ОписаниеРезультата = СтрШаблон(
		НСтр("ka='Обработка результата веб-сервиса для %1 записей.';ru='Обработка результата веб-сервиса для %1 записей.'"),
		МассивОписанийКонтрагентов.Количество());
	...
	ОписаниеРезультата = ОписаниеРезультата
		+ Символы.ПС
		+ СтрШаблон(
			НСтр("ka='Подготовка массива контрагентов (%1 элементов): %2 мс';ru='Подготовка массива контрагентов (%1 элементов): %2 мс'"),
	...
	ОписаниеРезультата = ОписаниеРезультата
		+ Символы.ПС
		+ СтрШаблон(
			НСтр("ka='Получение реквизитов для массива контрагентов (%1 элементов): %2 мс';ru='Получение реквизитов для массива контрагентов (%1 элементов): %2 мс'"),
			МассивКонтрагентов.Количество(),
			ТКонец - ТНачало);
	...
	ОписаниеРезультата = ОписаниеРезультата
		+ Символы.ПС
		+ СтрШаблон(
			НСтр("ka='Заполнение результата веб-сервиса (%1 элементов) реквизитами и градациями индексов: %2 мс';ru='Заполнение результата веб-сервиса (%1 элементов) реквизитами и градациями индексов: %2 мс'"),
...
#Область ДозаполнениеРезультатаИСохранениеВКэше
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("ka='Выполнение ЗагрузитьИндексыКонтрагентов, ДозаполнениеРезультатаИСохранениеВКэше';ru='Выполнение ЗагрузитьИндексыКонтрагентов, ДозаполнениеРезультатаИСохранениеВКэше'"));

	ОписаниеРезультата = НСтр("ka='Дозаполнение результата веб-сервиса.';ru='Дозаполнение результата веб-сервиса.'");
		...
		Если (ТипЗнч(Результат.ЗначенияИндексов) = ТипТаблицаЗначений) И (Результат.ЗначенияИндексов.Количество() > 0) Тогда
			...
			Если Не ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
				...
				ОписаниеРезультата = ОписаниеРезультата
					+ Символы.ПС
					+ СтрШаблон(
						НСтр("ka='Идентификаторы типов событий, подготовка списка из %1 в %2 элементов: %3 мс';ru='Идентификаторы типов событий, подготовка списка из %1 в %2 элементов: %3 мс'"),
				...
				ОписаниеРезультата = ОписаниеРезультата
					+ Символы.ПС
					+ СтрШаблон(
						НСтр("ka='Идентификаторы типов событий, загрузка списка новых событий (%1 элементов): %2 мс';ru='Идентификаторы типов событий, загрузка списка новых событий (%1 элементов): %2 мс'"),
			...
			ОписаниеРезультата = ОписаниеРезультата
				+ Символы.ПС
				+ СтрШаблон(
					НСтр("ka='Заполнение списка событий в результате (%1 элементов): %2 мс';ru='Заполнение списка событий в результате (%1 элементов): %2 мс'"),
					ЛокальныйЗначенияИндексов.Количество(),
					ТКонец - ТНачало);
			...
			ОписаниеРезультата = ОписаниеРезультата
				+ Символы.ПС
				+ СтрШаблон(
					НСтр("ka='Сохранение результата (%1 элементов) в кэше: %2 мс';ru='Сохранение результата (%1 элементов) в кэше: %2 мс'"),
					МассивОписанийКонтрагентов.Количество(),
					ТКонец - ТНачало);
...
"'"),
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ka='СПАРК Риски. Отладка. ЗагрузитьИндексыКонтрагентов';ru='СПАРК Риски. Отладка. ЗагрузитьИндексыКонтрагентов'"), // ИдентификаторШага
...
Функция НачатьПодготовкуСправок(СписокИНН) Экспорт
	...
	Если Не Пользователи.РолиДоступны("ЗапросНовойСправкиСПАРКРиски", , Ложь) Тогда
		...
		Результат.СообщениеОбОшибке  = НСтр("ka='Недостаточно прав для запроса новой справки 1СПАРК Риски.';ru='Недостаточно прав для запроса новой справки 1СПАРК Риски.'");
...
"Обратитесь к администратору.'");
		Результат.ИнформацияОбОшибке = НСтр("ka='Недостаточно прав для работы с сервисом 1СПАРК Риски.';ru='Недостаточно прав для работы с сервисом 1СПАРК Риски.'");
	...
	Если ЗаполнитьДанныеАутентификации И Результат.ВидОшибки.Пустая() Тогда
		...
		Если ДанныеАутентификации = Неопределено Тогда
			...
			Результат.СообщениеОбОшибке  = НСтр("ka='Интернет-поддержка пользователей не подключена.';ru='Интернет-поддержка пользователей не подключена.'");
			Результат.ИнформацияОбОшибке = Результат.СообщениеОбОшибке;
			...
			ИначеЕсли ИмяСвойства = "results" Тогда
				...
				ИначеЕсли ЧтениеОтвета.ТипТекущегоЗначения <> ТипЗначенияJSON.НачалоМассива Тогда
					ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ka='Некорректное значение свойства results. Ожидается тип значения Массив; Фактический тип значения: %1.';ru='Некорректное значение свойства results. Ожидается тип значения Массив; Фактический тип значения: %1.'"),
...
Процедура ПрочитатьСобытияМониторинга(ЧтениеОтвета, Результат, ИНН)
	...
	ИначеЕсли ЧтениеОтвета.ТипТекущегоЗначения <> ТипЗначенияJSON.НачалоМассива Тогда
		ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Некорректное значение свойства results[].events. Ожидается тип значения Массив; Фактический тип значения: %1.';ru='Некорректное значение свойства results[].events. Ожидается тип значения Массив; Фактический тип значения: %1.'"),
			Строка(ЧтениеОтвета.ТипТекущегоЗначения));
		ВызватьИсключение ТекстИсключения;
	КонецЕсли;
...
Процедура ПроверитьДоступностьСервиса(РезультатОперации)
	...
	ИначеЕсли РезультатПроверки.ИмяОшибки = "ServerError" Тогда
		...
		РезультатОперации.СообщениеОбОшибке =
			НСтр("ka='Сервис временно недоступен.';ru='Сервис временно недоступен.'")
			+ Символы.ПС
	...
	Иначе
		...
		РезультатОперации.СообщениеОбОшибке =
			НСтр("ka='Не удалось подключиться к сервису.';ru='Не удалось подключиться к сервису.'")
			+ Символы.ПС
			+ РезультатПроверки.СообщениеОбОшибке;
		
	КонецЕсли;
	
	РезультатОперации.ИнформацияОбОшибке = НСтр("ka='Не удалось проверить доступность сервиса.';ru='Не удалось проверить доступность сервиса.'")
...
Процедура ПриОшибкеВызоваОперацииСервиса(РезультатЗагрузкиСодержимого, URLОперации, Результат)
	...
	ШапкаИнформацииОбОшибке =
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Ошибка при вызове операции %1 сервиса СПАРК.';ru='Ошибка при вызове операции %1 сервиса СПАРК.'"),
			URLОперации);
	...
	Если ЭтоОбрабатываемыйКодОшибкиСервиса(РезультатЗагрузкиСодержимого.КодСостояния) Тогда
		...
		Исключение
			ПодвалСообщенияЖурналаРегистрации =
				НСтр("ka='Не удалось обработать описание ошибки.';ru='Не удалось обработать описание ошибки.'")
	...
	Если РезультатЗагрузкиСодержимого.КодСостояния = 402 Тогда
		...
		Если ПустаяСтрока(Результат.СообщениеОбОшибке) Тогда
			Результат.СообщениеОбОшибке = НСтр("ka='Требуется оплата сервиса.';ru='Требуется оплата сервиса.'");
		КонецЕсли;
	...
	ИначеЕсли РезультатЗагрузкиСодержимого.КодСостояния = 403 Тогда
		...
		Если ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
			...
			Результат.ВидОшибки = Перечисления.ВидыОшибокСПАРКРиски.ОшибкаАутентификации;
			Результат.СообщениеОбОшибке = НСтр("ka='Ошибка аутентификации в сервисе 1СПАРК Риски.';ru='Ошибка аутентификации в сервисе 1СПАРК Риски.'");
			
		Иначе
			
			Результат.ВидОшибки = Перечисления.ВидыОшибокСПАРКРиски.ИнтернетПоддержкаНеПодключена;
			Если ПустаяСтрока(Результат.СообщениеОбОшибке) Тогда
				Результат.СообщениеОбОшибке = НСтр("ka='Неверный логин или пароль пользователя Интернет-поддержки.';ru='Неверный логин или пароль пользователя Интернет-поддержки.'");
			КонецЕсли;
	...
	ИначеЕсли РезультатЗагрузкиСодержимого.КодСостояния = 404 Тогда
		...
		Если ПустаяСтрока(Результат.СообщениеОбОшибке) Тогда
			Результат.СообщениеОбОшибке = НСтр("ka='Запрошенные данные не найдены.';ru='Запрошенные данные не найдены.'");
		КонецЕсли;
	...
	ИначеЕсли РезультатЗагрузкиСодержимого.КодОшибки = "ConnectError" Тогда
		...
		Результат.СообщениеОбОшибке = НСтр("ka='Не удалось подключиться к сервису.';ru='Не удалось подключиться к сервису.'")
	...
	ИначеЕсли РезультатЗагрузкиСодержимого.КодОшибки = "ClientError" Тогда
		...
		Результат.ВидОшибки = Перечисления.ВидыОшибокСПАРКРиски.ОшибкаПодключения;
		Результат.СообщениеОбОшибке = НСтр("ka='Не удалось получить данные из сервиса СПАРК.';ru='Не удалось получить данные из сервиса СПАРК.'")
			+ Символы.ПС
	...
	ИначеЕсли РезультатЗагрузкиСодержимого.КодОшибки = "ServerError" Тогда
		...
		Результат.СообщениеОбОшибке = НСтр("ka='В сервисе возникли неполадки.';ru='В сервисе возникли неполадки.'")
			+ Символы.ПС
			+ ?(ПустаяСтрока(Результат.СообщениеОбОшибке),
				РезультатЗагрузкиСодержимого.СообщениеОбОшибке,
				Результат.СообщениеОбОшибке);
	...
	Иначе
		...
		Результат.СообщениеОбОшибке = НСтр("ka='Ошибка при получении данных из сервиса 1СПАРК Риски.';ru='Ошибка при получении данных из сервиса 1СПАРК Риски.'")
			+ Символы.ПС + РезультатЗагрузкиСодержимого.СообщениеОбОшибке;
...
"Тело ответа: %3'"),
	...
	Результат.ВидОшибки = Перечисления.ВидыОшибокСПАРКРиски.ВнутренняяОшибкаСервиса;
	Результат.СообщениеОбОшибке = НСтр("ka='Некорректный ответ сервиса.';ru='Некорректный ответ сервиса.'");
...
Функция ЗначениеСвойстваJSON(ЧтениеОбъектаJSON, ЗначениеПоУмолчанию = Неопределено)
	...
	Иначе
		ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Не удалось прочитать значение свойства %1. Некорректный тип значения свойства (%2).';ru='Не удалось прочитать значение свойства %1. Некорректный тип значения свойства (%2).'"),
			ИмяСвойства,
