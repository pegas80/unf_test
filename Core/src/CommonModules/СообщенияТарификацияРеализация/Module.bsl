...
Процедура ОбновитьДанныеАбонентаПоТарификацииВПриложении(Знач ДанныеАбонентаПоТарификации) Экспорт
	...
	ИмяСобытия = ТарификацияСлужебный.ИмяСобытияТарификации() + НСтр("ka='Обновление данных по тарификации в области данных';ru='Обновление данных по тарификации в области данных'");
	...
	Попытка
		...
		Для Каждого ПодпискаНаУслугу Из ДанныеАбонентаПоТарификации.ServiceSubscriptions Цикл
			...
			Иначе
				ШаблонТекстаОшибки = НСтр("ka='Не найдена услуга с идентификатором ""%1"" и идентификатором поставщика ""%2""';ru='Не найдена услуга с идентификатором ""%1"" и идентификатором поставщика ""%2""'");
	...
	Для Каждого Подписка Из УдаляемыеПодписки.SubscriptionsID Цикл
		...
		Исключение
			...
			ИнформацияПоОшибке = НСтр("ru='Проблема с удалением данных по подписке: ';ka='Проблема с удалением данных по подписке: '") + 
				...
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
			ИмяСобытия = ТарификацияСлужебный.ИмяСобытияТарификации() + НСтр("ka='Удаление данных по подписке';ru='Удаление данных по подписке'");
			ЗаписьЖурналаРегистрации(ИмяСобытия,
				УровеньЖурналаРегистрации.Ошибка,
				,
				,
...
Процедура ОбновитьДанныеПоЛицензиям(ОбновляемыеЛицензии) Экспорт
	...
	Исключение
		...
		ИнформацияПоОшибке = ИнформацияОбОшибке();
			ИмяСобытия = ТарификацияСлужебный.ИмяСобытияТарификации() + НСтр("ka='Обновление данных по лицензиям';ru='Обновление данных по лицензиям'");
			ЗаписьЖурналаРегистрации(ИмяСобытия,
				УровеньЖурналаРегистрации.Ошибка,
				,
				,
...
Процедура УдалитьДанныеПоЛицензиям(УдаляемыеЛицензии) Экспорт
	...
	Исключение
		...
		ОтменитьТранзакцию();
		ИнформацияПоОшибке = ИнформацияОбОшибке();
			ИмяСобытия = ТарификацияСлужебный.ИмяСобытияТарификации() + НСтр("ka='Удаление данных по лицензиям';ru='Удаление данных по лицензиям'");
			ЗаписьЖурналаРегистрации(ИмяСобытия,
				УровеньЖурналаРегистрации.Ошибка,
				,
				,
