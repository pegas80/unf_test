...
Процедура ПриВключенииИспользованияПрофилейБезопасности() Экспорт
	...
	ЗаписьЖурналаРегистрации(ПолучениеФайловИзИнтернетаКлиентСервер.СобытиеЖурналаРегистрации(),
		...
		НСтр("ka='უსაფრთხოების პროფილების ჩართვისას პროქსი-სერვერის მოწყობილობები ჩაიყრება სისტემურში';ru='При включении профилей безопасности настройки прокси-сервера сброшены на системные.';en='When the safety profiles of the proxy settings reset to the system.'"));
