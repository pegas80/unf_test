...
Процедура ПриВключенииИспользованияПрофилейБезопасности() Экспорт
	...
	ЗаписьЖурналаРегистрации(ПолучениеФайловИзИнтернетаКлиентСервер.СобытиеЖурналаРегистрации(),
		...
		НСтр("ka='უსაფრთხოების პროფილების ჩართვისას პროქსი-სერვერის მოწყობილობები ჩაიყრება სისტემურში';ru='При включении профилей безопасности настройки прокси-сервера сброшены на системные.'"));
