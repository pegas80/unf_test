...
Процедура ОткрытьФормуПримененныеСкидки(ТекущиеДанные, Объект, Форма) Экспорт
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		СтруктураПараметров.Вставить("Заголовок", НСтр("ka='ფასდაკლების (ფასნამატის) გამოყენება სტრიქონისთვის';ru='Примененные скидки (наценки) для строки';en='Applied discounts (mark-up) for the line'"));
