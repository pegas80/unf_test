...
// удаляет лидирующие нули в номере объекта.
//
Функция НомерНаПечать2(Знач НомерОбъекта, УдалитьПрефиксИнформационнойБазы = Ложь, УдалитьПользовательскийПрефикс = Ложь) Экспорт
...
// Устарела. Следует использовать НомерНаПечать.
Функция ПолучитьНомерНаПечать2(Знач НомерОбъекта, УдалитьПрефиксИнформационнойБазы = Ложь, УдалитьПользовательскийПрефикс = Ложь) Экспорт
	Возврат НомерНаПечать2(НомерОбъекта, УдалитьПрефиксИнформационнойБазы, УдалитьПользовательскийПрефикс);
КонецФункции
