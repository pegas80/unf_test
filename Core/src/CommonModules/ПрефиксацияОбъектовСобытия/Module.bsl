...
Функция РеквизитОрганизацияДоступен(Объект)
	...
	Если   (ОбщегоНазначения.ЭтоСправочник(МетаданныеОбъекта)
		...
		Если РеквизитОрганизация = Неопределено Тогда
			...
			СтрокаСообщения = НСтр("ka='მეტამონაცემთა ობიექტ %1-სთვის არ არის განსაზღვრული რეკვიზიტი სახელით %2.';ru='Для объекта метаданных %1 не определен реквизит с именем %2.'");
