...
Функция ЗапретитьОткрытиеВторогоОкнаДлительнойОперации(
	...
	Если ЭтоОтправка Тогда
		ТекстПредупреждения = НСтр("ka='Отправка не может быть начата.';ru='Отправка не может быть начата.';en='Sending can not be started.'");
	ИначеЕсли ЭтоРасшифровка Тогда
		ТекстПредупреждения = НСтр("ka='Расшифровка не может быть начата.';ru='Расшифровка не может быть начата.';en='Decryption can not be started.'");
	Иначе
		ТекстПредупреждения = НСтр("ka='Обмен не может быть начат.';ru='Обмен не может быть начат.';en='Exchange could not be started.'");
	КонецЕсли;
