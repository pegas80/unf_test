...
Функция ПечатьСогласияНаОбработкуПерсональныхДанных(ПараметрыПечати) Экспорт
	...
	ТекстСообщения = ?(СоставДокументов.Количество() > 1, 
		НСтр("ka='მიმდინარეობს ბეჭდური ფორმების ჩამოყალიბება...';ru='Выполняется формирование печатных форм...'"),
		НСтр("ka='მიმდინარეობს ბეჭდური ფორმის ჩამოყალიბება...';ru='Выполняется формирование печатной формы...'"));
