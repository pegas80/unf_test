...
"%1'"),
			...
			ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:ОблачныйАрхив.Отладка';ru='БИП:ОблачныйАрхив.Отладка'"), // ИмяСобытия
				НСтр("ka='Облачный архив. Отладка. Работа с Windows Script Host';ru='Облачный архив. Отладка. Работа с Windows Script Host'"), // ИдентификаторШага
