...
Функция МенеджерСервисаПоддерживаетУправлениеТарифамиВПриложении_1_0_1_2() Экспорт
	...
	Попытка
		...
		КонецЕсли;
	Исключение
		ИмяСобытия = ИмяСобытияТарификации() + НСтр("ka='МенеджерСервисаПоддерживаетУправлениеТарифамиВПриложении_1_0_1_2';ru='МенеджерСервисаПоддерживаетУправлениеТарифамиВПриложении_1_0_1_2'");
...
Процедура ЗарегистрироватьТарифицируемыеУслуги_ОбработчикОбновления() Экспорт
	...
	ИмяСобытия = ИмяСобытияТарификации() + НСтр("ka='Регистрация тарифицируемых услуг. Обработчик обновления';ru='Регистрация тарифицируемых услуг. Обработчик обновления'");
	...
	Попытка
		...
		ТекстИнформации = НСтр("ka='Услуги успешно отправлены в Менеджер сервиса';ru='Услуги успешно отправлены в Менеджер сервиса'");
		ЗаписьЖурналаРегистрации(ИмяСобытия, 
...
Процедура ЗарегистрироватьТарифицируемыеУслуги_РегламентноеЗадание() Экспорт
	...
	ИмяСобытия = ИмяСобытияТарификации() + НСтр("ka='Регистрация тарифицируемых услуг. Регламентное задание';ru='Регистрация тарифицируемых услуг. Регламентное задание'");
...
Процедура ЗапроситьЛицензииУникальныхУслуг_РегламентноеЗадание() Экспорт
	...
	ИмяСобытия = ИмяСобытияТарификации() + НСтр("ka='Запрос лицензий уникальных услуг. Регламентное задание';ru='Запрос лицензий уникальных услуг. Регламентное задание'");
	...
	Попытка
		...
		ТекстИнформации = НСтр("ka='წარმატება';ru='Успех.'");
		ЗаписьЖурналаРегистрации(ИмяСобытия, 
			УровеньЖурналаРегистрации.Информация,
			,
			,
...
Функция ИмяСобытияТарификации() Экспорт
	...
	Возврат НСтр("ka='Управление тарифами в модели сервиса.';ru='Управление тарифами в модели сервиса.'");
