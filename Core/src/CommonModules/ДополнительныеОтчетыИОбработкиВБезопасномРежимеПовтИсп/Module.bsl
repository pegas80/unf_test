...
Функция Словарь() Экспорт
	...
	Представление = НСтр("ka='მონაცემთა მიღება ინტერნეტის ქსელიდან';ru='Получение данных из сети Интернет'");
	Описание = НСтр("ka='დამატებითი ანგარიშგებისთვის ან დამუშავებისთვის ნებადართული იქნება მონაცემთა მიღება ინტერნეტის ქსელიდან';ru='Дополнительному отчету или обработке будет разрешено получать данные из сети Интернет'");
	
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "Host", НСтр("ka='სერვერ %1-იდან';ru='с сервера %1'"), НСтр("ka='ნებისმიერი სერვერიდან';ru='с любого сервера'"));
	ДобавитьПараметр(Параметры, "Protocol", НСтр("ka='по протоколу %1';ru='по протоколу %1'"), НСтр("ka='по любому протоколу';ru='по любому протоколу'"));
	ДобавитьПараметр(Параметры, "Port", НСтр("ka='через порт %1';ru='через порт %1'"), НСтр("ka='через любой порт';ru='через любой порт'"));
	...
	Представление = НСтр("ka='მონაცემთა გადაცემა ინტერნეტის ქსელში';ru='Передача данных в сеть Интернет'");
	Описание = НСтр("ka='დამატებითი ანგარიშგებისთვის ან დამუშავებისთვის ნებადართული იქნება მონაცემთა გაგზავნა ინტერნეტის ქსელში';ru='Дополнительному отчету или обработке будет разрешено отправлять данные в сеть Интернет'");
...
"выданные разрешения.'");
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "Host", НСтр("ka='через порт %1';ru='через порт %1'"), НСтр("ka='на любой сервера';ru='на любой сервера'"));
	ДобавитьПараметр(Параметры, "Protocol", НСтр("ka='по протоколу %1';ru='по протоколу %1'"), НСтр("ka='по любому протоколу';ru='по любому протоколу'"));
	ДобавитьПараметр(Параметры, "Port", НСтр("ka='через порт %1';ru='через порт %1'"), НСтр("ka='через любой порт';ru='через любой порт'"));
	...
	Представление = НСтр("ka='Обращение к веб-сервисам в сети Интернет';ru='Обращение к веб-сервисам в сети Интернет'");
...
"выданные разрешения.'");
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "WsdlDestination", НСтр("ka='по адресу %1';ru='по адресу %1'"), НСтр("ka='по любому адресу';ru='по любому адресу'"));
...
"выданные разрешения.'");
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "ProgId", НСтр("ka='с программным идентификатором %1';ru='с программным идентификатором %1'"), НСтр("ka='с любым программным идентификатором';ru='с любым программным идентификатором'"));
	...
	Представление = НСтр("ka='Создание объекта внешней компоненту';ru='Создание объекта внешней компоненту'");
...
"компоненты), накладываемые на выданные разрешения.'");
	...
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "TemplateName", НСтр("ka='из макета %1';ru='из макета %1'"), НСтр("ka='из любого макета';ru='из любого макета'"));
	...
	Представление = НСтр("ka='Получение файлов из внешнего объекта';ru='Получение файлов из внешнего объекта'");
	Описание = НСтр("ka='დამატებითი ანგარიშგებისთვის ან დამუშავებისთვის ნებადართული იქნება ფაილების მიღება გარე პროგრამული უზრუნველყოფიდან (მაგალითად, COM-შეერთების ან გარე კომპონენტის დახმარებით)';ru='Дополнительному отчету или обработке будет разрешено получать файлы из внешнего программного обеспечения (например, с помощью COM-соединения или внешней компоненты)'");
	...
	Представление = НСтр("ka='Передача файлов во внешний объект';ru='Передача файлов во внешний объект'");
	...
	Представление = НСтр("ka='დოკუმენტების გატარება';ru='Проведение документов'");
	Описание = НСтр("ka='დამატებითი ანგარიშგებისთვის ან დამუშავებისთვის ნებადართული იქნება დოკუმენტების გატარებულობის მდგომარეობის შეცვლა';ru='Дополнительному отчету или обработке будет разрешено изменять состояние проведенности документов'");
	
	Параметры = ТаблицаПараметров();
	ДобавитьПараметр(Параметры, "DocumentType", НСтр("ka='დოკუმენტები %1 ტიპით';ru='документы с типом %1'"), НСтр("ka='ნებისმიერი დოკუმენტები';ru='любые документы'"));
	ДобавитьПараметр(Параметры, "Action", НСтр("ka='разрешенное действие: %1';ru='разрешенное действие: %1'"), НСтр("ka='любое изменение состояния проведения';ru='любое изменение состояния проведения'"));
