...
Функция ПолучитьИмяДокументаПоТипу(ТипДокумента) Экспорт
	...
	//Паганини_
	СтруктураТипов.Вставить(Тип("ДокументСсылка.ВнутреннийЗаказ"), "ВнутреннийЗаказ");
	//_Паганини
	СтруктураТипов.Вставить(Тип("ДокументСсылка.ОдноразовыеНачисления"), "ОдноразовыеНачисления");// Kuzmich, 17.06.2020, Документ ОдноразовыеНачисления
