...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='Выполняет изменение наименований бухгалтерских регламентированных отчетов.';ru='Выполняет изменение наименований бухгалтерских регламентированных отчетов.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='Выполняет изменение представлений отчетного периода.';ru='Выполняет изменение представлений отчетного периода.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='Выполняет изменение наименований деклараций по алкоголю.';ru='Выполняет изменение наименований деклараций по алкоголю.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='Выполняет изменение наименований реестров по НДС.';ru='Выполняет изменение наименований реестров по НДС.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='Выполняет заполнение индекса картинки регламентированных отчетов.';ru='Выполняет заполнение индекса картинки регламентированных отчетов.'");
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='Выполняет изменение реквизитов отправки справок о рублевых и валютных счетах.';ru='Выполняет изменение реквизитов отправки справок о рублевых и валютных счетах.'");
