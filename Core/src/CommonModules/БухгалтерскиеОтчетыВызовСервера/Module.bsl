...
Функция ПолучитьПараметрыРасшифровкиОтчета(Адрес, ИдентификаторОбъекта, Расшифровка) Экспорт
	...
	Если ИдентификаторОбъекта = "АнализСубконто"
		...
		ПредставлениеДляКарточкиСчета         = НСтр("ka='Карточка счета %Счет%';ru='Карточка счета %Счет%';en='Card account% account%'");
		...
		ПредставлениеДляКарточкиСубконто      = НСтр("ka='Карточка субконто';ru='Карточка субконто';en='card subkonto'");
