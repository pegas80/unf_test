...
Процедура ОповеститьОтложенныеОбработчикиНеВыполнены() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("ka='პროგრამაში მუშაობა დროებით შეზღუდულია';ru='Работа в программе временно ограничена'"),
		НавигационнаяСсылкаОбработки(),
		НСтр("ka='ახალ ვერსიაზე გადასვლა არ დასრულებულა';ru='Не завершен переход на новую версию'"),
