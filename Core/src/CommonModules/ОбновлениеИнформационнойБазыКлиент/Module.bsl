...
Процедура ОповеститьОтложенныеОбработчикиНеВыполнены() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("ka='პროგრამაში მუშაობა დროებით შეზღუდულია';ru='Работа в программе временно ограничена';en='The work program is temporarily limited'"),
		НавигационнаяСсылкаОбработки(),
		НСтр("ka='ახალ ვერსიაზე გადასვლა არ დასრულებულა';ru='Не завершен переход на новую версию';en='Not completed the transition to the new version'"),
