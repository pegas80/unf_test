...
"ВыгрузкаЗагрузкаСовместноРазделенныхДанных.ЗаполнитьКэшСовместноРазделенныхОбъектов()';ka='Объект метаданных %1 не может быть обработчиком ВыгрузкаСовместноРазделенныхДанных.ПередВыгрузкойОбъекта(),"
"т.к. отсутствует в кэше совместно-разделенных объектов."
"Если после редактирования структуры метаданных конфигурации кэш не обновлялся - необходимо выполнять"
"обновление кэша совместно-разделенных объектов с помощью вызова метода"
...
"Если после редактирования структуры метаданных конфигурации кэш не обновлялся - необходимо выполнять"
"обновление кэша совместно-разделенных объектов с помощью вызова метода"
"ВыгрузкаЗагрузкаСовместноРазделенныхДанных.ЗаполнитьКэшСовместноРазделенныхОбъектов()';ka='Объект метаданных %1 не может быть обработчиком ВыгрузкаСовместноРазделенныхДанных.ПередЗагрузкойОбъекта(),"
"т.к. отсутствует в кэше совместно-разделенных объектов."
"Если после редактирования структуры метаданных конфигурации кэш не обновлялся - необходимо выполнять"
"обновление кэша совместно-разделенных объектов с помощью вызова метода"
"ВыгрузкаЗагрузкаСовместноРазделенныхДанных.ЗаполнитьКэшСовместноРазделенныхОбъектов()'", Метаданные.ОсновнойЯзык.КодЯзыка),
