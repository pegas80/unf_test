...
"т.к. он помечен на удаление.';ka='ფაილ ""%1""-ის დაკავება შეუძლებელია, ვინაიდან იგი წასაშლელად არის მონიშნული.'"),
...
"""%2"" с %3.';ka='ფაილი ""%1"" რედაქტირებისთვის უკვე დაკავებულია მომხმარებელ ""%2""-ის მიერ %3-დან.'"),
			Строка(ДанныеФайла.Ссылка),
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ka='ფაილები';ru='Файлы';en='files'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
