...
Процедура УстановитьПараметрыЗадания(Задание, Использование, Параметры, Расписание) Экспорт
	...
	Если Не Константы.РазрешитьВыполнениеДОИОРегламентнымиЗаданиямиВМоделиСервиса.Получить() Тогда
		ВызватьИсключение НСтр("ka='დავალებების სახით დამატებითი დამუშავების ბრძანებების პერიოდული შესრულება სერვისის ადმინისტრაციის მიერ აკრძალულია!';ru='Периодическое выполнение команд дополнительных обработок в качестве заданий запрещено администрацией сервиса!'");
	КонецЕсли;
