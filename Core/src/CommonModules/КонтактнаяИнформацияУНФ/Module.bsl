	...
	Для Каждого ДанныеКИ Из Форма.КонтактнаяИнформация Цикл
		...
		Если ДанныеКИ.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
			...
			ДобавитьКомандуКонтекстногоМеню(Форма,
				...
				НСтр("ka='მისამართი იანდექს.რუკებზე';ru='Адрес на Яндекс.Картах'"),
				НСтр("ka='იანდექს-რუკების რუკებზე აჩვენებს მისამართს';ru='Показывает адрес на картах Яндекс.Карты'"),
				ПолеПредставление
			);
			ДобавитьКомандуКонтекстногоМеню(Форма,
				"КонтекстноеМенюКартаGoogle_" + ИндексКИ,
				БиблиотекаКартинок.GoogleMaps,
				НСтр("ka='მისამართი Google Maps-ზე';ru='Адрес на Google Maps'"),
				НСтр("ka='მისამართს აჩვენებს Google Maps-ის რუკაზე';ru='Показывает адрес на карте Google Maps'"),
				ПолеПредставление
			);
...
Процедура ИнициализироватьФорму(Форма)
	...
	ГруппаЗначенийКИ.Заголовок = НСтр("ka='Значения контактной информации';ru='Значения контактной информации'");
	...
	Команда.Заголовок = НСтр("ka=' + ტელეფონი, მისამართი';ru='+ телефон, адрес'");
