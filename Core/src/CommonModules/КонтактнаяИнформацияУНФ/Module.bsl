	...
	Для Каждого ДанныеКИ Из Форма.КонтактнаяИнформация Цикл
		...
		Если ДанныеКИ.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
			...
			ДобавитьКомандуКонтекстногоМеню(Форма,
				...
				НСтр("ka='მისამართი იანდექს.რუკებზე';ru='Адрес на Яндекс.Картах';en='Address On Yandex.Maps'"),
				НСтр("ka='იანდექს-რუკების რუკებზე აჩვენებს მისამართს';ru='Показывает адрес на картах Яндекс.Карты';en='Shows the address On Yandex.Maps cards'"),
				ПолеПредставление
			);
			ДобавитьКомандуКонтекстногоМеню(Форма,
				"КонтекстноеМенюКартаGoogle_" + ИндексКИ,
				БиблиотекаКартинок.GoogleMaps,
				НСтр("ka='მისამართი Google Maps-ზე';ru='Адрес на Google Maps';en='Address on Google Maps'"),
				НСтр("ka='მისამართს აჩვენებს Google Maps-ის რუკაზე';ru='Показывает адрес на карте Google Maps';en='Shows the address on Google Maps'"),
				ПолеПредставление
			);
...
Процедура ИнициализироватьФорму(Форма)
	...
	ГруппаЗначенийКИ.Заголовок = НСтр("ka='Значения контактной информации';ru='Значения контактной информации';en='The values ​​of contact information'");
	...
	Команда.Заголовок = НСтр("ka=' + ტელეფონი, მისამართი';ru='+ телефон, адрес';en='+ Phone, address'");
