...
Процедура СписокОперацийВидаЭД(ВидЭД,СписокСпособовОбработки) Экспорт 
	...
	Если ВидЭД = Перечисления.ВидыЭД.АктИсполнитель Тогда
		...
		СписокСпособовОбработки.Добавить("ПриходнаяНакладная", НСтр("ka='შემოსავლის ზედდებული';ru='Приходная накладная'"), Истина);
	...
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель Тогда
		...
		СписокСпособовОбработки.Добавить("КорректировкаПоступления", НСтр("ka='შემოსვლის კორექტირება';ru='Корректировка поступления'"), Истина);
	...
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.КаталогТоваров Тогда
		...
		СписокСпособовОбработки.Добавить("НоменклатураПоставщиков", НСтр("ka='მომწოდებლების ნომენკლატურა';ru='Номенклатура поставщиков'"), Истина);
		
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.ПрайсЛист Тогда
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.ОтветНаЗаказ Тогда
		
		СписокСпособовОбработки.Добавить("ЗаказПоставщику", НСтр("ka='შეკვეთა მომწოდებელს';ru='Заказ поставщику'"), Истина);
	...
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.ЗаказТовара Тогда
		...
		СписокСпособовОбработки.Добавить("ЗаказПокупателя", НСтр("ka='მყიდველის შეკვეთა';ru='Заказ покупателя'"),Истина);
		
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.КорректировочныйСчетФактура Тогда
		
		СписокСпособовОбработки.Добавить("СчетФактураПолученный", НСтр("ka='ანგარიშ-ფაქტურა (მიღებული)';ru='Счет-фактура (полученный)'"),Истина);
	...
	ИначеЕсли ВидЭД = Перечисления.ВидыЭД.СчетНаОплату Тогда
		...
		СписокСпособовОбработки.Добавить("СчетНаОплатуПоставщика", НСтр("ka='გადახდის მოთხოვნა (მიღებული)';ru='Счет на оплату (полученный)'"), Истина);
...
Процедура СоответствиеИсходящихВидовЭДДокументамИБ(СоответствиеВидовЭДДокументамИБ) Экспорт 
	...
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.ТОРГ12Продавец,         НСтр("ka='საქონლის რეალიზაცია';ru='Реализация товаров'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.АктИсполнитель,         НСтр("ka='მომსახურების რეალიზაცია';ru='Реализация услуг'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.АктНаПередачуПрав,      НСтр("ka='აქტი უფლებების გადასაცემად';ru='Акт на передачу прав'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.СчетФактура,            НСтр("ka='Счет-фактура';ru='Счет-фактура'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель, НСтр("ka='რეალიზაციის კორექტირება';ru='Корректировка реализации'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.КорректировочныйСчетФактура, НСтр("ka='ანგარიშ-ფაქტურა (კორეატირება)';ru='Счет-фактура (корректировка)'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.КаталогТоваров,         НСтр("ka='Справочник Настройка ЭДО';ru='Справочник Настройка ЭДО'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.ОтветНаЗаказ,           НСтр("ka='შეკვეთა მომწოდებელს';ru='Заказ поставщику'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.ЗаказТовара,            НСтр("ka='მყიდველის შეკვეთა';ru='Заказ покупателя'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.ПрайсЛист,              НСтр("ka='Справочник Настройка ЭДО';ru='Справочник Настройка ЭДО'"));
	СоответствиеВидовЭДДокументамИБ.Вставить(Перечисления.ВидыЭД.СчетНаОплату,           НСтр("ka='გადახდის მოთხოვნა';ru='Счет на оплату'"));
...
Процедура ЗаполнитьДанныеПоАктуНаПередачуПрав(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных) Экспорт
	...
	Если СсылкаНаОбъект.ВидОперации <> Перечисления.ВидыОперацийРасходнаяНакладная.ПродажаПокупателю
		...
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='ოპერაციის სახეობა ""%1""-ისთვის ელექტრონული დოკუმენტის შექმნა არ შეიძლება!';ru='Нельзя создать электронный документ для вида операции ""%1""!'"), СсылкаНаОбъект.ВидОперации);
...
Процедура ЗаполнитьДанныеДляУПДИнформацияПродавцаФНС(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных) Экспорт
	...
	Если Не ЗначениеЗаполнено(СчетФактура) Тогда
		ТекстСообщения = НСтр("ka='უნივერსალური გადასაცემი დოკუმენტის ჩამოსაყალიბებლად ანგარიშფაქტურა შევსებული უნდა იყოს.';ru='Для формирования универсального передаточного документа счет-фактура должна быть заполнена.'");
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
	...
	Если ДанныеДляФормированияЭД.РеквизитыШапки.ВидОперации <> Перечисления.ВидыОперацийСчетФактура.Продажа
		...
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='ოპერაციის ტიპ ""%1""-ით ანგარიშფაქტურისთვის ელექტრონული დოკუმენტის შექმნა არ შეიძლება!';ru='Нельзя создать электронный документ для СФ с видом операции ""%1""!'"), ДанныеДляФормированияЭД.РеквизитыШапки.ВидОперации);
...
Процедура ЗаполнитьДанныеДляДОПИнформацияПродавцаФНС(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных) Экспорт
	...
	Если ЕстьТовары Тогда
		СоставСодержания.Добавить(НСтр("ka='საქონელი გადაცემულია.';ru='Товары переданы.'"));
	КонецЕсли;
	Если ЕстьУслуги Тогда
		СоставСодержания.Добавить(НСтр("ka='მომსახურებები გაწეულია სრული მოცულობით.';ru='Услуги оказаны в полном объеме.'"));
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДанныеШапки.ДатаДоговора)
		...
		НоваяСтрока.ДокументНаименование = НСтр("ka='ხელშეკრულება';ru='Договор'");
...
Процедура ЗаполнитьДанныеДляУПДИнформацииПокупателяФНС(СсылкаНаЭД, СтруктураЭД, ДеревоДанных) Экспорт
	...
	СоставСодержания = Новый Массив;
	Если ЕстьТовары Тогда
		СоставСодержания.Добавить(НСтр("ka='საქონელი მივიღე პრეტენზიის გარეშე.';ru='Товары принял без претензий.'"));
	КонецЕсли;
	Если ЕстьУслуги Тогда
		СоставСодержания.Добавить(НСтр("ka='მომსახურებები მიღებულია, პრეტენზია არ არის.';ru='Услуги получены, претензий нет.'"));
	КонецЕсли;
...
Процедура ЗаполнитьДанныеДляУКДИнформацияПродавцаФНС(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных) Экспорт
	...
	Если Не ЗначениеЗаполнено(СчетФактура) Тогда
		ТекстСообщения = НСтр("ka='უნივერსალური საკორექტირებო დოკუმენტის ჩამოსაყალიბებლად ანგარიშფაქტურა შევსებული უნდა იყოს.';ru='Для формирования универсального корректировочного документа счет-фактура должна быть заполнена.'");
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ЗаполнитьДанныеДляДИСИнформацияПродавцаФНС(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных) Экспорт
	...
	Иначе
		НоваяСтрока = ОснованиеКорректировки.Добавить();
		НоваяСтрока.ДокументНаименование = НСтр("ka='Отсутствует';ru='Отсутствует'");
	КонецЕсли;
	...
	Для Каждого Основание ИЗ ДанныеШапки.ТаблицаРеквизитовОснований Цикл
		Если Основание.УчитыватьИсправлениеИсходногоДокумента Тогда
			ОписаниеОснования = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									НСтр("ka='%2-ის # %1, %4-ის # %3 შესწორების გათვალისწინებით';ru='№ %1 от %2, с учетом исправления № %3 от %4'"),
	...
	Если МассивОснований.Количество() > 0 Тогда
		...
		ОписаниеОснований = НСтр("ka='უნივერსალური გადასაცემი დოკუმენტი';ru='Универсальный передаточный документ'") + " " + ОписаниеОснований;
...
Процедура ЗаполнитьДанныеДляУКДИнформацииПокупателяФНС(СсылкаНаЭД, СтруктураЭД, ДеревоДанных) Экспорт
	...
	ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(ДеревоДанных, "СодержаниеОперации", НСтр("ka='ღირებულების შეცვლას ვეთანხმები.';ru='С изменением стоимости согласенй.'"));
...
Процедура ЗаполнитьДанныеПоАкт501ИсполнительФНС(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных) Экспорт
	...
	Если ТабличнаяЧасть.Количество() = 0 Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='დოკუმენტი არ შეიცავს მონაცემებს ედ-ის ჩამოსაყალიბებლად ""%1""';ru='Документ не содержит данных для формирования ЭД ""%1""'"),
			СтруктураЭД.ВидЭД);
	...
	Для Каждого Строка Из ТабличнаяЧасть Цикл
		...
		Если НЕ ЗначениеЗаполнено(Строка.Номенклатура) Тогда
			ТекстСообщения = НСтр("ka='ცხრილ %2-ის სტრიქონ %1-ში ნომენკლატურა არ არის შევსებული. ელექტრონული დოკუმენტის გადასაცემად ნომენკლატურის შევსება სავალდებულოა.';ru='В строке %1 табличной части %2 не заполнена номенклатура. Для передачи электронного документа заполнение номенклатуры обязательно.'");
...
Процедура ПодготовитьДанныеПоЗаказуТоваров(СсылкаНаОбъект, СтруктураЭД, СтруктураПараметров) Экспорт
		...
		Если Выборка.Ид = Неопределено Тогда
			...
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ka='ნომენკლატურა ""%1""-ის შეპირისპირება მომწოდებლის ნომენკლატურასთან ვერ მოხერხდა';ru='Не удалось сопоставить номенклатуру ""%1"" с номенклатурой поставщика'"),
	...
	Если НеУдалосьСопоставитьНоменклатуру Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='ელექტრონული დოკუმენტის შედგენა გაუქმებულია.';ru='Формирование электронного документа отменено.'"));
	...
	ИтоговаяСтрока = НСтр("ka='სულ არის %Количество% დასახელების %Сумма%-ის ოდენობის';ru='Всего наименований %Количество%, на сумму %Сумма%'");
...
Функция ЗаполнитьРеквизитыКонтрагента(СтруктураРеквизитов) Экспорт
	...
	Попытка
		...
		Если СсылкаНового <> Неопределено Тогда
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='ახალი კონტრაგენტი ""%1"" წარმატებით შეიქმნა.';ru='Новый контрагент ""%1"" был успешно создан.'"),
				Контрагент.Наименование);
		Иначе
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='კონტრაგენტ ""%1""-ის მონაცემები გადავსებულია.';ru='Данные контрагента ""%1"" перезаполнены.'"),
				Контрагент.Наименование);
		КонецЕсли;
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ka='კონტრაგენტის რეკვიზიტების ჩატვირთვა';ru='Загрузка реквизитов контрагента'"), УровеньЖурналаРегистрации.Ошибка,,ТекстОшибки,ТекстСообщения);
...
Функция СформироватьТекстНДСЭтапаОплаты(СоответствиеСтавокНДС, ПроцентПлатежа) Экспорт
	...
	Если СоответствиеСтавокНДС.Количество() > 0 Тогда
		...
		Для Каждого ТекСтавкаНДС Из СоответствиеСтавокНДС Цикл
			...
			Если ТекСтавкаНДС.Значение <> 0 Тогда
				...
				ТекстНДС = ТекстНДС + ?(ПустаяСтрока(ТекстНДС), НСтр("ka='დღგ (%СтавкаНДС%) %СуммаНДС%';ru='НДС(%СтавкаНДС%) %СуммаНДС%'"), НСтр("ka=', დღგ(%СтавкаНДС%) %СуммаНДС%';ru=', НДС(%СтавкаНДС%) %СуммаНДС%'"));
	...
	Иначе
		ТекстНДС = НСтр("ka='გადასახადის (დღგ) გარეშე';ru='Без налога (НДС)'");
	КонецЕсли;
...
Функция ТекстНДСПоСтавке(СтавкаНДС, ЦенаВключаетНДС) Экспорт
	...
	ТекстНДСПоСтавке = ?(ЦенаВключаетНДС, НСтр("ka='მ.შ. დღგ (%დღგგანაკვეთი%):';ru='В т.ч. НДС (%СтавкаНДС%):'"), НСтр("ka='დღგ (%СтавкаНДС%):';ru='НДС (%СтавкаНДС%):'"));
...
Процедура НазначенСтатусУтвержден(ЭлектронныйДокумент) Экспорт
	...
	Исключение
		ТекстСообщения = КраткоеПредставлениеОшибки(ИнформацияОбОшибке()) + НСтр("ka='(დაწვრილებით, იხ. რეგისტრაციის ჟურნალში).';ru=' (подробности см. в Журнале регистрации).'");
		ТекстОшибки = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		ЗаписьЖурналаРегистрации(НСтр("ka='ედ-ის დამტკიცება';ru='утверждение ЭД'"), УровеньЖурналаРегистрации.Ошибка,,ТекстОшибки,ТекстСообщения);
	КонецПопытки;
...
Процедура ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, СтруктураЭД, ДеревоДокумента) Экспорт
	...
	ШаблонСтроки =	НСтр("ka='სულ არის %2 ოდენობის %1 დასახელება';ru='Всего наименований %1, на сумму %2'");
