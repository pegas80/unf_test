...
Процедура ЗагрузитьКлассификаторБанковРФ() Экспорт
	...
	Если Дескрипторы.Descriptor.Количество() < 1 Тогда
		ВызватьИсключение(НСтр("ka='სერვისის მენეჯერში არ არის ტიპ ""ბანკები""-ს მონაცემები';ru='В менеджере сервиса отсутствуют данные вида ""БанкиРФ""';en='The service manager is no data type ""BankiRF""'"));
	КонецЕсли;
