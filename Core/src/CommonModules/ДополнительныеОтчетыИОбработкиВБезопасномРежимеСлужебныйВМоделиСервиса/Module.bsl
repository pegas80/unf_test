	...
	Если ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		...
		Иначе
			...
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='გაშვების გასაღებ %1-ისთვის მოსაწოდებელი დამუშავება არ არის აღმოჩენილი!';ru='Не обнаружена поставляемая обработка для ключа запуска %1!';en='delivered treatment is not found to run the% 1 key!'"),
				Строка(КлючСессии));
