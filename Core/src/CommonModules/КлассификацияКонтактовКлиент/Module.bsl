...
Процедура ТегВыбранДляУстановки(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	...
	Если ПараметрыПредмета = Неопределено Тогда
		ПараметрыПредмета = НСтр("ka='объекту,объектам,объектам';ru='объекту,объектам,объектам';en='an object lens,'");
	КонецЕсли;
	
	ПоказатьОповещениеПользователя(
		НСтр("ka='თეგის მიმაგრება';ru='Прикрепление тега';en='Attaching the tag'"),
		,
		СтрШаблон(НСтр("ru='Тег ""%1"""
"прикреплен к %2';ka='Тег ""%1"""
