...
"დოკუმენტი %1."
"დოკუმენტში არ არის საქონელი ოპცია <საგარანტიო ტალონის გამოწერა>-თი';ru='__________________"
"Документ %1."
"В документе нет товаров с опцией <Выписывать гарантийный талон>'");
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = НСтр("ru = 'Гарантийный талон № '; ka = 'საგარანტიო ფურცელი № '" )
		+ НомерДокумента
		+  НСтр("ru = ' от '; ka = '  '" )
		+ Формат(Шапка.ДатаДокумента, "Л=ka_GE; ДФ=yyyy-MM-dd; ДЛФ=DD")+  НСтр("ka = ' - დან'" );
...
"В документе нет товаров с опцией <Выписывать гарантийный талон>'");
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = НСтр("ka='საგარანტიო ტალონი';ru='Гарантийный талон';en='warranty card'")+" № "+НомерДокумента+НСтр("ka=' от';ru=' от'")+" ___________________";
