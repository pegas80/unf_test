...
Функция СоздатьАдминистратора(ПользовательИБ = Неопределено) Экспорт
	...
	Если Не ОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
		ВызватьИсключение НСтр("ka='ცნობარი ""მომხმარებელი"" განუცალკევებელ რეჟიმში მიუწვდომელია.';ru='Справочник Пользователи недоступен в неразделенном режиме.';en='Directory of Members is not available in undivided mode.'");
	КонецЕсли;
	...
	Если ПользовательИБ = Неопределено Тогда
		...
		Если ПользователиИБ.Количество() = 0 Тогда
			Если ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
				ВызватьИсключение
					НСтр("ka='მონაცემთა არეალის პირველი ადმინისტრატორის ავტომატურად შექმნა შეუძლებელია.';ru='Невозможно автоматически создать первого администратора области данных.';en='Unable to automatically create the first administrator of the data area.'");
			КонецЕсли;
...
"Требуется назначить роль Полные права хотя бы одному пользователю.';ka='საინფორმაციო ბაზის მომხმარებლების სია არ არის ცარიელი, თუმცა როლ ""სრული უფლებები""-თ ვერცერთი მომხმარებელი ვერ მოძებნა."
""
"სავარაუდოდ, მომხმარებლები შეიქმნა კონფიგურატორში."
"საჭიროა თუნდ ერთი მომხმარებლისთვის როლ ""სრული უფლებები""-ს დანიშვნა.'");
			Иначе
				ТекстОшибки =
...
""
"Вероятно, пользователи создавались в конфигураторе."
"Требуется назначить роли Полные права и Администратор системы хотя бы одному пользователю.';ka='საინფორმაციო ბაზის მომხმარებლების სია არ არის ცარიელი, თუმცა, როლ ""სრული უფლებები""-ს და ""სისტემის ადმინისტრატორი""-ს მქონე ვერცერთი მომხმარებელი ვერ მოიძებნა."
""
"სავარაუდოდ, მომხმარებლები შეიქმნა კონფიგურატორში."
"საჭიროა, თუნდ ერთი მომხმარებლისთვის როლ ""სრული უფლებები""-ს და ""სისტემის ადმინისტრატორი""-ს დანიშვნა.'");
			КонецЕсли;
...
"создания пользователя в справочнике требуется назначить ему роль Полные права.';ka='საინფორმაციო ბაზა ""%1""-ის მომხმარებლის ცნობარში მომხმარებლის შექმნა შეუძლებელია, ვინაიდან მას არ აქვს როლი ""სრული უფლებები""."
""
"სავარაუდოდ, მომხმარებელი შეიქმნა კონფიგურატორში. ცნობარში მომხმარებლის ავტომატურად შესაქმნელად, საჭიროა მისთვის როლ ""სრული უფლებები""-ს დანიშვნა.'");
			Иначе
				ТекстОшибки =
					НСтр("ru='Невозможно создать пользователя в справочнике для пользователя"
"информационной базы ""%1"","
...
"назначить ему роли Полные права и Администратор системы.';ka='საინფორმაციო ბაზა ""%1""-ის მომხმარებლის ცნობარში მომხმარებლის შექმნა შეუძლებელია, ვინაიდან მას არ გააჩნია როლი ""სრული უფლებები"" და ""სისტემის ადმინისტრატორი""."
""
"სავარაუდოდ, მომხმარებელი შეიქმნა კონფიგურატორში."
"ცნობარში მომხმარებლის ავტომატურად შესაქმნელად, საჭიროა მისთვის შემდეგი როლების დანიშვნა: ""სრული უფლებები"" და ""სისტემის ადმინისტრატორი"".'");
			КонецЕсли;
	...
	Пользователь.ДополнительныеСвойства.Вставить("СозданиеАдминистратора",
		?(ПользовательИБ = Неопределено,
		  НСтр("ka='პირველი ადმინისტრატორის შექმნა შესრულებულია.';ru='Выполнено создание первого администратора.';en='Achieved creation of the first administrator.'"),
		  ?(ПользовательСоздан,
		    НСтр("ka='ადმინისტრატორი შეპირისპირებულია ცნობარის ახალ მომხმარებელთან.';ru='Администратор сопоставлен с новым пользователем справочника.';en='The administrator is associated with the new directory user.'"),
		    НСтр("ka='ადმინისტრატორი შედარებულია ცნობარის არსებულ მომხმარებელთან.';ru='Администратор сопоставлен с существующим пользователем справочника.';en='The administrator is associated with an existing user directory.'")) ) );
...
Функция ПолноеИмяНеуказанногоПользователя() Экспорт
	...
	Возврат НСтр("ka='<მითითებული არ არის>';ru='<Не указан>';en='<Not Set>'");
...
Функция ПрочитатьПользователяИБ(Знач Идентификатор,
	...
	Если ПользовательИБ = Неопределено Тогда
		ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Пользователь информационной базы ""%1"" не найден.';ru='Пользователь информационной базы ""%1"" не найден.';en='The user information database ""%1"" not found.'"),
			Идентификатор);
		Возврат Ложь;
	КонецЕсли;
...
"%1,"
"так как он уже существует.';ka='საინფორმაციო ბაზა %1-ის მომხმარებლის შექმნა შეუძლებელია, ვინაიდან, იგი უკვე არსებობს.'"),
			СтарыеСвойства.Имя,
...
"%1,"
"старый пароль указан не верно.';ka='При записи пользователя информационной базы"
"%1,"
...
"%1 произошла ошибка:"
""
"""%2"".';ka='При записи пользователя информационной базы"
"%1 произошла ошибка:"
""
"""%2"".'"),
			ПользовательИБ.Имя,
...
"%1 произошла ошибка:"
""
"""%2"".';ka='საინფორმაციო ბაზის მომხმარებლის %1 წაშლისას შეცდომა მოხდა:"
""
"""%2"".'"),
				ПользовательИБ.Имя,
...
"Имя (для входа): ""%1"""
"превышает длину 64 символа.';ka='საინფორმაციო ბაზის მომხმარებლის ჩაწერის შეცდომა"
"სახელი (შესასვლელად): ""%1"""
"აღემატება 64 სიმბოლოს სიგრძეს.'"),
								ЗначениеСвойства);
						...
						ИначеЕсли СтрНайти(ЗначениеСвойства, ":") > 0 Тогда
							ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
								НСтр("ru='Ошибка записи пользователя информационной базы"
"Имя (для входа): ""%1"""
"содержит запрещенный символ "":"".';ka='საინფორმაციო ბაზის მომხმარებლის ცაწერის შეცდომა"
"სახელი (შესასვლელად): ""%1"""
"შეიცავს აკრძალულ სიმბოლოს "":"".'"),
								ЗначениеСвойства);
						КонецЕсли;
					КонецЕсли;
...
Процедура НайтиНеоднозначныхПользователейИБ(Знач Пользователь,
	...
	ОписаниеОшибки = НСтр("ka='შეცდომა მონაცემთა ბაზაში:';ru='Ошибка в базе данных:';en='The error in the database:'") + Символы.ПС;
		...
		Если Строка.НеоднозначныйИдентификатор <> ТекущийНеоднозначныйИдентификатор Тогда
			...
			Иначе
				...
				Если ТекущийПользовательИБ = Неопределено Тогда
					ИмяДляВхода = НСтр("ka='<ვერ მოიძებნა>';ru='<не найден>';en='<Not found>'");
				Иначе
...
"соответствует более одного элемента в справочнике Пользователи:';ka='იდენტიფიკატორ ""%1""-ით სერვისის მომხმარებელს ერთ ელემენტზე მეტი შეესაბამება ცნობარ ""მომხმარებლები""-ში:'"),
						ТекущийНеоднозначныйИдентификатор);
				Иначе
					ОписаниеОшибки = ОписаниеОшибки + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Пользователю ИБ ""%1"" с идентификатором ""%2"""
"соответствует более одного элемента в справочнике Пользователи:';ka='იდენტიფიკატორ ""%2""-ის მქონე სბ-ის მომხმარებელ ""%1""-ს ცნობარ მომხმარებლებში ერთ ელემენტზე მეტი შეესაბამება:'"),
						ИмяДляВхода,
						ТекущийНеоднозначныйИдентификатор);
				КонецЕсли;
			КонецЕсли;
		...
		Иначе
			...
			ОписаниеОшибки = ОписаниеОшибки + Символы.ПС + "	"
				+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ka='""%1"" ბმულის იდენტიფიკატორით %2';ru='""%1"" с идентификатором ссылки %2';en='""%1"" identifier links 2%'"),
					Строка.Пользователь,
...
Функция ОписаниеОшибкиПриЗаписиПользователяИБ(ШаблонОшибки,
	...
	Если ЗаписатьВЖурнал Тогда
		ЗаписьЖурналаРегистрации(
			НСтр("ka='მომხმარებლები. საინფორმაციო ბაზის მომხმარებლის ჩაწერის შეცდომა';ru='Пользователи.Ошибка записи пользователя ИБ';en='Polzovateli.Oshibka recording IB user'",
			...
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонОшибки,
				"""" + ИмяДляВхода + """ (" + ?(ЗначениеЗаполнено(ИдентификаторПользователяИБ),
					НСтр("ka='Новый';ru='Новый';en='Новый'"), Строка(ИдентификаторПользователяИБ)) + ")",
