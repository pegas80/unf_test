...
Функция ОписаниеОшибкиОтправки(КодОшибки)
	...
	ОписанияОшибок.Вставить(1, НСтр("ka='Ошибка в параметрах.';ru='Ошибка в параметрах.'"));
	ОписанияОшибок.Вставить(2, НСтр("ka='არასწორი ლოგ-ინი ან პაროლი.';ru='Неверный логин или пароль.'"));
	ОписанияОшибок.Вставить(3, НСтр("ka='Недостаточно средств на счете.';ru='Недостаточно средств на счете.'"));
	ОписанияОшибок.Вставить(4, НСтр("ka='IP-адрес временно заблокирован из-за частых ошибок в запросах.Подробнее см. http://smsc.ru/faq/99';ru='IP-адрес временно заблокирован из-за частых ошибок в запросах.Подробнее см. http://smsc.ru/faq/99'"));
	ОписанияОшибок.Вставить(5, НСтр("ka='Неверный формат даты.';ru='Неверный формат даты.'"));
	ОписанияОшибок.Вставить(6, НСтр("ka='Сообщение запрещено (по тексту или по имени отправителя).';ru='Сообщение запрещено (по тексту или по имени отправителя).'"));
	ОписанияОшибок.Вставить(7, НСтр("ka='ტელეფონის ნომრის არასწორი ფორმატი.';ru='Неверный формат номера телефона.'"));
	ОписанияОшибок.Вставить(8, НСтр("ka='Сообщение на указанный номер не может быть доставлено.';ru='Сообщение на указанный номер не может быть доставлено.'"));
	ОписанияОшибок.Вставить(9, НСтр("ka='Отправка более одного одинакового запроса на передачу SMS-сообщения в течение минуты.';ru='Отправка более одного одинакового запроса на передачу SMS-сообщения в течение минуты.'"));
...
Функция ОписаниеОшибкиПолученияСтатуса(КодОшибки)
	...
	ОписанияОшибок.Вставить(1, НСтр("ka='Ошибка в параметрах.';ru='Ошибка в параметрах.'"));
	ОписанияОшибок.Вставить(2, НСтр("ka='არასწორი ლოგ-ინი ან პაროლი.';ru='Неверный логин или пароль.'"));
	ОписанияОшибок.Вставить(5, НСтр("ka='Ошибка удаления сообщения.';ru='Ошибка удаления сообщения.'"));
	ОписанияОшибок.Вставить(4, НСтр("ka='IP-адрес временно заблокирован из-за частых ошибок в запросах. Подробнее см. http://smsc.ru/faq/99';ru='IP-адрес временно заблокирован из-за частых ошибок в запросах. Подробнее см. http://smsc.ru/faq/99'"));
	ОписанияОшибок.Вставить(9, НСтр("ka='Отправка более пяти запросов на получения статуса одного и того же сообщения в течение минуты.';ru='Отправка более пяти запросов на получения статуса одного и того же сообщения в течение минуты.'"));
...
Функция Разрешения() Экспорт
	...
	Адрес = "smsc.ru";
	Порт = Неопределено;
	Описание = НСтр("ka='Отправка SMS через ""SMS-ЦЕНТР"".';ru='Отправка SMS через ""SMS-ЦЕНТР"".'");
