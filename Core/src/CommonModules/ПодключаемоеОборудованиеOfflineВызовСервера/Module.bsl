...
Функция ПриЗагрузкеОтчетаОРозничныхПродажах(Устройство, МассивДанных, РасширеннаяЗагрузка = Ложь) Экспорт
	...
	Если РасширеннаяЗагрузка Тогда
		...
		Для Каждого ОтчетОПродажах Из МассивДанных Цикл
			...
			Комментарий = НСтр("ka='ჩატვირთულია %ТипОборудования%:%Устройство%-იდან';ru='Загружено из %ТипОборудования%:%Устройство%'");
	...
	Иначе
		...
		Комментарий = НСтр("ka='ჩატვირთულია სსა-დან Offline:';ru='Загружено из ККМ Offline:'") + Символы.НПП + Устройство;
...
Процедура ОбновитьКодыТоваров(ПравилоОбмена) Экспорт
	...
	Иначе
		ВызватьИсключение НСтр("ka='შესაერთებელი მოწყობილობის არაკორექტული ტიპი';ru='Некорректный тип подключаемого оборудования'");
	КонецЕсли;
...
Процедура РегламентноеЗаданиеОбновитьКодыТоваров() Экспорт
	...
	ЗаписьЖурналаРегистрации(НСтр("ka='შესაერთებელი მოწყობილობის საქონლის კოდების განახლება Offline';ru='Обновление кодов товаров подключаемого оборудования Offline'"),
	                         УровеньЖурналаРегистрации.Информация, , ,
	                         НСтр("ka='დაწყებულია შესაერთებელი მოწყობილობის საქონლის კოდების სარეგლამენტო განახლება Offline.';ru='Начато регламентное обновление кодов товаров подключаемого оборудования Offline.'"));
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ka='შესაერთებელი მოწყობილობის საქონლის კოდების განახლება Offline';ru='Обновление кодов товаров подключаемого оборудования Offline'"),
			                         ...
			                         НСтр("ka='შესაერთებელი მოწყობილობის Offline საქონლის კოდების სარეგლამენტო განახლებისას შეცდომა მოხდა.';ru='Во время регламентного обновления кодов товаров подключаемого оборудования Offline произошла ошибка.'")
	...
	ЗаписьЖурналаРегистрации(НСтр("ka='შესაერთებელი მოწყობილობის საქონლის კოდების განახლება Offline';ru='Обновление кодов товаров подключаемого оборудования Offline'"),
	                         УровеньЖурналаРегистрации.Информация, , ,
	                         НСтр("ka='შესაერთებელი მოწყობილობის საქონლის კოდების სარეგლამენტო განახლება დასრულებულია Offline.';ru='Закончено регламентное обновление кодов товаров подключаемого оборудования Offline.'"));
