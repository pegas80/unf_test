...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
    ...
    ВыходныеПараметры.Добавить(?(Результат, 
		НСтр("ka='მიმდინარე წონა:';ru='Текущий вес:';en='Current weight:'") + ОбъектДрайвера.Вес,
		НСтр("ka='შეცდომა მოწყობილობის შეერთებისას';ru='Ошибка при подключении устройства';en='Error connecting device'")));
