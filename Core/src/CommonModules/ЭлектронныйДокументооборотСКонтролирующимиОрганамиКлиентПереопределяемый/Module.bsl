...
Функция СписокСсылокНаСтатьиПо1СОтчетности() Экспорт
	...
	СписокСсылок.Добавить("http://its.1c.ru/bmk/elreps/nalog", НСтр("ka='Отчетность в налоговые органы и Росстат';ru='Отчетность в налоговые органы и Росстат'"));
	СписокСсылок.Добавить("http://its.1c.ru/bmk/elreps/pfr", НСтр("ka='ანგარიშგებულობა საპენსიო ფონდში';ru='Отчетность в ПФР'"));
	СписокСсылок.Добавить("http://its.1c.ru/bmk/elreps/fss", НСтр("ka='ანგარიშგებულობა სდფ-ში';ru='Отчетность в ФСС'"));
	СписокСсылок.Добавить("http://its.1c.ru/bmk/elreps/alco", НСтр("ka='Отчетность в Росалкогольрегулирование';ru='Отчетность в Росалкогольрегулирование'"));
