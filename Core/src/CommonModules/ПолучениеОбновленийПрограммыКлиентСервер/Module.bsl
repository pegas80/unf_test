...
Функция ИнформацияОДоступномОбновленииВызовОперации(
	...
	Если ИмяТекущейПрограммы = "Unknown" Тогда
		...
		Результат.Сообщение = НСтр("ka='Неверные параметры подключения к сервису.';ru='Неверные параметры подключения к сервису.';en='Incorrect parameters to connect to the service.'");
		Результат.ИнформацияОбОшибке =
			НСтр("ru='Не удалось получить информацию о доступном обновлении."
"Не определено имя программы в методе ПриОпределенииИмениПрограммы() общего модуля ИнтернетПоддержкаПользователейПереопределяемый.';ka='Не удалось получить информацию о доступном обновлении."
...
"Причина:"
"%2';ka='Не удалось получить информацию о доступном обновлении."
"Не удалось проверить доступность сервиса автоматического обновления программы: %1."
"Причина:"
"%2'"),
			URLОперацииPing,
...
"%1';ka='Ошибка при получении информации о доступном обновлении."
"%1'"),
		...
		Результат.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось получить информацию о доступном обновлении."
"%1';ka='Не удалось получить информацию о доступном обновлении."
"%1'"),
...
"%1"
"Тело ответа: %2';ka='Не удалось проверить наличие обновлений программы."
"Ошибка при обработке ответа сервиса."
"Некорректный ответ сервиса."
"%1"
"Тело ответа: %2'"),
		...
		Результат.Сообщение =
			НСтр("ru='Не удалось проверить наличие обновлений программы."
"Некорректный ответ сервиса.';ka='Не удалось проверить наличие обновлений программы."
"Некорректный ответ сервиса.'");
...
""
"Ответ сервиса: %1';ka='Не удалось проверить наличие обновлений программы."
""
"Сервис сообщил об ошибке."
""
"Ответ сервиса: %1'"),
...
"%1';ka='Получена информация о доступном обновлении."
"%1'"),
...
"Не удалось проверить доступность сервиса автоматического обновления программы: %1."
"Причина:"
"%2';ka='Не удалось получить информацию о файлах обновления."
"Не удалось проверить доступность сервиса автоматического обновления программы: %1."
"Причина:"
"%2'"),
			URLОперацииPing,
...
"%1';ka='Ошибка при получении информации о файлах обновления."
"%1'"),
			РезультатОтправки.ИнформацияОбОшибке);
		ПолучениеОбновленийПрограммыВызовСервера.ЗаписатьОшибкуВЖурналРегистрации(
			Результат.ИнформацияОбОшибке);
		...
		Результат.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Не удалось получить информацию о файлах обновления."
"%1';ka='Не удалось получить информацию о файлах обновления."
"%1'"),
			РезультатОтправки.СообщениеОбОшибке);
...
"Некорректный ответ сервиса."
"%1"
"Тело ответа: %2';ka='Не удалось получить информацию об обновлении программы."
"Ошибка при обработке ответа сервиса."
"Некорректный ответ сервиса."
"%1"
"Тело ответа: %2'"),
		...
		Результат.Сообщение =
			НСтр("ru='Не удалось получить информацию об обновлении программы."
"Некорректный ответ сервиса.';ka='Не удалось получить информацию об обновлении программы."
"Некорректный ответ сервиса.'");
...
"Сервис сообщил об ошибке."
""
"Ответ сервиса: %1';ka='Не удалось получить информацию об обновлении программы."
""
"Сервис сообщил об ошибке."
""
"Ответ сервиса: %1'"),
...
"%1';ka='Получена информация о файлах обновления."
"%1'"),
			РезультатОтправки.Содержимое));
...
"Не совпадает количество запрошенных и возвращенных файлов (%1 и %2).';ka='Возвращена неполная информация об обновлении конфигурации."
...
Функция НовыйКонтекстПолученияИУстановкиОбновлений(Параметры) Экспорт
	...
	Результат.Вставить("ТекущееДействие",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Подготовка к получению обновления...';ru='Подготовка к получению обновления...';en='Preparing to Receive updates ...'"),
			КоличествоФайлов));
...
Процедура СоздатьКаталогиДляПолученияОбновления(Обновление, Контекст) Экспорт
	...
	Исключение
		...
		СообщениеЖурнала =
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Ошибка при создании каталога для сохранения дистрибутива конфигурации (%1).';ru='Ошибка при создании каталога для сохранения дистрибутива конфигурации (%1).';en='Error creating a directory to save the configuration distribution (1%).'"),
		...
		Контекст.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Не удалось создать каталог %1 для сохранения дистрибутива конфигурации. %2';ru='Не удалось создать каталог %1 для сохранения дистрибутива конфигурации. %2';en='Unable to create directory% 1 to save the configuration of the distribution. 2%'"),
			ВременныйКаталогОбновленийКонфигурации,
	...
	Исключение
		...
		СообщениеЖурнала =
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Ошибка при создании каталога (%1).';ru='Ошибка при создании каталога (%1).';en='Error creating directory (% 1).'"),
		...
		Контекст.ИнформацияОбОшибке = СообщениеЖурнала;
		Контекст.Сообщение = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Не удалось создать каталог %1. %2';ru='Не удалось создать каталог %1. %2';en='Unable to create directory% 1. 2%'"),
			КаталогИндексаФайлов,
			КраткоеПредставлениеОшибки(ИнфОшибка));
		Возврат;
	...
	Если Обновление.ФорматФайлаОбновления <> "zip" Тогда
		...
		Исключение
			...
			СообщениеЖурнала =
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ka='Ошибка при создании каталога дистрибутива конфигурации (%1).';ru='Ошибка при создании каталога дистрибутива конфигурации (%1).';en='Error creating directory configuration distribution (1%).'"),
	...
	Если Обновление.ФорматФайлаОбновления = "zip" Тогда
		...
		Если Не ФайлСуществует(Обновление.ПолноеИмяCFUФайлаВКаталогеДистрибутивов, Ложь) Тогда
			...
			Контекст.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Некорректный файл дистрибутива %1. Отсутствует файл обновления конфигурации %2.';ru='Некорректный файл дистрибутива %1. Отсутствует файл обновления конфигурации %2.';en='Incorrect distribution file% 1. No configuration update file% 2.'"),
			...
			Контекст.Сообщение = НСтр("ka='Дистрибутив не содержит файл обновления конфигурации.';ru='Дистрибутив не содержит файл обновления конфигурации.';en='Distribution does not contain the configuration of the update file.'");
			Возврат;
...
Функция ИмяСобытияЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ka='პროგრამის განახლებების მიღება';ru='Получение обновлений программы';en='Getting program updates'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
