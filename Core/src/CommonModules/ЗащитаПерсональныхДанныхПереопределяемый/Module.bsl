...
Процедура ЗаполнитьОбластиПерсональныхДанных(ОбластиПерсональныхДанных) Экспорт
	...
	НоваяОбласть.Представление = НСтр("ka='პირადი მონაცემები';ru='Личные данные';en='Personal data'");
	
	НоваяОбласть = ОбластиПерсональныхДанных.Добавить();
	НоваяОбласть.Имя = "ПаспортныеДанные";
	НоваяОбласть.Представление = НСтр("ka='საპასპორტო მონაცემები';ru='Паспортные данные';en='passport data'");
