...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Прототип.Представление = НСтр("ka='პროგრამის ოპტიმიზირება';ru='Оптимизировать программу'");
...
Функция РасписаниеЗаданияПоУмолчанию(Знач Имя)
	...
	Иначе
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='დავალების უცნობი სახელი %1';ru='Неизвестное имя задания %1'"), Имя);
