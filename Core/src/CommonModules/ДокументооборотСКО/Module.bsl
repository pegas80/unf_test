...
Функция УстановитьСоединениеССерверомИнтернета(URLСервера, ОписаниеОшибки = "") Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='ელექტრონული დოკუმენტბრუნვა მაკონტროლებელ ორგანოებთან. ინტერნეტის სერვერთან შეერთების დაყენება';ru='Электронный документооборот с контролирующими органами. Установление соединения с сервером интернета';en='Electronic document management with regulatory authorities. Establishing a connection from the Internet server'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ВключитьОбменПоУчетнойЗаписи(УчетнаяЗапись) Экспорт
	...
	ПараметрыЗадания.Вставить("Наименование", СтрШаблон(НСтр("ka='Обмен с контролирующими органами (%1)';ru='Обмен с контролирующими органами (%1)';en='Exchange with regulatory authorities (1%)'"), УчетнаяЗапись));
...
Функция ПолучитьПочтовоеСоединение(ПочтовыйПрофиль) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронный документооборот с контролирующими органами. Почтовое соединение';ru='Электронный документооборот с контролирующими органами. Почтовое соединение';en='Electronic document management with regulatory authorities. mail connection'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
