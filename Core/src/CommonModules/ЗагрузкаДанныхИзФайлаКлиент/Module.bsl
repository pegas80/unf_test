...
Процедура ДиалогЗагрузкиФайла(ОповещениеЗавершения , ИмяФайла = "") Экспорт
	...
	ДиалогВыборФайла.Вставить("Фильтр", НСтр("ka='ფაილების ყველა მხარდაჭერილი ფორმატი(*.xls;*.xlsx;*.ods;*.mxl;*.csv)|*.xls;*.xlsx;*.ods;*.mxl;*.csv|წიგნი Excel 97 (*.xls)|*.xls|წიგნი Excel 2007 (*.xlsx)|*.xlsx|ელექტრონული ცხრილი OpenDocument (*.ods)|*.ods|ტექსტური დოკუმენტი გამყოფებით (*.csv)|*.csv|ცხრილი დოკუმენტი (*.mxl)|*.mxl';ru='Все поддерживаемые форматы файлов(*.xls;*.xlsx;*.ods;*.mxl;*.csv)|*.xls;*.xlsx;*.ods;*.mxl;*.csv|Книга Excel 97 (*.xls)|*.xls|Книга Excel 2007 (*.xlsx)|*.xlsx|Электронная таблица OpenDocument (*.ods)|*.ods|Текстовый документ c разделителями (*.csv)|*.csv|Табличный документ (*.mxl)|*.mxl';en='All supported file formats (* xls; * xlsx; * ods; * mxl; * csv.....) | * .Xls;.. * Xlsx; * ods; * mxl; * csv | Book Excel 97 (.. * .xls) | * .xls | book Excel 2007 (* .xlsx) | * .xlsx | Electronic OpenDocument spreadsheet (* .ods) | * .ods | Text document c delimited (* .csv) | * .csv | Tabular document (* .mxl) | * .mxl'"));
