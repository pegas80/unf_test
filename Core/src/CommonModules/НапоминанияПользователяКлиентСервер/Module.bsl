...
Функция ПредставлениеВремени(Знач Время, ПолноеПредставление = Истина, ВыводитьСекунды = Истина) Экспорт
	...
	ПредставлениеНедель	= НСтр("ka='კვირას';ru='неделю'")  + "," + НСтр("ka='კვირა';ru='недели'")  + "," + НСтр("ka='კვირა';ru='недель'");
	ПредставлениеДней	= НСтр("ka='დღე';ru='день'")    + "," + НСтр("ka='დღე';ru='дня'")     + "," + НСтр("ka='დღე';ru='дней'");
	ПредставлениеЧасов	= НСтр("ka='სთ';ru='час'")     + "," + НСтр("ka='საათები';ru='часа'")    + "," + НСтр("ka='საათი';ru='часов'");
	ПредставлениеМинут	= НСтр("ka='წუთს';ru='минуту'")  + "," + НСтр("ka='წუთები';ru='минуты'")  + "," + НСтр("ka='წუთი';ru='минут'");
	ПредставлениеСекунд	= НСтр("ka='წამს';ru='секунду'") + "," + НСтр("ka='წამები';ru='секунды'") + "," + НСтр("ka='წამი';ru='секунд'");
...
Функция ЗаменитьЕдиницуИзмеренияНаМножитель(Знач Единица)
	...
	Если ПервыеТриСимвола = НСтр("ka='კვ';ru='нед'") Или ПервыеТриСимвола = НСтр("ka='н';ru='н'") Тогда
		Результат = 60*60*24*7;
	ИначеЕсли ПервыеТриСимвола = НСтр("ka='ден';ru='ден'") 
		  Или ПервыеТриСимвола = НСтр("ka='дне';ru='дне'")
		  Или ПервыеТриСимвола = НСтр("ka='დღე';ru='дня'")
		  Или ПервыеТриСимвола = НСтр("ka='დღ';ru='дн'")
		  Или ПервыеТриСимвола = НСтр("ka='д';ru='д'") Тогда
		Результат = 60*60*24;
	ИначеЕсли ПервыеТриСимвола = НСтр("ka='სთ';ru='час'") Или ПервыеТриСимвола = НСтр("ka='სთ';ru='ч'") Тогда
		Результат = 60*60;
	ИначеЕсли ПервыеТриСимвола = НСтр("ka='წთ';ru='мин'") Или ПервыеТриСимвола = НСтр("ka='м';ru='м'") Тогда
		Результат = 60;
	ИначеЕсли ПервыеТриСимвола = НСтр("ka='წმ';ru='сек'") Или ПервыеТриСимвола = НСтр("ka='с';ru='с'") Тогда
		Результат = 1;
	КонецЕсли;
