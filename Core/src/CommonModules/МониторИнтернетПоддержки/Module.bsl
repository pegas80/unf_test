...
Процедура ПриСозданииКонтекстаВзаимодействия(Контекст) Экспорт
	...
	Контекст.Вставить("СообщениеОНедоступностиДействия",
		НСтр("ka='ამ კონფიგურაციისთვის ინტერნეტ-მხარდაჭერის მონიტორის გამოსახვა მიუწვდომელია.';ru='Отображение монитора Интернет-поддержки недоступно для этой конфигурации.'"));
	...
	Иначе
		...
		Если НастройкаПоказыватьПриОбновлении = Истина
			...
			КонтекстОбработчика.Вставить("ОписаниеПричиныОстановки",
				НСтр("ka='მომხმარებლების ინტერნეტ-მხარდაჭერის სერვერზე ახალი ინფორმაცია არ არის.';ru='Новой информации на сервере Интернет-поддержки пользователей нет.'"));
