...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	//Паганини_
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РС_ЭлектроннаяНакладная", 		"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ОперацияБух", 					"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СчетФактураПолученныйГрузия", 	"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СчетФактураОтправленныйГрузия", 	"Дата", "УправленческийУчет",	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.Визит", 							"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаказНаВозврат", 				"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВнутреннийЗаказ", 				"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.Конвертация", 					"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.МинимальныеОстаткиСклада", 		"Дата", "УправленческийУчет",	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВозвратДенегОтПФ", 				"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.LT_СоответствияДанныхDMS", 		"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.СписаниеТопливаЗапасов", 		"Дата", "УправленческийУчет", 	"Организация");
	//+++ Дмгг
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ОтпускаСотрудников", 			"Дата", "УправленческийУчет", 	"Организация");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ДругиеВидыОтсутствия", 			"Дата", "УправленческийУчет", 	"Организация");    
	//--- Дмгг
	//_Паганини
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
		...
		//--------------------------------------------------------------------------
		// © Шишка В.В. [2 сентября 2022]  НАЧАЛО
		//Убираю это исключение
		//Levan 01.09.2022:
		//Когда я сделаю даты запрета по разделем
		//Когда закрит толко по заказ покупателя, тоже хочу что запретить редактирование следующего документа: заказ наряд
		...
		//	
		//КонецЕсли;
		// © Шишка В.В. [2 сентября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
...
Процедура ОбновлениеРазделовДатЗапретаИзменений(ОбработкаЗавершена) Экспорт
	...
	Попытка
		...
		Пока Выборка.Следующий() Цикл
			...
			Комментарий = НСтр("ka='ნაწილი დამატებულია ავტომატურად, 1.5.3.6 ვერსიამდე მფმ-ის განახლებისას';ru='Раздел добавлен автоматически при обновлении УНФ до версии 1.5.3.6';en='Section added automatically when you update to version 1.5.3.6 UNF'");
