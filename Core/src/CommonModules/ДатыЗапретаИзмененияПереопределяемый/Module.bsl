...
Процедура ОбновлениеРазделовДатЗапретаИзменений(ОбработкаЗавершена) Экспорт
	...
	Попытка
		...
		Пока Выборка.Следующий() Цикл
			...
			Комментарий = НСтр("ka='ნაწილი დამატებულია ავტომატურად, 1.5.3.6 ვერსიამდე მფმ-ის განახლებისას';ru='Раздел добавлен автоматически при обновлении УНФ до версии 1.5.3.6'");
