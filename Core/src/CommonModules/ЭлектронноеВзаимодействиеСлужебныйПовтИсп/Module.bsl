...
Функция КлючевыеРеквизитыОбъекта(ИмяОбъекта) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(СтруктураКлючевыхРеквизитов) Тогда
		ШаблонСообщения = НСтр("ka='ობიექტ %1-სთვის საკვანძო რეკვიზიტების სტრუქტურა დადგენილი არ არის.';ru='Не определена структура ключевых реквизитов для объекта %1.';en='Not determined key structure details for the object 1%.'");
