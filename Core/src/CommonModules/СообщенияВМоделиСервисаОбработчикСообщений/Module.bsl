	...
	Попытка
		...
		Иначе
			...
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='სერვისის მოდელში %1 შეტყობინებების არხის დამამუშავებლის დადგენა ვერ მოხერხდა';ru='Не удалось определить обработчик канала сообщений в модели сервиса %1'"), КаналСообщений);
