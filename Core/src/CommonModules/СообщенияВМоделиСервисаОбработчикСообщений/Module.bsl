	...
	Попытка
		...
		Иначе
			...
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='სერვისის მოდელში %1 შეტყობინებების არხის დამამუშავებლის დადგენა ვერ მოხერხდა';ru='Не удалось определить обработчик канала сообщений в модели сервиса %1';en='Failed to determine channel message handler in the service model% 1'"), КаналСообщений);
