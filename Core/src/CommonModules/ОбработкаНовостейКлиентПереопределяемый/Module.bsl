...
//						Текст,
//						0,
//						НСтр("ka='ინფორმაცია';ru='Информация'"));
//				КонецЕсли;
//			Иначе
//				// Другие действия
//			КонецЕсли;
	...
	Если НайденноеДействие <> Неопределено Тогда
		...
		Если НайденноеДействие.Значение = "ПодключитьЭДО" Тогда
			...
			Если УправлениеНебольшойФирмойВызовСервера.ПолучитьФункциональнуюОпциюСервер("ИспользоватьОбменЭД") Тогда
				...
				Иначе
					ТекстПредупреждения = НСтр("ka='ელექტრონული დოკუმენტების გაცვლის გასამართად არასაკმარისი უფლებებია. მიმართეთ ადმინისტრატორს.';ru='Недостаточно прав для настройки обмена электронными документами. Обратитесь к администратору.'");
			...
			Иначе
				...
				ТекстПредупреждения = НСтр("ka='კონტრაგენტებთან ელექტრონული დოკუმენტების გაცვლის შესაძლებლობის ჩასართავად მიმართეთ ადმინისტრატორს.';ru='Для включения возможности обмена электронными документами с контрагентами обратитесь к администратору.'");
				ПоказатьПредупреждение(,ТекстПредупреждения);
		...
		ИначеЕсли НайденноеДействие.Значение = "Отписаться" Тогда
			...
			Если Результат.Успешно Тогда
				ПоказатьОповещениеПользователя(
					НСтр("ka='ახალი ამბების მიღებაზე უარის თქმა';ru='Отказ получения новостей'"),
					,
					СтрШаблон(НСтр("ka='ახალი ამბების ლენტი ""%1"" გამორთულია';ru='Лента новостей ""%1"" отключена'"), Результат.ПредставлениеЛентыНовостей),
