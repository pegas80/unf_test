...
Функция ТекстДляАдминистратора() Экспорт
	...
	Возврат НСтр("ka='ადმინისტრატორისთვის:';ru='Для администратора:'");
...
Функция СобытиеЖурналаРегистрации() Экспорт
	...
	Возврат НСтр("ka='მომხმარებლების მუშაობის დასრულება';ru='Завершение работы пользователей'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
