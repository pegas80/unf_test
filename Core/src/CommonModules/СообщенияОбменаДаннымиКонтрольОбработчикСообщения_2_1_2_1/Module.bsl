...
Функция ПредставлениеНастройкаСинхронизацииШаг1()
	...
	Возврат НСтр("ka='სინქრონიზაციის გამართვა, ნაბიჯი 1.';ru='Настройка синхронизации, шаг 1.';en='To set up synchronization, step 1.'");
	
КонецФункции

Функция ПредставлениеНастройкаСинхронизацииШаг2()
	
	Возврат НСтр("ka='სინქრონიზაციის გამართვა, ნაბიჯი 2.';ru='Настройка синхронизации, шаг 2.';en='Set up sync, step 2.'");
	
КонецФункции

Функция ПредставлениеЗагрузкаСообщенияОбмена()
	
	Возврат НСтр("ka='გაცვლის შეტყობინების ჩატვირთვა.';ru='Загрузка сообщения обмена.';en='Loading sharing posts.'");
	
КонецФункции

Функция ПредставлениеПолучениеДанныхКорреспондента()
	
	Возврат НСтр("ka='კორესპონდენტის მონაცემთა მიღება.';ru='Получение данных корреспондента.';en='Obtaining data reporter.'");
	
КонецФункции

Функция ПредставлениеПолучениеОбщихДанныхУзловКорреспондента()
	
	Возврат НСтр("ka='კორესპონდენტის კვანძების საერთო მონაცემთა მიღება.';ru='Получение общих данных узлов корреспондента.';en='Preparation of common data correspondent nodes.'");
	
КонецФункции

Функция ПредставлениеПолучениеПараметровУчетаКорреспондента()
	
	Возврат НСтр("ka='კორესპონდენტის აღრიცხვის პარამეტრების მიღება.';ru='Получение параметров учета корреспондента.';en='Getting correspondent account settings.'");
