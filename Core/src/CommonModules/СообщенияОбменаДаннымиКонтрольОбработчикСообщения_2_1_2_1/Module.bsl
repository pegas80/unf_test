...
Функция ПредставлениеНастройкаСинхронизацииШаг1()
	...
	Возврат НСтр("ka='სინქრონიზაციის გამართვა, ნაბიჯი 1.';ru='Настройка синхронизации, шаг 1.'");
	
КонецФункции

Функция ПредставлениеНастройкаСинхронизацииШаг2()
	
	Возврат НСтр("ka='სინქრონიზაციის გამართვა, ნაბიჯი 2.';ru='Настройка синхронизации, шаг 2.'");
	
КонецФункции

Функция ПредставлениеЗагрузкаСообщенияОбмена()
	
	Возврат НСтр("ka='გაცვლის შეტყობინების ჩატვირთვა.';ru='Загрузка сообщения обмена.'");
	
КонецФункции

Функция ПредставлениеПолучениеДанныхКорреспондента()
	
	Возврат НСтр("ka='კორესპონდენტის მონაცემთა მიღება.';ru='Получение данных корреспондента.'");
	
КонецФункции

Функция ПредставлениеПолучениеОбщихДанныхУзловКорреспондента()
	
	Возврат НСтр("ka='კორესპონდენტის კვანძების საერთო მონაცემთა მიღება.';ru='Получение общих данных узлов корреспондента.'");
	
КонецФункции

Функция ПредставлениеПолучениеПараметровУчетаКорреспондента()
	
	Возврат НСтр("ka='კორესპონდენტის აღრიცხვის პარამეტრების მიღება.';ru='Получение параметров учета корреспондента.'");
