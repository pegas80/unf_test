...
Функция НаименованиеФоновогоРезервногоКопирования() Экспорт
	...
	Возврат НСтр("ka='მონაცემთა არეალის სარეზერვო კოპირება';ru='Резервное копирование области данных';en='Data backup area'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
