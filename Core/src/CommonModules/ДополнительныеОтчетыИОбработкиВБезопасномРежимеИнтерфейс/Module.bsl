...
"Для использования COM-класса требуется переработать дополнительную обработку для работы без режима обратной совместимости.';ka='COM-კლასის ""%1"" გამოყენების ნებართვა არ შეიძლება მიეცეს დამატებით დამუშავებას, რომელიც სქბ-ის 2.1.3 ვერსიაში რეალიზებულ ნებართვების მექანიზმთან უკუთავსებადობის რეჟიმში მუშაობს."
"COM-კლასის გამოსაყენებლად საჭიროა დამატებითი დამუშავების გადამუშავება უკუთავსებადობის რეჟიმის გარეშე სამუშაოდ.'"),
			ProgId);
