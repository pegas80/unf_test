...
"%1"
"Будет использован модуль, встроенный в конфигурацию.';ka='Не удалось загрузить внешний модуль для документооборота с налоговыми органами:"
"%1"
...
Функция УчетнаяЗаписьПредназначенаДляДокументооборотаСФНС(УчетнаяЗапись) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Проверка наличия возможности отправки в ФНС для учетной записи';ru='Проверка наличия возможности отправки в ФНС для учетной записи';en='Checking for the possibility of sending in the Federal Tax Service for the account'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
...
Функция УчетнаяЗаписьПредназначенаДляДокументооборотаСПФР(УчетнаяЗапись) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Проверка наличия возможности отправки в ПФР для учетной записи';ru='Проверка наличия возможности отправки в ПФР для учетной записи';en='Checking for the possibility of sending to the FIU for the account'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
...
Функция УчетнаяЗаписьПредназначенаДляДокументооборотаСФСГС(УчетнаяЗапись) Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Проверка наличия возможности отправки в Росстат для учетной записи';ru='Проверка наличия возможности отправки в Росстат для учетной записи';en='Check availability for shipment to Rosstat account'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
			УровеньЖурналаРегистрации.Ошибка,,,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
