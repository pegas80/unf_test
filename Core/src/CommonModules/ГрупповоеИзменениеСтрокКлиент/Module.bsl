...
Процедура УстановитьПредставлениеДействия(НаборЭлементов, УстановитьСвязиПараметровВыбора)
	...
	Если ЗначениеЗаполнено(ТипЗначения) Тогда
		...
		//+++ Дмгг
		НаборЭлементов.ЗначениеЭлемент.ОтображениеКнопкиВыбора = ОтображениеКнопкиВыбора.Авто;
		//--- Дмгг
		...
		ИначеЕсли НаборЭлементов.Действие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстановитьСтавкуНДС") Тогда
			...
			НаборЭлементов.ЗначениеЭлемент.КнопкаВыпадающегоСписка = Истина;
		//+++ Дмгг
		ИначеЕсли НаборЭлементов.Действие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстановитьПроект") Тогда
			НаборЭлементов.ЗначениеЭлемент.КнопкаВыбора = Истина;
			НаборЭлементов.ЗначениеЭлемент.КнопкаВыпадающегоСписка = Ложь;
			НаборЭлементов.ЗначениеЭлемент.ОтображениеКнопкиВыбора = ОтображениеКнопкиВыбора.ОтображатьВПолеВвода;
		//--- Дмгг
		...
		ИначеЕсли НаборЭлементов.Действие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.ИзменитьНаправлениеДеятельности") Тогда
		    НаборЭлементов.ЗначениеЭлемент.КнопкаВыбора = Истина;
			НаборЭлементов.ЗначениеЭлемент.КнопкаВыпадающегоСписка = Истина;
		// Олег Литвиненко <---
		КонецЕсли;
...
Функция ТипОбъектаДействия(Действие, ОбъектИзменений)
	...
	//+++ Дмгг
	ИначеЕсли Действие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.УстановитьПроект") Тогда
	...
	// Олег Литвиненко 21.04.23 --->
	ИначеЕсли Действие = ПредопределенноеЗначение("Перечисление.ДействияГрупповогоИзмененияСтрок.ИзменитьНаправлениеДеятельности") Тогда
