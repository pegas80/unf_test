...
Функция ОписанияОбластейДоступаКалендарь() Экспорт
	...
	Календарь.Представление = НСтр("ka='კალენდარი';ru='Календарь'");
...
Функция ОписанияОбластейДоступаКонтакты() Экспорт
	...
	Контакты.Представление = НСтр("ka='კონტაქტები';ru='Контакты'");
...
Функция ОписанияОбластейДоступаПочта() Экспорт
	...
	Почта.Представление = НСтр("ka='ფოსტა';ru='Почта'");
	...
	Профиль.Представление = НСтр("ka='პროფილი';ru='Профиль'");
