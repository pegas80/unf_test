...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Если Не Результат Тогда
		ВыходныеПараметры.Добавить(999);
		ВыходныеПараметры.Добавить(НСтр("ka='შეცდომა მოწყობილობის შეერთებისას';ru='Ошибка при подключении устройства';en='Error connecting device'"));
	Иначе                  
		СтрокаТекста = НСтр("ka='ტესტური სტრიქონი 1';ru='Тестовая строка 1';en='Test line 1'") + Символы.ПС + НСтр("ka='ტესტური სტრიქონი 2';ru='Тестовая строка 2';en='Test line 2'") + Символы.ПС + НСтр("ka='სატესტო სტრიქონი 3';ru='Тестовая строка 3';en='Test line 3'");
		...
		ВыходныеПараметры.Добавить(НСтр("ka='ტესტი წარმატებით შესრულდა';ru='Тест успешно выполнен';en='The test was successful'"));
	КонецЕсли;
