...
Функция ТестУстройства(ОбъектДрайвера, Параметры, ПараметрыПодключения, ВыходныеПараметры)
	...
	Если Не Результат Тогда
		ВыходныеПараметры.Добавить(999);
		ВыходныеПараметры.Добавить(НСтр("ka='შეცდომა მოწყობილობის შეერთებისას';ru='Ошибка при подключении устройства'"));
	Иначе                  
		СтрокаТекста = НСтр("ka='ტესტური სტრიქონი 1';ru='Тестовая строка 1'") + Символы.ПС + НСтр("ka='ტესტური სტრიქონი 2';ru='Тестовая строка 2'") + Символы.ПС + НСтр("ka='სატესტო სტრიქონი 3';ru='Тестовая строка 3'");
		...
		ВыходныеПараметры.Добавить(НСтр("ka='ტესტი წარმატებით შესრულდა';ru='Тест успешно выполнен'"));
	КонецЕсли;
