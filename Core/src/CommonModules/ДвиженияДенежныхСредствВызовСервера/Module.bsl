...
Функция ПолучитьСписокВидовОперацийПоступленияДСБанк() Экспорт
	...
	СписокОпераций.Добавить(Перечисления.ВидыОперацийПоступлениеНаСчет.ВозвратДенегОтСотрудника, НСтр("ka='ზედმეტად გადახდილი ხელფასის უკან დაბრუნება';ru='Возврат денег от сотрудника';en='Refund of employee'")); //+++ Дмгг ВозвратЗПОтСотрузника
