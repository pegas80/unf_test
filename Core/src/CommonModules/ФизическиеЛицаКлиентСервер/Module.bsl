...
Функция ЧастиИмени(ФамилияИмяОтчество) Экспорт
	...
	Если ЧастиИмени.Количество() > 3 Тогда
		...
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='оглы';ru='оглы';en='oglu'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='улы';ru='улы';en='uly'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='уулу';ru='уулу';en='uulu'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='кызы';ru='кызы';en='kyzy'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='гызы';ru='гызы';en='gyzy'"));
