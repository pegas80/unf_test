...
Функция ЧастиИмени(ФамилияИмяОтчество) Экспорт
	...
	Если ЧастиИмени.Количество() > 3 Тогда
		...
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='оглы';ru='оглы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='улы';ru='улы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='уулу';ru='уулу'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='кызы';ru='кызы'"));
		ДополнительныеЧастиОтчества.Добавить(НСтр("ka='гызы';ru='гызы'"));
