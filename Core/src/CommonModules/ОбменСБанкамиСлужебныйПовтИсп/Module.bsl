...
Функция ВерсияПрограммыКлиентаДляБанка(КоличествоСимволов = 100) Экспорт
	...
	ВерсияПрограммы = СтрШаблон(НСтр("ka='1С - БЭД: %1; %2: %3';ru='1С - БЭД: %1; %2: %3'"),
	...
	Иначе
		...
		Иначе
			...
			Исключение
				...
				ВидОперации = НСтр("ka='სერვის 1C:დირექტბანკის ბანკების სიის წაკითხვა გადმოწერილი ფაილიდან.';ru='Чтение списка банков сервиса 1С:ДиректБанк из скачанного файла.'");
