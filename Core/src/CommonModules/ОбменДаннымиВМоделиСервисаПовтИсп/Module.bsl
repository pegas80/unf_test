...
Функция ПолучитьWSПроксиСервисаОбмена() Экспорт
	...
	Если Результат = Неопределено Тогда
		ВызватьИсключение НСтр("ka='მმართველი დანართის მონაცემთა გაცვლის web-სერვისის მიღების შეცდომა.';ru='Ошибка получения web-сервиса обмена данными управляющего приложения.'");
	КонецЕсли;
