...
Процедура ПроверитьНаличиеУчетнойЗаписиДляОтправкиПочты(ОбработчикРезультата) Экспорт
	...
	Иначе
		...
		Иначе	
			ТекстСообщения = НСтр("ka='წერილის გასაგზავნად საჭიროა ელექტრონული ფოსტის სააღრიცხვო ჩანაწერის გამართვა."
"მიმართეთ ადმინისტრატორს.';ru='Для отправки письма требуется настройка учетной записи электронной почты."
