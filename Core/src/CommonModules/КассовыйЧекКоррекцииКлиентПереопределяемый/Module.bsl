...
Функция ПроверитьВозможностьПечатиЧека(ОбработчикОповещения, ФормаОбъекта) Экспорт
	...
	Если НЕ ФормаОбъекта.Объект.Проведен
		...
		ТекстВопроса = НСтр("ka='ოპერაცია შესაძლებელია მხოლოდ დოკუმენტის გატარების შემდეგ, გავატაროთ დოკუმენტი?';ru='Операция возможна только после проведения документа, провести документ?'");
