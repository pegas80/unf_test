...
Функция СписокКонтролируемыхСобытий152ФЗ() Экспорт
	...
	СписокСобытий.Добавить("_$Access$_.Access",					НСтр("ka='დაშვება. დაშვება';ru='Доступ. Доступ'"));
	СписокСобытий.Добавить("_$Access$_.AccessDenied",			НСтр("ka='დაშვება. უარი დაშვებაზე.';ru='Доступ. Отказ в доступе'"));
	СписокСобытий.Добавить("_$Session$_.Authentication",		НСтр("ka='სეანსი. ავთენტიფიკაცია.';ru='Сеанс. Аутентификация'"));
	СписокСобытий.Добавить("_$Session$_.AuthenticationError",	НСтр("ka='სეანსი. ავთენტიფიკაციის შეცდომა';ru='Сеанс. Ошибка аутентификации'"));
	СписокСобытий.Добавить("_$Session$_.Start",					НСтр("ka='სეანსი. დასაწყისი';ru='Сеанс. Начало'"));
	СписокСобытий.Добавить("_$Session$_.Finish",				НСтр("ka='სეანსი. დასრულებულია';ru='Сеанс. Завершение'"));
