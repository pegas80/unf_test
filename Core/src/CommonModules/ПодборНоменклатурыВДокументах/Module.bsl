...
Функция ИмяФормыПодбораПоДокументу(ПолноеИмяДокумента, ИмяТабличнойЧасти) Экспорт
	...
	Если НайденныеСтроки.Количество() = 0 Тогда
		...
		ТекстСообщения = НСтр("ka='ვერ მოხერხდა იმის დადგენა, თუ შერჩევის რომელი ფორმა უნდა იქნას გამოყენებული.';ru='Не удалось определить какую форму подбора использовать.';en='Unable to determine which form to use selection.'");
