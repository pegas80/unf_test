...
"и затем перейти к форме ""%2"".'");
		...
		ПоказатьПредупреждение(,НСтр("ka='მოცემული გამართვის ნახვა შეუძლებელია.';ru='Данную настройку невозможно просмотреть.'"));
		Возврат;
	...
	ПоказатьПредупреждение(,НСтр("ka='აირჩიეთ ნახვის გამართვა.';ru='Выберите настройку для просмотра.'"));
...
Функция ФормированиеПоясненияПриКопировании(ПредставлениеНастройки, КоличествоНастроек, ПояснениеКомуСкопированыНастройки) Экспорт
	...
	Если КоличествоНастроек = 1 Тогда
		...
		ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='""%1"" скопирована %2';ru='""%1"" скопирована %2'"),
	...
	Иначе
		...
		ТекстПояснения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Скопировано %1 %2';ru='Скопировано %1 %2'"),
...
Функция ПояснениеПользователи(КоличествоПользователей, Пользователь) Экспорт
	...
	Если КоличествоПользователей = 1 Тогда
		ПояснениеКомуСкопированыНастройки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='მომხმარებელს ""%1""';ru='пользователю ""%1""'"), Пользователь);
	Иначе
		ПояснениеКомуСкопированыНастройки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='%1 მომხმარებლებს';ru='%1 пользователям'"), КоличествоПользователей);
	КонецЕсли;
