...
Функция РазрешеноРедактированиеЦенДокументов() Экспорт
	...
	Если РольДоступна("ДобавлениеИзменениеПодсистемыПродажи") И НЕ РольДоступна("РедактированиеЦенДокументов") Тогда 
		//+++ Дмгг, 02.08.24, ONESOFT-3357
		Если РольДоступна("РедактированиеЦенДокументовБезИзмененияЦенНоменклатуры") Тогда 
			Возврат Истина;
		КонецЕсли; 
		//--- Дмгг, 02.08.24, ONESOFT-3357
		Возврат Ложь;
	...
	//+++ Дмгг, 02.08.24, ONESOFT-3357
	Если РольДоступна("ДобавлениеИзменениеПодсистемыПродажи") И НЕ РольДоступна("РедактированиеЦенДокументовБезИзмененияЦенНоменклатуры") Тогда
		Возврат Ложь;
	КонецЕсли;   
	//--- Дмгг, 02.08.24, ONESOFT-3357
