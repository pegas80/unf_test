...
Функция ШаблонТаблицыФаксимильныхПодписей() ЭКспорт
	...
	ОписаниеФорм.Колонки.Добавить("УдалитьЗначениеПоУмолчанию", Новый ОписаниеТипов("Булево"),					НСтр("ka='Подписывать по умолчанию факсимильной подписью (Булево)';ru='Подписывать по умолчанию факсимильной подписью (Булево)'"));
	ОписаниеФорм.Колонки.Добавить("ЗначениеПоУмолчанию",	Новый ОписаниеТипов("ПеречислениеСсылка.ДаНет"),	НСтр("ka='Подписывать по умолчанию факсимильной подписью (Перечисление)';ru='Подписывать по умолчанию факсимильной подписью (Перечисление)'"));
	ОписаниеФорм.Колонки.Добавить("Организация",			Новый ОписаниеТипов("СправочникСсылка.Организации"),НСтр("ka='ორგანიზაცია';ru='Организация'"));
	ОписаниеФорм.Колонки.Добавить("Документ",				Новый ОписаниеТипов("Строка"),						НСтр("ka='Документ (имя метаданных)';ru='Документ (имя метаданных)'"));
	ОписаниеФорм.Колонки.Добавить("ПредставлениеДокумента",	Новый ОписаниеТипов("Строка"),						НСтр("ka='დოკუმენტის წარმოდგენა';ru='Представление документа'"));
	ОписаниеФорм.Колонки.Добавить("ИмяМакетаПФ",			Новый ОписаниеТипов("Строка"),						НСтр("ka='Имя макета печатной формы';ru='Имя макета печатной формы'"));
	ОписаниеФорм.Колонки.Добавить("ПредставлениеПФ",		Новый ОписаниеТипов("Строка"),						НСтр("ka='Представление печатной формы';ru='Представление печатной формы'"));
...
Процедура ДобавитьОписаниеПечатнойФормы(ОписаниеФорм, ПодписыватьПоУмолчанию, Организация, Документ, ПечатнаяФорма)
	...
	СтрокаОписания.ПредставлениеДокумента	= ?(Документ.Имя = "ЗаказПокупателя", НСтр("ka='Заказ, Заказ-наряд';ru='Заказ, Заказ-наряд'"), Документ.Синоним);
