...
"""%1""'"),
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ka='Поставляемые данные. Загрузка внешнего модуля документооборота с контролирующими органами.';ru='Поставляемые данные. Загрузка внешнего модуля документооборота с контролирующими органами.'"),
		...
		Попытка
			...
			Если РезультатПоиска.Количество() = 0 Тогда
				ПредставлениеОшибки = НСтр("ka='Ошибка при извлечении файла из архива.';ru='Ошибка при извлечении файла из архива.'");
