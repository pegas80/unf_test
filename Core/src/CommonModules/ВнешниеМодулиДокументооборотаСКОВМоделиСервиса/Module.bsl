...
"Описание:"
"""%1""';ka='Получение архива внешнего модуля документооборота с контролирующими органами."
"Описание:"
"""%1""'"),
				ПредставлениеОшибки);
			
			ЗаписьЖурналаРегистрации(
				НСтр("ka='Поставляемые данные. Загрузка внешнего модуля документооборота с контролирующими органами.';ru='Поставляемые данные. Загрузка внешнего модуля документооборота с контролирующими органами.';en='Supplied data. Load external workflow module with regulatory authorities.'"),
		...
		Попытка
			...
			Если РезультатПоиска.Количество() = 0 Тогда
				ПредставлениеОшибки = НСтр("ka='Ошибка при извлечении файла из архива.';ru='Ошибка при извлечении файла из архива.';en='Error retrieving file from the archive.'");
...
"Описание:"
"""%1""';ka='Распаковка внешнего модуля документооборота с контролирующими органами."
"Описание:"
"""%1""'"),
				ПредставлениеОшибки);
...
"Описание:"
"""%1""';ka='Запись внешнего модуля документооборота с контролирующими органами."
"Описание:"
"""%1""'"),
				ПредставлениеОшибки);
