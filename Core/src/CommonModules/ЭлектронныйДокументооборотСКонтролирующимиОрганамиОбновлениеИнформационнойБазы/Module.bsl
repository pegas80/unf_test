...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор();
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Комментарий = НСтр("ka='ახორციელებს ჩატვირთული ანგარიშგებების სახელწოდების განახლებას.';ru='Выполняет обновление наименования загруженных отчетов.'");
...
Процедура РазнестиДублиПредопределенныхЭлементовВИБ()
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ka='БРО. Восстановление предопределенных элементов';ru='БРО. Восстановление предопределенных элементов'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), УровеньЖурналаРегистрации.Ошибка,
