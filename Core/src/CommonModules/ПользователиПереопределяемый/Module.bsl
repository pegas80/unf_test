...
Процедура ПриПолученииПрочихНастроек(СведенияОПользователе, Настройки) Экспорт
	...
	Если ЗначениеНастройки <> Неопределено Тогда
		...
		ИнформацияОНастройке.Вставить("НазваниеНастройки", НСтр("ka='დადასტურება პროგრამის დახურვისას';ru='Подтверждение при закрытии программы';en='Confirmation when closing the program'"));
