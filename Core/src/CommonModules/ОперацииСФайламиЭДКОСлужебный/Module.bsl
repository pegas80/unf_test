...
Функция ПолучитьРазмерФайла(Знач Соединение, Знач ПутьНаСервере)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ka='ელექტრონული დოკუმენტბრუნვა მაკონტროლებელ ორგანოებთან. ფაილის გადმოწერა';ru='Электронный документооборот с контролирующими органами. Скачивание файла'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
