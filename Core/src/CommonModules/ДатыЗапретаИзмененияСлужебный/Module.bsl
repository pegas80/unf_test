...
Процедура ПроверитьДатыЗапретаИзмененияЗагрузкиДанных(Источник,
	...
	ЗаписьЖурналаРегистрации(
		?(УзелПроверкиЗапретаЗагрузки <> Неопределено,
			НСтр("ka='შეცვლის აკრძალვის თარიღები. ნაპოვნია ჩატვირთვის აკრძალვები';ru='Даты запрета изменения.Найдены запреты загрузки'",
			     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			НСтр("ka='ცვლილების აკრძალვის თარიღები. ცვლილების აკრძალვები მოიძებნა';ru='Даты запрета изменения.Найдены запреты изменения'",
			     ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка())),
...
Процедура УстановитьНачальнуюДатуЗапретаИзменения() Экспорт
	...
	Запись.Комментарий  = "(" + НСтр("ka='ძირითადი მნიშვნელობა';ru='По умолчанию'") + ")";
