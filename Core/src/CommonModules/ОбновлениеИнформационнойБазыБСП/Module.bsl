...
"следует использовать одноименную процедуре в общем модуле ОбновлениеИнформационнойБазы<ИмяПодсистемы>.';ka='В подсистеме %1 вместо подписки на служебное событие ПриДобавленииОбработчиковОбновления"
