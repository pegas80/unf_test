...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	Если ПараметрыРаботыКлиента.ЭтоАвтономноеРабочееМесто Тогда
		...
		Если ПараметрыРаботыКлиента.СинхронизироватьДанныеСПриложениемВИнтернетеПриНачалеРаботы Тогда
			...
			ПоказатьОповещениеПользователя(НСтр("ka='ავტონომიური მუშაობა';ru='Автономная работа'"), "e1cib/app/Обработка.ВыполнениеОбменаДанными",
				НСтр("ka='რეკომენდებულია მონაცემთა სინქრონიზება დანართთან ინტერნეტში.';ru='Рекомендуется синхронизировать данные с приложением в Интернете.'"), БиблиотекаКартинок.Информация32);
...
" - доступно обновление приложения в Интернете.'");
		...
		ПараметрыПредупреждения.ТекстФлажка = НСтр("ka='მონაცემთა სინქრონიზება ინტერნეტში დანართით';ru='Синхронизировать данные с приложением в Интернете'");
