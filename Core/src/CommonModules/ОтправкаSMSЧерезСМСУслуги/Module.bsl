...
"%1 (код ошибки: %2)';ka='Не удалось получить статус доставки SMS (smsid: ""%3""):"
...
Функция Разрешения() Экспорт
	...
	Порт = Неопределено;
	Описание = НСтр("ka='Отправка SMS через ""СМС-Услуги"".';ru='Отправка SMS через ""СМС-Услуги"".';en='Sending an SMS through ""SMS-Services"".'");
