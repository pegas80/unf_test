...
Процедура ОбработкаНавигационнойСсылки(Форма, Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка, Параметры) Экспорт
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:OpenWebPersonalAccount_Backups" Тогда
		...
		ИнтернетПоддержкаПользователейКлиент.ОткрытьВебСтраницу(
			...
			НСтр("ka='Резервные копии сервиса Облачный архив';ru='Резервные копии сервиса Облачный архив';en='Backups of service Cloud archive'"),
			Параметры.Логин,
			Параметры.Пароль);
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:OpenWebPersonalAccount_DeactivateAgent" Тогда
		...
		ИнтернетПоддержкаПользователейКлиент.ОткрытьВебСтраницу(
			...
			НСтр("ka='Деактивация Агентов резервного копирования сервиса Облачный архив';ru='Деактивация Агентов резервного копирования сервиса Облачный архив';en='Deactivating Agents Cloud backup service backup archive'"),
			Параметры.Логин,
			Параметры.Пароль);
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:OpenWebPersonalAccount_BuyAgent" Тогда
		...
		ИнтернетПоддержкаПользователейКлиент.ОткрытьВебСтраницу(
			...
			НСтр("ka='Личный кабинет клиента сервиса Облачный архив';ru='Личный кабинет клиента сервиса Облачный архив';en='Personal Account Service Cloud archive'"),
			Параметры.Логин,
			Параметры.Пароль);
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_BackupsList" Тогда
		...
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: список резервных копий';ru='Облачный архив: список резервных копий';en='Cloud Archives: list of backups'"), // Тема
			"", // Тело
			"backup", // Получатель
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_ConnectionMaster_Login" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: мастер подключения (логин)';ru='Облачный архив: мастер подключения (логин)';en='Cloud Archive: Connection Wizard (login)'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_ConnectionMaster_BackupAgentInstall" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: мастер подключения (установка Агента резервного копирования)';ru='Облачный архив: мастер подключения (установка Агента резервного копирования)';en='Cloud Archive: Connection Wizard (install Backup Agent)'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_ConnectionMaster_BackupAgentInstall_Error" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: мастер подключения (прочие ошибки)';ru='Облачный архив: мастер подключения (прочие ошибки)';en='Cloud Archive: Connection Wizard (Other errors)'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_BackupCreate_Error" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: создание резервной копии';ru='Облачный архив: создание резервной копии';en='Cloud Archives: backup'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_Settings" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: настройки';ru='Облачный архив: настройки';en='Cloud Archives: Settings'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_BackupAgentUpdateMaster_Update" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: мастер обновления Агента резервного копирования (обновление)';ru='Облачный архив: мастер обновления Агента резервного копирования (обновление)';en='Cloud Archives: Upgrade Wizard Backup Agent (update)'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:TechSupport_BackupAgentUpdateMaster_Update_Error" Тогда
		...
		МассивВложений = ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылкаФорматированнойСтроки);
		ИнтернетПоддержкаПользователейКлиент.ОтправитьСообщениеВТехПоддержку(
			НСтр("ka='Облачный архив: мастер обновления Агента резервного копирования (прочие ошибки)';ru='Облачный архив: мастер обновления Агента резервного копирования (прочие ошибки)';en='Cloud Archives: Upgrade Wizard Backup Agent (Other errors)'"), // Тема
			"", // Сообщение
			"backup", // Получатель
			МассивВложений); // Вложения
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:BackupAgentUpdate_WhatIsNew" Тогда
		...
		Если Параметры.Свойство("ТекстЧтоНовогоВВерсии")
			...
			ПараметрыОткрытия = Новый Структура("Заголовок, ТекстХТМЛ",
				НСтр("ka='Что нового в версии';ru='Что нового в версии';en=""What's new in version"""),
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "backup1C:BackupAgentUpdate_HowToUpdate" Тогда
		...
		Если Параметры.Свойство("ТекстПорядокОбновления")
			...
			ПараметрыОткрытия = Новый Структура("Заголовок, ТекстХТМЛ",
				НСтр("ka='განახლების თანმიმდევრობა';ru='Порядок обновления';en='Procedure for the update'"),
...
"Сбор данных превысил допустимое время.';ka='Произошли ошибки при подключении к подсистеме Облачный архив:"
...
"%1';ka='Произошли ошибки при подключении к подсистеме Облачный архив:"
"%1'"),
	...
	Если ОблачныйАрхивКлиентПовтИсп.РазрешенаРаботаСОблачнымАрхивом() Тогда
		...
		Если ТипЗнч(лкРасписаниеСозданияРезервныхКопий) = ТипСписокЗначений Тогда
			...
			Если СписокНапоминаний.Количество() > 0 Тогда
				...
				Кнопки.Добавить("ВыйтиИзПрограммы", НСтр("ka='Выйти из программы';ru='Выйти из программы';en='Quit the program'"));
				Кнопки.Добавить("НапомнитьПозже", НСтр("ka='შეხსენება მოგვიანებით';ru='Напомнить позже';en='Remind me later'"));
				...
				Если НачалоМинуты(СписокНапоминаний[0].Значение) - НачалоМинуты(ВремяНачала) <= 1*60 Тогда
					КогдаНачнетсяКопирование = НСтр("ka='1 წუთი';ru='1 минуту';en='1 minute'");
				ИначеЕсли НачалоМинуты(СписокНапоминаний[0].Значение) - НачалоМинуты(ВремяНачала) <= 4*60 Тогда
					КогдаНачнетсяКопирование = СтрШаблон(
						НСтр("ka='%1 წუთები';ru='%1 минуты';en='% 1 minute'"),
				...
				ИначеЕсли НачалоМинуты(СписокНапоминаний[0].Значение) - НачалоМинуты(ВремяНачала) <= 20*60 Тогда
					КогдаНачнетсяКопирование = СтрШаблон(
						НСтр("ka='წუთების %1';ru='%1 минут';en='% 1 minutes'"),
						(НачалоМинуты(СписокНапоминаний[0].Значение) - НачалоМинуты(ВремяНачала)) / 60);
				Иначе
					КогдаНачнетсяКопирование = СтрШаблон(
						НСтр("ka='%1 мин';ru='%1 мин';en='%1 minute'"),
						(НачалоМинуты(СписокНапоминаний[0].Значение) - НачалоМинуты(ВремяНачала)) / 60);
				КонецЕсли;
...
""
"Для выполнения резервного копирования надо выйти из программы.';ka='Согласно расписанию 1С:Облачного архива, резервное копирование должно быть выполнено через %1."
""
"Для выполнения резервного копирования надо выйти из программы.'"),
				...
				ПоказатьВопрос(
					...
					НСтр("ka='Резервное копирование 1С:Облачный архив по расписанию';ru='Резервное копирование 1С:Облачный архив по расписанию';en='Backup 1C: Cloud archive on schedule'"), // Заголовок.
...
Функция ПодготовитьСписокВложенийДляТехподдержки(НавигационнаяСсылка)
	...
	Если ВложитьАрхивЛоговИспользования = Истина Тогда
		...
		Если СписокФайлов.Количество() > 0 Тогда
			...
			СписокФайловЛоговИспользования = СтрШаблон(
				НСтр("ka='Найдено %1 файлов логов работы Агента резервного копирования.';ru='Найдено %1 файлов логов работы Агента резервного копирования.';en='Found% 1 files work Backup Agent logs.'"),
				ВсегоФайлов);
			Для Каждого ТекущийФайл Из СписокФайлов Цикл
				Результат.Добавить(Новый Структура("Представление, ИмяФайла",
					СтрШаблон(
						НСтр("ka='Результат работы Агента резервного копирования от %1.txt';ru='Результат работы Агента резервного копирования от %1.txt';en='The result of the Backup Agent from% 1.txt'"),
	...
	Если ВложитьАрхивЛоговУстановки = Истина Тогда
		...
		Если СписокФайлов.Количество() > 0 Тогда
			...
			СписокФайловЛоговУстановки = СтрШаблон(
				НСтр("ka='Найдено %1 файлов логов установки.';ru='Найдено %1 файлов логов установки.';en='Found% 1 log file installation.'"),
				ВсегоФайлов);
			Для Каждого ТекущийФайл Из СписокФайлов Цикл
				Результат.Добавить(Новый Структура("Представление, ИмяФайла",
					СтрШаблон(
						НСтр("ka='Результат установки Агента резервного копирования от %1.txt';ru='Результат установки Агента резервного копирования от %1.txt';en='The result of the installation of Backup Agent% 1.txt'"),
						Формат(ТекущийФайл.Значение, "ДФ='yyyyMMdd_HHmm'")),
					ТекущийФайл.Представление));
				ВсегоФайлов = ВсегоФайлов - 1;
				Если ВсегоФайлов <= 0 Тогда
	...
	Если ВложитьРасписаниеАгентаРезервногоКопирования = Истина Тогда
		ТекстРасписания = НСтр("ka='Агент резервного копирования не запускался.';ru='Агент резервного копирования не запускался.';en='Backup Agent does not start.'");
			...
			Если ИнформацияОКлиенте.ЭтоАдминистраторWindows = Истина Тогда
				Если НЕ ПустаяСтрока(лкКаталогУстановкиАгентаКопирования) Тогда
					...
					Попытка
						...
						ТекстРасписания = НСтр("ka='Результат проверки расписания:';ru='Результат проверки расписания:';en='The result of checking the schedule:'")
							+ Символы.ПС
...
"%1"
"';ka='Результат проверки расписания (ошибка):"
"%1"
"'"),
...
"но у пользователя нет прав администратора Windows для просмотра расписания.';ka='Агент резервного копирования версии %1 установлен на этом компьютере (%2),"
"но у пользователя нет прав администратора Windows для просмотра расписания.'"),
		...
		Иначе
			ТекстРасписания = СтрШаблон(
				НСтр("ka='Агент резервного копирования не установлен на этом компьютере (%1).';ru='Агент резервного копирования не установлен на этом компьютере (%1).';en='Backup Agent is not installed on this computer (% 1).'"),
				ИмяКомпьютера());
		КонецЕсли;
		Результат.Добавить(
			Новый Структура("Представление, Текст",
				НСтр("ka='Расписание Агента резервного копирования.txt';ru='Расписание Агента резервного копирования.txt';en='Schedule Backup Agent kopirovaniya.txt'"),
				ТекстРасписания));
	КонецЕсли;
		...
		Если ПустаяСтрока(РезультатВыгрузкиЖурналаРегистрации.ТекстОшибки) Тогда
			Результат.Добавить(
				Новый Структура("Представление, Адрес",
					НСтр("ka='Журнал регистрации (все события).txt';ru='Журнал регистрации (все события).txt';en='log (all events) .txt'"),
					РезультатВыгрузкиЖурналаРегистрации.АдресВременногоХранилищаФайла));
		Иначе
			Результат.Добавить(
				Новый Структура("Представление, Текст",
					НСтр("ka='Журнал регистрации (ошибка).txt';ru='Журнал регистрации (ошибка).txt';en='log (error) .txt'"),
					СтрШаблон(
						НСтр("ru='Ошибка выгрузки журнала регистрации:"
"%1';ka='Ошибка выгрузки журнала регистрации:"
"%1'"),
...
"'"),
		...
		?(ВложитьАрхивЛоговИспользования = Истина, СписокФайловЛоговИспользования, НСтр("ka='არ არის ჩადებული';ru='Не вложены';en='not enclosed'")), // Файлы логов работы.
		?(ВложитьАрхивЛоговУстановки = Истина, СписокФайловЛоговУстановки, НСтр("ka='არ არის ჩადებული';ru='Не вложены';en='not enclosed'")), // Файлы логов установки.
		?(ВложитьРасписаниеАгентаРезервногоКопирования = Истина, ТекстРасписания, НСтр("ka='არ არის ჩადებული';ru='Не вложено';en='not enclosed'"))); // Текст расписания.

	Результат.Добавить(Новый Структура("Представление, Текст",
		НСтр("ka='Параметры работы Облачного архива';ru='Параметры работы Облачного архива';en='Parameters Job Offers archive'"),
