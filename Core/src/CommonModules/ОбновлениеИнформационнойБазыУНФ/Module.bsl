...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ka='Конвертация регистра сведений ответственных лиц в справочник Подписи';ru='Конвертация регистра сведений ответственных лиц в справочник Подписи'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Авансовый отчет';ru='Заполнение подписантов в последних документах вида Авансовый отчет'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Акт выполненных работ';ru='Заполнение подписантов в последних документах вида Акт выполненных работ'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Доверенность';ru='Заполнение подписантов в последних документах вида Доверенность'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Заказ покупателя';ru='Заполнение подписантов в последних документах вида Заказ покупателя'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Заказ-наряд';ru='Заполнение подписантов в последних документах вида Заказ-наряд'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Корректировка реализации';ru='Заполнение подписантов в последних документах вида Корректировка реализации'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Отчет о переработке';ru='Заполнение подписантов в последних документах вида Отчет о переработке'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Отчет о розничных продажах';ru='Заполнение подписантов в последних документах вида Отчет о розничных продажах'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Перемещение запасов';ru='Заполнение подписантов в последних документах вида Перемещение запасов'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Платежная ведомость';ru='Заполнение подписантов в последних документах вида Платежная ведомость'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Поступление в кассу';ru='Заполнение подписантов в последних документах вида Поступление в кассу'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Заявка на расход денег';ru='Заполнение подписантов в последних документах вида Заявка на расход денег'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Расходная накладная';ru='Заполнение подписантов в последних документах вида Расходная накладная'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Сверка взаиморасчетов';ru='Заполнение подписантов в последних документах вида Сверка взаиморасчетов'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Счет на оплату покупателю';ru='Заполнение подписантов в последних документах вида Счет на оплату покупателю'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Счет фактура';ru='Заполнение подписантов в последних документах вида Счет фактура'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Табель';ru='Заполнение подписантов в последних документах вида Табель'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение подписантов в последних документах вида Чек ККМ';ru='Заполнение подписантов в последних документах вида Чек ККМ'");
	...
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Комментарий = НСтр("ka='Настройка использования факсимиле';ru='Настройка использования факсимиле'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.6.10.6";
	Обработчик.Процедура = "Справочники.Банки.УстановитьСтрануВБанках";
	Обработчик.Комментарий = НСтр("ka='Заполнение стран в банках';ru='Заполнение стран в банках'");
	...
	Обработчик.Комментарий = НСтр("ka='Обработка документов для Книги учета доходов и расходов';ru='Обработка документов для Книги учета доходов и расходов'");
	...
	Обработчик.Комментарий = НСтр("ka='Заполнение реквизитов собственной службы доставки';ru='Заполнение реквизитов собственной службы доставки'");
	...
	Обработчик.Комментарий = НСтр("ka='Конвертация булевского признака в значение перечисления для настроек факсимиле.';ru='Конвертация булевского признака в значение перечисления для настроек факсимиле.'");
	...
	Обработчик.Комментарий = НСтр("ka='Создание предопределенных шаблонов коммерческого предложения.';ru='Создание предопределенных шаблонов коммерческого предложения.'");
	...
	Обработчик.Комментарий = НСтр("ka='Включение функцональной опции ""Использовать мобильную телефонию""';ru='Включение функцональной опции ""Использовать мобильную телефонию""'");
...
Процедура ПервыйЗапуск_РазделенныеДанные() Экспорт
	...
	ВалютаОбъект.Наименование = НСтр("ka='ლარი';ru='руб.'");
	...
	КассаРублевая.Наименование = НСтр("ka='ძირითადი სალარო';ru='Основная касса'");
	...
	НашаОрганизация.НаименованиеПолное	  = НСтр("ka='ООО ""Наша фирма""';ru='ООО ""Наша фирма""'");
	НашаОрганизация.Префикс				  = НСтр("ka='НФ-';ru='НФ-'");
	...
	Оптовая.ИдентификаторФормул = Нстр("ka='საბითუმო';ru='Оптовая'");
	...
	Учетная.ИдентификаторФормул = Нстр("ka='სააღრიცხვო';ru='Учетная'");
