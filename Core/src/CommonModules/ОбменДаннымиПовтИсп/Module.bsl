...
Функция СообщенияОбОшибках() Экспорт
	...
	СообщенияОбОшибках.Вставить(8,  НСтр("ka='არაკორექტულად არის მითითებული ფაილის სახელი მონაცემთა გადმოსატვირთად';ru='Не корректно указано имя файла для выгрузки данных'"));
...
"Объект из второй информационной базы не принят. Объект этой информационной базы не изменен.'"));
	...
	СообщенияОбОшибках.Вставить(177, НСтр("ka='გაცვლის შეტყობინებიდან გაცვლის გეგმის სახელი მოსალოდნელს არ შეესაბამება.';ru='Имя плана обмена из сообщения обмена не соответствует ожидаемому.'"));
	СообщенияОбОшибках.Вставить(178, НСтр("ka='გაცვლის შეტყობინებიდან მიმღები მოსალოდნელს არ შეესაბამება.';ru='Получатель из сообщения обмена не соответствует ожидаемому.'"));
...
Функция ПланОбменаАвтономнойРаботы() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		...
		ВызватьИсключение НСтр("ka='სისტემაში ავტონომიური მუშაობა გათვალისწინებული არ არის.';ru='Автономная работа в системе не предусмотрена.'");
		
	ИначеЕсли Результат.Количество() > 1 Тогда
		
		ВызватьИсключение НСтр("ka='ავტონომიური მუშაობისთვის შექმნილია გაცვლის ერთ გეგმაზე მეტი.';ru='Создано более одного плана обмена для автономной работы.'");
