...
Процедура ДобавитьКонтактнуюИнформациюВидВыбран(ВыбранныйЭлемент, ДополнительныеПараметры) Экспорт
	...
	Если СвойстваВида.ВыводитьВФормеВсегда = Ложь Тогда
		...
		ТекстВопроса = СтрШаблон(НСтр("ka='Добавить возможность ввода вида контактной информации ""%1""?';ru='Добавить возможность ввода вида контактной информации ""%1""?';en='Add the ability to enter contact information type ""%1""?'"), ВыбранныйЭлемент.Значение);
