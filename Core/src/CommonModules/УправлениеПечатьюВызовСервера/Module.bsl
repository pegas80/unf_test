...
Функция СообщениеОПредназначенииКомандыПечати(ТипыОбъектовПечати) Экспорт
	ТекстСообщения = НСтр("ka='ამობეჭდვის არჩეული ბრძანება განკუთვნილია დოკუმენტებისთვის';ru='Выбранная команда печати предназначена для документов';en='The selected print command for documents'") 
