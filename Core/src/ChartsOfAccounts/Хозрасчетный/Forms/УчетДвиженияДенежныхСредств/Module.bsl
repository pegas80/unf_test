...
Процедура УправлениеФормой(Форма)
	...
	Если Форма.ИспользоватьСтатьиДвиженияДенежныхСредств Тогда
		Форма.Элементы.ВключитьВыключитьУчетПоСтатьямДДС.Заголовок = НСтр("ru='Выключить';en='Switch off'");
	Иначе
		Форма.Элементы.ВключитьВыключитьУчетПоСтатьямДДС.Заголовок = НСтр("ru='Включить';en='enable'");
	КонецЕсли;
