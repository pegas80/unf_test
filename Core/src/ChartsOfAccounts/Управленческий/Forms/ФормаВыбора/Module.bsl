	...
	Если ТипЗнч(ТипыСчетов) = Тип("ФиксированныйМассив") Тогда
		Для каждого ТекТипСчета Из ТипыСчетов Цикл
			...
			Если ТекТипСчета = Перечисления.ТипыСчетов.Расходы Тогда
				ЗаголовокСчета = НСтр("ka='ფინანსურ შედეგზე განაწილებული ხარჯები (ირიბი)';ru='Расходы, распределяемые на финансовый результат (Косвенные)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеРасходы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა ხარჯები, რომელთა განაწილება ხდება ფინანსურ შედეგზე';ru='Прочие расходы, распределяемые на финансовый результат'");
			ИначеЕсли  ТекТипСчета = Перечисления.ТипыСчетов.Доходы Тогда
				ЗаголовокСчета = НСтр("ka='ფინანსურ შედეგზე განაწილებადი შემოსავლები';ru='Доходы, распределяемые на финансовый результат'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеДоходы Тогда
				ЗаголовокСчета = НСтр("ka='ფინანსურ შედეგზე განაწილებადი სხვა შემოსავლები';ru='Прочие доходы, распределяемые на финансовый результат'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Дебиторы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა დებიტორები (ჩვენს წინაშე არსებული დავალიანება)';ru='Прочие дебиторы (задолженность перед нами)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Кредиторы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა კრედიტორები (ჩვენი დავალიანება)';ru='Прочие кредиторы (наша задолженность)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ДенежныеСредства Тогда
				ЗаголовокСчета = НСтр("ka='ფულის გადაადგილება';ru='Перемещения денег'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ДолгосрочныеОбязательства Тогда
				ЗаголовокСчета = НСтр("ka='გრძელვადიანი ვალდებულებები';ru='Долгосрочные обязательства'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Капитал Тогда
				ЗаголовокСчета = НСтр("ka='კაპიტალი';ru='Капитал'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.КредитыИЗаймы Тогда
				ЗаголовокСчета = НСтр("ka='კრედიტები და სესხები';ru='Кредиты и займы'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.НезавершенноеПроизводство Тогда
				ЗаголовокСчета = НСтр("ka='პროდუქციის გამოშვებაზე მიკუთვნებული ხარჯები (პირდაპირი)';ru='Затраты, относящиеся к выпуску продукции (Прямые)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.КосвенныеЗатраты Тогда
				ЗаголовокСчета = НСтр("ka='ხარჯები, რომლებიც ნაწილდება პროდუქციის გამოშვების თვითღირებულებაზე (ირიბი)';ru='Затраты, распределяемые на себестоимость выпуска продукции (Косвенные)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеОборотныеАктивы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა მიმდინარე აქტივები';ru='Прочие оборотные активы'");
			КонецЕсли;
