	...
	Если ТипЗнч(ТипыСчетов) = Тип("ФиксированныйМассив") Тогда
		Для каждого ТекТипСчета Из ТипыСчетов Цикл
			...
			Если ТекТипСчета = Перечисления.ТипыСчетов.Расходы Тогда
				ЗаголовокСчета = НСтр("ka='ფინანსურ შედეგზე განაწილებული ხარჯები (ირიბი)';ru='Расходы, распределяемые на финансовый результат (Косвенные)';en='The costs allocated to the financial result (Indirect)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеРасходы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა ხარჯები, რომელთა განაწილება ხდება ფინანსურ შედეგზე';ru='Прочие расходы, распределяемые на финансовый результат';en='Other costs are allocated to the financial result'");
			ИначеЕсли  ТекТипСчета = Перечисления.ТипыСчетов.Доходы Тогда
				ЗаголовокСчета = НСтр("ka='ფინანსურ შედეგზე განაწილებადი შემოსავლები';ru='Доходы, распределяемые на финансовый результат';en='Profit attributable to the financial result'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеДоходы Тогда
				ЗаголовокСчета = НСтр("ka='ფინანსურ შედეგზე განაწილებადი სხვა შემოსავლები';ru='Прочие доходы, распределяемые на финансовый результат';en='Other income is allocated to the financial result'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Дебиторы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა დებიტორები (ჩვენს წინაშე არსებული დავალიანება)';ru='Прочие дебиторы (задолженность перед нами)';en='Other debtors (debt to us)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Кредиторы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა კრედიტორები (ჩვენი დავალიანება)';ru='Прочие кредиторы (наша задолженность)';en='Other creditors (our debt)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ДенежныеСредства Тогда
				ЗаголовокСчета = НСтр("ka='ფულის გადაადგილება';ru='Перемещения денег';en='move money'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ДолгосрочныеОбязательства Тогда
				ЗаголовокСчета = НСтр("ka='გრძელვადიანი ვალდებულებები';ru='Долгосрочные обязательства';en='long term duties'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.Капитал Тогда
				ЗаголовокСчета = НСтр("ka='კაპიტალი';ru='Капитал';en='Capital'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.КредитыИЗаймы Тогда
				ЗаголовокСчета = НСтр("ka='კრედიტები და სესხები';ru='Кредиты и займы';en='Loans'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.НезавершенноеПроизводство Тогда
				ЗаголовокСчета = НСтр("ka='პროდუქციის გამოშვებაზე მიკუთვნებული ხარჯები (პირდაპირი)';ru='Затраты, относящиеся к выпуску продукции (Прямые)';en='Costs related to the production of products (direct)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.КосвенныеЗатраты Тогда
				ЗаголовокСчета = НСтр("ka='ხარჯები, რომლებიც ნაწილდება პროდუქციის გამოშვების თვითღირებულებაზე (ირიბი)';ru='Затраты, распределяемые на себестоимость выпуска продукции (Косвенные)';en='The costs allocated to the cost of output (Indirect)'");
			ИначеЕсли ТекТипСчета = Перечисления.ТипыСчетов.ПрочиеОборотныеАктивы Тогда
				ЗаголовокСчета = НСтр("ka='სხვა მიმდინარე აქტივები';ru='Прочие оборотные активы';en='Other current assets'");
			КонецЕсли;
