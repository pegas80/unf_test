...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтказИзменитьАналитикуПрочихДоходовИРасходов(Объект.Ссылка) Тогда
		Элементы.ГруппаАналитикаУчетаПрочихДоходовИРасходов.Подсказка = НСтр("ka='ბაზაში არის ამ ანგარიშის მოძრაობები! ანალიტიკის შეცვლა არ არის რეკომენდებული!';ru='В базе есть движения по этому счету! Изменение аналитики не рекомендуется!';en='At the base there is movement on this account! Changing analysts do not recommend!'");
	КонецЕсли;
