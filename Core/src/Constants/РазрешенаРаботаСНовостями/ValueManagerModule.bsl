...
"Новое значение: %НовоеЗначение%'");
		...
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ka='ახალი ამბები. მონაცემთა ცვლილება. კონსტანტები. ახალამბებთანმუშაობანებადართულია';ru='Новости. Изменение данных. Константы. РазрешенаРаботаСНовостями'"), // ИдентификаторШага
