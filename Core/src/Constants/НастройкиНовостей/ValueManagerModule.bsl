...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("ka='ჩაწერილია კონსტანტა ახალიამბებისგამართვები"
"წინა მნიშვნელობა:"
"%ПредыдущееЗначение%"
""
"ახალი მნიშვნელობა:"
"%НовоеЗначение%';ru='Записана константа НастройкиНовостей"
"Предыдущее значение:"
"%ПредыдущееЗначение%"
""
"Новое значение:"
"%НовоеЗначение%'");
		...
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ka='ახალი ამბები. მონაცემთა ცვლილება. კონსტანტები. ახალიამბებისგამართვები';ru='Новости. Изменение данных. Константы. НастройкиНовостей';en='News. Changing data. Constants. NastroykiNovostey'"), // ИдентификаторШага
