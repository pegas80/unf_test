...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("ka='ჩაწერილია კონსტანტა ინტერნეტითახალამბებთანმუშაობანებადართულია"
"წინა მნიშვნელობა: %ПредыдущееЗначение%"
"ახალი მნიშვნელობა: %НовоеЗначение%';ru='Записана константа РазрешенаРаботаСНовостямиЧерезИнтернет"
...
"Новое значение: %НовоеЗначение%'");
		...
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ka='ახალი ამბები. მონაცემთა ცვლილება. კონსტანტები. ახალამბებთანინტერნეტითმუშაობანებადართულია';ru='Новости. Изменение данных. Константы. РазрешенаРаботаСНовостямиЧерезИнтернет';en='News. Changing data. Constants. RazreshenaRabotaSNovostyamiCherezInternet'"), // ИдентификаторШага
