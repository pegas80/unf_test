...
"Новое значение: %НовоеЗначение%'");
		...
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:სიახლეები.მონაცემების შეცვლა';ru='БИП:Новости.Изменение данных'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. მონაცემთა ცვლილება. კონსტანტები. ახალამბებთანინტერნეტითმუშაობანებადართულია';ru='Новости. Изменение данных. Константы. РазрешенаРаботаСНовостямиЧерезИнтернет'"), // ИдентификаторШага
