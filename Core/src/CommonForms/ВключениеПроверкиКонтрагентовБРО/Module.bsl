...
Функция ИнформацияОСервисе()
	...
	ЧастиСтроки.Добавить(НСтр("ka='გესრ-ში კონტრაგენტების რეგისტრაციის შესამოწმებლად პროგრამაში არსებობს საგადასახადო სამსახურის ვებ-სერვისის გამოყენების შესაძლებლობა';ru='В программе имеется возможность использовать веб-сервис ФНС для проверки регистрации контрагентов в ЕГРН'"));
	Если ЭтоЗапускПроверкиПослеЗаполнения Тогда
