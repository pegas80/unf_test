...
Процедура ЗаполнитьАвтоматически(Команда)
	...
	Если СуммаДокумента = 0 Тогда
		ПоказатьПредупреждение(Неопределено, НСтр("ka='В документе не заполнена сумма. Автоматическое заполнение выполняется на указанную в документе сумму.';ru='В документе не заполнена сумма. Автоматическое заполнение выполняется на указанную в документе сумму.';en='The document is not full amount. Automatic filling is performed on the specified amount in the document.'"));
		Возврат;
	КонецЕсли;
