...
Процедура ЗаполнитьИнформациюПоКредитуЗаймуНаСервере()
	...
	Запрос.Текст = 
		...
		|	РегистрСведений.ГрафикПогашенияКредитовИЗаймов.СрезПоследних(&ДатаСрезаПоследних, ДоговорКредитаЗайма = &ДоговорКредитаЗайма И Проект = &Проект) КАК ГрафикПогашенияКредитовИЗаймовСрезПоследних
		// © Шишка В.В. [26 ноября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
		|;
		|
		...
		|	РегистрНакопления.РасчетыПоКредитамИЗаймам.Остатки(, ДоговорКредитаЗайма = &ДоговорКредитаЗайма И Проект = &Проект) КАК РасчетыПоКредитамИЗаймамОстатки
		// © Шишка В.В. [26 ноября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
		|
		|СГРУППИРОВАТЬ ПО
		...
		//--------------------------------------------------------------------------
		// © Шишка В.В. [26 ноября 2022]  НАЧАЛО
		|	И РасчетыПоКредитамИЗаймам.Проект = &Проект	
		// © Шишка В.В. [26 ноября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
		|
		|СГРУППИРОВАТЬ ПО
		...
		|	РегистрСведений.ГрафикПогашенияКредитовИЗаймов.СрезПервых(&ДатаСрезаПоследних, ДоговорКредитаЗайма = &ДоговорКредитаЗайма И Проект = &Проект) КАК ГрафикПогашенияКредитовИЗаймовСрезПервых
		// © Шишка В.В. [26 ноября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
		|;
		|
		...
		//--------------------------------------------------------------------------
		// © Шишка В.В. [26 ноября 2022]  НАЧАЛО
		|	И ГрафикПогашенияКредитовИЗаймов.Проект = &Проект
		// © Шишка В.В. [26 ноября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
		|;
		|
		...
		|	РегистрНакопления.РасчетыПоКредитамИЗаймам.Обороты(, , Регистратор, ДоговорКредитаЗайма = &ДоговорКредитаЗайма И Проект = &Проект) КАК РасчетыПоКредитамИЗаймамОбороты
		// © Шишка В.В. [26 ноября 2022]  КОНЕЦ
		//--------------------------------------------------------------------------
		|ГДЕ
