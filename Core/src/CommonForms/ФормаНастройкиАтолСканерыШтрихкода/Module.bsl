...
Процедура ЗаписатьИЗакрытьВыполнить()
	...
	Иначе
		ТекстСообщения = НСтр("ka='შტრიხკოდის სკანერის სუფიქსი არ არის მითითებული. შტრიხკოდის საიდენტიფიკაციოდ სუფიქსი მითითებული უნდა იქნას.';ru='Не указан суффикс сканера штрихкода. Для идентификации штрихкода суффикс должен быть указан.'");
