...
Процедура РабочийКаталогПользователяНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='აირჩიეთ ძირითადი სამუშაო კატალოგი';ru='Выберите основной рабочий каталог';en='Select the main working directory'");
...
Процедура ОчиститьЛокальныйКэшФайлов(Команда)
	...
	ТекстВопроса =
		НСтр("ka='ძირითადი სამუშაო კატალოგიდან წაიშლება ყველა ფაილი, თქვენს მიერ რედაქტირებისთვის დაკავებულის გარდა. გავაგრძელოთ?';ru='Из основного рабочего каталога будут удалены все файлы,"
...
Процедура ОчиститьЛокальныйКэшФайловПослеОтветаНаВопросПродолжить(Ответ, ПараметрыВыполнения) Экспорт
	...
	Состояние(НСтр("ka='ხორციელდება ძირითადი საუშაო კატალოგის გასუფთავება... "
"გთხოვთ, მოიცადოთ.';ru='Выполняется очистка основного рабочего каталога..."
...
Процедура ОчиститьЛокальныйКэшФайловЗавершение(Результат, ПараметрыВыполнения) Экспорт
	...
	Состояние(НСтр("ka='ძირითადი სამუშაო კატალოგის გასუფთავება წარმატებით დასრულდა.';ru='Очистка основного рабочего каталога успешно завершена.';en='Cleaning the main working directory is successfully completed.'"));
