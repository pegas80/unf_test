...
Процедура РабочийКаталогПользователяНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='აირჩიეთ ძირითადი სამუშაო კატალოგი';ru='Выберите основной рабочий каталог'");
...
Процедура ОчиститьЛокальныйКэшФайловЗавершение(Результат, ПараметрыВыполнения) Экспорт
	...
	Состояние(НСтр("ka='ძირითადი სამუშაო კატალოგის გასუფთავება წარმატებით დასრულდა.';ru='Очистка основного рабочего каталога успешно завершена.'"));
