...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимРаботы = Перечисления.РежимыИспользованияИнформационнойБазы.Демонстрационный Тогда
		ВызватьИсключение(НСтр("ka='სადემონსტრაციო რეჟიმში ახალ მომხმარებელთა დამატება მიუწვდომელია';ru='В демонстрационном режиме не доступно добавление новых пользователей';en='The demonstration mode is not available to add new users'"));
	КонецЕсли;
