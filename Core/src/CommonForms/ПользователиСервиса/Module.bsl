...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимРаботы = Перечисления.РежимыИспользованияИнформационнойБазы.Демонстрационный Тогда
		ВызватьИсключение(НСтр("ka='სადემონსტრაციო რეჟიმში ახალ მომხმარებელთა დამატება მიუწვდომელია';ru='В демонстрационном режиме не доступно добавление новых пользователей'"));
	КонецЕсли;
