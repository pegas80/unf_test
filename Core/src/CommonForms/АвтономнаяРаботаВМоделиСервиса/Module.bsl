...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Пользователи.ЭтоПолноправныйПользователь() Тогда
		...
		ВызватьИсключение НСтр("ka='ავტონომიური მუშაობის გასამართად არასაკმარისი უფლებებია.';ru='Недостаточно прав для настройки автономной работы.'");
		
	ИначеЕсли Не АвтономнаяРаботаСлужебный.АвтономнаяРаботаПоддерживается() Тогда
		
		ВызватьИсключение НСтр("ka='ავტონომიური მუშაობის შესაძლებლობა პროგრამაში არ არის გათვალისწინებული.';ru='Возможность автономной работы в программе не предусмотрена.'");
...
Процедура КакНастроитьАвтономноеРабочееМесто(Команда)
	...
	ПараметрыФормы.Вставить("Заголовок", НСтр("ka='როგორ გავმართოთ ავტონომიური სამუშაო ადგილი';ru='Как настроить автономное рабочее место'"));
