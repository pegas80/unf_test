...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокИсточникЗагрузки.Добавить("Документ", НСтр("ka='მონაცემთა შეკრების ტერმინალის დოკუმენტი';ru='Документ терминала сбора данных'"));
	СписокИсточникЗагрузки.Добавить("База",     НСтр("ka='მონაცემთა შეკრების ტერმინალის ბაზა';ru='База терминала сбора данных'"));
