...
Процедура ТестУстройстваЗавершение(РезультатВыполнения, Параметры) Экспорт
	...
	ТекстСообщения = ?(РезультатВыполнения.Результат,  НСтр("ka='Тест успешно выполнен. %ДополнительноеОписание%';ru='Тест успешно выполнен. %ДополнительноеОписание%';en='The test was completed successfully. % DopolnitelnoeOpisanie%'"),
	                               НСтр("ka='Тест не пройден. %ДополнительноеОписание%';ru='Тест не пройден. %ДополнительноеОписание%';en='Fail. % DopolnitelnoeOpisanie%'"));
