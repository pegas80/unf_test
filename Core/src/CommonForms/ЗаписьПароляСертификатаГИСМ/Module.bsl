		...
		Иначе
			...
			Если ТипЗнч(Свойства) <> Тип("Структура")
			 ...
			 Или Не ТипЗнч(Свойства.Пароль) = Тип("Строка") Тогда
				...
				ВызватьИсключение НСтр("ka='განმეორებით შეიყვანეთ პაროლი.';ru='Введите пароль повторно.'");
			КонецЕсли;
		КонецЕсли;
...
Процедура УстановитьЗаголовокНадписиИПометкуКомандыДоступенВсем()
	...
	Если ЗначениеЗаполнено(Пользователь) Тогда
		Элементы.НадписьДоступенПользователю.Заголовок = НСтр("ka='Пароль доступен пользователю:';ru='Пароль доступен пользователю:'")
			+ " " + Пользователь;
	Иначе
		Элементы.НадписьДоступенПользователю.Заголовок = НСтр("ka='Пароль доступен всем пользователям.';ru='Пароль доступен всем пользователям.'")
	КонецЕсли;
