...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокМодель.Добавить("0"     , НСтр("ka='Zebex PDL-20';ru='Zebex PDL-20'"));
	СписокМодель.Добавить("00"    , НСтр("ka='Zebex PDC-10';ru='Zebex PDC-10'"));
	СписокМодель.Добавить("000"   , НСтр("ka='Zebex PDL-10';ru='Zebex PDL-10'"));
	СписокМодель.Добавить("0000"  , НСтр("ka='Zebex PDW-10';ru='Zebex PDW-10'"));
	СписокМодель.Добавить("00000" , НСтр("ka='Zebex PDM-10';ru='Zebex PDM-10'"));
	СписокМодель.Добавить("000000", НСтр("ka='Zebex PDT-10';ru='Zebex PDT-10'"));
	СписокМодель.Добавить("1"  , НСтр("ka='Zebex Z-1050 (ატოლ ტექნოლოგიები)';ru='Zebex Z-1050 (АТОЛ технологии)'"));
	СписокМодель.Добавить("3"  , НСтр("ka='Cipher CPT-711 (პერსონალურ კომპიუტერთან კაბელით შეერთება)';ru='Cipher CPT-711 (соединение с ПК через кабель)'"));
	СписокМодель.Добавить("03" , НСтр("ka='Cipher CPT-720 (პერსონალურ კომპიუტერთან სადენით შეერთება)';ru='Cipher CPT-720 (соединение с ПК через кабель)'"));
	СписокМодель.Добавить("003", НСтр("ka='Cipher CPT-8300 (პერსონალურ კომპიუტერთან კაბელით დაკავშირება)';ru='Cipher CPT-8300 (соединение с ПК через кабель)'"));
	СписокМодель.Добавить("4"  , НСтр("ka='Cipher CPT-800х (პერსონალურ კომპიუტერთან IR სადგარით შეერთება)';ru='Cipher CPT-800х (соединение с ПК через IR подставку)'"));
	СписокМодель.Добавить("04" , НСтр("ka='Cipher CPT-8300 (პერსონალურ კომპიუტერთან შეერთება IR სადგარით)';ru='Cipher CPT-8300 (соединение с ПК через IR подставку)'"));
	СписокМодель.Добавить("5"  , НСтр("ka='Cipher CPT-3510 სერია CPT-8x1x-ისთვის';ru='Cipher CPT-3510 для серии CPT-8x1x'"));
	СписокМодель.Добавить("6"  , НСтр("ka='Zebex Z-2030';ru='Zebex Z-2030'"));
	СписокМодель.Добавить("7"  , НСтр("ka='ტერმინალები საოპერაციო სისტემა WinCE/PocketPC/Windows Mobile-ით და დაყენებული შემდეგი პროგრამული უზრუნველყოფით ატოლ: Mobile Logistics';ru='Терминалы с ОС WinCE/PocketPC/Windows Mobile и установленным ПО АТОЛ: Mobile Logistics'"));
	СписокМодель.Добавить("07" , НСтр("ka='ტერმინალები Symbol SPT-1800 რომელზეც დაყენებულია პროგრამული უზრუნველყოფა ატოლ:Mobile Logistics';ru='Терминалы Symbol SPT-1800 с установленным ПО АТОЛ:Mobile Logistics'"));
	СписокМодель.Добавить("007", НСтр("ka='ტერმინალები Symbol SPT-1550 დაყენებული პროგრამული უზრუნველყოფით ატოლ:Mobile Logistics';ru='Терминалы Symbol SPT-1550 с установленным ПО АТОЛ:Mobile Logistics'"));
	СписокМодель.Добавить("8"  , НСтр("ka='Cipher CPT-8x00 (პერსონალურ კომპიუტერთან სადგარით შეერთება)';ru='Cipher CPT-8x00 (соединение с ПК через подставку)'"));
	СписокМодель.Добавить("9"  , НСтр("ka='Casio DT-900/DT-930';ru='Casio DT-900/DT-930'"));
	СписокМодель.Добавить("09" , НСтр("ka='Cipher CPT-800x/8300 (პერსონალურ კომპიუტერთან სადენით შეერთება)';ru='Cipher CPT-800x/8300 (соединение с ПК через провод)'"));
	СписокМодель.Добавить("10" , НСтр("ka='MobileLogistics 4.x';ru='MobileLogistics 4.x'"));
...
Процедура ТестУстройства(Команда)
	...
	Если Результат Тогда
		ТекстСообщения = НСтр("ka='ტესტი წარმატებით შესრულდა.';ru='Тест успешно выполнен.'");
