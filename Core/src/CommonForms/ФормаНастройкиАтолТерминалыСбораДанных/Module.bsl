...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокМодель.Добавить("0"     , НСтр("ka='Zebex PDL-20';ru='Zebex PDL-20';en='Zebex PDL-20'"));
	СписокМодель.Добавить("00"    , НСтр("ka='Zebex PDC-10';ru='Zebex PDC-10';en='Zebex PDC-10'"));
	СписокМодель.Добавить("000"   , НСтр("ka='Zebex PDL-10';ru='Zebex PDL-10';en='Zebex PDL-10'"));
	СписокМодель.Добавить("0000"  , НСтр("ka='Zebex PDW-10';ru='Zebex PDW-10';en='Zebex PDW-10'"));
	СписокМодель.Добавить("00000" , НСтр("ka='Zebex PDM-10';ru='Zebex PDM-10';en='Zebex PDM-10'"));
	СписокМодель.Добавить("000000", НСтр("ka='Zebex PDT-10';ru='Zebex PDT-10';en='Zebex PDT-10'"));
	СписокМодель.Добавить("1"  , НСтр("ka='Zebex Z-1050 (ატოლ ტექნოლოგიები)';ru='Zebex Z-1050 (АТОЛ технологии)';en='Zebex Z-1050 (ATOL technology)'"));
	СписокМодель.Добавить("3"  , НСтр("ka='Cipher CPT-711 (პერსონალურ კომპიუტერთან კაბელით შეერთება)';ru='Cipher CPT-711 (соединение с ПК через кабель)';en='Cipher CPT-711 (connection to the PC via cable)'"));
	СписокМодель.Добавить("03" , НСтр("ka='Cipher CPT-720 (პერსონალურ კომპიუტერთან სადენით შეერთება)';ru='Cipher CPT-720 (соединение с ПК через кабель)';en='Cipher CPT-720 (connection to the PC via cable)'"));
	СписокМодель.Добавить("003", НСтр("ka='Cipher CPT-8300 (პერსონალურ კომპიუტერთან კაბელით დაკავშირება)';ru='Cipher CPT-8300 (соединение с ПК через кабель)';en='Cipher CPT-8300 (connection to the PC via cable)'"));
	СписокМодель.Добавить("4"  , НСтр("ka='Cipher CPT-800х (პერსონალურ კომპიუტერთან IR სადგარით შეერთება)';ru='Cipher CPT-800х (соединение с ПК через IR подставку)';en='Cipher CPT-only 800 (connected to the PC via the stand IR)'"));
	СписокМодель.Добавить("04" , НСтр("ka='Cipher CPT-8300 (პერსონალურ კომპიუტერთან შეერთება IR სადგარით)';ru='Cipher CPT-8300 (соединение с ПК через IR подставку)';en='Cipher CPT-8300 (compound with the PC via the stand IR)'"));
	СписокМодель.Добавить("5"  , НСтр("ka='Cipher CPT-3510 სერია CPT-8x1x-ისთვის';ru='Cipher CPT-3510 для серии CPT-8x1x';en='Cipher CPT-3510 Series CPT-8x1x'"));
	СписокМодель.Добавить("6"  , НСтр("ka='Zebex Z-2030';ru='Zebex Z-2030';en='Zebex Z-2030'"));
	СписокМодель.Добавить("7"  , НСтр("ka='ტერმინალები საოპერაციო სისტემა WinCE/PocketPC/Windows Mobile-ით და დაყენებული შემდეგი პროგრამული უზრუნველყოფით ატოლ: Mobile Logistics';ru='Терминалы с ОС WinCE/PocketPC/Windows Mobile и установленным ПО АТОЛ: Mobile Logistics';en='Terminals with OS WinCE / PocketPC / Windows Mobile and the software installed ATOL: Mobile Logistics'"));
	СписокМодель.Добавить("07" , НСтр("ka='ტერმინალები Symbol SPT-1800 რომელზეც დაყენებულია პროგრამული უზრუნველყოფა ატოლ:Mobile Logistics';ru='Терминалы Symbol SPT-1800 с установленным ПО АТОЛ:Mobile Logistics';en='Terminals Symbol SPT-1800 with installed ATOL: Mobile Logistics'"));
	СписокМодель.Добавить("007", НСтр("ka='ტერმინალები Symbol SPT-1550 დაყენებული პროგრამული უზრუნველყოფით ატოლ:Mobile Logistics';ru='Терминалы Symbol SPT-1550 с установленным ПО АТОЛ:Mobile Logistics';en='Terminals Symbol SPT-1550 software installed ATOL: Mobile Logistics'"));
	СписокМодель.Добавить("8"  , НСтр("ka='Cipher CPT-8x00 (პერსონალურ კომპიუტერთან სადგარით შეერთება)';ru='Cipher CPT-8x00 (соединение с ПК через подставку)';en='Cipher CPT-8x00 (connection to the PC via the stand)'"));
	СписокМодель.Добавить("9"  , НСтр("ka='Casio DT-900/DT-930';ru='Casio DT-900/DT-930';en='Casio DT-900 / DT-930'"));
	СписокМодель.Добавить("09" , НСтр("ka='Cipher CPT-800x/8300 (პერსონალურ კომპიუტერთან სადენით შეერთება)';ru='Cipher CPT-800x/8300 (соединение с ПК через провод)';en='Cipher CPT-800x / 8300 (connection to the PC through a wire)'"));
	СписокМодель.Добавить("10" , НСтр("ka='MobileLogistics 4.x';ru='MobileLogistics 4.x';en='MobileLogistics 4.x'"));
