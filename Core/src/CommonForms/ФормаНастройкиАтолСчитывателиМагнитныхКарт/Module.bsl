...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокПорт.Добавить(100, НСтр("ka='<Клавиатура>';ru='<Клавиатура>'"));
	...
	СписокБитДанных.Добавить(3, НСтр("ka='7 ბიტი';ru='7 бит'"));
	СписокБитДанных.Добавить(4, НСтр("ka='8 ბიტი';ru='8 бит'"));
...
Процедура ЗаписатьИЗакрытьВыполнить()
	...
	ИначеЕсли НастроеноДорожек = 0 Тогда
		ТекстСообщения = НСтр("ka='აუცილებელია წამკითხველისთვის თუნდ ერთი ბილიკის გამოყენების მითითება.';ru='Необходимо указать использование хотя бы одной дорожки для считывателя.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения);
	ИначеЕсли ДорожкаСПустымСуффиксом Тогда
		ТекстСообщения = НСтр("ka='ყოველი გამოყენებული ბილიკისთვის მითითებული უნდა იქნას არა ცარიელი სუფიქსი.';ru='Для каждой используемой дорожки должен быть указан не пустой суффикс.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения);
	КонецЕсли;
