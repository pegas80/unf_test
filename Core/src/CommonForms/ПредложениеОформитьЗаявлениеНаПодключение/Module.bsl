...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ДекорацияПроверка.Заголовок = НСтр("ka='ამ პროგრამიდან შეიძლება კონტრაგენტებთან ელექტრონული დოკუმენტების გაცვლა.';ru='Из этой программы можно обмениваться электронными документами с контрагентами.'");
