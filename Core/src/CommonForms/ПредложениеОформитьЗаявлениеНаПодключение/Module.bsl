...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.ДекорацияПроверка.Заголовок = НСтр("ka='ამ პროგრამიდან შეიძლება კონტრაგენტებთან ელექტრონული დოკუმენტების გაცვლა.';ru='Из этой программы можно обмениваться электронными документами с контрагентами.';en='you can exchange electronic documents with partners from the program.'");
	
	Если КонтрагентВ1СЭДО Тогда
		ШаблонТекстаДекорации = НСтр("ru='С контрагентом ""%1"" можно обмениваться электронными документами"
"из этой программы.';ka='კონტრაგენტ ""%1""-თან შეიძლება ელექტრონული დოკუმენტების გაცვლა ამ პროგრამიდან.'");
