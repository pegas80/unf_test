...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокШиринаСлипЧека.Добавить(32,  НСтр("ka='32 სიმ.';ru='32 сим.';en='32 sim.'"));
	СписокШиринаСлипЧека.Добавить(36,  НСтр("ka='36 სიმ.';ru='36 сим.';en='36 sim.'"));
	СписокШиринаСлипЧека.Добавить(40,  НСтр("ka='40 სიმ.';ru='40 сим.';en='40 sim.'"));
	СписокШиринаСлипЧека.Добавить(48,  НСтр("ka='48 სიმ.';ru='48 сим.';en='48 Truly.'"));
...
Процедура ТестУстройства(Команда)
	...
	Если Результат Тогда
		ТекстСообщения = НСтр("ka='ბარათის ტესტური წაკითხვა წარმატებით შესრულდა.';ru='Тестовое чтение карты успешно выполнено.';en='Test card reading successful.'");
