...
""
"%3';ka='Размещение информационной базы изменилось с"
"<b>%1</b>"
"на "
"<b>%2</b>"
""
...
""
"%1';ka='Информационная база была загружена из приложения в Интернете"
""
"• Если информационная база будет использоваться для ведения учета, нажмите <b>Информационная база перемещена</b>."
"• При выборе варианта <b>Это копия информационной базы</b> работа со всеми внешними ресурсами"
"  (синхронизация данных, отправка почты и т.п.), выполняемая по расписанию,"
...
"  будет заблокирована для предотвращения конфликтов с приложением в Интернете."
""
"%1';ka='Приложение было перемещено"
""
"• Если приложение будет использоваться для ведения учета, нажмите <b>Приложение перемещено</b>."
"• При выборе варианта <b>Это копия приложения</b> работа со всеми внешними ресурсами"
"  (синхронизация данных, отправка почты и т.п.), выполняемая по расписанию,"
...
""
"%1'"), ТекстСнятияБлокировки);
			Элементы.ИнформационнаяБазаПеремещена.Заголовок = НСтр("ka='აპლიკაცია გადაადგილებულია';ru='Приложение перемещено';en='application moved'");
			Элементы.ЭтоКопияИнформационнойБазы.Заголовок = НСтр("ka='ეს არის დანართის ასლი';ru='Это копия приложения';en='This copy of the application'");
			Заголовок = НСтр("ka='დანართი გადაადგილდა ან აღდგა სარეზერვო ასლიდან';ru='Приложение было перемещено или восстановлено из резервной копии';en='The application has been moved or restored from a backup'");
...
""
"%1';ka='Приложение было загружено из локальной версии"
""
"• Если приложение будет использоваться для ведения учета, нажмите <b>Приложение перемещено</b>."
"• При выборе варианта <b>Это копия приложения</b> работа со всеми внешними ресурсами"
"  (синхронизация данных, отправка почты и т.п.), выполняемая по расписанию,"
...
"%1'"), ТекстСнятияБлокировки);
	...
	Иначе
		...
		Заголовок = НСтр("ka='გარე რესურსებთან მუშაობის ბლოკირების პარამეტრები';ru='Параметры блокировки работы с внешними ресурсами';en='Settings lock with external resources'");
	КонецЕсли;
...
Процедура НадписьПредупреждениеОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("СобытиеЖурналаРегистрации",
		НСтр("ka='გარე რესურსებთან მუშაობა დაბლოკილია';ru='Работа с внешними ресурсами заблокирована';en='Working with external resources locked'",
