...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Валюта) Тогда
		...
		СтрокаНовогоЗаголовка 						= Нстр("ka='გადარჩეულია შემდეგი თანხის საქონელი (%ВВалюте%)';ru='Товаров подобрано на сумму (%ВВалюте%)'");
...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	Иначе
		...
		Сообщение.Текст 		= НСтр("ka='ფორმის მონაცემთა განსაახლებლად შეავსეთ ორგანიზაცია';ru='Для обновление данных формы заполните организацию'");
