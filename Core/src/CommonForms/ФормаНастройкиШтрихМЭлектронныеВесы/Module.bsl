...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокТипВесов.Добавить("3",  НСтр("ka='შტრიქი АС';ru='Штрих АС'"));
	СписокТипВесов.Добавить("5",  НСтр("ka='შტრიხი АС POS';ru='Штрих АС POS'"));
	СписокТипВесов.Добавить("11", НСтр("ka='შტრიხი POS2';ru='Штрих POS2'"));
