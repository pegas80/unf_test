...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПоказатьНастройкиВнешнихПользователей Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='გარე მომხმარებლების შესვლის გამართვები';ru='Настройки входа внешних пользователей';en='external user input settings'");
...
"чтобы корректно использовать настройки входа.';ka='დაყენებულია პაროლების მინიმალური სიგრძე %1 და პაროლების სირთულის მოთხოვნა კონფიგურატორში მენიუ ""ადმინისტრირება""-ში, პუნქტ ""საინფორმაციო ბაზის პარამეტრები...""-ში."
""
"საჭიროა კონფიგურატორში მიცემული მინიმალური სიგრძის და პაროლის სირთულის მოთხოვნის გასუფთავება შესვლის გამართვების კორექტულად გამოსაყენებლად.'"),
...
"чтобы корректно использовать настройки входа.';ka='დაყენებულია პაროლების მინიმალური სიგრძე %1 კონფიგურატორში მენიუ ""ადმინისტრირება""-ში პუნქტ ""საინფორმაციო ბაზის პარამეტრები...""-ში."
""
"საჭიროა კონფიგურატორში მიცემული მინიმალური სიგრძის გასუფთავება შესვლის გამართვების კორექტულად გამოსაყენებლად.'"),
			ПолучитьМинимальнуюДлинуПаролейПользователей());
	КонецЕсли;
...
Процедура ПриОткрытии(Отказ)
	...
	Если ЗначениеЗаполнено(ТекстВопросаОбОчисткеНастроекКонфигуратора) Тогда
		...
		Кнопки.Добавить("Очистить", НСтр("ka='გასუფთავება';ru='Очистить';en='clean'"));
