...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПоказатьНастройкиВнешнихПользователей Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='გარე მომხმარებლების შესვლის გამართვები';ru='Настройки входа внешних пользователей'");
...
Процедура ПриОткрытии(Отказ)
	...
	Если ЗначениеЗаполнено(ТекстВопросаОбОчисткеНастроекКонфигуратора) Тогда
		...
		Кнопки.Добавить("Очистить", НСтр("ka='გასუფთავება';ru='Очистить'"));
