...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	Иначе
		ОчиститьСообщения();
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='შემოწმებისას აღმოჩენილი იქნა შემდეგი შეცდომები:';ru='При проверке были обнаружены следующие ошибки:'") + ТекстОшибки);
	КонецЕсли;
