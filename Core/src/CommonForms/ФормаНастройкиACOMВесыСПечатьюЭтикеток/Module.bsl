...
Процедура ЗаписатьИЗакрыть(Команда)
	...
	Иначе
		ОчиститьСообщения();
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='შემოწმებისას აღმოჩენილი იქნა შემდეგი შეცდომები:';ru='При проверке были обнаружены следующие ошибки:';en='When checking were found the following errors:'") + ТекстОшибки);
	КонецЕсли;
