...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		ПоясняющийТекст = НСтр("ka='ფაილის ატვირთვა....';ru='Загрузка файла...';en='Loading file ...'");
	КонецЕсли;
...
Процедура Подключаемый_ПроверитьВыполнениеЗадания()
	...
	Иначе
		...
		Элементы.Индикатор.Подсказка = СтрШаблон(НСтр("ka='ჩატვირთულია %2-დან %1';ru='Загружено %1 из %2';en='Loaded% 1% 2'"), Загружено, ОсталосьЗагрузить);
...
Процедура НачатьЗагрузкуФайла()
	...
	Результат = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		ПараметрыЗадания, НСтр("ka='ფაილის გადმოწერა ინტერნეტიდან';ru='Скачивание файла из Интернет';en='Downloading files from the Internet'"), Истина);
