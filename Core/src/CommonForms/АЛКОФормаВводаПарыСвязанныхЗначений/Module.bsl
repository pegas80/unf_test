...
"из форм регламентированных отчетов!'");
		ПоказатьПредупреждение(, ТекстПредупреждения, , НСтр("ka='Форма редактирования пары Код - Название.';ru='Форма редактирования пары Код - Название.';en='Editing form pairs code - name.'"));
		Возврат;	
	КонецЕсли;
