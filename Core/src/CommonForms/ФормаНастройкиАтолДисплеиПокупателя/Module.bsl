...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокЧетность.Добавить(3, НСтр("ka='დაყენებულია';ru='Установлен'"));
	СписокЧетность.Добавить(4, НСтр("ka='ჩამოგდებულია';ru='Сброшен'"));
	...
	СписокКодировка.Добавить(437, НСтр("ka='437 (OEM - აშშ)';ru='437 (OEM - США)'"));
	СписокКодировка.Добавить(850, НСтр("ka='850 (OEM - მრავალენოვანი ლათინური 1)';ru='850 (OEM - многоязычная латиница 1)'"));
	СписокКодировка.Добавить(852, НСтр("ka='852 (OEM - რუსული ანბანი)';ru='852 (OEM - кириллица традиционная)'"));
	СписокКодировка.Добавить(860, НСтр("ka='860 (OEM - პორტუგალიური)';ru='860 (OEM - португальский)'"));
	СписокКодировка.Добавить(863, НСтр("ka='863 (OEM - ფრანკო-კანადური)';ru='863 (OEM - франко-канадский)'"));
	СписокКодировка.Добавить(865, НСтр("ka='865 (OEM - სკანდინავიური)';ru='865 (OEM - скандинавский)'"));
	СписокКодировка.Добавить(866, НСтр("ka='866 (OEM - რუსული)';ru='866 (OEM - русский)'"));
	СписокКодировка.Добавить(932, НСтр("ka='932 (ANSI/OEM - იაპონური Shift-JIS)';ru='932 (ANSI/OEM - японский Shift-JIS)'"));
