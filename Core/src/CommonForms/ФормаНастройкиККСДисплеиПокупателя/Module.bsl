...
Процедура ТестУстройства(Команда)
	...
	ТекстСообщения = ?(Результат,  НСтр("ka='ტესტი წარმატებით შესრულდა. %ДополнительноеОписание%';ru='Тест успешно выполнен.%ДополнительноеОписание%'"),
	                               НСтр("ka='ტესტი ვერ იქნა ჩაბარებული. %ДополнительноеОписание%';ru='Тест не пройден.%ДополнительноеОписание%'"));
