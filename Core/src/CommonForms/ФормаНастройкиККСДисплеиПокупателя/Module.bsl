...
Процедура ТестУстройства(Команда)
	...
	ТекстСообщения = ?(Результат,  НСтр("ka='ტესტი წარმატებით შესრულდა. %ДополнительноеОписание%';ru='Тест успешно выполнен.%ДополнительноеОписание%';en='The test was successful.% DopolnitelnoeOpisanie%'"),
	                               НСтр("ka='ტესტი ვერ იქნა ჩაბარებული. %ДополнительноеОписание%';ru='Тест не пройден.%ДополнительноеОписание%';en='Fail.% DopolnitelnoeOpisanie%'"));
