...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Попытка
		...
		Если Не Пользователи.ЭтоПолноправныйПользователь() Тогда
			ВызватьИсключение НСтр("ka='სეანსის დასასრულებლად არასაკმარისი უფლებებია!';ru='Недостаточно прав для завершения сеанса!';en='Not have permission to log off!'");
		КонецЕсли;
...
Функция НачатьЗавершениеСеансов()
	...
	Если ПустаяСтрока(Пароль) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='სერვისთან დასაშვებად პაროლი არ არის მითითებული!';ru='Не указан пароль для доступа к сервису!';en='Unknown password to access the service!'"), ,
			"Пароль"
		);
...
Процедура НачатьЗавершениеСеансовНаСервере()
	...
	Задание = ФоновыеЗадания.Выполнить(
		...
		ПараметрыЗадания,
		,
		НСтр("ka='აქტიური სეანსის დასრულება';ru='Завершение активного сеанса';en='Completion active session'")
	);
...
Функция ФоновоеЗаданиеВыполнено(ИдентификаторЗадания)
	...
	Если Задание = Неопределено Тогда
		...
		ВызватьИсключение НСтр("ka='ფონური დავალება ვერ იქნა ნაპოვნი!';ru='Фоновое задание не найдено!';en='Background job is not found!'");
	...
	Иначе
		...
		ИначеЕсли Задание.Состояние = СостояниеФоновогоЗадания.Отменено Тогда
			...
			ВызватьИсключение НСтр("ka='ფონური დავალება გაუქმებულია ადმინისტრატორის მიერ!';ru='Фоновое задание отменено администратором!';en='The background job is canceled by the administrator!'");
