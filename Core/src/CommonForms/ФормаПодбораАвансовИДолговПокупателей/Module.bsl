...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СуммаУчетаПолучатель = Параметры.СуммаУчета;//++Lazare 16.02.2023
...
Процедура ЗаполнитьРасшифровкуПлатежа()
	...
	СуммаОсталосьРаспределить = СуммаУчетаПолучатель;
	...
	//СуммаОсталосьРаспределить = СуммаУчетаПолучатель;
	//
	//ТзАвансовДолгов = СписокАвансовДолгов.Выгрузить();
	//
	//Если ТзАвансовДолгов.Количество() > 0 Тогда 
	//	
	//	НоваяСтрока = СписокОтобранныеАвансыИДолги.Добавить();

	//	Для Каждого Ст из ТзАвансовДолгов Цикл 
	//		
	//		Если Ст.СуммаРасчетов <= СуммаОсталосьРаспределить Тогда 
	//			
	//		КонецЕсли;
	//		
	//	КонецЦикла;
