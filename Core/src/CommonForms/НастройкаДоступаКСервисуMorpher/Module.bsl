...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЧастиСтроки.Добавить(НСтр("ka='სერვისის ანონიმურ გამოყენებას შეზღუდვები გააჩნია.';ru='Анонимное использование сервиса имеет ограничения.';en='Anonymous use of the service has its limitations.'"));
