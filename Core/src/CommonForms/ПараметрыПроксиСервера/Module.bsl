...
""
"Настройка прокси-сервера выполняется администратором.';ka='დაშვების უფლებები არასაკმარისია."
""
"პროქსი-სერვერის გამართვა ხორციელდება ადმინისტრატორის მიერ.'");
	КонецЕсли;
	...
	Иначе
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("ka='პროქსი-სერვერის პარამეტრები 1C:საწარმოს სერვერზე';ru='Параметры прокси-сервера на сервере 1С:Предприятия';en='proxy server settings in the 1C: Enterprise server'");
