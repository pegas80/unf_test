...
Процедура ПроверитьЗавершение(Результат, Неопределен) Экспорт
	...
	Если Результат = Истина Тогда
		ПоказатьПредупреждение(, НСтр("ka='სერტიფიკატი ძალაშა.';ru='Сертификат действителен.'"));
		
	ИначеЕсли Результат <> Неопределено Тогда
		ПараметрыПредупреждения = Новый Структура;
		
		ПараметрыПредупреждения.Вставить("ТекстПредупреждения", Результат);
		ПараметрыПредупреждения.Вставить("ЗаголовокПредупреждения", НСтр("ka='Сертификат недействителен по причине:';ru='Сертификат недействителен по причине:'"));
...
Процедура ЗаполнитьСвойстваСубъекта(Сертификат)
	...
	ПредставленияСвойств.Добавить("ОбщееИмя",         НСтр("ka='საერთო სახელი';ru='Общее имя'"));
	ПредставленияСвойств.Добавить("Страна",           НСтр("ka='ქვეყანა';ru='Страна'"));
	ПредставленияСвойств.Добавить("Регион",           НСтр("ka='რეგიონი';ru='Регион'"));
	ПредставленияСвойств.Добавить("НаселенныйПункт",  НСтр("ka='დასახლებული პუნქტი';ru='Населенный пункт'"));
	ПредставленияСвойств.Добавить("Улица",            НСтр("ka='ქუჩა';ru='Улица'"));
	ПредставленияСвойств.Добавить("Организация",      НСтр("ka='ორგანიზაცია';ru='Организация'"));
	ПредставленияСвойств.Добавить("Подразделение",    НСтр("ka='ქვეგანყოფილება';ru='Подразделение'"));
	ПредставленияСвойств.Добавить("Должность",        НСтр("ka='თანამდებობა';ru='Должность'"));
	ПредставленияСвойств.Добавить("ЭлектроннаяПочта", НСтр("ka='ელ.ფოსტა';ru='Электронная почта'"));
	ПредставленияСвойств.Добавить("ОГРН",             НСтр("ka='ძსსნ';ru='ОГРН'"));
	ПредставленияСвойств.Добавить("ОГРНИП",           НСтр("ka='ОГРНИП';ru='ОГРНИП'"));
	ПредставленияСвойств.Добавить("СНИЛС",            НСтр("ka='СНИЛС';ru='СНИЛС'"));
	ПредставленияСвойств.Добавить("ИНН",              НСтр("ka='ИНН';ru='ИНН'"));
	ПредставленияСвойств.Добавить("Фамилия",          НСтр("ka='გვარი';ru='Фамилия'"));
	ПредставленияСвойств.Добавить("Имя",              НСтр("ka='სახელი';ru='Имя'"));
	ПредставленияСвойств.Добавить("Отчество",         НСтр("ka='მამის სახელი';ru='Отчество'"));
...
Процедура ЗаполнитьВнутренниеПоляСертификата()
	...
	Если ГруппаВнутреннихПолей = "Общие" Тогда
		...
		ДобавитьСвойство(Сертификат, "Версия",                    НСтр("ka='ვერსია';ru='Версия'"));
		ДобавитьСвойство(Сертификат, "ДатаНачала",                НСтр("ka='დაწყების თარიღი';ru='Дата начала'"));
		ДобавитьСвойство(Сертификат, "ДатаОкончания",             НСтр("ka='დასრულების თარიღი';ru='Дата окончания'"));
		ДобавитьСвойство(Сертификат, "ИспользоватьДляПодписи",    НСтр("ka='ხელმოწერისთვის გამოყენება';ru='Использовать для подписи'"));
		ДобавитьСвойство(Сертификат, "ИспользоватьДляШифрования", НСтр("ka='დასაშიფრად გამოყენება';ru='Использовать для шифрования'"));
		ДобавитьСвойство(Сертификат, "ОткрытыйКлюч",              НСтр("ka='გახსნილი გასაღები';ru='Открытый ключ'"), Истина);
		ДобавитьСвойство(Сертификат, "Отпечаток",                 НСтр("ka='ანაბეჭდი';ru='Отпечаток'"), Истина);
		ДобавитьСвойство(Сертификат, "СерийныйНомер",             НСтр("ka='სერიული ნომერი';ru='Серийный номер'"), Истина);
