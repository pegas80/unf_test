...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимПодбора Тогда
		Заголовок = НСтр("ka='გაცვლის გეგმების კვანძების შერჩევა';ru='Подбор узлов планов обмена';en='Selection of nodes sharing plans'");
	КонецЕсли;
...
Процедура Выбрать(Команда)
	...
	Иначе
		...
		Если ТекущиеДанные = Неопределено Тогда
			ПоказатьПредупреждение(, НСтр("ka='კვანძი არ არის არჩეული.';ru='Узел не выбран.';en='The node is not selected.'"));
		Иначе
...
Процедура ДобавитьИспользуемыйПланОбмена(ОбъектМетаданных)
	...
	Если Параметры.ВыбиратьВсеУзлы Тогда
		...
		НоваяСтрока.УзелПредставление       = НСтр("ka='<ყველა საინფორმაციო ბაზა>';ru='<Все информационные базы>';en='<All information databases>'");
	КонецЕсли;
