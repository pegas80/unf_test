...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СообщениеПользователю = НСтр("ka='გთხოვთ, მოიცადეთ...';ru='Пожалуйста, подождите...'");
...
"из форм регламентированных отчетов!'");
		ПоказатьПредупреждение(, ТекстПредупреждения, , НСтр("ka='Форма длительных операций.';ru='Форма длительных операций.'"));
		Возврат;	
	КонецЕсли;
