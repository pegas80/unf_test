...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СообщениеПользователю = НСтр("ka='გთხოვთ, მოიცადეთ...';ru='Пожалуйста, подождите...';en='Please wait...'");
...
"из форм регламентированных отчетов!';ka='Данная форма вспомогательная, предназначена для "
"демонстрации хода процесса длительной операции"
"из форм регламентированных отчетов!'");
		ПоказатьПредупреждение(, ТекстПредупреждения, , НСтр("ka='Форма длительных операций.';ru='Форма длительных операций.';en='Form long-term operations.'"));
		Возврат;	
	КонецЕсли;
