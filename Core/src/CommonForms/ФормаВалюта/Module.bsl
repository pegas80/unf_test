...
Процедура ПроверитьЗаполнениеРеквизитовФормы(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(ВалютаДокумента) Тогда
		...
		Сообщение.Текст = НСтр("ka='არ არის არჩეული ვალუტა შესავსებად!';ru='Не выбрана валюта для заполнения!'");
	...
	Если НЕ ЗначениеЗаполнено(Курс) Тогда
		Сообщение = Новый СообщениеПользователю();
		Сообщение.Текст = НСтр("ka='აღმოჩენილია დოკუმენტის ვალუტის ნულოვანი კურსი!';ru='Обнаружен нулевой курс валюты документа!'");
		Сообщение.Поле = "Курс";
		Сообщение.Сообщить();
		Отказ = Истина;
	КонецЕсли;
	Если НЕ ЗначениеЗаполнено(Кратность) Тогда
		Сообщение = Новый СообщениеПользователю();
		Сообщение.Текст = НСтр("ka='აღმოჩენილია დოკუმენტის ვალუტის კურსის ნულოვანი ჯერადობა!';ru='Обнаружена нулевая кратность курса валюты документа!'");
