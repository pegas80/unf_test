...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не АвтономнаяРаботаСлужебный.ЭтоАвтономноеРабочееМесто() Тогда
		ВызватьИсключение НСтр("ka='ეს საინფორმაციო ბაზა არ წარმოადგენს ავტონომიურ სამუშაო ადგილს.';ru='Эта информационная база не является автономным рабочим местом.'");
	КонецЕсли;
...
Процедура ПриИзмененииРасписанияСинхронизацииДанных()
	...
	Элементы.ВариантРасписанияСинхронизацииДанных.СписокВыбора.Добавить(1, НСтр("ka='ყოველ 15 წუთში';ru='Каждые 15 минут'"));
	Элементы.ВариантРасписанияСинхронизацииДанных.СписокВыбора.Добавить(2, НСтр("ka='ყოველ საათს';ru='Каждый час'"));
	Элементы.ВариантРасписанияСинхронизацииДанных.СписокВыбора.Добавить(3, НСтр("ka='ყოველდღე 10:00-ზე, შაბათ-კვირის გარდა.';ru='Каждый день в 10:00, кроме сб. и вс.'"));
