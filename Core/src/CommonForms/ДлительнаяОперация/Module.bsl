...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстСообщения = НСтр("ka='გთხოვთ, მოიცადეთ...';ru='Пожалуйста, подождите...';en='Please wait...'");
...
Процедура Подключаемый_ПроверитьВыполнениеЗадания()
	...
	ИначеЕсли Статус = "Ошибка" Тогда
		...
		Если ВозвращатьРезультатВОбработкуВыбора() Тогда
			...
			ПараметрыПредупреждения.Вставить("Заголовок", НСтр("ka='Не удалось выполнить запрошенное действие';ru='Не удалось выполнить запрошенное действие';en='Unable to perform the requested action'"));
...
Процедура ПоказатьОповещение()
	...
	ПоказатьОповещениеПользователя(?(Оповещение.Текст <> Неопределено, Оповещение.Текст, НСтр("ka='ქმედება შესრულებულია';ru='Действие выполнено';en='action complete'")), 
