...
""
"Настройка параметров подключения к серверу Интернет-поддержки пользователей доступна только администратору системы.';ka='დაშვების უფლებები არასაკმარისია."
""
"მომხმარებლების ინტერნეტ-მხარდაჭერის სერვერთან შეერთების პარამეტრების გამართვა ხელმისაწვდომია მხოლოდ სისტემის ადმინისტრატორისთვის.'");
	КонецЕсли;
