...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОткрытьОрганизации.Заголовок = ?(ФОУчетПоНесколькимОрганизациям, НСтр("ka='ორგანიზაციები';ru='Организации'"), НСтр("ka='ორგანიზაცია';ru='Организация'"));
	
	ФОУчетПоНесколькимСкладам = ПолучитьФункциональнуюОпцию("УчетПоНесколькимСкладам");
	Элементы.ОткрытьСклады.Заголовок = ?(ФОУчетПоНесколькимСкладам, НСтр("ka='საწყობები';ru='Склады'"), НСтр("ka='საწყობი';ru='Склад'"));
	
	ФОУчетПоНесколькимПодразделениям = ПолучитьФункциональнуюОпцию("УчетПоНесколькимПодразделениям");
	Элементы.ОткрытьПодразделения.Заголовок = ?(ФОУчетПоНесколькимПодразделениям, НСтр("ka='განაყოფილებები';ru='Подразделения'"), НСтр("ka='განყოფილება';ru='Подразделение'"));
	
	ФОУчетПоНесколькимНаправлениямДеятельности = ПолучитьФункциональнуюОпцию("УчетПоНесколькимНаправлениямДеятельности");
	Элементы.ОткрытьНаправленияДеятельности.Заголовок = ?(ФОУчетПоНесколькимНаправлениямДеятельности,НСтр("ka='განაყოფილებები';ru='Направления деятельности'"), НСтр("ka='განყოფილება';ru='Направление деятельности'"));
