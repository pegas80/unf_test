	...
	Если СохраненныеНастройки <> Неопределено Тогда
		...
		Для Каждого СтрокаТЧ Из Настройки Цикл
			...
			Если ПарольУстановлен(СтрокаТЧ.Сертификат) Тогда
				СтрокаТЧ.Пароль = НСтр("ka='დაყენებულია';ru='Установлен'");
			Иначе
				СтрокаТЧ.Пароль = НСтр("ka='არ არის დაყენებული';ru='Не установлен'");
			КонецЕсли;
...
Процедура НастройкиПриИзменении(Элемент)
	...
	Если ПарольУстановлен(ТекущиеДанные.Сертификат) Тогда
		ТекущиеДанные.Пароль = НСтр("ka='დაყენებულია';ru='Установлен'");
	Иначе
		ТекущиеДанные.Пароль = НСтр("ka='არ არის დაყენებული';ru='Не установлен'");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст",      НСтр("ka='<любое подразделение>';ru='<любое подразделение>'"));
