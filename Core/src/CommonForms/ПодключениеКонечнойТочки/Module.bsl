...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ТекстПредупреждения = НСтр("ka='გავაუქმოთ საბოლოო წერტილის ჩართვა?';ru='Отменить подключение конечной точки?';en='Cancel the connection endpoint?'");
...
Процедура ПодключитьИЗакрыть(Результат = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Состояние(НСтр("ka='მიმდინარეობს საბოლოო წერტილის დაკავშირება. გთხოვთ, მოიცადოთ...';ru='Выполняется подключение конечной точки. Пожалуйста, подождите...';en='You connect to the endpoint. Please wait...'"));
...
"Перейти в журнал регистрации?';ka='ბოლო წერტილის ჩართვისას შეცდომები წარმოიშვა. გადავიდეთ რეგისტრაციის ჟურნალზე?'");
	...
	ПоказатьОповещениеПользователя(,,НСтр("ka='საბოლოო წერტილის ჩართვა წარმატებით დასრულდა.';ru='Подключение конечной точки успешно завершено.';en='Connection endpoint is successfully completed.'"));
