...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Деньги,Кассы,Банки';ru='Деньги,Кассы,Банки';en='Money, cash, Banks'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Деньги,Кассы,Банки';ru='Деньги,Кассы,Банки';en='Money, cash, Banks'");
	НастройкиВариантов["Анализ движений"].Теги = НСтр("ka='ფული';ru='Деньги';en='Money'");
	НастройкиВариантов["ВедомостьВВалюте"].Теги = НСтр("ka='Главное,Деньги,Кассы,Банки,Валюты';ru='Главное,Деньги,Кассы,Банки,Валюты';en='The main thing is money, cash, bank, currency'");
	НастройкиВариантов["ОстаткиВВалюте"].Теги = НСтр("ka='Деньги,Кассы,Банки,Валюты';ru='Деньги,Кассы,Банки,Валюты';en='Money, cash, bank, currency'");
	НастройкиВариантов["Анализ движений в валюте"].Теги = НСтр("ka='Деньги,Валюты';ru='Деньги,Валюты';en='Money, Currency'");
	НастройкиВариантов["ДинамикаПоступленияДенежныхСредств"].Теги = НСтр("ka='Деньги,Поступления';ru='Деньги,Поступления';en='Money Receipts'");
	НастройкиВариантов["ДинамикаРасходаДенежныхСредств"].Теги = НСтр("ka='Деньги,Платежи';ru='Деньги,Платежи';en='Money, Payments'");
...
Процедура ДобавитьПолеВыбораПериодичности(НастройкиСКД, Форма)
	...
	Стр.Заголовок = НСтр("ka='პერიოდულობა';ru='Периодичность';en='Periodicity'");
