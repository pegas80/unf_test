...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ДвижениеДенегПоПроектам"].Рекомендуемый = Истина;
	НастройкиВариантов["ДвижениеДенегПоПроектам"].Вставить("РежимПериода", "ЗаПериод");
	НастройкиВариантов["ДвижениеДенегПоПроектам"].ИмяМакетаОбразца = "ОбразецАнализДвиженийВВалюте";
	НастройкиВариантов["ДвижениеДенегПоПроектам"].ФункциональнаяОпция = "УчетПоПроектам";
	//ПодольскийАИ #УчетПроектов 18.10.2020 }
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Деньги,Кассы,Банки';ru='Деньги,Кассы,Банки'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Деньги,Кассы,Банки';ru='Деньги,Кассы,Банки'");
	НастройкиВариантов["Анализ движений"].Теги = НСтр("ka='ფული';ru='Деньги'");
	НастройкиВариантов["ВедомостьВВалюте"].Теги = НСтр("ka='Главное,Деньги,Кассы,Банки,Валюты';ru='Главное,Деньги,Кассы,Банки,Валюты'");
	НастройкиВариантов["ОстаткиВВалюте"].Теги = НСтр("ka='Деньги,Кассы,Банки,Валюты';ru='Деньги,Кассы,Банки,Валюты'");
	НастройкиВариантов["Анализ движений в валюте"].Теги = НСтр("ka='Деньги,Валюты';ru='Деньги,Валюты'");
	НастройкиВариантов["ДинамикаПоступленияДенежныхСредств"].Теги = НСтр("ka='Деньги,Поступления';ru='Деньги,Поступления'");
	НастройкиВариантов["ДинамикаРасходаДенежныхСредств"].Теги = НСтр("ka='Деньги,Платежи';ru='Деньги,Платежи'");
	
	//ПодольскийАИ #УчетПроектов 18.10.2020 {
	НастройкиВариантов["ДвижениеДенегПоПроектам"].Теги = НСтр("ka='Деньги,Валюты';ru='Деньги,Валюты'");
	//ПодольскийАИ #УчетПроектов 18.10.2020 }
...
Процедура ДобавитьПолеВыбораПериодичности(НастройкиСКД, Форма)
	...
	Стр.Заголовок = НСтр("ka='პერიოდულობა';ru='Периодичность'");
