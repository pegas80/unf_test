...
Процедура ДобавитьПолеВыбораВидаЦен(НастройкиСКД, Форма)
	...
	Стр.Заголовок = НСтр("ka='ფასის ტიპი';ru='Вид цены'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Запасы,Закупки,Склады,Номенклатура,Остатки,Цены';ru='Запасы,Закупки,Склады,Номенклатура,Остатки,Цены'");
	НастройкиВариантов["ОценкаСтоимостиСклада"].Теги = НСтр("ka='Запасы,Закупки,Склады,Номенклатура,Остатки,Цены';ru='Запасы,Закупки,Склады,Номенклатура,Остатки,Цены'");
