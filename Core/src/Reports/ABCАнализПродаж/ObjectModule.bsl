...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если СуммаПроцентов <> 100 Тогда
		ВызватьИсключение НСтр("ka='Сумма процентов критериев распределения по АВС-классам должна быть равна 100%';ru='Сумма процентов критериев распределения по АВС-классам должна быть равна 100%'");
	КонецЕсли; 
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = НСтр("ka='ABC-анализ продаж';ru='ABC-анализ продаж'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ABCанализПродажПоНоменклатуре"].Теги = НСтр("ka='Номенклатура,Продажи';ru='Номенклатура,Продажи'");
	НастройкиВариантов["ABCанализПродажПоКатегориямНоменклатуры"].Теги = НСтр("ka='Категории,Продажи';ru='Категории,Продажи'");
	НастройкиВариантов["ABCанализПродажПоПокупателям"].Теги = НСтр("ka='Покупатели,Контрагенты,Продажи,CRM';ru='Покупатели,Контрагенты,Продажи,CRM'");
	НастройкиВариантов["ABCанализПродажПоМенеджерам"].Теги = НСтр("ka='Менеджеры,Сотрудники,Продажи';ru='Менеджеры,Сотрудники,Продажи'");
