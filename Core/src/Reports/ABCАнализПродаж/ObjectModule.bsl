...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если СуммаПроцентов <> 100 Тогда
		ВызватьИсключение НСтр("ka='Сумма процентов критериев распределения по АВС-классам должна быть равна 100%';ru='Сумма процентов критериев распределения по АВС-классам должна быть равна 100%';en='The amount of interest the criteria for ABC-class distribution should be equal to 100%'");
	КонецЕсли; 
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = НСтр("ka='ABC-анализ продаж';ru='ABC-анализ продаж';en='ABC-analysis of sales'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ABCанализПродажПоНоменклатуре"].Теги = НСтр("ka='Номенклатура,Продажи';ru='Номенклатура,Продажи';en='Nomenclature, Sales'");
	НастройкиВариантов["ABCанализПродажПоКатегориямНоменклатуры"].Теги = НСтр("ka='Категории,Продажи';ru='Категории,Продажи';en='Categories Sales'");
	НастройкиВариантов["ABCанализПродажПоПокупателям"].Теги = НСтр("ka='Покупатели,Контрагенты,Продажи,CRM';ru='Покупатели,Контрагенты,Продажи,CRM';en='Buyers, Accounts, Sales, CRM'");
	НастройкиВариантов["ABCанализПродажПоМенеджерам"].Теги = НСтр("ka='Менеджеры,Сотрудники,Продажи';ru='Менеджеры,Сотрудники,Продажи';en='Managers, Employees, Sales'");
