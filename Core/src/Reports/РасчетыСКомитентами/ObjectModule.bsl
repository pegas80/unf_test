...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Деньги,Запасы,Закупки,Контрагенты,Номенклатура,Комиссия';ru='Деньги,Запасы,Закупки,Контрагенты,Номенклатура,Комиссия';en='Money, Stocks, Procurement, Accounts, Nomenclature Commission'");
	КонецЦикла;
