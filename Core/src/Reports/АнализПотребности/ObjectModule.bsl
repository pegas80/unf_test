...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Заказы,Отгрузки,Резервы';ru='Запасы,Закупки,Номенклатура,Заказы,Отгрузки,Резервы';en='Inventories, Purchases, Inventory, Orders, Shipments, Reserves'");
