...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ka='(AzRy) ბრუნვითი უწყისი USD%1';ru='(AzRy) Оборотно-сальдовая ведомость USD%1'"),
...
Функция ПолучитьНаборПоказателей() Экспорт
	...
	НаборПоказателей.Добавить("БУ");//НСтр("ka='ლარი';ru='БУ!'"));
		...
		Если СтрокаГруппировкиПоСчету <> Неопределено Тогда
			...
			Для Индекс = 1 По КоличествоСубконто Цикл
				...
				Если ИндексСубконто = "0" Тогда
					...
					СтрокаГруппировки.Представление = 	НСтр("ka='განყოფილება';ru='Подразделение'");
...
Процедура ЗаполнитьПравилаРасшифровки(Правила) Экспорт
	...
	Правило.ШаблонПредставления = НСтр("ka='ბრუნვითი უწყისი ანგარიშის მიხედვით [Счет]';ru='ОСВ по счету [Счет]'");
	
	Правило = Правила.Добавить();
	Правило.Отчет = "КарточкаСчета";
	БухгалтерскиеОтчетыРасшифровка.ДобавитьТребуемыйРеквизитРасшифровки(Правило.ТребуемыеРеквизиты, "Счет", "Счет");
	Правило.ШаблонПредставления = НСтр("ka='ანგარიშის ბარათი [Счет]';ru='Карточка счета [Счет]'");
	
	Правило = Правила.Добавить();
	Правило.Отчет = "АнализСчета";
	БухгалтерскиеОтчетыРасшифровка.ДобавитьТребуемыйРеквизитРасшифровки(Правило.ТребуемыеРеквизиты, "Счет", "Счет");
	Правило.ШаблонПредставления = НСтр("ka='ანგარიშის ანალიზი [Счет]';ru='Анализ счета [Счет]'");
	...
	Правило.ШаблонПредставления = НСтр("ka='ანგარიშის ბრუნვა [Счет] თვეების მიხედვით';ru='Обороты счета [Счет] по месяцам'");
	
	Правило = Правила.Добавить();
	Правило.Отчет = "ОборотыСчета";
	БухгалтерскиеОтчетыРасшифровка.ДобавитьТребуемыйРеквизитРасшифровки(Правило.ТребуемыеРеквизиты, "Счет", "Счет");
	БухгалтерскиеОтчетыРасшифровка.ДобавитьТребуемыйРеквизитРасшифровки(Правило.ТребуемыеРеквизиты, "Периодичность", "", 6);
	Правило.ШаблонПредставления = НСтр("ka='ანგარიშის ბრუნვა [Счет] დღეების მიხედვით';ru='Обороты счета [Счет] по дням'");
...
Процедура СоздатьКолонкиОтчета(КолонкиСтруктурыОтчета, ПараметрыОтчета)
	...
	ГруппаСальдоНаНачало.Заголовок     = НСтр("ka='ნაშთი პერიოდის დასაწყისისთვის';ru='Сальдо на начало периода'");
	...
	ГруппаСальдоНаНачалоДт.Заголовок     = НСтр("ka='დებეტი';ru='Дебет'");
	...
	ГруппаСальдоНаНачалоКт.Заголовок     = НСтр("ka='კრედიტი';ru='Кредит'");
	...
	ГруппаОбороты.Заголовок     = НСтр("ka='ბრუნვა პერიოდში';ru='Обороты за период'");
	...
	ГруппаОборотыДт.Заголовок     = НСтр("ka='დებეტი';ru='Дебет'");
	...
	ГруппаОборотыКт.Заголовок     = НСтр("ka='კრედიტი';ru='Кредит'");
	...
	ГруппаСальдоНаКонец.Заголовок     = НСтр("ka='ნაშთი პერიოდის ბოლოსთვის';ru='Сальдо на конец периода'");
	...
	ГруппаСальдоНаКонецДт.Заголовок     = НСтр("ka='დებეტი';ru='Дебет'");
	...
	ГруппаСальдоНаКонецКт.Заголовок     = НСтр("ka='კრედიტი';ru='Кредит'");
