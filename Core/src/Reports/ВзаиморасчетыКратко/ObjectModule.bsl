...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость в валюте (кратко)"].Теги = НСТР("ka='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики,Валюты';ru='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики,Валюты';en='Settlements, debts Advances Accounts, Customers, Suppliers, Currency'");
