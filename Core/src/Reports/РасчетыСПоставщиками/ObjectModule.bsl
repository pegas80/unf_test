...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка'");
	НастройкиВариантов["ВедомостьВВалюте"].Теги = НСтр("ka='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка'");
	НастройкиВариантов["ОстаткиВВалюте"].Теги = НСтр("ka='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка';ru='Деньги,Запасы,Закупки,Контрагенты,Поставщики,Кредиторка'");
