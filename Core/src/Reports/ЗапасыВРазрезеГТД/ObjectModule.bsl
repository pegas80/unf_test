...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Запасы,Закупки,Номенклатура,Товары,ГТД';ru='Запасы,Закупки,Номенклатура,Товары,ГТД'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ka='Запасы,Закупки,Номенклатура,Товары,ГТД';ru='Запасы,Закупки,Номенклатура,Товары,ГТД'");
