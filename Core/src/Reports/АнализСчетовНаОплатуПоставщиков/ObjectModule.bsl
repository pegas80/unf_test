...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Контрагенты,Поставщики,Счета,Оплаты,Авансы,Долги';ru='Контрагенты,Поставщики,Счета,Оплаты,Авансы,Долги';en='Contractors, Suppliers, Invoices, Payments, Advances Debts'");
