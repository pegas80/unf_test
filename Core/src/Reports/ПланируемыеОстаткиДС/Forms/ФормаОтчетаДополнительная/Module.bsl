...
Процедура УстановитьПериод(НазваниеПериода, Направление)
	...
	Результат.Область(2,2,2,2).Текст 		= Нстр("ka='ანგარიშგება არ არის ფორმირებული. ანგარიშგების მისაღებად დააჭირეთ ""ფორმირება""-ს.';ru='Отчет не сформирован. Нажмите ""Сформировать"" для получения отчета.';en='The report has not been formed. Click ""Create"" to obtain a report.'");
