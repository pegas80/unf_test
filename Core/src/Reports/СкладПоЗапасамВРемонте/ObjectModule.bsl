...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';ru='Запасы,Номенклатура,Товары,Ремонты,Серийные номера'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Номенклатура,Товары,Ремонты,Серийные номера';ru='Запасы,Номенклатура,Товары,Ремонты,Серийные номера'");
