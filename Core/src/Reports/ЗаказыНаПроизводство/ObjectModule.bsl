...
Процедура ПриКонтекстномОткрытии(СсылкаНаОбъект, ПолеСвязи, Отборы, Отказ) Экспорт
	...
	Если ПолеСвязи = "ЗаказНаПроизводство" Тогда
		...
		Если НЕ ЗначениеЗаполнено(ЗаказНаПроизводство) Тогда
			Отказ = Истина;
			Сообщить(НСтр("ka='Отчет можно сформировать только при сборке на основании заказа на производство';ru='Отчет можно сформировать только при сборке на основании заказа на производство'"));
			Возврат;
		КонецЕсли; 
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Производство,Заказы,Продукция';ru='Производство,Заказы,Продукция'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ka='Производство,Заказы,Продукция';ru='Производство,Заказы,Продукция'");
