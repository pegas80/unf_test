...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Продажи,Закупки,Запасы,Работы,Производство,Номенклатура';ru='Продажи,Закупки,Запасы,Работы,Производство,Номенклатура'");
