...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = 
		НСтр("ka='Выводит подробные сведения о всех пользователях,"
"включая настройки для входа (если указаны).';ru='Выводит подробные сведения о всех пользователях,"
"включая настройки для входа (если указаны).'");
	...
	НастройкиВарианта.Описание = 
		НСтр("ka='Выводит подробные сведения о пользователях,"
"включая настройки для входа (если указаны).';ru='Выводит подробные сведения о пользователях,"
"включая настройки для входа (если указаны).'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "СведенияОВнешнихПользователях");
	НастройкиВарианта.Описание = 
		НСтр("ka='Выводит подробные сведения о внешних пользователях,"
"включая настройки для входа (если указаны).';ru='Выводит подробные сведения о внешних пользователях,"
"включая настройки для входа (если указаны).'");
	НастройкиВарианта.ФункциональныеОпции.Добавить("ИспользоватьВнешнихПользователей");
КонецПроцедуры
