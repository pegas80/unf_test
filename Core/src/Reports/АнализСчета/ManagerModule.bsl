...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат СтрШаблон(
			НСтр("ka='ანგარიშის ანალიზი %1%2';ru='Анализ счета %1%2'"),
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	ГруппаДт.Заголовок     = НСтр("ka='დებეტი';ru='Дебет'");
	...
	ГруппаКт.Заголовок     = НСтр("ka='კრედიტი';ru='Кредит'");
	...
	Если УсловноеОформлениеАвтоотступа = Неопределено Тогда
		...
		УсловноеОформлениеАвтоотступа.Представление = НСтр("ka='ვტოდაშორების შემცირება';ru='Уменьшенный автоотступ'");
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Для Каждого Макет Из МакетКомпоновки.Макеты Цикл 
		...
		Если МакетГруппировкиСчетЗаголовок.Найти(Макет) <> Неопределено 
			...
			НовыйЭлемент.Значение = НСтр("ka='საწყისი ნაშთი';ru='Начальное сальдо'");
		...
		Если МакетГруппировкиСчетПодвал.Найти(Макет) <> Неопределено 
			...
			НовыйЭлемент.Значение = НСтр("ka='ბრუნვა';ru='Оборот'");
			...
			НовыйЭлемент.Значение = НСтр("ka='საბოლოო ნაშთი';ru='Конечное сальдо'");
...
Процедура ЗаполнитьПравилаРасшифровки(Правила) Экспорт
		...
		Правило.ШаблонПредставления = НСтр("ka='ანგარიშგება გატარებების მიხედვით';ru='Отчет по проводкам'");
