...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Главное,Компания,Баланс';ru='Главное,Компания,Баланс';en='Most importantly, the Company, Balance'");
...
Процедура ДобавитьПолеВыбораОрганизации(НастройкиСКД, Форма)
	...
	Стр.Заголовок = НСтр("ka='ორგანიზაცია';ru='Организация';en='Organization'");
