...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Комиссия,Продажи';ru='Запасы,Закупки,Номенклатура,Передача,Комиссия,Продажи'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Комиссия';ru='Запасы,Закупки,Номенклатура,Передача,Комиссия'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Переработка';ru='Запасы,Закупки,Номенклатура,Передача,Переработка'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Ответхранение';ru='Запасы,Закупки,Номенклатура,Передача,Ответхранение'");
