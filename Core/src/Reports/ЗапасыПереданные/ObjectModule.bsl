...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Комиссия,Продажи';ru='Запасы,Закупки,Номенклатура,Передача,Комиссия,Продажи';en='Inventories, Purchases, Inventory, transmission, Commission Sales'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Комиссия';ru='Запасы,Закупки,Номенклатура,Передача,Комиссия';en='Inventories, Purchases, Inventory, Transfer Commission'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Переработка';ru='Запасы,Закупки,Номенклатура,Передача,Переработка';en='Inventories, Purchases, Inventory, Transfer, Recycling'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Передача,Ответхранение';ru='Запасы,Закупки,Номенклатура,Передача,Ответхранение';en='Inventories, Purchases, Inventory, transmission, otvethranenie'");
