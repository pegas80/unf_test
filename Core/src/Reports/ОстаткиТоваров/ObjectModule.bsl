...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ПоМестамХранения"].Теги = НСТР("ka='Главное,Товары,Запасы,Закупки,Номенклатура';ru='Главное,Товары,Запасы,Закупки,Номенклатура'");
	НастройкиВариантов["ПоМестамХранения"].Рекомендуемый = Истина;
	НастройкиВариантов["ПоМестамХранения"].Вставить("РежимПериода", "НаДату");
	
	НастройкиВариантов["Прогноз"].Теги = НСТР("ka='Товары,Запасы,Закупки,Номенклатура,Заказы,План,Прогноз';ru='Товары,Запасы,Закупки,Номенклатура,Заказы,План,Прогноз'");
...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	СтрВидЦен.Заголовок = НСтр("ka='ფასების ტიპი';ru='Вид цен'");
	...
	Группа.Заголовок = НСтр("ka='რეჟიმი';ru='Режим'");
	...
	СтрСвой = ДобавитьПоле(Форма.ПоляНастроек, "Фильтр", "Режим", ОписаниеТиповБулево, НСтр("ka='რეჟიმი';ru='Режим'"), "Флажок");
	СтрСвой.Создан = Истина;
	СтрСвой.ИмяГруппы = Группа.Имя;
	СтрСвой.Поле = "Свой";
	ИмяРеквизита = "ФильтрРежимСвои";
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрСвой.ТипЗначения,, НСтр("ka='საკუთარი';ru='Свои'")));
	КонецЕсли;
	...
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрСвой.ТипЗначения,, НСтр("ka='სხვისი';ru='Чужие'")));
	КонецЕсли; 
	...
	СтрНаСкладе = ДобавитьПоле(Форма.ПоляНастроек, "Фильтр", "НаСкладе", ОписаниетиповБулево, НСтр("ka='რეჟიმი';ru='Режим'"), "Флажок");
	СтрНаСкладе.Создан = Истина;
	СтрНаСкладе.ИмяГруппы = Группа.Имя;
	ИмяРеквизита = "ФильтрРежимНаСкладах";
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрНаСкладе.ТипЗначения,, НСтр("ka='საწყობებში';ru='На складах'")));
	КонецЕсли; 
	...
	Если ИменаРеквизитов.Найти(ИмяРеквизита)=Неопределено Тогда
		МассивРеквизитов.Добавить(Новый РеквизитФормы(ИмяРеквизита, СтрНаСкладе.ТипЗначения,, НСтр("ka='რეალიზატორებთან';ru='У реализаторов'")));
	КонецЕсли; 
