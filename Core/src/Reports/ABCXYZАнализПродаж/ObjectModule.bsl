...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ABCXYZанализПродажПоНоменклатуре"].Теги = НСТР("ka='Номенклатура,Продажи';ru='Номенклатура,Продажи'");
	НастройкиВариантов["ABCXYZанализПродажПоКатегориямНоменклатуры"].Теги = НСТР("ka='Категории,Продажи';ru='Категории,Продажи'");
	НастройкиВариантов["ABCXYZанализПродажПоПокупателям"].Теги = НСТР("ka='Покупатели,Контрагенты,Продажи,CRM';ru='Покупатели,Контрагенты,Продажи,CRM'");
	НастройкиВариантов["ABCXYZанализПродажПоМенеджерам"].Теги = НСТР("ka='Менеджеры,Сотрудники,Продажи';ru='Менеджеры,Сотрудники,Продажи'");
