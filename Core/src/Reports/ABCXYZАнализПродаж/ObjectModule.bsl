...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ABCXYZанализПродажПоНоменклатуре"].Теги = НСТР("ka='Номенклатура,Продажи';ru='Номенклатура,Продажи';en='Nomenclature, Sales'");
	НастройкиВариантов["ABCXYZанализПродажПоКатегориямНоменклатуры"].Теги = НСТР("ka='Категории,Продажи';ru='Категории,Продажи';en='Categories Sales'");
	НастройкиВариантов["ABCXYZанализПродажПоПокупателям"].Теги = НСТР("ka='Покупатели,Контрагенты,Продажи,CRM';ru='Покупатели,Контрагенты,Продажи,CRM';en='Buyers, Accounts, Sales, CRM'");
	НастройкиВариантов["ABCXYZанализПродажПоМенеджерам"].Теги = НСТР("ka='Менеджеры,Сотрудники,Продажи';ru='Менеджеры,Сотрудники,Продажи';en='Managers, Employees, Sales'");
...
Функция ПолучитьРезультатРаспределения(ПараметрыОтчета)
	...
	Если Не ЕстьХарактеристики Тогда
		...
		|ПО
		|	ПродажиОбороты.Период ПЕРИОДАМИ("+XMLстрока(ПараметрыОтчета.Периодичность) +", &НачалоПериода, &КонецПериода),
