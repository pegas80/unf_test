...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Номенклатура,Отгрузки,Запасы,Закупки,Остатки,Продажи,Серийные номера';ru='Номенклатура,Отгрузки,Запасы,Закупки,Остатки,Продажи,Серийные номера'");
