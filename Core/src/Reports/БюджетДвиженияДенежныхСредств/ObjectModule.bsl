...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Компания,Деньги,Бюджет,План';ru='Компания,Деньги,Бюджет,План';en='Company, Money, Budget Plan'");
	НастройкиВариантов["План-фактный анализ"].Теги = НСТР("ka='Компания,Деньги,Бюджет,План,Факт';ru='Компания,Деньги,Бюджет,План,Факт';en='Company, Money, Budget, Plan Fact'");
