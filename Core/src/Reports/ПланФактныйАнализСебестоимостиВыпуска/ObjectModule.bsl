...
Процедура СформироватьТаблицыВыпускаИПлановыхЗатрат(ТаблицаВыпуска, ТаблицаПлановыхЗатратНаВыпуск, ЗначенияПараметровМКД)
	...
	|	ВыпускПродукцииОбороты.Проект КАК Проект, //Малышев 2024-06-26 ONESOFT-3282
	...
	|	ВыпускПродукции.Проект, //Малышев 2024-06-26 ONESOFT-3282
	...
	|	ВыпускПродукции.Проект КАК Проект,  //Малышев 2024-06-26 ONESOFT-3282
	...
	|	СоставВыпуска.Проект, //Малышев 2024-06-26 ONESOFT-3282
...
Процедура РассчитатьПлановуюСебестоимостьЗатратНаВыпуск(ТаблицаПлановыхЗатратНаВыпуск, ЗначенияПараметровМКД)
	...
	|	И НЕ Запасы.Номенклатура.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Услуга)
	|
	|СГРУППИРОВАТЬ ПО
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Производство,Себестоимость,Продукция';ru='Производство,Себестоимость,Продукция';en='Production, costs, production'");
	КонецЦикла;
