...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Компания,Деньги,План,Факт';ru='Компания,Деньги,План,Факт'");
	НастройкиВариантов["ВВалюте"].Теги = НСТР("ka='Компания,Деньги,План,Факт,Валюты';ru='Компания,Деньги,План,Факт,Валюты'");
	НастройкиВариантов["План-фактный анализ"].Теги = НСТР("ka='Компания,Деньги,План,Факт';ru='Компания,Деньги,План,Факт'");
	НастройкиВариантов["План-фактный анализ (вал.)"].Теги = НСТР("ka='Компания,Деньги,План,Факт,Валюты';ru='Компания,Деньги,План,Факт,Валюты'");
