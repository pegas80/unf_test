...
Процедура ОткрытьФормуОтчета(Команда)
	...
	Если мСкопированаФорма <> Неопределено Тогда
		...
		Если мВыбраннаяФорма <> мСкопированаФорма Тогда
			...
			ПоказатьПредупреждение(,НСтр("ka='Форма отчета изменилась, копирование невозможно!';ru='Форма отчета изменилась, копирование невозможно!'"));
			Возврат;
	...
	Если ФормироватьАвтоматически Тогда
		...
		Если НЕ ВыбраныНалоговыеОрганы Тогда
			...
			ПоказатьПредупреждение(, НСтр("ka='Не выбраны налоговые органы.';ru='Не выбраны налоговые органы.'"));
...
Функция СформироватьАвтоматическиРеглОтчет()
	...
	НаименованиеЗадания = НСтр("ka='Автоматическое формирование форм 6-НДФЛ';ru='Автоматическое формирование форм 6-НДФЛ'");
...
Процедура НалоговыеОрганыНажатие(Элемент)
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		...
		ПоказатьПредупреждение(, НСтр("ka='ორგანიზაცია არ არის არჩეული.';ru='Не выбрана организация.'"));	
	...
	Иначе
		...
		ПоказатьПредупреждение(, НСтр("ka='В справочник ""Регистрации в налоговом органе"" не добавлены налоговые органы.';ru='В справочник ""Регистрации в налоговом органе"" не добавлены налоговые органы.'"));
