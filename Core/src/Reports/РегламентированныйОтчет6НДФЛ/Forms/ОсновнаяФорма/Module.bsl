...
Процедура ОткрытьФормуОтчета(Команда)
	...
	Если мСкопированаФорма <> Неопределено Тогда
		...
		Если мВыбраннаяФорма <> мСкопированаФорма Тогда
			...
			ПоказатьПредупреждение(,НСтр("ka='Форма отчета изменилась, копирование невозможно!';ru='Форма отчета изменилась, копирование невозможно!';en='The report form has changed, can not be copied!'"));
			Возврат;
	...
	Если ФормироватьАвтоматически Тогда
		...
		Если НЕ ВыбраныНалоговыеОрганы Тогда
			...
			ПоказатьПредупреждение(, НСтр("ka='Не выбраны налоговые органы.';ru='Не выбраны налоговые органы.';en='Not selected tax authorities.'"));
...
Функция СформироватьАвтоматическиРеглОтчет()
	...
	НаименованиеЗадания = НСтр("ka='Автоматическое формирование форм 6-НДФЛ';ru='Автоматическое формирование форм 6-НДФЛ';en='Automatic generation of forms of 6-PIT'");
...
Процедура НалоговыеОрганыНажатие(Элемент)
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		...
		ПоказатьПредупреждение(, НСтр("ka='ორგანიზაცია არ არის არჩეული.';ru='Не выбрана организация.';en='Not selected organization.'"));	
	...
	Иначе
		...
		ПоказатьПредупреждение(, НСтр("ka='В справочник ""Регистрации в налоговом органе"" не добавлены налоговые органы.';ru='В справочник ""Регистрации в налоговом органе"" не добавлены налоговые органы.';en='The reference ""Registration with the tax authority"" is not added to the tax authorities.'"));
