...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ЗаймыСотрудникам"].Теги = НСтр("ka='Деньги,Кредиты,Займы,Зарплата';ru='Деньги,Кредиты,Займы,Зарплата'");
	НастройкиВариантов["КредитыПолученные"].Теги = НСтр("ka='Деньги,Кредиты,Займы';ru='Деньги,Кредиты,Займы'");
