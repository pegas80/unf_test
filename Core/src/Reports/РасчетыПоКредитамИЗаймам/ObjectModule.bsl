...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["КредитыВыданные"].Теги = НСтр("ka='Деньги,Кредиты,Займы';ru='Деньги,Кредиты,Займы';en='Money, credit, loans'");
...
Процедура ДобавитьОписанияСвязанныхПолей(НастройкиВариантов)
	...
	ОтчетыУНФ.ДобавитьОписаниеПривязки(НастройкиВариантов["КредитыВыданные"].СвязанныеПоля, "Контрагент", "Справочник.Контрагенты");
