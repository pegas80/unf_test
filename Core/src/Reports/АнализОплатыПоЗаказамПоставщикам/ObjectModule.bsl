...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Контрагенты,Поставщики,Заказы,Оплаты,Авансы,Долги';ru='Контрагенты,Поставщики,Заказы,Оплаты,Авансы,Долги';en='Contractors, Suppliers, Orders, Payments, Advances Debts'");
