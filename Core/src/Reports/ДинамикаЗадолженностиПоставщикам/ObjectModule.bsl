...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ДинамикаЗадолженности"].Теги = НСТР("ka='Деньги,Долги,Авансы,Поставщики';ru='Деньги,Долги,Авансы,Поставщики';en='Money Debts Advances Suppliers'");
