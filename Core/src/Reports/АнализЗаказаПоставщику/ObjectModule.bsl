...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Номенклатура,Заказы,Оплаты,Поступления,Запасы,Закупки,Резервы';ru='Номенклатура,Заказы,Оплаты,Поступления,Запасы,Закупки,Резервы'");
