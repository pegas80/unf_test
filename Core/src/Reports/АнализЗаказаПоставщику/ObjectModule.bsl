...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Номенклатура,Заказы,Оплаты,Поступления,Запасы,Закупки,Резервы';ru='Номенклатура,Заказы,Оплаты,Поступления,Запасы,Закупки,Резервы';en='Nomenclature, ordering, payment, receipts, inventory, purchasing, Reserves'");
