...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Товары,Ячейка';ru='Запасы,Закупки,Номенклатура,Товары,Ячейка'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Товары,Ячейка';ru='Запасы,Закупки,Номенклатура,Товары,Ячейка'");
