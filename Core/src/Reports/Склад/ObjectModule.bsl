...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Товары,Ячейка';ru='Запасы,Закупки,Номенклатура,Товары,Ячейка';en='Inventories, Purchases, Inventory, Items Cell'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Товары,Ячейка';ru='Запасы,Закупки,Номенклатура,Товары,Ячейка';en='Inventories, Purchases, Inventory, Items Cell'");
