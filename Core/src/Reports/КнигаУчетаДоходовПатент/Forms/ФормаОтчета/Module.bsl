...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = НСтр("ka='Книга доходов по патенту';ru='Книга доходов по патенту';en='The book yield on patent'");
...
Функция ПоместитьТабличныеДокументыВоВременноеХранилище(НастройкиСохранения)
	...
	ПрефиксИмени = НСтр("ru='Книга учета доходов ';ka='Книга учета доходов '") + Отчеты.КнигаУчетаДоходовИРасходов.ПолучитьПредставлениеПериода(КонецКвартала(Отчет.КонецПериода));
