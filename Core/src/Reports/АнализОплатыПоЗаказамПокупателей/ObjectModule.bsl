...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Контрагенты,Покупатели,Заказы,Оплаты,Авансы,Долги';ru='Контрагенты,Покупатели,Заказы,Оплаты,Авансы,Долги';en='Accounts, Customers, Orders, Payments, Advances Debts'");
