...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';ru='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';en='Settlements, debts Advances Accounts, Customers, Suppliers'");
	НастройкиВариантов["ВедомостьКратко"].Теги = НСТР("ka='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';ru='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';en='Settlements, debts Advances Accounts, Customers, Suppliers'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ka='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';ru='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';en='Settlements, debts Advances Accounts, Customers, Suppliers'");
	НастройкиВариантов["ВедомостьКраткоКонтекст"].Теги = НСТР("ka='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики,Валюты';ru='Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики,Валюты';en='Settlements, debts Advances Accounts, Customers, Suppliers, Currency'");
