...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Компания,Доходы,Расходы,Направление деятельности';ru='Компания,Доходы,Расходы,Направление деятельности';en='The company, revenues, expenses, activity Direction'");
