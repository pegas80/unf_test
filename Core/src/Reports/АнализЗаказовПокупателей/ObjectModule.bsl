...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Покупатели,Номенклатура,Заказы,Отгрузки,Запасы,Закупки,Резервы,Продажи';ru='Покупатели,Номенклатура,Заказы,Отгрузки,Запасы,Закупки,Резервы,Продажи'");
