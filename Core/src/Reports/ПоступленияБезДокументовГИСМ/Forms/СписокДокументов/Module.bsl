...
Процедура СформироватьЗаголовкиФормы(Параметры)
	...
	Если Параметры.ИмяНабораДанных = "КиЗ" Тогда
		Заголовок = НСтр("ka='Несопоставленные документы поступления и ""Заявки на выпуски КиЗ""';ru='Несопоставленные документы поступления и ""Заявки на выпуски КиЗ""'");
	...
	ИначеЕсли Параметры.ИмяНабораДанных = "МаркированныеТовары" Тогда
		Заголовок = НСтр("ka='Несопоставленные документы поступления и ""Уведомления о поступлении""';ru='Несопоставленные документы поступления и ""Уведомления о поступлении""'");
...
Процедура СформириватьПредставлениеОтборы(Параметры)
	...
	ТекстПредставленияОтбора = НСтр("ka='Номер КиЗ: %1, Организация : %2, Контрагент: %3.';ru='Номер КиЗ: %1, Организация : %2, Контрагент: %3.'");
