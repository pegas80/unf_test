...
Процедура ВывестиСоставИзделия(ТаблицаСостава, Макет, ОформлениеСтроки)
	...
	Если ТаблицаСостава.Количество() < 2 Тогда
		...
		Сообщение.Текст = НСтр("ka='Не заполнен нормативный состав изделия';ru='Не заполнен нормативный состав изделия';en='Not filled normative composition of the product'");
		Сообщение.Сообщить();
...
Процедура СформироватьОтчет(Номенклатура, Характеристика, Спецификация)
	...
	Если НЕ ЗначениеЗаполнено(Номенклатура) Тогда
		...
		ТекстСообщения = НСтр("ka='Поле Номенклатура не заполнено';ru='Поле Номенклатура не заполнено';en='Field filled not Nomenclature'");
	...
	Если НЕ ЗначениеЗаполнено(Спецификация) Тогда
		...
		ТекстСообщения = НСтр("ka='Поле Спецификация не заполнено';ru='Поле Спецификация не заполнено';en='Specification field is not filled'");
...
"';ka='Нормативный состав изделия на %1"
"Изделие: %2%3, спецификация ""%4"""
"Количество: %5 %6, стоимость: %7 %8"
"'"),
