...
Процедура ВывестиСоставИзделия(ТаблицаСостава, Макет, ОформлениеСтроки)
	...
	Если ТаблицаСостава.Количество() < 2 Тогда
		...
		Сообщение.Текст = НСтр("ka='Не заполнен нормативный состав изделия';ru='Не заполнен нормативный состав изделия'");
		Сообщение.Сообщить();
...
Процедура СформироватьОтчет(Номенклатура, Характеристика, Спецификация)
	...
	Если НЕ ЗначениеЗаполнено(Номенклатура) Тогда
		...
		ТекстСообщения = НСтр("ka='Поле Номенклатура не заполнено';ru='Поле Номенклатура не заполнено'");
	...
	Если НЕ ЗначениеЗаполнено(Спецификация) Тогда
		...
		ТекстСообщения = НСтр("ka='Поле Спецификация не заполнено';ru='Поле Спецификация не заполнено'");
