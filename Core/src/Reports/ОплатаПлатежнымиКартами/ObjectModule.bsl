...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["ОплатаПлатежнымиКартами"].Теги = НСтр("ka='Деньги,Платежная карта,Безнал,Эквайринг';ru='Деньги,Платежная карта,Безнал,Эквайринг';en='Cash, payment cards, clearing, Acquiring'");
