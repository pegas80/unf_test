...
Процедура ПроверитьКС_2(СтруктураРезультата)
	...
	ОписаниеКС = НСтр("ka='Значение базовой доходности на единицу физического показателя (строка 040 Раздела 2) должно соответствовать значению из Справочника ""Коды видов предпринимательской деятельности и значения базовой доходности на единицу физического показателя""';ru='Значение базовой доходности на единицу физического показателя (строка 040 Раздела 2) должно соответствовать значению из Справочника ""Коды видов предпринимательской деятельности и значения базовой доходности на единицу физического показателя""'");
	
	Нарушение      = НСтр("ka='Неправильное применение значений базовой доходности на единицу физического показателя';ru='Неправильное применение значений базовой доходности на единицу физического показателя'");
	ОписаниеОшибки = НСтр("ru=''");
...
Процедура ПроверитьКС_4(СтруктураРезультата)
	...
	ОписаниеКС   = НСтр("ka='Сумма исчисленного единого налога на вмененный доход (строка 110 Раздела 2) должна быть равна произведению налоговой базы (строка 100 Раздела 2) и налоговой ставки 15% по одноименному ОКТМО.';ru='Сумма исчисленного единого налога на вмененный доход (строка 110 Раздела 2) должна быть равна произведению налоговой базы (строка 100 Раздела 2) и налоговой ставки 15% по одноименному ОКТМО.'");
