...
Процедура ПроверитьКС_1(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 1 (КС 1)';ru='Проверка раздела 1 (КС 1)'");
...
Процедура ПроверитьКС_2(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 2 (КС 2)';ru='Проверка раздела 2 (КС 2)'");
...
Процедура ПроверитьКС_3(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 2 (КС 3)';ru='Проверка раздела 2 (КС 3)'");
...
Процедура ПроверитьКС_4(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 2 (КС 4)';ru='Проверка раздела 2 (КС 4)'");
...
Процедура ПроверитьКС_5(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 3 (КС 5)';ru='Проверка раздела 3 (КС 5)'");
...
Процедура ПроверитьКС_6_1(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 3 (КС 6.1)';ru='Проверка раздела 3 (КС 6.1)'");
...
Процедура ПроверитьКС_6_2(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 3 (КС 6.2)';ru='Проверка раздела 3 (КС 6.2)'");
