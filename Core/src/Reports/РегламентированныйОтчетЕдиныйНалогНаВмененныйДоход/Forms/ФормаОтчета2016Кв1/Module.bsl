...
Процедура ПроверитьКС_1(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 1 (КС 1)';ru='Проверка раздела 1 (КС 1)';en='Checking section 1 (COP-1)'");
...
Процедура ПроверитьКС_2(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 2 (КС 2)';ru='Проверка раздела 2 (КС 2)';en='Checking section 2 (CS 2)'");
...
Процедура ПроверитьКС_3(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 2 (КС 3)';ru='Проверка раздела 2 (КС 3)';en='Checking section 2 (CS 3)'");
...
Процедура ПроверитьКС_4(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 2 (КС 4)';ru='Проверка раздела 2 (КС 4)';en='Checking section 2 (CS 4)'");
...
Процедура ПроверитьКС_5(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 3 (КС 5)';ru='Проверка раздела 3 (КС 5)';en='Testing Section 3 (CS 5)'");
...
Процедура ПроверитьКС_6_1(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 3 (КС 6.1)';ru='Проверка раздела 3 (КС 6.1)';en='Testing Section 3 (6.1 CS)'");
	ОписаниеКС   = НСтр("ka='Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строке 010 Раздела 3 и по строке 020 Раздела 3, если результат такого вычитания больше или равен 50% строки 010 Раздела 3 и строка 005 Раздела 3 = ""1""';ru='Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строке 010 Раздела 3 и по строке 020 Раздела 3, если результат такого вычитания больше или равен 50% строки 010 Раздела 3 и строка 005 Раздела 3 = ""1""';en='Amount single imputed income tax to be paid (line 040 Section 3) must be equal to the difference values ​​for line 010, Section 3, and line 020, Section 3, when the result of the subtraction is greater than or equal to 50% of the lines 010, Section 3, and line 005 of Section 3 = ""1""'");
...
Процедура ПроверитьКС_6_2(СтруктураРезультата)
	...
	ТекстФормулы = НСтр("ka='Проверка раздела 3 (КС 6.2)';ru='Проверка раздела 3 (КС 6.2)';en='Testing Section 3 (6.2 CS)'");
	ОписаниеКС   = НСтр("ka='Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строкам 010 Раздела 3 и по строке 030 Раздела 3, если результат такого вычитания больше или равен нулю и строка 005 Раздела 3 = ""2""';ru='Сумма единого налога на вмененный доход, подлежащий к уплате (строка 040 Раздела 3) должна быть равна разнице значений по строкам 010 Раздела 3 и по строке 030 Раздела 3, если результат такого вычитания больше или равен нулю и строка 005 Раздела 3 = ""2""';en='Amount single imputed income tax to be paid (line 040 Section 3) must be equal to the difference values ​​in the lines 010, Section 3, and line 030, Section 3, when the result of the subtraction is greater than or equal to zero and the row 005, Section 3 = ""2""'");
