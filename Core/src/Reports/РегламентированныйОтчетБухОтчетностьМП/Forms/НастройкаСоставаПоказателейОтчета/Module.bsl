...
Процедура ЗакрытьФорму(Команда)
	...
	Если Модифицированность Тогда
		...
		ТекстВопроса = НСтр("ka='Состав дополнительных строк был изменен. Сохранить изменения?';ru='Состав дополнительных строк был изменен. Сохранить изменения?';en='Composition additional lines has been changed. I save changes?'");
...
"иначе изменения будут утеряны.';ka='Состав дополнительных строк был изменен."
"Перед завершением работы рекомендуется сохранить новый состав,"
