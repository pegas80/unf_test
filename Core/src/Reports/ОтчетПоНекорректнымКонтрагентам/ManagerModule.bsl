...
Функция НаименованиеСостояния(Состояние)
	...
	Если Состояние = Перечисления.СостоянияСуществованияКонтрагента.КонтрагентОтсутствуетВБазеФНС Тогда
		Наименование = НСтр("ka='По данным ЕГРН сведения о контрагентах отсутствуют';ru='По данным ЕГРН сведения о контрагентах отсутствуют'");
	ИначеЕсли Состояние = Перечисления.СостоянияСуществованияКонтрагента.КППНеСоответствуетДаннымБазыФНС Тогда
		Наименование = НСтр("ka='По данным ЕГРН у контрагентов другой КПП';ru='По данным ЕГРН у контрагентов другой КПП'");
	ИначеЕсли Состояние = Перечисления.СостоянияСуществованияКонтрагента.НеДействуетИлиИзмененКПП Тогда
		Наименование = НСтр("ka='По данным ЕГРН контрагенты недействующие';ru='По данным ЕГРН контрагенты недействующие'");
	КонецЕсли;
