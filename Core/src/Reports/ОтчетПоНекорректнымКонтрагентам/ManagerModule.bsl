...
Функция НаименованиеСостояния(Состояние)
	...
	Если Состояние = Перечисления.СостоянияСуществованияКонтрагента.КонтрагентОтсутствуетВБазеФНС Тогда
		Наименование = НСтр("ka='По данным ЕГРН сведения о контрагентах отсутствуют';ru='По данным ЕГРН сведения о контрагентах отсутствуют';en='According USRRE no information about contractors'");
	ИначеЕсли Состояние = Перечисления.СостоянияСуществованияКонтрагента.КППНеСоответствуетДаннымБазыФНС Тогда
		Наименование = НСтр("ka='По данным ЕГРН у контрагентов другой КПП';ru='По данным ЕГРН у контрагентов другой КПП';en='According USRRE with counterparties other PPC'");
	ИначеЕсли Состояние = Перечисления.СостоянияСуществованияКонтрагента.НеДействуетИлиИзмененКПП Тогда
		Наименование = НСтр("ka='По данным ЕГРН контрагенты недействующие';ru='По данным ЕГРН контрагенты недействующие';en='According USRRE counterparties inactive'");
	КонецЕсли;
