...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Деньги,Платежная карта,Безнал,Эквайринг';ru='Деньги,Платежная карта,Безнал,Эквайринг'");
	НастройкиВариантов["ОсновнойБезРазнесенияПоОперациямОплаты"].Теги = НСтр("ka='Деньги,Платежная карта,Безнал,Эквайринг';ru='Деньги,Платежная карта,Безнал,Эквайринг'");
