...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Деньги,Платежная карта,Безнал,Эквайринг';ru='Деньги,Платежная карта,Безнал,Эквайринг';en='Cash, payment cards, clearing, Acquiring'");
	НастройкиВариантов["ОсновнойБезРазнесенияПоОперациямОплаты"].Теги = НСтр("ka='Деньги,Платежная карта,Безнал,Эквайринг';ru='Деньги,Платежная карта,Безнал,Эквайринг';en='Cash, payment cards, clearing, Acquiring'");
