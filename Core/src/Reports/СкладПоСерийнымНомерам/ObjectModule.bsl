...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Товары,Серийные номера';ru='Запасы,Закупки,Номенклатура,Товары,Серийные номера'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Товары,Серийные номера';ru='Запасы,Закупки,Номенклатура,Товары,Серийные номера'");
