...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Долги"].Теги = НСТР("ka='Главное,Запасы,Закупки,Продажи,Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики';ru='Главное,Запасы,Закупки,Продажи,Взаиморасчеты,Долги,Авансы,Контрагенты,Покупатели,Поставщики'");
...
Процедура ОбработатьШапкуИПодвал(ТабличныйДокумент)
	...
	Для ИндексСтроки = 1 По ТабличныйДокумент.ВысотаТаблицы Цикл
		...
		Для ИндексКолонки = 1 По ТабличныйДокумент.ШиринаТаблицы Цикл
			...
			ОбработатьЗаголовокКолонки(ИмяОбластиНачОст, ИндексКолонки, ИндексСтроки, ТабличныйДокумент, ТекстЗаголовка, НСтр("ka='(нач. ост.)';ru='(нач. ост.)'"));
			
			ОбработатьЗаголовокКолонки(ИмяОбластиКонОст, ИндексКолонки, ИндексСтроки, ТабличныйДокумент, ТекстЗаголовка, НСтр("ka='(кон. ост.)';ru='(кон. ост.)'"));
		...
		НСтр("ka='Начальный остаток';ru='Начальный остаток'"));
		
		УстановитьТекстОбласти(
		ТабличныйДокумент,
		ИмяОбластиКонОст,
		Формат(ПараметрПериодОтчета.Значение.ДатаОкончания, "ДЛФ=D"),
		НСтр("ka='Конечный остаток';ru='Конечный остаток'"));
