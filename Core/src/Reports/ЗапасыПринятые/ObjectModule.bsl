...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Комиссия';ru='Запасы,Закупки,Номенклатура,Комиссия';en='Inventories, Purchases, Inventory, Commission'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Комиссия';ru='Запасы,Закупки,Номенклатура,Комиссия';en='Inventories, Purchases, Inventory, Commission'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Переработка,Производство';ru='Запасы,Закупки,Номенклатура,Переработка,Производство';en='Inventories, Purchases, Inventory, Processing, Production'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Ответхранение';ru='Запасы,Закупки,Номенклатура,Ответхранение';en='Inventories, Purchases, Inventory, otvethranenie'");
