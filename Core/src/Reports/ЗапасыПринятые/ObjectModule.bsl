...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Комиссия';ru='Запасы,Закупки,Номенклатура,Комиссия'");
	НастройкиВариантов["Остатки"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Комиссия';ru='Запасы,Закупки,Номенклатура,Комиссия'");
	НастройкиВариантов["ЗапасыВПереработке"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Переработка,Производство';ru='Запасы,Закупки,Номенклатура,Переработка,Производство'");
	НастройкиВариантов["ЗапасыНаОтветхранении"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура,Ответхранение';ru='Запасы,Закупки,Номенклатура,Ответхранение'");
