...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Компания,Доходы,Расходы,Направление деятельности';ru='Компания,Доходы,Расходы,Направление деятельности'");
	НастройкиВариантов["ДоходыИРасходыПоЗаказам"].Теги = НСТР("ka='Компания,Доходы,Расходы,Заказы';ru='Компания,Доходы,Расходы,Заказы'");
	НастройкиВариантов["ДинамикаДоходовИРасходов"].Теги = НСТР("ka='Компания,Доходы,Расходы,Направление деятельности';ru='Компания,Доходы,Расходы,Направление деятельности'");
