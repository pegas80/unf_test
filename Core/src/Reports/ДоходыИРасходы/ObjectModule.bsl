...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Компания,Доходы,Расходы,Направление деятельности';ru='Компания,Доходы,Расходы,Направление деятельности';en='The company, revenues, expenses, activity Direction'");
	НастройкиВариантов["ДоходыИРасходыПоЗаказам"].Теги = НСТР("ka='Компания,Доходы,Расходы,Заказы';ru='Компания,Доходы,Расходы,Заказы';en='Company, Income, Expenses, Purchase Orders'");
	НастройкиВариантов["ДинамикаДоходовИРасходов"].Теги = НСТР("ka='Компания,Доходы,Расходы,Направление деятельности';ru='Компания,Доходы,Расходы,Направление деятельности';en='The company, revenues, expenses, activity Direction'");
