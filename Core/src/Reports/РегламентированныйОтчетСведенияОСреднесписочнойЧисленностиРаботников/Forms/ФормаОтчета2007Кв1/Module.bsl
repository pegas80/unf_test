...
Процедура ЗаполнитьДатуПериода()
	...
	ОтчетныйГод = СтрЗаменить(Формат(Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета), "ЧРГ=%"), "%", "") + НСтр("ru=' г.      ';ka=' г.      '");
	ТекущийГод  = СтрЗаменить(Формат(Год(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета) + 1, "ЧРГ=%"), "%", "") + НСтр("ru=' г.      ';ka=' г.      '");
	
	СтруктураРеквизитовФормы.ДатаПериод = Новый СписокЗначений;
	
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(1, НСтр("ru=' 1 января ';ka=' 1 января '") + ТекущийГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(12, НСтр("ru=' 1 декабря ';ka=' 1 декабря '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(11, НСтр("ru=' 1 ноября ';ka=' 1 ноября '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(10, НСтр("ru=' 1 октября ';ka=' 1 октября '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(9, НСтр("ru=' 1 сентября ';ka=' 1 сентября '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(8, НСтр("ru=' 1 августа ';ka=' 1 августа '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(7, НСтр("ru=' 1 июля ';ka=' 1 июля '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(6, НСтр("ru=' 1 июня ';ka=' 1 июня '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(5, НСтр("ru=' 1 мая ';ka=' 1 мая '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(4, НСтр("ru=' 1 апреля ';ka=' 1 апреля '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(3, НСтр("ru=' 1 марта ';ka=' 1 марта '") + ОтчетныйГод);
	СтруктураРеквизитовФормы.ДатаПериод.Добавить(2, НСтр("ru=' 1 февраля ';ka=' 1 февраля '") + ОтчетныйГод);
