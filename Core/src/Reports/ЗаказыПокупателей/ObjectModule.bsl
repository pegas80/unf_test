...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Заказы,Продажи';ru='Заказы,Продажи';en='Orders, Sales'");
	НастройкиВариантов["Остатки"].Теги = НСТР("ka='Заказы,Продажи';ru='Заказы,Продажи';en='Orders, Sales'");
