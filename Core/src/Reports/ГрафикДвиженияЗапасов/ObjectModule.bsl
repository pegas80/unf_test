...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Запасы,Закупки,Заказы,Отгрузки,Поступления';ru='Запасы,Закупки,Заказы,Отгрузки,Поступления';en='Inventories, Purchases, Orders, Shipments, Revenues'");
