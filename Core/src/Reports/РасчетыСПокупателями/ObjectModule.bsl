...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Деньги,Контрагенты,Покупатели,Дебиторка,Продажи,Работы';ru='Деньги,Контрагенты,Покупатели,Дебиторка,Продажи,Работы';en='Money Accounts, Customers, Receivables, Sales, Work'");
	КонецЦикла;
