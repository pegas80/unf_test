...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	Форма,
	"СостояниеОтгрузки",
	НСтр("ka='გადმოტვირთვის მდგომარეობა';ru='Состояние отгрузки';en='Status of shipment'"),
	...
	Форма,
	"СостояниеОплаты",
	НСтр("ka='გადახდის მდგომარეობა';ru='Состояние оплаты';en='payment Status'"),
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Продажи,CRM';ru='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Продажи,CRM';en='Orders, Accounts, Customers, Inventory, Shipping, Payments, Sales, CRM'");
	//НастройкиВариантов["ВыполнениеИОплатаЗаказНарядов"].Теги = НСтр("ka='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Работы';ru='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Работы';en='Orders, Accounts, Customers, Inventory, Shipping, payment, work'");
