...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Описание = НСтр("ka='Согласия на обработку персональных данных, срок действия которых истекает.';ru='Согласия на обработку персональных данных, срок действия которых истекает.'");
	
	НастройкиВарианта = МодульВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ИстекающиеСогласия");
	НастройкиВарианта.Описание = НСтр("ka='Согласия, срок действия которых истекает в заданном периоде.';ru='Согласия, срок действия которых истекает в заданном периоде.'");
КонецПроцедуры
