...
Процедура ВывестиЖурналПроводокРегл()
	...
	ОбластьЗаголовок.Параметры.СинонимРегистра = НСтр("ka='ბუღალტრული რეგისტრი ""ბუღალტრული გატარებების ჟურნალი""';ru='Регистр бухгалтерии ""Хозрасчетный""';en='Accounting register ""Self-supporting""'");
	ТабличныйДокумент.Вывести(ОбластьЗаголовок);
	ТабличныйДокумент.НачатьГруппуСтрок();
...
Процедура ВывестиЖурналПроводокПлан()
	...
	ОбластьЗаголовок.Параметры.СинонимРегистра = НСтр("ka='ბუღალტრული რეგისტრი ""ბუღალტრული გატარებების ჟურნალი""';ru='Регистр бухгалтерии ""Хозрасчетный (план)""';en='Accounting register ""Self-supporting (plan)""'");
	ТабличныйДокумент.Вывести(ОбластьЗаголовок);
	ТабличныйДокумент.НачатьГруппуСтрок();
