	...
	ИначеЕсли СтрНачинаетсяС(Область.Имя, "П00321М119001")
		...
		Для каждого Эл Из СписокМесяцев Цикл
			Если Эл.Значение = "01" Тогда
				Эл.Представление = НСтр("ka='01 - январь';ru='01 - январь';en='01 - January'");
			ИначеЕсли Эл.Значение = "02" Тогда
				Эл.Представление = НСтр("ka='02 - февраль';ru='02 - февраль';en='02 - February'");
			ИначеЕсли Эл.Значение = "03" Тогда
				Эл.Представление = НСтр("ka='03 - март';ru='03 - март';en='03 - March'");
			...
			ИначеЕсли Эл.Значение = "10" Тогда
				Эл.Представление = НСтр("ka='10 - октябрь';ru='10 - октябрь';en='10 - October'");
			ИначеЕсли Эл.Значение = "11" Тогда
				Эл.Представление = НСтр("ka='11 - ноябрь';ru='11 - ноябрь';en='11 - November'");
			ИначеЕсли Эл.Значение = "12" Тогда
				Эл.Представление = НСтр("ka='12 - декабрь';ru='12 - декабрь';en='12 - December'");
			КонецЕсли;
		КонецЦикла;
...
Процедура ТабличныйДокументПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если ИмяПоказателя = "П000010001001"
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='Код по ОКТМО должен состоять из 8 или 11 цифр. Значение очищено.';ru='Код по ОКТМО должен состоять из 8 или 11 цифр. Значение очищено.';en='by OKTMO code must consist of 8 or 11 digits. Meaning purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяПоказателя = "П000010002001"
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='Код бюджетной классификации должен состоять из 20 цифр. Значение очищено.';ru='Код бюджетной классификации должен состоять из 20 цифр. Значение очищено.';en='budget classification code shall consist of 20 digits. Meaning purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяПоказателя = "П000110000101" Тогда
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='Код тарифа должен состоять из 2 цифр. Значение очищено.';ru='Код тарифа должен состоять из 2 цифр. Значение очищено.';en='tariff code must consist of 2 digits. Meaning purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00019М105001")
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='ИНН физического лица должен состоять из 12 цифр. Значение очищено.';ru='ИНН физического лица должен состоять из 12 цифр. Значение очищено.';en='INN natural person shall consist of 12 digits. Meaning purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П00019М106001")
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='СНИЛС должен состоять из 14 символов и соответствовать одному из шаблонов: ""ХХХ-ХХХ-ХХХ-ХХ"", ""ХХХ-ХХХ-ХХХ ХХ"" (X - любая цифра). Значение очищено.';ru='СНИЛС должен состоять из 14 символов и соответствовать одному из шаблонов: ""ХХХ-ХХХ-ХХХ-ХХ"", ""ХХХ-ХХХ-ХХХ ХХ"" (X - любая цифра). Значение очищено.';en='SNILS must consist of 14 characters and fit one of the patterns: ""XXX-XXX-XXX-XX"", ""XXX-XXX-XXX XX"" (X - any number). Meaning purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяПоказателя = "П000310014001" Тогда
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='Код вида документа должен состоять из 2 цифр. Значение очищено.';ru='Код вида документа должен состоять из 2 цифр. Значение очищено.';en='Document type code must consist of 2 digits. Meaning purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если ИмяПоказателя = "П000310015001"
		...
		Иначе
			Область.Значение = "";
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = НСтр("ka='Общее количество символов в серии и номере документа не должно превышать 24. Значение очищено.';ru='Общее количество символов в серии и номере документа не должно превышать 24. Значение очищено.';en='The total number of symbols in series and the document number should not exceed 24. The value purified.'");
			Сообщение.Сообщить();
		КонецЕсли;
	КонецЕсли;
	...
	Если СтрНачинаетсяС(ИмяПоказателя, "П000010011")
		...
		Если ОблПарногоПоказателя <> Неопределено Тогда
			...
			Если ЗначениеЗаполнено(ЗначПоказателя)
				...
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Не допускается одновременное заполнение строки %1 и строки %2. Значение в строке %2 очищено.';ru='Не допускается одновременное заполнение строки %1 и строки %2. Значение в строке %2 очищено.';en='Not allowed simultaneous% filling line 1 and line 2%. The value in row 2% purified.'"),
				Стр1, Стр2);
				Сообщение.Сообщить();
		...
		Если ОблПарногоПоказателя1 <> Неопределено
			...
			Если ЗначениеЗаполнено(ЗначПоказателя)
				...
				Если ЗначениеЗаполнено(ЗначПарногоПоказателя1)
					...
					НСтр("ka='Значения в строках %1 и %2 очищены';ru='Значения в строках %1 и %2 очищены';en='The values ​​in rows 1% and 2% purified'"), Стр1, Стр2);
				Иначе
					ДополнительныйТекст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ka='Значение в строке %1 очищено';ru='Значение в строке %1 очищено';en='The value in row 1% purified'"),
					?(ЗначениеЗаполнено(ЗначПарногоПоказателя1), Стр1, Стр2));
				КонецЕсли;
				Сообщение = Новый СообщениеПользователю;
				Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Не допускается одновременное указание сведений, подтверждающих членство в студенческом отряде, и сведений, подтверждающих очную форму обучения. %1.';ru='Не допускается одновременное указание сведений, подтверждающих членство в студенческом отряде, и сведений, подтверждающих очную форму обучения. %1.';en='It is not allowed the simultaneous indication of data confirming membership in student teams, and information confirming the full-time training. %one.'"),
				ДополнительныйТекст);
				Сообщение.Сообщить();
				Мофицированность = Истина;
			КонецЕсли;
	...
	Если ИмяПоказателя = "П000030004001" Тогда
		...
		Если ЗначениеЗаполнено(ПредставлениеСтраницыРаздела3НайденнойПоЗначениюВСтроке040) Тогда
			Область.Очистить();
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Номер %1 уже используется на странице ""%2"". Значение в строке 040 очищено.';ru='Номер %1 уже используется на странице ""%2"". Значение в строке 040 очищено.';en='Number of% 1 is already in use on the page ""%2"". Value on line 040 cleared.'"),
...
Процедура ДобавитьСтроку(Команда)
	...
	Если СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1" Тогда
		...
		Если СтрНачинаетсяС(ИмяОбласти, СтруктураРеквизитовФормы.мИдГруппы1М1) Тогда
			...
			Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + "_4") <> Неопределено Тогда
				ТекстПредупреждения = НСтр("ka='Нельзя добавлять более четырех групп строк 060-073 в разделе 1.';ru='Нельзя добавлять более четырех групп строк 060-073 в разделе 1.';en='You can not add more than four groups of lines 060-073 in Section 1.'");
			КонецЕсли;
		...
		ИначеЕсли СтрНачинаетсяС(ИмяОбласти, СтруктураРеквизитовФормы.мИдГруппы1М2) Тогда
			...
			Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + "_2") <> Неопределено Тогда
				ТекстПредупреждения = НСтр("ka='Нельзя добавлять более двух групп строк 080-093 в разделе 1.';ru='Нельзя добавлять более двух групп строк 080-093 в разделе 1.';en='Do not add more than two groups of lines 080-093, see 1.'");
			КонецЕсли;
	...
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1Прил1Подр1_3_1" Тогда
		...
		Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + "_2") <> Неопределено Тогда
			ТекстПредупреждения = НСтр("ka='Нельзя добавлять более двух групп строк 001-050 в подразделе 1.3.1 приложения 1 к разделу 1.';ru='Нельзя добавлять более двух групп строк 001-050 в подразделе 1.3.1 приложения 1 к разделу 1.';en='Do not add more than two groups of lines 001-050 in Section 1.3.1 of Annex 1 to the section 1.'");
		КонецЕсли;
	...
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1Прил1Подр1_3_2" Тогда
		...
		Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + "_30") <> Неопределено Тогда
			ТекстПредупреждения = НСтр("ka='Нельзя добавлять более тридцати групп строк 001-050 в подразделе 1.3.2 приложения 1 к разделу 1.';ru='Нельзя добавлять более тридцати групп строк 001-050 в подразделе 1.3.2 приложения 1 к разделу 1.';en='You can not add more than thirty groups of lines 001-050 in Section 1.3.2, Annex 1, section 1.'");
		КонецЕсли;
	...
	ИначеЕсли СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел1Прил1Подр1_4" Тогда
		...
		Если ТабличныйДокумент.Области.Найти(ИмяПервойГрафы + "_2") <> Неопределено Тогда
			ТекстПредупреждения = НСтр("ka='Нельзя добавлять более двух групп строк 001-050 в подразделе 1.4 приложения 1 к разделу 1.';ru='Нельзя добавлять более двух групп строк 001-050 в подразделе 1.4 приложения 1 к разделу 1.';en='Do not add more than two groups of rows 001-050 in section 1.4 of Annex 1 to the section 1.'");
		КонецЕсли;
...
Процедура ВыгрузитьСведенияРаботниковЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если НЕ ПроверитьВозможностьВыгрузкиСведенийРаботников(ПараметрыВыгрузки) Тогда
		...
		НСтр("ka='Не удалось выгрузить сведения работающих лиц из Раздела 3 (%1).';ru='Не удалось выгрузить сведения работающих лиц из Раздела 3 (%1).';en='Unable to unload the information of employees of Section 3 (1%).'"), ПредставлениеРасчетаПоСтраховымВзносам);
		Сообщение.Сообщить();
...
Процедура ОчиститьТекущуюСтраницу(Команда)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='ყურადღება! მიმდინარე გვერდი გასუფთავდება.%1გავაგრძელოთ?';ru='Внимание! Будет очищена текущая страница.%1Продолжить?';en='Attention! the current page will be cleared.% 1Prodolzhit?'"), Символы.ПС);
...
Процедура ПомещениеФайлаСДаннымиДляРаздела3(Результат, АдресФайла, ВыбИмяФайла, ДопПараметры) Экспорт
	...
	Если Результат Тогда
		...
		Если Прав(ВыбИмяФайла, 5) <> ".pncb" Тогда
			...
			ПоказатьПредупреждение(, НСтр("ka='Необходимо выбрать файл, содержащий персонифицированные сведения о застрахованных лицах, с расширением ""pncb""!';ru='Необходимо выбрать файл, содержащий персонифицированные сведения о застрахованных лицах, с расширением ""pncb""!';en='You must select a file containing personalized information on the insured persons with the extension ""pncb""!'"));
		...
		Если ЗаполнениеРаздела3ВыполненоУспешно Тогда
			...
			Сообщение = Новый СообщениеПользователю;
			Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ka='Данные файла %1, содержащего персонифицированные сведения о застрахованных лицах, успешно импортированы.';ru='Данные файла %1, содержащего персонифицированные сведения о застрахованных лицах, успешно импортированы.';en='Data file% 1 containing personalized information on the insured persons are successfully imported.'"), ВыбИмяФайла);
			Сообщение.Сообщить();
...
Процедура ЗаполнитьРаздел3ДаннымиИзФайла(АдресФайла, ПолноеИмяФайла, Каталог, ЗаполнениеРаздела3ВыполненоУспешно)
	...
	Если НЕ (Файл_Версия = Отчет_Версия
		...
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = НСтр("ka='Данные файла, содержащего персонифицированные сведения о застрахованных лицах, не соответствует экземпляру отчета!';ru='Данные файла, содержащего персонифицированные сведения о застрахованных лицах, не соответствует экземпляру отчета!';en='file data containing personalized information on the insured persons does not match the copy of the report!'");
		Сообщение.Сообщить();
		УдалитьВременныйФайл(ФайлЗагрузки);
		Возврат;
	КонецЕсли;
...
Процедура СообщитьОбОшибкеФорматаИмпорта()
	...
	Сообщение = Новый СообщениеПользователю;
	Сообщение.Текст = НСтр("ka='Нарушен формат файла, содержащего персонифицированные сведения о застрахованных лицах!';ru='Нарушен формат файла, содержащего персонифицированные сведения о застрахованных лицах!';en='Broken file format containing personalized information on the insured persons!'");
	Сообщение.Сообщить();
