...
Процедура ПоказатьПериод(Форма)
	...
	Если ГодПериода >= 2017 Тогда
		...
		Форма.НадписьКтоСдаетОтчет = НСтр("ka='Лица, производящие выплаты и иные вознаграждения физическим лицам: организации, индивидуальные предприниматели, физические лица, не являющиеся индивидуальными предпринимателями (п.1 ст.419 НК РФ).';ru='Лица, производящие выплаты и иные вознаграждения физическим лицам: организации, индивидуальные предприниматели, физические лица, не являющиеся индивидуальными предпринимателями (п.1 ст.419 НК РФ).';en='Persons making payments and other compensation to individuals: companies, individual entrepreneurs, individuals who are not individual entrepreneurs (p.1 st.419 Tax Code).'");
