...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Контрагенты,Покупатели,Счета,Оплаты,Авансы,Долги';ru='Контрагенты,Покупатели,Счета,Оплаты,Авансы,Долги';en='Accounts, Customers, Invoices, Payments, Advances Debts'");
