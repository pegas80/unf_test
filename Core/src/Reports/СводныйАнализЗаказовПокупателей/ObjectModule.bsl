...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	Форма,
	"СостояниеОтгрузки",
	НСтр("ka='გადმოტვირთვის მდგომარეობა';ru='Состояние отгрузки'"),
	...
	Форма,
	"СостояниеОплаты",
	НСтр("ka='გადახდის მდგომარეობა';ru='Состояние оплаты'"),
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Продажи,CRM';ru='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Продажи,CRM'");
	НастройкиВариантов["ВыполнениеИОплатаЗаказНарядов"].Теги = НСтр("ka='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Работы';ru='Заказы,Контрагенты,Покупатели,Номенклатура,Отгрузки,Оплаты,Работы'");
