...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		ВызватьИсключение НСтр("ka='Не заполнено значение обязательного параметра ""Организация""';ru='Не заполнено значение обязательного параметра ""Организация""';en='Not filled mandatory parameter value is the ""Organization""'");
	КонецЕсли;
	Если НЕ ЗначениеЗаполнено(Склад) Тогда
		ВызватьИсключение НСтр("ka='Не заполнено значение обязательного параметра ""Склад""';ru='Не заполнено значение обязательного параметра ""Склад""';en='Not filled with the value of a mandatory parameter ""Store""'");
	КонецЕсли;
			...
			Пока Выборка.Следующий() Цикл
				...
				Иначе
					...
					Если ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.ОтчетОРозничныхПродажах")
						...
						СодержаниеОперации = НСтр("ka='Проданная продукция';ru='Проданная продукция';en='sold products'");
						
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.РасходнаяНакладная")
						И Выборка.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику Тогда
						
						СодержаниеОперации = НСтр("ka='Продукция, возвращенная поставщику';ru='Продукция, возвращенная поставщику';en='Products returned to the supplier'");
					...
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.СписаниеЗапасов") Тогда
						...
						СодержаниеОперации = НСтр("ka='Недостачи продукции';ru='Недостачи продукции';en='shortage of products'");
					...
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.ПеремещениеЗапасов")
						...
						СодержаниеОперации = НСтр("ka='Продукция, переданная в другое подразделение';ru='Продукция, переданная в другое подразделение';en='Products transferred to another unit'");
						
					Иначе
						
						СодержаниеОперации = НСтр("ka='Списанная продукция';ru='Списанная продукция';en='Written-off products'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='გაყიდვები';ru='Продажи';en='the sale'");
