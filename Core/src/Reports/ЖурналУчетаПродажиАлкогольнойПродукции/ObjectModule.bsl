...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		ВызватьИсключение НСтр("ka='Не заполнено значение обязательного параметра ""Организация""';ru='Не заполнено значение обязательного параметра ""Организация""'");
	КонецЕсли;
	Если НЕ ЗначениеЗаполнено(Склад) Тогда
		ВызватьИсключение НСтр("ka='Не заполнено значение обязательного параметра ""Склад""';ru='Не заполнено значение обязательного параметра ""Склад""'");
	КонецЕсли;
			...
			Пока Выборка.Следующий() Цикл
				...
				Иначе
					...
					Если ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.ОтчетОРозничныхПродажах")
						...
						СодержаниеОперации = НСтр("ka='Проданная продукция';ru='Проданная продукция'");
						
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.РасходнаяНакладная")
						И Выборка.ВидОперации = Перечисления.ВидыОперацийРасходнаяНакладная.ВозвратПоставщику Тогда
						
						СодержаниеОперации = НСтр("ka='Продукция, возвращенная поставщику';ru='Продукция, возвращенная поставщику'");
					...
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.СписаниеЗапасов") Тогда
						...
						СодержаниеОперации = НСтр("ka='Недостачи продукции';ru='Недостачи продукции'");
					...
					ИначеЕсли ТипЗнч(Выборка.Регистратор) = Тип("ДокументСсылка.ПеремещениеЗапасов")
						...
						СодержаниеОперации = НСтр("ka='Продукция, переданная в другое подразделение';ru='Продукция, переданная в другое подразделение'");
						
					Иначе
						
						СодержаниеОперации = НСтр("ka='Списанная продукция';ru='Списанная продукция'");
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='გაყიდვები';ru='Продажи'");
