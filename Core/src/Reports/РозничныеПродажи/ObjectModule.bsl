...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["РозничныеПродажиКонтекст"].Теги = НСТР("ka='Главное,Продажи,Розница,Номенклатура,Выручка';ru='Главное,Продажи,Розница,Номенклатура,Выручка';en='Main, Sales, Retail, Inventory, Sales'");
	НастройкиВариантов["РозничныеПродажиПоТочкамКонтекст"].Теги = НСТР("ka='Главное,Продажи,Розница,Номенклатура,Выручка,ККМ';ru='Главное,Продажи,Розница,Номенклатура,Выручка,ККМ';en='Main, Sales, Retail, Inventory, Sales, POS'");
