...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	ТекстЗаголовкаОтчета = НСтр("ka='ბრუნვითი უწყისი ანგარიშის მიხედვით %1 %2';ru='Оборотно-сальдовая ведомость по счету %1 %2';en='Trial balance of the account% 1% 2'");
...
Процедура ПослеКомпоновкиМакета(ПараметрыОтчета, МакетКомпоновки) Экспорт
	...
	Если ПараметрыОтчета.РазвернутоеСальдо Тогда
		...
		// Kuzmich, 31.08.2023, Вставил "костылик"
		МакетПодвалаТаблицы = МакетКомпоновки.Макеты[НужыйЭлемент.Строки[0].МакетПодвала.Макет];
		// Kuzmich, 31.08.2023, Вставил "костылик"
		...
		НовыйЭлемент.Значение = НСтр("ka='შედეგი ჩაშლილი';ru='Итого развернутое';en='Total unfolded'");
		...
		// Kuzmich, 31.08.2023, Вставил "костылик"
		Для Каждого МакетРесурсаПодвала Из НужыйЭлемент.Строки[0].МакетПодвала.МакетРесурсов Цикл
		// Kuzmich, 31.08.2023, Вставил "костылик"
		...
		// Kuzmich, 31.08.2023, Вставил "костылик"
		ЗаполнитьМакетыРесурсовГруппировки(НужыйЭлемент.Строки, МакетыРесурсов, СоответствиеМакетовКолонкамОтчета, , Истина, Истина);
		// Kuzmich, 31.08.2023, Вставил "костылик"
	...
	Для Каждого СтрокаГруппировка Из ПараметрыОтчета.Группировка Цикл
		...
		Если НайденаВалюта Тогда // Нужны все последующие группировки.
			...
			// Kuzmich, 31.08.2023, Вставил "костылик"
			ИменаМакетовРесурсов = ЗаполнитьМакетыРесурсовГруппировки(НужыйЭлемент.Строки, 
				МакетГруппировкиВключеннойВВалюту, СоответствиеМакетовКолонкамОтчета, СтрокаГруппировка.Поле, Истина);
			// Kuzmich, 31.08.2023, Вставил "костылик"
...
Процедура НастроитьСтруктуруОтчета(КомпоновщикНастроек, ПараметрыОтчета)
	...
	Для каждого ЭлементОформления Из КомпоновщикНастроек.Настройки.УсловноеОформление.Элементы Цикл
		Если ЭлементОформления.Представление = НСтр("ka='ავტოდაშორების შემცირება';ru='Уменьшенный автоотступ';en='reduced autoindent'") Тогда
	...
	Если УсловноеОформлениеАвтоотступа = Неопределено Тогда
		...
		УсловноеОформлениеАвтоотступа.Представление = НСтр("ka='ავტოდაშორების შემცირება';ru='Уменьшенный автоотступ';en='reduced autoindent'");
