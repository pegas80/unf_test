...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ka='Прогресс выполнения дополнительных процедур обработки данных.';ru='Прогресс выполнения дополнительных процедур обработки данных.';en='The progress of a further data processing procedures.'");
	НастройкиВарианта.НастройкиДляПоиска.КлючевыеСлова = НСтр("ka='გადადებული განახლება';ru='Отложенное обновление';en='deferred update'");
КонецПроцедуры
