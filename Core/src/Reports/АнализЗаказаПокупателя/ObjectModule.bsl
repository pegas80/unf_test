...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСТР("ka='Номенклатура,Заказы,Оплаты,Отгрузки,Запасы,Закупки,Остатки,Резервы,Продажи';ru='Номенклатура,Заказы,Оплаты,Отгрузки,Запасы,Закупки,Остатки,Резервы,Продажи'");
