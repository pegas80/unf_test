...
Функция ПредставлениеРасшифровки(ПараметрыРасшифровки)
	...
	Возврат СтрШаблон(НСтр("ka='%1: %2, уровень воронки: %3';ru='%1: %2, уровень воронки: %3'"),
	?(ПараметрыРасшифровки.ЭтоПотери, НСтр("ka='დანაკარგი';ru='Потери'"), НСтр("ka='შეკვეთები';ru='Заказы'")),
