...
Функция ПредставлениеРасшифровки(ПараметрыРасшифровки)
	...
	Возврат СтрШаблон(НСтр("ka='%1: %2, уровень воронки: %3';ru='%1: %2, уровень воронки: %3';en='% 1,% 2, the level of the funnel: 3%'"),
	?(ПараметрыРасшифровки.ЭтоПотери, НСтр("ka='დანაკარგი';ru='Потери';en='Losses'"), НСтр("ka='შეკვეთები';ru='Заказы';en='orders'")),
