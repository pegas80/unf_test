...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			...
			"ОсновнаяФорма",
			,
			НСтр("ka='Новости: Расчетная ведомость по средствам ФСС (форма 4-ФСС)';ru='Новости: Расчетная ведомость по средствам ФСС (форма 4-ФСС)';en='News: Settlement statement for the FSS (Form 4-FSS)'"),
			Ложь,
