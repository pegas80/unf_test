...
Процедура ПроверитьВероятностныеОшибкиЗаполнения()
	...
	Если ЗначениеЗаполнено(РегистрационныйНомерСтрахователя) Тогда
		Если РегистрационныйНомерСтрахователя = ИНН ИЛИ РегистрационныйНомерСтрахователя = КПП Тогда
			...
			Сообщение.Текст = НСтр("ka='Проверьте правильность указания регистрационного номера страхователя! Возможно, регистрационный номер страхователя указан неверно!';ru='Проверьте правильность указания регистрационного номера страхователя! Возможно, регистрационный номер страхователя указан неверно!';en='Check that the indication of the registration number of the insured! Perhaps the insurer registration number is wrong!'");
	...
	Если ЗначениеЗаполнено(ДополнительныйКод) Тогда
		Если ДополнительныйКод = ИНН ИЛИ ДополнительныйКод = КПП Тогда
			...
			Сообщение.Текст = НСтр("ka='Проверьте правильность указания дополнительного кода! Возможно, дополнительный код указан неверно!';ru='Проверьте правильность указания дополнительного кода! Возможно, дополнительный код указан неверно!';en='Check the correct guidance of extra code! Perhaps the additional code is incorrect!'");
