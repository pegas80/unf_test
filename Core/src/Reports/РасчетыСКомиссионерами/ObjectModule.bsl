...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Деньги,Контрагенты,Номенклатура,Комиссия,Продажи';ru='Деньги,Контрагенты,Номенклатура,Комиссия,Продажи';en='Money Accounts, Nomenclature, the Commission Sales'");
	КонецЦикла;
