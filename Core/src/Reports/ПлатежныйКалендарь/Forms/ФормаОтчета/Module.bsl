...
Функция ЗапросПоОстаткамПланируемыхПлатежей()
	...
	Запрос.УстановитьПараметр("ПросроченныеПлатежи", НСтр("ka='Итого просроченные платежи';ru='Итого просроченные платежи'"));
	Запрос.УстановитьПараметр("ЗапланированныеПлатежи", НСтр("ka='Итого запланированные платежи';ru='Итого запланированные платежи'"));
	Запрос.УстановитьПараметр("ТекстИтога", НСтр("ka='Всего платежи';ru='Всего платежи'"));
...
Функция ЗапросПоОстаткамДенежныхСредств()
	...
	Запрос.УстановитьПараметр("Организация", УправлениеНебольшойФирмойСервер.ПолучитьОрганизацию(Организация));
	Запрос.УстановитьПараметр("РабочаяДата", Отчет.РабочаяДата);
	Запрос.УстановитьПараметр("СтатусПлатежа", НСтр("ka='Доступный остаток';ru='Доступный остаток'"));
	Запрос.УстановитьПараметр("ТекстИтога", НСтр("ka='Всего платежи';ru='Всего платежи'"));
	Запрос.УстановитьПараметр("Платеж", НСтр("ka='Текущий остаток';ru='Текущий остаток'"));
