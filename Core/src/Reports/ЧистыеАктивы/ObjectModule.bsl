...
Процедура ПриОпределенииНастроекОтчета(НастройкиОтчета, НастройкиВариантов) Экспорт
	...
	НастройкиВариантов["ЧистыеАктивы"].Теги = НСтр("ka='მთავარი';ru='Главное'");
...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если НЕ СхемаКомпоновкиДанных.НаборыДанных.Найти("ТаблицаПериодов")=Неопределено Тогда
		...
		Если НЕ ЗначениеЗаполнено(Периодичность) Тогда
			...
			Если ПолеСхемы <> Неопределено Тогда
				ПолеСхемы.Заголовок = НСтр("ka='ბალანსი';ru='Баланс'");
	...
	ДокументРезультат.Область(ДокументРезультат.ВысотаТаблицы, 1, ДокументРезультат.ВысотаТаблицы, 1).Текст = НСтр("ka='სუფთა აქტივები';ru='Чистые активы'");
