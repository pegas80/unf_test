...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Ведомость"].Теги = НСТР("ka='Компания,Доходы,Расходы,План,Направление деятельности';ru='Компания,Доходы,Расходы,План,Направление деятельности'");
	НастройкиВариантов["План-фактный анализ"].Теги = НСТР("ka='Компания,Доходы,Расходы,План,Факт,Направление деятельности';ru='Компания,Доходы,Расходы,План,Факт,Направление деятельности'");
