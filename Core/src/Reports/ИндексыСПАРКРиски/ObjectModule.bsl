...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Иначе
		...
		РезультатВызоваВебСервиса.Вставить("СообщениеОбОшибке", НСтр("ka='Услуга не подключена.';ru='Услуга не подключена.';en='The service is not connected.'"));
...
"Услуга с идентификатором %1 не подключена.';ka='Не удалось сформировать отчет по индексам 1СПАРК Риски."
