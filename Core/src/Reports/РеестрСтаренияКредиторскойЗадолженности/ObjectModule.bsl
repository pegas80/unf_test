...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Запасы,Закупки,Деньги,Долги,Кредиторка,Контрагенты,Поставщики';ru='Запасы,Закупки,Деньги,Долги,Кредиторка,Контрагенты,Поставщики'");
	КонецЦикла;
