...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Производство,Продукция,Номенклатура';ru='Производство,Продукция,Номенклатура';en='Production, Products, Nomenclature'");
	КонецЦикла;
