...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	|	ЗапасыОстаткиИОбороты.СчетУчетаРегл КАК СчетУчета,
...
Функция СформироватьТаблицуПараметр(Таблица)
	...
	ОписаниеТипов = Новый ОписаниеТипов(Массив, ,);
	Массив.Очистить();
	ТаблицаПараметр.Колонки.Добавить("СчетУчетаРегл", ОписаниеТипов);
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	НастройкиВариантов["Основной"].Теги = НСтр("ka='Запасы,Закупки,Номенклатура';ru='Запасы,Закупки,Номенклатура';en='Inventories, Purchases, Nomenclature'");
