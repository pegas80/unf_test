...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		...
		МодульОбработкаНовостей.КонтекстныеНовости_ПриСозданииНаСервере(
			...
			"ОсновнаяФорма",
			,
			НСтр("ka='Новости: Расчет по страховым взносам в ПФР, ФФОМС, ТФОМС (форма РСВ-1 ПФР)';ru='Новости: Расчет по страховым взносам в ПФР, ФФОМС, ТФОМС (форма РСВ-1 ПФР)'"),
			Ложь,
