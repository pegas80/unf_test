...
Процедура Перенумеровать(Команда)
	...
	ТекстВопроса = НСтр("ka='При перенумерации страниц данные листов Г будут очищены. Продолжить?';ru='При перенумерации страниц данные листов Г будут очищены. Продолжить?'");
