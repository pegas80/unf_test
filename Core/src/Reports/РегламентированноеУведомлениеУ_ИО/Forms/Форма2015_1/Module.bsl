...
Процедура Перенумеровать(Команда)
	...
	ТекстВопроса = НСтр("ka='При перенумерации страниц данные листов Г будут очищены. Продолжить?';ru='При перенумерации страниц данные листов Г будут очищены. Продолжить?';en='When renumbering pages of data sheets G will be cleared. Proceed?'");
