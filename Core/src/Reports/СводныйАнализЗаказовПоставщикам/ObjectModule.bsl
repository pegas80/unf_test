...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	НСтр("ka='შემოსვლის მდგომარეობა';ru='Состояние поступления';en='Status of collection'"),
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Запасы,Закупки,Заказы,Контрагенты,Поставщики,Номенклатура,Поступления,Оплаты';ru='Запасы,Закупки,Заказы,Контрагенты,Поставщики,Номенклатура,Поступления,Оплаты';en='Inventories, Purchases, Orders, Accounts, Vendors, Inventory, Receipts, Payments'");
	КонецЦикла;
