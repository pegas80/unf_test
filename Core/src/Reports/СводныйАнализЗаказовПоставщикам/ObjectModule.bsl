...
Процедура ОбновитьНастройкиНаФорме(НастройкиОтчета, НастройкиСКД, Форма) Экспорт
	...
	НСтр("ka='შემოსვლის მდგომარეობა';ru='Состояние поступления'"),
...
Процедура УстановитьТегиВариантов(НастройкиВариантов)
	...
	Для Каждого НастройкиТекВарианта Из НастройкиВариантов Цикл
		НастройкиТекВарианта.Значение.Теги = НСтр("ka='Запасы,Закупки,Заказы,Контрагенты,Поставщики,Номенклатура,Поступления,Оплаты';ru='Запасы,Закупки,Заказы,Контрагенты,Поставщики,Номенклатура,Поступления,Оплаты'");
	КонецЦикла;
