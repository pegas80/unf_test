...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ka='ავტონომიური სამუშაო ადგილის გაცვლის გამართვები';ru='Настройки обмена автономного рабочего места'");
...
Функция ОписаниеОграниченийПередачиДанных(НастройкаОтборовНаУзле, ВерсияКорреспондента, ИдентификаторНастройки) Экспорт
	...
	Если НастройкаОтборовНаУзле.ИспользоватьОтборПоОрганизациям Тогда
		...
		Возврат НСтр("ka='ავტონომიურ სამუშაო ადგილზე ხელმისაწვდომია მხოლოდ მონაცემთა ნაწილი.';ru='В автономном рабочем месте доступна только часть данных.'");
		
	Иначе
		
		Возврат НСтр("ka='ავტონომიურ სამუშაო ადგილზე ხელმისაწვდომია ყველა მონაცემი.';ru='В автономном рабочем месте доступны все данные.'");
