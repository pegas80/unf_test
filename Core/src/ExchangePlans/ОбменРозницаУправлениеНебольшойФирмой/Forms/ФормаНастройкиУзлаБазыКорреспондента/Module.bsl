...
Процедура СформироватьЗаголовокТаблицыОрганизации()
	...
	Если ВспомогательныйРеквизитРежимСинхронизацииОрганизаций = "СинхронизироватьДанныеТолькоПоВыбраннымОрганизациям" Тогда
		...
		ЗаголовокСтраницы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='ორგანიზაციების მიხედვით (%1)';ru='По организациям (%1)';en='For organizations (1%)'"),
			КоличествоВыбранныхСтрок("ВспомогательныйРеквизитОрганизации"));
	Иначе
		
		ЗаголовокСтраницы = НСтр("ka='ყველა ორგანიზაციით';ru='По всем организациям';en='For all organizations'");
	КонецЕсли;
