...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ОбменТоварами
		...
		Отказ = Истина;
		Сообщение = НСтр("ka='გაცვლის რეჟიმი არ არის არჩეული!';ru='Режим обмена не выбран!';en='sharing mode is not selected!'");
		Поле = "ОбменТоварами";
...
Процедура СформироватьНаименование() Экспорт
	...
	Если ОбменТоварами И ОбменЗаказами Тогда
		...
		Префикс = НСтр("ka='საქონლებით და შეკვეთებით გაცვლა';ru='Обмен товарами и заказами';en='The exchange of goods and orders'");
		
	ИначеЕсли ОбменЗаказами Тогда
		
		Префикс = НСтр("ka='შეკვეთების გაცვლა';ru='Обмен заказами';en='Exchange orders'");
		
	Иначе
		
		Префикс = НСтр("ka='საქონლის გადმოტვირთვა';ru='Выгрузка товаров';en='unloading of goods'");
