...
Процедура ПриЗавершенииОперацииЗагрузки(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Ошибка" Тогда
		ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(НСтр("ka='Выполнение обмена с сайтом';ru='Выполнение обмена с сайтом';en='Performing with the site exchange'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
"Подробности см. в журнале регистрации.'"),
	...
	ПоказатьОповещениеПользователя(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			УзелОбмена) 
		,,
		НСтр("ka='საიტთან გაცვლა დასრულებულია';ru='Обмен с сайтом завершен';en='Exchange with complete site'"),
...
Функция ВыполнитьОбменССайтомНаСервере(ПараметрыОбмена)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ka='Выполнение обмена с сайтом';ru='Выполнение обмена с сайтом';en='Performing with the site exchange'");
