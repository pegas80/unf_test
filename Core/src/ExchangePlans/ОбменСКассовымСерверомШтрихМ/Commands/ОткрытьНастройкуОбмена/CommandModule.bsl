...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если УзелОбменаШтрих = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ka='Настройки доступны только администратору сервиса';ru='Настройки доступны только администратору сервиса';en='Only the administrator can configure the service'",
