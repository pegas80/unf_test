...
Функция АдресЗапроса(ВидДокумента, ФорматОбмена, ТекстОшибки) Экспорт
	...
	Иначе
		ТекстОшибки = НСтр("ka='В функцию %1 передан некорректный параметр %2';ru='В функцию %1 передан некорректный параметр %2';en='The function% 1% passed invalid parameter 2'");
