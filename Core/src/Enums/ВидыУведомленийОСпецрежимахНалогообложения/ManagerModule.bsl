...
Функция ПолучитьИмяОтчетаПоВидуУведомления(Вид) Экспорт 
	...
	ИначеЕсли Вид = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ФормаР13001 Тогда 
		Возврат "РегламентированноеУведомлениеФормаР13001";
	ИначеЕсли Вид = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ФормаР14001 Тогда 
		Возврат "РегламентированноеУведомлениеФормаР14001";
	ИначеЕсли Вид = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ФормаКИК Тогда 
		Возврат "РегламентированноеУведомлениеКИК";
	КонецЕсли;
...
Функция ЭтоУведомлениеВФНС(Вид) Экспорт
	Если Вид = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ЗаявлениеНаПолучениеПатентаРекомендованнаяФорма
		...
		Или Вид = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.УведомлениеОбУтратеПраваНаУСН
		Или Вид = Перечисления.ВидыУведомленийОСпецрежимахНалогообложения.ФормаКИК Тогда 
		Возврат Истина;
	КонецЕсли;
