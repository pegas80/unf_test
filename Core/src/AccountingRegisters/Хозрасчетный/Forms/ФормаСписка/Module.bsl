...
Функция ПолучитьДокумент()
	...
	Если ТекДанные = Неопределено Тогда
		ПоказатьПредупреждение( , НСтр("ru='Не выбран документ';en='the document is not selected'"));
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("НадписьНУ", НСтр("ru='НУ:';en='WELL:'"));
	Список.Параметры.УстановитьЗначениеПараметра("НадписьПР", НСтр("ru='ПР:';en='ETC:'"));
	Список.Параметры.УстановитьЗначениеПараметра("НадписьВР", НСтр("ru='ВР:';en='BP:'"));
	Список.Параметры.УстановитьЗначениеПараметра("НадписьКоличество", НСтр("ru='Кол:';en='Number:'"));
	
	ЕстьПлательщикиНалогаНаПрибыль = Ложь; //ПолучитьФункциональнуюОпцию("ПлательщикНалогаНаПрибыль");
	ЕстьПрименяющиеПБУ18           = Ложь; //ПолучитьФункциональнуюОпцию("ПоддержкаПБУ18");
