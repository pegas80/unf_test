...
Процедура ВыполнитьВыбор(Область)
	...
	Если ПустаяСтрока(ВыбранныйКод) 
		...
		ПоказатьПредупреждение( , НСтр("ka='Выберите строку с кодом';ru='Выберите строку с кодом'"));
		Возврат;
	КонецЕсли;
...
Процедура ВыполнитьПоиск()
	...
	Если НичегоНеНашли Тогда
		ПоказатьПредупреждение(, НСтр("ka='Строка не найдена';ru='Строка не найдена'"));
	КонецЕсли;
