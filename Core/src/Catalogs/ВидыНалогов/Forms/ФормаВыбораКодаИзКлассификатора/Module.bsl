...
"(в редакции приказа Минфина от 07.12.2016 г. № 230н)';ka='по приказу Минфина от 01.07.2013 г. № 65н"
"(в редакции приказа Минфина от 07.12.2016 г. № 230н)'");
	Иначе
		ИмяМакета      = "КлассификацияДоходовБюджетов";
		НадписьПриказа = НСтр("ru='по приказу Минфина от 01.07.2013 г. № 65н"
"(в редакции приказа Минфина от 20.06.2016 г. № 89н)';ka='по приказу Минфина от 01.07.2013 г. № 65н"
...
Процедура ВыполнитьВыбор(Область)
	...
	Если ПустаяСтрока(ВыбранныйКод) 
		...
		ПоказатьПредупреждение( , НСтр("ka='Выберите строку с кодом';ru='Выберите строку с кодом';en='Select a code string'"));
		Возврат;
	КонецЕсли;
...
Процедура ВыполнитьПоиск()
	...
	Если НичегоНеНашли Тогда
		ПоказатьПредупреждение(, НСтр("ka='Строка не найдена';ru='Строка не найдена';en='String is not found'"));
	КонецЕсли;
