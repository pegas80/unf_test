...
Процедура ЗаполнитьПредставлениеНоменклатуры()
	...
	Если Объект.ПечатьПрайсЛиста = КэшЗначений.Диафильм Тогда
		...
		СоставРеквизитов = СоставРеквизитов + НСтр("ru=', Колонок: ';ka=', Колонок: '") + Объект.КоличествоКолонок + НСтр("ru=', Размер: ';ka=', Размер: '") + Объект.КартинкаШирина + НСтр("ru=' х ';ka=' х '") + Объект.КартинкаВысота;
