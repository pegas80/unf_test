...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПустаяСтрока(Объект.Наименование) Тогда
		...
		Объект.Наименование = Нстр("ka='პრაის-ლისტი';ru='Прайс-лист'");
	...
	Если НЕ ПолучитьФункциональнуюОпцию("УчетВалютныхОпераций") Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаИерархияВалюта", "Заголовок", НСтр("ka='პრაის-ლისტის დაჯგუფება';ru='Группировка прайс-листа'"));
