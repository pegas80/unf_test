...
Процедура ПриОткрытии(Отказ)
	...
	#Если ВебКлиент Тогда
		ТекстПредупреждения =
			НСтр("ka='ვებ-კლიენტში საქაღალდეების იმპორტს მხარდაჭერა არ გააჩნია. ფაილების სიაში გამოიყენეთ ბრძანება ""შექმნა"".';ru='В Веб-клиенте импорт файлов не поддерживается."
"Используйте команду ""Создать"" в списке файлов.'");
	...
	Если ТолькоКаталоги Тогда
		Заголовок = НСтр("ka='ფოლდერების ატვირთვა';ru='Загрузка папок';en='Loading folder'");
	КонецЕсли;
...
Процедура ЗагрузитьФайлы()
	...
	Если ВыбранныеФайлы.Количество() = 0 Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='დასამატებლად ფაილები არ არის.';ru='Нет файлов для добавления.';en='No files to include.'"), , "ВыбранныеФайлы");
