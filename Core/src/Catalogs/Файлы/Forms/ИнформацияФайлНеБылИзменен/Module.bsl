...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстНапоминания = 
	НСтр("ka='ვერსია არ შექმნილა, ვინაიდან ფაილი არ შეცვლილა. კომენტარი არ არის შენახული.';ru='Версия не была создана, т.к. файл не изменен. Комментарий не сохранен.'");
