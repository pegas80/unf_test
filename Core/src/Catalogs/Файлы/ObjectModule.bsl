...
Процедура ПриЗаписи(Отказ)
	...
	//+++ Дмгг
	Если НЕ Отказ И НЕ Ссылка.ПометкаУдаления Тогда    
		
		Если ЗначениеЗаполнено(Ссылка.ТекстХранилище.Получить()) Тогда 
			...
			Запись.Файл = Ссылка;
			Запись.ДвоичныеДанныеФайла = Ссылка.ТекстХранилище;//Новый ХранилищеЗначения(ДвоичныеДанныеФайла);
