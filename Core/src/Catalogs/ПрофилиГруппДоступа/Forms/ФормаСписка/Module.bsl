...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Заголовок = НСтр("ka='დაშვების ჯგუფების პროფილების შერჩევა';ru='Подбор профилей групп доступа'");
		Иначе
			Заголовок = НСтр("ka='დაშვების ჯგუფების პროფილის არჩევა';ru='Выбор профиля групп доступа'");
		КонецЕсли;
	Иначе
...
Процедура ВидПользователейНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПользователиСлужебныйКлиент.ВыбратьНазначение(ЭтотОбъект,
		НСтр("ka='პროფილების დანიშნულების არჩევა';ru='Выбор назначения профилей'"), Истина, Истина, ОписаниеОповещения);
