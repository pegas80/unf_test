...
"Поставляемый профиль уже существует:';ka='შეცდომა პროფილ ""%1""-ის ჩაწერისას. მოსაწოდებელი პროფილი უკვე არსებობს:'"),
				Наименование);
			
			ПодробноеПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru='Ошибка при записи профиля ""%1""."
"Идентификатор поставляемых данных ""%2"" уже используется в профиле:';ka='შეცდომა პროფილ ""%1""-ის ჩაწერისას. მოსაწოდებელ მონაცემთა იდენტიფიკატორი ""%2"" უკვე გამოიყენება პროფილში:'"),
				Наименование,
			...
			Иначе
				ЗаписьЖурналаРегистрации(
					НСтр("ka='წვდომის მართვა. მოსაწოდებელი პროფილის ერთმნიშვნელოვნების დარღვევა';ru='Управление доступом.Нарушение однозначности поставляемого профиля';en='dostupom.Narushenie Management uniqueness supplied Profile'",
