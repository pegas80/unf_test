...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для каждого СтрокаФайлДокумента Из ТЗФайлыДокумента Цикл
		...
		НСтр("ka='%1 (%2)';ru='%1 (%2)'"), НоваяСтрока.Имя, ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ТекстовоеПредставлениеРазмераФайла(НоваяСтрока.Размер));
