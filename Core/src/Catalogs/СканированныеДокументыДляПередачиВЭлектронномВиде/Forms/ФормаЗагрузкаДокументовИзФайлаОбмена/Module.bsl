...
Процедура Загрузить(Команда)
	...
	Если НЕ ЗначениеЗаполнено(ОрганизацияСсылка) Тогда
		ТекстСообщения = НСтр("ka='Для загрузки необходимо указать организацию.';ru='Для загрузки необходимо указать организацию.';en='To download you must specify the organization.'");
