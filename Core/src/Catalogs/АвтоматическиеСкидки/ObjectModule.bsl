...
Процедура ОбновитьИнформациюВСлужебномРегистреСведений(Отказ)
	...
	ЗаписьЖурналаРегистрации(
			НСтр("ka='ავტომატური ფასდაკლებები. სამახურებრივი ინფორმაცია ავტომატური ფასდაკლებების შესახებ';ru='Автоматические скидки. Служебная информация по автоматическим скидкам'",
