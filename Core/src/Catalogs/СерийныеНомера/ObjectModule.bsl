...
Процедура ПередЗаписью(Отказ)
	...
	Если ЭтоНовый() Тогда
		...
		Если НЕ Результат.Пустой() Тогда
			...
			ТекстСообщения = НСтр("ka='ნომენკლატურა %1%-ზე უკვე შეყვანილია სერიული ნომერი %2%';ru='У номенклатуры %1% уже введен серийный номер %2%';en='In the range of% 1% already entered the serial number% 2%'");
