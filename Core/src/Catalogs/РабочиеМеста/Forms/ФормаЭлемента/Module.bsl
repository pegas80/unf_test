...
"Рабочее место с таким идентификатором клиента уже существует.';ka='სამუშაო ადგილის შენახვის შეცდომა! სამუშაო ადგილი კლიენტის ამგვარი იდენტიფიკატორით უკვე არსებობს.'");
...
"Продолжить сохранение с указанным наименованием?';ka='მითითებულია სამუშაო ადგილის არაუნიკალური დასახელება!"
"შეიძლება, მომავალში ამან გაართულოს სამუშაო ადგილის იდენტიფიკაცია და არჩევა."
"რეკომენდებულია სამუშაო ადგილების უნიკალური დასახელების მითითება."
"გავაგრძელოთ მითითებული დასახელებით შენახვა?'");
