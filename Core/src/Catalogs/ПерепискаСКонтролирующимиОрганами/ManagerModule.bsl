...
Процедура ЗаполнитьНаименованиеИКодКонтролирующегоОргана(Письмо, Бланк, ОбластьНаименований)
	...
	Иначе
		ОбластьНаименований.Параметры["Наименование" + Постфикс] = НСтр("ru='в ';ka='в '")  + НаименованиеОргана;
	КонецЕсли;
...
Процедура ЗаполнитьКонтактыОрганизации(Письмо, ТабДокумент, Бланк)
	...
	Если ЗначениеЗаполнено(СведенияОбОрганизации.ИННЮЛ) Тогда
		...
		НадписьИННиКПП = НСтр("ru='ИНН ';ka='ИНН '") + СведенияОбОрганизации.ИННЮЛ;
		Если ЗначениеЗаполнено(СведенияОбОрганизации.КППЮЛ) Тогда 
			 НадписьИННиКПП = НадписьИННиКПП + НСтр("ru=' КПП ';ka=' КПП '") + СведенияОбОрганизации.КППЮЛ;
		КонецЕсли;
	...
	Если ЗначениеЗаполнено(СведенияОбОрганизации.ТелОрганизации)
		...
		ОбластьТелефон.Параметры["Телефон" + Постфикс] = НСтр("ru='тел: ';ka='тел: '") + СведенияОбОрганизации.ТелОрганизации;
