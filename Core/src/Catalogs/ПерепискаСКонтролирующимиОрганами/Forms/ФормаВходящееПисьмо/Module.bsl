...
Функция ЗаполнитьВложенияИзТекстаПисьма(ТекстПисьма, Вложения, Ссылка)
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронный документооборот с контролирующими органами.Анализ текста письма рассылки';ru='Электронный документооборот с контролирующими органами.Анализ текста письма рассылки';en='Electronic document management with controlling organami.Analiz mailing letters text'", 
