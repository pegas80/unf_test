...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.Владелец) И 
		...
		Сообщение.Текст = НСтр("ka='ნომენკლატურისთვის არ წარმოებს პარტიების მიხედვით აღრიცხვა! ნომენკლატურის ბარათში დააყენეთ ალამი ""პარტიების გამოყენება""';ru='Для номенклатуры не ведется учет по партиям!"
