...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		ТекстСообщения = НСтр("ka='ცნობარი არ არის განკუთვნილი ხელით შესავსებად!';ru='Справочник не предназначен для ручного заполнения!';en='Reference is not designed for manual filling!'");
