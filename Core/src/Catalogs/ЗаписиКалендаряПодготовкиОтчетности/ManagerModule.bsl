...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	ГруппаДел	= НСтр("ka='გადასახადები და ანგარიშგებულობა';ru='Налоги и отчетность';en='Taxes and Reporting'");
	...
	Дело.Важное			= Ложь;
	Дело.Представление	= НСтр("ka='შესრულების მოლოდინი';ru='Ожидают выполнения';en='expected to perform'");
