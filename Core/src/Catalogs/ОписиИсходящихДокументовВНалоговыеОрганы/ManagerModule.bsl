...
Процедура ОбновитьНаименованиеВсехОписейИсходящихДокументов() Экспорт
	...
	Пока ВыборкаРезультата.Следующий() Цикл
		...
		Наименование = НСтр("ka='Ответ на требование о представлении документов';ru='Ответ на требование о представлении документов';en='Response to a request for production of documents'");
