...
Процедура ЗаполнитьТаблицуКнопокИзМакета() Экспорт
	...
	Для НомерСтрокиМакета = 2 По КолСтрок Цикл
		...
		пAlt = ?(ЗначениеЗаполнено(Макет.Область(НомерСтрокиМакета,7,НомерСтрокиМакета,7).Текст), Макет.Область(НомерСтрокиМакета,7,НомерСтрокиМакета,7).Текст, Ложь);
		пCtrl = ?(ЗначениеЗаполнено(Макет.Область(НомерСтрокиМакета,8,НомерСтрокиМакета,8).Текст), Макет.Область(НомерСтрокиМакета,7,НомерСтрокиМакета,7).Текст, Ложь);
		пShift = ?(ЗначениеЗаполнено(Макет.Область(НомерСтрокиМакета,9,НомерСтрокиМакета,9).Текст), Макет.Область(НомерСтрокиМакета,7,НомерСтрокиМакета,7).Текст, Ложь);
		пПоУмолчанию = ?(ЗначениеЗаполнено(Макет.Область(НомерСтрокиМакета,10,НомерСтрокиМакета,10).Текст), Макет.Область(НомерСтрокиМакета,7,НомерСтрокиМакета,7).Текст, Ложь);


		СтрокаТаблицы.Вставить("Alt", пAlt);//Булево(Макет.Область(НомерСтрокиМакета,7,НомерСтрокиМакета,7).Текст)
		СтрокаТаблицы.Вставить("Ctrl", пCtrl);//Булево(Макет.Область(НомерСтрокиМакета,8,НомерСтрокиМакета,8).Текст)
		СтрокаТаблицы.Вставить("Shift", пShift);//Булево(Макет.Область(НомерСтрокиМакета,9,НомерСтрокиМакета,9).Текст)
		СтрокаТаблицы.Вставить("ПоУмолчанию", пПоУмолчанию);//Булево(Макет.Область(НомерСтрокиМакета,10,НомерСтрокиМакета,10).Текст)
