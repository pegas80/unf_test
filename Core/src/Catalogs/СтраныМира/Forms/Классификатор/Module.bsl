...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Служебные реквизиты
	ПоляКлассификатора = "Код, Наименование, НаименованиеПолное, КодАльфа2, КодАльфа3, КодРС";  //+++ Дмгг
	...
	Если Не РежимВыбора Тогда
		...
		Если СтраныНетВСпискеСтран(Страна.Наименование) Тогда
			ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='Добавить страну ""%1"" из классификатора в список стран мира?';ru='Добавить страну ""%1"" из классификатора в список стран мира?';en='Add to ""%1"" of the classifier in the list of countries in the world?'"),
				Страна.Наименование);
