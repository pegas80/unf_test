...
Процедура ПослеПроверкиПодписи(Результат, ДополнительныеПараметры) Экспорт
	...
	ИначеЕсли Результат = Неопределено Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Не удалось получить менеджер криптографии';ru='Не удалось получить менеджер криптографии';en='Failed to get Cryptographic manager'"));
