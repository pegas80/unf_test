...
Процедура ДобавлениеРеквизитов(Сообщение, ДобавляемыеРеквизиты)
	...
	Реквизит = Новый РеквизитФормы("Сообщение" + Идентификатор, Новый ОписаниеТипов("СправочникСсылка.ГИСМПрисоединенныеФайлы"), "", НСтр("ka='შეტყობინება';ru='Сообщение'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("Подпись" + Идентификатор, Новый ОписаниеТипов("ФорматированнаяСтрока"), "", НСтр("ka='ხელმოწერა';ru='Подпись'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ДатаСоздания" + Идентификатор, Новый ОписаниеТипов("Дата"), "", НСтр("ka='მოთხოვნის თარიღი';ru='Дата запроса'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ТекстSOAP" + Идентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ka='ტექსტი SOAP';ru='Текст SOAP'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ТекстXML" + Идентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ka='ტექსტი XML';ru='Текст XML'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
...
Процедура ДобавлениеЭлементов(СтрокаТЧ, РеквизитыСообщений)
	...
	СтраницаТекстXML  = ДобавитьСтраницу("СтраницаТекстXML",  НСтр("ka='ტექსტი XML';ru='Текст XML'"),  ВложенныеСтраницы, Идентификатор);
	СтраницаТекстSOAP = ДобавитьСтраницу("СтраницаТекстSOAP", НСтр("ka='ტექსტი SOAP';ru='Текст SOAP'"), ВложенныеСтраницы, Идентификатор);
	СтраницаПрочее    = ДобавитьСтраницу("СтраницаПрочее",    НСтр("ka='სხვა დანარჩენი';ru='Прочее'"),     ВложенныеСтраницы, Идентификатор);
	...
	ДобавитьПолеВвода("Сообщение", НСтр("ka='შეტყობინება';ru='Сообщение'"), РеквизитыСообщения.Ссылка, СтраницаПрочее, Идентификатор);
	ДобавитьПолеВвода("ДатаСоздания", НСтр("ka='შექმნის თარიღი';ru='Дата создания'"), РеквизитыСообщения.ДатаСоздания, СтраницаПрочее, Идентификатор);
	ДобавитьНадпись("Подпись", НСтр("ka='ხელმოწერა';ru='Подпись'"), Подпись, Страница, Идентификатор);
	...
	Для Каждого СтрокаТЧ Из Данные Цикл
		Для Каждого Колонка Из Колонки Цикл
			Если ПоследовательностьСообщений.Найти(СтрокаТЧ[Колонка.Имя]) = Неопределено Тогда
				...
				Иначе
					НоваяСтрока.Заголовок = НСтр("ka='კვიტანციის მიღება';ru='Получение квитанции'");
					НоваяСтрока.Подсказка = Операция;
				КонецЕсли;
