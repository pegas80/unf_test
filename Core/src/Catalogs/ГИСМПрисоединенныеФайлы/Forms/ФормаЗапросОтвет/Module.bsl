...
Процедура ДобавлениеРеквизитов(Сообщение, ДобавляемыеРеквизиты)
	...
	Реквизит = Новый РеквизитФормы("Сообщение" + Идентификатор, Новый ОписаниеТипов("СправочникСсылка.ГИСМПрисоединенныеФайлы"), "", НСтр("ka='შეტყობინება';ru='Сообщение';en='Message'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("Подпись" + Идентификатор, Новый ОписаниеТипов("ФорматированнаяСтрока"), "", НСтр("ka='ხელმოწერა';ru='Подпись';en='Signature'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ДатаСоздания" + Идентификатор, Новый ОписаниеТипов("Дата"), "", НСтр("ka='მოთხოვნის თარიღი';ru='Дата запроса';en='Date of request'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ТекстSOAP" + Идентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ka='ტექსტი SOAP';ru='Текст SOAP';en='text SOAP'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
	
	Реквизит = Новый РеквизитФормы("ТекстXML" + Идентификатор, Новый ОписаниеТипов("Строка"), "", НСтр("ka='ტექსტი XML';ru='Текст XML';en='text XML'"));
	ДобавляемыеРеквизиты.Добавить(Реквизит);
...
Процедура ДобавлениеЭлементов(СтрокаТЧ, РеквизитыСообщений)
	...
	СтраницаТекстXML  = ДобавитьСтраницу("СтраницаТекстXML",  НСтр("ka='ტექსტი XML';ru='Текст XML';en='text XML'"),  ВложенныеСтраницы, Идентификатор);
	СтраницаТекстSOAP = ДобавитьСтраницу("СтраницаТекстSOAP", НСтр("ka='ტექსტი SOAP';ru='Текст SOAP';en='text SOAP'"), ВложенныеСтраницы, Идентификатор);
	СтраницаПрочее    = ДобавитьСтраницу("СтраницаПрочее",    НСтр("ka='სხვა დანარჩენი';ru='Прочее';en='Other'"),     ВложенныеСтраницы, Идентификатор);
	...
	ДобавитьПолеВвода("Сообщение", НСтр("ka='შეტყობინება';ru='Сообщение';en='Message'"), РеквизитыСообщения.Ссылка, СтраницаПрочее, Идентификатор);
	ДобавитьПолеВвода("ДатаСоздания", НСтр("ka='შექმნის თარიღი';ru='Дата создания';en='date of creation'"), РеквизитыСообщения.ДатаСоздания, СтраницаПрочее, Идентификатор);
	ДобавитьНадпись("Подпись", НСтр("ka='ხელმოწერა';ru='Подпись';en='Signature'"), Подпись, Страница, Идентификатор);
	...
	Для Каждого СтрокаТЧ Из Данные Цикл
		Для Каждого Колонка Из Колонки Цикл
			Если ПоследовательностьСообщений.Найти(СтрокаТЧ[Колонка.Имя]) = Неопределено Тогда
				...
				Иначе
					НоваяСтрока.Заголовок = НСтр("ka='კვიტანციის მიღება';ru='Получение квитанции';en='obtain receipts'");
					НоваяСтрока.Подсказка = Операция;
				КонецЕсли;
