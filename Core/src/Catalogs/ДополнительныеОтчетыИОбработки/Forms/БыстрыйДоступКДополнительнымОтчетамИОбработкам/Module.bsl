...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='სწრაფი წვდომა ბრძანებასთან ""%1""';ru='Быстрый доступ к команде ""%1""';en='Quick access to the command ""%1""'"), Параметры.ПредставлениеКоманды);
