...
Функция ДоговорСоответствуетУсловиямДокумента(ТекстСообщения, Договор, Организация, Контрагент, СписокВидовДоговора) Экспорт
	...
	ТекстСообщения = НСтр("ka='ხელშეკრულების რეკვიზიტები არ შეესაბამება დოკუმენტის პირობებს:';ru='Реквизиты договора не соответствуют условиям документа:'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='ხელშეკრულების ფორმა (HTML)';ru='Форма договора (HTML)'");
	...
	КомандаПечати.Представление = НСтр("ka='ხელშეკრულების ფორმა (Microsoft word)';ru='Форма договора (Microsoft word)'");
	КомандаПечати.СписокФорм = "";
	КомандаПечати.ФункциональныеОпции = "ДоговорыКонтрагентовТехническиеКомандыПечати";
	
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "ТарифныйПланДоговораОбслуживания";
	КомандаПечати.Представление = НСтр("ka='სატარიფო გეგმა';ru='Тарифный план'");
	КомандаПечати.СписокФорм = "ФормаЭлемента,ФормаСписка,ФормаВыбора,ФормаВыбораСКонтрагентом";
...
Функция ПечатьТарифныйПланДоговораОбслуживания(МассивОбъектов, ОбъектыПечати, ИмяМакета) Экспорт
	...
	Для каждого Эл Из МассивОбъектов Цикл
		...
		ТекстСообщения = СтрШаблон(
			НСтр("ka='ხელშეკრულება %1 მომსახურების ხელშეკრულებას არ წარმოადგენს!';ru='Договор %1 не является договором обслуживания!'"),
			Эл.Ссылка
		);
