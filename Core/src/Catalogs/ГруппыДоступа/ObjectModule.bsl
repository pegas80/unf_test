...
"либо при наличии роли ""Полные права"".';ka='წინასწარგანსაზღვრულ დაშვების ჯგუფ ადმინისტრატორების შეცვლა შეიძლება, ან პრივილეგირებულ რეჟიმში, ან როლ ""სრული უფლებების"" არსებობისას.'");
		КонецЕсли;
...
"группы внешних пользователей недопустимы.';ka='დაშვების წინასწარ განსაზღვრული ჯგუფი ადმინისტრატორები შეიძლება შეიცავდეს მხოლოდ მომხმარებლებს."
""
"მომხმარებლების ჯგუფები, გარე მომხმარებლები და გარე მომხმარებლების ჯგუფები დაუშვებელია.'");
			КонецЕсли;
		КонецЦикла;
...
"у предопределенной группы доступа Администраторы.';ka='წინასწარგანსაზღვრული პროფილი ადმინისტრატორი შეიძლება გააჩნდეს მხოლოდ დაშვების წინასწარგანსაზღვრულ ჯგუფ ადმინისტრატორებს.'");
	КонецЕсли;
