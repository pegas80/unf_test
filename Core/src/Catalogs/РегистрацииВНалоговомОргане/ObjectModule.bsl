...
Процедура ПередЗаписью(Отказ)
	...
	Если СуществующаяЗапись <> Неопределено И СуществующаяЗапись <> Ссылка Тогда
		...
		РегламентированнаяОтчетностьКлиентСервер.СообщитьОбОшибке(НСтр("ka='Для данной организации уже существует запись с указанными кодом налогового органа';ru='Для данной организации уже существует запись с указанными кодом налогового органа';en='For the organization is already an entry with the specified tax authority code'") 
															  + ?(ЭтоПБОЮЛ, ".", НСтр("ka=' и КПП.';ru=' и КПП.'")), Отказ);
		
		Сообщение = Новый СообщениеПользователю;

		Сообщение.Текст = НСтр("ka='Для данной организации уже существует запись с указанными кодом налогового органа';ru='Для данной организации уже существует запись с указанными кодом налогового органа';en='For the organization is already an entry with the specified tax authority code'") 
						+ ?(ЭтоПБОЮЛ, ".", НСтр("ka=' и КПП.';ru=' и КПП.'"));
