...
Процедура НастроитьФорму()
	...
	Если Запрос.Выполнить().Пустой() Тогда
		...
		Заголовок = НСтр("ka='დოკუმენტებისთვის შაბლონები არ არის.';ru='Шаблоны для документов отсутствуют.';en='There are no templates for documents.'");
	Иначе
		Элементы.Список.Видимость = Истина;
		Заголовок = НСтр("ka='აირჩიეთ შაბლონი დოკუმენტის შესაქმნელად';ru='Выберите шаблон для создания документа';en='Select a template to create a document'");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДокументСсылка) Тогда
		...
		Элементы.ДекорацияПустойШаблон.Заголовок = НСтр("ka='или';ru='или';en='or'");
	Иначе
		Элементы.ГруппаШаблонПоДокументу.Видимость = Ложь;
		Элементы.ДекорацияПустойШаблон.Заголовок = НСтр("ka='თვენ შეგიძლიათ';ru='Вы можете';en='You can'");
	КонецЕсли;
