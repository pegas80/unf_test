...
Процедура НастроитьФорму()
	...
	Если Запрос.Выполнить().Пустой() Тогда
		...
		Заголовок = НСтр("ka='დოკუმენტებისთვის შაბლონები არ არის.';ru='Шаблоны для документов отсутствуют.'");
	Иначе
		Элементы.Список.Видимость = Истина;
		Заголовок = НСтр("ka='აირჩიეთ შაბლონი დოკუმენტის შესაქმნელად';ru='Выберите шаблон для создания документа'");
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДокументСсылка) Тогда
		...
		Элементы.ДекорацияПустойШаблон.Заголовок = НСтр("ka='или';ru='или'");
	Иначе
		Элементы.ГруппаШаблонПоДокументу.Видимость = Ложь;
		Элементы.ДекорацияПустойШаблон.Заголовок = НСтр("ka='თვენ შეგიძლიათ';ru='Вы можете'");
	КонецЕсли;
