...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтказИзменитьСчетРасчетовСПерсоналом(Ссылка) Тогда
		Элементы.СПерсоналом.Подсказка = НСтр("ka='ბაზაში არის ამ თანამშრომლის თაობაზე მოძრაობები! პერსონალთან ანგარიშსწორების მიხედვით აღრიცხვის ანგარიშების შეცვლა აკრძალულია!';ru='В базе есть движения по этому сотруднику! Изменение счетов учета по расчетам с персоналом запрещено!'");
		Элементы.СПерсоналом.Доступность = Ложь;
	КонецЕсли;

	Если ОтказИзменитьСчетРасчетовСПодотчетниками(Ссылка) Тогда
		Элементы.СПодотчетником.Подсказка = НСтр("ka='ბაზაში არის ამ ანგარიშვალდებული პირის თაობაზე მოძრაობები! ანგარიშვალდებულებთან ანგარიშსწორებების მიხედვით აღრიცხვის ანგარიშების შეცვლა აკრძალულია!';ru='В базе есть движения по этому подотчетнику! Изменение счетов учета по расчетам с подотчетниками запрещено!'");
