...
Процедура ОбработатьЗавершениеЗаданияНаСервере(АдресХранилища)
	...
	Иначе
		...
		Заголовок = НСтр("ka='Яндекс не может предложить подходящего варианта.';ru='Яндекс не может предложить подходящего варианта.'");
	КонецЕсли;
...
Процедура ЗаполнитьРасчетСтоимостиДоставки(Знач ПараметрыВарианта)
	...
	НСтр("ka='Расчет для ""%1""';ru='Расчет для ""%1""'"),
	...
	НСтр("ka='Стоимость доставки для вашего магазина';ru='Стоимость доставки для вашего магазина'"),
	ПараметрыВарианта.СтоимостьДляМагазина,
	Макет);
	
	ВывестиОтступ(Макет);
	
	ВывестиЗаголовок(НСтр("ka='Включено:';ru='Включено:'"), Макет);
	
	ВывестиНаименованиеИСумму(НСтр("ka='Тариф доставки';ru='Тариф доставки'"), ПараметрыВарианта.СтоимостьДляПолучателя, Макет);
	...
	ВывестиЗаголовок(НСтр("ka='Не включено:';ru='Не включено:'"), Макет);
...
Процедура НастроитьКолонкиВариантовДоставки()
	...
	Если ЗначениеЗаполнено(ПараметрыПоискаСпособаДоставки.СпособДоставки) Тогда
		Элементы.СлужбаИСпособДоставки.Заголовок = НСтр("ka='Служба доставки';ru='Служба доставки'");
		Элементы.ВариантыДоставкиСпособДоставки.Видимость = Ложь;
	Иначе
		Элементы.СлужбаИСпособДоставки.Заголовок = НСтр("ka='Служба и способ доставки';ru='Служба и способ доставки'");
