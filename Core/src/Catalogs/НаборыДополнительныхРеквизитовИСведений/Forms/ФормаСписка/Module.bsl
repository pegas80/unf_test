...
Процедура ОформитьНаборыИСвойства()
	...
	ЭлементЦветаОформления.Значение = НСтр("ka='ნაკრებები';ru='Наборы';en='sets'");
...
Процедура НастроитьОтображениеНаборов()
	...
	Если ЭтоНаборыДополнительныхСведений Тогда
		Заголовок = НСтр("ka='დამატებითი ცნობები';ru='Дополнительные сведения';en='additional information'");
		
		КомандаСоздать.Подсказка          = НСтр("ka='უნიკალური ინფორმაციის შექმნა';ru='Создать уникальное сведение';en='Create unique information'");
		КомандаСоздать.Заголовок          = НСтр("ka='ახალი';ru='Новое';en='New'");
		КомандаСоздать.Подсказка          = НСтр("ka='უნიკალური ინფორმაციის შექმნა';ru='Создать уникальное сведение';en='Create unique information'");
		
		КомандаСкопировать.Подсказка        = НСтр("ka='ახალი ინფორმაციის შექმნა მიმდინარეს კოპირებით';ru='Создать новое сведение копированием текущего';en='Create a new copy of this reduction'");
		КомандаИзменить.Подсказка           = НСтр("ka='მიმდინარე ინფორმაციის შეცვლა (ან გახსნა)';ru='Изменить (или открыть) текущее сведение';en='Change (or open) the current status'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ka='მიმდინარე ინფორმაციის წასაშლელად მონიშვნა (Del)';ru='Пометить текущее сведение на удаление (Del)';en='Flag current reduction removal (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ka='მიმდინარე ინფორმაციის გადაადგილება ზემოთ';ru='Переместить текущее сведение вверх';en='Move up current information'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ka='მიმდინარე ინფორმაციის გადაადგილება ქვემოთ';ru='Переместить текущее сведение вниз';en='Move down current reduction'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ka='მნიშვნელობის ტიპები, რომლის შეყვანა შეიძლება ინფორმაციის შევსებისას.';ru='Типы значения, которое можно ввести при заполнении сведения.';en='The types of values ​​that can be entered when filling out information.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ka='ინფორმაცია იყენებს ნიმუშ-ინფორმაციის მნიშვნელობების სიას.';ru='Сведение использует список значений сведения-образца.';en='Mixing uses a list of sample data values.'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ka='საერთო';ru='Общее';en='overall'");
		Элементы.СвойстваОбщее.Подсказка = НСтр("ru='Общее дополнительное сведение, которое используется в"
"нескольких наборах дополнительных сведений.';ka='საერთო დამატებითი ინფორმაცია, რომელიც დამატებითი ინფორმაციის რამდენიმე კრებულში გამოიყენება.'");
	Иначе
		Заголовок = НСтр("ka='დამატებითი რეკვიზიტები';ru='Дополнительные реквизиты';en='Additional Information'");
		КомандаСоздать.Заголовок          = НСтр("ka='Новый';ru='Новый';en='Новый'");
		КомандаСоздать.Подсказка          = НСтр("ka='უნიკალური რეკვიზიტის შექმნა';ru='Создать уникальный реквизит';en='Create a unique props'");
		
		КомандаСкопировать.Подсказка        = НСтр("ka='ახალი რეკვიზიტის შექმნა მიმდინარეს კოპირების გზით';ru='Создать новый реквизит копированием текущего';en='Create a new prop up the current'");
		КомандаИзменить.Подсказка           = НСтр("ka='მიმდინარე რეკვიზიტის შეცვლა (ან გახსნა)';ru='Изменить (или открыть) текущий реквизит';en='Change (or open) the current props'");
		КомандаПометитьНаУдаление.Подсказка = НСтр("ka='მიმდინარე რეკვიზიტის წასაშლელად მონიშვნა (Del)';ru='Пометить текущий реквизит на удаление (Del)';en='Mark the current props to delete (Del)'");
		КомандаПереместитьВверх.Подсказка   = НСтр("ka='მიმდინარე რეკვიზიტის გადაადგილება ზემოთ';ru='Переместить текущий реквизит вверх';en='Move the current props up'");
		КомандаПереместитьВниз.Подсказка    = НСтр("ka='მიმდინარე რეკვიზიტის გადაადგილება ქვემოთ';ru='Переместить текущий реквизит вниз';en='Move down the current props'");
		...
		Элементы.СвойстваТипЗначения.Подсказка =
			НСтр("ka='მნიშვნელობის ტიპები, რომლის შეყვანა შეიძლება რეკვიზიტის შევსებისას.';ru='Типы значения, которое можно ввести при заполнении реквизита.';en='The types of values ​​that can be entered when filling props.'");
		
		Элементы.СвойстваОбщиеЗначения.Подсказка =
			НСтр("ka='რეკვიზიტი იყენებს ნიმუში რეკვიზიტის მნიშვნელობების სიას.';ru='Реквизит использует список значений реквизита-образца.';en='Props uses a list of props sample values.'");
		
		Элементы.СвойстваОбщее.Заголовок = НСтр("ka='საერთო';ru='Общий';en='overall'");
		Элементы.СвойстваОбщее.Подсказка = НСтр("ru='Общий дополнительный реквизит, который используется в"
"нескольких наборах дополнительных реквизитов.';ka='საერთო დამატებითი რეკვიზიტი, რომელიც დამატებითი რეკვიზიტების რამდენიმე კრებულში გამოიყენება.'");
	КонецЕсли;
	...
	Если Элементы.Свойства.ТекущиеДанные <> Неопределено Тогда
		...
		Если ЭтоНаборыДополнительныхСведений Тогда
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
				ТекстВопроса = НСтр("ka='მიმდინარე საერთო ინფორმაცია გავრიცხოთ კრებულიდან?';ru='Исключить текущее общее сведения из набора?';en='Delete the current general information from the set?'");
				
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ka='მიმდინარე ინფორმაციას მოვხსნათ წაშლის ნიშნული?';ru='Снять с текущего сведения пометку на удаление?';en='Remove from current data marked for deletion?'");
			Иначе
				ТекстВопроса = НСтр("ka='მიმდინარე ინფორმაცია მოვნიშნოთ წასაშლელად?';ru='Пометить текущее сведение на удаление?';en='Mark current information on the removal?'");
			КонецЕсли;
		Иначе
			Если Элементы.Свойства.ТекущиеДанные.Общее Тогда
				ТекстВопроса = НСтр("ka='მიმდინარე საერთო რეკვიზიტი გავრიცხოთ კრებულიდან?';ru='Исключить текущий общий реквизит из набора?';en='Delete the current total props from the set?'");
				
			ИначеЕсли Элементы.Свойства.ТекущиеДанные.ПометкаУдаления Тогда
				ТекстВопроса = НСтр("ka='მიმდინარე რეკვიზიტს მოვხსნათ წაშლის ნიშნული?';ru='Снять с текущего реквизита пометку на удаление?';en='Remove from current props marked for deletion?'");
			Иначе
				ТекстВопроса = НСтр("ka='მიმდინარე რეკვიზიტი მოვნიშნოთ წასაშლელად?';ru='Пометить текущий реквизит на удаление?';en='Mark the current requisite for deletion?'");
			КонецЕсли;
		КонецЕсли;
	...
	Попытка
		...
		Попытка
			...
			Если ТекущийНаборОбъект.ВерсияДанных <> ТекущийНаборВерсияДанных Тогда
				...
				Если ЭтоНаборыДополнительныхСведений Тогда
					ВызватьИсключение
						НСтр("ka='მოქმედება არ არის შესრულებული, ვინაიდან დამატებითი ინფორმაციის შემადგენლობა შეიცვალა სხვა მომხმარებლის მიერ. დამატებითი ინფორმაციის ახალი შემადგენლობა წაკითხულია."
""
"თუ საჭიროა, გაიმეორეთ მოქმედება.';ru='Действие не выполнено, так как состав дополнительных сведений"
...
"Повторите действие, если требуется.'");
				Иначе
					ВызватьИсключение
						НСтр("ka='მოქმედება არ შესრულებულა, ვინაიდან დამატებითი რეკვიზიტების შემადგენლობა შეიცვალა სხვა მომხმარებლის მიერ. დამატებითი რეკვიზიტების ახალი შემადგენლობა წაკითხულია."
""
"თუ საჭირო არის, გაიმეორეთ მოქმედება.';ru='Действие не выполнено, так как состав дополнительных реквизитов"
"был изменен другим пользователем."
