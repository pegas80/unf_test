...
Процедура НадписьПервичноеСообщениеНажатие(Элемент)
	...
	ПолучитьФайл(Адрес, НСтр("ka='ხელმოწერა';ru='Подпись'") + Объект.ИмяФайлаВыгрузки);
...
Процедура ВыгрузитьПротокол(Команда)
	...
	ПолучитьФайл(Адрес, НСтр("ka='ოქმი';ru='Протокол'") + ИмяФайлаВыгрузкиДоТочки + ".html");
...
Процедура ВыгрузитьКвитанцию(Команда)
	...
	ПолучитьФайл(Адрес, НСтр("ka='კვიტანცია';ru='Квитанция'") + ИмяФайлаВыгрузкиДоТочки + ".xml");
...
Процедура ОбновитьФорму()
	...
	Если Объект.СтатусОтправки = Перечисления.СтатусыОтправки.Отправлен Тогда
		...
		Элементы.НадписьСтатусОтправки.Заголовок = НСтр("ka='ანგარიშგების დამუშავების პროტოკოლი არ არის';ru='Протокол обработки отчета отсутствует'");
	...
	Иначе
		...
		Если Объект.НаКонтроле Тогда
			...
			Элементы.НадписьСтатусОтправки.Заголовок = НСтр("ka='პროტოკოლი მიღებულია';ru='Протокол получен'");
