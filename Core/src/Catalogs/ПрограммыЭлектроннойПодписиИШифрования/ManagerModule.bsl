...
Функция ПоставляемыеНастройкиПрограмм() Экспорт
	...
	Настройка.Представление       = НСтр("ka='ViPNet CSP';ru='ViPNet CSP';en='ViPNet CSP'");
	...
	// КриптоПро CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ka='КриптоПро CSP';ru='КриптоПро CSP';en='Crypto CSP'");
	...
	// ЛИССИ CSP
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ka='ЛИССИ CSP';ru='ЛИССИ CSP';en='LISSI CSP'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ka='სიგნალი-კომ CSP (RFC 4357)';ru='Сигнал-КОМ CSP (RFC 4357)';en='Signal COM CSP (RFC 4357)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ka='სიგნალი-კომ CSP (ITU-T X.509 v.3)';ru='Сигнал-КОМ CSP (ITU-T X.509 v.3)';en='Signal COM CSP (ITU-T X.509 v.3)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("ka='Microsoft Enhanced CSP';ru='Microsoft Enhanced CSP';en='Microsoft Enhanced CSP'");
...
Процедура ЗаполнитьНачальныеНастройкиВОблачномСервисе() Экспорт
	...
	Попытка
		...
		Если Программа = Неопределено Тогда
			...
			Программа.Наименование = НСтр("ka='ღრუბლის სერვისი';ru='Облачный сервис';en='cloud service'");
