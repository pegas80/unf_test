...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КонецЦикла;
	Элементы.Наименование.СписокВыбора.Добавить("", НСтр("ka='<Другая программа>';ru='<Другая программа>';en='<Another program>'"));
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не Запрос.Выполнить().Пустой() Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ka='აღნიშნული სახელის და ტიპის მქონე პროგრამა უკვე დამატებულია სიაში.';ru='Программа с указанным именем и типом уже добавлена в список.';en='The program with the specified name and type has already been added to the list.'"),
			,
			"Объект.ИмяПрограммы");
	КонецЕсли;
...
Процедура УстановитьПометкуУдаления(Команда)
	...
	ПоказатьВопрос(
		...
		НСтр("ka='წაშლის ნიშნულის დასაყენებლად საჭიროა თქვენს მიერ შეტანილი ცვლილებების ჩაწერა. ჩავწეროთ მონაცემები?';ru='Для установки отметки удаления необходимо записать внесенные Вами изменения."
