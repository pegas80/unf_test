...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЕстьПользовательскиеНастройки(Параметры.МассивВариантов) Тогда
		ТекстОшибки = НСтр("ka='ანგარიშგებების არჩეული ვარიანტების (%1 ც) სამომხმარებლო გამართვები არ არის მიცემული ან უკვე ჩამოყრილია.';ru='Пользовательские настройки выбранных вариантов отчетов (%1 шт) не заданы или уже сброшены.';en='Custom settings of the selected report options (% 1 items) are not set or has been reset.'");
...
Процедура КомандаСбросить(Команда)
	...
	Если КоличествоВариантов = 1 Тогда
		...
		ОповещениеЗаголовок = НСтр("ka='ანგარიშგების ვარიანტის სამომხმარებლო გამართვები ჩამოყრილია';ru='Сброшены пользовательские настройки варианта отчета';en='Reset user preferences report variant'");
