...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Если ВидФормы = "ФормаОбъекта" Тогда
		...
		Если Не ЗначениеЗаполнено(СсылкаВарианта) Тогда
			ВызватьИсключение НСтр("ka='ანგარიშგების ახალი ვარიანტის შექმნა შეიძლება მხოლოდ ანგარიშგების ფორმიდან';ru='Новый вариант отчета можно создать только из формы отчета'");
		КонецЕсли;
		...
		ИначеЕсли ПараметрыОткрытия.ТипОтчета = "Дополнительный" Тогда
			...
			Если Не ПараметрыОткрытия.Подключен Тогда
				ВызватьИсключение НСтр("ka='გარე ანგარიშგების ვარიანტის გახსნა შეიძლება მხოლოდ ანგარიშგების ფორმიდან.';ru='Вариант внешнего отчета можно открыть только из формы отчета.'");
			КонецЕсли;
		Иначе
			ВызватьИсключение НСтр("ka='გარე ანგარიშგების ვარიანტის გახსნა შეიძლება მხოლოდ ანგარიშგების ფორმიდან.';ru='Вариант внешнего отчета можно открыть только из формы отчета.'");
		КонецЕсли;
