...
Процедура ПроверитьПриоритет(Отказ)
	...
	Если Выборка.Следующий() Тогда
		ТекстСообщения = НСтр("ka='საკვანძო ოპერაცია პრიორიტეტ ""%1""-ით უკვე არსებობს (%2).';ru='Ключевая операция с приоритетом ""%1"" уже существует (%2).';en='Key operation with priority ""%1"" already exists (2%).'");
