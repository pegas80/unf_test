...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если КоэфициентПересчета = 0 Тогда 
		Отказ = Истина;
		Сообщить(НСтр("ka='Значение коэфициента не может равняться ""0""';ru='Значение коэфициента не может равняться ""0""';en='Значение коэфициента не может равняться ""0""'"));
	КонецЕсли;
