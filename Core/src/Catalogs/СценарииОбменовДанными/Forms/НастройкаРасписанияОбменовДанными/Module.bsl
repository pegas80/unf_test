...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='მონაცემთა სინქრონიზაციის სცენარი: [УзелИнформационнойБазы]-სთვის';ru='Сценарии синхронизации данных для: [УзелИнформационнойБазы]';en='Scenarios for synchronizing data [UzelInformatsionnoyBazy]'");
...
Процедура ВыполнитьСценарий(Команда)
	...
	Сообщение = НСтр("ka='მონაცემთა სინქრონიზება ხდება სცენარ ""%1""-ით...';ru='Синхронизируются данные по сценарию ""%1""...';en='Synchronize data script ""%1"" ...'");
	...
	Если Отказ Тогда
		Сообщение = НСтр("ka='სინქრონიზაციის სცენარი შეცდომებით შესრულდა.';ru='Сценарий синхронизации выполнен с ошибками.';en='Scenario synchronization is unsuccessful.'");
		Картинка = БиблиотекаКартинок.Ошибка32;
	Иначе
		Сообщение = НСтр("ka='სინქრონიზაციის სცენარი წარმატებით შესრულდა.';ru='Сценарий синхронизации успешно выполнен.';en='Scenario synchronization was successfully performed.'");
