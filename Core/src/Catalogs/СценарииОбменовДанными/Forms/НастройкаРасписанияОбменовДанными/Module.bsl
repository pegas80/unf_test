...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ka='მონაცემთა სინქრონიზაციის სცენარი: [УзелИнформационнойБазы]-სთვის';ru='Сценарии синхронизации данных для: [УзелИнформационнойБазы]'");
...
Процедура ВыполнитьСценарий(Команда)
	...
	Сообщение = НСтр("ka='მონაცემთა სინქრონიზება ხდება სცენარ ""%1""-ით...';ru='Синхронизируются данные по сценарию ""%1""...'");
	...
	Если Отказ Тогда
		Сообщение = НСтр("ka='სინქრონიზაციის სცენარი შეცდომებით შესრულდა.';ru='Сценарий синхронизации выполнен с ошибками.'");
		Картинка = БиблиотекаКартинок.Ошибка32;
	Иначе
		Сообщение = НСтр("ka='სინქრონიზაციის სცენარი წარმატებით შესრულდა.';ru='Сценарий синхронизации успешно выполнен.'");
