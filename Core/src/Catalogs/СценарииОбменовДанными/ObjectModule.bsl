...
Процедура УдалитьРегламентноеЗадание(Отказ)
	...
	Если РегламентноеЗаданиеОбъект <> Неопределено Тогда
		...
		Исключение
			СтрокаСообщения = НСтр("ka='შეცდომა მოხდა სარეგლამენტო დავალების წაშლისას: %1';ru='Ошибка при удалении регламентного задания: %1';en='Error deleting scheduled tasks: 1%'");
