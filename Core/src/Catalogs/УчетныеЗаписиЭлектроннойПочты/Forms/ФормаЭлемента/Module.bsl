...
Процедура ВыполнитьАвтоматическуюНастройку()
	...
	Если ПроверкаЗавершиласьСОшибками Тогда
		ВызватьИсключение НСтр("ka='შესაერთებლად გამართვების შერჩევა ვერ მოხერხდა. გამართვა მოახდინეთ ხელით.';ru='Не удалось подобрать настройки для подключения. Настройте вручную.'");
...
Процедура ПроверитьВыполнениеФоновогоЗадания()
	...
	Если РезультатФоновогоЗадания.ЗаданиеВыполнено Тогда
		...
		Если ПроверкаЗавершиласьСОшибками Тогда
			ПоказатьОповещениеПользователя(НСтр("ka='შესაერთებლად გამართვების შერჩევა ვერ მოხერხდა. გამართვა მოახდინეთ ხელით.';ru='Не удалось подобрать настройки для подключения. Настройте вручную.'"));
		Иначе
			ПоказатьОповещениеПользователя(НСтр("ka='ავტომატური გამართვა წარმატებით შესრულდა!';ru='Автоматическая настройка выполнена успешно!'"));
