...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИначеЕсли ТипВидаЦен = Перечисления.ТипыВидовЦен.ДинамическийПроцент Тогда
		...
		Если БазовыйВидЦен = Ссылка Тогда
			...
			ТекстОшибки = НСтр("ka='ფასის საბაზო სახეობა არ შეიძლება, რომ ფასის მიმდინარე სახეობის ტოლი იყოს';ru='Базовый вид цены не может быть равен текущему виду цены'");
