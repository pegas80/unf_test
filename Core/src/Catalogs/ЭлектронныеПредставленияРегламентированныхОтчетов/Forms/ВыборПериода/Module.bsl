...
Процедура ЗаполнитьСписокВыбораИнтервал(Форма)
	...
	Если Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Полугодие") Тогда
		СписокВыбора.Добавить(1, НСтр("ka='1 ნახევარი წელი';ru='1 полугодие'"));
		СписокВыбора.Добавить(2, НСтр("ka='2 ნახევარი წელი';ru='2 полугодие'"));
	ИначеЕсли Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал") Тогда
		СписокВыбора.Добавить(1, НСтр("ka='1 კვარტალი';ru='1 квартал'"));
		СписокВыбора.Добавить(2, НСтр("ka='2 კვარტალი';ru='2 квартал'"));
		СписокВыбора.Добавить(3, НСтр("ka='3 კვარტალი';ru='3 квартал'"));
		СписокВыбора.Добавить(4, НСтр("ka='4 კვარტალი';ru='4 квартал'"));
	ИначеЕсли Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Месяц") Тогда
		СписокВыбора.Добавить(1, НСтр("ka='იანვარი';ru='Январь'"));
		СписокВыбора.Добавить(2, НСтр("ka='თებერვალი';ru='Февраль'"));
		СписокВыбора.Добавить(3, НСтр("ka='მარტი';ru='Март'"));
		СписокВыбора.Добавить(4, НСтр("ka='აპრილი';ru='Апрель'"));
		СписокВыбора.Добавить(5, НСтр("ka='მაისი';ru='Май'"));
		СписокВыбора.Добавить(6, НСтр("ka='ივნისი';ru='Июнь'"));
		СписокВыбора.Добавить(7, НСтр("ka='ივლისი';ru='Июль'"));
		СписокВыбора.Добавить(8, НСтр("ka='აგვისტო';ru='Август'"));
		СписокВыбора.Добавить(9, НСтр("ka='სექტემბერი';ru='Сентябрь'"));
		СписокВыбора.Добавить(10, НСтр("ka='ოქტომბერი';ru='Октябрь'"));
		СписокВыбора.Добавить(11, НСтр("ka='ნოემბერი';ru='Ноябрь'"));
		СписокВыбора.Добавить(12, НСтр("ka='დეკემბერი';ru='Декабрь'"));
	КонецЕсли;
