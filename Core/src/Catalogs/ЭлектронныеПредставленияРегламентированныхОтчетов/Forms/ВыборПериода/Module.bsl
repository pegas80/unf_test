...
Процедура ЗаполнитьСписокВыбораИнтервал(Форма)
	...
	Если Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Полугодие") Тогда
		СписокВыбора.Добавить(1, НСтр("ka='1 ნახევარი წელი';ru='1 полугодие';en='1st half'"));
		СписокВыбора.Добавить(2, НСтр("ka='2 ნახევარი წელი';ru='2 полугодие';en='2nd half'"));
	ИначеЕсли Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Квартал") Тогда
		СписокВыбора.Добавить(1, НСтр("ka='1 კვარტალი';ru='1 квартал';en='Q1'"));
		СписокВыбора.Добавить(2, НСтр("ka='2 კვარტალი';ru='2 квартал';en='Q2'"));
		СписокВыбора.Добавить(3, НСтр("ka='3 კვარტალი';ru='3 квартал';en='Q3'"));
		СписокВыбора.Добавить(4, НСтр("ka='4 კვარტალი';ru='4 квартал';en='Q4'"));
	ИначеЕсли Форма.ВидПериода = ПредопределенноеЗначение("Перечисление.Периодичность.Месяц") Тогда
		СписокВыбора.Добавить(1, НСтр("ka='იანვარი';ru='Январь';en='January'"));
		СписокВыбора.Добавить(2, НСтр("ka='თებერვალი';ru='Февраль';en='February'"));
		СписокВыбора.Добавить(3, НСтр("ka='მარტი';ru='Март';en='March'"));
		СписокВыбора.Добавить(4, НСтр("ka='აპრილი';ru='Апрель';en='April'"));
		СписокВыбора.Добавить(5, НСтр("ka='მაისი';ru='Май';en='May'"));
		СписокВыбора.Добавить(6, НСтр("ka='ივნისი';ru='Июнь';en='June'"));
		СписокВыбора.Добавить(7, НСтр("ka='ივლისი';ru='Июль';en='July'"));
		СписокВыбора.Добавить(8, НСтр("ka='აგვისტო';ru='Август';en='August'"));
		СписокВыбора.Добавить(9, НСтр("ka='სექტემბერი';ru='Сентябрь';en='September'"));
		СписокВыбора.Добавить(10, НСтр("ka='ოქტომბერი';ru='Октябрь';en='October'"));
		СписокВыбора.Добавить(11, НСтр("ka='ნოემბერი';ru='Ноябрь';en='November'"));
		СписокВыбора.Добавить(12, НСтр("ka='დეკემბერი';ru='Декабрь';en='December'"));
	КонецЕсли;
