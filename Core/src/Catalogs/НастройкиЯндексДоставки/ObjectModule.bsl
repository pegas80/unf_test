...
Процедура ПередЗаписью(Отказ)
	...
	Если НастройкаПоОрганизацииСуществует() Тогда
		...
		СтрШаблон(НСтр("ka='Настройка по организации ""%1"" существует!';ru='Настройка по организации ""%1"" существует!'"), Организация),,
		"Организация",
		"Объект",
		Отказ);
		Возврат;
	...
	НСтр("ka='Настройка для ""%1""';ru='Настройка для ""%1""'"),
