...
Процедура ПередЗаписью(Отказ)
	...
	Если НастройкаПоОрганизацииСуществует() Тогда
		...
		СтрШаблон(НСтр("ka='Настройка по организации ""%1"" существует!';ru='Настройка по организации ""%1"" существует!';en='Configuring the organization ""%1"" exists!'"), Организация),,
		"Организация",
		"Объект",
		Отказ);
		Возврат;
	...
	НСтр("ka='Настройка для ""%1""';ru='Настройка для ""%1""';en='Setting for ""%1""'"),
