...
Функция ДобавляемыеРеквизиты()
	...
	"СтатусыСостояния",
	НСтр("ka='Статус в Яндекс.Доставке';ru='Статус в Яндекс.Доставке'"),
	Истина));
...
Процедура ПроверитьСоответствиеМагазинов(Ошибки)
	...
	Ошибки,
	"Объект.Магазины",
	НСтр("ka='Установите соответствие магазинов и подразделений.';ru='Установите соответствие магазинов и подразделений.'"),
	"Объект.Магазины");
...
Процедура ПроверитьСоответствиеСкладов(Ошибки)
	...
	Ошибки,
	"Объект.Склады",
	НСтр("ka='Установите соответствие складов.';ru='Установите соответствие складов.'"),
	"Объект.Склады");
...
Процедура ОтобразитьОбновленныеЗаказы(АдресРезультата)
	...
	НСтр("ka='Обновлен,Обновлено,Обновлено';ru='Обновлен,Обновлено,Обновлено'"),
	Ложь),
	СтроковыеФункцииКлиентСервер.ЧислоЦифрамиПредметИсчисленияПрописью(
	ОбновленныеЗаказы.Количество(),
	НСтр("ka='заказ,заказа,заказов';ru='заказ,заказа,заказов'")));
