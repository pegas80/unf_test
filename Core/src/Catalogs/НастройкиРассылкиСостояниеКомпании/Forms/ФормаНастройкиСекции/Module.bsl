...
Процедура Сохранить(Команда)
	...
	Если Не ЗначениеЗаполнено(ЗаголовокСекции) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Укажите заголовок секции.';ru='Укажите заголовок секции.'"),,, "ЗаголовокСекции");
		Возврат;
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ТипСекции) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='Укажите тип секции.';ru='Укажите тип секции.'"),,, "ТипСекции");
		Возврат;
	КонецЕсли;
