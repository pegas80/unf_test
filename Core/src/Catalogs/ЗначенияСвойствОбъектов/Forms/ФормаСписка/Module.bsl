	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = НСтр("ka='თვისება %1-ის მნიშვნელობა';ru='Значения свойства %1'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ka='აირჩიეთ თვისების მნიშვნელობების ჯგუფი %1';ru='Выберите группу значений свойства %1'");
			Иначе
				СтрокаЗаголовка = НСтр("ka='აირჩიეთ თვისების მნიშვნელობა %1';ru='Выберите значение свойства %1'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("ka='აირჩიეთ თვისების მნიშვნელობების ჯგუფი';ru='Выберите группу значений свойства'");
			Иначе
				СтрокаЗаголовка = НСтр("ka='აირჩიეთ თვისების მნიშვნელობა';ru='Выберите значение свойства'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
