...
Функция СформироватьПечатнуюФормуКодыТоваров(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	Для Каждого Объект Из МассивОбъектов Цикл
		...
		ОбластьМакета.Параметры.ТекстЗаголовка = НСтр("ka='საქონლის კოდები';ru='Коды товаров';en='product codes'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='საქონლის კოდები';ru='Коды товаров';en='product codes'");
