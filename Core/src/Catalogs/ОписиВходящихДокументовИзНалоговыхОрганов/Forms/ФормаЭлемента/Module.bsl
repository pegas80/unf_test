...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоНовый Тогда
		ТекстПредупреждения = НСтр("ka='Копирование описей входящих документов запрещено!';ru='Копирование описей входящих документов запрещено!';en='Copying inventories of incoming documents is forbidden!'");
		Отказ = Истина;
		Возврат;
	КонецЕсли;
