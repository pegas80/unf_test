...
Процедура ИзменитьПараметрыРасширеннойФормыПодбора()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьГруппыПользователей") Тогда
		...
		Элементы.ПользователиСписок.Заголовок                    = НСтр("ka='მომხმარებლები ჯგუფში';ru='Пользователи в группе'");
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Если ВыборГруппПользователей Тогда
				...
				Иначе
					Заголовок = НСтр("ka='მომხმარებლების და ჯგუფების შერჩევა';ru='Подбор пользователей и групп'");
				КонецЕсли;
				
				Элементы.ВыбратьПользователя.Заголовок =
					НСтр("ka='მომხმარებელთა არჩევა';ru='Выбрать пользователей'");
			...
			Иначе
				...
				Если ХранимыеПараметры.РасширенныйПодбор Тогда
					Заголовок = ХранимыеПараметры.ЗаголовокФормыПодбора;
				Иначе
					Заголовок = НСтр("ka='მომხმარებლების შერჩევა';ru='Подбор пользователей'");
				КонецЕсли;
		...
		Иначе
			...
			Если ВыборГруппПользователей Тогда
				...
				Заголовок = НСтр("ka='მომხმარებლის ან ჯგუფის არჩევა';ru='Выбор пользователя или группы'");
				
				Элементы.ВыбратьПользователя.Заголовок = НСтр("ka='მომხმარებლის არჩევა';ru='Выбрать пользователя'");
			Иначе
				Заголовок = НСтр("ka='მომხმარებლის არჩევა';ru='Выбор пользователя'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
