...
Процедура ИзменитьПараметрыРасширеннойФормыПодбора()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьГруппыПользователей") Тогда
		...
		Элементы.ПользователиСписок.Заголовок                    = НСтр("ka='მომხმარებლები ჯგუფში';ru='Пользователи в группе';en='Members in the group'");
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			...
			Если ВыборГруппПользователей Тогда
				...
				Иначе
					Заголовок = НСтр("ka='მომხმარებლების და ჯგუფების შერჩევა';ru='Подбор пользователей и групп';en='Selection of users and groups'");
				КонецЕсли;
				
				Элементы.ВыбратьПользователя.Заголовок =
					НСтр("ka='მომხმარებელთა არჩევა';ru='Выбрать пользователей';en='select users'");
			...
			Иначе
				...
				Если ХранимыеПараметры.РасширенныйПодбор Тогда
					Заголовок = ХранимыеПараметры.ЗаголовокФормыПодбора;
				Иначе
					Заголовок = НСтр("ka='მომხმარებლების შერჩევა';ru='Подбор пользователей';en='selection of members'");
				КонецЕсли;
		...
		Иначе
			...
			Если ВыборГруппПользователей Тогда
				...
				Заголовок = НСтр("ka='მომხმარებლის ან ჯგუფის არჩევა';ru='Выбор пользователя или группы';en='Selecting a user or group'");
				
				Элементы.ВыбратьПользователя.Заголовок = НСтр("ka='მომხმარებლის არჩევა';ru='Выбрать пользователя';en='select user'");
			Иначе
				Заголовок = НСтр("ka='მომხმარებლის არჩევა';ru='Выбор пользователя';en='Select user'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
