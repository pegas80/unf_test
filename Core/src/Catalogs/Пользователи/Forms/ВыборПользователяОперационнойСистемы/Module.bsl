...
Процедура Выбрать(Команда)
	...
	Если Элементы.ТаблицаДоменов.ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ka='აირჩიეთ დომენი.';ru='Выберите домен.';en='Select the domain.'"));
		Возврат;
	КонецЕсли;
	...
	Если Элементы.ТаблицаПользователейДомена.ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ka='აირჩიეთ დომენის მომხმარებელი.';ru='Выберите пользователя домена.';en='Select a domain user.'"));
		Возврат;
	КонецЕсли;
