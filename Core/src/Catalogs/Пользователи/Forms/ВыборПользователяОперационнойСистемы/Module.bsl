...
Процедура Выбрать(Команда)
	...
	Если Элементы.ТаблицаДоменов.ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ka='აირჩიეთ დომენი.';ru='Выберите домен.'"));
		Возврат;
	КонецЕсли;
	...
	Если Элементы.ТаблицаПользователейДомена.ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ka='აირჩიეთ დომენის მომხმარებელი.';ru='Выберите пользователя домена.'"));
		Возврат;
	КонецЕсли;
