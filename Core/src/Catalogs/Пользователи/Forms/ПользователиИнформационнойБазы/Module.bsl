...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Пользователи.ЭтоПолноправныйПользователь(, Не РазделениеВключено) Тогда
		ВызватьИсключение НСтр("ka='საინფორმაციო ბაზის მომხმარებელთა სიის გასახსნელად უფლებები არასაკმარისია.';ru='Недостаточно прав для открытия списка пользователей информационной базы.'");
	КонецЕсли;
...
Процедура ОтменитьСопоставление(Команда)
	...
	Кнопки.Добавить("ОтменитьСопоставление", НСтр("ka='შედარების გაუქმება';ru='Отменить сопоставление'"));
	Кнопки.Добавить("ОставитьСопоставление", НСтр("ka='შედარების დატოვება';ru='Оставить сопоставление'"));
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ka='<Нет данных>';ru='<Нет данных>'"));
...
Процедура УдалитьТекущегоПользователяИБ(УдалитьСтроку = Ложь)
	...
	ПоказатьВопрос(
		...
		НСтр("ka='წავშალოთ საინფორმაციო ბაზის მომხმარებელი?';ru='Удалить пользователя информационной базы?'"),
