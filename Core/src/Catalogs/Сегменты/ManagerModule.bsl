...
Функция ПолучитьДоступныеПравилаОтбора() Экспорт
	...
	ГруппаСвойстваКонтрагента.Представление = НСтр("ka='რეკვიზიტები (ძირითადი, დამატებითი)';ru='Реквизиты (основные, дополнительные)'");
	ГруппаСвойстваКонтрагента.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаСвойстваКонтрагента.Строки.Добавить();
	НовоеПравило.Имя = "Тег";
	НовоеПравило.Представление = НСтр("ka='ტეგი';ru='Тег'");
	...
	НовоеПравило.Представление = НСтр("ka='კონტრაგენტის სახეობა';ru='Вид контрагента'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ka='მყიდველი';ru='Покупатель'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ka='მომწოდებელი';ru='Поставщик'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("Булево"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	НовоеПравило.Представление = НСтр("ka='სხვა ურთიერთობები';ru='Прочие отношения'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("Булево"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаКонтактнаяИнформация.Представление = НСтр("ka='მისამართები (გეოგრაფია)';ru='Адреса (география)'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.Тип = Перечисления.ТипыКонтактнойИнформации.Адрес Тогда
			...
			НовоеПравило.ЭтоГруппа = Ложь;
			НовоеПравило.МножественноеИспользование = Ложь;
			НовоеПравило.Представление = НСтр("ka='ქვეყანა';ru='Страна'") + " (" + НРег(ПравилоАдрес.Представление) + ")";
			НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтрока);
			НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
			ДобавитьВидыСравнений(НовоеПравило, "НачинаетсяС,НеНачинаетсяС,Содержит,НеСодержит", 3);
			...
			НовоеПравило.ЭтоГруппа = Ложь;
			НовоеПравило.МножественноеИспользование = Ложь;
			НовоеПравило.Представление = НСтр("ka='რეგიონი';ru='Регион'") + " (" + НРег(ПравилоАдрес.Представление) + ")";
			НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтрока);
			НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
			ДобавитьВидыСравнений(НовоеПравило, "НачинаетсяС,НеНачинаетсяС,Содержит,НеСодержит", 3);
			...
			НовоеПравило.ЭтоГруппа = Ложь;
			НовоеПравило.МножественноеИспользование = Ложь;
			НовоеПравило.Представление = НСтр("ka='ქალაქი';ru='Город'") + " (" + НРег(ПравилоАдрес.Представление) + ")";
			НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтрока);
			НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
			ДобавитьВидыСравнений(НовоеПравило, "НачинаетсяС,НеНачинаетсяС,Содержит,НеСодержит", 3);
	...
	ГруппаСобытия.Представление = НСтр("ka='მოვლენები (ხანდაზმულობა, რაოდენობა)';ru='События (давность, количество)'");
	ГруппаСобытия.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаСобытия.Строки.Добавить();
	НовоеПравило.Имя = "СобытияДатаПоследнего";
	НовоеПравило.Представление = НСтр("ka='უკანასკნელი მოვლენის თარიღი';ru='Дата последнего события'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартнаяДата);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ПравилоКоличествоСобытий.Представление = НСтр("ka='მოვლენების რაოდენობა';ru='Количество событий'");
	...
	НовоеПравило.Представление = НСтр("ka='პერიოდის მანძილზე';ru='За период'") + " (" + НРег(ПравилоКоличествоСобытий.Представление) + ")";
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаДополнительно.Представление = НСтр("ka='მოვლენების დაზუსტება';ru='Уточнения событий'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "СобытияСостояние";
	НовоеПравило.Представление = НСтр("ka='მოვლენების მდგომარეობა';ru='Состояние событий'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ka='მოვლენების ტიპი';ru='Тип событий'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаЗаказы.Представление = НСтр("ka='მყიდველების შეკვეთა (ხანდაზმულობა, რაოდენობა)';ru='Заказы покупателей (давность, количество)'");
	ГруппаЗаказы.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаЗаказы.Строки.Добавить();
	НовоеПравило.Имя = "ЗаказыПокупателейДатаПоследнего";
	НовоеПравило.Представление = НСтр("ka='უკანასკნელი შეკვეთის თარიღი';ru='Дата последнего заказа'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартнаяДата);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ПравилоКоличествоЗаказов.Представление = НСтр("ka='შეკვეთების რაოდენობა';ru='Количество заказов'");
	...
	НовоеПравило.Представление = НСтр("ka='პერიოდის მანძილზე';ru='За период'") + " (" + НРег(ПравилоКоличествоЗаказов.Представление) + ")";
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаДополнительно.Представление = НСтр("ka='მყიდველების შეკვეთის დაზუსტება';ru='Уточнения заказов покупателей'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "ЗаказыПокупателейСостояниеЗаказа";
	НовоеПравило.Представление = НСтр("ka='მყიდველის შეკვეთების მდგომარეობა';ru='Состояние заказов покупателя'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаСчета.Представление = НСтр("ka='გადასახდელი ანგარიშები (ხანდაზმულობა, რაოდენობა)';ru='Счета на оплату (давность, количество)'");
	ГруппаСчета.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаСчета.Строки.Добавить();
	НовоеПравило.Имя = "СчетаНаОплатуДатаПоследнего";
	НовоеПравило.Представление = НСтр("ka='უკანასკნელი ანგარიშის თარიღი';ru='Дата последнего счета'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартнаяДата);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ПравилоКоличествоСчетов.Представление = НСтр("ka='ანგარიშების რაოდენობა';ru='Количество счетов'");
	...
	НовоеПравило.Представление = НСтр("ka='პერიოდის მანძილზე';ru='За период'") + " (" + НРег(ПравилоКоличествоСчетов.Представление) + ")";
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаПродажиНоменклатура.Представление = НСтр("ka='გაყიდვები (ნომენკლატურა)';ru='Продажи (номенклатура)'");
	...
	НовоеПравило.Представление = НСтр("ka='ნომენკლატურა';ru='Номенклатура'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	НовоеПравило.Представление = НСтр("ka='ნომენკლატურის ჯგუფი';ru='Группа номенклатуры'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("СправочникСсылка.Номенклатура"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Группы);
	...
	НовоеПравило.Представление = НСтр("ka='ნომენკლატურის კატეგორია';ru='Категория номенклатуры'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	...
	ГруппаДополнительно.Представление = НСтр("ka='ნომენკლატურის მიხედვით გაყიდვების დაზუსტება';ru='Уточнения продаж по номенклатуре'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "ПродажиНоменклатураПериод";
	НовоеПравило.Представление = НСтр("ka='პერიოდის მანძილზე (ნომენკლატურის მიხედვით გაყიდვები)';ru='За период (продажи по номенклатуре)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаПродажиВыручка.Представление = НСтр("ka='გაყიდვები (შემოსავალი, მოგება)';ru='Продажи (выручка, прибыль)'");
	...
	НовоеПравило.Представление = НСтр("ka='შემოსავალი (მმართვ. ვალუტა)';ru='Выручка (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	...
	НовоеПравило.Представление = НСтр("ka='მთლიანი მოგება (მმართვ. ვალუტა)';ru='Валовая прибыль (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеДенежногоТипа);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаДополнительно.Представление = НСтр("ka='გაყიდვებისგან მოგების დაზუსტება';ru='Уточнения выручки от продаж'");
	ГруппаДополнительно.ЭтоГруппа = Истина;
	
	НовоеПравило = ГруппаДополнительно.Строки.Добавить();
	НовоеПравило.Имя = "ПродажиВыручкаПериод";
	НовоеПравило.Представление = НСтр("ka='პერიოდის მანძილზე (გაყიდვიდან მიღებული შემოსავალი)';ru='За период (выручка от продаж)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Ложь;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеТипаСтандартныйПериод);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	ГруппаЗадолженность.Представление = НСтр("ka='დავალიანება (ვალი, გადავადება)';ru='Задолженность (долг, просрочка)'");
	...
	НовоеПравило.Представление = НСтр("ka='მყიდველის ვალის თანხა (მმართვ. ვალუტა)';ru='Сумма долга покупателя (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеДенежногоТипа);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	НовоеПравило.Представление = НСтр("ka='მყიდველის ვადის გადაცილების ვადა (დღე)';ru='Срок просрочки покупателя (дней)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	...
	НовоеПравило.Представление = НСтр("ka='მომწოდებლისადმი არსებული ვალის ოდენობა (მმართვ. ვალუტა)';ru='Сумма долга поставщику (упр. валюта)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", ОписаниеДенежногоТипа);
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
	...
	НовоеПравило.Представление = НСтр("ka='მომწოდებლისთვის გადავადების ვადა (დღე)';ru='Срок просрочки поставщику (дней)'");
	НовоеПравило.ЭтоГруппа = Ложь;
	НовоеПравило.МножественноеИспользование = Истина;
	НовоеПравило.СвойстваЗначения.Вставить("ОграничениеТипа", Новый ОписаниеТипов("Число"));
	НовоеПравило.СвойстваЗначения.Вставить("ВыборГруппИЭлементов", ГруппыИЭлементы.Авто);
...
Процедура ДобавитьВидыСравнений(Правило, ДобавляемыеВидыСравнений, НомерВидаПоУмолчанию = 1)
	...
	Для Каждого ВидСтрокой Из МассивВидов Цикл
		Если ВидСтрокой = "Равно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Равно,			 НСтр("ka='უდრის';ru='Равно'"));
		ИначеЕсли ВидСтрокой = "НеРавно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеРавно,		 НСтр("ka='არ უდრის';ru='Не равно'"));
		ИначеЕсли ВидСтрокой = "Больше" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Больше,		 НСтр("ka='მეტი';ru='Больше'"));
		ИначеЕсли ВидСтрокой = "БольшеИлиРавно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.БольшеИлиРавно, НСтр("ka='მეტია ან ტოლია';ru='Больше или равно'"));
		ИначеЕсли ВидСтрокой = "Меньше" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Меньше,		 НСтр("ka='ნაკლები';ru='Меньше'"));
		ИначеЕсли ВидСтрокой = "МеньшеИлиРавно" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.МеньшеИлиРавно, НСтр("ka='ნაკლები ან ტოლი';ru='Меньше или равно'"));
		ИначеЕсли ВидСтрокой = "ВСписке" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.ВСписке,		 НСтр("ka='სიაში';ru='В списке'"));
		ИначеЕсли ВидСтрокой = "НеВСписке" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеВСписке,		 НСтр("ka='არა სიაში';ru='Не в списке'"));
		ИначеЕсли ВидСтрокой = "ВИерархии" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.ВИерархии,		 НСтр("ka='ჯგუფში';ru='В группе'"));
		ИначеЕсли ВидСтрокой = "НеВИерархии" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеВИерархии,	 НСтр("ka='არა ჯგუფში';ru='Не в группе'"));
		ИначеЕсли ВидСтрокой = "Заполнено" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Заполнено,		 НСтр("ka='შევსებულია';ru='Заполнено'"));
		ИначеЕсли ВидСтрокой = "НеЗаполнено" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеЗаполнено,	 НСтр("ka='არ არის შევსებული';ru='Не заполнено'"));
		ИначеЕсли ВидСтрокой = "НачинаетсяС" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НачинаетсяС,	 НСтр("ka='იწყება  დან';ru='Начинается с'"));
		ИначеЕсли ВидСтрокой = "НеНачинаетсяС" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеНачинаетсяС,	 НСтр("ka='არ იწყება';ru='Не начинается с'"));
		ИначеЕсли ВидСтрокой = "Содержит" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.Содержит,		 НСтр("ka='შეიცავს';ru='Содержит'"));
		ИначеЕсли ВидСтрокой = "НеСодержит" Тогда
			Правило.ДоступныеВидыСравнения.Добавить(ВидСравненияКомпоновкиДанных.НеСодержит,	 НСтр("ka='არ შეიცავს';ru='Не содержит'"));
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗаполнитьПоставляемыеСегменты() Экспорт
	...
	Сегмент.Наименование = НСтр("ka='ახლები კვირეულის მანძილზე';ru='Новые за неделю'");
	Сегмент.Комментарий = НСтр("ka='# სეგმენტი შექმნილია ავტომატურად';ru='# Сегмент создан автоматически'");
	...
	Сегмент = Справочники.Сегменты.СоздатьЭлемент();
	Сегмент.УстановитьНовыйКод();
	Сегмент.Наименование = НСтр("ka='ერთ თვეზე მეტია კავშირზე არ გამოსულან.';ru='Не связывались больше месяца'");
	Сегмент.Комментарий = НСтр("ka='# სეგმენტი შექმნილია ავტომატურად';ru='# Сегмент создан автоматически'");
	...
	Сегмент = Справочники.Сегменты.СоздатьЭлемент();
	Сегмент.УстановитьНовыйКод();
	Сегмент.Наименование = НСтр("ka='არის ბოლო თვის შეკვეთები';ru='Есть заказы за последний месяц'");
	Сегмент.Комментарий = НСтр("ka='# სეგმენტი შექმნილია ავტომატურად';ru='# Сегмент создан автоматически'");
