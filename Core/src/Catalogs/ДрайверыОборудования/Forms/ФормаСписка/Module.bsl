...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.ТекстЗапроса = СтрЗаменить(Список.ТекстЗапроса, "%Предопределенный%", НСтр("ka='მოწოდებული კონფიგურაციის შემადგენლობაში.';ru='Поставляемый в составе конфигурации'"));
	Список.ТекстЗапроса = СтрЗаменить(Список.ТекстЗапроса, "%Подключаемый%", НСтр("ka='სტანდარტ """"1С:თავსებადია""""-თი შესაერთებელი';ru='Подключаемый по стандарту """"1С:Совместимо""""'"));
