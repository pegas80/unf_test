	...
	Если Параметры.Отбор.Свойство("Владелец") Тогда
		...
		Если ЗначениеЗаполнено(Параметры.Отбор.Владелец) Тогда
			...
			Если (ТипВладелец = Перечисления.ТипыНоменклатуры.Операция
				...
				ТекстНадписи = НСтр("ka='%ТПНоменклатура% ტიპის ნომენკლატურისთვის სპეციფიკაცია არ მიეთითება!';ru='Для номенклатуры типа %ТПНоменклатура% спецификация не указывается!';en='For the range of type%% TPNomenklatura specification does not specify!'");
