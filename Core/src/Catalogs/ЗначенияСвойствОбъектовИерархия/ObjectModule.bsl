	...
	Если ЗначениеЗаполнено(Владелец) Тогда
		...
		Если ЗначениеЗаполнено(ВладелецДополнительныхЗначений) Тогда
			ОписаниеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ka='დამატებითი მნიშვნელობები თვისება ""%1""-ისთვის, რომელიც თვისება ""%2""-ის ნიმუშის მიხედვით არის შექმნილი, უნდა შეიქმნას თვისება-ნიმუშისთვის.';ru='Дополнительные значения для свойства ""%1"", созданного"
