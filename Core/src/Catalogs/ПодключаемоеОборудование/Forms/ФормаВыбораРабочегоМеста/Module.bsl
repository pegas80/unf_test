...
Процедура ВыбратьИЗакрыть(Команда)
	...
	Иначе
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='აირჩიეთ სამუშაო ადგილი';ru='Выберите рабочее место';en='Select a workspace'"), РабочееМесто, "РабочееМесто");
