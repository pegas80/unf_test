...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ПустаяСтрока(Наименование) Тогда
		...
		Если Не Запрос.Выполнить().Пустой() Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='მითითებულია ელემენტის არაუნიკალური სახელწოდება. მიუთითეთ უნიკალური სახელწოდება.';ru='Указано неуникальное наименование элемента. Укажите уникальное наименование.'"), ЭтотОбъект, , , Отказ);
		КонецЕсли;
	КонецЕсли;
	...
	Если ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.WebСервисОборудование Тогда
		...
		Если ЗначениеЗаполнено(ИдентификаторWebСервисОборудования) Тогда
			...
			Если Не Запрос.Выполнить().Пустой() Тогда
				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='მითითებულია ელემენტის აქტიური მოწყობილობის არაუნიკალური იდენტიფიკატორი. მიუთითეთ უნიკალური იდენტიფიკატორი.';ru='Указан неуникальный идентификатор активного оборудования элемента. Укажите уникальный идентификатор.'"), ЭтотОбъект, , , Отказ);
			КонецЕсли;
		КонецЕсли;
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Наименование = НСтр("ka='%Наименование% (ასლი)';ru='%Наименование% (копия)'");
