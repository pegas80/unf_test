...
Функция СоздатьВидЦенКонтрагента(Контрагент, ВалютаРасчетов) Экспорт
	...
	СтруктураЗаполнения = Новый Структура("Наименование, Владелец, ВалютаЦены, ЦенаВключаетНДС, Комментарий", 
		Лев(Нстр("ru = 'Цены для '; ka = 'ფასები '") + Контрагент.Наименование + Нстр("ka = ' -სთვის'"), 50),
		Контрагент,
		ВалютаРасчетов,
		Истина,
		Нстр("ru = 'Регистрирует входящие цены. Создан автоматически.'; ka = 'არეგისტრირებს შემომავალ ფასებს. შექმნილია ავტომატურად.'"));
