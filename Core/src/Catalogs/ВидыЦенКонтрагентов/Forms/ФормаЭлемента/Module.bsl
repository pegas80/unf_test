...
Процедура ПоказатьПомощникЗагрузкиДанныхИзВнешнегоИсточника()
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		ТекстСообщения = НСтр("ka='აუცილებელია კონტრაგენტის ფასების სახეობის ჩაწერა';ru='Необходимо записать вид цен контрагента';en='You must write the type of counterparty prices'");
