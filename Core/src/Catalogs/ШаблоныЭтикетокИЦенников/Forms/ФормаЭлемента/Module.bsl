...
Процедура ОткрытьФормуРедактированияМакета(Команда)
	...
	Если Объект.Ссылка.Пустая() Тогда
		...
		ПоказатьВопрос(Оповещение, НСтр("ka='შაბლონის რედაქტირებისთვის აუცილებელია ელემენტის ჩაწერა! ჩავწეროთ?';ru='Для редактирования шаблона необходимо записать элемент! Записать?'"), РежимДиалогаВопрос.ДаНет, , КодВозвратаДиалога.Да);
	Иначе
