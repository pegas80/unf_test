...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РезультатЗапроса.Количество() = 0 Тогда
		...
		Сообщение.Текст = НСтр("ka='Отсутствуют элементы для восстановления.';ru='Отсутствуют элементы для восстановления.'");
	...
	Для Каждого Стр Из ТаблицаЗначений Цикл
		...
		Если Стр.Пометка = Истина Тогда
			...
			Исключение
				...
				Сообщение.Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ka='Не удалось удалить ссылку на скрытый отчет из регистра сведений. %1';ru='Не удалось удалить ссылку на скрытый отчет из регистра сведений. %1'"), ОписаниеОшибки());
