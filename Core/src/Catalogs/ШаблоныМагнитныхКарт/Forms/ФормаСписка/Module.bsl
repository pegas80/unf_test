...
"Возможно, шаблон настроен неверно.';ka='ველების წაკითხვა ვერ მოხერხდა. შეიძლება, შაბლონი არასწორად არის გამართული.'"));
			Иначе
				НайденШаблон = Ложь;
				...
				Если НЕ НайденШаблон Тогда
					ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ka='კოდი არ შეესაბამება მოცემულ შაბლონს. შეიძლება, შაბლონი არასწორად არის გამართული.';ru='Код не соответствует данному шаблону. "
