...
Процедура ПроверитьДублиФизическихЛиц(Отказ)
	...
	ШаблонСообщения = НСтр("ka='Физическое лицо %1 добавлено более одного раза в комиссию. Необходимо пересмотреть состав комиссии.';ru='Физическое лицо %1 добавлено более одного раза в комиссию. Необходимо пересмотреть состав комиссии.'");
