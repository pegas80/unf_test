...
Функция ШаблоныТекстовПечатнойФормы(ЭтоИнвентаризация)
	...
	Если ЭтоИнвентаризация Тогда
		...
		ТекстыЗаполненияПФ.Вставить("ОписаниеПриказа",					НСтр("ka='о создании инвентаризационной комиссии по предприятию:';ru='о создании инвентаризационной комиссии по предприятию:'"));
		ТекстыЗаполненияПФ.Вставить("НазначениеКомиссии",				НСтр("ka='с целью проведения инвентаризационных работ назначается постоянно действующая комиссия в составе:';ru='с целью проведения инвентаризационных работ назначается постоянно действующая комиссия в составе:'"));
		ТекстыЗаполненияПФ.Вставить("ОбязанностиКомиссииЗаголовок",		НСтр("ka='Постоянно действующая инвентаризационная комиссия осуществляет свою работу в соответствии с учетной политикой организации и утверждается текущим приказом. В обязанности комиссии входит:';ru='Постоянно действующая инвентаризационная комиссия осуществляет свою работу в соответствии с учетной политикой организации и утверждается текущим приказом. В обязанности комиссии входит:'"));
		ТекстыЗаполненияПФ.Вставить("Пункт1",							НСтр("ka='1. Обеспечивает проведение инвентаризаций всего имущества и всех обязательств организации;';ru='1. Обеспечивает проведение инвентаризаций всего имущества и всех обязательств организации;'"));
		ТекстыЗаполненияПФ.Вставить("Пункт2",							НСтр("ka='2. В период проведения плановых инвентаризаций курирует и обобщает деятельность рабочих предприятия.';ru='2. В период проведения плановых инвентаризаций курирует и обобщает деятельность рабочих предприятия.'"));
		ТекстыЗаполненияПФ.Вставить("СрокДействияКомиссииЗаголовок",	НСтр("ka='Персональный состав постоянно действующей инвентаризационной комиссии назначается сроком до:';ru='Персональный состав постоянно действующей инвентаризационной комиссии назначается сроком до:'"));
		
	Иначе
		
		ТекстыЗаполненияПФ.Вставить("ОписаниеПриказа",					НСтр("ka='о создании комиссии по предприятию:';ru='о создании комиссии по предприятию:'"));
		ТекстыЗаполненияПФ.Вставить("НазначениеКомиссии",				НСтр("ka='с целью оприходования товаров без счета поставщика назначается постоянно действующая комиссия в составе:';ru='с целью оприходования товаров без счета поставщика назначается постоянно действующая комиссия в составе:'"));
		...
		ТекстыЗаполненияПФ.Вставить("Пункт1",							НСтр("ka='1. Обеспечивает приемку и оприходования фактически полученных товарно-материальных ценностей, поступивших без счета поставщика;';ru='1. Обеспечивает приемку и оприходования фактически полученных товарно-материальных ценностей, поступивших без счета поставщика;'"));
		ТекстыЗаполненияПФ.Вставить("Пункт2",							НСтр("ka='2. Оформляет документы, которые подтверждают фактическое наличие товаров (ТОРГ-4) и обобщает деятельность рабочих предприятия.';ru='2. Оформляет документы, которые подтверждают фактическое наличие товаров (ТОРГ-4) и обобщает деятельность рабочих предприятия.'"));
		ТекстыЗаполненияПФ.Вставить("СрокДействияКомиссииЗаголовок",	НСтр("ka='Персональный состав постоянно действующей комиссии назначается сроком до:';ru='Персональный состав постоянно действующей комиссии назначается сроком до:'"));
...
Функция ПечатьПриказа(МассивОбъектов, ОбъектыПечати, Макет) Экспорт
	...
	Пока ДанныеДокументов.Следующий() Цикл
		...
		ПредставлениеПриказа = НСтр("ka='Приказ №%1 от %2';ru='Приказ №%1 от %2'");
		...
		СтруктурнаяЕдиница = ?(ЗначениеЗаполнено(ДанныеДокументов.СтруктурнаяЕдиница), ДанныеДокументов.СтруктурнаяЕдиница, НСтр("ka='По организации в целом';ru='По организации в целом'"));
		...
		Иначе
			...
			СрокДействияКомиссии = НСтр("ka='Комиссия фукционирует бессрочно';ru='Комиссия фукционирует бессрочно'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПечатнаяФорма <> Неопределено Тогда
		...
		ПечатнаяФорма.СинонимМакета		= НСтр("ka='Приказ о создании комиссии';ru='Приказ о создании комиссии'");
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ka='Приказ о создании комиссии';ru='Приказ о создании комиссии'");
