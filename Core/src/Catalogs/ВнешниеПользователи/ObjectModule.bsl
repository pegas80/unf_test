...
Процедура ПередЗаписью(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(ОбъектАвторизации) Тогда
		ВызватьИсключение НСтр("ka='გარე მომხმარებელს ავტორიზაციის ობიექტი არ აქვს მიცემული.';ru='У внешнего пользователя не задан объект авторизации.'");
	Иначе
		ТекстОшибки = "";
	...
	Иначе
		...
		Если ЗначениеЗаполнено(СтарыйОбъектАвторизации)
		   И СтарыйОбъектАвторизации <> ОбъектАвторизации Тогда
			...
			ВызватьИсключение НСтр("ka='ავტორიზაციის უწინ მითითებული ობიექტის შეცვლა არ შეიძლება.';ru='Невозможно изменить ранее указанный объект авторизации.'");
		КонецЕсли;
	КонецЕсли;
