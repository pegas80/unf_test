	...
	Если ВидФормы = "ФормаОбъекта" И Параметры.Свойство("ОбъектАвторизации") Тогда
		...
		Иначе
			ОписаниеОшибкиКакПредупреждения =
				НСтр("ka='პროგრამაში შესვლის ნებართვა არ შეთავაზებულა.';ru='Разрешение на вход в программу не предоставлялось.';en='Permission for entry into the program is not granted.'");
