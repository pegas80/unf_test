...
Процедура РозничныйВидЦенПриИзменении(Элемент)
	...
	Если НЕ СтруктураДанных.ВалютаЦены = СтруктураДанных.НациональнаяВалюта Тогда
		...
		ТекстСообщения = НСтр("ka='ფასების ტიპ ""%ВидЦен%""-ს, საცალო სტრუქტურული ერთეულისთვის უნდა მიეცეს ეროვნული ვალუტა (%НацВалюта%).';ru='У вида цен ""%ВидЦен%"", для розничной структурной единицы, должна быть задана национальная валюта (%НацВалюта%).'");
