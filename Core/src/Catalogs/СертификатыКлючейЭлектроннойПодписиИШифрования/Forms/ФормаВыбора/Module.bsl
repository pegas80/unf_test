...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбщиеНастройки.ИспользоватьШифрование
	   И Не ОбщиеНастройки.ЗаявлениеНаВыпускСертификатаДоступно Тогда
		...
		Элементы.ФормаСоздать.Заголовок = НСтр("ka='დამატება';ru='Добавить';en='Add'");
		Элементы.СписокКонтекстноеМенюСоздать.Заголовок = НСтр("ka='დამატება';ru='Добавить';en='Add'");
	КонецЕсли;
