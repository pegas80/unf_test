...
Процедура НастроитьАвтоматическиСейчасПослеСохранения()
	...
	Если Организация = Неопределено Тогда
		...
		Иначе
			ПоказатьПредупреждение(, НСтр("ka='Учетная запись не привязана ни к какой организации. Настройка невозможна.';ru='Учетная запись не привязана ни к какой организации. Настройка невозможна.'"));
		КонецЕсли;
	Иначе
...
Функция ПараметрыДоступаВерны()
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ka='Электронный документооборот с КО.Проверка параметров подключения';ru='Электронный документооборот с КО.Проверка параметров подключения'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
