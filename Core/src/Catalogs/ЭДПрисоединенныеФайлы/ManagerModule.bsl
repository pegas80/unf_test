...
Процедура ЗаполнитьНаименованиеФайла() Экспорт
	...
	Пока ЭлементСсылка.Следующий() Цикл
		...
		Исключение
			Операция = НСтр("ka='მიერთებული ფაილის ჩაწერა';ru='Запись присоединенного файла'");
...
Процедура СообщитьОбОшибке(Знач Описание)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ka='Сертификаты электронной подписи.Перенос настроек в новый объект метаданных';ru='Сертификаты электронной подписи.Перенос настроек в новый объект метаданных'",
			ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
