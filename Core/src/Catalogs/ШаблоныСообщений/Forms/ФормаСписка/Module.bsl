...
Процедура ИнициализироватьОтборы()
	...
	ВидыШаблонов.Вставить(0, НСтр("ka='Электронных писем и SMS';ru='Электронных писем и SMS'"), НСтр("ka='Электронных писем и SMS';ru='Электронных писем и SMS'"));
	...
	Список.Параметры.УстановитьЗначениеПараметра("СлужебныйШаблон", НСтр("ka='სამსახურებრივი';ru='Служебный'"));
	...
	Элементы.НазначениеФильтр.СписокВыбора.Добавить("", НСтр("ka='ყველა';ru='Все'"));
	
	ОбщийПредставление = НСтр("ka='საერთო';ru='Общий'");
	...
	Назначение = "";
	ШаблонДля = НСтр("ka='Электронных писем и SMS';ru='Электронных писем и SMS'");
...
Процедура ШаблонДляФильтрОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	Если ВыбранноеЗначение = "SMS" Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "ШаблонДля", НСтр("ka='სმს შეტყობინებები';ru='Сообщения SMS'"), ВидСравненияКомпоновкиДанных.Равно);
	ИначеЕсли ВыбранноеЗначение = "Email" Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(Список.Отбор, "ШаблонДля", НСтр("ka='ელექტრონული წერილი';ru='Электронного письма'"), ВидСравненияКомпоновкиДанных.Равно);
	Иначе
...
Процедура ПоказыватьСлужебныеШаблоны(Команда)
	...
	Если Элементы.ФормаПоказыватьСлужебныеШаблоны.Пометка Тогда
		Элементы.НазначениеФильтр.СписокВыбора.Добавить("Служебный", НСтр("ka='სამსახურებრივი';ru='Служебный'"));
	Иначе
