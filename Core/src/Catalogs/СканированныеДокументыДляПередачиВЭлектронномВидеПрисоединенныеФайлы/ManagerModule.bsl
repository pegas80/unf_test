...
Процедура ВыполнитьНачальноеЗаполнение(Параметры) Экспорт
	...
	Пока ВыборкаДокумент.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(НСтр("ka='Заполнение справочника СканированныеДокументыДляПередачиВЭлектронномВидеПрисоединенныеФайлы';ru='Заполнение справочника СканированныеДокументыДляПередачиВЭлектронномВидеПрисоединенныеФайлы';en='Filling SkanirovannyeDokumentyDlyaPeredachiVElektronnomVidePrisoedinennyeFayly directory'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), 
