...
Процедура СоставПеретаскивание(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
	...
	Если СообщениеПользователю <> Неопределено Тогда
		ПоказатьОповещениеПользователя(
			НСтр("ka='მომხმარებლების გადაადგილება';ru='Перемещение пользователей'"), , СообщениеПользователю, БиблиотекаКартинок.Информация32);
	КонецЕсли;
...
Процедура ВыбратьНазначение(Команда)
	...
	ПользователиСлужебныйКлиент.ВыбратьНазначение(ЭтотОбъект, НСтр("ka='მომხმარებლების სახეობის არჩევა';ru='Выбор вида пользователей'"), Ложь, Ложь, ОписаниеОповещения);
...
Функция ПараметрыРасширеннойФормыПодбора()
	...
	ЗаголовокФормыПодбора = НСтр("ka='გარე მომხმარებლების ჯგუფის მონაწილეების შერჩევა';ru='Подбор участников группы внешних пользователей'");
