...
Функция ПараметрыРасширеннойФормыПодбора()
	...
	ЗаголовокФормыПодбора = НСтр("ka='მომხმარებლების ჯგუფის მონაწილეების შერჩევა';ru='Подбор участников группы пользователей';en='Selection of participants in a group of users'");
