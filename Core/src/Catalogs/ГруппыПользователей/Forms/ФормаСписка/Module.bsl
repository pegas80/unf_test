...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			// Режим подбора.
			Заголовок = НСтр("ka='მომხმარებლების ჯგუფების შერჩევა';ru='Подбор групп пользователей';en='Selection of user groups'");
			Элементы.Список.МножественныйВыбор = Истина;
			Элементы.Список.РежимВыделения = РежимВыделенияТаблицы.Множественный;
		Иначе
			Заголовок = НСтр("ka='მომხმარებელთა ჯგუფის არჩევა';ru='Выбор группы пользователей';en='Selection of user group'");
		КонецЕсли;
