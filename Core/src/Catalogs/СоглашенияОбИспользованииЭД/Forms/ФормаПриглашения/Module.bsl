...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("НастройкаЭДО", НастройкаЭДО) И ЗначениеЗаполнено(НастройкаЭДО) Тогда
		...
		ШаблонНастройкиЭДО = НСтр("ka='კონტრაგენტ %1-თან ედბ-ის გამართვა';ru='Настройка ЭДО с контрагентом %1';en='Setting up the EDI counterparty 1%'");
...
"Необходимо выполнить тест настроек ЭДО с контрагентом %1.';ka='მოწვევის გაგზავნისას შეცდომები წარმოიშვა."
"აუცილებელია კონტრაგენტ %1-თან ედბ-ის გამართვების ტესტის შესრულება.'");
...
"Необходимо выполнить тест настроек ЭДО с контрагентом %1.';ka='მოწვევის უარყოფისას შეცდომები წარმოიშვა."
"საჭიროა კონტრაგენტ %1-თან ედბ-ის გამართვების ტესტის შესრულება.'");
...
"Необходимо выполнить тест настроек ЭДО с контрагентом %1.';ka='მოწვევის მიღებისას შეცდომები წარმოიშვა."
"აუცილებელია კონტრაგენტ %1-თან ედბ-ის გამართვების ტესტის შესრულება.'");
