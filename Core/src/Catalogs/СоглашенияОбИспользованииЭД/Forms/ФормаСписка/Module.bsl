...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокСоглашенийСКонтрагентами.Параметры.УстановитьЗначениеПараметра("ТекстРасширенныйРежим", НСтр("ka='გაფართოებული რეჟიმი';ru='Расширенный режим';en='Advanced mode'"));
