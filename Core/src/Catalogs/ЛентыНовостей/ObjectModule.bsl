...
Процедура ПередЗаписью(Отказ)
	...
	Если ЭтотОбъект.ЗагруженоССервера = Истина Тогда
		...
		Если (ЭтотОбъект.ПометкаУдаления = Истина)
			...
			Иначе
				ТекстСообщения = НСтр("ka='ახალი ამბების სერვერიდან ავტომატურად ჩატვირთული ახალი ამბების ლენტების წასაშლელად მონიშვნა არ შეიძლება.';ru='Нельзя помечать на удаление ленты новостей, загруженные автоматически с сервера новостей.'");
				Сообщение = Новый СообщениеПользователю();
