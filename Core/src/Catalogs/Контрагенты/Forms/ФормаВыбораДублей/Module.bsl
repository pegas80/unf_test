...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = ?(ЗначениеЗаполнено(КПП),
					НСтр("ka='გსნ-ის და აამკ-ის დუბლების სია';ru='Список дублей по ИНН и КПП'"),
					НСтр("ka='გსნ-ის მიხედვით დუბლების სია';ru='Список дублей по ИНН'"));
...
Процедура ОбработатьАктивизациюСтрокиСписка()
	...
	Элементы.ОткрытьДокументыПоКонтрагенту.Заголовок = СтрШаблон(НСтр("ka='Документы по контрагенту (%1)';ru='Документы по контрагенту (%1)'"),
