...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		Если ЗавершениеРаботы Тогда
			ТекстПредупреждения = НСтр("ka='Изменения состава печати не сохранены.';ru='Изменения состава печати не сохранены.'");
			Возврат;
		КонецЕсли;
...
"Сохранить изменения?';ka='საკონტაქტო ინფორმაციის შემადგენლობა შეიცვალა. შევინახოთ ცვლილებები?'");
		...
		ПоказатьВопрос(Оповещение, ТекстВопроса, РежимДиалогаВопрос.ДаНетОтмена, , КодВозвратаДиалога.Отмена, НСтр("ka='საკონტაქტო ინფორმაციის შემადგენლობის რედაქტირება';ru='Редактирование состава контактной информации'"));
