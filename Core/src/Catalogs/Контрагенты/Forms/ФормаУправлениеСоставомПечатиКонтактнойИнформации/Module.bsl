...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность Тогда
		...
		Если ЗавершениеРаботы Тогда
			ТекстПредупреждения = НСтр("ka='Изменения состава печати не сохранены.';ru='Изменения состава печати не сохранены.';en='Changes in the composition of printing is not saved.'");
			Возврат;
		КонецЕсли;
		
		ТекстВопроса = НСтр("ru='Состав контактной информации был изменен."
"Сохранить изменения?';ka='საკონტაქტო ინფორმაციის შემადგენლობა შეიცვალა. შევინახოთ ცვლილებები?'");
		
		Оповещение = Новый ОписаниеОповещения("ПередЗакрытиемСохранениеПредложено", ЭтотОбъект);
		ПоказатьВопрос(Оповещение, ТекстВопроса, РежимДиалогаВопрос.ДаНетОтмена, , КодВозвратаДиалога.Отмена, НСтр("ka='საკონტაქტო ინფორმაციის შემადგენლობის რედაქტირება';ru='Редактирование состава контактной информации';en='Editing contact information structure'"));
