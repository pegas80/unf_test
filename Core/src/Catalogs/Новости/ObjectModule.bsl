...
"Данные новости:"
"УИН: %УИННовости%"
"Текст новости: %ТекстНовости%';ka='სისტემური შეცდომის შესახებ ახალი ამბის ჩაწერამდე, მას დაყენებული ჰქონდა თვისება ახალიამბებისსაერთოსიაშიდამალვა, იმისთვის, რომ იგი არ გამოჩნდეს მომხმარებლისთვის."
"ახალი ამბების მონაცემები:"
"დუი: %УИННовости%"
"ახალი ამბის ტექსტი: %ТекстНовости%'");
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ka='ახალი ამბები. მონაცემთა შეცვლა. ახალი ამბავი. ჩაწერამდე';ru='Новости. Изменение данных. Новость. Перед записью';en='News. Changing data. News. before recording'"), // ИдентификаторШага
