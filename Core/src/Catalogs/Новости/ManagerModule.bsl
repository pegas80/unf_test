...
"'");
			...
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				...
				НСтр("ka='ახალი ამბები. სერვისი და რეგლამენტი. სტანდარტული მნიშვნელობების ჩატვირთვა. ახალი ამბები. შეცდომა';ru='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Ошибка';en='News. Service and regulations. Loading standard values. News. Mistake'") , // ИдентификаторШага
	...
	ИдентификаторШага = НСтр("ka='ახალი ამბები. სერვისი და რეგლამენტი. სტანდარტული მნიშვნელობების ჩატვირთვა. %ИмяСвойства%. დასაწყისი';ru='Новости. Сервис и регламент. Загрузка стандартных значений. %ИмяСвойства%. Начало';en='News. Service and regulations. Loading standard values. % PropertyName%. Start'");
...
"';ka='Начало загрузки стандартных значений"
"Время начала (мс): %ТНачало%"
"'");
	...
	Если ПравоДоступа("Изменение", Метаданные.Справочники.Новости) = Истина
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("ka='БИП:ახალი ამბები.სერვისი და რეგლამენტი';ru='БИП:Новости.Сервис и регламент';en='BIP: Novosti.Servis and regulations'"), // ИмяСобытия
				НСтр("ka='ახალი ამბები. სერვისი და რეგლამენტი. სტანდარტული მნიშვნელობების ჩატვირთვა. ახალი ამბები. ახალი ამბების ლენტები არ არის';ru='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Нет лент новостей';en='News. Service and regulations. Loading standard values. News. No news feeds'"), // ИдентификаторШага
				УровеньЖурналаРегистрации.Предупреждение, // УровеньЖурналаРегистрации.*
				Метаданные.Справочники.Новости, // ОбъектМетаданных
				, // Данные
				НСтр("ka='მაკეტებიდან ახალი ამბების სტანდარტული მნიშვნელობების ჩატვირთვის შეცდომა. ახალი ამბების ლენტების ცნობარი ცარიელია.';ru='Ошибка загрузки стандартных значений новостей из макетов. Справочник лент новостей пустой.';en='Error loading standard news values ​​of the layouts. Directory news feeds empty.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
...
"Не найдена лента новостей с таким идентификатором.';ka='მაკეტ %ТекущийМакет.Имя%-იდან ახალი ამბების სტანდარტული მნიშვნელობების ჩატვირთვის შეცდომა."
"ასეთი იდენტიფიკატორით ახალი ამბების ლენტი ვერ მოიძებნა.'");
						ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ТекущийМакет.Имя%", ТекущийМакет.Имя);
						ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
							НСтр("ka='БИП:ახალი ამბები.სერვისი და რეგლამენტი';ru='БИП:Новости.Сервис и регламент';en='BIP: Novosti.Servis and regulations'"), // ИмяСобытия
							НСтр("ka='ახალი ამბები. სერვისი და რეგლამენტი. სტანდარტული მნიშვნელობების ჩატვირთვა. ახალი ამბები. ახალი ამბების დაუდგენელი ლენტი';ru='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Неопределенная лента новостей';en='News. Service and regulations. Loading standard values. News. Uncertain Feed'"), // ИдентификаторШага
							УровеньЖурналаРегистрации.Предупреждение, // УровеньЖурналаРегистрации.*
							Метаданные.Справочники.Новости, // ОбъектМетаданных
							, // Данные
							ТекстСообщения, // Комментарий
...
"%2';ka='Ошибка загрузки дополнительных стандартных значений новостей по причине:"
"%1"
"Первые 2000 символов дополнительного содержимого:"
"%2'"),
								...
								ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
									НСтр("ka='БИП:ახალი ამბები.სერვისი და რეგლამენტი';ru='БИП:Новости.Сервис и регламент';en='BIP: Novosti.Servis and regulations'"), // ИмяСобытия
									НСтр("ka='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Ошибки записи из дополнительных источников';ru='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Ошибки записи из дополнительных источников';en='News. Service and regulations. Loading standard values. News. additional source of write errors'"), // ИдентификаторШага
									УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
									Метаданные.Справочники.Новости, // ОбъектМетаданных
									, // Данные
									ТекстСообщения, // Комментарий
...
"У текущего пользователя (имя ИБ: %ТекущийПользователь%) нет прав на изменение справочника новостей.';ka='მაკეტებიდან ახალი ამბების სტანდარტული მნიშვნელობების ჩატვირთვის შეცდომა."
"მიმდინარე მომხმარებელს (სბ-ის სახელი: %ТекущийПользователь%) ახალი ამბების ცნობარის შეცვლის უფლებები არ აქვს.'");
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("ka='БИП:ახალი ამბები.სერვისი და რეგლამენტი';ru='БИП:Новости.Сервис и регламент';en='BIP: Novosti.Servis and regulations'"), // ИмяСобытия
			НСтр("ka='ახალი ამბები. სერვისი და რეგლამენტი. სტანდარტული მნიშვნელობების ჩატვირთვა. ახალი ამბები. დაშვების უფლებების დარღვევა';ru='Новости. Сервис и регламент. Загрузка стандартных значений. Новости. Нарушение прав доступа';en='News. Service and regulations. Loading standard values. News. Access Violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			Метаданные.Справочники.Новости, // ОбъектМетаданных
			, // Данные
			ТекстСообщения, // Комментарий
...
"'");
	...
	ИдентификаторШага = НСтр("ka='ახალი ამბები. სერვისი და რეგლამენტი. სტანდარტული მნიშვნელობების ჩატვირთვა. %ИмяСвойства%. დასასრული';ru='Новости. Сервис и регламент. Загрузка стандартных значений. %ИмяСвойства%. Конец';en='News. Service and regulations. Loading standard values. % PropertyName%. the end'");
	ИдентификаторШага = СтрЗаменить(ИдентификаторШага, "%ИмяСвойства%", ИмяСвойства);
...
"По шагам:"
"%РезультатПоШагам%"
"';ka='Окончание загрузки стандартных значений"
"Время начала (мс): %ТНачало%"
"Время окончания (мс): %ТКонец%"
"Длительность (мс): %ТДлительность%"
""
