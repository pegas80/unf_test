...
"или закройте окно вручную, до выхода из программы.';ka='Необходим пересчет служебных данных."
"Нажмите кнопку [Пересчет служебных данных]"
...
"Пользователю с ролью РедактированиеНовостей можно редактировать разрешенные Администратором локальные ленты новостей.';ka='ახალი ამბების დამატება არ შეიძლება, თუ არ არის ახალი ამბების არცერთი ლოკალური ლენტი, სადაც ნებადართულია რედაქტირება."
"როლ სისტემისადმინისტრატორი-ს და სრულიუფლებები-ს მქონე მომხმარებელს შეუძლია ახალი ამბების ყველა ლოკალური ლენტის რედაქტირება."
"როლ ახალიამბებისრედაქტირება-ს მქონე მომხმარებელს შეუძლია ადმინისტრატორის მიერ ნებადართული ახალი ამბების ლოკალური ლენტების რედაქტირება.'");
...
Процедура СписокПередНачаломИзменения(Элемент, Отказ)
	...
	Если ЭтаФорма.РазрешенныеДляРедактированияЛентыНовостей.НайтиПоЗначению(Элемент.ТекущиеДанные.ЛентаНовостей) = Неопределено Тогда
		ТекстСообщения = НСтр("ka='ახალი ამბების შეცვლა შეიძლება მხოლოდ ახალი ამბების ლოკალურ ლენტში, სადაც ნებადართულია რედაქტირება."
"როლ სისტემისადმინისტრატორი-ს და სრულიუფლებები-ს მქონე მომხმარებელს შეუძლია ახალი ამბების ყველა ლოკალური ლენტის რედაქტირება."
"როლ ახალიამბებისრედაქტირება-ს მქონე მომხმარებელს შეუძლია ადმინისტრატორის მიერ ნებადართული ახალი ამბების ლოკალური ლენტების რედაქტირება.';ru='Можно изменять новости только в локальной ленте новостей, где разрешено редактирование."
"Пользователю с ролями АдминистраторСистемы и ПолныеПрава можно редактировать все локальные ленты новостей."
