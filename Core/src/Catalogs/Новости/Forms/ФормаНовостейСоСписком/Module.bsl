...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтаФорма.ВремяПереносаПоказатьПозжеМинут > 0 Тогда
		Если ЭтаФорма.ТаблицаНовостей.Количество() = 1 Тогда
			ТекстПодсказки = НСтр("ka='ამ ახალი ამბის შესახებ ამ შემახსენო %ВремяПереносаПоказатьПозжеМинут% წუთი';ru='Не напоминать про эту новость %ВремяПереносаПоказатьПозжеМинут% минут'");
		Иначе
			ТекстПодсказки = НСтр("ka='ამ ახალი ამბების შესახებ არ შემახსენო %ВремяПереносаПоказатьПозжеМинут% წუთი';ru='Не напоминать про эти новости %ВремяПереносаПоказатьПозжеМинут% минут'");
		КонецЕсли;
