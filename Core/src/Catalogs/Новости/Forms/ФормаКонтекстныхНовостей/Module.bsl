...
Процедура ПриОткрытии(Отказ)
	...
	Если ЭтаФорма.ТаблицаНовостей.Количество() <= 0 Тогда
		...
		ТекстСообщения     = НСтр("ka='ამ ფორმისთვის კონტექსტური ახალი ამბები არ არის.';ru='Для этой формы нет контекстных новостей.'");
		ПояснениеСообщения = НСтр("ka='ყველა ახალი ამბავის სანახავად, დააჭირეთ აქ.';ru='Нажмите здесь для просмотра всех новостей.'");
