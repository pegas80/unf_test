...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		Сообщение.Текст = НСтр("ka='ახალი ამბების ცნობარში ახალი ამბების ხელით შექმნა არ შეიძლება."
"გამოიყენეთ ახალი ამბების ლენტიდან ახალი ამბების ჩატვირთვა.';ru='В справочнике новостей нельзя создавать новости вручную."
...
Процедура УправлениеФормой()
	...
	Если ЭтаФорма.Пометка = 0 Тогда
		...
		Элементы.Пометка.Подсказка = НСтр("ka='Новость не отмечена';ru='Новость не отмечена';en='The news is not checked'");
	Иначе
		Элементы.Пометка.Рамка = Новый Рамка(ТипРамкиЭлементаУправления.Вдавленная);
		Элементы.Пометка.Подсказка = НСтр("ka='სიახლე მონიშნულია';ru='Новость отмечена';en='The news marked'");
	КонецЕсли;
