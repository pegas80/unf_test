...
Процедура ЗагрузитьПодготовленныеДанныеНаКлиенте(СтруктураДанных)
	...
	Если СтруктураДанных.Свойство("УспешноВыполнена") Тогда
		...
		ТекстОповещения = НСтр("ka='ბანკები განახლებულია კლასიფიკატორიდან';ru='Банки обновлены из классификатора'");
...
Функция ВыполнитьНаСервере(ИБФайловая)
	...
	Иначе
		НаименованиеФоновогоЗадания = НСтр("ka='ბანკების განახლება კლასიფიკატორიდან';ru='Обновление банков из классификатора'");
