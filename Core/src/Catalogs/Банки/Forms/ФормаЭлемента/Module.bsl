...
"Продолжить с изменением?';ka='მოსაწოდებელი მონაცემების განახლება ავტომატურად ხდება. ხელის რეჟიმში შეცვლის შემდეგ, ამ ელემენტის ავტომატური განახლება არ განხორციელდება. გავაგრძელოთ ცვლილებით?'");
...
Процедура ИзменитьРеквизитыЗависимыеОтСтраны(Форма)
	...
	Иначе
		Форма.Элементы.Код.Заголовок = НСтр("ka='Национальный код';ru='Национальный код';en='National code'"); 
	КонецЕсли;
