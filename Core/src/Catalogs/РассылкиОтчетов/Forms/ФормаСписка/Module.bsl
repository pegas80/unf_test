...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеСостоянияНовая", НСтр("ka='ახალი';ru='Новая';en='new'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеСостоянияНеВыполнена", НСтр("ka='არ არის შესრულებული';ru='Не выполнена';en='not done'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеСостоянияВыполненаСОшибками", НСтр("ka='შესრულებულია შეცდომებით';ru='Выполнена с ошибками';en='Is unsuccessful'"));
	Список.Параметры.УстановитьЗначениеПараметра("ПредставлениеСостоянияВыполнена", НСтр("ka='სესრულებულია';ru='Выполнена';en='done'"));
