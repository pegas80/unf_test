...
Процедура Заполнить(Команда)
	Если Сервер = "" Тогда
		ПолныйАдрес = НСтр("ka='ftp://სახელი:პაროლი@სერვერი:პორტი/კატალოგი/';ru='ftp://логин:пароль@сервер:порт/каталог/'");
	Иначе
		Если Логин = "" Тогда
	...
	ПоказатьВводСтроки(Обработчик, ПолныйАдрес, НСтр("ka='შეიყვანეთ სრული ftp მისამართი';ru='Введите полный ftp адрес'"))
КонецПроцедуры
