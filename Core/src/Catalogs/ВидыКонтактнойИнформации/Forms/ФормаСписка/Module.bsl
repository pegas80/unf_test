...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	Если Копирование И Группа Тогда
		...
		ПоказатьПредупреждение(, НСтр("ka='ცნობარში ახალი ჯგუფების დამატება აკრძალულია.';ru='Добавление новых групп в справочнике запрещено.';en='Adding new groups in the directory is prohibited.'"));
	КонецЕсли;
