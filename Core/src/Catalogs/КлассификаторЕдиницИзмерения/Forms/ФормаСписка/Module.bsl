...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	ТекстВопроса = НСтр("ka='კლასიფიკატორიდან საზომი ერთეულის დამატების შესაძლებლობა არის. დავამატოთ კლასიფიკატორიდან? (დიახ - დავამატოთ კლასიფიკატორიდან; არა - დავამატოთ დამოუკიდებლად; გაუქმება - მოქმედების გაუქმება)';ru='Имеется возможность добавить единицу измерения из классификатора. Добавить из классификатора?"
