...
Функция СформироватьАвтоНаименование()
	...
	СтрокаНаименования = НСтр("ru='Эквайринговый терминал ';ka='ეკვაირინგის ტერმინალი'") + " (" + Строка(Объект.Касса) + ")";
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗапретРедактированияРеквизитовОбъектов.ЗаблокироватьРеквизиты(ЭтаФорма);
	 ...
	 УстановитьВидимостьПечатногоУстройства(); //+++ Дмгг
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Объект.СчетЗатрат.Пустая() и НЕ ИспользоватьТолькоРегламентированныйПланСчетов Тогда
...
//+++ Дмгг
&НаСервере
Процедура УстановитьВидимостьПечатногоУстройства()
	
	Элементы.ПечатноеУстройство.Видимость = Объект.ИспользовыатьВнешнееПечатноеОборудование;
...
//+++ Дмгг
&НаКлиенте
Процедура ИспользовыатьВнешнееПечатноеОборудованиеПриИзменении(Элемент)
	
	Если НЕ Объект.ИспользовыатьВнешнееПечатноеОборудование Тогда 
		Объект.ПечатноеУстройство = ПредопределенноеЗначение("Справочник.ПодключаемоеОборудование.ПустаяСсылка");
	КонецЕсли;
	
	УстановитьВидимостьПечатногоУстройства();
